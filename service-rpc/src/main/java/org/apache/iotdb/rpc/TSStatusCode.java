...
public enum TSStatusCode {
  ...
  CREATE_PIPE_SINK_FAILED(334),
  PIPE_ERROR(335),
  PIPESERVER_ERROR(336),
  SERIES_OVERFLOW(337),
  TIMESERIES_ALREADY_EXIST(338),
  CREATE_TEMPLATE_FAILED(340),
  SYNC_FILE_REDIRECTION_FAILED(341),
  SYNC_FILE_FAILED(342),
  ...
  MIGRATE_REGION_FAILED(710),
  CREATE_REGION_FAILED(711),
  DELETE_REGION_FAILED(712),
  PARTITION_CACHE_UPDATE_FAIL(713),
  DESERIALIZE_PIECE_OF_TSFILE_FAILED(714),
