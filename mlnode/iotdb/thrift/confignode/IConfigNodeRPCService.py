...
class setDatabase_args(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == -1:
                if ftype == TType.STRUCT:
                    self.databaseSchema = TStorageGroupSchema()
...
class deleteStorageGroup_args(object):
    """
    Attributes:
     - req
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == -1:
                if ftype == TType.STRUCT:
                    self.req = TDeleteStorageGroupReq()
                    self.req.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('deleteStorageGroup_args')
        if self.req is not None:
            oprot.writeFieldBegin('req', TType.STRUCT, -1)
            self.req.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(deleteStorageGroup_args)
deleteStorageGroup_args.thrift_spec = ()


class deleteStorageGroup_result(object):
    """
    Attributes:
     - success
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('deleteStorageGroup_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(deleteStorageGroup_result)
deleteStorageGroup_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [iotdb.thrift.common.ttypes.TSStatus, None], None, ),  # 0
)
...
class deleteStorageGroups_args(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == -1:
                if ftype == TType.STRUCT:
                    self.req = TDeleteStorageGroupsReq()
                    self.req.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
...
class countMatchedStorageGroups_args(object):
    """
    Attributes:
     - storageGroupPathPattern
    ...
    def __init__(self, storageGroupPathPattern=None,):
            ...
            if fid == -1:
                if ftype == TType.LIST:
                    ...
                    for _i509 in range(_size505):
                        _elem510 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.storageGroupPathPattern.append(_elem510)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('countMatchedStorageGroups_args')
        if self.storageGroupPathPattern is not None:
            ...
            for iter511 in self.storageGroupPathPattern:
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(countMatchedStorageGroups_args)
countMatchedStorageGroups_args.thrift_spec = ()


class countMatchedStorageGroups_result(object):
    """
    Attributes:
     - success
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = TCountStorageGroupResp()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('countMatchedStorageGroups_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(countMatchedStorageGroups_result)
countMatchedStorageGroups_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [TCountStorageGroupResp, None], None, ),  # 0
)


class getMatchedStorageGroupSchemas_args(object):
    """
    Attributes:
     - storageGroupPathPattern
            ...
            if fid == -1:
                if ftype == TType.LIST:
                    ...
                    for _i516 in range(_size512):
                        _elem517 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.storageGroupPathPattern.append(_elem517)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('getMatchedStorageGroupSchemas_args')
        if self.storageGroupPathPattern is not None:
            oprot.writeFieldBegin('storageGroupPathPattern', TType.LIST, -1)
            oprot.writeListBegin(TType.STRING, len(self.storageGroupPathPattern))
            for iter518 in self.storageGroupPathPattern:
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getMatchedStorageGroupSchemas_args)
getMatchedStorageGroupSchemas_args.thrift_spec = ()


class getMatchedStorageGroupSchemas_result(object):
    """
    Attributes:
     - success
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = TStorageGroupSchemaResp()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('getMatchedStorageGroupSchemas_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getMatchedStorageGroupSchemas_result)
getMatchedStorageGroupSchemas_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [TStorageGroupSchemaResp, None], None, ),  # 0
)
...
class showStorageGroup_args(object):
    """
    Attributes:
     - storageGroupPathPattern
            ...
            if fid == -1:
                if ftype == TType.LIST:
                    ...
                    for _i523 in range(_size519):
                        _elem524 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.storageGroupPathPattern.append(_elem524)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('showStorageGroup_args')
        if self.storageGroupPathPattern is not None:
            oprot.writeFieldBegin('storageGroupPathPattern', TType.LIST, -1)
            oprot.writeListBegin(TType.STRING, len(self.storageGroupPathPattern))
            for iter525 in self.storageGroupPathPattern:
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(showStorageGroup_args)
showStorageGroup_args.thrift_spec = ()


class showStorageGroup_result(object):
    """
    Attributes:
     - success
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = TShowStorageGroupResp()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('showStorageGroup_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(showStorageGroup_result)
showStorageGroup_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [TShowStorageGroupResp, None], None, ),  # 0
)
