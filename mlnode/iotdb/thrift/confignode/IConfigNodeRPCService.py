...
class getMatchedDatabaseSchemas_args(object):
            ...
            if fid == -1:
                if ftype == TType.LIST:
                    ...
                    for _i530 in range(_size526):
                        ...
                        self.DatabasePathPattern.append(_elem531)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.DatabasePathPattern is not None:
            oprot.writeFieldBegin('DatabasePathPattern', TType.LIST, -1)
            oprot.writeListBegin(TType.STRING, len(self.DatabasePathPattern))
            for iter532 in self.DatabasePathPattern:
...
class showDatabase_args(object):
            ...
            if fid == -1:
                if ftype == TType.LIST:
                    ...
                    for _i537 in range(_size533):
                        _elem538 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.databasePathPattern.append(_elem538)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.databasePathPattern is not None:
            oprot.writeFieldBegin('databasePathPattern', TType.LIST, -1)
            oprot.writeListBegin(TType.STRING, len(self.databasePathPattern))
            for iter539 in self.databasePathPattern:
