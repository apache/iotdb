...
class countMatchedDatabases_args(object):
            ...
            if fid == -1:
                if ftype == TType.LIST:
                    ...
                    for _i509 in range(_size505):
                        ...
                        self.DatabasePathPattern.append(_elem510)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.DatabasePathPattern is not None:
            ...
            for iter511 in self.DatabasePathPattern:
...
class getMatchedDatabaseSchemas_args(object):
            ...
            if fid == -1:
                if ftype == TType.LIST:
                    ...
                    for _i516 in range(_size512):
                        ...
                        self.DatabasePathPattern.append(_elem517)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.DatabasePathPattern is not None:
            oprot.writeFieldBegin('DatabasePathPattern', TType.LIST, -1)
            oprot.writeListBegin(TType.STRING, len(self.DatabasePathPattern))
            for iter518 in self.DatabasePathPattern:
...
class showDatabase_args(object):
            ...
            if fid == -1:
                if ftype == TType.LIST:
                    ...
                    for _i523 in range(_size519):
                        ...
                        self.databasePathPattern.append(_elem524)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.databasePathPattern is not None:
            oprot.writeFieldBegin('databasePathPattern', TType.LIST, -1)
            oprot.writeListBegin(TType.STRING, len(self.databasePathPattern))
            for iter525 in self.databasePathPattern:
