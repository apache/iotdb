...
class TSetStorageGroupReq(object):
    """
    Attributes:
     - storageGroup
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.storageGroup = TStorageGroupSchema()
                    self.storageGroup.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('TSetStorageGroupReq')
        if self.storageGroup is not None:
            oprot.writeFieldBegin('storageGroup', TType.STRUCT, 1)
            self.storageGroup.write(oprot)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TStorageGroupSchema(object):
    ...
    def __init__(self, name=None, TTL=None, schemaReplicationFactor=None, dataReplicationFactor=None, timePartitionInterval=None, maxSchemaRegionGroupNum=None, maxDataRegionGroupNum=None,):
        self.name = name
        self.TTL = TTL
        self.schemaReplicationFactor = schemaReplicationFactor
        self.dataReplicationFactor = dataReplicationFactor
    ...
    def write(self, oprot):
        ...
        if self.maxSchemaRegionGroupNum is not None:
            oprot.writeFieldBegin('maxSchemaRegionGroupNum', TType.I32, 6)
            oprot.writeI32(self.maxSchemaRegionGroupNum)
            oprot.writeFieldEnd()
        if self.maxDataRegionGroupNum is not None:
            oprot.writeFieldBegin('maxDataRegionGroupNum', TType.I32, 7)
...
class TClusterParameters(object):
    ...
    def __init__(self, clusterName=None, dataReplicationFactor=None, schemaReplicationFactor=None, dataRegionConsensusProtocolClass=None, schemaRegionConsensusProtocolClass=None, configNodeConsensusProtocolClass=None, timePartitionInterval=None, defaultTTL=None, readConsistencyLevel=None, schemaRegionPerDataNode=None, dataRegionPerProcessor=None, leastDataRegionGroupNum=None, seriesPartitionSlotNum=None, seriesPartitionExecutorClass=None, diskSpaceWarningThreshold=None,):
        ...
        self.leastDataRegionGroupNum = leastDataRegionGroupNum
        self.seriesPartitionSlotNum = seriesPartitionSlotNum
        self.seriesPartitionExecutorClass = seriesPartitionExecutorClass
        self.diskSpaceWarningThreshold = diskSpaceWarningThreshold
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.I32:
                    self.leastDataRegionGroupNum = iprot.readI32()
                else:
                    iprot.skip(ftype)
            elif fid == 13:
                if ftype == TType.I32:
    ...
    def write(self, oprot):
        ...
        if self.dataRegionPerProcessor is not None:
            ...
            oprot.writeFieldEnd()
        if self.leastDataRegionGroupNum is not None:
            oprot.writeFieldBegin('leastDataRegionGroupNum', TType.I32, 12)
            oprot.writeI32(self.leastDataRegionGroupNum)
            oprot.writeFieldEnd()
        if self.seriesPartitionSlotNum is not None:
            oprot.writeFieldBegin('seriesPartitionSlotNum', TType.I32, 13)
            oprot.writeI32(self.seriesPartitionSlotNum)
            oprot.writeFieldEnd()
        if self.seriesPartitionExecutorClass is not None:
            oprot.writeFieldBegin('seriesPartitionExecutorClass', TType.STRING, 14)
            oprot.writeString(self.seriesPartitionExecutorClass.encode('utf-8') if sys.version_info[0] == 2 else self.seriesPartitionExecutorClass)
            oprot.writeFieldEnd()
        if self.diskSpaceWarningThreshold is not None:
            oprot.writeFieldBegin('diskSpaceWarningThreshold', TType.DOUBLE, 15)
            oprot.writeDouble(self.diskSpaceWarningThreshold)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def validate(self):
        ...
        if self.leastDataRegionGroupNum is None:
            raise TProtocolException(message='Required field leastDataRegionGroupNum is unset!')
        if self.seriesPartitionSlotNum is None:
            raise TProtocolException(message='Required field seriesPartitionSlotNum is unset!')
        if self.seriesPartitionExecutorClass is None:
            raise TProtocolException(message='Required field seriesPartitionExecutorClass is unset!')
...
class TStorageGroupInfo(object):
    ...
    def __init__(self, name=None, TTL=None, schemaReplicationFactor=None, dataReplicationFactor=None, timePartitionInterval=None, schemaRegionNum=None, dataRegionNum=None,):
        self.name = name
        self.TTL = TTL
        self.schemaReplicationFactor = schemaReplicationFactor
        self.dataReplicationFactor = dataReplicationFactor
    ...
    def write(self, oprot):
        ...
        if self.schemaRegionNum is not None:
            ...
            oprot.writeFieldEnd()
        if self.dataRegionNum is not None:
            oprot.writeFieldBegin('dataRegionNum', TType.I32, 7)
            oprot.writeI32(self.dataRegionNum)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
all_structs.append(TSetStorageGroupReq)
TSetStorageGroupReq.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'storageGroup', [TStorageGroupSchema, None], None, ),  # 1
)
...
TStorageGroupSchema.thrift_spec = (
    ...
    (5, TType.I64, 'timePartitionInterval', None, None, ),  # 5
    (6, TType.I32, 'maxSchemaRegionGroupNum', None, None, ),  # 6
    (7, TType.I32, 'maxDataRegionGroupNum', None, None, ),  # 7
)
...
TClusterParameters.thrift_spec = (
    ...
    (12, TType.I32, 'leastDataRegionGroupNum', None, None, ),  # 12
    (13, TType.I32, 'seriesPartitionSlotNum', None, None, ),  # 13
    (14, TType.STRING, 'seriesPartitionExecutorClass', 'UTF8', None, ),  # 14
    (15, TType.DOUBLE, 'diskSpaceWarningThreshold', None, None, ),  # 15
)
...
TStorageGroupInfo.thrift_spec = (
    ...
    (5, TType.I64, 'timePartitionInterval', None, None, ),  # 5
    (6, TType.I32, 'schemaRegionNum', None, None, ),  # 6
    (7, TType.I32, 'dataRegionNum', None, None, ),  # 7
)
