...
class TAuthorizerReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i218 in range(_size214):
                        ...
                        self.nodeNameList.append(_elem219)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.permissions is not None:
            ...
            for iter220 in self.permissions:
        ...
        if self.nodeNameList is not None:
            ...
            for iter221 in self.nodeNameList:
...
class TAuthorizerResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i226 in range(_size222):
                        ...
                        iprot.readListEnd()
                        self.authorizerInfo[_key227] = _val228
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.authorizerInfo is not None:
            ...
            for kiter235, viter236 in self.authorizerInfo.items():
...
class TUserResp(object):
    ...
    def write(self, oprot):
        ...
        if self.privilegeList is not None:
            ...
            for iter250 in self.privilegeList:
...
class TRoleResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i256 in range(_size252):
                        ...
                        self.privilegeList.append(_elem257)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.privilegeList is not None:
            ...
            oprot.writeListBegin(TType.STRING, len(self.privilegeList))
            for iter258 in self.privilegeList:
...
class TAddConsensusGroupReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i279 in range(_size275):
                        _elem280 = iotdb.thrift.common.ttypes.TConfigNodeLocation()
                        _elem280.read(iprot)
                        self.configNodeList.append(_elem280)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.configNodeList is not None:
            ...
            oprot.writeListBegin(TType.STRUCT, len(self.configNodeList))
            for iter281 in self.configNodeList:
                iter281.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TGetUDFTableResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i286 in range(_size282):
                        ...
                        self.allUDFInformation.append(_elem287)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.allUDFInformation is not None:
            ...
            oprot.writeListBegin(TType.STRING, len(self.allUDFInformation))
            for iter288 in self.allUDFInformation:
...
class TCreateTriggerReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i293 in range(_size289):
                        ...
                        self.attributes[_key294] = _val295
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            ...
            for kiter296, viter297 in self.attributes.items():
...
class TGetTriggerTableResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i302 in range(_size298):
                        ...
                        self.allTriggerInformation.append(_elem303)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.allTriggerInformation is not None:
            oprot.writeFieldBegin('allTriggerInformation', TType.LIST, 2)
            oprot.writeListBegin(TType.STRING, len(self.allTriggerInformation))
            for iter304 in self.allTriggerInformation:
...
class TGetJarInListReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i309 in range(_size305):
                        ...
                        self.jarNameList.append(_elem310)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.jarNameList is not None:
            ...
            for iter311 in self.jarNameList:
...
class TGetDataNodeLocationsResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i323 in range(_size319):
                        _elem324 = iotdb.thrift.common.ttypes.TDataNodeLocation()
                        _elem324.read(iprot)
                        self.dataNodeLocationList.append(_elem324)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.dataNodeLocationList is not None:
            ...
            for iter325 in self.dataNodeLocationList:
                iter325.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TGetPipePluginTableResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i330 in range(_size326):
                        ...
                        self.allPipePluginMeta.append(_elem331)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.allPipePluginMeta is not None:
            ...
            for iter332 in self.allPipePluginMeta:
                oprot.writeBinary(iter332)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TShowClusterResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i337 in range(_size333):
                        _elem338 = iotdb.thrift.common.ttypes.TConfigNodeLocation()
                        _elem338.read(iprot)
                        self.configNodeList.append(_elem338)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.LIST:
                    ...
                    for _i343 in range(_size339):
                        _elem344 = iotdb.thrift.common.ttypes.TDataNodeLocation()
                        _elem344.read(iprot)
                        self.dataNodeList.append(_elem344)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.MAP:
                    ...
                    for _i349 in range(_size345):
                        ...
                        self.nodeStatus[_key350] = _val351
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.configNodeList is not None:
            oprot.writeFieldBegin('configNodeList', TType.LIST, 2)
            oprot.writeListBegin(TType.STRUCT, len(self.configNodeList))
            for iter352 in self.configNodeList:
                iter352.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.dataNodeList is not None:
            ...
            for iter353 in self.dataNodeList:
                iter353.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.nodeStatus is not None:
            ...
            for kiter354, viter355 in self.nodeStatus.items():
                oprot.writeI32(kiter354)
...
class TShowDataNodesResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i360 in range(_size356):
                        _elem361 = TDataNodeInfo()
                        _elem361.read(iprot)
                        self.dataNodesInfoList.append(_elem361)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.dataNodesInfoList is not None:
            ...
            for iter362 in self.dataNodesInfoList:
                iter362.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TShowConfigNodesResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i367 in range(_size363):
                        _elem368 = TConfigNodeInfo()
                        _elem368.read(iprot)
                        self.configNodesInfoList.append(_elem368)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.configNodesInfoList is not None:
            ...
            for iter369 in self.configNodesInfoList:
                iter369.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TShowDatabaseResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i374 in range(_size370):
                        ...
                        _val376 = TDatabaseInfo()
                        _val376.read(iprot)
                        self.databaseInfoMap[_key375] = _val376
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.databaseInfoMap is not None:
            ...
            for kiter377, viter378 in self.databaseInfoMap.items():
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i383 in range(_size379):
                        ...
                        self.databases.append(_elem384)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class TShowRegionResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i390 in range(_size386):
                        _elem391 = TRegionInfo()
                        _elem391.read(iprot)
                        self.regionInfoList.append(_elem391)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.regionInfoList is not None:
            ...
            for iter392 in self.regionInfoList:
                iter392.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TRegionRouteMapResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i397 in range(_size393):
                        _key398 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _key398.read(iprot)
                        _val399 = iotdb.thrift.common.ttypes.TRegionReplicaSet()
                        _val399.read(iprot)
                        self.regionRouteMap[_key398] = _val399
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.regionRouteMap is not None:
            ...
            for kiter400, viter401 in self.regionRouteMap.items():
                kiter400.write(oprot)
...
class TGetAllTemplatesResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i406 in range(_size402):
                        ...
                        self.templateList.append(_elem407)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.templateList is not None:
            ...
            for iter408 in self.templateList:
...
class TGetPathsSetTemplatesResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i413 in range(_size409):
                        _elem414 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.pathList.append(_elem414)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.pathList is not None:
            ...
            for iter415 in self.pathList:
                oprot.writeString(iter415.encode('utf-8') if sys.version_info[0] == 2 else iter415)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TShowPipeInfo(object):
    ...
    def __init__(self, id=None, creationTime=None, state=None, pipeCollector=None, pipeProcessor=None, pipeConnector=None, exceptionMessage=None,):
        self.id = id
        self.creationTime = creationTime
        self.state = state
        self.pipeCollector = pipeCollector
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.pipeCollector = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.STRING:
    ...
    def write(self, oprot):
        ...
        if self.state is not None:
            ...
            oprot.writeFieldEnd()
        if self.pipeCollector is not None:
            oprot.writeFieldBegin('pipeCollector', TType.STRING, 4)
            oprot.writeString(self.pipeCollector.encode('utf-8') if sys.version_info[0] == 2 else self.pipeCollector)
            oprot.writeFieldEnd()
    ...
    def validate(self):
        ...
        if self.pipeCollector is None:
            raise TProtocolException(message='Required field pipeCollector is unset!')
...
class TGetAllPipeInfoResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i420 in range(_size416):
                        ...
                        self.allPipeInfo.append(_elem421)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.allPipeInfo is not None:
            ...
            for iter422 in self.allPipeInfo:
                oprot.writeBinary(iter422)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TCreatePipeReq(object):
    ...
    def __init__(self, pipeName=None, collectorAttributes=None, processorAttributes=None, connectorAttributes=None,):
        self.pipeName = pipeName
        self.collectorAttributes = collectorAttributes
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i427 in range(_size423):
                        ...
                        self.collectorAttributes[_key428] = _val429
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.MAP:
                    ...
                    for _i434 in range(_size430):
                        ...
                        self.processorAttributes[_key435] = _val436
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.MAP:
                    ...
                    for _i441 in range(_size437):
                        ...
                        self.connectorAttributes[_key442] = _val443
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.pipeName is not None:
            ...
            oprot.writeString(self.pipeName.encode('utf-8') if sys.version_info[0] == 2 else self.pipeName)
            oprot.writeFieldEnd()
        if self.collectorAttributes is not None:
            oprot.writeFieldBegin('collectorAttributes', TType.MAP, 2)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.collectorAttributes))
            for kiter444, viter445 in self.collectorAttributes.items():
        ...
        if self.processorAttributes is not None:
            ...
            for kiter446, viter447 in self.processorAttributes.items():
                oprot.writeString(kiter446.encode('utf-8') if sys.version_info[0] == 2 else kiter446)
                oprot.writeString(viter447.encode('utf-8') if sys.version_info[0] == 2 else viter447)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.connectorAttributes is not None:
            ...
            for kiter448, viter449 in self.connectorAttributes.items():
...
class TPipeSinkInfo(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i454 in range(_size450):
                        _key455 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val456 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.attributes[_key455] = _val456
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.attributes))
            for kiter457, viter458 in self.attributes.items():
                oprot.writeString(kiter457.encode('utf-8') if sys.version_info[0] == 2 else kiter457)
                oprot.writeString(viter458.encode('utf-8') if sys.version_info[0] == 2 else viter458)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TGetPipeSinkResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i463 in range(_size459):
                        _elem464 = TPipeSinkInfo()
                        _elem464.read(iprot)
                        self.pipeSinkInfoList.append(_elem464)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.pipeSinkInfoList is not None:
            ...
            for iter465 in self.pipeSinkInfoList:
                iter465.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TShowPipeResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i470 in range(_size466):
                        _elem471 = TShowPipeInfo()
                        _elem471.read(iprot)
                        self.pipeInfoList.append(_elem471)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.pipeInfoList is not None:
            ...
            for iter472 in self.pipeInfoList:
                iter472.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TCreateModelReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i484 in range(_size480):
                        ...
                        self.queryExpressions.append(_elem485)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i490 in range(_size486):
                        _key491 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val492 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.modelConfigs[_key491] = _val492
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.queryExpressions is not None:
            ...
            for iter493 in self.queryExpressions:
        ...
        if self.modelConfigs is not None:
            ...
            for kiter494, viter495 in self.modelConfigs.items():
                oprot.writeString(kiter494.encode('utf-8') if sys.version_info[0] == 2 else kiter494)
                oprot.writeString(viter495.encode('utf-8') if sys.version_info[0] == 2 else viter495)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TShowModelResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i500 in range(_size496):
                        ...
                        self.modelInfoList.append(_elem501)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.modelInfoList is not None:
            ...
            for iter502 in self.modelInfoList:
                oprot.writeBinary(iter502)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TShowTrailResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i507 in range(_size503):
                        ...
                        self.trailInfoList.append(_elem508)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.trailInfoList is not None:
            ...
            for iter509 in self.trailInfoList:
...
class TUpdateModelInfoReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i514 in range(_size510):
                        _key515 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val516 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.modelInfo[_key515] = _val516
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.modelInfo is not None:
            ...
            for kiter517, viter518 in self.modelInfo.items():
                oprot.writeString(kiter517.encode('utf-8') if sys.version_info[0] == 2 else kiter517)
                oprot.writeString(viter518.encode('utf-8') if sys.version_info[0] == 2 else viter518)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
TShowPipeInfo.thrift_spec = (
    ...
    (4, TType.STRING, 'pipeCollector', 'UTF8', None, ),  # 4
...
TCreatePipeReq.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'pipeName', 'UTF8', None, ),  # 1
    (2, TType.MAP, 'collectorAttributes', (TType.STRING, 'UTF8', TType.STRING, 'UTF8', False), None, ),  # 2
