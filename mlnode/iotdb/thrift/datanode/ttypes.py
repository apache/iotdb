...
class TGetDataBlockRequest(object):
    ...
    def __init__(self, sourceFragmentInstanceId=None, startSequenceId=None, endSequenceId=None,):
...
class TLoadSample(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.I16:
                    self.cpuUsageRate = iprot.readI16()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.cpuUsageRate is not None:
            oprot.writeFieldBegin('cpuUsageRate', TType.I16, 1)
            oprot.writeI16(self.cpuUsageRate)
            oprot.writeFieldEnd()
...
TLoadSample.thrift_spec = (
    None,  # 0
    (1, TType.I16, 'cpuUsageRate', None, None, ),  # 1
