...
class Iface(object):
    ...
    def onCloseLocalSinkChannelEvent(self, e):
        """
        Parameters:
         - e
...
class Client(Iface):
    ...
    def onCloseLocalSinkChannelEvent(self, e):
        ...
        """
        self.send_onCloseLocalSinkChannelEvent(e)
        self.recv_onCloseLocalSinkChannelEvent()

    def send_onCloseLocalSinkChannelEvent(self, e):
        self._oprot.writeMessageBegin('onCloseLocalSinkChannelEvent', TMessageType.CALL, self._seqid)
        args = onCloseLocalSinkChannelEvent_args()
        args.e = e
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_onCloseLocalSinkChannelEvent(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = onCloseLocalSinkChannelEvent_result()
        result.read(iprot)
        iprot.readMessageEnd()
        return
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["onCloseLocalSinkChannelEvent"] = Processor.process_onCloseLocalSinkChannelEvent
    ...
    def process_onCloseLocalSinkChannelEvent(self, seqid, iprot, oprot):
        args = onCloseLocalSinkChannelEvent_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = onCloseLocalSinkChannelEvent_result()
        try:
            self._handler.onCloseLocalSinkChannelEvent(args.e)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("onCloseLocalSinkChannelEvent", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class onCloseLocalSinkChannelEvent_args(object):
    """
    Attributes:
     - e
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == -1:
                if ftype == TType.STRUCT:
                    self.e = TCloseLocalSinkChannelEvent()
                    self.e.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('onCloseLocalSinkChannelEvent_args')
        if self.e is not None:
            oprot.writeFieldBegin('e', TType.STRUCT, -1)
            self.e.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(onCloseLocalSinkChannelEvent_args)
onCloseLocalSinkChannelEvent_args.thrift_spec = ()


class onCloseLocalSinkChannelEvent_result(object):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('onCloseLocalSinkChannelEvent_result')
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(onCloseLocalSinkChannelEvent_result)
onCloseLocalSinkChannelEvent_result.thrift_spec = (
)
