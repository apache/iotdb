...
_data_config_parser.add_argument('--dataset_type', type=str, required=True)
...
_model_config_parser.add_argument('--forecast_type', type=str, default='m')
...
_task_config_parser.add_argument('--forecast_type', type=str, default='m')
