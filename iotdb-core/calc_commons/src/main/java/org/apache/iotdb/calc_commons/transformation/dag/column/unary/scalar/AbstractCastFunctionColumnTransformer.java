...
package org.apache.iotdb.calc_commons.transformation.dag.column.unary.scalar;
...
import org.apache.iotdb.calc_commons.transformation.dag.column.unary.UnaryColumnTransformer;
...
public abstract class AbstractCastFunctionColumnTransformer extends UnaryColumnTransformer {
  ...
  protected void castTimestamp(ColumnBuilder columnBuilder, long value) {
    try {
      switch (returnType.getTypeEnum()) {
        case INT32:
          returnType.writeInt(columnBuilder, (CastFunctionUtils.castLongToInt(value)));
          break;
        case DATE:
          returnType.writeInt(
              columnBuilder,
  ...
  protected void cast(ColumnBuilder columnBuilder, float value) {
    switch (returnType.getTypeEnum()) {
      case INT32:
      case DATE:
        returnType.writeInt(columnBuilder, CastFunctionUtils.castFloatToInt(value));
        break;
      case INT64:
      case TIMESTAMP:
        returnType.writeLong(columnBuilder, CastFunctionUtils.castFloatToLong(value));
        break;
      case FLOAT:
        returnType.writeFloat(columnBuilder, value);
        break;
  ...
  protected void cast(ColumnBuilder columnBuilder, double value) {
    switch (returnType.getTypeEnum()) {
      case INT32:
      case DATE:
        returnType.writeInt(columnBuilder, CastFunctionUtils.castDoubleToInt(value));
        break;
      case INT64:
      case TIMESTAMP:
        returnType.writeLong(columnBuilder, CastFunctionUtils.castDoubleToLong(value));
        break;
      case FLOAT:
        returnType.writeFloat(columnBuilder, CastFunctionUtils.castDoubleToFloat(value));
        break;
      case DOUBLE:
        returnType.writeDouble(columnBuilder, value);
        break;
    ...
    try {
      switch (returnType.getTypeEnum()) {
        ...
        case TIMESTAMP:
          ...
          break;
        case FLOAT:
          returnType.writeFloat(columnBuilder, CastFunctionUtils.castTextToFloat(stringValue));
          break;
        case DOUBLE:
          returnType.writeDouble(columnBuilder, CastFunctionUtils.castTextToDouble(stringValue));
          break;
        case BOOLEAN:
          returnType.writeBoolean(columnBuilder, CastFunctionUtils.castTextToBoolean(stringValue));
          break;
        case TEXT:
        case STRING:
        case BLOB:
