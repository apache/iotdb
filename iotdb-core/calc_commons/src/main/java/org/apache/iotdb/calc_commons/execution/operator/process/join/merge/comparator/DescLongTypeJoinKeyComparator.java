...
package org.apache.iotdb.calc_commons.execution.operator.process.join.merge.comparator;
...
public class DescLongTypeJoinKeyComparator implements JoinKeyComparator {
  ...
  private static final DescLongTypeJoinKeyComparator INSTANCE = new DescLongTypeJoinKeyComparator();

  private DescLongTypeJoinKeyComparator() {
    // hide constructor
  }

  public static DescLongTypeJoinKeyComparator getInstance() {
    return INSTANCE;
  }
