...
import org.apache.iotdb.calc_commons.execution.operator.process.rowpattern.PatternAggregators;
...
import static org.apache.iotdb.calc_commons.execution.operator.process.rowpattern.matcher.MatchResult.NO_MATCH;
