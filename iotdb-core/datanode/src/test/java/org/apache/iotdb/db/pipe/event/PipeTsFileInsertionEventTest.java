...
public class PipeTsFileInsertionEventTest {
  ...
  public void testTsFileDedupScopeIdIsPreservedForCleanupAndCopy() throws Exception {
    final PipeTsFileEpochProgressIndexAndFlushManager keeper =
    ...
    try {
      ...
      keeper.registerResource(dataRegionId, scopeA, sourceResource);
      keeper.registerResource(dataRegionId, scopeB, sourceResource);
