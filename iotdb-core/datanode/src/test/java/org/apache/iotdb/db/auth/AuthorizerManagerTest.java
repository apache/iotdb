...
public class AuthorizerManagerTest {
  ...
  public void permissionCacheTest() throws IllegalPathException {
    ...
    user.grantTBPrivilege("test2", "table2", PrivilegeType.UPDATE, false);
  ...
  public void grantOptTest() throws IllegalPathException {
    ...
    user.grantTBPrivilege("database", "table", PrivilegeType.UPDATE, false);
    ...
    Assert.assertFalse(
        authorityFetcher.checkUserPrivilegeGrantOpt("user1", PrivilegeType.UPDATE, "database"));
