...
public class OptimizationTestUtil {
  ...
  static {
    try {
      schemaMap.put("root.db.d1.s1", new MeasurementPath("root.db.d1.s1", TSDataType.INT32));
      schemaMap.put("root.db.d1.s2", new MeasurementPath("root.db.d1.s2", TSDataType.DOUBLE));
      schemaMap.put("root.db.d1.s3", new MeasurementPath("root.db.d1.s3", TSDataType.BOOLEAN));
      schemaMap.put("root.db.d2.s1", new MeasurementPath("root.db.d2.s1", TSDataType.INT32));
      schemaMap.put("root.db.d2.s2", new MeasurementPath("root.db.d2.s2", TSDataType.DOUBLE));
      schemaMap.put("root.db.d2.s4", new MeasurementPath("root.db.d2.s4", TSDataType.TEXT));

      MeasurementPath aS1 = new MeasurementPath("root.db.d2.a.s1", TSDataType.INT32);
      aS1.setUnderAlignedEntity(true);
      MeasurementPath aS2 = new MeasurementPath("root.db.d2.a.s2", TSDataType.DOUBLE);
      aS2.setUnderAlignedEntity(true);
      schemaMap.put("root.db.d2.a.s1", aS1);
      schemaMap.put("root.db.d2.a.s2", aS2);
      ...
      schemaMap.put("root.db.d2.a", alignedPath);
      schemaMap.put("desc_root.db.d2.a", descOrderAlignedPath);
      ...
      schemaMap.put("aligned_root.db.d2.a.s1", aligned_d2s1);
      AlignedPath aligned_d2s2 =
          new AlignedPath(
              "root.db.d2.a",
              Collections.singletonList("s2"),
              Collections.singletonList(aS2.getMeasurementSchema()));
      schemaMap.put("aligned_root.db.d2.a.s2", aligned_d2s2);

      // used in GROUP BY LEVEL
      schemaMap.put("root.db.*.s1", new MeasurementPath("root.db.*.s1", TSDataType.INT32));
      schemaMap.put("root.db.*.s2", new MeasurementPath("root.db.*.s2", TSDataType.DOUBLE));
      schemaMap.put("root.db.*.*.s1", new MeasurementPath("root.db.*.*.s1", TSDataType.INT32));
      schemaMap.put("root.db.*.*.s2", new MeasurementPath("root.db.*.*.s2", TSDataType.DOUBLE));
