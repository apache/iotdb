...
public class ShowSubscriptionsStatementTest {
  ...
  private void assertDetails(final String sql, final String topicName) {
    final Statement statement = StatementGenerator.createStatement(sql, ZoneId.systemDefault());

    assertTrue(statement instanceof ShowSubscriptionsStatement);
    final ShowSubscriptionsStatement showSubscriptions = (ShowSubscriptionsStatement) statement;
