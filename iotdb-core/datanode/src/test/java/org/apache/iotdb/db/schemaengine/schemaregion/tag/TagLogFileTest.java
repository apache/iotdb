...
public class TagLogFileTest {
  ...
  @Test
  public void writeAppendsFirstRecordWithoutReadingPastFileEnd() throws Exception {
    ...
    try (TagLogFile tagLogFile = new TagLogFile(tempDir.getAbsolutePath(), "tag.log")) {
      long offset = tagLogFile.write(tags, attributes);
      Pair<Map<String, String>, Map<String, String>> result = tagLogFile.read(offset);
