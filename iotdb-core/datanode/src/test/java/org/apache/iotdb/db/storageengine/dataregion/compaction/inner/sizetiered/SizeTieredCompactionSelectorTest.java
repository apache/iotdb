...
public class SizeTieredCompactionSelectorTest {
  ...
  public void testSubmitWhenNextTimePartitionExists() {
    ...
    for (long i = 0; i < 9; ++i) {
      Assert.assertEquals(
          1,
          new SizeTieredCompactionSelector("root.test", "0", i, true, manager, new ModFileManager())
    ...
    Assert.assertEquals(
        0,
        new SizeTieredCompactionSelector("root.test", "0", 9, true, manager, new ModFileManager())
