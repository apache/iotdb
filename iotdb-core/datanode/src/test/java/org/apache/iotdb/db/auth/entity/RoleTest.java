  ...
  public void testRole_InitAndSerialize() throws IllegalPathException {
    ...
    Assert.assertEquals(
        "Role{name='root', pathPrivilegeList=[root.** : READ_DATA_wi"
            ...
            + "USE_CQ_with_grant_option, USE_PIPE_with_grant_option, USE_SERVICE_with_grant_option"
            + ", USE_UDF_with_grant_option, EXTEND_TEMPLATE_with_grant_option, MANAGE_ROLE_with_gr"
