...
public class RoleTest {
  ...
  public void testRole_InitAndSerialize() throws IllegalPathException {
    ...
    ObjectPrivilege objectPrivilege = new ObjectPrivilege("testdb");
    TablePrivilege tablePrivilege = new TablePrivilege("testtb");
    objectPrivilege.getTablePrivilegeMap().put("testtb", tablePrivilege);
    for (PrivilegeType item : PrivilegeType.values()) {
      ...
      } else if (item.isObjectPrivilege()) {
        objectPrivilege.grantDBObjectPrivilege(item);
        objectPrivilege.grantDBGrantOption(item);
        objectPrivilege.grantTableObjectPrivilege("testtb", item);
      }
    }
    admin.getObjectPrivilegeMap().put("testdb", objectPrivilege);
