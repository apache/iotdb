...
public class PipeTsFileEpochProgressIndexAndFlushManagerTest {
  ...
  private final PipeTsFileEpochProgressIndexAndFlushManager keeper =
  ...
  public void setUp() throws IOException {
    tempDir = Files.createTempDirectory("PipeTsFileEpochProgressIndexAndFlushManager").toFile();
  }
  ...
  public void testDuplicateTsFileLookupIsScopedByTaskInstance() throws IOException {
    ...
    keeper.registerResource(DATA_REGION_ID, TASK_SCOPE_A, resource);
  ...
  public void testProgressIndexCheckDoesNotLeakAcrossTaskScopes() throws IOException {
    ...
    keeper.registerResource(DATA_REGION_ID, TASK_SCOPE_A, comparedResource);
  ...
  public void testClearProgressIndexOnlyRemovesTargetTaskScope() throws IOException {
    ...
    keeper.registerResource(DATA_REGION_ID, TASK_SCOPE_A, scopeAResource);
    keeper.registerResource(DATA_REGION_ID, TASK_SCOPE_B, scopeBResource);
