...
public class TsFileEpochManagerPerformanceTest {
  ...
  private static volatile Map<String, String[]> benchmarkBlackhole;
  ...
  private static Map<String, String[]> getLegacyDevice2MeasurementsMap(
    ...
    return insertRowsNode.getInsertRowNodeList().stream()
        .collect(
            Collectors.toMap(
                ...
                insertRowNode -> insertRowNode.getMeasurements(),
  ...
  private static InsertRowsNode createInsertRowsNode(
    ...
    final PartialPath devicePath = new PartialPath("root.schema_aggregation_performance.d1", false);
