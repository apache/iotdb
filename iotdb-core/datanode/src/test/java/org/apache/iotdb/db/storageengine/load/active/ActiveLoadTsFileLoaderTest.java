...
public class ActiveLoadTsFileLoaderTest {
  ...
  public void testStopClearsPendingFilesForRestart() throws Exception {
    ...
    Assert.assertTrue(pendingQueue.enqueue(tsFilePath, tempDir.getAbsolutePath(), false));
  ...
  public void testPendingEntryRetainsConversionTaskId() {
    ...
    Assert.assertTrue(
        pendingQueue.enqueue(tsFilePath, tempDir.getAbsolutePath(), true, "conversion-task"));
