...
public class PatternTreeMapTest {
  ...
  public void modificationPatternTreeMapTest() throws IllegalPathException {
    ...
    patternTreeMap.append(
        new PartialPath("root.sg1.d1.s1"),
        new TreeDeletionEntry(new PartialPath("root.sg1.d1.s1"), 1, 3));
    patternTreeMap.append(
        new PartialPath("root.sg1.d1.s1"),
    ...
    checkOverlapped(
        ...
        Arrays.asList(
            ...
            new TreeDeletionEntry(new PartialPath("root.**.s1"), 10, 100),
            new TreeDeletionEntry(new PartialPath("root.**.s1"), 100, 200),
            new TreeDeletionEntry(new PartialPath("root.**"), 10, 100)));
    ...
    checkOverlapped(
        patternTreeMap,
        new PartialPath("root.sg1.d1.s2"),
        Collections.singletonList(new TreeDeletionEntry(new PartialPath("root.**"), 10, 100)));

    patternTreeMap.append(
        new PartialPath("root.sg1.d2.s1"),
        new TreeDeletionEntry(new PartialPath("root.sg1.d2.s1"), 4, 6));
    patternTreeMap.append(
        new PartialPath("root.**.s2"), new TreeDeletionEntry(new PartialPath("root.**.s2"), 4, 6));
    patternTreeMap.append(
    ...
    patternTreeMap.append(
        ...
        new TreeDeletionEntry(new PartialPath("root.sg1.d1.*.d3.s4"), 4, 6));
    ...
    checkOverlappedByDevice(
        ...
        Arrays.asList(
            ...
            new TreeDeletionEntry(new PartialPath("root.sg1.d1.s1"), 6, 10),
            new TreeDeletionEntry(new PartialPath("root.**.s1"), 10, 100),
            new TreeDeletionEntry(new PartialPath("root.**.s2"), 4, 6),
            new TreeDeletionEntry(new PartialPath("root.sg1.d1.s3"), 5, 6),
            new TreeDeletionEntry(new PartialPath("root.**.s1"), 100, 200),
            new TreeDeletionEntry(new PartialPath("root.sg1.d1.*"), 4, 6),
            new TreeDeletionEntry(new PartialPath("root.**"), 10, 100)));
