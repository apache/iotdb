...
public class PrimitiveMemTableTest {
  ...
  public void testWriteAndFlushSortDuringQuerySortTVListAndActualQueryExecution()
    ...
    memTable.getWritableMemChunk(new StringArrayDeviceID("root.test.d1"), "s1").sortTvListForFlush();
    memTable.getWritableMemChunk(new StringArrayDeviceID("root.test.d1"), "s2").sortTvListForFlush();
    memTable.getWritableMemChunk(new StringArrayDeviceID("root.test.d1"), "s3").sortTvListForFlush();
