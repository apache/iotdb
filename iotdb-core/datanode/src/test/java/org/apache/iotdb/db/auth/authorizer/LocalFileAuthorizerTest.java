...
public class LocalFileAuthorizerTest {
  ...
  public void testRelationalPermission() throws AuthException {
    ...
    assertFalse(authorizer.checkUserPrivileges(userName, PrivilegeType.UPDATE, database));
    assertTrue(
    ...
    assertFalse(authorizer.checkUserPrivileges(userName, PrivilegeType.UPDATE, database, table));
  }
