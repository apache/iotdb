...
public class DateTimeUtilsTest {
  ...
  public void testConstructTimeDuration() {
    ...
    Assert.assertEquals(1000000 * 86400_000L + 1, timeDuration.nsDuration);

    timeDuration = DateTimeUtils.constructTimeDuration("1y1mo1d1ns");
    ...
    Assert.assertEquals(12, timeDuration.monthDuration);
    Assert.assertEquals(0, timeDuration.nsDuration);
