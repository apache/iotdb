...
public final class SymbolAliases {
  ...
  public SymbolReference get(String alias) {
    ...
    return getOptional(alias)
        .orElseThrow(
            () -> new IllegalStateException(format("missing expression for alias %s", alias)));
  }
  ...
  public static class Builder {
    ...
    public Builder put(String alias, SymbolReference symbolReference) {
      ...
      checkState(
          !bindings.containsKey(alias),
          "Alias '%s' already bound to expression '%s'. Tried to rebind to '%s'",
          alias,
          bindings.get(alias),
          symbolReference);
