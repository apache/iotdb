...
public final class DataNodeQueryMessages {
  ...
  public static final String INVALID_AGGREGATION_TYPE = "Invalid Aggregation Type: ";
  ...
  public static final String SOURCE_HANDLE_FAILED_DUE_TO = "Source handle failed due to: ";
  public static final String SINK_FAILED_DUE_TO = "Sink failed due to";
  public static final String ISINKCHANNEL_FAILED_DUE_TO = "ISinkChannel failed due to";
  public static final String SINK_HANDLE_FAILED_DUE_TO = "Sink handle failed due to";
  public static final String MPPDATAEXCHANGEMANAGER_INIT_SUCCESSFULLY =
      "MPPDataExchangeManager init successfully";
  public static final String QUEUE_HAS_BEEN_DESTROYED = "queue has been destroyed";
  public static final String SINK_HANDLE_IS_BLOCKED = "Sink handle is blocked.";
  public static final String LOCALSINKCHANNEL_IS_ABORTED = "LocalSinkChannel is ABORTED.";
  ...
  public static final String SHUFFLESINKHANDLE_IS_ABORTED = "ShuffleSinkHandle is aborted.";
  ...
  public static final String SINKCHANNEL_IS_ABORTED = "SinkChannel is aborted.";
  ...
  public static final String SOURCE_HANDLE_IS_BLOCKED = "Source handle is blocked.";
  public static final String RESERVED_DATA_BLOCK_SIZE_IS_NULL = "Reserved data block size is null.";
  public static final String DATA_BLOCK_SIZE_IS_NULL = "Data block size is null.";
  public static final String SOURCE_HANDLE_IS_ABORTED = "Source handle is aborted.";
  public static final String SOURCEHANDLE_IS_CLOSED = "SourceHandle is closed.";
  ...
  public static final String WAIT_MS_FOR_ALL_DRIVERS_CLOSED = "Wait {}ms for all Drivers closed";
  ...
  public static final String EXECUTE_ERROR_CAUSED_BY = "Execute error caused by ";
  ...
  public static final String UNKNOWN_DATA_TYPE_2 = "Unknown data type ";
  ...
  public static final String FAILED_TO_CREATE_DIRECTORIES = "Failed to create directories: ";
  public static final String TARGET_FILE_ALREADY_EXISTS = "Target file already exists: ";
  ...
  public static final String ERROR_WHILE_SCANNING_THE_FILE = "Error while scanning the file";
  ...
  public static final String NO_MORE_BATCH_DATA = "No more batch data";
  ...
  public static final String UNSUPPORTED_COLUMN_TYPE = "Unsupported column type: ";
  public static final String FAIL_TO_CLOSE_CTEDATAREADER = "Fail to close CteDataReader";
  ...
  public static final String DRIVERTASK_SHOULD_NEVER_BE_NULL = "DriverTask should never be null";
  ...
  public static final String CLEAR_DRIVERTASK_FAILED = "Clear DriverTask failed";

  // --- Execution / Warnings ---

  public static final String CODE_IS_NEGATIVE = "code is negative";

  // --- Metric ---

  public static final String UNSUPPORTED_STAGE_IN_TREE_MODEL = "Unsupported stage in tree model: ";
  ...
  public static final String COST_MS = "Cost: {} ms, {}";

  // --- Plan / Analyze ---

  public static final String COMPUTEDATAPARTITIONPARAMS_FOR = "computeDataPartitionParams for ";
  ...
  public static final String UNSUPPORTED_WINDOW_TYPE = "Unsupported window type";
  ...
  public static final String NO_RUNNING_DATANODES = "no Running DataNodes";
  ...
  public static final String SHOULDN_T_ATTACH_HERE = "shouldn't attach here";
  public static final String SELECT_INTO_THE_I_OF_SHOULD_BE_AN =
      "select into: the i of ${i} should be an integer.";
  public static final String FAILED_TO_GET_DATABASE_MAP = "Failed to get database Map";
  ...
  public static final String TSFILE_IS_EMPTY = "TsFile {} is empty.";
  ...
  public static final String REACHMAXRETRYCOUNT = "[ReachMaxRetryCount]";
  public static final String ERROR_WHEN_EXECUTING_QUERY = "error when executing query. {}";
  public static final String WAITBEFORERETRY_WAIT_MS = "[WaitBeforeRetry] wait {}ms.";
  public static final String INTERRUPTED_WHEN_WAITING_RETRY = "interrupted when waiting retry";
  public static final String RETRY_RETRY_COUNT_IS = "[Retry] retry count is: {}";
  public static final String RESULTHANDLEABORTED = "[ResultHandleAborted]";
  ...
  public static final String DUPLICATED_PROPERTY = "Duplicated property: ";
  public static final String TABLE_PROPERTY = "Table property '";
  ...
  public static final String FAILED_TO_DROP_FUNCTION = "[{}] Failed to drop function {}.";
  public static final String FAILED_TO_DROP_TRIGGER = "[{}] Failed to drop trigger {}.";
  public static final String CANNOT_REMOVE_INVALID_NODEIDS = "Cannot remove invalid nodeIds:{}";
  ...
  public static final String SUBMIT_REMOVE_DATANODES_RESULT = "Submit Remove DataNodes result {} ";
  public static final String STARTING_TO_REMOVE_CONFIGNODE_WITH_NODE_ID =
      "Starting to remove ConfigNode with node-id {}";
  public static final String CONFIGNODE_IS_REMOVED = "ConfigNode: {} is removed.";
  public static final String STARTING_TO_REMOVE_AINODE = "Starting to remove AINode";
  ...
  public static final String AINODE_IN_THE_CLUSTER_IS_REMOVED = "AINode in the cluster is removed.";
  ...
  public static final String NOT_SUPPORT_CURRENT_STATEMENT = "Not support current statement";
  public static final String WRONG_REQUEST_TYPE = "Wrong request type";
  public static final String WRONG_UNIT_TYPE = "Wrong unit type";

  // --- Plan / Expression ---

  public static final String INVALID_EXPRESSION_TYPE = "Invalid expression type: ";
  public static final String UNSUPPORTED_EXPRESSION_TYPE = "Unsupported expression type: ";
  ...
  public static final String PLEASE_ENSURE_INPUT_IS_CORRECT = "please ensure input[%s] is correct";
  ...
  public static final String IS_NULL_CANNOT_BE_PUSHED_DOWN = "IS NULL cannot be pushed down";
  ...
  public static final String IS_NULL_CAN_BE_PUSHED_DOWN = "IS NULL can be pushed down";
  public static final String GROUP_BY_TIME_CANNOT_BE_REVERSED = "GROUP BY TIME cannot be reversed";

  // --- Plan / Optimization ---

  public static final String UNEXPECTED_PLAN_NODE = "Unexpected plan node: ";
  public static final String UNEXPECTED_PATH_TYPE = "unexpected path type";
  ...
  public static final String DATATYPE_MUST_BE_DECLARED = "datatype must be declared";
  public static final String UNSUPPORTED_ENCODING = "Unsupported encoding: %s";
  public static final String UNSUPPORTED_COMPRESSION = "Unsupported compression: %s";
  public static final String UNSUPPORTED_ENCODING_2 = "unsupported encoding: %s";
  public static final String UNSUPPORTED_COMPRESSOR = "unsupported compressor: %s";
  ...
  public static final String UNSUPPORTED_COMPRESSOR_2 = "Unsupported compressor: %s";
  public static final String PROPERTY_IS_UNSUPPORTED_YET = "property %s is unsupported yet.";
  public static final String THE_TIMESERIES_SHALL_NOT_BE_ROOT = "The timeSeries shall not be root.";
  public static final String UNSUPPORTED_DATATYPE = "unsupported datatype: %s";
  public static final String UNEXPECTED_FILTER_KEY = "unexpected filter key";
  ...
  public static final String RENAMING_VIEW_IS_NOT_SUPPORTED = "Renaming view is not supported.";
  public static final String VIEW_DOESN_T_SUPPORT_ALIAS = "View doesn't support alias.";
  public static final String MODELID_SHOULD_BE_2_64_CHARACTERS =
      "ModelId should be 2-64 characters";
  public static final String MODELID_SHOULD_NOT_START_WITH = "ModelId should not start with '_'";
  ...
  public static final String DUPLICATED_GROUP_BY_KEY_LEVEL = "duplicated group by key: LEVEL";
  public static final String DUPLICATED_GROUP_BY_KEY_TAGS = "duplicated group by key: TAGS";
  public static final String UNKNOWN_GROUP_BY_TYPE = "Unknown GROUP BY type.";
  public static final String DUPLICATE_ALIAS_IN_SELECT_CLAUSE = "duplicate alias in select clause";
  public static final String CONSTANT_OPERAND_IS_NOT_ALLOWED = "Constant operand is not allowed: ";
  ...
  public static final String DUPLICATED_KEY_IN_GROUP_BY_TAGS = "duplicated key in GROUP BY TAGS: ";
  public static final String UNKNOWN_FILL_TYPE = "Unknown FILL type.";
  ...
  public static final String CAN_NOT_PARSE_TO_TIME = "Can not parse %s to time";
  public static final String PATH_CAN_NOT_START_WITH_ROOT_IN_SELECT =
      "Path can not start with root in select clause.";
  public static final String INPUT_TIMESTAMP_CANNOT_BE_EMPTY = "input timestamp cannot be empty";
  ...
  public static final String STATEMENT_NEEDS_TARGET_PATHS = "Statement needs target paths";
  ...
  public static final String UNSUPPORTED_CONSTANT_VALUE = "Unsupported constant value: ";
  public static final String UNSUPPORTED_CONSTANT_OPERAND = "Unsupported constant operand: ";
  ...
  public static final String EXPECTING_DATATYPE = "Expecting datatype";
  ...
  public static final String WRONG_SPACE_QUOTA_TYPE = "Wrong space quota type: ";
  ...
  public static final String ALIGN_DESIGNATION_INCORRECT_AT = "Align designation incorrect at: ";

  // --- Plan / Relational / Analyzer ---

  public static final String COLUMN_NOT_IN_GROUP_BY_CLAUSE = "Column %s not in GROUP BY clause";
  ...
  public static final String UNEXPECTED_NAVIGATION_ANCHOR = "Unexpected navigation anchor: ";
  public static final String UNEXPECTED_MODE = "Unexpected mode: ";
  public static final String QUERY_TAKES_NO_PARAMETERS = "Query takes no parameters";
  public static final String NO_VALUE_PROVIDED_FOR_PARAMETER = "No value provided for parameter";
  public static final String CANNOT_EXTRACT_FROM = "Cannot extract from %s";
  public static final String UNKNOWN_IS_NOT_A_VALID_TYPE = "UNKNOWN is not a valid type";
  ...
  public static final String UNSUPPORTED_FRAME_TYPE = "Unsupported frame type: ";
  ...
  public static final String TYPE_MISMATCH_FMT = "%s: %s vs %s";
  public static final String UNKNOWN_PATTERN_RECOGNITION_FUNCTION =
      "Unknown pattern recognition function: ";
  public static final String CANNOT_ACCESS_PREANALYZED_TYPES = "Cannot access preanalyzed types";
  public static final String CANNOT_ACCESS_RESOLVED_WINDOWS = "Cannot access resolved windows";
  public static final String REFERENCE_IS_AMBIGUOUS = "Reference '%s' is ambiguous";
  public static final String COLUMN_IS_AMBIGUOUS = "Column '%s' is ambiguous";
  ...
  public static final String TIME_COLUMN_CAN_NOT_BE_NULL = "time column can not be null";
  public static final String NO_FIELD_COLUMN_PRESENT = "No Field column present";
  ...
  public static final String NESTED_RECURSIVE_WITH_QUERY = "nested recursive WITH query";
  public static final String THERE_IS_AT_LEAST_ONE_RESULT_OF_EXPANDED =
      "There is at least one result of expanded";
  public static final String UNSUPPORTED_EXPRESSION_2 = "UnSupported Expression: ";
  ...
  public static final String UNKNOWN_COLUMNNAME = "Unknown ColumnName: ";
  public static final String INVALID_REGEX = "Invalid regex '%s'";
  ...
  public static final String COLUMN_ALIASES_NOT_SUPPORTED = "Column aliases not supported";
  ...
  public static final String NATURAL_JOIN_NOT_SUPPORTED = "Natural join not supported";
  public static final String UNKNOWN_FILL_METHOD = "Unknown fill method: ";
  public static final String RECURSIVE_REFERENCE_IN_INTERSECT_ALL =
      "recursive reference in INTERSECT ALL";
  public static final String TABLE_PROPERTY_2 = "Table property ";
  public static final String THE_DATABASE_MUST_BE_SET = "The database must be set.";
  ...
  public static final String DUPLICATE_ARGUMENT_NAME = "Duplicate argument name: %s";
  ...
  public static final String TIMESTAMP_DOES_NOT_SUPPORT_LIKE = "TIMESTAMP does not support LIKE";
  public static final String TIMESTAMP_DOES_NOT_CASE_WHEN = "TIMESTAMP does not CASE WHEN";
  public static final String TIMESTAMP_DOES_NOT_IF = "TIMESTAMP does not IF";
  public static final String TIMESTAMP_DOES_NOT_NULLIF = "TIMESTAMP does not NULLIF";
  public static final String SHOULD_NEVER_RETURN_NULL = "Should never return null.";
  ...
  public static final String UNSUPPORTED_OPERATOR_2 = "Unsupported operator ";
  ...
  public static final String INVALID_FUNCTION_PARAMETERS = "Invalid function parameters: ";
  ...
  public static final String AUTO_ADD_TABLE_COLUMN_FAILED = "Auto add table column failed.";
  ...
  public static final String NO_TABLE_SCHEMA_FOUND_IN_TSFILES = "No table schema found in TsFiles";
  ...
  public static final String MISSING_SCALAR_ARGUMENT = "Missing scalar argument: ";
  public static final String ARGUMENT_SHOULD_NOT_BE_EMPTY = "Argument %s should not be empty";
  public static final String INVALID_SCALAR_ARGUMENT = "Invalid scalar argument: ";
  public static final String ARGUMENT_SHOULD_BE_A_STRING = "Argument %s should be a string";
  public static final String ARGUMENT_SHOULD_BE_A_NUMBER = "Argument %s should be a number";
  ...
  public static final String TSFILE_PATH_DOES_NOT_EXIST = "TsFile path does not exist: ";
  public static final String TSFILE_PATH_IS_NEITHER_A_FILE_NOR_A_DIRECTORY =
      "TsFile path is neither a file nor a directory: ";
  public static final String NO_VALID_TSFILES_FOUND = "No valid TsFiles found";
  public static final String FAILED_TO_SCAN_TSFILE_PATH = "Failed to scan TsFile path: ";
  ...
  public static final String FILE_IS_NOT_A_VALID_TSFILE = "File is not a valid TsFile: ";
  ...
  public static final String FAIL_TO_MATERIALIZE_CTE_BECAUSE = "Fail to materialize CTE because {}";
  ...
  public static final String CANNOT_COERCE_TYPE = "Cannot coerce type ";
  public static final String UNKNOWN_TYPE_2 = "Unknown type: ";
  public static final String NODE_MUST_BE_A_LITERAL = "node must be a Literal";
  public static final String UNHANDLED_LITERAL_TYPE = "Unhandled literal type: ";
  public static final String NO_LITERAL_FORM_FOR_TYPE = "No literal form for type %s";
  ...
  public static final String FROM_CLAUSE_MUST_NOT_BE_EMPTY = "From clause must not be empty";
  public static final String COERCION_RESULT_IN_ANALYSIS_ONLY_CAN_BE_EMPTY =
      "Coercion result in analysis only can be empty";
  public static final String UNEXPECTED_RECURSIVE_CTE = "unexpected recursive cte";
  public static final String TABLE = "Table ";
  public static final String UNEXPECTED_JOIN_TYPE = "Unexpected Join Type: ";
  public static final String UNEXPECTED_ROWS_PER_MATCH = "Unexpected rows per match: ";
  ...
  public static final String FAILED_TO_FETCH_SUBQUERY_RESULT = "Failed to Fetch Subquery Result.";

  // --- Plan / Relational / Planner / Iterative ---

  public static final String UNEXPECTED_PATTERN = "Unexpected Pattern: ";
  ...
  public static final String TABLE_2 = "TABLE ";
  public static final String UNEXPECTED_VALUE_2 = "Unexpected value:";
  public static final String EACH_OPERATION_SHOULD_HAVE_PERMISSION_CHECK =
      "Each operation should have permission check.";
  public static final String UNKNOWN_AUTHORTYPE = "Unknown authorType: ";

  // --- Plan / Relational / SQL ---

  public static final String UNKNOWN_AUTHORTYPE_2 = "Unknown authorType:";
  ...
  public static final String UNEXPECTED_EXPRESSION_2 = "unexpected expression: ";
  ...
  public static final String MISSING_LIMIT_VALUE = "Missing LIMIT value";
  public static final String DATABASE_IS_NOT_SET_YET = "Database is not set yet.";
  public static final String AUTHOR_STATEMENT_PARSER_ERROR = "author statement parser error";
  public static final String UNSUPPORTED_SET_OPERATION = "Unsupported set operation: ";
  public static final String UNSUPPORTED_JOIN_CRITERIA = "Unsupported join criteria";
  ...
  public static final String UNSUPPORTED_SIGN = "Unsupported sign: ";
  public static final String UNSUPPORTED_WINDOW_FRAME_TYPE = "Unsupported window frame type: ";
  public static final String UNSUPPORTED_BOUNDED_TYPE = "Unsupported bounded type: ";
  public static final String UNSUPPORTED_TRIM_SPECIFICATION = "Unsupported trim specification: ";
  ...
  public static final String UNSUPPORTED_SPECIAL_FUNCTION = "Unsupported special function: ";
  public static final String UNSUPPORTED_ORDERING = "Unsupported ordering: ";
  public static final String UNSUPPORTED_QUANTIFIER = "Unsupported quantifier: ";
  public static final String NOT_YET_IMPLEMENTED_WILDCARD_TRANSITION =
      "not yet implemented: wildcard transition";
  public static final String UNKNOWN_TABLE_ELEMENT = "unknown table element: ";
  ...
  public static final String CAN_T_CONNECT_TO_NODE = "can't connect to node {}";
  public static final String CANCEL_QUERY_ON_NODE_FAILED = "cancel query {} on node {} failed.";
  public static final String CANNOT_DISPATCH_FI_FOR_LOAD_OPERATION =
      "cannot dispatch FI for load operation";
  public static final String MESSAGE_UNEXPECTED_ERRORS_ARG_78EE0800 = "Unexpected errors: %s";
  public static final String RECEIVE_LOAD_NODE_FROM_UUID = "Receive load node from uuid {}.";
  public static final String LOAD_TSFILE_NODE_ERROR = "Load TsFile Node {} error.";
  public static final String SERIALIZE_TSFILERESOURCE_ERROR = "Serialize TsFileResource {} error.";
  ...
  public static final String INTERRUPT_OR_EXECUTION_ERROR = "Interrupt or Execution error.";
  ...
  public static final String START_LOAD_TSFILE_LOCALLY = "Start load TsFile {} locally.";
  ...
  public static final String UNKNOWN_LITERAL_TYPE = "Unknown literal type: %s";
  ...
  public static final String IS_NOT_A_LEGAL_PATH = "{} is not a legal path";
  ...
  public static final String MISSING_TIME_CATEGORY_COLUMN = "Missing TIME category column";
  public static final String UNKNOWN_SQL_DIALECT = "Unknown sql dialect: %s";
  public static final String UNEXPECTED_PATH_TYPE_2 = "Unexpected path type";
  ...
  public static final String UNKNOWN_FILL_POLICY = "Unknown fill policy: ";
  ...
  public static final String UNKNOWN_NODE_TYPE = "Unknown node type: ";
  public static final String UNSUPPORTED_COLUMN_GENERATOR_TYPE =
      "Unsupported column generator type: ";
  public static final String ROOT_NODE_MUST_RETURN_ONLY_ONE = "root node must return only one";
  public static final String SINGLEDEVICEVIEWNODE_HAVE_ONLY_ONE_CHILD =
      "SingleDeviceViewNode have only one child";
  public static final String AVAILABLE_REPLICAS = "available replicas: {}";
  ...
  public static final String INVALID_NODE_TYPE = "Invalid node type: ";
  ...
  public static final String SERIALIZE_TO_BYTEBUFFER_ERROR = "Serialize to ByteBuffer error.";
  public static final String SPLIT_LOAD_PIECE_TSFILE_IS_NOT_IMPLEMENTED =
      "split load piece TsFile is not implemented";
  public static final String DESERIALIZE_ERROR = "Deserialize {} error.";
  public static final String INVALID_LENGTH_FOR_SLICING = "Invalid length for slicing: ";
  ...
  public static final String UNEXPECTED_DESCRIPTORTYPE = "Unexpected descriptorType: ";
  ...
  public static final String CANNOT_DESERIALIZE_INSERTROWNODE = "Cannot deserialize InsertRowNode";
  ...
  public static final String DELETEDATANODES_IS_EMPTY = "deleteDataNodes is empty";
  ...
  public static final String MERGE_IS_NOT_SUPPORTED = "Merge is not supported";
  ...
  public static final String INVALID_AGGREGATIONSTEP_TYPE = "Invalid AggregationStep type: ";

  // --- Transformation ---

  public static final String SIZE_IS_0 = "Size is 0";
  public static final String CAN_NOT_CALL_NEXT_ON_EMPTYROWITERATOR =
      "Can not call next on EmptyRowIterator";
  public static final String THE_EXPRESSION_CANNOT_BE_NULL = "The expression cannot be null";
  public static final String UNSUPPORTED_TYPE = "Unsupported type: ";
  public static final String UNSUPPORTED_DATA_TYPE_2 = "Unsupported data type: ";
  public static final String UNSUPPORTED_DATA_TYPE_3 = "unsupported data type: ";
  ...
  public static final String ACK_TSBLOCK_FAILED = "ack TsBlock [{}, {}) failed.";
  public static final String CLOSE_CHANNEL_OF_SHUFFLESINKHANDLE_FAILED =
      "Close channel of ShuffleSinkHandle {}, index {} failed.";
  public static final String SHUFFLESINKHANDLE_ALREADY_IN_MAP = "ShuffleSinkHandle for ";
  public static final String IS_IN_THE_MAP = " is in the map.";
  ...
  public static final String LOCAL_SINK_CHANNEL_STATE_IS = "LocalSinkChannel state is .";
  public static final String SCH_LISTENER_ON_FINISH = "[ScHListenerOnFinish]";
  public static final String SCH_LISTENER_ALREADY_RELEASED = "[ScHListenerAlreadyReleased]";
  public static final String SCH_LISTENER_ON_ABORT = "[ScHListenerOnAbort]";
  ...
  public static final String SKH_LISTENER_ON_FINISH = "[SkHListenerOnFinish]";
  public static final String SKH_LISTENER_ON_END_OF_TSBLOCKS = "[SkHListenerOnEndOfTsBlocks]";
  public static final String SKH_LISTENER_ON_ABORT = "[SkHListenerOnAbort]";
  public static final String CLOSE_SHUFFLE_SINK_HANDLE = "Close ShuffleSinkHandle: {}";
  ...
  public static final String CREATE_SHARED_TSBLOCK_QUEUE = "Create SharedTsBlockQueue";
  public static final String CREATE_LOCAL_SINK_HANDLE_FOR = "Create local sink handle for {}";
  public static final String CREATE_LOCAL_SOURCE_HANDLE_FOR = "Create local source handle for {}";
  ...
  public static final String CLOSE_SOURCE_HANDLE = "[CloseSourceHandle] {}";
  ...
  public static final String GET_SERIALIZED_TSBLOCK = "[GetSerializedTsBlock] TsBlock:{}";
  public static final String START_ABORT_LOCAL_SOURCE_HANDLE = "[StartAbortLocalSourceHandle]";
  public static final String END_ABORT_LOCAL_SOURCE_HANDLE = "[EndAbortLocalSourceHandle]";
  public static final String START_CLOSE_LOCAL_SOURCE_HANDLE = "[StartCloseLocalSourceHandle]";
  public static final String END_CLOSE_LOCAL_SOURCE_HANDLE = "[EndCloseLocalSourceHandle]";
  public static final String START_SET_NO_MORE_TSBLOCKS = "[StartSetNoMoreTsBlocks]";
  public static final String START_ABORT_SINK_CHANNEL = "[StartAbortSinkChannel]";
  public static final String END_ABORT_SINK_CHANNEL = "[EndAbortSinkChannel]";
  public static final String START_CLOSE_SINK_CHANNEL = "[StartCloseSinkChannel]";
  public static final String END_CLOSE_SINK_CHANNEL = "[EndCloseSinkChannel]";
  public static final String ACK_TSBLOCK = "[ACKTsBlock] {}.";
  public static final String NOTIFY_NO_MORE_TSBLOCK = "[NotifyNoMoreTsBlock]";
  public static final String START_SEND_TSBLOCK_ON_LOCAL = "[StartSendTsBlockOnLocal]";
  public static final String START_SET_NO_MORE_TSBLOCKS_ON_LOCAL =
      "[StartSetNoMoreTsBlocksOnLocal]";
  public static final String END_SET_NO_MORE_TSBLOCKS_ON_LOCAL = "[EndSetNoMoreTsBlocksOnLocal]";
  public static final String START_ABORT_LOCAL_SINK_CHANNEL = "[StartAbortLocalSinkChannel]";
  public static final String END_ABORT_LOCAL_SINK_CHANNEL = "[EndAbortLocalSinkChannel]";
  public static final String START_CLOSE_LOCAL_SINK_CHANNEL = "[StartCloseLocalSinkChannel]";
  public static final String END_CLOSE_LOCAL_SINK_CHANNEL = "[EndCloseLocalSinkChannel]";
  public static final String GET_TSBLOCK_FROM_BUFFER =
      "[GetTsBlockFromBuffer] sequenceId:{}, size:{}";
  public static final String WAIT_FOR_MORE_TSBLOCK = "[WaitForMoreTsBlock]";
  public static final String RECEIVE_NO_MORE_TSBLOCK_EVENT = "[ReceiveNoMoreTsBlockEvent]";
  public static final String END_PULL_TSBLOCKS_FROM_REMOTE = "[EndPullTsBlocksFromRemote] Count:{}";
  public static final String PUT_TSBLOCKS_INTO_BUFFER = "[PutTsBlocksIntoBuffer]";
  public static final String SEND_ACK_TSBLOCK = "[SendACKTsBlock] [{}, {}).";
  public static final String START_ABORT_SHUFFLE_SINK_HANDLE = "[StartAbortShuffleSinkHandle]";
  public static final String END_ABORT_SHUFFLE_SINK_HANDLE = "[EndAbortShuffleSinkHandle]";
  public static final String START_CLOSE_SHUFFLE_SINK_HANDLE = "[StartCloseShuffleSinkHandle]";
  public static final String END_CLOSE_SHUFFLE_SINK_HANDLE = "[EndCloseShuffleSinkHandle]";
  public static final String SIGNAL_NO_MORE_TSBLOCK_ON_QUEUE = "[SignalNoMoreTsBlockOnQueue]";
  ...
  public static final String ADD_TSBLOCK = "[addTsBlock] TsBlock:{}";

  // --- Plan (additional debug) ---

  public static final String QUERY_START_SQL = "[QueryStart] sql: {}";
  public static final String CLEAN_UP_QUERY = "[CleanUpQuery]]";
  public static final String RELEASE_QUERY_RESOURCE_STATE = "[ReleaseQueryResource] state is: {}";
  public static final String SKIP_EXECUTE = "[SkipExecute]";
  public static final String SKIP_EXECUTE_AFTER_LOGICAL_PLAN = "[SkipExecute After LogicalPlan]";
  public static final String RESULT_HANDLE_FINISHED = "[ResultHandleFinished]";
  ...
  public static final String DEVICES_ARE_MISSING = "{} devices are missing";

  // --- Execution / Fragment (additional debug) ---

  public static final String STATE_CHANGED_TO = "[StateChanged] To {}";
  public static final String ENTER_THE_STATE_CHANGE_LISTENER = "Enter the stateChangeListener";
  ...
  public static final String ERROR_WHEN_READ_OBJECT_FILE = "Error when read object file {}.";

  // --- Additional Edge Cases ---

  public static final String JOIN_TYPE_IS_NOT_SUPPORTED = " Join type is not supported";
  public static final String COLON_S_VS_S = ": %s vs %s";
  ...
  public static final String SHOULD_HAVE_TWO_NUMERIC_OPERANDS = "Should have two numeric operands.";
  public static final String SHOULD_HAVE_ONE_NUMERIC_OPERANDS = "Should have one numeric operands.";
  ...
  public static final String NO_MAPPING_FOR_S = "No mapping for %s";
  public static final String CANCEL_STATE_TRACKING_TASK_FAILED =
      "cancel state tracking task failed. {}";
  public static final String TRACK_TASK_NOT_STARTED = "trackTask not started";
  public static final String PRINT_FI_STATE = "[PrintFIState] state is {}";
  ...
  public static final String PARTITION_CACHE_INVALID = "[Partition Cache] invalid";
  public static final String PARTITION_CACHE_IS_INVALID = "[Partition Cache] is invalid:{}";
  ...
  public static final String REMOVE_CONFIG_NODE_FAILED = "Remove ConfigNode failed: ";
  ...
  public static final String QUERY_TIMEOUT_IN_FETCH_SCHEMA =
      "Query execution is time out while fetching schema";

  public static final String QUERY_EXECUTION_MISSING =
      "Query execution %s is missing during fetching device schema";
  ...
  public static final String DATA_TYPE_OF_TAG_COLUMN = "Data type of tag column ";
  public static final String IS_NOT_STRING = " is not STRING";
  ...
  public static final String UNSUPPORTED_COMPRESSION_S = "unsupported compression: %s";
  public static final String
  ...
  public static final String FAILED_TO_PARSE_THE_TIMESTAMP = "Failed to parse the timestamp: ";
  ...
  public static final String INPUT_TIME_FORMAT_S_ERROR = "Input time format %s error. ";
  ...
  public static final String PRIVILEGE_TYPE = "Privilege type ";
  public static final String IS_DEPRECATED_USE = " is deprecated, use ";
  public static final String TO_INSTEAD_IT = " to instead it";
  ...
  public static final String CAN_NOT_PARSE_S_TO_LONG_VALUE = "Can not parse %s to long value";
  ...
  public static final String START_TIME_D_IS_GREATER_THAN_END_TIME_D =
      "Start time %d is greater than end time %d";
  public static final String THE_COLUMN = "The column '";
  ...
  public static final String S_IS_NOT_A_LEGAL_PROP = "%s is not a legal prop.";
  public static final String
  ...
  public static final String INPUT_OF_S_IS_ILLEGAL = "Input of '%s' is illegal.";
  ...
  public static final String IS_CURRENTLY_NOT_ALLOWED = "' is currently not allowed.";
  ...
  public static final String VALUE_MUST_BE_LOWER_THAN = " value must be lower than ";
  public static final String BUT_NOW_IS = ", but now is: ";
  ...
  public static final String THE_TABLE = "The table ";
  ...
  public static final String THE_PARAMETERS = "The parameters '";
  public static final String
  ...
  public static final String IS_UNSUPPORTED_YET = ") is unsupported yet.";
  ...
  public static final String UNEXPECTED_DESCRIPTOR_TYPE = "Unexpected descriptor type: ";
  ...
  public static final String SCALAR_FUNCTION = "Scalar function ";
  public static final String
  ...
  public static final String ACCEPTS_NO_ARGUMENT = " accepts no argument.";
  public static final String
  ...
  public static final String CANNOT_BE_RESOLVED = "cannot be resolved";
  ...
  public static final String CANNOT_RESOLVE_WINDOW_NAME_S = "Cannot resolve WINDOW name %s";
  public static final String
  ...
  public static final String S_ARE_NOT_SUPPORTED_NOW = "%s are not supported now";
  public static final String UNABLE_TO_RESOLVE_REFERENCE_S = "Unable to resolve reference %s";
  public static final String
  ...
  public static final String IS_CURRENTLY_NOT_ALLOWED_2 = " is currently not allowed.";
  public static final String DUPLICATE_PROPERTY_S = "Duplicate property: %s";
  ...
  public static final String UNEXPECTED_ARGUMENT_NAME_S = "Unexpected argument name: %s";
  ...
  public static final String INVALID_SCALAR_ARGUMENT_S_S = "Invalid scalar argument %s, %s";
  public static final String MISSING_REQUIRED_ARGUMENT_S = "Missing required argument: %s";
  ...
  public static final String COLUMN_S_CANNOT_BE_RESOLVED = "Column '%s' cannot be resolved";
  ...
  public static final String EXPRESSION_S_IS_NOT_OF_TYPE_ROW = "Expression %s is not of type ROW";
  public static final String AMBIGUOUS_ROW_FIELD_REFERENCE_S = "Ambiguous row field reference: %s";
  ...
  public static final String NOT_YET_IMPLEMENTED_S = "not yet implemented: %s";
  ...
  public static final String COLUMNS_SIZE = ", columns size: ";
  ...
  public static final String DOES_NOT_EXISTS_OR_FAILS_TO_BE = " does not exists or fails to be ";
  ...
  public static final String WRONG_CATEGORY_AT_COLUMN_S = "Wrong category at column %s.";
  public static final String MISSING_COLUMNS_S = "Missing columns %s.";
  ...
  public static final String STATE_TRACKER_STARTS = "state tracker starts";
  ...
  public static final String TSFILE_ARG_IS_A_ARG_MODEL_FILE = "TsFile {} is a {}-model file.";
  public static final String
  ...
  public static final String PARSE_OR_SEND_TSFILE_S_ERROR = "Parse or send TsFile %s error.";
  ...
  public static final String WAIT_FOR_LOADING_S_TIME_OUT = "Wait for loading %s time out.";
  public static final String
  ...
  public static final String RESULT_STATUS_MESSAGE_S = "Result status message %s.";
  ...
  public static final String RULE_S_BEFORE_S_AFTER_S = "Rule: {}\nBefore:\n{}\nAfter:\n{}";
  ...
  public static final String LOAD_FILE_CROSSES_PARTITIONS = "The data of file crosses partitions";
  ...
  public static final String ALL_REPLICA_CANNOT_BE_REACHED_FMT = "All replica cannot be reached:%s";
  ...
  public static final String EXCEPTION_EXPECTEDPARTS_MUST_BE_AT_LEAST_1_B867DB08 =
      "expectedParts must be at least 1";
  ...
  public static final String EXCEPTION_FRAGMENT_INSTANCE_ID_CANNOT_BE_NULL_4BE84F40 =
      "fragment instance ID cannot be null";
  public static final String EXCEPTION_PLANNODE_ID_CANNOT_BE_NULL_F91303CD =
      "PlanNode ID cannot be null";
  public static final String EXCEPTION_LOCAL_MEMORY_MANAGER_CANNOT_BE_NULL_54701481 =
      "local memory manager cannot be null";
  public static final String EXCEPTION_EXECUTORSERVICE_CAN_NOT_BE_NULL_DOT_220C966B =
      "ExecutorService can not be null.";
  ...
  public static final String EXCEPTION_FRAGMENTINSTANCEID_CANNOT_BE_NULL_C722F460 =
      "fragmentInstanceId cannot be null";
  public static final String EXCEPTION_PLANNODEID_CANNOT_BE_NULL_4533C72B =
      "planNodeId cannot be null";
  ...
  public static final String EXCEPTION_FRAGMENTINSTANCEID_IS_NULL_4D371DB4 =
      "fragmentInstanceId is null";
  public static final String EXCEPTION_CURRENT_STATE_IS_ALREADY_DONE_19FC56DC =
      "Current state is already done";
  ...
  public static final String
      EXCEPTION_LASTVALUESCACHERESULTS_SHOULDN_QUOTE_T_BE_NULL_HERE_0DCD5841 =
          "lastValuesCacheResults shouldn't be null here";
  public static final String
  ...
  public static final String EXCEPTION_DRIVERTASK_TO_BE_PUSHED_IS_NULL_7581A0E3 =
      "DriverTask to be pushed is null";
  ...
  public static final String EXCEPTION_MPP_DATA_EXCHANGE_MANAGER_SHOULD_NOT_BE_NULL_44D7141E =
      "MPP_DATA_EXCHANGE_MANAGER should not be null";
  ...
  public static final String EXCEPTION_QUERY_CONTEXT_CANNOT_BE_NULL_C4809234 =
      "Query context cannot be null";
  ...
  public static final String EXCEPTION_GROUPBYTAG_TAG_KEYS_CANNOT_BE_EMPTY_5D649624 =
      "GroupByTag tag keys cannot be empty";
  ...
  public static final String EXCEPTION_PUSH_DOWN_PREDICATE_IS_NOT_SUPPORTED_YET_178F04A1 =
      "Push down predicate is not supported yet";
  ...
  public static final String EXCEPTION_THERE_MUST_BE_AT_MOST_ONE_SINKNODE_A965AFE7 =
      "There must be at most one SinkNode";
  public static final String EXCEPTION_QUERY_CONTEXT_CANNOT_BE_NULL_DOT_2D3369FE =
      "Query context cannot be null.";
  public static final String EXCEPTION_UNEXPECTED_NODE_TYPE_COLON_41FBCBF3 =
      "Unexpected node type: ";
  public static final String EXCEPTION_TEMPLATEDINFO_SHOULD_NOT_BE_NULL_B5898568 =
      "TemplatedInfo should not be null";
  public static final String
      EXCEPTION_RESULTHANDLE_IN_COORDINATOR_SHOULD_BE_INIT_FIRSTLY_DOT_0F44159B =
          "ResultHandle in Coordinator should be init firstly.";
  public static final String EXCEPTION_EXPRESSION_IS_NOT_ANALYZED_COLON_ARG_7D34C49A =
      "Expression is not analyzed: %s";
  public static final String
      EXCEPTION_PATH_QUOTE_ARG_QUOTE_IS_NOT_ANALYZED_IN_GROUPBYLEVELHELPER_DOT_BCEE9D39 =
          "path '%s' is not analyzed in GroupByLevelHelper.";
  ...
  public static final String
      EXCEPTION_NO_TYPE_FOUND_FOR_SYMBOL_QUOTE_ARG_QUOTE_IN_TYPEPROVIDER_F4DD9DF7 =
          "no type found for symbol '%s' in TypeProvider";
  public static final String EXCEPTION_OUTPUT_COLUMN_QUOTE_ARG_QUOTE_IS_NOT_STORED_IN_ARG_2DE3176D =
      "output column '%s' is not stored in %s";
  public static final String EXCEPTION_PATTERNSTRING_CANNOT_BE_NULL_8A2903F8 =
      "patternString cannot be null";
  public static final String
      EXCEPTION_THE_LENGTH_OF_CASEWHENTHENEXPRESSION_QUOTE_S_WHENTHENLIST_MUST_GREATER_THAN_0_069775ED =
          "the length of CaseWhenThenExpression's whenThenList must greater than 0";
  ...
  public static final String
      EXCEPTION_PREDICATE_LEFT_BRACKET_ARG_RIGHT_BRACKET_SHOULD_BE_SIMPLIFIED_IN_PREVIOUS_STEP_9262C154 =
          "Predicate [%s] should be simplified in previous step";
  ...
  public static final String
      EXCEPTION_THE_TSBLOCK_SHOULD_NOT_BE_NULL_WHEN_CONSTRUCTING_MEMORYSOURCEHANDLE_8D205293 =
          "the TsBlock should not be null when constructing MemorySourceHandle";
  public static final String EXCEPTION_THE_TIME_ORDER_IS_NOT_SPECIFIED_DOT_624A7526 =
      "The time order is not specified.";
  public static final String EXCEPTION_THE_TIMESERIES_ORDER_IS_NOT_SPECIFIED_DOT_68EE3875 =
      "The timeseries order is not specified.";
  public static final String EXCEPTION_THE_DEVICE_ORDER_IS_NOT_SPECIFIED_DOT_D3FB9559 =
      "The device order is not specified.";
  ...
  public static final String
      EXCEPTION_INFORMATIONSCHEMATABLESCANNODE_MUST_HAVE_REGIONREPLICASET_0411DBCB =
          "InformationSchemaTableScanNode must have regionReplicaSet";
  public static final String
  ...
  public static final String EXCEPTION_LINES_OF_BOX_STRING_SHOULD_BE_GREATER_THAN_0_5DB8C047 =
      "Lines of box string should be greater than 0";
  ...
  public static final String EXCEPTION_OBJECTS_AND_TYPES_DO_NOT_HAVE_THE_SAME_SIZE_8B51E17B =
      "objects and types do not have the same size";
  ...
  public static final String EXCEPTION_TOO_FEW_PARAMETER_VALUES_2F7358C6 =
  ...
  public static final String
      EXCEPTION_CLUSTER_CONTAINS_EXPRESSIONS_THAT_ARE_NOT_EQUIVALENT_TO_EACH_OTHER_7AD9A0E3 =
          "Cluster contains expressions that are not equivalent to each other";
  ...
  public static final String EXCEPTION_NO_RELATIONS_SPECIFIED_FOR_UNION_70CE42C4 =
  ...
  public static final String EXCEPTION_NO_RELATIONS_SPECIFIED_FOR_EXCEPT_C8E4B4AA =
      "No relations specified for except";
  ...
  public static final String EXCEPTION_EXPRESSIONS_MUST_BE_IN_THE_SAME_LOCAL_SCOPE_CCAD793E =
      "Expressions must be in the same local scope";
  ...
  public static final String EXCEPTION_CANNOT_RESOLVE_SYMBOL_ARG_79F76FA6 =
      "Cannot resolve symbol %s";
  public static final String EXCEPTION_COLUMNREFERENCES_IS_NULL_124955C5 =
      "columnReferences is null";
  ...
  public static final String EXCEPTION_EXPRESSION_CANNOT_BE_NULL_EFF1A99C =
  ...
  public static final String EXCEPTION_SUBQUERYCOERCION_IS_NULL_33646290 =
      "subqueryCoercion is null";
  ...
  public static final String EXCEPTION_QUERY_IS_NOT_REGISTERED_AS_EXPANDABLE_FAAD8FC9 =
      "query is not registered as expandable";
  public static final String EXCEPTION_EXPRESSION_NOT_ANALYZED_COLON_ARG_D397B665 =
      "Expression not analyzed: %s";
  public static final String EXCEPTION_EXPRESSION_IS_NOT_A_COLUMN_REFERENCE_COLON_ARG_7957E705 =
      "Expression is not a column reference: %s";
  public static final String
  ...
  public static final String EXCEPTION_NO_COLUMNS_GIVEN_TO_INSERT_52C42E47 =
      "No columns given to insert";
  public static final String EXCEPTION_MISSING_FILLANALYSIS_FOR_NODE_ARG_7E5B19A4 =
      "missing FillAnalysis for node %s";
  public static final String EXCEPTION_MISSING_OFFSET_VALUE_FOR_NODE_ARG_4B107520 =
      "missing OFFSET value for node %s";
  public static final String EXCEPTION_MISSING_LIMIT_VALUE_FOR_NODE_ARG_DD5FD777 =
      "missing LIMIT value for node %s";
  public static final String EXCEPTION_MISSING_RANGE_FOR_QUANTIFIER_ARG_03461228 =
      "missing range for quantifier %s";
  public static final String EXCEPTION_MISSING_UNDEFINED_LABELS_FOR_ARG_CA615EC2 =
      "missing undefined labels for %s";
  ...
  public static final String
      EXCEPTION_FIELDINDEX_MUST_BE_NON_MINUS_NEGATIVE_COMMA_GOT_COLON_ARG_09C2C06D =
          "fieldIndex must be non-negative, got: %s";
  ...
  public static final String EXCEPTION_MATCHNUMBERCALLS_IS_NULL_EC08D0D0 =
      "matchNumberCalls is null";
  ...
  public static final String EXCEPTION_FIELD_QUOTE_ARG_QUOTE_NOT_FOUND_1BC2FDED =
      "Field '%s' not found";
  ...
  public static final String EXCEPTION_EXISTSSUBQUERIES_IS_NULL_5EA140F5 =
      "existsSubqueries is null";
  ...
  public static final String EXCEPTION_ORIGINCOLUMNNAME_IS_NULL_98607162 =
      "originColumnName is null";
  ...
  public static final String EXCEPTION_PATTERNRECOGNITIONCONTEXT_IS_NULL_59C665F1 =
      "patternRecognitionContext is null";
  ...
  public static final String
      EXCEPTION_LEXER_ATN_MISMATCH_COLON_EXPECTED_ARG_COMMA_FOUND_ARG_8ED22CF1 =
          "Lexer ATN mismatch: expected %s, found %s";
  public static final String
  ...
  public static final String EXCEPTION_SIZE_OF_COLUMNLIST_SHOULD_BE_LARGER_THAN_1_7EB80E55 =
      "size of columnList should be larger than 1";
  ...
  public static final String EXCEPTION_SUBSCRIPTION_ID_CAN_NOT_BE_NULL_0CDFFD7D =
      "subscription id can not be null";
  ...
  public static final String
      EXCEPTION_SCALAR_SUBQUERY_RESULT_SHOULD_ONLY_HAVE_ONE_COLUMN_DOT_893F76CB =
          "Scalar Subquery result should only have one column.";
  public static final String
  ...
  public static final String EXCEPTION_CORRELATEDPREDICATES_IS_NULL_5FCB8011 =
      "correlatedPredicates is null";
  public static final String EXCEPTION_GROUPING_KEYS_WERE_CORRELATED_EE1C8406 =
  ...
  public static final String EXCEPTION_CARDINALITYRANGE_IS_NULL_8FDEE0B4 =
      "cardinalityRange is null";
  ...
  public static final String EXCEPTION_SUBQUERY_RESULT_TYPE_MUST_BE_ORDERABLE_82AF0EFA =
      "Subquery result type must be orderable";
  public static final String
  ...
  public static final String EXCEPTION_CHANGEDPLANNODES_IS_NULL_5ECBDE28 =
      "changedPlanNodes is null";
  public static final String EXCEPTION_MAPPINGFUNCTION_IS_NULL_212D6109 = "mappingFunction is null";
  public static final String EXCEPTION_ROOT_NODE_MUST_RETURN_ONLY_ONE_FF42061C =
  ...
  public static final String EXCEPTION_SIZE_OF_TOPKNODE_CAN_ONLY_BE_1_IN_LOGICAL_PLAN_DOT_DB32E3C5 =
      "Size of TopKNode can only be 1 in logical plan.";
  public static final String
      EXCEPTION_THE_SIZE_OF_LEFT_CHILDREN_NODE_OF_JOINNODE_SHOULD_BE_1_F3437368 =
          "The size of left children node of JoinNode should be 1";
  public static final String
  ...
  public static final String EXCEPTION_DATE_BIN_FUNCTION_MUST_BE_THE_LAST_GROUPINGKEY_EE955FF5 =
      "date_bin function must be the last GroupingKey";
  public static final String
  ...
  public static final String EXCEPTION_EXPECTED_AGGREGATION_TO_HAVE_DISTINCT_INPUT_EC6AF059 =
      "Expected aggregation to have DISTINCT input";
  public static final String
  ...
  public static final String EXCEPTION_MISSING_TYPE_FOR_EXPRESSION_3D66D302 =
  ...
  public static final String EXCEPTION_CANNOT_SIMPLIFY_A_UNIONNODE_9D5B09A7 =
      "Cannot simplify a UnionNode";
  public static final String
  ...
  public static final String EXCEPTION_INVALID_EXPLAIN_ANALYZE_FORMAT_0879A025 =
      "Invalid EXPLAIN ANALYZE format: ";
  public static final String
  ...
  public static final String MESSAGE_FAILED_TO_RELEASE_EXTERNAL_TSFILE_QUERY_RESOURCE_712EE978 =
      "Failed to release external TsFile query resource";
  public static final String
  ...
  public static final String EXCEPTION_SINGLECOLUMNEXPRESSIONS_IS_NULL_EFB296FD =
      "singleColumnExpressions is null";
