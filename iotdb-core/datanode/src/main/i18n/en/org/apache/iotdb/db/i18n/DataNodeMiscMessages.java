...
public final class DataNodeMiscMessages {
  ...
  public static final String INVALID_PIPE_NAME = "Invalid pipeName";
  ...
  public static final String ADD_PEER_FOR_REGION_SUCCEED = "addPeer %s for region %s succeed";
  public static final String REMOVE_PEER_FOR_REGION_SUCCEED = "removePeer %s for region %s succeed";
  public static final String DELETE_PEER_FROM_CONSENSUS_GROUP_SUCCEED =
      "deletePeer from consensus group %ssucceed";
  public static final String DELETE_REGION_ERROR = "deleteRegion %s error, %s";
  public static final String DELETE_REGION_SUCCEED = "deleteRegion %s succeed";
  public static final String START_TO_ADD_PEER_FOR_REGION = "{}, Start to addPeer {} for region {}";
  public static final String EXECUTED_ADD_PEER_FOR_REGION_ERROR =
      "{}, executed addPeer {} for region {} error";
  public static final String REGION_MIGRATE_UNEXPECTED_EXCEPTION = "Unexpected exception";
  ...
  public static final String DELETE_REGION_ERROR_LOG = "{}, deleteRegion {} error";
  public static final String SUCCEED_TO_DELETE_REGION = "{}, Succeed to deleteRegion {}";
  public static final String ERROR_PROCESSING_DATA_REGION = "Error processing data region: {}";
  public static final String FAILED_TO_PROCESS_TSFILE = "Failed to process tsfile {}, {}";
  ...
  public static final String ILLEGAL_REGEXP_PATTERN_FMT = "illegal REGEXP pattern: %s";
  ...
  public static final String COLUMN_FILTER_COMPARISON_RIGHT_OPERAND = "comparison right operand";
  ...
  public static final String CREATE_NEW_REGION_ERROR_FMT =
      "create new region %s error,  exception:%s";
  ...
  public static final String SET_SERVER_CONTEXT_FACTORY = "Will set ServerContextFactory from {} ";
  ...
  // ---------------------------------------------------------------------------
  public static final String USER_OPENS_INTERNAL_SESSION = "User: {}, opens internal Session-{}.";
  ...
  public static final String FAILED_ON_DATANODE = "Failed to {} on DataNode: {}, response: {}";
  public static final String SUCCESSFULLY_ON_CONFIG_NODE = "Successfully {} on ConfigNode: {}";
  public static final String FAILED_ON_CONFIG_NODE = "Failed to {} on ConfigNode: {}, response: {}";

  // ---------------------------------------------------------------------------
  // protocol – AINodeClient
  // ---------------------------------------------------------------------------
  public static final String AINODE_MAY_DOWN = "The current AINode may have been down {}, because";
  ...
  // ---------------------------------------------------------------------------
  public static final String LOGIN_STATUS = "{}: Login status: {}. User : {}, opens Session-{}";
  ...
  public static final String SCHEMA_REGION_ALREADY_EXISTS_FMT = "SchemaRegion %d already exists.";
  public static final String CREATE_DATA_REGION_FAILED = "Create Data Region {} failed because {}";
  ...
  public static final String RECEIVE_FRAGMENT_INSTANCE = "receive FragmentInstance to group[{}]";
  ...
  public static final String SCHEMA_CACHE_INVALIDATED = "Schema cache of {} has been invalidated";
  public static final String ERROR_PUSHING_PIPE_META = "Error occurred when pushing pipe meta";
  ...
  public static final String ERROR_PUSHING_TOPIC_META = "Error occurred when pushing topic meta";
  ...
  public static final String START_DISABLE_DATA_NODE = "start disable data node in the request: {}";
  ...
  // service – DataNode
  // ---------------------------------------------------------------------------
  public static final String DATANODE_ENV_VARS = "IoTDB-DataNode environment variables: {}";
  public static final String DATANODE_DEFAULT_CHARSET = "IoTDB-DataNode default charset is: {}";
  public static final String STARTING_DATANODE = "Starting DataNode...";
  public static final String DATANODE_FIRST_START = "DataNode is starting for the first time...";
  ...
  public static final String CLEANED_SORT_TEMP_DIR = "Cleaned up stale sort temp directory: {}";
  ...
  public static final String FAILED_BORROW_CONFIG_NODE_CLIENT = "Failed to borrow ConfigNodeClient";
  public static final String FAILED_REPORT_SHUTDOWN = "Failed to report shutdown";

  // ---------------------------------------------------------------------------
  // service – RegionMigrateService
  // ---------------------------------------------------------------------------
  public static final String REGION_BEGIN_MIGRATING = "Region {} is notified to begin migrating";
  public static final String REGION_FINISH_MIGRATING = "Region {} is notified to finish migrating";
  ...
  public static final String CHECK_FINISHED_NO_DAMAGED = "Check finished. There is no damaged file";
  public static final String FAILED_FILES_FOUND = "There are {} failed files. They are {}";
  public static final String NO_ENOUGH_ARGS = "No enough args: require the walRootDirectory";
  ...
  // ---------------------------------------------------------------------------
  public static final String MEET_ERRORS_READING_FILE = "Meet errors in reading file {} , skip it.";
  ...
  // ---------------------------------------------------------------------------
  public static final String IOEXCEPTION_GET_FOLDER = "ioexception when get {}'s folder";
  ...
  public static final String START_SETTLING_TSFILE = "Start settling for tsFile : {}";
  public static final String FINISH_SETTLING_ALL = "Finish settling all tsfiles Successfully!";
  public static final String FAIL_SERIALIZE_TSFILE_RESOURCE =
      "fail to serialize new tsfile resource.";
  public static final String FAILED_DELETE_SETTLE_LOG = "failed to delete settle log, log path:{}";

  // ---------------------------------------------------------------------------
  // tools – TsFileSettleByCompactionTool
  // ---------------------------------------------------------------------------
  public static final String PARSE_COMMAND_LINE_FAILED = "Parse command line args failed: {}";
  ...
  public static final String ERROR_VALIDATING_REPAIRING_RESOURCE =
      "Error validating or repairing resource {}: {}";
  public static final String ERROR_LOADING_RESOURCES_FROM_PARTITION =
  ...
  public static final String SKIPPED_RESOURCE_FILE_NOT_EXIST =
      "{} is skipped because resource file is not exist.";
  ...
  public static final String MARKED_TSFILE_RESOURCE_AS =
  ...
  public static final String FAILED_TO_REPAIR_TSFILE_RESOURCE =
  ...
  // ---------------------------------------------------------------------------
  public static final String FAILED_REMOVE_OBJECT_FILE = "Failed to remove object file {}";
  public static final String FAILED_REMOVE_EMPTY_OBJECT_DIR =
      "Failed to remove empty object dir {}";
  public static final String REMOVE_OBJECT_FILE = "Remove object file {}, size is {}(byte)";

  // ---------------------------------------------------------------------------
  // utils – OpenFileNumUtil
  // ---------------------------------------------------------------------------
  public static final String CANNOT_GET_PID = "Cannot get PID of IoTDB process because ";
  ...
  // ---------------------------------------------------------------------------
  public static final String ERROR_OPERATION_LOG = "Status code: {}, operation: {} failed";
  ...
  public static final String INVALID_AGGREGATION_FUNCTION_FMT = "Invalid Aggregation function: %s";
  public static final String SCALAR_FUNCTION_NAME_NULL = "ScalarFunction Name must not be null.";
  ...
  // utils – ThreadUtils
  // ---------------------------------------------------------------------------
  public static final String WAITING_TERMINATED_TIMEOUT = "Waiting {} to be terminated is timeout";
  public static final String POOL_NOT_EXIT_AFTER_TIMEOUT = "{} still doesn't exit after 60s";
  ...
  public static final String UNEXPECTED_CONSENSUS_GROUP_TYPE = "Unexpected consensus group type";
  ...
  public static final String FAILED_PARSE_TRUSTED_URI = "Failed to parse trusted_uri_pattern {}";
  ...
  // ---------------------------------------------------------------------------
  public static final String PORTS_HAVE_REPEAT = "ports used in datanode have repeat.";
  ...
  public static final String REST_FAIL_FIND_CONFIG = "REST service fail to find config file {}";
  ...
  // ---------------------------------------------------------------------------
  public static final String EXCEPTION_DROPPING_TOPIC = "Exception occurred when dropping topic {}";
  ...
  // ---------------------------------------------------------------------------
  public static final String UNEXPECTED_CONSENSUS_REQUEST = "Unexpected IConsensusRequest : {}";
  ...
  // ---------------------------------------------------------------------------
  public static final String ERROR_EXECUTING_PLAN_NODE = "Error in executing plan node: {}";
  ...
  public static final String IP_UNLOCKED_MANUAL = "IP '{}' for user ID '{}' unlocked (manual)";
  public static final String USER_UNLOCKED_EXPIRED = "User ID '{}' unlocked (expired)";
  public static final String IP_UNLOCKED_EXPIRED = "IP '{}' for user ID '{}' unlocked (expired)";
  ...
  public static final String FAILED_CHECK_IP_UP = "Failed to check if IP address={} is up";
  ...
  // ---------------------------------------------------------------------------
  public static final String TRIGGER_INTERRUPTED_SLEEP = "{} interrupted when sleep";
  ...
  // ---------------------------------------------------------------------------
  public static final String ERROR_READING_MD5 = "Error occurred when trying to read md5 of {}";

  // ---------------------------------------------------------------------------
  // partition – DataPartitionTableGenerator
  // ---------------------------------------------------------------------------
  public static final String TASK_ALREADY_STARTED = "Task is already started or completed";
  ...
  public static final String CANNOT_SSL_HANDSHAKE_WITH_CN_LEADER =
      "Cannot SSL Handshake with ConfigNode-leader.";
  public static final String CANNOT_CONNECT_TO_CN_LEADER = "Cannot connect to ConfigNode-leader.";
  public static final String CAPACITY_LARGER_THAN_INITIAL_PERMITS =
      "Capacity should be larger than initial permits.";
  ...
  public static final String DN_CLIENT_NOT_SUPPORT_ADD_CONSENSUS_GROUP =
      "DataNode to ConfigNode client doesn't support addConsensusGroup.";
  public static final String DN_CLIENT_NOT_SUPPORT_GET_HEARTBEAT =
      "DataNode to ConfigNode client doesn't support getConfigNodeHeartBeat.";
  public static final String DN_CLIENT_NOT_SUPPORT_NOTIFY_REGISTER =
      "DataNode to ConfigNode client doesn't support notifyRegisterSuccess.";
  public static final String DN_CLIENT_NOT_SUPPORT_REGISTER_CN =
      "DataNode to ConfigNode client doesn't support registerConfigNode.";
  public static final String DN_CLIENT_NOT_SUPPORT_REMOVE_CONSENSUS_GROUP =
      "DataNode to ConfigNode client doesn't support removeConsensusGroup.";
  public static final String DN_CLIENT_NOT_SUPPORT_REPORT_SHUTDOWN =
      "DataNode to ConfigNode client doesn't support reportConfigNodeShutdown.";
  public static final String DN_CLIENT_NOT_SUPPORT_SET_STATUS =
      "DataNode to ConfigNode client doesn't support setDataNodeStatus.";
  public static final String DN_CLIENT_NOT_SUPPORT_STOP_AND_CLEAR =
      "DataNode to ConfigNode client doesn't support stopAndClearConfigNode.";
  public static final String ERROR_OCCURRED_DURING_CREATING_DIR =
      "Error occurred during creating directory ";
  public static final String EXPECTING_NON_EMPTY_STRING_FOR = "Expecting a non-empty string for ";
  public static final String FAILED_TO_CONSTRUCT_PIPE_SINK =
      "Failed to construct PipeSink, because of ";
  ...
  public static final String FAILED_TO_GET_CONSUMER_GROUP_META =
      "Failed to get consumer group meta from config node.";
  public static final String FAILED_TO_GET_TOPIC_META =
      "Failed to get topic meta from config node.";
  public static final String FAILED_TO_GET_TRIGGER_JAR =
      "Failed to get trigger jar from config node.";
  ...
  public static final String INVALID_PARAMETERS_CHECK_USER_GUIDE =
      "Invalid parameters. Please check the user guide.";
  ...
  public static final String PREPARED_STMT_NOT_SUPPORTED_FOR_TREE =
      "PreparedStatement is not supported for Tree model";
  public static final String FILE_LENGTH_LARGER_THAN_MAX =
      "The file length is larger than max_object_file_size_in_bytes";
  ...
  public static final String UNSUPPORTED_COLUMN_GENERATOR_TYPE =
      "Unsupported ColumnGeneratorType: ";
  public static final String UNSUPPORTED_TRIGGER_FIRE_RESULT_TYPE =
      "Unsupported TriggerFireResult Type";
  ...
  public static final String OBJECT_STORAGE_NOT_SUPPORTED_YET =
      "object storage is not supported yet";
  ...
  public static final String
      MESSAGE_FAILED_STOP_EXTERNAL_SERVICE_ARG_BECAUSE_IT_NOT_EXISTED_3CCCDA42 =
          "Failed to stop External Service %s, because it is not existed!";
  public static final String
      MESSAGE_FAILED_DROP_EXTERNAL_SERVICE_ARG_BECAUSE_IT_NOT_EXISTED_FDD11F17 =
          "Failed to drop External Service %s, because it is not existed!";
  ...
  public static final String MESSAGE_FAILED_DROP_EXTERNAL_SERVICE_ARG_BECAUSE_IT_RUNNING_89B38F80 =
      "Failed to drop External Service %s, because it is RUNNING!";
  public static final String
  ...
  public static final String MESSAGE_ERROR_OCCURRED_IN_READ_PROCESS_COLON_CD184195 =
      "Error occurred in read process: ";
