...
public final class DataNodeSchemaMessages {
  ...
  public static final String DELETE_SCHEMA_REGION_FOLDER_FAILED = "删除 schema region 目录 {} 失败。";
  public static final String FAILED_TO_DELETE_SCHEMA_REGION_FOLDER = "删除 schema region 目录 %s 失败";
  public static final String DELETE_DATABASE_SCHEMA_FOLDER = "删除数据库 schema 目录 {}";
  public static final String DELETE_DATABASE_SCHEMA_FOLDER_FAILED = "删除数据库 schema 目录 {} 失败";

  // ======================== SchemaRegionLoader 相关消息 ========================

  public static final String CLASS_NOT_SUBCLASS_OF_ISCHEMAREGION = "类 %s 不是 ISchemaRegion 的子类。";
  ...
  public static final String UNRECOGNIZED_SCHEMA_REGION_PLAN_TYPE = "无法识别的 SchemaRegionPlanType：";

  // ======================== SchemaRegion 初始化/目录 相关消息 ========================

  public static final String CREATE_DATABASE_SCHEMA_FOLDER = "创建数据库 schema 目录 {}";
  public static final String CREATE_DATABASE_SCHEMA_FOLDER_FAILED = "创建数据库 schema 目录 {} 失败。";
  public static final String CREATE_SCHEMA_REGION_FOLDER = "创建 schema region 目录 {}";
  public static final String CREATE_SCHEMA_REGION_FOLDER_FAILED = "创建 schema region 目录 {} 失败。";
  public static final String CANNOT_RECOVER_ALL_SCHEMA_INFO = "无法从 {} 恢复所有 schema 信息，将尽可能恢复";
  public static final String CANNOT_RECOVER_ALL_MTREE = "无法从 {} 文件恢复所有 MTree，将尽可能恢复";
  ...
  public static final String MLOG_BIN_CORRUPTED = "mlog.bin 文件已损坏，请删除或修复该文件，然后重启 IoTDB";
  public static final String CANNOT_CLOSE_METADATA_LOG_WRITER = "无法关闭元数据日志写入器：";
  ...
  public static final String DIRECT_BUFFER_MEMORY_EXCEEDED = "直接缓冲区的总分配内存将达到 ";
  ...
  public static final String MTREE_SNAPSHOT_CREATION_COST = "schemaRegion {} 的 MTree 快照创建耗时 {}ms。";
  public static final String MTREE_SNAPSHOT_CREATION_COST_WITH_STATUS =
      "schemaRegion {} 的 MTree 快照创建耗时 {}ms，状态：{}";
  public static final String TAG_SNAPSHOT_CREATION_COST = "schemaRegion {} 的 Tag 快照创建耗时 {}ms。";
  ...
  public static final String SNAPSHOT_CREATION_COST = "schemaRegion {} 的快照创建耗时 {}ms。";
  public static final String SUCCESSFULLY_CREATE_SNAPSHOT = "成功创建 schemaRegion {} 的快照";
  public static final String START_LOADING_SNAPSHOT = "开始加载 schemaRegion {} 的快照";
  ...
  public static final String TAG_SNAPSHOT_LOADING_COST = "schemaRegion {} 的 Tag 快照加载耗时 {}ms。";
  public static final String MTREE_SNAPSHOT_LOADING_COST = "schemaRegion {} 的 MTree 快照加载耗时 {}ms。";
  public static final String SNAPSHOT_LOADING_COST = "schemaRegion {} 的快照加载耗时 {}ms。";
  public static final String SUCCESSFULLY_LOAD_SNAPSHOT = "成功加载 schemaRegion {} 的快照";
  public static final String FAILED_TO_LOAD_SNAPSHOT =
      "加载 schemaRegion {} 的快照失败，原因：{}，将使用空的 schemaRegion";
  public static final String ERROR_DURING_INIT_SCHEMA_REGION = "初始化 schemaRegion {} 过程中发生错误";
  public static final String FAILED_TO_RECOVER_TAG_INDEX = "恢复 {} 的 tagIndex 失败，schemaRegion 为 {}。";
  public static final String FAILED_TO_READ_TAG_ATTRIBUTE = "读取 tag 和 attribute 信息失败：{}";

  // ======================== DeviceAttributeStore 相关消息 ========================

  public static final String FAILED_TO_DELETE_OLD_SNAPSHOT_DEVICE_ATTR = "创建设备属性快照时删除旧快照 {} 失败。";
  public static final String FAILED_TO_RENAME_SNAPSHOT_DEVICE_ATTR = "创建设备属性快照时将 {} 重命名为 {} 失败。";
  public static final String FAILED_TO_CREATE_DEVICE_ATTR_SNAPSHOT = "创建设备属性快照失败：{}";
  public static final String DEVICE_ATTR_SNAPSHOT_NOT_FOUND = "未找到设备属性快照 {}，视为从旧版本升级，使用空属性";
  public static final String LOAD_DEVICE_ATTR_SNAPSHOT_FAILED = "从 {} 加载设备属性快照失败";

  // ======================== DeviceAttributeCacheUpdater 相关消息 ========================

  public static final String FAILED_TO_DELETE_OLD_SNAPSHOT_UPDATER = "创建设备属性远程更新器快照时删除旧快照 {} 失败。";
  public static final String FAILED_TO_RENAME_SNAPSHOT_UPDATER = "创建设备属性远程更新器快照时将 {} 重命名为 {} 失败。";
  public static final String FAILED_TO_CREATE_UPDATER_SNAPSHOT = "创建设备属性远程更新器快照失败：{}";
  public static final String UPDATER_SNAPSHOT_NOT_FOUND = "未找到设备属性远程更新器快照 {}，视为从旧版本升级，将不更新远程节点";
  public static final String LOAD_UPDATER_SNAPSHOT_FAILED = "从 {} 加载设备属性远程更新器快照失败，继续...";
  public static final String REQUEST_MEMORY_SIZE_NEGATIVE = "requestMemory 大小不能为负数";
  public static final String RELEASE_MEMORY_SIZE_NEGATIVE = "releaseMemory 大小不能为负数";

  // ======================== MetaFormatUtils 相关消息 ========================

  public static final String ILLEGAL_NAME = "%s 是不合法的名称。";
  public static final String NAME_CONTAINS_UNSUPPORTED_CHAR = "名称 %s 包含不支持的字符。";
  public static final String DATABASE_NAME_ILLEGAL_CHARS = "数据库名称只能包含中英文字符、数字、反引号和下划线。%s";
  public static final String SDT_COMPRESSION_DEVIATION_REQUIRED = "SDT 压缩偏差为必填项";
  public static final String SDT_COMPRESSION_DEVIATION_NEGATIVE = "SDT 压缩偏差不能为负数";
  public static final String SDT_COMPRESSION_DEVIATION_FORMAT_ERROR = "SDT 压缩偏差格式错误";
  public static final String SDT_COMPRESSION_MAX_GREATER_THAN_MIN = "SDT 压缩最大时间必须大于最小时间";
  public static final String SDT_COMPRESSION_TIME_NEGATIVE = "SDT 压缩 %s 时间不能为负数";
  public static final String SDT_COMPRESSION_TIME_FORMAT_ERROR = "SDT 压缩 %s 时间格式错误";
  public static final String SDT_ENABLED_NO_COMPRESSION_TIME = "{} 已启用 SDT 但未设置压缩 {} 时间";

  // ======================== Tag/Attribute 相关消息 ========================

  public static final String TIMESERIES_NO_TAG_ATTRIBUTE = "时间序列 [%s] 没有任何 tag/attribute。";
  public static final String TIMESERIES_NO_SPECIFIC_TAG_ATTRIBUTE =
      "时间序列 [%s] 没有 [%s] tag/attribute。";
  public static final String TIMESERIES_ALREADY_HAS_ATTRIBUTE = "时间序列 [%s] 已有 attribute [%s]。";
  public static final String TIMESERIES_ALREADY_HAS_TAG = "时间序列 [%s] 已有 tag [%s]。";
  public static final String TIMESERIES_NO_TAG_ATTRIBUTE_LOG = "时间序列 [{}] 没有 tag/attribute [{}]";
  public static final String TIMESERIES_NO_SPECIFIC_TAG_ATTRIBUTE_FMT =
      "时间序列 [%s] 没有 tag/attribute [%s]。";

  // ======================== TagManager 快照相关消息 ========================

  public static final String FAILED_TO_DELETE_OLD_TAG_SNAPSHOT = "创建 tagManager 快照时删除旧快照 {} 失败。";
  public static final String FAILED_TO_RENAME_TAG_SNAPSHOT = "创建 tagManager 快照时将 {} 重命名为 {} 失败。";
  public static final String FAILED_TO_DELETE_AFTER_RENAME_FAILURE = "重命名失败后删除 {} 失败。";
  public static final String FAILED_TO_CREATE_TAG_SNAPSHOT = "创建 tagManager 快照失败：{}";
  ...
  public static final String FAILED_TO_DELETE_EXISTING_WHEN_LOADING = "加载快照时删除已有的 {} 失败。";
  public static final String FAILED_TO_DELETE_EXISTING_WHEN_COPY_FAILURE = "复制快照失败时删除已有的 {} 失败。";
  ...
  public static final String FAILED_TO_DELETE_OLD_MTREE_SNAPSHOT = "创建 mTree 快照时删除旧快照 {} 失败。";
  public static final String FAILED_TO_RENAME_MTREE_SNAPSHOT = "创建 mTree 快照时将 {} 重命名为 {} 失败。";
  public static final String FAILED_TO_CREATE_MTREE_SNAPSHOT = "创建 mTree 快照失败：{}";
  public static final String SERIALIZE_ERROR_INFO = "序列化 MemMTree 过程中发生错误。";
  ...
  public static final String CANNOT_CONSTRUCT_ABSTRACT_CLASS = "无法构造抽象类。";

  // ======================== PBTree 相关消息 ========================

  public static final String TABLE_MODEL_NOT_SUPPORT_PBTREE = "表模型尚不支持 PBTree。";
  public static final String PBTREE_NOT_SUPPORT_ALTER_ENCODING = "PBTree 尚不支持修改编码和压缩方式。";
  public static final String NOT_IMPLEMENTED = "尚未实现";
  public static final String PBTREE_FILE_OVERWRITTEN = "PBTree 文件 [{}] 已存在，将被覆盖。";
  public static final String SCHEMA_FILE_WRONG_VERSION = "SchemaFile 版本错误，请检查或升级。";
  public static final String NODE_NO_CHILD_IN_PBTREE = "节点 [%s] 在 pbtree 文件中没有子节点。";
  public static final String SCHEMA_FILE_INSPECTED = "SchemaFile[%s] 已被检查。";
  public static final String FAILED_TO_CREATE_SCHEMA_FILE_SNAPSHOT = "创建 SchemaFile 快照失败：{}";
  public static final String FAILED_TO_DELETE_OLD_PBTREE_SNAPSHOT = "创建 pbtree 文件快照时删除旧快照 {} 失败。";

  // ======================== PBTree Segment/Page 相关消息 ========================

  public static final String FAILED_TO_INSERT_RELOCATED_SEGMENT = "向重定位的 segment 插入缓冲区失败";
  public static final String FAILED_TO_UPDATE_RELOCATED_SEGMENT = "在重定位的 segment 上更新缓冲区失败";
  public static final String ALIAS_INDEX_PAGE_EXTEND_CAPACITY = "AliasIndexPage 只能扩展到相同容量的缓冲区。";
  public static final String SEGMENTS_SPLIT_SAME_CAPACITY = "Segment 只能以相同容量进行拆分。";
  public static final String SEGMENT_SPLIT_NO_RECORDS = "没有记录的 Segment 无法拆分。";
  public static final String SEGMENT_SPLIT_ONLY_ONE_RECORD = "只有一条记录的 Segment 无法拆分。";
  public static final String INTERNAL_PAGE_EXTEND_CAPACITY = "InternalPage 只能扩展到相同容量的缓冲区。";
  public static final String INTERNAL_SEGMENT_SPLIT_NO_KEY = "内部 Segment 没有插入键时无法拆分";
  public static final String INTERNAL_SEGMENT_LESS_THAN_2_POINTERS = "指针数少于 2 的 Segment 无法拆分。";
  public static final String LEAF_SEGMENT_EXTEND_SMALLER = "叶子 Segment 无法扩展到更小的缓冲区。";
  public static final String RECORD_CONFLICT_NAME_WITH_ALIAS = "记录 [%s] 的名称与其兄弟节点的别名冲突。";
  public static final String RECORD_CONFLICT_ALIAS = "记录 [%s] 的别名 [%s] 与其兄弟节点冲突。";
  ...
  public static final String ROOT_PAGE_SHALL_NOT_BE_MIGRATED = "根页面不应被迁移。";
  public static final String SUBORDINATE_INDEX_NOT_ON_SINGLE_PAGE = "不应在单页面 segment 上构建从属索引。";
  public static final String SUBORDINATE_INDEX_BROKEN = "文件可能已损坏，从属索引已断裂。";
  public static final String DUPLICATE_PAGE_INSTANCES = "存在索引相同的重复页面实例：{}";
  public static final String PAGE_LOCKED_TIMES = "页面 [{}] 已被锁定 {} 次。";
  public static final String REENTRANT_WRITE_LOCKS_DETAIL = "页面 {} 上存在可重入写锁，内容详情：{}";
  public static final String REENTRANT_WRITE_LOCKS = "页面 {} 上存在可重入写锁";

  // ======================== PBTree Flush 相关消息 ========================

  public static final String IO_EXCEPTION_UPDATING_SG_MNODE = "更新 StorageGroupMNode {} 时发生 IO 异常";
  public static final String ERROR_DURING_MTREE_FLUSH = "MTree 刷写过程中发生错误，当前节点为 {}";

  // ======================== PBTree ReleaseFlushMonitor 相关消息 ========================

  public static final String RELEASE_TASK_MONITOR_INTERRUPTED = "ReleaseTaskMonitor 线程被中断。";
  public static final String RELEASE_FLUSH_TASK_TIMEOUT = "释放任务和刷写任务未在 {} 毫秒内完成，已中断。";

  // ======================== PBTree PagePool 相关消息 ========================

  public static final String PAGE_CACHE_EVICTION_INTERRUPTED = "页面缓存淘汰过程中被中断，请考虑增加缓存大小、降低并发或延长超时时间";
  ...
  public static final String TABLE_DEVICE_NOT_UNDER_TREE_MODEL = "不应在树模型下创建表设备";
  ...
  public static final String PLAN_NOT_SUPPORT_DESERIALIZATION = "%s 计划不支持反序列化。";
  public static final String PLAN_NOT_SUPPORT_SERIALIZATION = "%s 计划不支持序列化。";
  public static final String SCHEMA_FILE_LOG_INCOMPLETE_ENTRY = "不完整的日志条目。";

  // ======================== Template 相关消息 ========================

  public static final String UNKNOWN_TEMPLATE_UPDATE_OPERATION_TYPE = "未知的模板更新操作类型";

  // ======================== InformationSchema 相关消息 ========================

  public static final String SYSTEM_VIEW_NOT_SUPPORT_SHOW_CREATE = "系统视图不支持 show create。";
  public static final String SYSTEM_DATABASE_NOT_SUPPORT_SHOW_CREATE = "系统数据库不支持 show create。";
  ...
  public static final String PBTREE_NOT_SUPPORT_ALTER_DATA_TYPE = "PBTree 尚不支持修改时间序列数据类型。";

  // ======================== 附加 MTree 相关消息 ========================

  public static final String DEVICE_NUM_UPPER_LIMIT = "设备数量已达到上限";
  public static final String TIMESERIES_TYPE_NOT_COMPATIBLE = "时间序列 %s 使用的新类型 %s 与已有类型 %s 不兼容";
  public static final String ALIAS_DUPLICATED = "别名与其他测点的名称或别名重复，别名：";
  public static final String LOGICAL_VIEW_NODE_TYPE_ERROR =
      "newMNode 的类型不是 LogicalViewMNode！实际类型为 ";
  public static final String TEMPLATE_SHOULD_MOUNTED_ON_ANCESTOR = "使用模板的节点 [%s] 的祖先节点上应挂载模板。";
  public static final String DESCENDANT_SHOULD_NOT_EXIST = "节点 %s 下不应存在后代节点";
  ...
  public static final String NODE_NO_CHILD_IN_PBTREE_WITH_NAME = "节点 [%s] 在 pbtree 文件中没有子节点 [%s]。";
  public static final String SINGLE_RECORD_TOO_LARGE = "SchemaFile 目前不支持超过半页大小的单条记录。";
  public static final String PAGE_REPLACEMENT_ERROR = "页面 [%d] 替换错误：引用计数或锁对象不一致。";
  ...
  public static final String NOT_ENDED_BY_MARK = "未以 COMMIT_MARK 或 PREPARE_MARK 结尾。";
  ...
  public static final String FAILED_TO_CREATE_FILE_ALREADY_EXISTS = "创建文件 %s 失败，因为同名文件已存在";
  ...
  public static final String FAILED_TO_CREATE_TEMPLATE = "在 ConfigNode 中执行创建设备模板 {} 失败，状态为 {}。";
  ...
  public static final String FAILED_TO_SET_TEMPLATE = "在 ConfigNode 中执行设置设备模板 {} 到路径 {} 失败，状态为 {}。";

  // ======================== 附加 InformationSchema 相关消息 ========================

  public static final String INFORMATION_SCHEMA_READ_ONLY = "数据库 'information_schema' 仅支持查询操作";

  // ======================== 附加 GRASS/Updater 相关消息 ========================

  public static final String FAILED_TO_WRITE_ATTR_COMMIT = "向 region {} 写入属性提交消息失败。";
  public static final String FAILED_TO_FETCH_DATANODE_LOCATIONS = "获取 DataNode 位置信息失败，将重试。";
  ...
  public static final String ERROR_DURING_PBTREE_CLEAR = "PBTree 清理过程中发生错误：{}";
  ...
  public static final String DESERIALIZE_ERROR_INFO = "反序列化 MemMTree 过程中发生错误。";

  // ======================== 附加 MetaUtils 相关消息 ========================

  public static final String PATH_NO_LONGER_THAN_SG_LEVEL = "路径长度不超过默认 sg 层级：";
  public static final String PATH_DOES_NOT_START_WITH_ROOT = "路径不以 ";

  // ======================== FakeCRC32Deserializer 相关消息 ========================

  public static final String READ_LOG_LENGTH_NEGATIVE_LOG = "读取的日志长度 {} 为负数。";

  // ======================== SchemaLogReader 相关消息 ========================

  public static final String FILE_CORRUPTED = "文件 {} 已损坏，未损坏的大小为 {}。";
  public static final String LOG_FILE_END_CORRUPTED_TRUNCATE =
      "日志文件 {} 的末尾已损坏，开始截断。未损坏的大小为 {}，文件大小为 {}。";
  public static final String FAIL_TO_TRUNCATE_LOG_FILE = "截断日志文件到大小 {} 失败";

  // ======================== SchemaRegionPlanDeserializer 相关消息 ========================

  public static final String CANNOT_DESERIALIZE_SCHEMA_REGION_PLAN = "无法从缓冲区反序列化 SchemaRegionPlan";

  // ======================== MTreeBelowSGMemoryImpl 相关消息 ========================

  public static final String TIMESERIES_NUM_UPPER_LIMIT = "时间序列数量已达到上限";
  public static final String ALIAS_DUPLICATED_DETAIL = "，完整路径：";
  public static final String ALIAS_DUPLICATED_OTHER_MEASUREMENT = "，其他测点：";
  public static final String START_CREATE_TABLE_DEVICE = "开始创建表设备 {}.{}";
  public static final String TABLE_DEVICE_ALREADY_EXISTS = "表设备 {}.{} 已存在";
  public static final String TABLE_DEVICE_CREATED = "表设备 {}.{} 已创建";

  // ======================== CachedMTreeStore / Scheduler 相关消息 ========================

  public static final String MTREE_FLUSH_COST = "MTree 刷写耗时 {}ms，SchemaRegion 为 {}";
  ...
  public static final String FAILED_TO_GET_FENCE_THRESHOLD_FROM_CN = "在租约恢复期间未能从 ConfigNode 获取隔离阈值";
  ...
  public static final String UPDATED_METADATA_LEASE_FENCE_THRESHOLD = "元数据租约隔离阈值已更新为 {} 毫秒";
  ...
  public static final String NESTED_LOGICAL_VIEW_UNSUPPORTED_FMT = "视图 [%s] 的源也是一个视图！不支持嵌套视图，请检查。";
  ...
  public static final String SOME_TASK_DELETING_TIMESERIES_FMT = "某个任务正在删除时间序列 [%s]";
  ...
  public static final String ALIAS_FOR_PATH_ALREADY_EXIST_FMT = "别名 [%s] 对应路径 [%s] 已存在";
  public static final String DATABASE_NOT_SET_FOR_SERIES_PATH_FMT = "%s，当前 seriesPath：[%s]";
  public static final String DATABASE_ALREADY_CREATED_AS_DATABASE_FMT = "%s 已被创建为数据库";
  ...
  public static final String ILLEGAL_PARAMETER_FAILED_CREATE_TIMESERIES_FMT = "%s。为路径 %s 创建时间序列失败";
  ...
  public static final String SOURCE_PATH_NOT_EXIST_WRONG_MESSAGE = "源路径 [%s] 对应视图 [%s] 不存在。";
  public static final String NORMAL_TIMESERIES_NOT_EXIST_WRONG_MESSAGE = "时间序列 [%s] 不存在或由设备模板表示";
  ...
  public static final String SCHEMA_DIR_CREATION_FAILED_FMT = "创建数据库 schema 文件夹 %s 失败。";
  ...
  public static final String FAILED_CREATE_DUPLICATED_TEMPLATE_FMT = "为路径 %s 创建重复模板失败";
  public static final String TEMPLATE_ON_PATH_DIFFERENT_FROM_FMT = "%s 上的模板与 %s 不同";
  public static final String UNDEFINED_TEMPLATE_NAME_FMT = "未定义的模板名：%s";
  public static final String COLOSSAL_RECORD_FMT = "key [%s] 的记录过大，SchemaFile 无法存储，内容大小：%d";
  ...
  public static final String SEGMENT_NOT_FOUND_FMT = "Segment(index:%d) 在 page(index:%d) 中未找到。";
  public static final String SEGMENT_IS_NOT_LAST_FMT = "Segment(index:%d) 不是 page 中的最后一个 segment";
  public static final String NO_SPLITTABLE_SEGMENT_FOUND_FMT = "在 page [%s] 中未找到可 split 的 segment";
  public static final String PBTREE_FILE_LOG_CORRUPTED_FMT = "PBTreeFileLog [%s] 因 [%s] 损坏。";
  ...
  public static final String SCHEMA_PAGE_OVERFLOW_FMT = "pbtree 文件中的 Page [%s] 空间耗尽或包含过多 segment。";
  public static final String SOURCE_PATH_DELETED_FMT = "源路径 [%s] 已被删除";
  public static final String BROKEN_VIEW_UNMATCHED_FMT = "视图已损坏！源路径 [%s] 映射到不匹配的 %s 个路径：%s。";
  public static final String INSERT_NON_WRITABLE_VIEW_FMT = "无法向不是别名序列的视图插入数据。（视图路径：%s）";
  public static final String INSERT_NON_WRITABLE_VIEW = "无法向不是别名序列的视图插入数据。";
  public static final String DATABASE_NOT_SET = "未设置数据库";
  public static final String DUPLICATE_INSERTION_WRONG_MESSAGE = "插入非法，因为设备 [%s] 下的测点 [%s] 重复。";
  public static final String VIEW_IS_UNSUPPORTED_FMT = "视图不受支持，原因：%s";
  public static final String VIEW_CONTAINS_AGGREGATION_FUNCTION_FMT = "该视图包含名为 [%s] 的聚合函数";
