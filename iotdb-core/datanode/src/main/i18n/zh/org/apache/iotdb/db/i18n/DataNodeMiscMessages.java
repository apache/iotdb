...
public final class DataNodeMiscMessages {
  ...
  public static final String INVALID_PIPE_NAME = "无效的 pipeName";
  public static final String READ_OBJECT_CONTENT_FROM_REMOTE_FILE =
      "readObjectContentFromRemoteFile";
  public static final String ERROR_EXCEPTION = "错误，异常：";
  public static final String ACCOUNT_BLOCKED_DUE_TO_CONSECUTIVE_FAILED_LOGINS = "账户因连续登录失败已被锁定。";
  public static final String VERSION_INCOMPATIBLE_PLEASE_UPGRADE_TO = "版本不兼容，请升级至 ";
  public static final String ADD_PEER_FOR_REGION_SUCCEED = "addPeer %s for region %s 成功";
  public static final String REMOVE_PEER_FOR_REGION_SUCCEED = "removePeer %s for region %s 成功";
  public static final String DELETE_PEER_FROM_CONSENSUS_GROUP_SUCCEED = "从共识组 %s 删除 peer 成功";
  public static final String DELETE_REGION_ERROR = "deleteRegion %s 错误，%s";
  public static final String DELETE_REGION_SUCCEED = "deleteRegion %s 成功";
  public static final String START_TO_ADD_PEER_FOR_REGION = "{}, 开始将 addPeer {} 添加到 region {}";
  public static final String EXECUTED_ADD_PEER_FOR_REGION_ERROR =
      "{}, 执行 addPeer {} 于 region {} 时出错";
  public static final String REGION_MIGRATE_UNEXPECTED_EXCEPTION = "发生意外异常";
  public static final String ADD_PEER_FOR_REGION_ERROR_FMT =
      "%s, 为 region 执行 AddPeer 出错，peerId：%s，regionId：%s";
  public static final String SUCCEED_TO_ADD_PEER_FOR_REGION = "{}, 成功将 addPeer {} 添加到 region {}";
  ...
  public static final String SUCCEED_TO_REMOVE_PEER_FOR_REGION = "{}, 成功移除 removePeer {}，region {}";
  public static final String START_TO_DELETE_PEER_FOR_REGION = "{}, 开始执行 deletePeer {}，region {}";
  public static final String DELETE_PEER_ERROR_WITH_ERROR_MESSAGE_FMT =
      "deletePeer 出错，regionId：%s，错误信息：%s";
  public static final String DELETE_PEER_ERROR_WITH_REGION_ID = "{}, deletePeer 出错，regionId：{}";
  ...
  public static final String DELETE_REGION_ERROR_LOG = "{}, deleteRegion {} 出错";
  public static final String SUCCEED_TO_DELETE_REGION = "{}, deleteRegion {} 成功";
  public static final String ERROR_PROCESSING_DATA_REGION = "处理数据 region 出错：{}";
  public static final String FAILED_TO_PROCESS_TSFILE = "处理 TsFile {} 失败，{}";

  public static final String INVALID_COLUMN_FILTER_FMT = "无效的 column-filter：%s";
  public static final String COLUMN_FILTER_SHOULD_NOT_BE_EMPTY = "column-filter 不应为空";
  public static final String EXPECTED_COLUMN_PREDICATE_OPERATOR = "预期 column 谓词操作符";
  public static final String EXPECTED_STRING_LITERAL = "预期字符串字面量";
  public static final String UNSUPPORTED_COMPARISON_OPERATOR_FMT = "不支持的比较操作符 '%s'";
  public static final String UNEXPECTED_CHARACTER_FMT = "非预期字符 '%s'";
  public static final String UNSUPPORTED_COLUMN_FILTER_PREDICATE = "不支持的 column-filter 谓词";
  ...
  public static final String IN_PREDICATE_MUST_USE_STRING_LITERAL_LIST = "IN 谓词必须使用字符串字面量列表";
  public static final String ONLY_REGEXP_SUPPORTED_AS_REGEXP_LIKE =
      "仅支持作为 regexp_like(field, pattern) 的 REGEXP";
  public static final String ILLEGAL_REGEXP_PATTERN_FMT = "非法 REGEXP 模式：%s";
  public static final String LEFT_OPERAND_MUST_BE_COLUMN_METADATA_FIELD = "左操作数必须是 column 元数据字段之一";
  public static final String UNSUPPORTED_COLUMN_METADATA_FIELD_FMT = "不支持的 column 元数据字段：%s";
  public static final String MUST_BE_STRING_LITERAL_FMT = "%s 必须是字符串字面量";
  public static final String LIKE_ESCAPE_MUST_BE_SINGLE_CHARACTER = "LIKE 转义符必须为单个字符";
  public static final String LIKE_PATTERN_ENDS_WITH_ESCAPE_CHARACTER = "LIKE 模式以转义符结尾";
  public static final String UNSUPPORTED_TABLE_COLUMN_CATEGORY_FMT = "不支持的表列类别：%s";
  public static final String COLUMN_FILTER_COMPARISON_RIGHT_OPERAND = "比较右操作数";
  ...
  // ---------------------------------------------------------------------------
  public static final String MULTIPLE_SERVER_CONTEXT_FACTORY = "存在多个 ServerContextFactory 实现，请检查。";
  public static final String SET_SERVER_CONTEXT_FACTORY = "将从 {} 设置 ServerContextFactory";

  // ---------------------------------------------------------------------------
  // protocol – ConfigNodeInfo
  // ---------------------------------------------------------------------------
  public static final String UPDATE_CONFIG_NODE_SUCCESSFULLY = "成功更新 ConfigNode：{}，耗时 {} 毫秒。";
  public static final String UPDATE_CONFIG_NODE_FAILED = "更新 ConfigNode 失败。";
  public static final String SYSTEM_PROPERTIES_NOT_EXIST = "系统属性文件不存在，无需存储 ConfigNode 列表";
  public static final String LOAD_CONFIG_NODE_SUCCESSFULLY = "成功加载 ConfigNode：{}，耗时 {} 毫秒。";
  ...
  // ---------------------------------------------------------------------------
  public static final String NODE_LEADER_MAY_DOWN_TRY_NEXT = "当前节点 Leader {} 可能已宕机，尝试下一个节点";
  public static final String UNEXPECTED_INTERRUPTION_CONNECT_CONFIG_NODE =
      "等待连接 ConfigNode 时发生意外中断";
  public static final String NODE_MAY_DOWN_TRY_NEXT = "当前节点 {} 可能已宕机，尝试下一个节点";
  ...
  // ---------------------------------------------------------------------------
  public static final String USER_OPENS_INTERNAL_SESSION = "用户 {} 打开了内部 Session-{}。";
  public static final String USER_OPENS_INTERNAL_SESSION_FAILED = "用户 {} 打开内部 Session 失败。";
  public static final String USER_OPENS_INTERNAL_SESSION_FAILED_FMT = "用户 %s 打开内部 Session 失败。";
  ...
  public static final String FAILED_ON_DATANODE = "在 DataNode {} 上执行 {} 失败，响应：{}";
  public static final String SUCCESSFULLY_ON_CONFIG_NODE = "在 ConfigNode {} 上成功执行 {}";
  public static final String FAILED_ON_CONFIG_NODE = "在 ConfigNode {} 上执行 {} 失败，响应：{}";

  // ---------------------------------------------------------------------------
  // protocol – AINodeClient
  // ---------------------------------------------------------------------------
  public static final String AINODE_MAY_DOWN = "当前 AINode {} 可能已宕机，原因：";
  public static final String CANNOT_CONNECT_ANY_AINODE = "无法连接任何 AINode，因为没有可用的节点。";
  ...
  // ---------------------------------------------------------------------------
  public static final String LOGIN_STATUS = "{}: 登录状态：{}。用户：{}，打开 Session-{}";
  ...
  public static final String CLIENT_SESSION_REGISTERED_REPEATEDLY = "客户端会话被重复注册，请检查是否存在 Bug。";
  ...
  public static final String CREATE_SCHEMA_REGION_FAILED = "创建 Schema Region {} 失败，原因：{}";
  public static final String CREATE_SCHEMA_REGION_FAILED_FMT = "创建 Schema Region 失败，原因：%s";
  public static final String SCHEMA_REGION_ALREADY_EXISTS_FMT = "SchemaRegion %d 已存在。";
  public static final String CREATE_DATA_REGION_FAILED = "创建 Data Region {} 失败，原因：{}";
  public static final String CREATE_DATA_REGION_FAILED_FMT = "创建 Data Region 失败，原因：%s";
  ...
  // ---------------------------------------------------------------------------
  public static final String CONSENSUS_NOT_STARTED = "共识协议在 {} 秒后仍未启动，拒绝 Region 请求";
  public static final String RECEIVE_FRAGMENT_INSTANCE = "收到 FragmentInstance，目标组 [{}]";
  public static final String DESERIALIZE_CONSENSUS_GROUP_ID_FAILED = "反序列化 ConsensusGroupId 失败。";
  public static final String DESERIALIZE_FRAGMENT_INSTANCE_FAILED = "反序列化 FragmentInstance 失败。";
  public static final String RECEIVE_LOAD_NODE = "收到 UUID 为 {} 的加载节点请求。";
  public static final String SCHEMA_CACHE_INVALIDATED = "{} 的 Schema 缓存已失效";
  public static final String ERROR_PUSHING_PIPE_META = "推送 Pipe 元数据时发生错误";
  public static final String ERROR_PUSHING_SINGLE_PIPE_META = "推送单个 Pipe 元数据时发生错误";
  public static final String ERROR_PUSHING_MULTI_PIPE_META = "推送多个 Pipe 元数据时发生错误";
  public static final String ERROR_PUSHING_TOPIC_META = "推送 Topic 元数据时发生错误";
  public static final String ERROR_PUSHING_SINGLE_TOPIC_META = "推送单个 Topic 元数据时发生错误";
  public static final String ERROR_PUSHING_MULTI_TOPIC_META = "推送多个 Topic 元数据时发生错误";
  public static final String ERROR_PUSHING_TOPIC_OWNER_LEASE = "推送 Topic owner 租约时发生错误";
  public static final String ERROR_PUSHING_CONSUMER_GROUP_META = "推送消费者组元数据时发生错误";
  public static final String ERROR_PUSHING_SINGLE_CONSUMER_GROUP_META = "推送单个消费者组元数据时发生错误";
  public static final String EXCEPTION_EXECUTING_INTERNAL_SCHEMA_TASK = "执行内部 Schema 任务时发生异常：";
  public static final String UNSUPPORTED_TYPE_UPDATING_TABLE = "更新表时遇到不支持的类型 {}";
  public static final String UNSUPPORTED_TYPE_UPDATING_TEMPLATE = "更新模板时遇到不支持的类型 {}";
  public static final String FAILED_GET_MEMORY_FROM_METRIC = "从指标获取内存信息失败，原因：";
  ...
  public static final String START_DISABLE_DATA_NODE = "开始在请求中禁用 DataNode：{}";
  public static final String EXECUTE_STOP_AND_CLEAR = "执行 stopAndClearDataNode RPC 方法";
  public static final String INTERRUPTED_STOP_AND_CLEAR = "在 stopAndClearDataNode RPC 方法中遇到中断异常";
  public static final String STOP_AND_CLEAR_ERROR = "停止并清理 DataNode 时发生错误";
  public static final String RETRIEVED_EARLIEST_TIMESLOTS = "已获取 {} 个数据库的最早时间槽";
  public static final String FAILED_GET_EARLIEST_TIMESLOTS = "获取最早时间槽失败";
  public static final String FAILED_GENERATE_DATA_PARTITION_TABLE = "生成数据分区表失败";
  public static final String FAILED_CHECK_DATA_PARTITION_TABLE_STATUS = "检查数据分区表生成状态失败";
  public static final String DATA_PARTITION_TABLE_COMPLETED = "数据分区表生成完成，任务 ID：{}";
  public static final String DATA_PARTITION_TABLE_FAILED = "数据分区表生成失败，任务 ID：{}";
  public static final String PROCESS_DATA_DIR_COMPLETED = "处理数据目录以获取最早时间槽已成功完成";
  public static final String ERROR_EXECUTING_BATCH_STATEMENT = "执行批量语句时发生错误：";
  ...
  public static final String TEST_INSERT_STRING_RECORD_RECEIVE = "收到测试字符串记录插入请求。";
  public static final String TEST_INSERT_ROW_IN_BATCH_RECEIVE = "收到测试批量行插入请求。";
  public static final String TEST_INSERT_ROWS_IN_BATCH_RECEIVE = "收到测试批量多行插入请求。";
  public static final String TEST_INSERT_STRING_RECORDS_RECEIVE = "收到测试字符串记录批量插入请求。";
  public static final String START_BATCH_EXECUTING_TREE = "开始在树模型中批量执行 {} 个子语句，queryId：{}";
  public static final String EXECUTING_SUB_STATEMENT_TREE = "正在树模型中执行第 {}/{} 个子语句，queryId：{}";
  ...
  public static final String COMPLETED_BATCH_EXECUTING_TREE = "树模型中全部 {} 个子语句批量执行完成，queryId：{}";
  public static final String START_BATCH_EXECUTING_TABLE = "开始在表模型中批量执行 {} 个子语句，queryId：{}";
  public static final String EXECUTING_SUB_STATEMENT_TABLE = "正在表模型中执行第 {}/{} 个子语句，queryId：{}";
  ...
  public static final String COMPLETED_BATCH_EXECUTING_TABLE = "表模型中全部 {} 个子语句批量执行完成，queryId：{}";

  // ---------------------------------------------------------------------------
  // service – DataNode
  // ---------------------------------------------------------------------------
  public static final String DATANODE_ENV_VARS = "IoTDB-DataNode 环境变量：{}";
  public static final String DATANODE_DEFAULT_CHARSET = "IoTDB-DataNode 默认字符集：{}";
  public static final String STARTING_DATANODE = "正在启动 DataNode...";
  public static final String DATANODE_FIRST_START = "DataNode 首次启动中...";
  public static final String DATANODE_RESTARTING = "DataNode 正在重启...";
  public static final String IOTDB_CONFIGURATION = "IoTDB 配置信息：{}";
  public static final String DATANODE_SETUP_SUCCESSFULLY = "恭喜，IoTDB DataNode 已成功启动，祝使用愉快！";
  public static final String FAIL_TO_START_SERVER = "启动服务器失败";
  public static final String DATANODE_STARTED = "DataNode 已启动";
  public static final String DATANODE_PREPARED_SUCCESSFULLY = "DataNode 准备就绪，耗时 {} 毫秒";
  public static final String PULLING_SYSTEM_CONFIGURATIONS = "正在从 ConfigNode Leader 拉取系统配置...";
  public static final String CANNOT_PULL_SYSTEM_CONFIGURATIONS = "无法从 ConfigNode Leader 拉取系统配置";
  public static final String SENDING_REGISTER_REQUEST = "正在向 ConfigNode Leader 发送注册请求...";
  public static final String CANNOT_REGISTER_TO_CLUSTER = "无法注册到集群，原因：{}";
  public static final String CANNOT_REGISTER_AFTER_RETRIES = "重试 {} 次后仍无法注册到集群。";
  public static final String PRECHECK_PASSED = "预检查通过，即将进行正式注册。";
  public static final String DELETE_SUCCEED = "删除 {} 成功。";
  public static final String DELETE_FAILED_NOT_EXIST = "删除 {} 失败，因为目录不存在。";
  public static final String SENDING_RESTART_REQUEST = "正在向 ConfigNode Leader 发送重启请求...";
  public static final String CLEANED_SORT_TEMP_DIR = "已清理过期的排序临时目录：{}";
  ...
  public static final String PREPARE_PIPE_RESOURCES = "Pipe 资源准备完成，耗时 {} 毫秒。";
  public static final String RECOVER_SCHEMA_SUCCESSFULLY = "Schema 恢复完成，耗时 {} 毫秒。";
  ...
  public static final String INTERRUPTED_WAITING_PIPE_FINISH = "等待 Pipe 完成时被中断";
  public static final String TIMED_OUT_WAITING_PIPES = "等待 Pipe 完成超时，将终止等待";
  public static final String FAILED_BORROW_CONFIG_NODE_CLIENT = "借用 ConfigNodeClient 失败";
  public static final String FAILED_REPORT_SHUTDOWN = "上报关闭状态失败";

  // ---------------------------------------------------------------------------
  // service – RegionMigrateService
  // ---------------------------------------------------------------------------
  public static final String REGION_BEGIN_MIGRATING = "Region {} 收到开始迁移通知";
  public static final String REGION_FINISH_MIGRATING = "Region {} 收到完成迁移通知";
  ...
  public static final String WAITING_SETTLE_POOL_SHUTDOWN = "正在等待 Settle 任务池关闭";
  public static final String SETTLE_SERVICE_STOPPED = "Settle 服务已停止";

  // ---------------------------------------------------------------------------
  // service – IoTDBInternalLocalReporter
  // ---------------------------------------------------------------------------
  public static final String CHECK_OR_CREATE_DATABASE_FAILED = "IoTDBSessionReporter 检查或创建数据库失败。";
  public static final String CHECK_OR_CREATE_DATABASE_FAILED_BECAUSE =
      "IoTDBSessionReporter 检查或创建数据库失败，原因：";
  public static final String INTERNAL_REPORTER_ALREADY_STARTED = "IoTDB 内部 Reporter 已经启动";
  ...
  public static final String FAILED_UPDATE_METRIC_VALUE = "更新指标值失败，状态：{}";
  public static final String FAILED_AUTO_CREATE_TIMESERIES = "自动创建时间序列 {} 失败，状态：{}";

  // ---------------------------------------------------------------------------
  // service – ExternalService
  // ---------------------------------------------------------------------------
  public static final String FAILED_MAKE_EXTERNAL_SERVICE_DIR = "创建外部服务目录失败";
  public static final String EXTERNAL_SERVICE_LIB_ROOT = "外部服务库根目录：{}";
  public static final String FAILED_GET_OPEN_FILE_NUMBER = "获取打开文件数失败，原因：";
  public static final String UNEXPECTED_ERROR_GETTING_TSFILE_NAME = "获取 TsFile 名称时发生意外错误";

  // ---------------------------------------------------------------------------
  // service – metrics
  // ---------------------------------------------------------------------------
  public static final String FAILED_GET_PROCESS_RESIDENT_MEMORY = "获取进程 {} 的常驻内存失败";
  ...
  public static final String NO_SUB_DIRECTORIES = "指定目录下无子目录，检查结束";
  ...
  public static final String CHECK_FINISHED_NO_DAMAGED = "检查完成，没有损坏的文件";
  public static final String FAILED_FILES_FOUND = "共有 {} 个文件检查失败，文件列表：{}";
  public static final String NO_ENOUGH_ARGS = "参数不足：需要提供 WAL 根目录路径";
  ...
  public static final String UNSUPPORTED_SPLIT_WITH_MODIFICATION = "暂不支持拆分带有修改记录的 TsFile。";
  public static final String UNSUPPORTED_SPLIT_WITH_ALIGNED = "暂不支持拆分包含对齐时间序列的 TsFile。";

  // ---------------------------------------------------------------------------
  // tools – TsFileSplitByPartitionTool
  // ---------------------------------------------------------------------------
  public static final String DELETE_UNCOMPLETED_FILE = "删除未完成的文件 {}";
  public static final String CREATE_TSFILE_FAILED_EXISTS = "创建新 TsFile {} 失败，因为文件已存在";
  public static final String CREATE_TSFILE_FAILED = "创建新 TsFile {} 失败";
  public static final String INCORRECT_MAGIC_STRING = "文件的 MAGIC STRING 不正确，文件路径：{}";
  public static final String INCORRECT_VERSION_NUMBER = "文件的版本号不正确，文件路径：{}";
  public static final String FILE_NOT_CLOSED_CORRECTLY = "文件未正确关闭，文件路径：{}";

  // ---------------------------------------------------------------------------
  // tools – TsFileSelfCheckTool
  // ---------------------------------------------------------------------------
  public static final String ERROR_GETTING_TIMESERIES_METADATA = "获取 TsFile 中所有带偏移量的时间序列元数据时发生错误。";
  public static final String FILE_PATH = "文件路径：{}";

  // ---------------------------------------------------------------------------
  // tools – TsFileValidationTool
  // ---------------------------------------------------------------------------
  public static final String NOT_DIRECTORY_OR_NOT_EXIST = "{} 不是目录或不存在，跳过。";

  // ---------------------------------------------------------------------------
  // tools – TsFileValidationScan / TsFileStatisticScan
  // ---------------------------------------------------------------------------
  public static final String MEET_ERRORS_READING_FILE = "读取文件 {} 时遇到错误，跳过。";
  public static final String MEET_ERROR = "遇到错误。";

  // ---------------------------------------------------------------------------
  // tools – MLogParser / PBTreeFileSketchTool
  // ---------------------------------------------------------------------------
  public static final String TOO_FEW_PARAMS = "输入参数过少，请参考以下提示。";
  ...
  // ---------------------------------------------------------------------------
  public static final String IOEXCEPTION_GET_FOLDER = "获取 {} 的目录时发生 IO 异常";

  // ---------------------------------------------------------------------------
  // tools – SRStatementGenerator
  // ---------------------------------------------------------------------------
  public static final String ERROR_PARSER_TAG_ATTRIBUTES = "解析标签和属性文件时发生错误";
  public static final String MEASUREMENT_ATTRIBUTES_NO_SNAPSHOT = "测点已设置属性或标签，但未找到快照文件";
  ...
  public static final String START_SETTLING_TSFILE = "开始整理 TsFile：{}";
  public static final String FINISH_SETTLING_ALL = "所有 TsFile 整理完成！";
  public static final String FAIL_SERIALIZE_TSFILE_RESOURCE = "序列化新的 TsFile 资源失败。";
  public static final String FAILED_DELETE_SETTLE_LOG = "删除整理日志失败，日志路径：{}";

  // ---------------------------------------------------------------------------
  // tools – TsFileSettleByCompactionTool
  // ---------------------------------------------------------------------------
  public static final String PARSE_COMMAND_LINE_FAILED = "解析命令行参数失败：{}";
  public static final String ADD_SETTLE_COMPACTION_TASK_SUCCESS = "添加整理合并任务成功";
  public static final String ADD_SETTLE_COMPACTION_TASK_FAILED = "添加整理合并任务失败，状态码：{}";

  // ---------------------------------------------------------------------------
  // tools – TsFileResourcePipeStatisticsSetTool
  // ---------------------------------------------------------------------------
  public static final String UNKNOWN_ARGUMENT = "未知参数：{}";
  public static final String NO_DATA_DIRS_PROVIDED = "未提供数据目录，请使用 --dirs <dir1> <dir2> ... 指定。";
  public static final String VALIDATION_REPAIR_COMPLETED = "校验和修复已完成。统计信息：";
  ...
  public static final String TIME_PARTITION_PROCESS_COMPLETED =
      "时间分区 {} 共有 {} 个资源，{} 个需要设置 isGeneratedByPipe，{} 个需要重置 progressIndex，{} 个已更改。处理完成。";
  public static final String SKIPPED_RESOURCE_FILE_NOT_EXIST = "{} 已跳过，因为资源文件不存在。";
  public static final String REPAIRING_TSFILE_RESOURCE =
      "正在修复 TsFileResource: {}，isGeneratedByPipe 标记: {}，实际标记: {}";
  public static final String RESETTING_PROGRESS_INDEX_TO_MINIMUM =
      "正在将 TsFileResource:{} 的 progressIndex 重置为最小值，原始 progressIndex: {}";
  public static final String MARKED_TSFILE_RESOURCE_AS = "已将 TsFileResource 标记为 {} ，资源: {}";
  public static final String RESET_PROGRESS_INDEX_TO_MINIMUM =
      "已将 TsFileResource:{} 的 progressIndex 重置为最小值。";
  public static final String FAILED_TO_REPAIR_TSFILE_RESOURCE = "错误：修复 TsFileResource 失败：{}";
  public static final String TOTAL_TIME_TAKEN =
      "总耗时: {} 毫秒，TsFile 资源总数: {}，设置 isGeneratedByPipe 的资源数: {}，重置 progressIndex 的资源数: {}，已更改的资源数: {}";
  ...
  // ---------------------------------------------------------------------------
  public static final String FAILED_REMOVE_OBJECT_FILE = "删除对象文件 {} 失败";
  public static final String FAILED_REMOVE_EMPTY_OBJECT_DIR = "删除空对象目录 {} 失败";
  public static final String REMOVE_OBJECT_FILE = "删除对象文件 {}，大小为 {}（字节）";

  // ---------------------------------------------------------------------------
  // utils – OpenFileNumUtil
  // ---------------------------------------------------------------------------
  public static final String CANNOT_GET_PID = "无法获取 IoTDB 进程的 PID，原因：";
  public static final String UNSUPPORTED_OS_GET_PID =
      "不支持的操作系统 {}，无法通过 OpenFileNumUtil 获取 IoTDB 的 PID。";
  public static final String CANNOT_GET_OPEN_FILE_NUMBER = "无法获取 IoTDB 进程的打开文件数，原因：";
  ...
  // ---------------------------------------------------------------------------
  public static final String ERROR_OPERATION_LOG = "状态码：{}，操作 {} 失败";
  ...
  public static final String BOOLEAN_PARSE_ERROR = "BOOLEAN 值应为 true/TRUE、false/FALSE 或 0/1";
  public static final String UNSUPPORTED_DATA_TYPE_FMT = "不支持的数据类型：%s";
  public static final String UNSUPPORTED_DATA_TYPE = "不支持的数据类型：";
  public static final String AGGREGATE_FUNCTION_NAME_NULL = "聚合函数名称不能为空";
  public static final String INVALID_AGGREGATION_FUNCTION = "无效的聚合函数：";
  public static final String INVALID_AGGREGATION_FUNCTION_FMT = "无效的聚合函数：%s";
  public static final String SCALAR_FUNCTION_NAME_NULL = "标量函数名称不能为空。";
  public static final String DELETE_CURSOR_SIZE_ERROR = "deleteCursor 应为大小为 1 的数组";

  // ---------------------------------------------------------------------------
  // utils – ThreadUtils
  // ---------------------------------------------------------------------------
  public static final String WAITING_TERMINATED_TIMEOUT = "等待 {} 终止超时";
  public static final String POOL_NOT_EXIT_AFTER_TIMEOUT = "{} 在 60 秒后仍未退出";

  // ---------------------------------------------------------------------------
  // utils – WindowEvaluationTaskPoolManager
  // ---------------------------------------------------------------------------
  public static final String WINDOW_EVAL_POOL_INIT = "WindowEvaluationTaskPoolManager 正在初始化，线程数：{}";

  // ---------------------------------------------------------------------------
  // utils – LogWriter
  // ---------------------------------------------------------------------------
  public static final String INTERRUPTED_NO_WRITE = "当前线程被中断，为保证 IO 安全跳过写入操作";
  ...
  public static final String UNEXPECTED_CONSENSUS_GROUP_TYPE = "未预期的共识组类型";
  public static final String ENCRYPT_MAGIC_STRING_NOT_MATCHED = "encrypt_magic_string 不匹配";
  ...
  public static final String FAIL_FIND_CONFIG_FILE = "找不到配置文件 {}，拒绝启动 DataNode。";
  public static final String CANNOT_LOAD_CONFIG_FILE = "无法加载配置文件，拒绝启动 DataNode。";
  public static final String INCORRECT_FORMAT_CONFIG_FILE = "配置文件格式不正确，拒绝启动 DataNode。";
  public static final String COULD_NOT_LOAD_CONFIG = "无法从任何已知来源加载配置。";
  ...
  public static final String MQTT_HOST_NOT_CONFIGURED = "MQTT 主机未配置，将使用 dn_rpc_address。";
  public static final String FAILED_PARSE_TRUSTED_URI = "解析 trusted_uri_pattern {} 失败";
  ...
  public static final String FAIL_RELOAD_CONFIGURATION_FMT = "重新加载配置失败，原因：%s";

  // ---------------------------------------------------------------------------
  // conf – IoTDBConfig
  // ---------------------------------------------------------------------------
  public static final String FAIL_GET_CANONICAL_PATH = "获取 {} 的规范路径失败";
  public static final String NO_DATA_DIR_SET = "未设置数据目录，loadTsFileDirs 保持默认值。";
  public static final String FAILED_GET_FIELD = "获取字段 {} 失败";
  public static final String SKIP_FAILED_TABLE_SCHEMA_CHECK = "skipFailedTableSchemaCheck 已设置为 {}。";
  public static final String DIR_REMOVED_FROM_DATA_DIRS = "%s 已从 data_dirs 参数中移除，请将其添加回去。";

  // ---------------------------------------------------------------------------
  // conf – DataNodeMemoryConfig
  // ---------------------------------------------------------------------------
  public static final String FAIL_RELOAD_MEMORY_CONFIG_FMT = "重新加载配置失败，原因：%s";

  // ---------------------------------------------------------------------------
  // conf – DataNodeStartupCheck
  // ---------------------------------------------------------------------------
  public static final String PORTS_HAVE_REPEAT = "DataNode 使用的端口存在重复。";

  // ---------------------------------------------------------------------------
  // conf – REST service
  // ---------------------------------------------------------------------------
  public static final String REST_COULD_NOT_LOAD_CONFIG = "无法从任何已知来源加载 REST 服务配置。";
  public static final String REST_START_READ_CONFIG = "开始读取配置文件 {}";
  public static final String REST_FAIL_FIND_CONFIG = "REST 服务找不到配置文件 {}";
  public static final String REST_CANNOT_LOAD_CONFIG = "REST 服务无法加载配置文件，使用默认配置";
  public static final String REST_INCORRECT_FORMAT = "REST 服务配置文件格式不正确，使用默认配置";
  ...
  public static final String SUBSCRIPTION_UNEXPECTED_EXCEPTION = "订阅：意外异常（不变量被破坏）{}";
  ...
  public static final String SUBSCRIPTION_CONSUMER_HEARTBEAT_SUCCESS = "订阅：消费者 {} 心跳成功";
  public static final String SUBSCRIPTION_CONSUMER_SUBSCRIBE_SUCCESS = "订阅：消费者 {} 订阅 {} 成功";
  public static final String SUBSCRIPTION_CONSUMER_CLOSE_SUCCESS = "订阅：消费者 {} 关闭成功";
  public static final String SUBSCRIPTION_EXCEPTION_HANDSHAKING = "握手请求 {} 时发生异常";
  public static final String SUBSCRIPTION_EXCEPTION_HEARTBEAT = "心跳请求 {} 时发生异常";
  public static final String SUBSCRIPTION_EXCEPTION_SUBSCRIBING = "订阅请求 {} 时发生异常";
  public static final String SUBSCRIPTION_EXCEPTION_UNSUBSCRIBING = "取消订阅请求 {} 时发生异常";
  public static final String SUBSCRIPTION_EXCEPTION_POLLING = "拉取请求 {} 时发生异常";
  public static final String SUBSCRIPTION_EXCEPTION_COMMITTING = "提交请求 {} 时发生异常";
  public static final String SUBSCRIPTION_EXCEPTION_CLOSING = "关闭请求 {} 时发生异常";
  ...
  // ---------------------------------------------------------------------------
  public static final String SUBSCRIPTION_CREATE_BROKER = "订阅：创建绑定到消费者组 [{}] 的 Broker";
  public static final String SUBSCRIPTION_DROP_BROKER = "订阅：删除绑定到消费者组 [{}] 的 Broker";
  public static final String SUBSCRIPTION_BROKER_NOT_EXIST_FMT = "订阅：绑定到消费者组 [%s] 的 Broker 不存在";
  ...
  public static final String SUBSCRIPTION_DROP_CONSENSUS_BROKER = "订阅：删除绑定到消费者组 [{}] 的共识 Broker";
  ...
  // ---------------------------------------------------------------------------
  public static final String EXCEPTION_DROPPING_CONSUMER_GROUP = "删除消费者组 {} 时发生异常";

  // ---------------------------------------------------------------------------
  // subscription – SubscriptionTopicAgent
  // ---------------------------------------------------------------------------
  public static final String EXCEPTION_DROPPING_TOPIC = "删除 Topic {} 时发生异常";
  ...
  // ---------------------------------------------------------------------------
  public static final String NULL_RESPONSE_INVALIDATING = "使缓存失效时响应为空，跳过";
  ...
  // ---------------------------------------------------------------------------
  public static final String EXCEPTION_SEALING_EVENTS = "从批次 {} 封存事件时发生异常";
  public static final String EXCEPTION_CONSTRUCT_NEW_BATCH = "构造新批次时发生异常";

  // ---------------------------------------------------------------------------
  // subscription – SubscriptionPrefetchingQueue
  // ---------------------------------------------------------------------------
  public static final String EXCEPTION_EXECUTE_RECEIVER_SUBTASK = "异常 {} 在 {} 执行接收子任务时发生";
  ...
  // ---------------------------------------------------------------------------
  public static final String UNEXPECTED_CONSENSUS_REQUEST = "未预期的 IConsensusRequest：{}";
  public static final String UNEXPECTED_CONSENSUS_REQUEST_EXCEPTION = "未预期的 IConsensusRequest！";

  // ---------------------------------------------------------------------------
  // consensus – SchemaExecutionVisitor
  // ---------------------------------------------------------------------------
  public static final String IO_ERROR = "{}: IO 错误：";
  public static final String OPENED_PIPE_LISTENING_QUEUE = "已在 Schema Region {} 上打开 Pipe 监听队列";
  public static final String CLOSED_PIPE_LISTENING_QUEUE = "已在 Schema Region {} 上关闭 Pipe 监听队列";
  ...
  // ---------------------------------------------------------------------------
  public static final String ERROR_EXECUTING_PLAN_NODE = "执行计划节点 {} 时发生错误";
  public static final String ERROR_EXECUTING_PLAN_NODE_CAUSED = "执行计划节点 {} 时发生错误，原因：{}";
  public static final String REJECT_EXECUTING_PLAN_NODE = "拒绝执行计划节点 {}，原因：{}";
  public static final String BATCH_FAILURE_INSERT_ROWS = "执行 InsertRowsNode 时出现批量失败。";
  ...
  // ---------------------------------------------------------------------------
  public static final String EXCEPTION_REPLACING_DATA_REGION = "替换存储引擎中的数据 Region 时发生异常。";
  public static final String UNEXPECTED_PLAN_NODE_TYPE = "未预期的 PlanNode 类型 {}，不是 SearchNode";
  public static final String TABLE_NOT_EXISTS_OR_LOST = "表不存在或已丢失，结果码为 {}";
  public static final String GET_FRAGMENT_INSTANCE_FAILED = "获取 FragmentInstance 失败";
  public static final String CANNOT_GET_CANONICAL_FILE = "{}: 无法获取 {} 的规范文件路径，原因：{}";

  // ---------------------------------------------------------------------------
  // auth – LoginLockManager
  // ---------------------------------------------------------------------------
  public static final String IP_LOGIN_ATTEMPTS_DISABLED = "IP 级别登录尝试已禁用（设置为 {}）";
  public static final String USER_LOGIN_ATTEMPTS_DISABLED = "用户级别登录尝试已禁用（设置为 {}）";
  public static final String IP_LOCKED = "IP '{}' 已锁定，用户 ID '{}'";
  public static final String USER_UNLOCKED_MANUAL = "用户 ID '{}' 已解锁（手动）";
  public static final String IP_UNLOCKED_MANUAL = "IP '{}' 已为用户 ID '{}' 解锁（手动）";
  public static final String USER_UNLOCKED_EXPIRED = "用户 ID '{}' 已解锁（过期）";
  public static final String IP_UNLOCKED_EXPIRED = "IP '{}' 已为用户 ID '{}' 解锁（过期）";
  public static final String IP_LOCKED_MULTIPLE_USERS = "IP '{}' 被 {} 个不同用户锁定 → 可能遭受攻击";
  public static final String USER_MULTIPLE_IP_LOCKS = "用户 ID '{}' 有 {} 个 IP 锁定 → 可能遭受攻击";
  public static final String FAILED_CHECK_IP_UP = "检查 IP 地址 {} 是否可达失败";

  // ---------------------------------------------------------------------------
  // auth – ClusterAuthorityFetcher
  // ---------------------------------------------------------------------------
  public static final String CACHE_USER_PATH_PRIVILEGES_ERROR = "缓存用户路径权限时发生错误";
  public static final String CACHE_ROLE_PATH_PRIVILEGES_ERROR = "缓存角色路径权限时发生错误";

  // ---------------------------------------------------------------------------
  // trigger – TriggerExecutor
  // ---------------------------------------------------------------------------
  public static final String TRIGGER_FIRE_ERROR = "触发器触发时发生错误，触发器：{}，原因：{}";

  // ---------------------------------------------------------------------------
  // trigger – TriggerInformationUpdater
  // ---------------------------------------------------------------------------
  public static final String TRIGGER_INFO_UPDATER_STARTED = "有状态触发器信息更新器已成功启动。";
  public static final String TRIGGER_INFO_UPDATER_STOPPED = "有状态触发器信息更新器已成功停止。";
  public static final String ERROR_UPDATING_TRIGGER_INFO = "更新触发器信息时遇到错误：";

  // ---------------------------------------------------------------------------
  // trigger – TriggerFireVisitor
  // ---------------------------------------------------------------------------
  public static final String TRIGGER_INTERRUPTED_SLEEP = "{} 在休眠时被中断";
  ...
  // ---------------------------------------------------------------------------
  public static final String ERROR_READING_MD5 = "尝试读取 {} 的 MD5 时发生错误";

  // ---------------------------------------------------------------------------
  // partition – DataPartitionTableGenerator
  // ---------------------------------------------------------------------------
  public static final String TASK_ALREADY_STARTED = "任务已启动或已完成";

  public static final String FROM_CONFIG_NODE = "' 来自 ConfigNode。'";
  public static final String IS_NOT_SUPPORTED = " 不受支持";
  public static final String CANNOT_SSL_HANDSHAKE_WITH_CN_LEADER =
      "无法与 ConfigNode-leader 进行 SSL 握手。";
  ...
  public static final String DN_CLIENT_NOT_SUPPORT_ADD_CONSENSUS_GROUP =
      "DataNode 到 ConfigNode 客户端不支持 addConsensusGroup。";
  public static final String DN_CLIENT_NOT_SUPPORT_GET_HEARTBEAT =
      "DataNode 到 ConfigNode 客户端不支持 getConfigNodeHeartBeat。";
  public static final String DN_CLIENT_NOT_SUPPORT_NOTIFY_REGISTER =
      "DataNode 到 ConfigNode 客户端不支持 notifyRegisterSuccess。";
  public static final String DN_CLIENT_NOT_SUPPORT_REGISTER_CN =
      "DataNode 到 ConfigNode 客户端不支持 registerConfigNode。";
  public static final String DN_CLIENT_NOT_SUPPORT_REMOVE_CONSENSUS_GROUP =
      "DataNode 到 ConfigNode 客户端不支持 removeConsensusGroup。";
  public static final String DN_CLIENT_NOT_SUPPORT_REPORT_SHUTDOWN =
      "DataNode 到 ConfigNode 客户端不支持 reportConfigNodeShutdown。";
  public static final String DN_CLIENT_NOT_SUPPORT_SET_STATUS =
      "DataNode 到 ConfigNode 客户端不支持 setDataNodeStatus。";
  public static final String DN_CLIENT_NOT_SUPPORT_STOP_AND_CLEAR =
      "DataNode 到 ConfigNode 客户端不支持 stopAndClearConfigNode。";
  ...
  public static final String CHECK_AGGREGATION_KEEP_CONDITION = "请检查聚合函数 [%s] 的输入 keep 条件";
  ...
  public static final String TOPOLOGY_PROBING_TIMED_OUT_AFTER_S_MS = "拓扑探测在 %s 毫秒后超时";
  ...
  // --- DataNode ---
  public static final String SUCCESSFULLY_REGISTERED_ALL_UDFS_TAKES_MS = "成功注册所有 UDF，耗时 {} 毫秒。";
  ...
  public static final String MISC_LOG_SUCCESSFULLY_REGISTER_TO_THE_CLUSTER_WHICH_TAKES_MS_ED479CA7 =
      "成功注册到集群：{}，耗时 {} ms。";
  public static final String
      MISC_LOG_RESTART_REQUEST_TO_CLUSTER_IS_ACCEPTED_WHICH_TAKES_MS_E8305E02 =
  ...
  public static final String
      MISC_LOG_CANNOT_SEND_RESTART_REQUEST_TO_THE_CONFIGNODE_LEADER_BECAUSE_AB17D41A =
  ...
  public static final String
      MISC_LOG_CHANGEREGIONLEADER_START_CHANGE_THE_LEADER_OF_REGIONGROUP_248A99AD =
  ...
  public static final String MISC_LOG_ERROR_OCCURRED_WHEN_PULLING_COMMIT_PROGRESS_48C12E4B =
      "拉取提交进度时发生错误";
  public static final String
      MISC_LOG_ERROR_OCCURRED_WHEN_RECEIVING_SUBSCRIPTION_PROGRESS_BROADCAST_94B2CF10 =
          "接收订阅进度广播时发生错误";
  public static final String
      MISC_LOG_ERROR_OCCURRED_WHEN_PUSHING_SUBSCRIPTION_RUNTIME_STATE_D4E71CE3 = "推送订阅运行时状态时发生错误";
  public static final String
      MISC_LOG_FAILED_TO_PROCESS_CONSENSUS_SUBSCRIPTION_ROUTE_UPDATE_80D73E2B = "处理共识订阅路由更新失败";
  public static final String
  ...
  public static final String MISC_EXCEPTION_DATA_TYPE_S_IS_NOT_SUPPORTED_5D5C02E4 = "不支持数据类型 %s。";
  ...
  public static final String
      MISC_EXCEPTION_CANNOT_REGISTER_INTO_THE_CLUSTER_PLEASE_CHECK_WHETHER_THE_D8B29F58 =
          "无法注册到集群。请检查 iotdb-system.properties 中的 dn_seed_config_node 是否正确或存活。";
  public static final String
      MISC_EXCEPTION_CANNOT_SEND_RESTART_DATANODE_REQUEST_TO_CONFIGNODE_LEADER_368BE214 =
  ...
  public static final String MISC_EXCEPTION_S_IS_NOT_ALLOWED_ONLY_SUPPORT_S_1B06E0B7 =
      " %s 不允许，仅支持 %s";
  public static final String PARAMETER_CANNOT_BE_MODIFIED_AFTER_FIRST_STARTUP_FMT = "%s 首次启动后不能修改";
  public static final String UNSUPPORTED_INVOCATION_BY_DATANODE = "DataNode 不支持调用此方法";
  ...
  public static final String INVALID_REQUEST_FROM_CONFIG_NODE_FMT = "来自 ConfigNode 的无效请求 %s。";
  ...
  public static final String STORAGE_GROUP_NOT_READY_FMT = "存储组 %s 可能尚未就绪，请稍后重试";
  public static final String BAD_NODE_URL_FORMAT_FMT = "节点 url %s 格式错误，应为 {IP/DomainName}:{Port}";
  public static final String INCONSISTENT_DATA_TYPES_FMT = "数据类型不一致，已有数据类型：%s，传入数据类型：%s";
  public static final String CREATE_SYSTEM_DIRECTORY_FAILED = "创建系统目录失败！";
  public static final String DATABASE_READ_ONLY_NON_QUERY = "数据库为只读状态，当前不接受非查询操作";
  public static final String AINODE_CONNECTION_FAILED_FMT = "连接 AINode 失败，原因：[%s]，请检查 AINode 的状态。";
  ...
  public static final String
      MESSAGE_EXECUTEFASTLASTDATAQUERYFORONEPREFIXPATH_DOS_NOT_SUPPORT_WILDCARDS_8E8F44F5 =
          "\"executeFastLastDataQueryForOnePrefixPath\" 不支持通配符。";
  public static final String
  ...
  public static final String
      MESSAGE_ERROR_OCCURRED_WHILE_PARSING_SQL_TO_PHYSICAL_PLAN_COLON_5C9F2C59 =
          "将 SQL 解析为物理计划时发生错误：";
  public static final String MESSAGE_ERROR_OCCURRED_IN_READ_PROCESS_COLON_CD184195 = "读取过程中发生错误：";
  ...
  public static final String
      MESSAGE_CONFIGNODE_LEADER_ARG_IS_WARMING_UP_BEFORE_SERVING_DATANODE_ARG_WILL_WAIT_AND_RETRY_AAB5F962 =
          "ConfigNode leader {} 正在预热，暂未对 DataNode {} 提供服务，将等待并重试。";
  public static final String
  ...
  public static final String
      EXCEPTION_TRUST_STORE_PATH_MUST_BE_SET_WHEN_THRIFT_SSL_CLIENT_AUTH_IS_TRUE_36016171 =
          "当 thrift_ssl_client_auth 为 true 时，必须设置 trust_store_path";
  public static final String
      EXCEPTION_CONTINUOUS_QUERY_MIN_EVERY_INTERVAL_IN_MS_SHOULD_BE_GREATER_THAN_0_BUT_CURRENT_VALUE_IS_F9A1BEC4 =
          "continuous_query_min_every_interval_in_ms 必须大于 0，但当前值为 ";
  public static final String
      EXCEPTION_UNKNOWN_READ_CONSISTENCY_LEVEL_ARG_PLEASE_SET_TO_STRONG_OR_WEAK_8CF29949 =
          "未知的 read_consistency_level：%s，请设置为 \"strong\" 或 \"weak\"";
  public static final String MESSAGE_INITIAL_ALLOCATEMEMORYFORAUTORESIZINGBUFFER_ARG_A0DB6DA0 =
  ...
  public static final String EXCEPTION_CLONELIST_CANNOT_BE_NULL_47AEEA8F = "cloneList 不能为 null";
  public static final String
