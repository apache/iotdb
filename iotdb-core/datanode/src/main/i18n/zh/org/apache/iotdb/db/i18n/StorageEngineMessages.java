...
public final class StorageEngineMessages {
  ...
  public static final String SEQ_MEMTABLE_FLUSH_CHECK_THREAD_STARTED =
      "顺序 memtable 定时 flush 检查线程启动成功。";
  public static final String UNSEQ_MEMTABLE_FLUSH_CHECK_THREAD_STARTED =
      "乱序 memtable 定时 flush 检查线程启动成功。";
  ...
  public static final String IOEXCEPTION_CREATING_TSFILE_PROCESSOR_RETRY =
      "创建 TsFileProcessor 时遇到 IOException，正在重试";
  ...
  public static final String MEET_ERROR_IN_INSERTION_COMPACTION_SCHEDULE =
      "插入 compaction 调度过程中遇到错误。";
  ...
  public static final String WAITING_COMPACTION_SCHEDULE_POOL_SHUTDOWN =
      "正在等待 compaction 调度任务线程池关闭";
  public static final String COMPACTION_SCHEDULE_MANAGER_WAIT_TO_STOP =
      "CompactionScheduleTaskManager 已等待 {} 秒以停止";
  public static final String COMPACTION_SCHEDULE_TASK_MANAGER_STOPPED =
      "CompactionScheduleTaskManager 已停止";
  public static final String REPAIR_FAILED_RENAME_PROGRESS_FILE =
      "[RepairTaskManager] 重命名修复数据进度文件失败";
  ...
  public static final String COMPACTION_START_DELETE_REAL_FILE =
      "{} [Compaction] compaction 开始删除实际文件 ";
  ...
  public static final String METHOD_NOT_SUPPORTED_FAST_CROSS_WRITER =
      "FastCrossCompactionWriter 不支持此方法";
  public static final String DEVICE_SHOULD_EXIST_IN_SEQ_FILE = "设备应存在于当前顺序文件中";
  public static final String METHOD_NOT_SUPPORTED_FAST_INNER_WRITER =
      "FastInnerCompactionWriter 不支持此方法";
  public static final String METHOD_NOT_SUPPORTED_READ_POINT_WRITER =
      "ReadPointInnerCompactionWriter 不支持此方法";
  ...
  public static final String CANNOT_RECOVER_INSERTION_CROSS_TASK =
      "无法恢复 InsertionCrossSpaceCompactionTask";
  ...
  public static final String COMPACTION_RECOVER_FAILED =
      "{} [Compaction][Recover] 恢复 compaction 失败";
  ...
  public static final String REPAIR_WAIT_COMPACTION_FINISH =
      "[RepairScheduler] 等待 compaction 调度任务完成";
  public static final String REPAIR_WAIT_ALL_RUNNING_TASK_FINISH =
      "[RepairScheduler] 等待所有正在运行的 compaction 任务完成";
  ...
  public static final String DELETION_IN_FLUSHING_MEMTABLE =
      "[Deletion] 在 flushing 中的 memtable 中执行删除 {}";
  ...
  public static final String TIME_CHUNK_METADATA_SHOULD_NOT_BE_EMPTY =
      "对齐设备中的 TimeChunkMetadata 不应为空";
  ...
  public static final String FAIL_TO_READ_WAL_ENTRY_SKIP_BROKEN =
      "从 WAL 文件 {} 读取 WALEntry 失败，跳过损坏的 WALEntry。";
  ...
  public static final String CANNOT_RECOVER_TSFILE_WAL_ALREADY_STARTED =
      "无法从 WAL 恢复 TsFile，因为 WAL 恢复已经开始";
  ...
  public static final String NO_SEQ_OR_UNSEQ_FILES_IN_SNAPSHOT = "快照 {} 中没有顺序或乱序文件，跳过创建文件链接";
  public static final String EXCEPTION_DELETING_TIME_PARTITION_DIR = "删除 {}-{} 的时间分区目录时发生异常";
  public static final String CANNOT_CREATE_LINK_FALLBACK_COPY = "无法创建从 {} 到 {} 的链接，回退为复制";
  public static final String FAILED_TO_PROCESS_SNAPSHOT_FILE = "处理文件 {} 失败，所在目录为 {}: {}";
  public static final String FAILED_TO_PROCESS_SNAPSHOT_FILE_AFTER_RETRIES =
      "重试后仍无法处理文件。源文件: %s，目标后缀: %s";
  public static final String SNAPSHOT_FILE_NUM_MISMATCH = "日志中的文件数为 %d，但磁盘中的文件数为 %d";
  ...
  public static final String ERROR_RECORD_FILE_TIME_INDEX_CACHE_NO_DETAIL =
      "记录 FileTimeIndexCache 时遇到错误";
  public static final String ERROR_COMPACT_FILE_TIME_INDEX_CACHE =
      "压缩 FileTimeIndexCache 时遇到错误: {}";
  public static final String ERROR_COMPACT_FILE_TIME_INDEX_CACHE_NO_DETAIL =
      "压缩 FileTimeIndexCache 时遇到错误";
  ...
  public static final String EXCEPTION_APPLY_TABLE_DISK_USAGE_INDEX =
      "应用 TableDiskUsageIndex 操作时遇到异常。";
  ...
  public static final String EXCEPTION_REMOVE_TABLE_DISK_USAGE_INDEX =
      "移除 TableDiskUsageIndex 时遇到异常。";
  ...
  public static final String FAILED_COMPACTION_TABLE_SIZE_INDEX =
      "对 TsFile 表大小索引文件执行 compaction 失败";
  ...
  public static final String THREAD_INTERRUPTED_SKIP_WRITE_FOR_IO_SAFETY =
      "当前线程被中断，为保证 IO 安全无需执行写入";
  ...
  public static final String START_DATA_TYPE_CONVERSION_DOT =
      "开始对 LoadTsFileStatement: {} 进行数据类型转换。";
  public static final String START_DATA_TYPE_CONVERSION = "开始对 LoadTsFileStatement: {} 进行数据类型转换";
  public static final String INTERRUPTED_WAITING_TABLET_CONVERSION_SLOT = "等待 tablet 转换槽位时被中断: ";
  ...
  public static final String LOAD_TSFILE_DATABASE_KEY_AND_NAME_CANNOT_COEXIST =
      "参数键 '%s' 和 '%s' 不能同时存在。";
  public static final String DATABASE_LEVEL_LESS_THAN_MINIMUM = "给定的数据库层级 %d 小于最小值 %d，请输入有效的数据库层级。";
  public static final String DATABASE_LEVEL_NOT_VALID_INTEGER = "给定的数据库层级 %s 不是有效整数，请输入有效的数据库层级。";
  public static final String ON_SUCCESS_VALUE_NOT_SUPPORTED = "给定的参数值 '%s' 不受支持，请输入有效值。";
  public static final String PARAMETER_VALUE_NOT_SUPPORTED_BOOLEAN =
      "给定的 %s 值 '%s' 不受支持，请输入有效的布尔值。";
  public static final String TABLET_CONVERSION_THRESHOLD_NON_NEGATIVE = "tablet 转换阈值必须是非负 long 值。";
  ...
  public static final String USER_IN_ACTIVE_LOAD_PATH_DOES_NOT_EXIST = "Active 加载路径中的用户不存在";
  ...
  public static final String STORAGE_LOG_ASYNC_CLOSE_FAILED_BECAUSE_C5B63B78 = "{}：{} 异步关闭失败，原因：";
  ...
  public static final String STORAGE_LOG_TRUNCATE_CORRUPTED_DATA_MEETS_ERROR_3757A85E =
      "{}：{} 截断损坏数据时出错";
  public static final String STORAGE_LOG_RELEASE_RESOURCE_MEETS_ERROR_B62CBC3A = "{}：{} 释放资源时出错";
  public static final String
  ...
  public static final String STORAGE_LOG_THE_START_TIME_OF_IS_GREATER_THAN_END_TIME_44DD784A =
      "{} {} {} 的开始时间大于结束时间";
  public static final String STORAGE_LOG_THERE_IS_NO_DATA_IN_THE_FILE_F480954E = "{} {} 文件中没有数据";
  public static final String
  ...
  public static final String STORAGE_LOG_CAN_T_READ_FILE_FROM_DISK_F5625609 = "无法从磁盘读取文件 {}";
  ...
  public static final String STORAGE_LOG_FILE_HAS_UNSORTED_DATA_1B118A14 = "文件 {} 存在未排序数据：";
  ...
  public static final String
      STORAGE_LOG_COMPACTION_INSERTIONCROSSSPACECOMPACTION_TASK_FINISHES_SUCCESSFULLY_69360DD0 =
          "{}-{} [Compaction] InsertionCrossSpaceCompaction 任务成功完成，target 文件为 {}，耗时 " + "{} s。";
  public static final String
  ...
  public static final String
      STORAGE_LOG_COMPACTION_CROSSSPACECOMPACTION_TASK_FINISHES_SUCCESSFULLY_D7F1B1FD =
          "{}-{} [Compaction] CrossSpaceCompaction 任务成功完成，耗时 {} s，compaction 速度 " + "为 {} MB/s，{}";
  public static final String
  ...
  public static final String
      STORAGE_LOG_COMPACTION_RECOVER_EXCEPTION_OCCURS_WHILE_DELETING_LOG_FILE_49A24E1D =
  ...
  public static final String
      STORAGE_LOG_COMPACTION_RECOVER_EXCEPTION_OCCURS_WHILE_DELETING_COMPACTION_218A56FB =
  ...
  // 补充异常消息
  // ---------------------------------------------------------------------------
  public static final String STORAGE_EXCEPTION_SYSTEM_REJECTED_OVER_SMS_94CEF932 = "系统拒绝，等待超过 %sms";
  public static final String
  ...
  public static final String STORAGE_EXCEPTION_UNSUPPORTED_DATA_TYPE_S_D16A1E9A = "不支持的数据类型：%s";
  public static final String
  ...
  public static final String STORAGE_EXCEPTION_SOURCE_FILE_S_IS_DELETED_D2ED7D90 = "源文件 %s 已删除";
  ...
  public static final String DEVICE_DOES_NOT_EXIST_IN_RESOURCE_FILE_FMT = "%s 在资源文件中不存在";
  ...
  public static final String DEVICE_TIME_RANGE_VERIFICATION_FAILED_FMT = "设备(%s) 的时间范围校验失败。%s";
  public static final String CURRENT_DEVICE_TIME_RANGE_MISMATCH_FMT = "当前设备时间范围为 %s，应等于实际设备时间范围 %s";
  ...
  public static final String CLOSED_TSFILE_READER_CLOSED = "{} closedTsFileReader 已关闭。";
  public static final String UNCLOSED_TSFILE_READER_CLOSED = "{} unclosedTsFileReader 已关闭。";
  ...
  public static final String
      MESSAGE_NO_LOAD_TSFILE_UUID_ARG_RECORDED_EXECUTE_LOAD_COMMAND_ARG_66722D80 =
          "未记录 Load TsFile uuid %s，执行 Load 命令为 %s。";
  public static final String
  ...
  public static final String
      MESSAGE_LOAD_QUERY_FALLBACK_FAILED_FOR_DEVICE_ARG_MEASUREMENTS_ARG_IN_TSFILE_ARG_50771955 =
          "Load：设备 {} 测点 {} 在 TsFile {} 中的查询回退失败。";
  public static final String
      MESSAGE_LOAD_FAILED_TO_INITIALIZE_QUERY_FALLBACK_FOR_TSFILE_ARG_AFTER_SCAN_PARSER_FAILURE_143B6037 =
          "Load：scan parser 失败后，TsFile {} 的查询回退初始化失败。";
  public static final String
      MESSAGE_LOAD_SCAN_PARSER_DETECTED_A_CORRUPTED_SECTION_IN_TSFILE_ARG_AT_DEVICE_ARG_E2632421 =
          "Load：scan parser 在 TsFile {} 的设备 {} 处检测到损坏的数据段。";
  public static final String EXCEPTION_EXPECTED_PIPERAWTABLETINSERTIONEVENT_BUT_GOT_D1D1DD05 =
      "期望 PipeRawTabletInsertionEvent，但得到 ";
  public static final String
      MESSAGE_LOAD_FAILED_TO_INITIALIZE_QUERY_FALLBACK_FOR_DEVICE_ARG_MEASUREMENTS_ARG_IN_TSFILE_ARG_0BF15119 =
          "Load：设备 {} 测点 {} 在 TsFile {} 中的查询回退初始化失败。";
  public static final String
