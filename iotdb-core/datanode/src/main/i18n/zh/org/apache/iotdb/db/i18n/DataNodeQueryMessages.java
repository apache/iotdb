...
public final class DataNodeQueryMessages {
  ...
  public static final String NO_MATCHED_DATABASE_PLEASE_CHECK_THE_PATH = "未找到匹配的数据库，请检查路径 ";
  ...
  public static final String MODE_WITH_SLIDINGWINDOW_IS_NOT_SUPPORTED_NOW = "目前不支持 MODE 与滑动窗口组合使用";
  public static final String INVALID_AGGREGATION_TYPE = "无效的聚合类型：";

  // --- Execution / Driver ---

  public static final String QUERYDATASOURCE_SHOULD_NEVER_BE_NULL = "QueryDataSource 不应为 null！";

  // --- Execution / Exchange ---

  public static final String SOURCE_HANDLE_FAILED_DUE_TO = "Source handle 失败，原因：";
  public static final String SINK_FAILED_DUE_TO = "Sink 失败，原因";
  public static final String ISINKCHANNEL_FAILED_DUE_TO = "ISinkChannel 失败，原因";
  public static final String SINK_HANDLE_FAILED_DUE_TO = "Sink handle 失败，原因";
  public static final String MPPDATAEXCHANGEMANAGER_INIT_SUCCESSFULLY =
      "MPPDataExchangeManager 初始化成功";
  public static final String QUEUE_HAS_BEEN_DESTROYED = "队列已被销毁";
  public static final String SINK_HANDLE_IS_BLOCKED = "Sink handle 已被阻塞。";
  public static final String LOCALSINKCHANNEL_IS_ABORTED = "LocalSinkChannel 已中止。";
  public static final String ERROR_OCCURRED_WHEN_TRY_TO_ABORT_CHANNEL = "尝试中止通道时发生错误。";
  public static final String ERROR_OCCURRED_WHEN_TRY_TO_CLOSE_CHANNEL = "尝试关闭通道时发生错误。";
  public static final String SHUFFLESINKHANDLE_IS_ABORTED = "ShuffleSinkHandle 已中止。";
  public static final String UNSUPPORTED_TYPE_OF_SHUFFLE_STRATEGY = "不支持的 shuffle 策略类型";
  public static final String SINKCHANNEL_IS_ABORTED_OR_CLOSED = "SinkChannel 已中止或关闭。";
  public static final String THE_DATA_BLOCK_DOESN_T_EXIST_SEQUENCE_ID = "数据块不存在。序列 ID：";
  public static final String THE_TSBLOCK_DOESNT_EXIST_SEQUENCE_ID_REMAINING =
      "TsBlock 不存在。序列 ID 为 {}，剩余映射为 {}";
  public static final String SINKCHANNEL_IS_ABORTED = "SinkChannel 已中止。";
  public static final String FAILED_TO_SEND_NEW_DATA_BLOCK_EVENT_ATTEMPT = "发送新数据块事件失败，尝试次数：{}";
  public static final String FAILED_TO_SEND_END_OF_DATA_BLOCK_EVENT = "发送数据块结束事件失败，尝试次数：{}";
  public static final String FAILED_TO_SEND_END_OF_DATA_BLOCK_EVENT_2 = "所有重试后仍无法发送数据块结束事件";
  public static final String SOURCE_HANDLE_IS_BLOCKED = "Source handle 已被阻塞。";
  public static final String RESERVED_DATA_BLOCK_SIZE_IS_NULL = "预留的数据块大小为 null。";
  public static final String DATA_BLOCK_SIZE_IS_NULL = "数据块大小为 null。";
  public static final String SOURCE_HANDLE_IS_ABORTED = "Source handle 已中止。";
  public static final String SOURCEHANDLE_IS_CLOSED = "SourceHandle 已关闭。";
  ...
  public static final String WAIT_MS_FOR_ALL_DRIVERS_CLOSED = "等待 {} 毫秒以关闭所有 Driver";
  public static final String EXCEPTION_HAPPENED_WHEN_EXECUTING_UDTF = "执行 UDTF 时发生异常：";
  public static final String ERROR_WHEN_CREATE_FRAGMENTINSTANCEEXECUTION =
      "创建 FragmentInstanceExecution 时出错。";
  public static final String EXECUTE_ERROR_CAUSED_BY = "执行错误，原因：";

  // --- Execution / Memory ---

  public static final String FREE_MORE_MEMORY_THAN_HAS_BEEN_RESERVED = "释放的内存超过已预留的量。";
  ...
  public static final String FOR_QUERY_ENGINE_OPERATOR_MEMORY_POOL = "（用于查询引擎/operator 内存池）";
  ...
  public static final String UNKNOWN_DATA_TYPE_2 = "未知的数据类型 ";
  ...
  public static final String GETWRITTENCOUNT_IS_NOT_SUPPORTED = "不支持 getWrittenCount() 操作";
  public static final String THE_MEMORY_THRESHOLD_MUST_BE_GREATER_THAN_0 = "内存阈值必须大于 0。";
  public static final String FAILED_TO_CREATE_DIRECTORIES = "创建目录失败：";
  public static final String TARGET_FILE_ALREADY_EXISTS = "目标文件已存在：";
  public static final String FAILED_TO_CREATE_FILE = "创建文件失败：";
  public static final String DATA_TYPE_OF_TARGET_TIME_COLUMN_IS_NOT = "目标时间列的数据类型不是 TIMESTAMP";
  public static final String DUPLICATE_COLUMN_NAMES_IN_QUERY_DATASET = "查询数据集中存在重复的列名。";
  public static final String SOME_SPECIFIED_TAG_COLUMNS_ARE_NOT_EXIST_IN = "部分指定的标签列在查询数据集中不存在。";
  public static final String NUMBER_OF_FIELD_COLUMNS_SHOULD_BE_LARGER_THAN = "字段列的数量应大于 0。";
  public static final String ALL_CHILD_SHOULD_HAVE_SAME_TIME_COLUMN_RESULT = "所有子节点应具有相同的时间列结果！";
  public static final String LAST_READ_RESULT_SHOULD_ONLY_HAVE_ONE_RECORD = "Last 读取结果应只有一条记录";
  ...
  public static final String ERROR_OCCURS_WHEN_SCANNING_ACTIVE_TIME_SERIES = "扫描活跃时间序列时发生错误。";
  public static final String ERROR_WHILE_SCANNING_THE_FILE = "扫描文件时发生错误";
  public static final String ERROR_HAPPENED_WHILE_SCANNING_THE_FILE = "扫描文件时发生错误";
  ...
  public static final String ALL_CACHED_CHUNKS_SHOULD_BE_CONSUMED_FIRST = "所有缓存的 chunk 应先被消费";
  public static final String OVERLAPPED_DATA_SHOULD_BE_CONSUMED_FIRST = "重叠数据应先被消费";
  public static final String NO_MORE_BATCH_DATA = "没有更多的批次数据";
  public static final String GETALLSATISFIEDPAGEDATA_SHOULDN_T_BE_CALLED_HERE =
      "此处不应调用 getAllSatisfiedPageData()";
  public static final String GETPAGEREADER_SHOULDN_T_BE_CALLED_HERE = "此处不应调用 getPageReader()";
  public static final String UNSUPPORTED_COLUMN_TYPE = "不支持的列类型：";
  public static final String FAIL_TO_CLOSE_CTEDATAREADER = "关闭 CteDataReader 失败";
  public static final String UNKNOWN_TABLE = "未知的表：";
  public static final String FAILED_TO_CLOSE_READER_IN_TABLEDISKUSAGESUPPLIER =
      "在 TableDiskUsageSupplier 中关闭 reader 失败";
  public static final String UNSUPPORTED_CATEGORY = "不支持的列类别：";
  ...
  public static final String EXTERNAL_TSFILE_DEVICE_TASK_READER_IS_NOT_ALIGNED_WITH_DEVICE_ENTRIES =
      "外部 TsFile 设备任务读取器与设备条目不匹配，索引 %d：期望 %s，实际 %s";
  public static final String FAILED_TO_UPDATE_EXTERNAL_TSFILE_DEVICE_RESOURCES =
      "更新外部 TsFile 设备资源失败";
  public static final String SCHEMA_FILTER_TYPE_IS_NOT_SUPPORTED = "不支持 SchemaFilter 类型 %s";
  public static final String
  ...
  public static final String UNSUPPORTED_INFERENCE_WINDOW_TYPE = "不支持的推理窗口类型：";

  // --- Execution / Schedule ---

  public static final String EXECUTOR_FAILED_TO_POLL_DRIVER_TASK_FROM_QUEUE = "执行器 {} 从队列中获取驱动任务失败";
  public static final String DRIVERTASK_SHOULD_NEVER_BE_NULL = "DriverTask 不应为 null";
  public static final String EXECUTEFAILED = "[执行失败]";
  public static final String EXECUTOR_EXITS_BECAUSE_IT_IS_CLOSED = "执行器 {} 因已关闭而退出。";
  public static final String CLEAR_DRIVERTASK_FAILED = "清除 DriverTask 失败";

  // --- Execution / Warnings ---

  public static final String CODE_IS_NEGATIVE = "code 为负数";

  // --- Metric ---

  public static final String UNSUPPORTED_STAGE_IN_TREE_MODEL = "树模型中不支持的阶段：";
  public static final String UNSUPPORTED_STAGE_IN_TABLE_MODEL = "表模型中不支持的阶段：";
  ...
  public static final String EXPIRED_QUERIES_INFO_CLEAR_THREAD_IS_SUCCESSFULLY_STARTED =
      "过期查询信息清理线程已成功启动。";
  public static final String COST_MS = "耗时：{} 毫秒，{}";

  // --- Plan / Analyze ---

  public static final String COMPUTEDATAPARTITIONPARAMS_FOR = "计算数据分区参数，目标：";
  public static final String UNSUPPORTED_OPERATOR = "不支持的运算符：";
  public static final String UNSUPPORTED_EXPRESSION = "不支持的表达式：";
  public static final String ONLY_SUPPORT_AND_OPERATOR_IN_DELETION = "删除操作仅支持 AND 运算符";
  public static final String LEFT_HAND_EXPRESSION_IS_NOT_AN_IDENTIFIER = "左侧表达式不是标识符：";
  public static final String THE_LEFT_HAND_VALUE_MUST_BE_AN_IDENTIFIER = "左侧值必须是标识符：";
  public static final String THE_TABLE_S_DOES_NOT_CONTAIN_A_TIME_COLUMN = "表 '%s' 不包含时间列";
  public static final String START_TIME_IS_GREATER_THAN_END_TIME = "开始时间 %d 大于结束时间 %d";
  ...
  public static final String THE_OPERATOR_OF_TIME_PREDICATE_MUST_BE_FOR =
      "时间谓词的操作符必须是 <、<=、> 或 >=：";
  public static final String THE_OPERATOR_OF_TAG_PREDICATE_MUST_BE_FOR = "标签谓词的运算符必须为 '='，目标：";
  public static final String
  ...
  public static final String ONLY_TIME_FILTERS_ARE_SUPPORTED_IN_LAST_QUERY = "LAST 查询中仅支持时间过滤器";
  public static final String VIEWS_CANNOT_BE_USED_IN_GROUP_BY_TAGS = "视图暂不支持在 GROUP BY TAGS 查询中使用。";
  public static final String ONLY_TIME_FILTERS_ARE_SUPPORTED_IN_GROUP_BY =
      "GROUP BY TAGS 查询中仅支持时间过滤器";
  public static final String UNSUPPORTED_WINDOW_TYPE = "不支持的窗口类型";
  public static final String AGGREGATION_EXPRESSION_SHOULDN_T_EXIST_IN_GROUP_BY =
      "GROUP BY 子句中不应包含聚合表达式";
  public static final String ONLY_SUPPORT_NUMERIC_TYPE_WHEN_DELTA_0 = "当 delta != 0 时仅支持数值类型";
  public static final String ONLY_SUPPORT_BOOLEAN_TYPE_IN_PREDICT_OF_GROUP =
      "GROUP BY SERIES 的谓词中仅支持布尔类型";
  public static final String GROUP_BY_MONTH_DOESN_T_SUPPORT_ORDER_BY = "按月分组目前不支持按时间降序排列。";
  public static final String NO_RUNNING_DATANODES = "没有运行中的 DataNode";
  public static final String AN_ERROR_OCCURRED_WHEN_SERIALIZING_PATTERN_TREE = "序列化模式树时发生错误";
  ...
  public static final String SHOULDN_T_ATTACH_HERE = "不应在此处附加";
  public static final String SELECT_INTO_THE_I_OF_SHOULD_BE_AN = "SELECT INTO：${i} 中的 i 应为整数。";
  public static final String FAILED_TO_GET_DATABASE_MAP = "获取数据库映射失败";
  ...
  public static final String ASYNC_LOAD_HAS_FAILED_AND_IS_NOW_TRYING = "异步加载失败，正在尝试同步加载";
  public static final String TSFILE_IS_EMPTY = "TsFile {} 为空。";
  public static final String THE_ENCRYPTION_WAY_OF_THE_TSFILE_IS_NOT = "不支持该 TsFile 的加密方式。";
  public static final String EMPTY_FILE_DETECTED_WILL_SKIP_LOADING_THIS_FILE = "检测到空文件，将跳过加载此文件：{}";
  public static final String AUTO_CREATE_OR_VERIFY_SCHEMA_ERROR = "自动创建或验证 schema 出错。";
  ...
  public static final String FAILED_TO_FIND_TAG_COLUMN_MAPPING_FOR_TABLE = "未找到表 {} 的标签列映射";
  public static final String AUTO_CREATE_DATABASE_FAILED_BECAUSE = "自动创建数据库失败，原因：";

  // --- Plan / Execution ---

  public static final String REACHMAXRETRYCOUNT = "[已达最大重试次数]";
  public static final String ERROR_WHEN_EXECUTING_QUERY = "执行查询时出错。{}";
  public static final String WAITBEFORERETRY_WAIT_MS = "[重试前等待] 等待 {} 毫秒。";
  public static final String INTERRUPTED_WHEN_WAITING_RETRY = "等待重试时被中断";
  public static final String RETRY_RETRY_COUNT_IS = "[重试] 重试次数：{}";
  public static final String RESULTHANDLEABORTED = "[结果句柄已中止]";
  public static final String UNSUPPORTED_DATABASE_PROPERTY_KEY = "不支持的数据库属性键：";
  public static final String A_TABLE_CANNOT_HAVE_MORE_THAN_ONE_TIME = "一个表不能有多于一个时间列";
  public static final String THE_TIME_COLUMN_S_TYPE_SHALL_BE_TIMESTAMP = "时间列的类型应为 'timestamp'。";
  public static final String THE_TABLE_S_OLD_NAME_SHALL_NOT_BE = "表的旧名称不应与新名称相同。";
  public static final String ADDING_TIME_COLUMN_IS_NOT_SUPPORTED = "不支持添加 TIME 列。";
  public static final String THE_COLUMN_S_OLD_NAME_SHALL_NOT_BE = "列的旧名称不应与新名称相同。";
  public static final String DUPLICATED_PROPERTY = "重复的属性：";
  public static final String TABLE_PROPERTY = "表属性 '";
  public static final String UNKNOWN_TYPE = "未知的类型：%s";
  public static final String FAILED_TO_CHECK_CONFIG_ITEM_PERMISSION = "检查配置项权限失败";
  public static final String CONFIGTASK_IS_NOT_IMPLEMENTED_FOR = "ConfigTask 未针对以下内容实现：";
  public static final String FAILED_TO_GET_EXECUTABLE_FOR_UDF_USING_URI =
      "无法使用 URI {} 获取 UDF({}) 的可执行文件。";
  public static final String FAILED_TO_DROP_FUNCTION = "[{}] 删除函数 {} 失败。";
  public static final String FAILED_TO_DROP_TRIGGER = "[{}] 删除触发器 {} 失败。";
  public static final String CANNOT_REMOVE_INVALID_NODEIDS = "无法移除无效的节点 ID：{}";
  public static final String STARTING_TO_REMOVE_DATANODE_WITH_NODEIDS = "开始移除 DataNode，节点 ID：{}";
  public static final String START_TO_REMOVE_DATANODE_REMOVED_DATANODES_ENDPOINT =
      "开始移除 DataNode，已移除的 DataNode 端点：{}";
  public static final String SUBMIT_REMOVE_DATANODES_RESULT = "提交移除 DataNode 结果 {} ";
  public static final String STARTING_TO_REMOVE_CONFIGNODE_WITH_NODE_ID =
      "开始移除 ConfigNode，节点 ID：{}";
  public static final String CONFIGNODE_IS_REMOVED = "ConfigNode {} 已移除。";
  public static final String STARTING_TO_REMOVE_AINODE = "开始移除 AINode";
  public static final String REMOVE_AINODE_FAILED_BECAUSE_THERE_IS_NO_AINODE =
      "移除 AINode 失败，因为集群中没有 AINode。";
  public static final String AINODE_IN_THE_CLUSTER_IS_REMOVED = "集群中的 AINode 已移除。";
  public static final String FAILED_TO_HANDLETRANSFERCONFIGPLAN_STATUS_IS =
      "handleTransferConfigPlan 失败，状态为 {}。";
  public static final String FAILED_TO_FETCHTABLES_STATUS_IS = "fetchTables 失败，状态为 {}。";
  ...
  public static final String NOT_SUPPORT_CURRENT_STATEMENT = "不支持当前语句";
  public static final String WRONG_REQUEST_TYPE = "错误的请求类型";
  public static final String WRONG_UNIT_TYPE = "错误的单位类型";

  // --- Plan / Expression ---

  public static final String INVALID_EXPRESSION_TYPE = "无效的表达式类型：";
  public static final String UNSUPPORTED_EXPRESSION_TYPE = "不支持的表达式类型：";
  public static final String FUNCTION_CAST_MUST_SPECIFY_A_TARGET_DATA_TYPE = "CAST 函数必须指定目标数据类型。";
  public static final String FUNCTION_REPLACE_MUST_SPECIFY_FROM_AND_TO_COMPONENT =
      "REPLACE 函数必须指定 from 和 to 参数。";
  public static final String PLEASE_ENSURE_INPUT_IS_CORRECT = "请确保输入 [%s] 正确";
  public static final String CASE_EXPRESSION_CANNOT_BE_USED_WITH_NON_MAPPABLE =
      "CASE 表达式不能与非映射型 UDF 一起使用";
  public static final String UNSUPPORTED_TRANSFORMER_ACCESS_STRATEGY = "不支持的转换器访问策略";
  public static final String AGGREGATE_FUNCTIONS_ARE_NOT_SUPPORTED_IN_WHERE_CLAUSE =
      "WHERE 子句中不支持聚合函数";
  public static final String IS_NULL_CANNOT_BE_PUSHED_DOWN = "IS NULL 不能下推";
  ...
  public static final String IS_NULL_CAN_BE_PUSHED_DOWN = "IS NULL 可以下推";
  public static final String GROUP_BY_TIME_CANNOT_BE_REVERSED = "GROUP BY TIME 不能反转";

  // --- Plan / Optimization ---

  public static final String UNEXPECTED_PLAN_NODE = "意外的计划节点：";
  public static final String UNEXPECTED_PATH_TYPE = "意外的路径类型";
  public static final String SOURCEPATH_MUST_BE_MEASUREMENTPATH_OR_ALIGNEDPATH =
      "sourcePath 必须为 MeasurementPath 或 AlignedPath";

  // --- Plan / Parser ---

  public static final String DATATYPE_MUST_BE_DECLARED = "必须声明数据类型";
  public static final String UNSUPPORTED_ENCODING = "不支持的编码：%s";
  public static final String UNSUPPORTED_COMPRESSION = "不支持的压缩方式：%s";
  public static final String UNSUPPORTED_ENCODING_2 = "不支持的编码：%s";
  public static final String UNSUPPORTED_COMPRESSOR = "不支持的压缩器：%s";
  public static final String CREATE_ALIGNED_TIMESERIES_PROPERTY_IS_NOT_SUPPORTED_YET =
      "创建对齐时间序列：暂不支持 property。";
  public static final String UNSUPPORTED_COMPRESSOR_2 = "不支持的压缩器：%s";
  public static final String PROPERTY_IS_UNSUPPORTED_YET = "暂不支持属性 %s。";
  public static final String THE_TIMESERIES_SHALL_NOT_BE_ROOT = "时间序列不应为 root。";
  public static final String UNSUPPORTED_DATATYPE = "不支持的数据类型：%s";
  public static final String UNEXPECTED_FILTER_KEY = "意外的过滤键";
  public static final String URI_IS_EMPTY_PLEASE_SPECIFY_THE_URI = "URI 为空，请指定 URI。";
  public static final String INVALID_URI = "无效的 URI：%s";
  ...
  public static final String RENAMING_VIEW_IS_NOT_SUPPORTED = "不支持重命名视图。";
  public static final String VIEW_DOESN_T_SUPPORT_ALIAS = "视图不支持别名。";
  public static final String MODELID_SHOULD_BE_2_64_CHARACTERS = "ModelId 应为 2-64 个字符";
  public static final String MODELID_SHOULD_NOT_START_WITH = "ModelId 不应以 '_' 开头";
  public static final String MODELID_CAN_ONLY_CONTAIN_LETTERS_NUMBERS_AND_UNDERSCORES =
      "ModelId 只能包含字母、数字和下划线";
  public static final String DEVICE_ID_SHOULD_BE_CPU_OR_INTEGER = "设备 ID 应为 'cpu' 或整数";
  public static final String DATA_SHOULD_NOT_BE_SET_FOR_MODEL_TRAINING = "模型训练时不应设置数据";
  public static final String DUPLICATED_GROUP_BY_KEY_LEVEL = "重复的 GROUP BY 键：LEVEL";
  public static final String DUPLICATED_GROUP_BY_KEY_TAGS = "重复的 GROUP BY 键：TAGS";
  public static final String UNKNOWN_GROUP_BY_TYPE = "未知的 GROUP BY 类型。";
  public static final String DUPLICATE_ALIAS_IN_SELECT_CLAUSE = "SELECT 子句中存在重复的别名";
  public static final String CONSTANT_OPERAND_IS_NOT_ALLOWED = "不允许使用常量操作数：";
  public static final String THE_TIME_WINDOWS_MAY_EXCEED_10000_PLEASE_ENSURE =
      "时间窗口可能超过 10000 个，请确认输入。";
  public static final String START_TIME_SHOULD_BE_SMALLER_THAN_ENDTIME_IN = "GroupBy 中的起始时间应小于结束时间";
  public static final String KEEP_THRESHOLD_IN_GROUP_BY_CONDITION_SHOULD_BE =
      "应设置 GROUP BY 条件中的保持阈值";
  public static final String DUPLICATED_KEY_IN_GROUP_BY_TAGS = "GROUP BY TAGS 中存在重复的键：";
  public static final String UNKNOWN_FILL_TYPE = "未知的 FILL 类型。";
  public static final String UNSUPPORTED_CONSTANT_VALUE_IN_FILL = "FILL 中不支持的常量值：";
  public static final String OUT_OF_RANGE_LIMIT_N_N_SHOULD_BE = "超出范围。LIMIT <N>：N 应为 Int64。";
  public static final String LIMIT_N_N_SHOULD_BE_GREATER_THAN_0 = "LIMIT <N>：N 应大于 0。";
  public static final String OFFSET_OFFSETVALUE_OFFSETVALUE_SHOULD_0 =
      "OFFSET <OFFSETValue>：OFFSETValue 应 >= 0。";
  public static final String OUT_OF_RANGE_SLIMIT_SN_SN_SHOULD_BE = "超出范围。SLIMIT <SN>：SN 应为 Int32。";
  public static final String SLIMIT_SN_SN_SHOULD_BE_GREATER_THAN_0 = "SLIMIT <SN>：SN 应大于 0。";
  public static final String SOFFSET_SOFFSETVALUE_SOFFSETVALUE_SHOULD_0 =
      "SOFFSET <SOFFSETValue>：SOFFSETValue 应 >= 0。";
  public static final String ONE_ROW_SHOULD_ONLY_HAVE_ONE_TIME_VALUE = "一行数据应只有一个时间值";
  public static final String INSERTSTATEMENT_SHOULD_CONTAIN_AT_LEAST_ONE_MEASUREMENT =
      "InsertStatement 应至少包含一个测点";
  public static final String NEED_TIMESTAMPS_WHEN_INSERT_MULTI_ROWS = "插入多行时需要时间戳";
  public static final String CAN_NOT_PARSE_TO_TIME = "无法将 %s 解析为时间";
  public static final String PATH_CAN_NOT_START_WITH_ROOT_IN_SELECT = "SELECT 子句中的路径不能以 root 开头。";
  public static final String INPUT_TIMESTAMP_CANNOT_BE_EMPTY = "输入时间戳不能为空";
  public static final String NOT_SUPPORT_FOR_THIS_ALIAS_PLEASE_ENCLOSE_IN = "不支持此别名，请使用反引号括起来。";
  public static final String STATEMENT_NEEDS_TARGET_PATHS = "语句需要目标路径";
  public static final String THE_DATATYPE_OF_TIMESTAMP_SHOULD_BE_LONG = "时间戳的数据类型应为 LONG。";
  public static final String ATTRIBUTES_OF_FUNCTIONS_SHOULD_BE_QUOTED_WITH_OR =
      "函数的属性应使用 '' 或 \"\" 引起来";
  public static final String UNSUPPORTED_CONSTANT_VALUE = "不支持的常量值：";
  public static final String UNSUPPORTED_CONSTANT_OPERAND = "不支持的常量操作数：";
  public static final String UNKNOWN_SYSTEM_STATUS_IN_SET_SYSTEM_COMMAND = "SET SYSTEM 命令中的系统状态未知。";
  public static final String DEVICE_TEMPLATE_ALIAS_IS_NOT_SUPPORTED_YET = "设备模板：暂不支持别名。";
  public static final String DEVICE_TEMPLATE_PROPERTY_IS_NOT_SUPPORTED_YET = "设备模板：暂不支持属性。";
  public static final String DEVICE_TEMPLATE_TAG_IS_NOT_SUPPORTED_YET = "设备模板：暂不支持标签。";
  public static final String DEVICE_TEMPLATE_ATTRIBUTE_IS_NOT_SUPPORTED_YET = "设备模板：暂不支持属性。";
  public static final String EXPECTING_DATATYPE = "需要数据类型";
  public static final String NOT_SUPPORT_FOR_THIS_SQL_IN_DROP_PIPE = "DROP PIPE 不支持此 SQL，请输入管道名。";
  public static final String NOT_SUPPORT_FOR_THIS_SQL_IN_START_PIPE = "START PIPE 不支持此 SQL，请输入管道名。";
  public static final String NOT_SUPPORT_FOR_THIS_SQL_IN_STOP_PIPE = "STOP PIPE 不支持此 SQL，请输入管道名。";
  ...
  public static final String WRONG_SPACE_QUOTA_TYPE = "错误的空间配额类型：";
  public static final String PLEASE_SET_THE_NUMBER_OF_DEVICES_GREATER_THAN = "请将设备数设置为大于 0";
  public static final String PLEASE_SET_THE_NUMBER_OF_TIMESERIES_GREATER_THAN = "请将时间序列数设置为大于 0";
  public static final String CANNOT_SET_THROTTLE_QUOTA_FOR_USER_ROOT = "不能为 root 用户设置限流配额。";
  public static final String PLEASE_SET_THE_NUMBER_OF_REQUESTS_GREATER_THAN = "请将请求数设置为大于 0";
  public static final String PLEASE_SET_THE_NUMBER_OF_CPU_GREATER_THAN = "请将 CPU 数量设置为大于 0";
  public static final String PLEASE_SET_THE_SIZE_GREATER_THAN_0 = "请将大小设置为大于 0";
  public static final String PLEASE_SET_THE_DISK_SIZE_GREATER_THAN_0 = "请将磁盘大小设置为大于 0";
  public static final String THERE_SHOULD_BE_ONLY_ONE_WINDOW_IN_CALL = "CALL INFERENCE 中应只有一个窗口。";
  public static final String THE_CREATETABLEVIEW_IS_UNSUPPORTED_IN_TREE_SQL_DIALECT =
      "树模型 SQL 方言中不支持 'CreateTableView'。";
  public static final String CURRENTLY_OTHER_EXPRESSIONS_ARE_NOT_SUPPORTED = "目前不支持其他表达式";
  public static final String ALIGN_DESIGNATION_INCORRECT_AT = "对齐指定不正确，位于：";

  // --- Plan / Relational / Analyzer ---

  public static final String COLUMN_NOT_IN_GROUP_BY_CLAUSE = "列 %s 不在 GROUP BY 子句中";
  public static final String DATABASE_IS_NOT_SPECIFIED_FOR_INSERT = "未指定插入操作的数据库：";
  public static final String IDENTIFIER_NOT_ALLOWED_IN_THIS_CONTEXT = "此上下文中不允许 <identifier>.*";
  public static final String UNKNOWN_SIGN = "未知的符号：";
  public static final String DECIMALLITERAL_IS_NOT_SUPPORTED_YET = "暂不支持 DecimalLiteral。";
  public static final String GENERICLITERAL_IS_NOT_SUPPORTED_YET = "暂不支持 GenericLiteral。";
  public static final String DISTINCT_IS_NOT_SUPPORTED_FOR_NON_AGGREGATION_FUNCTIONS =
      "非聚合函数不支持 DISTINCT";
  public static final String UNEXPECTED_PATTERN_RECOGNITION_FUNCTION = "意外的模式识别函数 ";
  public static final String THE_INPUT_ARGUMENT_DOES_NOT_EXIST = "输入参数不存在";
  public static final String MATCH_NUMBER_PATTERN_RECOGNITION_FUNCTION_TAKES_NO_ARGUMENTS =
      "MATCH_NUMBER 模式识别函数不接受参数";
  public static final String UNEXPECTED_NAVIGATION_ANCHOR = "意外的导航锚点：";
  public static final String UNEXPECTED_MODE = "意外的模式：";
  public static final String QUERY_TAKES_NO_PARAMETERS = "查询不接受参数";
  public static final String NO_VALUE_PROVIDED_FOR_PARAMETER = "未提供参数值";
  public static final String CANNOT_EXTRACT_FROM = "无法从 %s 中提取";
  public static final String UNKNOWN_IS_NOT_A_VALID_TYPE = "UNKNOWN 不是有效的类型";
  public static final String CANNOT_CAST_TO = "无法将 %s 转换为 %s";
  ...
  public static final String UNSUPPORTED_FRAME_TYPE = "不支持的帧类型：";
  public static final String COLUMNS_ONLY_SUPPORT_TO_BE_USED_IN_SELECT =
      "Columns 仅支持在 SELECT 和 WHERE 子句中使用";
  public static final String TYPE_MISMATCH_FMT = "%s：%s 与 %s";
  public static final String UNKNOWN_PATTERN_RECOGNITION_FUNCTION = "未知的模式识别函数：";
  public static final String CANNOT_ACCESS_PREANALYZED_TYPES = "无法访问预分析类型";
  public static final String CANNOT_ACCESS_RESOLVED_WINDOWS = "无法访问已解析的窗口";
  public static final String REFERENCE_IS_AMBIGUOUS = "引用 '%s' 有歧义";
  public static final String COLUMN_IS_AMBIGUOUS = "列 '%s' 有歧义";
  ...
  public static final String SHOW_TABLES_STATEMENT_IS_NOT_SUPPORTED_YET = "暂不支持 Show Tables 语句。";
  public static final String DESCRIBE_TABLE_STATEMENT_IS_NOT_SUPPORTED_YET =
      "暂不支持 Describe Table 语句。";
  public static final String ADD_COLUMN_STATEMENT_IS_NOT_SUPPORTED_YET = "暂不支持 Add Column 语句。";
  public static final String CREATE_INDEX_STATEMENT_IS_NOT_SUPPORTED_YET = "暂不支持 Create Index 语句。";
  public static final String DROP_INDEX_STATEMENT_IS_NOT_SUPPORTED_YET = "暂不支持 Drop Index 语句。";
  public static final String SHOW_INDEX_STATEMENT_IS_NOT_SUPPORTED_YET = "暂不支持 Show Index 语句。";
  public static final String UPDATE_CAN_ONLY_SPECIFY_ATTRIBUTE_COLUMNS = "UPDATE 只能指定属性列。";
  ...
  public static final String USE_STATEMENT_IS_NOT_SUPPORTED_YET = "暂不支持 USE 语句。";
  public static final String TARGET_TABLE_SCHEMA_MISSES_A_TIME_CATEGORY_COLUMN =
      "目标表结构缺少 TIME 类别的列";
  public static final String TIME_COLUMN_CAN_NOT_BE_NULL = "时间列不能为 null";
  public static final String NO_FIELD_COLUMN_PRESENT = "没有 Field 列";
  public static final String FETCH_FIRST_WITH_TIES_CLAUSE_REQUIRES_ORDER_BY =
      "FETCH FIRST WITH TIES 子句需要 ORDER BY";
  public static final String RECURSIVE_CTE_IS_NOT_SUPPORTED_YET = "暂不支持递归 CTE。";
  public static final String MISSING_COLUMN_ALIASES_IN_RECURSIVE_WITH_QUERY = "递归 WITH 查询中缺少列别名";
  public static final String NESTED_RECURSIVE_WITH_QUERY = "嵌套的递归 WITH 查询";
  public static final String THERE_IS_AT_LEAST_ONE_RESULT_OF_EXPANDED = "至少存在一个展开后的结果";
  public static final String UNSUPPORTED_EXPRESSION_2 = "不支持的表达式：";
  public static final String RELATION_NOT_FOUND_OR_NOT_ALLOWED = "关系未找到或不允许访问";
  public static final String COLUMNS_NOT_ALLOWED_FOR_RELATION_THAT_HAS_NO = "无列的关系不允许使用 COLUMNS";
  public static final String UNKNOWN_COLUMNNAME = "未知的列名：";
  public static final String INVALID_REGEX = "无效的正则表达式 '%s'";
  public static final String COLUMNS_ARE_NOT_SUPPORTED_IN_DEREFERENCEEXPRESSION =
      "DereferenceExpression 中不支持 Columns";
  public static final String SELECT_NOT_ALLOWED_FROM_RELATION_THAT_HAS_NO = "不允许对无列的关系使用 SELECT *";
  public static final String COLUMN_ALIASES_NOT_SUPPORTED = "不支持列别名";
  ...
  public static final String PATTERN_RECOGNITION_OUTPUT_TABLE_HAS_NO_COLUMNS = "模式识别输出表没有列";
  public static final String NATURAL_JOIN_NOT_SUPPORTED = "不支持自然连接";
  public static final String UNKNOWN_FILL_METHOD = "未知的填充方法：";
  public static final String RECURSIVE_REFERENCE_IN_INTERSECT_ALL = "INTERSECT ALL 中存在递归引用";
  public static final String TABLE_PROPERTY_2 = "表属性 ";
  public static final String THE_DATABASE_MUST_BE_SET = "必须设置数据库。";
  public static final String AT_MOST_ONE_TABLE_ARGUMENT_CAN_BE_PASSED = "最多只能向表函数传递一个表参数";
  public static final String DUPLICATE_ARGUMENT_NAME = "重复的参数名：%s";
  public static final String SETTING_MONTHLY_INTERVALS_IS_NOT_SUPPORTED = "不支持设置按月间隔。";
  public static final String FILTER_PUSH_DOWN_DOES_NOT_SUPPORT_CASE_WHEN = "过滤下推不支持 CASE WHEN";
  public static final String FILTER_PUSH_DOWN_DOES_NOT_SUPPORT_IF = "过滤下推不支持 IF";
  public static final String FILTER_PUSH_DOWN_DOES_NOT_SUPPORT_NULLIF = "过滤下推不支持 NULLIF";
  public static final String EXPRESSION_SHOULD_BE_NUMERIC_ACTUAL_IS = "表达式应为数值类型，实际为 ";
  public static final String TIMESTAMP_DOES_NOT_SUPPORT_IS_NULL = "TIMESTAMP 不支持 IS NULL";
  public static final String TIMESTAMP_DOES_NOT_SUPPORT_IS_NOT_NULL = "TIMESTAMP 不支持 IS NOT NULL";
  public static final String TIMESTAMP_DOES_NOT_SUPPORT_LIKE = "TIMESTAMP 不支持 LIKE";
  public static final String TIMESTAMP_DOES_NOT_CASE_WHEN = "TIMESTAMP 不支持 CASE WHEN";
  public static final String TIMESTAMP_DOES_NOT_IF = "TIMESTAMP 不支持 IF";
  public static final String TIMESTAMP_DOES_NOT_NULLIF = "TIMESTAMP 不支持 NULLIF";
  public static final String SHOULD_NEVER_RETURN_NULL = "不应返回 null。";
  public static final String IS_NULL_EXPRESSION_CAN_T_BE_PUSHED_DOWN = "IS NULL 表达式不能下推";
  public static final String NOT_EXPRESSION_CAN_T_BE_PUSHED_DOWN = "NOT 表达式不能下推";
  public static final String UNSUPPORTED_OPERATOR_2 = "不支持的运算符 ";
  public static final String THE_LOGICAL_EXPRESSION_HAS_NO_BOUNDED_COLUMN = "逻辑表达式没有绑定的列";
  public static final String THE_NOT_EXPRESSION_HAS_NO_BOUNDED_COLUMN = "NOT 表达式没有绑定的列";

  // --- Plan / Relational / Metadata ---
  public static final String OBJECT_TYPE_IS_NOT_SUPPORTED_AS_RETURN_TYPE = "不支持 OBJECT 类型作为返回值类型";
  public static final String INVALID_FUNCTION_PARAMETERS = "无效的函数参数：";
  public static final String UNKNOWN_FUNCTION = "未知的函数：";
  public static final String THE_OBJECT_TYPE_COLUMN_IS_NOT_SUPPORTED = "不支持 object 类型的列。";
  public static final String NO_COLUMN_OTHER_THAN_TIME_PRESENT_PLEASE_CHECK = "除时间列外没有其他列，请检查请求";
  public static final String NO_FIELD_COLUMN_PRESENT_PLEASE_CHECK_THE_REQUEST = "没有 Field 列，请检查请求";
  public static final String AUTO_ADD_TABLE_COLUMN_FAILED = "自动添加表列失败。";
  public static final String TAG_COLUMN_ONLY_SUPPORT_DATA_TYPE_STRING = "标签列仅支持 STRING 数据类型。";
  public static final String ATTRIBUTE_COLUMN_ONLY_SUPPORT_DATA_TYPE_STRING = "属性列仅支持 STRING 数据类型。";
  public static final String UNSUPPORTED_EXTERNAL_TSFILE_DEVICE_FILTER = "不支持的外部 TsFile 设备过滤器：";

  // --- Plan / Relational / Table Function ---

  public static final String NO_TABLE_SCHEMA_FOUND_IN_TSFILES = "TsFile 中未找到表结构";
  public static final String NO_TABLE_SCHEMA_FOUND_FOR_TABLE_IN_TSFILES = "TsFile 中未找到表 %s 的表结构";
  ...
  public static final String MISSING_SCALAR_ARGUMENT = "缺少标量参数：";
  public static final String ARGUMENT_SHOULD_NOT_BE_EMPTY = "参数 %s 不应为空";
  public static final String INVALID_SCALAR_ARGUMENT = "无效的标量参数：";
  public static final String ARGUMENT_SHOULD_BE_A_STRING = "参数 %s 应为字符串";
  public static final String ARGUMENT_SHOULD_BE_A_NUMBER = "参数 %s 应为数字";
  public static final String ARGUMENT_SHOULD_CONTAIN_AT_LEAST_ONE_PATH = "参数 %s 应至少包含一个路径";
  public static final String READ_TSFILE_PATH_IS_NOT_ALLOWED =
      "不允许 readTsFile 路径 %s，因为它可能访问 IoTDB 数据目录 %s";
  public static final String OUTPUT_COLUMN_NAMES_AND_TYPES_SIZE_MISMATCH = "输出列名和类型数量不匹配";
  public static final String OUTPUT_COLUMN_NAMES_AND_CATEGORIES_SIZE_MISMATCH = "输出列名和类别数量不匹配";
  ...
  public static final String TSFILE_PATH_DOES_NOT_EXIST = "TsFile 路径不存在：";
  public static final String TSFILE_PATH_IS_NEITHER_A_FILE_NOR_A_DIRECTORY = "TsFile 路径既不是文件也不是目录：";
  public static final String NO_VALID_TSFILES_FOUND = "未找到有效的 TsFile";
  public static final String FAILED_TO_SCAN_TSFILE_PATH = "扫描 TsFile 路径失败：";
  ...
  public static final String FILE_IS_NOT_A_VALID_TSFILE = "文件不是有效的 TsFile：";
  public static final String FAILED_TO_READ_TABLE_SCHEMA_FROM_TSFILE = "从 TsFile 读取表结构失败：";
  public static final String MULTIPLE_TIME_COLUMNS_FOUND_WHEN_MERGING_TABLE_SCHEMA =
      "合并表结构时发现多个时间列，表：";
  public static final String TIME_COLUMN_CONFLICTS_WHEN_MERGING_TABLE_SCHEMA = "合并表结构时时间列冲突，表：";
  public static final String TAG_COLUMNS_CONFLICT_WHEN_MERGING_TABLE_SCHEMA = "合并表结构时标签列冲突，表：";
  ...
  public static final String UNKNOWN_EXTERNAL_TSFILE_DEVICE_TASK_PARTITION = "未知的外部 TsFile 设备任务分区：";
  public static final String EXTERNAL_TSFILE_QUERY_RESOURCE_HAS_BEEN_CLOSED = "外部 TsFile 查询资源已关闭：";
  ...
  public static final String FAIL_TO_MATERIALIZE_CTE_BECAUSE = "物化 CTE 失败，原因：{}";
  public static final String BOTH_OBJECT_MUST_BE_TYPE_OF_NUMBER = "两个对象都必须为数值类型";
  public static final String NOT_YET_IMPLEMENTED = "尚未实现：";
  public static final String UNSUPPORTED_TYPE_IN_GENERICLITERAL = "GenericLiteral 中不支持的类型：";
  public static final String CANNOT_COERCE_TYPE = "无法将类型 ";
  public static final String UNKNOWN_TYPE_2 = "未知的类型：";
  public static final String NODE_MUST_BE_A_LITERAL = "节点必须为 Literal";
  public static final String UNHANDLED_LITERAL_TYPE = "未处理的字面量类型：";
  public static final String NO_LITERAL_FORM_FOR_TYPE = "类型 %s 没有字面量形式";
  public static final String WINDOW_FRAME_OFFSET_VALUE_MUST_NOT_BE_NEGATIVE = "窗口帧偏移值不能为负数或 null";
  public static final String UNEXPECTED_TYPE = "意外的类型：";
  public static final String FROM_CLAUSE_MUST_NOT_BE_EMPTY = "FROM 子句不能为空";
  public static final String COERCION_RESULT_IN_ANALYSIS_ONLY_CAN_BE_EMPTY = "分析中的类型转换结果只能为空";
  public static final String UNEXPECTED_RECURSIVE_CTE = "意外的递归 CTE";
  public static final String TABLE = "表 ";
  public static final String UNEXPECTED_JOIN_TYPE = "意外的 Join 类型：";
  public static final String UNEXPECTED_ROWS_PER_MATCH = "意外的 rowsPerMatch：";
  public static final String UNEXPECTED_SKIP_TO_POSITION = "意外的 skipTo 位置：";
  public static final String VALUES_IS_NOT_SUPPORTED_IN_CURRENT_VERSION = "当前版本不支持 Values。";
  public static final String SUBSCRIPT_IS_NOT_SUPPORTED_IN_CURRENT_VERSION = "当前版本不支持下标操作";
  public static final String READ_TSFILE_TABLE_FUNCTION_HANDLE_IS_INVALID = "readTsFile 表函数句柄无效";
  ...
  public static final String UNSUPPORTED_LOGICALEXPRESSION_OPERATOR = "不支持的逻辑表达式运算符";
  public static final String UNEXPECTED_EXPRESSION = "意外的表达式：";
  public static final String FAILED_TO_FETCH_SUBQUERY_RESULT = "获取子查询结果失败。";

  // --- Plan / Relational / Planner / Iterative ---

  public static final String UNEXPECTED_PATTERN = "意外的 Pattern：";
  public static final String TABLE_FUNCTION_DOES_NOT_SUPPORT_MULTIPLE_SOURCE_NOW = "表函数目前不支持多个数据源。";
  ...
  public static final String NOT_SUPPORTED_YET = "暂不支持。";
  public static final String COPYTONODE_SHOULD_NOT_BE_SERIALIZED = "CopyToNode 不应被序列化";
  public static final String
  ...
  public static final String UNSUPPORTED_JOIN_TYPE = "不支持的 Join 类型：";
  public static final String TOPK_IS_NOT_SUPPORTED_IN_CORRELATED_SUBQUERY_FOR =
      "目前不支持在关联子查询中使用 TopK";
  public static final String UNEXPECTED_VALUE = "意外的值：";

  // --- Plan / Relational / Security ---

  public static final String USER_NOT_EXISTS = "用户不存在";
  public static final String ONLY_THE_SUPERUSER_CAN_ALTER_HIM_HERSELF = "仅超级用户可以修改自身信息。";
  public static final String DATABASE = "数据库 ";
  public static final String TABLE_2 = "表 ";
  public static final String UNEXPECTED_VALUE_2 = "意外的值：";
  public static final String EACH_OPERATION_SHOULD_HAVE_PERMISSION_CHECK = "每个操作都应进行权限检查。";
  public static final String UNKNOWN_AUTHORTYPE = "未知的授权类型：";

  // --- Plan / Relational / SQL ---

  public static final String UNKNOWN_AUTHORTYPE_2 = "未知的授权类型：";
  public static final String THE_RENAMING_FOR_BASE_TABLE_COLUMN_IS_CURRENTLY = "目前不支持重命名基表列";
  public static final String THE_RENAMING_FOR_BASE_TABLE_IS_CURRENTLY_UNSUPPORTED = "目前不支持重命名基表";
  public static final String UNEXPECTED_EXPRESSION_2 = "意外的表达式：";
  public static final String THE_TABLE_SHOULD_ONLY_HAVE_ONE_COLUMN_FOUND = "表中应只有一个 TIME 类别的列";
  public static final String TIMESTAMP_CANNOT_BE_NULL = "时间戳不能为 null";
  public static final String SHOW_REGION_ID_IS_NOT_SUPPORTED_YET = "暂不支持 SHOW REGION ID。";
  public static final String SHOW_TIME_SLOT_IS_NOT_SUPPORTED_YET = "暂不支持 SHOW TIME SLOT。";
  public static final String COUNT_TIME_SLOT_IS_NOT_SUPPORTED_YET = "暂不支持 COUNT TIME SLOT。";
  public static final String SHOW_SERIES_SLOT_IS_NOT_SUPPORTED_YET = "暂不支持 SHOW SERIES SLOT。";
  public static final String MISSING_LIMIT_VALUE = "缺少 LIMIT 值";
  public static final String DATABASE_IS_NOT_SET_YET = "尚未设置数据库。";
  public static final String AUTHOR_STATEMENT_PARSER_ERROR = "授权语句解析错误";
  public static final String UNSUPPORTED_SET_OPERATION = "不支持的集合操作：";
  public static final String UNSUPPORTED_JOIN_CRITERIA = "不支持的 join 条件";
  public static final String TOLERANCE_IN_ASOF_JOIN_ONLY_SUPPORTS_INNER_TYPE =
      "ASOF JOIN 中的容差目前仅支持 INNER 类型";
  public static final String UNSUPPORTED_SIGN = "不支持的符号：";
  public static final String UNSUPPORTED_WINDOW_FRAME_TYPE = "不支持的窗口帧类型：";
  public static final String UNSUPPORTED_BOUNDED_TYPE = "不支持的边界类型：";
  public static final String UNSUPPORTED_TRIM_SPECIFICATION = "不支持的 TRIM 规范：";
  public static final String TARGET_DATA_IN_SQL_SHOULD_BE_SET_IN = "SQL 中的目标数据应在 CREATE MODEL 中设置";
  public static final String THE_TREE_MODEL_DATABASE_SHALL_NOT_BE_SPECIFIED = "表模型中不应指定树模型数据库。";
  public static final String UNSUPPORTED_SPECIAL_FUNCTION = "不支持的特殊函数：";
  public static final String UNSUPPORTED_ORDERING = "不支持的排序方式：";
  public static final String UNSUPPORTED_QUANTIFIER = "不支持的量词：";
  public static final String NOT_YET_IMPLEMENTED_WILDCARD_TRANSITION = "尚未实现：通配符转换";
  public static final String UNKNOWN_TABLE_ELEMENT = "未知的表元素：";

  // --- Plan / Scheduler ---

  public static final String ERROR_HAPPENED_WHILE_FETCHING_QUERY_STATE = "获取查询状态时发生错误";
  public static final String INTERRUPTED_WHEN_DISPATCHING_READ_ASYNC = "异步分发读取操作时被中断";
  public static final String INTERRUPTED_WHEN_DISPATCHING_WRITE_ASYNC = "异步分发写入操作时被中断";
  public static final String DESERIALIZE_CONSENSUSGROUPID_FAILED = "反序列化 ConsensusGroupId 失败。";
  public static final String CAN_T_CONNECT_TO_NODE = "无法连接到节点 {}";
  public static final String CANCEL_QUERY_ON_NODE_FAILED = "在节点 {} 上取消查询 {} 失败。";
  public static final String CANNOT_DISPATCH_FI_FOR_LOAD_OPERATION = "无法为加载操作分发 FI";
  public static final String MESSAGE_UNEXPECTED_ERRORS_ARG_78EE0800 = "意外错误：%s";
  public static final String RECEIVE_LOAD_NODE_FROM_UUID = "接收来自 uuid {} 的加载节点。";
  public static final String LOAD_TSFILE_NODE_ERROR = "加载 TsFile 节点 {} 出错。";
  public static final String SERIALIZE_TSFILERESOURCE_ERROR = "序列化 TsFileResource {} 出错。";
  public static final String LOAD_SKIP_TSFILE_BECAUSE_IT_HAS_NO_DATA = "跳过加载 TsFile {}，因为没有数据。";
  public static final String LOADTSFILESCHEDULER_LOADS_TSFILE_ERROR =
      "LoadTsFileScheduler 加载 TsFile {} 出错";
  public static final String INTERRUPT_OR_EXECUTION_ERROR = "中断或执行错误。";
  public static final String START_DISPATCHING_LOAD_COMMAND_FOR_UUID = "开始分发 uuid {} 的加载命令";
  public static final String EXCEPTION_OCCURRED_DURING_SECOND_PHASE_OF_LOADING_TSFILE =
      "加载 TsFile {} 的第二阶段发生异常。";
  public static final String START_LOAD_TSFILE_LOCALLY = "开始本地加载 TsFile {}。";
  public static final String LOAD_ALL_FAILED_TSFILES_ARE_CONVERTED_TO_TABLETS =
      "加载：所有失败的 TsFile 已转换为 Tablet 并插入。";

  // --- Plan / Statement ---

  public static final String METHOD_NOT_IMPLEMENTED_YET = "方法尚未实现";
  public static final String INSERTION_CONTAINS_DUPLICATED_MEASUREMENT = "插入操作包含重复的测点：";
  ...
  public static final String MODEL_INFERENCE_DOES_NOT_SUPPORT_ALIGN_BY_DEVICE = "模型推理目前不支持按设备对齐。";
  ...
  public static final String GROUP_BY_TAGS_DOES_NOT_SUPPORT_ALIGN_BY = "GROUP BY TAGS 目前不支持按设备对齐。";
  public static final String HAVING_CLAUSE_IS_NOT_SUPPORTED_YET_IN_GROUP =
      "GROUP BY TAGS 查询中暂不支持 HAVING 子句";
  public static final String OUTPUT_COLUMN_IS_DUPLICATED_WITH_THE_TAG_KEY = "输出列与标签键重复：";
  public static final String LIMIT_OR_SLIMIT_ARE_NOT_SUPPORTED_YET_IN =
      "GROUP BY TAGS 中暂不支持 LIMIT 或 SLIMIT";
  public static final String EXPRESSION_OF_HAVING_CLAUSE_MUST_TO_BE_AN = "HAVING 子句的表达式必须是聚合函数";
  public static final String WHEN_HAVING_USED_WITH_GROUPBYLEVEL = "当 HAVING 与 GroupByLevel 一起使用时：";
  public static final String ALIGN_BY_DEVICE = "按设备对齐：";
  public static final String SORTING_BY_TIMESERIES_IS_ONLY_SUPPORTED_IN_LAST =
      "按时间序列排序仅在 LAST 查询中支持。";
  public static final String LAST_QUERY_DOESN_T_SUPPORT_ALIGN_BY_DEVICE = "LAST 查询不支持按设备对齐。";
  public static final String LAST_QUERIES_CAN_ONLY_BE_APPLIED_ON_RAW = "LAST 查询只能应用于原始时间序列。";
  ...
  public static final String UNKNOWN_LITERAL_TYPE = "未知的字面量类型：%s";
  public static final String ILLEGAL_PATH = "非法路径：{}";
  public static final String CQ_THE_START_TIME_OFFSET_SHOULD_BE_GREATER = "连续查询：起始时间偏移量应大于 0。";
  public static final String CQ_THE_END_TIME_OFFSET_SHOULD_BE_GREATER = "连续查询：结束时间偏移量应大于或等于 0。";
  public static final String CQ_THE_QUERY_BODY_MISSES_AN_INTO_CLAUSE = "连续查询：查询体缺少 INTO 子句。";
  public static final String CQ_SPECIFYING_TIME_FILTERS_IN_THE_QUERY_BODY = "连续查询：禁止在查询体中指定时间过滤器。";
  public static final String IS_NOT_A_LEGAL_PATH = "{} 不是合法路径";

  // --- Plan / Tree Planner ---

  public static final String VALID_TREEDEVICEVIEWSCANNODE_IS_NOT_EXPECTED_HERE =
      "此处不应出现有效的 TreeDeviceViewScanNode。";
  public static final String MULTIPLE_COLUMNS_WITH_TIME_CATEGORY_FOUND = "发现多个 TIME 类别的列";
  public static final String MISSING_TIME_CATEGORY_COLUMN = "缺少 TIME 类别的列";
  public static final String UNKNOWN_SQL_DIALECT = "未知的 SQL 方言：%s";
  public static final String UNEXPECTED_PATH_TYPE_2 = "意外的路径类型";
  public static final String SHOULD_CALL_THE_CONCRETE_VISITXX_METHOD = "应调用具体的 visitXX() 方法";
  public static final String OUTPUTCOLUMTYPES_SHOULD_NOT_BE_NULL_EMPTY =
      "OutputColumTypes 不应为 null 或空";
  public static final String UNKNOWN_FILL_POLICY = "未知的填充策略：";
  public static final String FILTER_CAN_NOT_CONTAIN_NON_MAPPABLE_UDF = "过滤器不能包含非映射型 UDF";
  ...
  public static final String UNKNOWN_NODE_TYPE = "未知的节点类型：";
  public static final String UNSUPPORTED_COLUMN_GENERATOR_TYPE = "不支持的列生成器类型：";
  public static final String ROOT_NODE_MUST_RETURN_ONLY_ONE = "根节点必须只返回一个结果";
  public static final String SINGLEDEVICEVIEWNODE_HAVE_ONLY_ONE_CHILD =
      "SingleDeviceViewNode 只有一个子节点";
  public static final String AVAILABLE_REPLICAS = "可用副本：{}";
  public static final String UNEXPECTED_ERROR_OCCURS_WHEN_SERIALIZING_THIS_FRAGMENTINSTANCE =
      "序列化此 FragmentInstance 时发生意外错误。";
  public static final String INVALID_NODE_TYPE = "无效的节点类型：";
  public static final String THIS_LASTQUERYSCANNODE_IS_DEPRECATED = "此 LastQueryScanNode 已弃用";
  ...
  public static final String SPLIT_LOAD_SINGLE_TSFILE_IS_NOT_IMPLEMENTED = "单 TsFile 加载的 split 未实现";
  public static final String DELETE_AFTER_LOADING_ERROR = "加载后删除 {} 出错。";
  public static final String CLONE_OF_LOAD_TSFILE_IS_NOT_IMPLEMENTED = "TsFile 加载的 clone 未实现";
  ...
  public static final String SERIALIZE_TO_BYTEBUFFER_ERROR = "序列化到 ByteBuffer 出错。";
  public static final String SPLIT_LOAD_PIECE_TSFILE_IS_NOT_IMPLEMENTED = "TsFile 分片加载的 split 未实现";
  public static final String DESERIALIZE_ERROR = "反序列化 {} 出错。";
  public static final String INVALID_LENGTH_FOR_SLICING = "无效的切片长度：";
  ...
  public static final String CAN_NOT_DESERIALIZE_ALTERTIMESERIESNODE = "无法反序列化 AlterTimeSeriesNode";
  ...
  public static final String UNEXPECTED_DESCRIPTORTYPE = "意外的 descriptorType：";
  public static final String NO_CHILD_IS_ALLOWED_FOR_ALIGNEDSERIESSCANNODE =
      "AlignedSeriesScanNode 不允许有子节点";
  public static final String DEVICEREGIONSCANNODE_HAS_NO_CHILDREN = "DeviceRegionScanNode 没有子节点";
  public static final String NO_CHILD_IS_ALLOWED_FOR_SERIESSCANNODE = "SeriesScanNode 不允许有子节点";
  ...
  public static final String NO_CHILD_IS_ALLOWED_FOR_SHOWQUERIESNODE = "ShowQueriesNode 不允许有子节点";
  ...
  public static final String CANNOT_DESERIALIZE_INSERTROWNODE = "无法反序列化 InsertRowNode";
  public static final String UNEXPECTED_ERROR_OCCURS_WHEN_SERIALIZING_DELETEDATANODE =
      "序列化 deleteDataNode 时发生意外错误。";
  public static final String DELETEDATANODES_IS_EMPTY = "deleteDataNodes 为空";
  public static final String INSERTMULTITABLETSNODE_NOT_SUPPORT_MERGE =
      "InsertMultiTabletsNode 不支持合并";
  public static final String CLONE_OF_INSERT_IS_NOT_IMPLEMENTED = "Insert 的 clone 未实现";
  public static final String INSERTNODES_SHOULD_NEVER_BE_EMPTY = "insertNodes 不应为空";
  ...
  public static final String CANNOT_DESERIALIZE_INSERTTABLETNODE = "无法反序列化 InsertTabletNode";
  public static final String MERGE_IS_NOT_SUPPORTED = "不支持合并";
  public static final String FAILED_TO_SERIALIZE_MODENTRY_TO_WAL = "将 modEntry 序列化到 WAL 失败";
  public static final String ALL_DATABASE_NAME_NEED_TO_BE_SAME = "所有数据库名称必须相同";
  public static final String INVALID_AGGREGATIONSTEP_TYPE = "无效的 AggregationStep 类型：";

  // --- Transformation ---

  public static final String SIZE_IS_0 = "大小为 0";
  public static final String CAN_NOT_CALL_NEXT_ON_EMPTYROWITERATOR =
      "不能在 EmptyRowIterator 上调用 next";
  public static final String THE_EXPRESSION_CANNOT_BE_NULL = "表达式不能为 null";
  public static final String UNSUPPORTED_TYPE = "不支持的类型：";
  public static final String UNSUPPORTED_DATA_TYPE_2 = "不支持的数据类型：";
  public static final String UNSUPPORTED_DATA_TYPE_3 = "不支持的数据类型：";
  public static final String ERROR_OCCURRED_DURING_INFERRING_UDF_DATA_TYPE = "推断 UDF 数据类型时发生错误";
  public static final String ERROR_OCCURRED_DURING_GETTING_UDF_ACCESS_STRATEGY = "获取 UDF 访问策略时发生错误";
  public static final String TRANSFORMUTILS_SHOULD_NOT_BE_INSTANTIATED = "TransformUtils 不应被实例化。";

  // --- Execution / Exchange (additional) ---

  public static final String ACK_TSBLOCK_FAILED = "确认 TsBlock [{}, {}) 失败。";
  public static final String CLOSE_CHANNEL_OF_SHUFFLESINKHANDLE_FAILED =
      "关闭 ShuffleSinkHandle {} 的通道（索引 {}）失败。";
  public static final String SHUFFLESINKHANDLE_ALREADY_IN_MAP = "ShuffleSinkHandle ";
  public static final String IS_IN_THE_MAP = " 已存在于映射中。";
  ...
  public static final String FAILED_TO_GET_DATA_BLOCK = "获取数据块 [{}, {}) 失败，尝试次数：{}";
  public static final String FAILED_TO_SEND_ACK_DATA_BLOCK_EVENT = "发送数据块确认事件 [{}, {}) 失败，尝试次数：{}";
  public static final String SEND_CLOSE_SINK_CHANNEL_EVENT_FAILED =
      "[发送关闭 SinkChannel 事件] 到 [ShuffleSinkHandle: {}, 索引: {}] 失败。";
  public static final String LOCAL_SINK_CHANNEL_STATE_IS = "LocalSinkChannel 状态为 .";
  public static final String SCH_LISTENER_ON_FINISH = "[ScH 监听器完成]";
  public static final String SCH_LISTENER_ALREADY_RELEASED = "[ScH 监听器已释放]";
  public static final String SCH_LISTENER_ON_ABORT = "[ScH 监听器中止]";
  public static final String SHUFFLE_SINK_HANDLE_LISTENER_ON_FINISH = "[ShuffleSinkHandle 监听器完成]";
  public static final String SHUFFLE_SINK_HANDLE_LISTENER_ON_END_OF_TSBLOCKS =
      "[ShuffleSinkHandle 监听器 TsBlock 结束]";
  public static final String SHUFFLE_SINK_HANDLE_LISTENER_ON_ABORT = "[ShuffleSinkHandle 监听器中止]";
  public static final String SKH_LISTENER_ON_FINISH = "[SkH 监听器完成]";
  public static final String SKH_LISTENER_ON_END_OF_TSBLOCKS = "[SkH 监听器 TsBlock 结束]";
  public static final String SKH_LISTENER_ON_ABORT = "[SkH 监听器中止]";
  public static final String CLOSE_SHUFFLE_SINK_HANDLE = "关闭 ShuffleSinkHandle: {}";
  public static final String GET_SHARED_TSBLOCK_QUEUE_FROM_LOCAL_SOURCE_HANDLE =
      "从本地源句柄获取 SharedTsBlockQueue";
  public static final String CREATE_SHARED_TSBLOCK_QUEUE = "创建 SharedTsBlockQueue";
  public static final String CREATE_LOCAL_SINK_HANDLE_FOR = "为 {} 创建本地 Sink 句柄";
  public static final String CREATE_LOCAL_SOURCE_HANDLE_FOR = "为 {} 创建本地 Source 句柄";
  public static final String GET_SHARED_TSBLOCK_QUEUE_FROM_LOCAL_SINK_HANDLE =
      "从本地 Sink 句柄获取 SharedTsBlockQueue";
  public static final String START_FORCE_RELEASE_FI_DATA_EXCHANGE_RESOURCE = "[开始强制释放 FI 数据交换资源]";
  public static final String CLOSE_SOURCE_HANDLE = "[关闭 SourceHandle] {}";
  public static final String END_FORCE_RELEASE_FI_DATA_EXCHANGE_RESOURCE = "[结束强制释放 FI 数据交换资源]";
  public static final String CREATE_LOCAL_SINK_HANDLE_TO_PLAN_NODE =
      "为计划节点 {} 的 {} 创建本地 Sink 句柄，目标 {}";
  public static final String CREATE_SINK_HANDLE_TO_PLAN_NODE = "为计划节点 {} 的 {} 创建 Sink 句柄，目标 {}";
  public static final String CREATE_LOCAL_SOURCE_HANDLE_FROM = "从 {} 为计划节点 {} 的 {} 创建本地 Source 句柄";
  public static final String GET_SERIALIZED_TSBLOCK = "[获取序列化 TsBlock] TsBlock:{}";
  public static final String START_ABORT_LOCAL_SOURCE_HANDLE = "[开始中止 LocalSourceHandle]";
  public static final String END_ABORT_LOCAL_SOURCE_HANDLE = "[结束中止 LocalSourceHandle]";
  public static final String START_CLOSE_LOCAL_SOURCE_HANDLE = "[开始关闭 LocalSourceHandle]";
  public static final String END_CLOSE_LOCAL_SOURCE_HANDLE = "[结束关闭 LocalSourceHandle]";
  public static final String START_SET_NO_MORE_TSBLOCKS = "[开始设置无更多 TsBlock]";
  public static final String START_ABORT_SINK_CHANNEL = "[开始中止 SinkChannel]";
  public static final String END_ABORT_SINK_CHANNEL = "[结束中止 SinkChannel]";
  public static final String START_CLOSE_SINK_CHANNEL = "[开始关闭 SinkChannel]";
  public static final String END_CLOSE_SINK_CHANNEL = "[结束关闭 SinkChannel]";
  public static final String ACK_TSBLOCK = "[确认 TsBlock] {}.";
  public static final String NOTIFY_NO_MORE_TSBLOCK = "[通知无更多 TsBlock]";
  public static final String START_SEND_TSBLOCK_ON_LOCAL = "[开始在本地发送 TsBlock]";
  public static final String START_SET_NO_MORE_TSBLOCKS_ON_LOCAL = "[开始在本地设置无更多 TsBlock]";
  public static final String END_SET_NO_MORE_TSBLOCKS_ON_LOCAL = "[结束在本地设置无更多 TsBlock]";
  public static final String START_ABORT_LOCAL_SINK_CHANNEL = "[开始中止 LocalSinkChannel]";
  public static final String END_ABORT_LOCAL_SINK_CHANNEL = "[结束中止 LocalSinkChannel]";
  public static final String START_CLOSE_LOCAL_SINK_CHANNEL = "[开始关闭 LocalSinkChannel]";
  public static final String END_CLOSE_LOCAL_SINK_CHANNEL = "[结束关闭 LocalSinkChannel]";
  public static final String GET_TSBLOCK_FROM_BUFFER = "[从缓冲区获取 TsBlock] sequenceId:{}, size:{}";
  public static final String WAIT_FOR_MORE_TSBLOCK = "[等待更多 TsBlock]";
  public static final String RECEIVE_NO_MORE_TSBLOCK_EVENT = "[收到无更多 TsBlock 事件]";
  public static final String END_PULL_TSBLOCKS_FROM_REMOTE = "[结束从远端拉取 TsBlock] 数量:{}";
  public static final String PUT_TSBLOCKS_INTO_BUFFER = "[将 TsBlock 放入缓冲区]";
  public static final String SEND_ACK_TSBLOCK = "[发送确认 TsBlock] [{}, {}).";
  public static final String START_ABORT_SHUFFLE_SINK_HANDLE = "[开始中止 ShuffleSinkHandle]";
  public static final String END_ABORT_SHUFFLE_SINK_HANDLE = "[结束中止 ShuffleSinkHandle]";
  public static final String START_CLOSE_SHUFFLE_SINK_HANDLE = "[开始关闭 ShuffleSinkHandle]";
  public static final String END_CLOSE_SHUFFLE_SINK_HANDLE = "[结束关闭 ShuffleSinkHandle]";
  public static final String SIGNAL_NO_MORE_TSBLOCK_ON_QUEUE = "[队列信号无更多 TsBlock]";
  public static final String QUEUE_DESTROYED_WHEN_SET_NO_MORE_TSBLOCKS =
      "调用 setNoMoreTsBlocks 时队列已被销毁。";
  public static final String ADD_TSBLOCK = "[添加 TsBlock] TsBlock:{}";

  // --- Plan (additional debug) ---

  public static final String QUERY_START_SQL = "[查询开始] sql: {}";
  public static final String CLEAN_UP_QUERY = "[清理查询]";
  public static final String RELEASE_QUERY_RESOURCE_STATE = "[释放查询资源] 状态为: {}";
  public static final String SKIP_EXECUTE = "[跳过执行]";
  public static final String SKIP_EXECUTE_AFTER_LOGICAL_PLAN = "[逻辑计划后跳过执行]";
  public static final String RESULT_HANDLE_FINISHED = "[结果句柄已完成]";
  ...
  public static final String DEVICES_ARE_MISSING = "{} 个设备缺失";

  // --- Execution / Fragment (additional debug) ---

  public static final String STATE_CHANGED_TO = "[状态变更] 变更为 {}";
  public static final String ENTER_THE_STATE_CHANGE_LISTENER = "进入状态变更监听器";

  // --- Execution / Fragment (additional) ---

  public static final String ERRORS_RELEASING_SINK = "尝试释放 Sink 时发生错误，可能导致资源泄漏。";
  public static final String ERRORS_DELETING_TMP_FILES = "尝试删除临时文件时发生错误，可能导致资源泄漏。";
  public static final String ERRORS_DEREGISTER_FI_FROM_MEMORY_POOL =
      "尝试从内存池注销分片实例时发生错误，可能导致资源泄漏，状态为 {}。";
  public static final String ERRORS_RELEASING_MEMORY = "尝试释放内存时发生错误，可能导致资源泄漏。";
  public static final String ERRORS_FINISHING_FI_PROCESS = "尝试完成分片实例流程时发生错误，可能导致资源泄漏。";

  // --- Plan (additional) ---

  public static final String CLEANING_UP_STALE_QUERY = "正在清理过期查询，ID: {}，已运行 {} 毫秒，超时时间：{} 毫秒";

  // --- Plan / Tree Planner (additional) ---

  public static final String ERROR_WHEN_READ_OBJECT_FILE = "读取对象文件 {} 时出错。";

  // --- Additional Edge Cases ---

  public static final String JOIN_TYPE_IS_NOT_SUPPORTED = " Join 类型不受支持";
  public static final String COLON_S_VS_S = "：%s 与 %s";
  public static final String IS_TOO_LARGE_STACK_OVERFLOW_WHILE_PARSING = " 过大（解析时发生栈溢出）";
  ...
  public static final String THE_FIELD_IN_TABLE_DOES_NOT_HAVE_A_NAME = "表中的字段没有名称";
  public static final String SHOULD_HAVE_TWO_NUMERIC_OPERANDS = "应有两个数值类型操作数。";
  public static final String SHOULD_HAVE_ONE_NUMERIC_OPERANDS = "应有一个数值类型操作数。";
  public static final String SHOULD_HAVE_TWO_COMPARABLE_OPERANDS = "应有两个可比较类型操作数。";
  ...
  public static final String NO_MAPPING_FOR_S = "找不到 %s 的映射";
  public static final String CANCEL_STATE_TRACKING_TASK_FAILED = "取消状态跟踪任务失败。{}";
  public static final String TRACK_TASK_NOT_STARTED = "trackTask 未启动";
  public static final String PRINT_FI_STATE = "[PrintFIState] 状态为 {}";
  public static final String START_FETCH_SCHEMA = "[StartFetchSchema]";
  public static final String END_FETCH_SCHEMA = "[EndFetchSchema]";
  public static final String CACHE_HIT = "[{} Cache] 命中";
  public static final String PARTITION_CACHE_INVALID = "[Partition Cache] 无效";
  public static final String PARTITION_CACHE_IS_INVALID = "[Partition Cache] 无效：{}";
  public static final String CANCEL_FI = "[CancelFI]";
  public static final String RENAME_VIEW_NOT_SUPPORT_WILDCARD = "重命名视图不支持带通配符的路径模式。";
  public static final String REMOVE_CONFIG_NODE_FAILED = "移除 ConfigNode 失败：";
  ...
  public static final String PREPARED_STATEMENT_S_DOES_NOT_EXIST = "预编译语句 '%s' 不存在";
  public static final String
  ...
  public static final String DATA_TYPE_OF_TAG_COLUMN = "tag 列的数据类型 ";
  public static final String IS_NOT_STRING = " 不是 STRING";
  public static final String THE_SOURCE_PATHS_S_OF_VIEW_S_ARE_MULTIPLE = "源路径 [%s] 对应的视图 [%s] 有多个。";
  ...
  public static final String ERROR_OCCURRED_DURING_GETTING_UDF_ACCESS_STRATEGY_S =
      "获取 UDF 访问策略时发生错误：%s";
  public static final String UNSUPPORTED_COMPRESSION_S = "不支持压缩方式：%s";
  ...
  public static final String
      TIME_COLUMN_IS_NO_NEED_TO_APPEAR_IN_SELECT_CLAUSE_EXPLICITLY_IT_WILL_ALWAYS_BE_RETURNED =
  ...
  public static final String
      CONSTANT_OPERAND_S_IS_NOT_ALLOWED_IN_GROUP_BY_VARIATION_THERE_SHOULD_BE_AN_EXPRESSION =
  ...
  public static final String FAILED_TO_PARSE_THE_TIMESTAMP = "解析时间戳失败：";

  public static final String CURRENT_SYSTEM_TIMESTAMP_PRECISION_IS_S = "当前系统时间戳精度为 %s，";

  public static final String PLEASE_CHECK_WHETHER_THE_TIMESTAMP_S_IS_CORRECT = "请检查时间戳 %s 是否正确。";
  ...
  public static final String
      S_IS_ILLEGAL_UNQUOTED_NODE_NAME_IN_SELECT_INTO_CLAUSE_CAN_ONLY_CONSIST_OF_DIGITS =
          "%s 非法，SELECT INTO 子句中的未引用节点名只能由数字、字符、$、{ 和 } 组成";
  public static final String
      S_IS_ILLEGAL_IDENTIFIER_NOT_ENCLOSED_WITH_BACKTICKS_CAN_ONLY_CONSIST_OF_DIGITS =
          "%s 非法，未用反引号括起的标识符只能由数字、字符和下划线组成。";
  public static final String INPUT_TIME_FORMAT_S_ERROR = "输入时间格式 %s 错误。 ";
  ...
  public static final String REFER_TO_USER_DOCUMENT_FOR_MORE_INFO = "更多信息请参阅用户文档。";

  public static final String
      GRANT_OPTION_IS_DISABLED_PLEASE_CHECK_THE_PARAMETER_ENABLE_GRANT_OPTION =
          "Grant Option 已禁用，请检查参数 enable_grant_option。";
  public static final String S_CAN_ONLY_BE_SET_ON_PATH_ROOT_STAR_STAR = "[%s] 只能设置在路径 root.** 上";

  public static final String PRIVILEGE_TYPE = "权限类型 ";

  public static final String IS_DEPRECATED_USE = " 已弃用，请使用 ";

  public static final String TO_INSTEAD_IT = " 替代它";
  ...
  public static final String CAN_NOT_PARSE_S_TO_LONG_VALUE = "无法将 %s 解析为 long 值";

  public static final String THERE_S_DUPLICATE_S_IN_TAG_OR_ATTRIBUTE_CLAUSE = "标签或属性子句中存在重复项 [%s]。";
  ...
  public static final String PLEASE_SET_THE_CORRECT_REQUEST_TYPE = "请设置正确的请求类型：";
  ...
  public static final String START_TIME_D_IS_GREATER_THAN_END_TIME_D = "开始时间 %d 大于结束时间 %d";

  public static final String THE_COLUMN = "列 '";
  public static final String DOES_NOT_EXIST_OR_IS_NOT_A_TAG_COLUMN = "' 不存在或不是标签列";
  ...
  public static final String ALIAS_S_CAN_ONLY_BE_MATCHED_WITH_ONE_RESULT_COLUMN =
      "别名 '%s' 只能匹配一个结果列";
  public static final String RESULT_COLUMN_S_WITH_MORE_THAN_ONE_ALIAS_S_S = "结果列 %s 有多个别名[%s, %s]";
  ...
  public static final String S_IN_ORDER_BY_CLAUSE_DOESN_T_EXIST = "%s 在 ORDER BY 子句中不存在。";

  public static final String S_IN_ORDER_BY_CLAUSE_SHOULDN_T_REFER_TO_MORE_THAN_ONE_TIMESERIES =
      "%s 在 ORDER BY 子句中不应引用多个时间序列。";
  public static final String THE_DATA_TYPE_OF_S_IS_NOT_COMPARABLE = "%s 的数据类型不可比较";
  ...
  public static final String S_IN_GROUP_BY_CLAUSE_DOESN_T_EXIST = "%s 在 GROUP BY 子句中不存在。";

  public static final String S_IN_GROUP_BY_CLAUSE_SHOULDN_T_REFER_TO_MORE_THAN_ONE_TIMESERIES =
      "%s 在 GROUP BY 子句中不应引用多个时间序列。";
  public static final String PLEASE_CHECK_THE_KEEP_CONDITION_S = "请检查 keep 条件（[%s]），";
  ...
  public static final String TAG_AND_ATTRIBUTE_SHOULDN_T_HAVE_THE_SAME_PROPERTY_KEY_S =
      "标签和属性不应拥有相同的属性键 [%s]";
  public static final String S_IS_NOT_A_LEGAL_PROP = "%s 不是合法属性。";
  ...
  public static final String AGGREGATION_RESULTS_CANNOT_BE_AS_INPUT_OF_THE_AGGREGATION_FUNCTION =
      "聚合结果不能作为聚合函数的输入。";
  public static final String INPUT_OF_S_IS_ILLEGAL = "'%s' 的输入非法。";
  ...
  public static final String COLUMNS_IN_TABLE_SHALL_NOT_SHARE_THE_SAME_NAME_S = "表中的列不应重名：'%s'。";

  public static final String THE_DUPLICATED_SOURCE_MEASUREMENT_S_IS_UNSUPPORTED_YET =
      "暂不支持重复的源测点 %s。";
  public static final String THE_LENGTH_OF_DATABASE_NAME_SHALL_NOT_EXCEED = "数据库名称长度不得超过 ";

  public static final String
      THE_DATABASE_NAME_CAN_ONLY_CONTAIN_ENGLISH_OR_CHINESE_CHARACTERS_NUMBERS_BACKTICKS_AND =
          "数据库名称只能包含英文或中文字符、数字、反引号和下划线。";
  public static final String IS_CURRENTLY_NOT_ALLOWED = "' 当前不允许。";

  public static final String VALUE_MUST_BE_A_LONGLITERAL_BUT_NOW_IS = " 值必须为 LongLiteral，当前为 ";

  public static final String VALUE = "，值：";

  public static final String VALUE_MUST_BE_EQUAL_TO_OR_GREATER_THAN_0_BUT_NOW_IS =
      " 值必须大于等于 0，当前为：";
  public static final String VALUE_MUST_BE_LOWER_THAN = " 值必须小于 ";

  public static final String BUT_NOW_IS = "，当前为：";
  ...
  public static final String ALTER = "修改";
  ...
  public static final String
      FAILED_TO_ALTER_PIPE_S_IN_IOTDB_SOURCE_PASSWORD_MUST_BE_SET_WHEN_THE_USERNAME_IS =
          "alter pipe %s 失败：iotdb-source 中指定 username 时必须设置 password。";
  public static final String
      FAILED_TO_ALTER_PIPE_S_IN_WRITE_BACK_SINK_PASSWORD_MUST_BE_SET_WHEN_THE_USERNAME_IS =
          "alter pipe %s 失败：write-back-sink 中指定 username 时必须设置 password。";
  public static final String PREPARED_STATEMENT_S_ALREADY_EXISTS = "预编译语句 '%s' 已存在。";
  ...
  public static final String MEASUREMENT_CONTAINS_NULL_OR_EMPTY_STRING = "测点包含 null 或空字符串：";
  ...
  public static final String TREE_DEVICE_VIEW_WITH_MULTIPLE_DATABASES = "包含多个数据库的树设备视图（";

  public static final String IS_UNSUPPORTED_YET = "）暂不支持。";

  public static final String COMPLEX_ASOF_MAIN_JOIN_EXPRESSION_S_IS_NOT_SUPPORTED =
      "不支持复杂的 ASOF 主 JOIN 表达式 [%s]";
  public static final String UNEXPECTED_DESCRIPTOR_TYPE = "意外的描述符类型：";

  public static final String WHEN_CLAUSE_OPERAND_TYPE_MUST_MATCH_CASE_OPERAND_TYPE_S_VS_S =
      "WHEN子句操作数类型必须匹配 CASE 操作数类型：%s vs %s";
  public static final String ALL_RESULT_TYPES_MUST_BE_THE_SAME_S = "所有结果类型必须一致：%s";

  public static final String DEFAULT_RESULT_TYPE_MUST_BE_THE_SAME_AS_WHEN_RESULT_TYPES_S_VS_S =
      "默认结果类型必须与 WHEN结果类型一致：%s vs %s";
  public static final String ALL_OPERANDS_MUST_HAVE_THE_SAME_TYPE_S = "所有操作数必须具有相同类型：%s";

  public static final String TO = " 到 ";

  public static final String SCALAR_FUNCTION = "标量函数 ";
  public static final String
  ...
  public static final String ACCEPTS_NO_ARGUMENT = " 不接受参数。";
  public static final String
  ...
  public static final String AGGREGATION_FUNCTIONS_S_DO_NOT_SUPPORT_WEIGHT_AS_S_TYPE =
      "聚合函数 [%s] 不支持 %s 类型的权重";
  public static final String WINDOW_FUNCTION_S_SHOULD_ONLY_HAVE_ONE_ARGUMENT = "窗口函数 [%s] 只能有一个参数";
  ...
  public static final String UPDATE_ATTRIBUTE_SHALL_SPECIFY_A_ATTRIBUTE_ONLY_ONCE =
      "UPDATE 属性只能指定一次。";
  public static final String CANNOT_BE_RESOLVED = "无法解析";
  public static final String IS_NOT_AN_ATTRIBUTE_OR_TAG_COLUMN = "不是属性列或标签列";
  ...
  public static final String INSERT_COLUMN_NAME_DOES_NOT_EXIST_IN_TARGET_TABLE_S =
      "插入列名在目标表中不存在：%s";
  public static final String INSERT_COLUMN_NAME_IS_SPECIFIED_MORE_THAN_ONCE_S = "插入列名被指定多次：%s";

  public static final String INSERT_QUERY_HAS_MISMATCHED_COLUMN_TYPES_TABLE_S_QUERY_S =
      "插入查询的列类型不匹配：表：[%s]，查询：[%s]";
  public static final String WITH_QUERY_NAME_S_SPECIFIED_MORE_THAN_ONCE = "WITH查询名称 '%s' 被指定多次。";
  ...
  public static final String CANNOT_SPECIFY_WINDOW_FRAME_FOR_S_FUNCTION = "不能为 %s 函数指定窗口框架";

  public static final String WINDOW_NAME_S_SPECIFIED_MORE_THAN_ONCE = "WINDOW 名称 '%s' 被指定多次";

  public static final String CANNOT_RESOLVE_WINDOW_NAME_S = "无法解析 WINDOW 名称 %s";
  ...
  public static final String NO_MATCHING_COLUMNS_FOUND_THAT_MATCH_REGEX_S = "没有匹配 regex '%s' 的列。";

  public static final String S_ARE_NOT_SUPPORTED_NOW = "目前不支持 %s";

  public static final String UNABLE_TO_RESOLVE_REFERENCE_S = "无法解析引用 %s。";
  ...
  public static final String S_QUERY_HAS_DIFFERENT_NUMBER_OF_FIELDS_D_D = "%s 查询的字段数量不同：%d，%d";
  ...
  public static final String AMBIGUOUS_COLUMN_S_IN_ROW_PATTERN_INPUT_RELATION = "行模式输入关系中的列存在歧义：%s";
  ...
  public static final String VALUES_ROWS_HAVE_MISMATCHED_SIZES_S_VS_S = "VALUES 行大小不匹配：%s vs %s";
  ...
  public static final String COLUMN_S_APPEARS_MULTIPLE_TIMES_IN_USING_CLAUSE =
      "USING子句中列 '%s' 出现多次。";
  public static final String COLUMN_S_IS_MISSING_FROM_LEFT_SIDE_OF_JOIN = "JOIN 左侧缺少列 '%s'";

  public static final String COLUMN_S_IS_MISSING_FROM_RIGHT_SIDE_OF_JOIN = "JOIN 右侧缺少列 '%s'";
  ...
  public static final String NON_CONSTANT_PARAMETER_VALUE_FOR_S_S = "%s 的参数值不是常量：%s";

  public static final String PARAMETER_VALUE_PROVIDED_FOR_S_IS_NULL_S = "为 %s 提供的参数值为 NULL：%s";

  public static final String RECURSIVE_REFERENCE_IN_LEFT_SOURCE_OF_S_JOIN = "%s join 的左侧源中存在递归引用";

  public static final String RECURSIVE_REFERENCE_IN_RIGHT_SOURCE_OF_S_JOIN = "%s join 的右侧源中存在递归引用";

  public static final String RECURSIVE_REFERENCE_IN_RIGHT_RELATION_OF_EXCEPT_S =
      "EXCEPT %s 的右侧关系中存在递归引用";
  public static final String DISTINCT_2 = "DISTINCT";
  ...
  public static final String IS_CURRENTLY_NOT_ALLOWED_2 = " 当前不允许。";

  public static final String DUPLICATE_PROPERTY_S = "重复属性：%s";

  public static final String TTL_VALUE_MUST_BE_A_INF_OR_A_LONGLITERAL_BUT_NOW_IS =
      "TTL' 值必须为 'INF' 或 LongLiteral，当前为：";
  public static final String COLUMN_NAME_NOT_SPECIFIED_AT_POSITION_S = "位置 %s 未指定列名";

  public static final String COLUMN_NAME_S_SPECIFIED_MORE_THAN_ONCE = "列名 '%s' 被指定多次";
  ...
  public static final String UNEXPECTED_ARGUMENT_NAME_S = "意外的参数名：%s";

  public static final String UNEXPECTED_TABLE_FUNCTION_ARGUMENT_TYPE_S = "意外的表函数参数类型：%s";
  ...
  public static final String INVALID_SCALAR_ARGUMENT_S_S = "无效标量参数 %s，%s";

  public static final String MISSING_REQUIRED_ARGUMENT_S = "缺少必需参数：%s";

  public static final String EXPECTED_COLUMN_REFERENCE_ACTUAL_S = "期望列引用。实际：%s";

  public static final String COLUMN_S_IS_NOT_PRESENT_IN_THE_INPUT_RELATION = "输入关系中不存在列 %s";
  ...
  public static final String DEFINED_VARIABLE_S_IS_NOT_A_PRIMARY_PATTERN_VARIABLE =
      "定义的变量 %s 不是主模式变量";
  public static final String PATTERN_VARIABLE_WITH_NAME_S_IS_DEFINED_TWICE = "名称为 %s 的模式变量被定义了两次";
  ...
  public static final String PATTERN_QUANTIFIER_LOWER_BOUND_MUST_BE_GREATER_THAN_OR_EQUAL_TO_0 =
      "模式量词下界必须大于或等于 0";
  public static final String PATTERN_QUANTIFIER_LOWER_BOUND_MUST_NOT_EXCEED = "模式量词下界不得超过 ";

  public static final String PATTERN_QUANTIFIER_UPPER_BOUND_MUST_BE_GREATER_THAN_OR_EQUAL_TO_1 =
      "模式量词上界必须大于或等于 1";
  public static final String PATTERN_QUANTIFIER_UPPER_BOUND_MUST_NOT_EXCEED = "模式量词上界不得超过 ";
  ...
  public static final String COLUMN_S_CANNOT_BE_RESOLVED = "无法解析列 '%s'";
  ...
  public static final String COLUMN_S_PREFIXED_WITH_LABEL_S_CANNOT_BE_RESOLVED =
      "无法解析带标签前缀 %s 的列 %s";
  public static final String EXPRESSION_S_IS_NOT_OF_TYPE_ROW = "表达式 %s 不是 ROW 类型";

  public static final String AMBIGUOUS_ROW_FIELD_REFERENCE_S = "行字段引用存在歧义：%s";
  ...
  public static final String UNARY_OPERATOR_CANNOT_BY_APPLIED_TO_S_TYPE = "一元 '+' 操作符不能应用于 %s 类型";
  ...
  public static final String THE_THIRD_ARGUMENT_OF_S_FUNCTION_MUST_BE_ACTUAL_TIME_NAME =
      "%s 函数的第三个参数必须为实际时间名称";
  public static final String TOO_MANY_ARGUMENTS_FOR_FUNCTION_CALL_S = "函数调用 %s() 的参数过多";

  public static final String S_IS_NOT_A_PRIMARY_PATTERN_VARIABLE_OR_SUBSET_NAME = "%s 不是主模式变量或子集名称";
  public static final String
  ...
  public static final String INVALID_PARAMETER_INDEX_S_MAX_VALUE_IS_S = "无效的参数索引 %s，最大值为 %s";

  public static final String CANNOT_CHECK_IF_S_IS_BETWEEN_S_AND_S = "无法判断 %s 是否位于 %s 和 %s 之间。";
  ...
  public static final String
      TYPE_S_MUST_BE_COMPARABLE_IN_ORDER_TO_BE_USED_IN_QUANTIFIED_COMPARISON =
          "类型 [%s] 必须可比较，才能用于量化比较。";
  public static final String NOT_YET_IMPLEMENTED_S = "尚未实现：%s";

  public static final String S_MUST_EVALUATE_TO_A_S_ACTUAL_S = "%s 必须计算为 %s（实际：%s）";
  ...
  public static final String PARAMETER_NODE_MUST_HAVE_A_LOCATION = "参数节点必须包含位置信息";
  public static final String INVALID_NUMBER_OF_PARAMETERS_EXPECTED_D_GOT_D = "参数数量无效：期望 %d，实际得到 %d";
  ...
  public static final String EXPRESSIONS_AND_COLUMNS_DO_NOT_MATCH_EXPRESSIONS_SIZE =
      "表达式和列不匹配，表达式数量：";
  public static final String COLUMNS_SIZE = "，列数量：";

  public static final String TIMECOLUMNINDEX_OUT_OF_BOUND_D_D = "timeColumnIndex 越界：%d-%d";
  ...
  public static final String EXCEPTION_FAILED_TO_WRITE_THE_TARGET_FILE_ARG_5AC3025D = "写入目标文件失败：%s";
  ...
  public static final String ASOF_JOIN_DOES_NOT_SUPPORT_S_TYPE_NOW = "ASOF JOIN 目前不支持 %s 类型";
  ...
  public static final String INCONSISTENT_COLUMN_CATEGORY_OF_COLUMN_S_S_S = "列 %s 的类别不一致：%s/%s";

  public static final String COLUMN = "列 ";
  public static final String DOES_NOT_EXISTS_OR_FAILS_TO_BE = " 不存在或无法被 ";
  public static final String CREATED = "已创建";

  public static final String INCOMPATIBLE_DATA_TYPE_OF_COLUMN_S_S_S = "列 %s 的数据类型不兼容：%s/%s";
  ...
  public static final String UNKNOWN_COLUMN_DATA_TYPE_FOR_S_CANNOT_AUTO_CREATE_COLUMN =
      "%s 的列数据类型未知，无法自动创建列。";
  public static final String WRONG_CATEGORY_AT_COLUMN_S = "列 %s 的类别错误。";
  public static final String MISSING_COLUMNS_S = "缺少列 %s。";
  ...
  public static final String GIVEN_CORRELATED_SUBQUERY_IS_NOT_SUPPORTED = "不支持给定的关联子查询";

  public static final String GIVEN_QUERIED_DATABASE_S_IS_NOT_EXIST = "查询的数据库 %s 不存在！";
  ...
  public static final String FAILED_TO_DO_THE_INITIALIZATION_FOR_DRIVER_ARG = "driver {} 初始化失败 ";
  ...
  public static final String STATE_TRACKER_STARTS = "状态跟踪器启动";
  ...
  public static final String WRITE_LOCALLY_FAILED_TSSTATUS_ARG_MESSAGE_ARG =
      "本地写入失败。TSStatus：{}，消息：{}。";
  public static final String DISPATCH_WRITE_FAILED_MESSAGE_ARG_NODE_ARG = "分发写入失败。消息：{}，节点 {}。";

  public static final String DISPATCH_WRITE_FAILED_STATUS_ARG_CODE_ARG_MESSAGE_ARG_NODE_ARG_2 =
      "分发写入失败。状态：{}，code：{}，消息：{}，节点 {}。";
  public static final String LOGICAL_PLAN_IS_ARG = "逻辑计划为：\n {}";
  ...
  public static final String TSFILE_ARG_IS_A_ARG_MODEL_FILE = "TsFile {} 是 {}-model 文件。";
  ...
  public static final String ENCODING_TYPE_NOT_MATCH_MEASUREMENT_ARGARGARG = "编码类型不匹配，测点：{}{}{}，";

  public static final String TSFILE_ENCODING_ARG_IOTDB_ENCODING_ARG = "TsFile 编码：{}，IoTDB 编码：{}";

  public static final String COMPRESSOR_NOT_MATCH_MEASUREMENT_ARGARGARG = "压缩器不匹配，测点：{}{}{}，";

  public static final String TSFILE_COMPRESSOR_ARG_IOTDB_COMPRESSOR_ARG =
      "TsFile 压缩器：{}，IoTDB 压缩器：{}";
  public static final String ARG_CACHE_FAILED_TO_CREATE_DATABASE_ARG = "[{} Cache] 创建数据库 {} 失败";

  public static final String ARG_CACHE_MISS_WHEN_SEARCH_DEVICE_ARG = "[{} Cache] 搜索设备 {} 时未命中";

  public static final String ARG_CACHE_HIT_WHEN_SEARCH_DEVICE_ARG = "[{} Cache] 搜索设备 {} 时命中";
  ...
  public static final String ARG_CACHE_MISS_WHEN_SEARCH_DATABASE_ARG = "[{} Cache] 搜索数据库 {} 时未命中";
  ...
  public static final String FAILED_TO_CREATE_PIPEPLUGIN_ARG_ARG_BECAUSE_ARG =
      "创建 PipePlugin {}({}) 失败，原因：{}";
  public static final String ARG_FAILED_TO_DROP_PIPE_PLUGIN_ARG = "[{}] 删除 pipe plugin {} 失败。";
  ...
  public static final String
      THE_CONFIGNODE_TO_BE_REMOVED_IS_NOT_IN_THE_CLUSTER_OR_THE_INPUT_FORMAT_IS_INCORRECT =
  ...
  public static final String PARSE_OR_SEND_TSFILE_S_ERROR = "解析或发送 TsFile %s 出错。";
  ...
  public static final String RESULT_STATUS_MESSAGE_ARG_DISPATCH_PIECE_NODE_ERROR_PERCENT_NARG =
      "结果状态消息 {}。分发片段节点出错：%n{}";
  public static final String SUB_STATUS_CODE_ARG_SUB_STATUS_MESSAGE_ARG = "子状态码 {}。子状态消息 {}。";

  public static final String WAIT_FOR_LOADING_S_TIME_OUT = "等待加载 %s 超时。";
  ...
  public static final String RESULT_STATUS_MESSAGE_S = "结果状态消息 %s。";
  ...
  public static final String DATA_TYPE_OF_ARG_ARG_IS_NOT_CONSISTENT = "{}.{} 的数据类型不一致， ";
  ...
  public static final String RULE_S_BEFORE_S_AFTER_S = "规则：{}\n之前：\n{}\n之后：\n{}";
  ...
  public static final String QUERY_EXCEPTION_INTERRUPTED_BY_92FAED2D = "被中断，原因：";
  public static final String QUERY_EXCEPTION_DRIVER_WAS_INTERRUPTED_737358E4 = "Driver 已中断";
  ...
  public static final String QUERY_EXCEPTION_S_IS_NOT_VIEW_B5840A3C = "%s 不是视图。";
  public static final String
  ...
  public static final String
      QUERY_EXCEPTION_NOT_SUPPORT_THIS_TYPE_OF_AGGREGATION_WINDOW_S_604F93D0 = "不支持此类聚合窗口：%s";
  public static final String
  ...
  public static final String QUERY_EXCEPTION_DATA_TYPE_S_IS_NOT_SUPPORTED_5D5C02E4 = "不支持数据类型 %s。";
  ...
  public static final String QUERY_EXCEPTION_UNEXPECTED_COLUMN_CATEGORY_S_6E60A44E = "意外的列类别：%s";
  ...
  public static final String QUERY_EXCEPTION_UNEXPECTED_ACCESS_STRATEGY_S_92EA9D64 = "意外的访问策略：%s";
  public static final String
  ...
  public static final String QUERY_EXCEPTION_UNSUPPORTED_TARGET_DATATYPE_S_8DEFDAE6 =
      "不支持的目标 dataType：%s";
  public static final String QUERY_EXCEPTION_UNSUPPORTED_STATEMENT_TYPE_S_FBCA7305 = "不支持的语句类型：%s";
  ...
  public static final String QUERY_EXCEPTION_LINE_S_S_S_7CA5F0E1 = "行 %s:%s %s";
  public static final String
  ...
  public static final String QUERY_EXCEPTION_THE_TYPE_OF_INPUT_EXPRESSION_S_IS_UNKNOWN_841AC714 =
      "输入表达式 %s 的类型未知";
  public static final String
      QUERY_EXCEPTION_MEET_ERROR_WHEN_ANALYZING_THE_QUERY_STATEMENT_S_AD732908 = "分析查询语句时遇到错误：%s";
  public static final String
  ...
  public static final String QUERY_EXCEPTION_UNSUPPORTED_EXPRESSION_TYPE_S_7C6F99A9 =
      "不支持的表达式类型 %s";
  public static final String QUERY_EXCEPTION_S_CANNOT_BE_CAST_TO_S_DABC2DA0 = "\"%s\" 无法转换为 [%s]";
  ...
  public static final String QUERY_EXCEPTION_MEASUREMENT_S_DOES_NOT_EXIST_23D2B5BE =
      "Measurement %s 不存在";
  public static final String QUERY_EXCEPTION_INVALID_SCALAR_FUNCTION_S_4DC1ED95 = "无效的标量函数 [%s]。";

  public static final String QUERY_EXCEPTION_FETCH_SCHEMA_FAILED_BECAUSE_S_BE584DCE =
      "获取 Schema 失败，原因：%s";
  public static final String QUERY_EXCEPTION_FETCH_SCHEMA_FAILED_S_1C7B0050 = "获取 Schema 失败：%s";
  ...
  public static final String QUERY_EXCEPTION_SUBSCRIPTION_IS_NOT_ENABLED_7F43DCBB =
      "Subscription 未启用。";
  public static final String
      QUERY_EXCEPTION_FAILED_TO_CREATE_UDF_S_THE_GIVEN_FUNCTION_NAME_CONFLICTS_6FBB1136 =
  ...
  public static final String
      QUERY_EXCEPTION_FAILED_TO_CREATE_FUNCTION_S_BECAUSE_THERE_IS_DUPLICATE_ARGUMENT_7905BC09 =
          "无法创建函数 '%s'：存在重复的参数名 '%s'。";
  public static final String
      QUERY_EXCEPTION_FAILED_TO_CREATE_FUNCTION_S_BECAUSE_THERE_IS_AN_ARGUMENT_E7A0B1D6 =
          "无法创建函数 '%s'：存在 OBJECT 类型参数 '%s'。";
  public static final String
      QUERY_EXCEPTION_FAILED_TO_LOAD_CLASS_S_BECAUSE_IT_S_NOT_FOUND_IN_JAR_FILE_E467D08D =
  ...
  public static final String QUERY_EXCEPTION_BUILT_IN_FUNCTION_S_CAN_NOT_BE_DEREGISTERED_1CC7D3C3 =
      "内置函数 %s 不能注销。";
  public static final String
      QUERY_EXCEPTION_FAILED_TO_GET_EXECUTABLE_FOR_TRIGGER_S_PLEASE_CHECK_THE_DA49134A =
  ...
  public static final String QUERY_EXCEPTION_NOT_ALL_SG_IS_READY_9F51CF3E = "并非所有 sg 都已就绪";
  public static final String
  ...
  public static final String
      QUERY_EXCEPTION_FAILED_TO_CREATE_PIPE_S_PIPE_NAME_STARTING_WITH_S_ARE_NOT_201FE8C3 =
          "无法创建 pipe %s，不允许创建以 \"%s\" 开头的 pipe。";
  public static final String
      QUERY_EXCEPTION_FAILED_TO_ALTER_PIPE_S_PIPE_NAME_STARTING_WITH_S_ARE_NOT_03D99ECF =
          "无法修改 pipe %s，不允许修改以 \"%s\" 开头的 pipe。";
  public static final String
      QUERY_EXCEPTION_FAILED_TO_GET_PIPE_INFO_FROM_CONFIG_NODE_STATUS_IS_S_FE797D7B =
  ...
  public static final String QUERY_EXCEPTION_FAILED_TO_ALTER_PIPE_S_BECAUSE_S_A1823289 =
      "无法修改 pipe %s, 原因：%s";
  public static final String
      QUERY_EXCEPTION_FAILED_TO_START_PIPE_S_PIPE_NAME_STARTING_WITH_S_ARE_NOT_F16D488F =
  ...
  public static final String QUERY_EXCEPTION_DATABASE_S_DOESN_T_EXIST_5A8EE8CA = "数据库 %s 不存在。";
  ...
  public static final String QUERY_EXCEPTION_UNEXPECTED_ORDERBY_EXPRESSION_S_9301B69E =
      "意外的 orderBy 表达式：%s";
  public static final String
      QUERY_EXCEPTION_AGGREGATION_ANALYSIS_NOT_YET_IMPLEMENTED_FOR_S_38B64170 = "尚未实现 %s 的聚合分析";
  public static final String QUERY_EXCEPTION_UNEXPECTED_VALUE_LIST_TYPE_FOR_INPREDICATE_S_3D50B78B =
      "InPredicate 的值列表类型意外：%s";
  public static final String QUERY_EXCEPTION_UNEXPECTED_COMPARISON_TYPE_S_5D101FCB = "意外的比较类型：%s";
  ...
  public static final String QUERY_EXCEPTION_UNEXPECTED_QUANTIFIER_S_62214B74 = "意外的 Quantifier：%s";
  public static final String
  ...
  public static final String QUERY_EXCEPTION_UNSUPPORTED_PATTERN_QUANTIFIER_TYPE_S_4ED427E9 =
      "不支持的模式量词类型：%s";
  public static final String FAILED_TO_CREATE_PIPE_PLUGIN_PREFIX_FMT = "创建 pipe plugin %s 失败。 ";
  ...
  public static final String PATH_HAS_NOT_BEEN_SET_ANY_TEMPLATE_FMT = "路径 [%s] 未设置任何模板。";
  ...
  public static final String DATABASE_NAME_LENGTH_SHALL_NOT_EXCEED_FMT = "数据库名长度不能超过 %d";
  public static final String MODEL_TABLE = "表";
  public static final String MODEL_TREE = "树";
  public static final String NO_SYMBOL_MAPPING_FOR_NODE_FMT = "节点 '%s' (%s) 没有 symbol 映射";
  public static final String NO_MAPPING_FOR_EXPRESSION_WITH_IDENTITY_FMT = "表达式没有映射：%s (%s)";
  ...
  public static final String AUTO_ADD_TABLE_COLUMN_FAILED_WITH_COLUMNS_FMT = "自动添加表列失败：%s.%s，%s";
  public static final String QUERY_STATEMENT_NOT_ALLOWED_IN_BATCH_FMT = "批处理中不允许查询语句：[%s]";
  public static final String TABLE_LOST_UNEXPECTED_FMT = "数据库 %s 中的表 %s 意外丢失。";
  public static final String LOAD_FILE_CROSSES_PARTITIONS_FMT = "文件 %s 的数据跨越了分区";
  ...
  public static final String OUT_OF_TTL_FMT = "插入时间 [%s] 小于 ttl 时间下界 [%s]";
  ...
  public static final String DRIVER_TASK_ABORTED_BY_QUERY_CASCADING_ABORTED = "查询级联中止";
  public static final String DRIVER_TASK_ABORTED_BY_ALREADY_BEING_CANCELLED = "已经在取消中";
  public static final String DRIVER_TASK_ABORTED_BY_INTERNAL_ERROR_SCHEDULED = "内部错误调度";
  public static final String DRIVER_TASK_ABORTED_BY_MEMORY_NOT_ENOUGH = "内存不足，无法执行查询任务。";
  public static final String ROOT_FRAGMENT_INSTANCE_PLACEMENT_ERROR_FMT =
      "Root FragmentInstance 放置错误：%s";
  public static final String ALL_REPLICA_CANNOT_BE_REACHED_FMT = "所有副本均不可达：%s";
  public static final String LOAD_READ_ONLY_MESSAGE = "当前系统模式为只读，不支持加载文件";
  ...
  public static final String MESSAGE_FAILED_FETCH_STATE_HAS_RETRIED_ARG_TIMES_E7572C66 =
      "获取 state 失败，已重试 %s 次";
  public static final String MESSAGE_IGNORED_CONFIG_ITEMS_FE28ADBC = "已忽略配置项：";
  public static final String MESSAGE_BECAUSE_THEY_IMMUTABLE_UNDEFINED_07C04F65 = "，因为它们不可变或未定义。";
  ...
  public static final String EXCEPTION_EXPECTEDPARTS_MUST_BE_AT_LEAST_1_B867DB08 =
      "expectedParts 必须至少为 1";
  public static final String EXCEPTION_INVALID_ARG_ARG_2946DBE5 = "无效的 %s %s";
  public static final String EXCEPTION_ID_IS_EMPTY_28C94FC0 = "id 为空";
  ...
  public static final String EXCEPTION_PARTIALRESULT_OF_MAXBY_SLASH_MINBY_SHOULD_BE_1_BF0078F4 =
      "MaxBy/MinBy 的 partialResult 应为 1";
  ...
  public static final String EXCEPTION_FINAL_OUTPUT_CAN_ONLY_BE_SINGLE_COLUMN_6D82F9E0 =
      "最终输出只能是单列";
  public static final String EXCEPTION_PARTIALRESULT_OF_SUM_SHOULD_BE_1_40E85216 =
      "Sum 的 partialResult 应为 1";
  public static final String EXCEPTION_INPUT_OF_SUM_SHOULD_BE_1_D5C11EC8 = "Sum 的输入应为 1";
  ...
  public static final String EXCEPTION_WRONG_INPUTDATATYPES_SIZE_DOT_675FF289 =
      "inputDataTypes 大小错误。";
  public static final String EXCEPTION_INPUT_OF_COUNT_SHOULD_BE_1_C7EEEC46 = "Count 的输入应为 1";
  public static final String EXCEPTION_PARTIALRESULT_OF_MAXTIME_SHOULD_BE_1_877F7EAC =
      "MaxTime 的 partialResult 应为 1";
  public static final String EXCEPTION_LOCALMEMORYMANAGER_IS_NULL_DOT_69FE497A =
      "localMemoryManager 不能为空。";
  public static final String EXCEPTION_TSBLOCKSERDEFACTORY_IS_NULL_DOT_32EB5BD2 =
      "tsBlockSerdeFactory 不能为空。";
  public static final String EXCEPTION_EXECUTORSERVICE_IS_NULL_DOT_7B057909 =
      "executorService 不能为空。";
  public static final String EXCEPTION_MPPDATAEXCHANGESERVICECLIENTMANAGER_IS_NULL_DOT_F31E746C =
      "mppDataExchangeServiceClientManager 不能为空。";
  public static final String EXCEPTION_SHAREDTSBLOCKQUEUE_IS_FULL_87493E26 =
      "SharedTsBlockQueue 已满";
  public static final String EXCEPTION_FRAGMENT_INSTANCE_ID_CANNOT_BE_NULL_4BE84F40 =
      "FragmentInstance ID 不能为空";
  ...
  public static final String EXCEPTION_MAX_BYTES_SHOULD_BE_GREATER_THAN_ZERO_COLON_ARG_EA1FB495 =
      "max bytes 应大于 0：%d";
  public static final String
      EXCEPTION_MAX_BYTES_PER_FI_SHOULD_BE_IN_LEFT_PAREN_0_COMMA_MAXBYTES_RIGHT_BRACKET_DOT_MAXB_4D37C457 =
          "max bytes per FI 应在 (0,maxBytes] 范围内。maxBytesPerFI：%d，maxBytes：%d";
  public static final String
      EXCEPTION_BYTESTORESERVE_SHOULD_BE_IN_LEFT_PAREN_0_COMMA_MAXBYTESPERFI_RIGHT_BRACKET_DOT_M_0753BB69 =
          "bytesToReserve 应在 (0,maxBytesPerFI] 范围内。maxBytesPerFI：%d，bytesToReserve：%d";
  ...
  public static final String EXCEPTION_FRAGMENTINSTANCEID_CANNOT_BE_NULL_C722F460 =
      "fragmentInstanceId 不能为空";
  public static final String EXCEPTION_PLANNODEID_CANNOT_BE_NULL_4533C72B = "planNodeId 不能为空";
  public static final String EXCEPTION_ID_CAN_NOT_BE_NULL_DOT_BDD2AD7D = "id 不能为空";
  public static final String EXCEPTION_QUERYID_CAN_NOT_BE_NULL_DOT_16639DBE = "queryId 不能为空";
  public static final String EXCEPTION_FRAGMENTINSTANCEID_CAN_NOT_BE_NULL_DOT_E88CF18B =
      "fragmentInstanceId 不能为空";
  public static final String EXCEPTION_PLANNODEID_CAN_NOT_BE_NULL_DOT_44027620 = "planNodeId 不能为空";
  ...
  public static final String EXCEPTION_ROOT_OPERATOR_SHOULD_NOT_BE_NULL_F4890A7A =
      "root Operator 不能为空";
  ...
  public static final String EXCEPTION_FRAGMENTINSTANCEID_IS_NULL_4D371DB4 =
      "fragmentInstanceId 不能为空";
  ...
  public static final String EXCEPTION_ARG_IS_A_NON_MINUS_DONE_FAILURE_STATE_B167E915 =
      "%s 是未完成的失败状态";
  ...
  public static final String EXCEPTION_CAN_QUOTE_T_INIT_NULL_CHUNKMETA_15C12BEE =
      "不能用 null chunkMeta 初始化";
  ...
  public static final String EXCEPTION_REMAININGINPUTLOCATIONS_IS_NULL_CEBBA2C1 =
      "remainingInputLocations 不能为空";
  public static final String EXCEPTION_LAST_QUERY_RESULT_SHOULD_ONLY_HAVE_ONE_RECORD_EDFEE635 =
      "last 查询结果只能有一条记录";
  public static final String EXCEPTION_OUTPUTPATHS_SHOULDN_QUOTE_T_BE_NULL_BF3F5FB4 =
      "outputPaths 不能为空";
  public static final String
  ...
  public static final String EXCEPTION_DRIVERTASK_TO_BE_PUSHED_IS_NULL_7581A0E3 =
      "待推送的 DriverTask 不能为空";
  ...
  public static final String EXCEPTION_RESULT_DRIVERTASK_CANNOT_BE_NULL_30A06DB1 =
      "结果 DriverTask 不能为空";
  public static final String EXCEPTION_DRIVERTASKQUEUE_IS_NULL_7C3C8B7B = "driverTaskQueue 不能为空";
  public static final String EXCEPTION_MAXDRIVERSPERTASK_IS_NULL_8408F9B7 =
      "maxDriversPerTask 不能为空";
  public static final String EXCEPTION_QUEUE_CAN_NOT_BE_NULL_DOT_9BB286B1 = "queue 不能为空";
  ...
  public static final String EXCEPTION_EXECUTORSERVICE_CAN_NOT_BE_NULL_DOT_BC459BD4 =
      "executorService 不能为空";
  public static final String EXCEPTION_SERDE_CAN_NOT_BE_NULL_DOT_D46F66E7 = "serde 不能为空";
  ...
  public static final String
      EXCEPTION_STEP_IN_SLIDINGWINDOWAGGREGATIONOPERATOR_CAN_ONLY_PROCESS_PARTIAL_RESULT_E221A2C5 =
          "SlidingWindowAggregationOperator 中的 Step 只能处理部分结果";
  public static final String
      EXCEPTION_SLIDINGWINDOWAGGREGATIONOPERATOR_CAN_ONLY_PROCESS_ONE_TSBLOCK_INPUT_DOT_7B9FCAB7 =
          "SlidingWindowAggregationOperator 只能处理一个 TsBlock 输入。";
  public static final String EXCEPTION_IS_NULL_97AAF381 = " 不能为空";
  public static final String EXCEPTION_MPP_DATA_EXCHANGE_MANAGER_SHOULD_NOT_BE_NULL_44D7141E =
      "MPP_DATA_EXCHANGE_MANAGER 不能为空";
  ...
  public static final String EXCEPTION_DESCRIPTOR_QUOTE_S_INPUT_EXPRESSION_SIZE_IS_NOT_1_DA4BED50 =
      "descriptor 的输入表达式大小不是 1";
  public static final String EXCEPTION_GROUPBYLEVEL_DESCRIPTORLIST_CANNOT_BE_EMPTY_34604314 =
      "GroupByLevel descriptorList 不能为空";
  public static final String EXCEPTION_GROUPBYTAG_TAG_KEYS_CANNOT_BE_EMPTY_5D649624 =
      "GroupByTag tag keys 不能为空";
  public static final String EXCEPTION_GROUPBYTAG_AGGREGATION_DESCRIPTORS_CANNOT_BE_EMPTY_82EC14EB =
      "GroupByTag aggregation descriptors 不能为空";
  public static final String EXCEPTION_AGGREGATION_DESCRIPTORLIST_CANNOT_BE_EMPTY_490C1740 =
      "Aggregation descriptorList 不能为空";
  public static final String EXCEPTION_PUSH_DOWN_PREDICATE_IS_NOT_SUPPORTED_YET_178F04A1 =
      "暂不支持 push down predicate";
  public static final String EXCEPTION_SINK_IS_NULL_E33854B4 = "sink 不能为空";
  public static final String EXCEPTION_THERE_MUST_BE_AT_MOST_ONE_SINKNODE_A965AFE7 =
      "最多只能有一个 SinkNode";
  ...
  public static final String EXCEPTION_TEMPLATEDINFO_SHOULD_NOT_BE_NULL_B5898568 =
      "TemplatedInfo 不能为空";
  public static final String
      EXCEPTION_RESULTHANDLE_IN_COORDINATOR_SHOULD_BE_INIT_FIRSTLY_DOT_0F44159B =
          "Coordinator 中的 ResultHandle 应先初始化。";
  ...
  public static final String
      EXCEPTION_PATH_QUOTE_ARG_QUOTE_IS_NOT_ANALYZED_IN_GROUPBYLEVELHELPER_DOT_BCEE9D39 =
          "路径 '%s' 未在 GroupByLevelHelper 中分析。";
  ...
  public static final String
      EXCEPTION_NO_TYPE_FOUND_FOR_SYMBOL_QUOTE_ARG_QUOTE_IN_TYPEPROVIDER_F4DD9DF7 =
          "TypeProvider 中未找到 symbol '%s' 的类型";
  public static final String EXCEPTION_OUTPUT_COLUMN_QUOTE_ARG_QUOTE_IS_NOT_STORED_IN_ARG_2DE3176D =
      "输出列 '%s' 未存储在 %s 中";
  ...
  public static final String
      EXCEPTION_THE_LENGTH_OF_CASEWHENTHENEXPRESSION_QUOTE_S_WHENTHENLIST_MUST_GREATER_THAN_0_069775ED =
          "CaseWhenThenExpression 的 whenThenList 长度必须大于 0";
  ...
  public static final String EXCEPTION_THE_TIMESERIES_ORDER_IS_NOT_SPECIFIED_DOT_68EE3875 =
      "未指定时间序列顺序。";
  ...
  public static final String
      EXCEPTION_INFORMATIONSCHEMATABLESCANNODE_MUST_HAVE_REGIONREPLICASET_0411DBCB =
          "InformationSchemaTableScanNode 必须包含 regionReplicaSet";
  public static final String
      EXCEPTION_EACH_INFORMATIONSCHEMATABLESCANNODE_HAVE_ONLY_ONE_DATANODELOCATION_FA3E82C4 =
          "每个 InformationSchemaTableScanNode 只能有一个 DataNodeLocation";
  public static final String
      EXCEPTION_CHILD_OF_EXCHANGENODE_MUST_BE_MULTICHILDRENSINKNODE_1BF715FD =
          "ExchangeNode 的子节点必须是 MultiChildrenSinkNode。";
  public static final String EXCEPTION_SIZE_OF_SOURCELOCATIONS_SHOULD_BE_LARGER_THAN_0_2EC41A23 =
      "sourceLocations 的大小应大于 0";
  public static final String EXCEPTION_INDEX_IS_NOT_VALID_2AB4FB3A = "索引无效";
  public static final String EXCEPTION_LINES_OF_BOX_STRING_SHOULD_BE_GREATER_THAN_0_5DB8C047 =
      "box string 的行数应大于 0";
  ...
  public static final String EXCEPTION_SYMBOLHINT_NOT_IN_SYMBOLS_MAP_B0D67E43 =
      "symbolHint 不在 symbols map 中";
  ...
  public static final String EXCEPTION_RECURSIVESUBQUERIES_IS_NULL_6AD8A180 =
      "recursiveSubqueries 不能为空";
  public static final String
      EXCEPTION_PREDICATEWITHUNCORRELATEDSCALARSUBQUERYRECONSTRUCTOR_IS_NULL_B264FEBC =
          "predicateWithUncorrelatedScalarSubqueryReconstructor 不能为空";
  public static final String EXCEPTION_ONLY_SUPPORT_ONE_GROUPINGSET_NOW_A1277FA4 =
      "目前仅支持一个 groupingSet";
  ...
  public static final String EXCEPTION_TYPE_NOT_FOUND_FOR_EXPRESSION_COLON_ARG_C26C9237 =
      "未找到表达式的类型：%s";
  public static final String EXCEPTION_VALUE_REACH_HERE_MUST_BE_EXPRESSION_C7CA1971 =
      "执行到这里时值必须为表达式";
  ...
  public static final String
      EXCEPTION_NO_FIELD_MINUS_GREATER_THAN_SYMBOL_MAPPING_FOR_FIELD_ARG_698FDF06 =
          "字段 %s 没有 field->symbol 映射";
  public static final String
      EXCEPTION_FOR_NOW_COMMA_ONLY_SINGLE_COLUMN_SUBQUERIES_ARE_SUPPORTED_AD9593BE = "目前仅支持单列子查询";
  public static final String
      EXCEPTION_FOR_NOW_COMMA_ONLY_SINGLE_COLUMN_SUBQUERIES_ARE_SUPPORTED_DOT_068B1A66 =
          "目前仅支持单列子查询。";
  public static final String EXCEPTION_CLUSTER_IS_EMPTY_22299EED = "Cluster 为空";
  public static final String
  ...
  public static final String EXCEPTION_NO_RELATIONS_SPECIFIED_FOR_INTERSECT_76B0ED3B =
      "未为 INTERSECT 指定关系";
  public static final String EXCEPTION_NO_RELATIONS_SPECIFIED_FOR_EXCEPT_C8E4B4AA =
      "未为 EXCEPT 指定关系";
  ...
  public static final String EXCEPTION_SCOPECOMPLEMENTEQUALITIES_IS_NULL_B9080FC7 =
      "scopeComplementEqualities 不能为空";
  public static final String EXCEPTION_SCOPESTRADDLINGEQUALITIES_IS_NULL_F6B979AE =
      "scopeStraddlingEqualities 不能为空";
  ...
  public static final String EXCEPTION_CONDITION_MUST_BE_BOOLEAN_COLON_ARG_806C2960 =
      "条件必须为 boolean：%s";
  public static final String EXCEPTION_TYPES_MUST_BE_EQUAL_COLON_ARG_VS_ARG_098424AD =
      "类型必须相同：%s vs %s";
  ...
  public static final String EXCEPTION_N_MUST_BE_GREATER_THAN_OR_EQUAL_TO_ZERO_C4CE8BF0 =
      "n 必须大于或等于 0";
  ...
  public static final String EXCEPTION_STATEMENTANALYZERFACTORY_IS_NULL_D309BAB5 =
      "statementAnalyzerFactory 不能为空";
  ...
  public static final String EXCEPTION_RECURSIVEREFERENCE_IS_NULL_24B9D5DC =
      "recursiveReference 不能为空";
  ...
  public static final String EXCEPTION_EXPRESSION_IS_NOT_A_COLUMN_REFERENCE_COLON_ARG_7957E705 =
      "表达式不是列引用：%s";
  public static final String
  ...
  public static final String EXCEPTION_MISSING_FILLANALYSIS_FOR_NODE_ARG_7E5B19A4 =
      "节点 %s 缺少 FillAnalysis";
  public static final String EXCEPTION_MISSING_OFFSET_VALUE_FOR_NODE_ARG_4B107520 =
      "节点 %s 缺少 OFFSET 值";
  public static final String EXCEPTION_MISSING_LIMIT_VALUE_FOR_NODE_ARG_DD5FD777 =
      "节点 %s 缺少 LIMIT 值";
  ...
  public static final String EXCEPTION_GROUPBYEXPRESSIONS_IS_NULL_BFDC07D2 =
      "groupByExpressions 不能为空";
  ...
  public static final String EXCEPTION_QUERY_QUOTE_ARG_QUOTE_IS_ALREADY_ADDED_F3D47DBD =
      "Query '%s' 已添加";
  ...
  public static final String EXCEPTION_SUBQUERYINPREDICATES_IS_NULL_5A37F1C8 =
      "subqueryInPredicates 不能为空";
  ...
  public static final String EXCEPTION_QUANTIFIEDCOMPARISONS_IS_NULL_A30F5121 =
      "quantifiedComparisons 不能为空";
  ...
  public static final String EXCEPTION_GETRESOLVEDWINDOW_IS_NULL_2438758C =
      "getResolvedWindow 不能为空";
  public static final String EXCEPTION_GETPREANALYZEDTYPE_IS_NULL_FBB2EC7D =
      "getPreanalyzedType 不能为空";
  public static final String EXCEPTION_BASESCOPE_IS_NULL_ABE8F618 = "baseScope 不能为空";
  public static final String EXCEPTION_PATTERNRECOGNITIONCONTEXT_IS_NULL_59C665F1 =
      "patternRecognitionContext 不能为空";
  public static final String EXCEPTION_CORRELATIONSUPPORT_IS_NULL_E0D669BF =
      "correlationSupport 不能为空";
  public static final String EXCEPTION_FUNCTIONINPUTTYPES_IS_NULL_3030658F =
      "functionInputTypes 不能为空";
  public static final String EXCEPTION_COLUMN_IS_NULL_0C404041 = "column 不能为空";
  public static final String EXCEPTION_EXPRESSION_NOT_YET_ANALYZED_COLON_ARG_0F4F19B7 =
      "表达式尚未分析：%s";
  public static final String EXCEPTION_ARG_ALREADY_KNOWN_TO_REFER_TO_ARG_8C8B4F24 = "%s 已知引用 %s。";
  public static final String EXCEPTION_NO_RESOLVED_WINDOW_FOR_COLON_AED19667 =
      "没有 resolved window：";
  ...
  public static final String EXCEPTION_STATEMENT_REWRITE_RETURNED_NULL_AB1E89EA =
      "Statement rewrite 返回了 null";
  ...
  public static final String EXCEPTION_PARSERRULECONTEXT_IS_NULL_9E0DD3B5 =
      "parserRuleContext 不能为空";
  ...
  public static final String EXCEPTION_TOPIC_NAME_CAN_NOT_BE_NULL_EA4ED0BF = "topic name 不能为空";
  ...
  public static final String EXCEPTION_SIZE_OF_COLUMNLIST_SHOULD_BE_LARGER_THAN_1_7EB80E55 =
      "columnList 的大小应大于 1";
  public static final String EXCEPTION_ASSIGNMENTS_IS_NULL_1FD6142D = "assignments 不能为空";
  public static final String EXCEPTION_PIPE_NAME_CAN_NOT_BE_NULL_14570979 = "pipe name 不能为空";
  ...
  public static final String EXCEPTION_PLUGIN_NAME_CAN_NOT_BE_NULL_92F0F4D6 = "plugin name 不能为空";
  public static final String EXCEPTION_CLASS_NAME_CAN_NOT_BE_NULL_1D276677 = "class name 不能为空";
  public static final String EXCEPTION_URI_CAN_NOT_BE_NULL_B3535EDC = "uri 不能为空";
  ...
  public static final String EXCEPTION_TABLEARGUMENTANALYSES_IS_NULL_C8724E40 =
      "tableArgumentAnalyses 不能为空";
  public static final String EXCEPTION_ARGUMENT_IS_NULL_0CBBD22B = "argument 不能为空";
  public static final String EXCEPTION_TABLEARGUMENTANALYSIS_IS_NULL_CF9F0E25 =
      "tableArgumentAnalysis 不能为空";
  ...
  public static final String EXCEPTION_CORRELATEDPREDICATES_IS_NULL_5FCB8011 =
      "correlatedPredicates 不能为空";
  ...
  public static final String EXCEPTION_METADATAEXPRESSIONS_IS_NULL_3752914C =
      "metadataExpressions 不能为空";
  public static final String EXCEPTION_EXPRESSIONSCANPUSHDOWN_IS_NULL_DC8DFEB3 =
      "expressionsCanPushDown 不能为空";
  public static final String EXCEPTION_EXPRESSIONSCANNOTPUSHDOWN_IS_NULL_63BC9AF9 =
      "expressionsCannotPushDown 不能为空";
  public static final String EXCEPTION_FILTER_PREDICATE_OF_FILTERNODE_IS_NULL_C3964179 =
      "FilterNode 的过滤谓词为空。";
  public static final String EXCEPTION_UNSUPPORTED_JOIN_TYPE_COLON_ARG_9FB6751B =
      "不支持的 join type: %s";
  public static final String EXCEPTION_UNIQUEID_IN_PREDICATE_IS_NOT_YET_SUPPORTED_7B5D2EAF =
      "predicate 中暂不支持 UniqueId";
  public static final String EXCEPTION_MAPPERPROVIDER_IS_NULL_472725D5 = "mapperProvider 不能为空";
  public static final String EXCEPTION_CORRELATIONMAPPING_IS_NULL_9D595C82 =
      "correlationMapping 不能为空";
  ...
  public static final String EXCEPTION_PLANOPTIMIZERSSTATSCOLLECTOR_IS_NULL_9DA4B0CC =
      "planOptimizersStatsCollector 不能为空";
  public static final String EXCEPTION_SUBQUERY_RESULT_TYPE_MUST_BE_ORDERABLE_82AF0EFA =
      "子查询结果类型必须可排序";
  public static final String
      EXCEPTION_ALL_THE_NON_CORRELATED_SUBQUERIES_SHOULD_BE_REWRITTEN_AT_THIS_POINT_B4614541 =
          "执行到这里时，所有非关联子查询都应已被重写";
  ...
  public static final String EXCEPTION_SIZE_OF_TOPKNODE_CAN_ONLY_BE_1_IN_LOGICAL_PLAN_DOT_DB32E3C5 =
      "逻辑计划中的 TopKNode 大小只能为 1。";
  public static final String
      EXCEPTION_THE_SIZE_OF_LEFT_CHILDREN_NODE_OF_JOINNODE_SHOULD_BE_1_F3437368 =
          "JoinNode 的左子节点数量应为 1";
  public static final String
      EXCEPTION_THE_SIZE_OF_RIGHT_CHILDREN_NODE_OF_JOINNODE_SHOULD_BE_1_6BA167CF =
          "JoinNode 的右子节点数量应为 1";
  public static final String
      EXCEPTION_THE_SIZE_OF_LEFT_CHILDREN_NODE_OF_SEMIJOINNODE_SHOULD_BE_1_FFEE3F41 =
          "SemiJoinNode 的左子节点数量应为 1";
  public static final String
      EXCEPTION_THE_SIZE_OF_RIGHT_CHILDREN_NODE_OF_SEMIJOINNODE_SHOULD_BE_1_AE90C4B8 =
          "SemiJoinNode 的右子节点数量应为 1";
  public static final String EXCEPTION_CHILDRENNODES_SHOULD_NOT_BE_NULL_DOT_0C93B063 =
      "childrenNodes 不能为空。";
  public static final String EXCEPTION_CHILDRENNODES_SHOULD_NOT_BE_EMPTY_DOT_E5555FD9 =
      "childrenNodes 不能为空。";
  public static final String
      EXCEPTION_SIZE_OF_TOPKRANKINGNODE_CAN_ONLY_BE_1_IN_LOGICAL_PLAN_DOT_20D6A513 =
          "逻辑计划中的 TopKRankingNode 大小只能为 1。";
  ...
  public static final String
      EXCEPTION_TIMEOUT_HAS_TO_BE_A_NON_MINUS_NEGATIVE_NUMBER_LEFT_BRACKET_MILLISECONDS_RIGHT_BR_5201D8B3 =
          "Timeout 必须为非负数 [milliseconds]";
  public static final String EXCEPTION_NODE_QUOTE_ARG_QUOTE_IS_NOT_A_GROUPREFERENCE_73C8C127 =
      "节点 '%s' 不是 GroupReference";
  ...
  public static final String
      EXCEPTION_ARG_COLON_TRANSFORMED_EXPRESSION_DOESN_QUOTE_T_PRODUCE_SAME_OUTPUTS_COLON_ARG_VS_F9BAF138 =
          "%s：转换后的表达式产生的输出不同：%s vs %s";
  public static final String EXCEPTION_CANNOT_DELETE_GROUP_THAT_HAS_INCOMING_REFERENCES_83C9D700 =
      "无法删除存在传入引用的 group。";
  public static final String EXCEPTION_REFERENCE_TO_REMOVE_NOT_FOUND_2EB93289 = "未找到待移除的引用。";
  ...
  public static final String
      EXCEPTION_PRE_MINUS_GROUPED_SYMBOLS_MUST_BE_A_SUBSET_OF_THE_GROUPING_KEYS_AFC6C33D =
          "预分组符号必须是分组键的子集。";
  public static final String EXCEPTION_EXPECTED_AGGREGATION_TO_HAVE_DISTINCT_INPUT_EC6AF059 =
      "期望聚合包含 DISTINCT 输入";
  public static final String
      EXCEPTION_MISMATCHED_CHILD_LEFT_PAREN_ARG_RIGHT_PAREN_AND_PERMITTED_OUTPUTS_LEFT_PAREN_ARG_57801144 =
          "子节点 (%s) 与允许输出 (%s) 的大小不匹配";
  public static final String EXCEPTION_MISSING_TYPE_FOR_EXPRESSION_3D66D302 = "缺少表达式类型";
  public static final String EXCEPTION_EXCEPTNODE_TRANSLATION_RESULT_HAS_NO_COUNT_SYMBOLS_8653930E =
      "ExceptNode 翻译结果中没有计数符号";
  public static final String EXCEPTION_UNEXPECTED_CORRELATED_JOIN_TYPE_COLON_ARG_27E8EC42 =
      "意外的 correlated join 类型：%s";
  ...
  public static final String
      EXCEPTION_THE_SIZE_OF_MARKERS_SHOULD_BE_SAME_AS_THE_SIZE_OF_COUNT_OUTPUT_SYMBOLS_6DBDD287 =
          "markers 的数量应与计数输出符号的数量相同";
  public static final String EXCEPTION_ROWNUMBERSYMBOL_IS_EMPTY_34FE9565 = "rowNumberSymbol 为空";
  public static final String EXCEPTION_EXPECTED_SUBQUERY_OUTPUT_SYMBOLS_TO_BE_PRUNED_13B84182 =
      "期望子查询输出符号已被剪枝";
  public static final String EXCEPTION_TYPEANALYZER_IS_NULL_3106B188 = "typeAnalyzer 不能为空";
  public static final String EXCEPTION_UNEXPECTED_CORRELATEDJOIN_TYPE_COLON_47A368C1 =
      "意外的 CorrelatedJoin 类型：";
  public static final String EXCEPTION_UNEXPECTED_NULL_LITERAL_WITHOUT_A_CAST_TO_BOOLEAN_D399CFCB =
      "意外的 null 字面量，未 cast 为 boolean";
  ...
  public static final String
      EXCEPTION_EXPRESSION_IS_NOT_ANALYZED_LEFT_PAREN_ARG_RIGHT_PAREN_COLON_ARG_DAE760B6 =
          "Expression 尚未分析（%s）：%s";
  public static final String EXCEPTION_SYMBOL_REFERENCES_ARE_NOT_ALLOWED_93779D6C =
      "不允许使用 symbol references";
  public static final String
  ...
  public static final String
      EXCEPTION_GROUP_BY_ALL_CANNOT_BE_COMBINED_WITH_EXPLICIT_GROUPING_ELEMENTS_4CFE411D =
          "GROUP BY ALL 不能与显式分组元素组合使用";
  public static final String
      EXCEPTION_THE_SECOND_ARGUMENT_OF_PERCENTILE_FUNCTION_PERCENTAGE_MUST_BE_A_DOUBLE_LITERAL_D9464B46 =
          "'percentile' 函数的第二个参数 percentage 必须是 double 字面量";
  public static final String
      EXCEPTION_DATA_TYPE_MISMATCH_FOR_MEASUREMENT_ARGARGARG_TYPE_IN_TSFILE_ARG_TYPE_IN_IOTDB_ARG_C5BA7DBD =
          "测点 %s%s%s 的数据类型不匹配，TsFile 中类型：%s，IoTDB 中类型：%s";
  public static final String MESSAGE_FAILED_TO_RELEASE_EXTERNAL_TSFILE_QUERY_RESOURCE_712EE978 =
      "释放外部 TsFile 查询资源失败";
  public static final String
      EXCEPTION_OUTER_QUERY_TIMEOUT_EXCEEDED_BEFORE_IOTDBLOCAL_QUERY_STARTS_800BFA63 =
          "在 IoTDBLocal 查询开始前，外层查询已超时";
  public static final String MESSAGE_FAILED_TO_CLOSE_UDF_RESULT_SET_AT_INDEX_ARG_A293B7EC =
      "关闭索引 {} 处的 UDF 结果集失败";
  ...
  public static final String
      EXCEPTION_ONLY_QUERY_IS_SUPPORTED_FOR_IOTDBLOCAL_QUERY_INTERFACE_09195570 =
          "IoTDBLocal 查询接口仅支持 query 操作";
  public static final String EXCEPTION_FAILED_TO_CLOSE_INTERNAL_QUERY_RESULT_ED86BF5E =
      "关闭内部查询结果失败";
  public static final String EXCEPTION_UDFRESULTSET_IS_ALREADY_CLOSED_E1ACABE3 =
      "UDFResultSet 已经关闭";

  public static final String EXCEPTION_LATERALCOLUMNALIASREFERENCES_IS_NULL_0CC58C78 =
      "lateralColumnAliasReferences 不能为空";

  public static final String EXCEPTION_OUTPUTEXPRESSIONS_IS_NULL_7BD39A8F =
      "outputExpressions 不能为空";
  public static final String EXCEPTION_ALIASES_IS_NULL_6D98FA6C = "aliases 不能为空";
  public static final String EXCEPTION_SINGLECOLUMNEXPRESSIONS_IS_NULL_EFB296FD =
      "singleColumnExpressions 不能为空";
  public static final String EXCEPTION_CANONICALNAME_IS_NULL_DDFE6DB1 = "canonicalName 不能为空";
  public static final String EXCEPTION_REWRITTENEXPRESSION_IS_NULL_6EE23088 =
      "rewrittenExpression 不能为空";
  public static final String EXCEPTION_ALIASESBYCANONICALNAME_IS_NULL_635C7ED3 =
      "aliasesByCanonicalName 不能为空";
