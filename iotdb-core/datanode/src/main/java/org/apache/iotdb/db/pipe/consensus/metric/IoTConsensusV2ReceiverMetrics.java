...
import org.apache.iotdb.db.pipe.receiver.protocol.iotconsensusv2.IoTConsensusV2Receiver;
...
public class IoTConsensusV2ReceiverMetrics implements IMetricSet {
  private final IoTConsensusV2Receiver iotConsensusV2Receiver;
  ...
  private static final String RECEIVER = "iotConsensusV2Receiver";

  public IoTConsensusV2ReceiverMetrics(IoTConsensusV2Receiver iotConsensusV2Receiver) {
    this.iotConsensusV2Receiver = iotConsensusV2Receiver;
  }
  ...
  public void bindAutoGauge(AbstractMetricService metricService) {
    metricService.createAutoGauge(
        ...
        IoTConsensusV2Receiver::getReceiveBufferSize,
        Tag.NAME.toString(),
        RECEIVER,
        Tag.REGION.toString(),
        iotConsensusV2Receiver.getConsensusGroupIdStr(),
        Tag.TYPE.toString(),
        "receiveBufferSize");
    metricService.createAutoGauge(
        Metric.PIPE_RECEIVE_EVENT.toString(),
        MetricLevel.IMPORTANT,
        iotConsensusV2Receiver,
        IoTConsensusV2Receiver::getWALEventCount,
        Tag.NAME.toString(),
        RECEIVER,
        Tag.REGION.toString(),
        iotConsensusV2Receiver.getConsensusGroupIdStr(),
    ...
    metricService.createAutoGauge(
        ...
        MetricLevel.IMPORTANT,
        iotConsensusV2Receiver,
        IoTConsensusV2Receiver::getTsFileEventCount,
        Tag.NAME.toString(),
        RECEIVER,
        Tag.REGION.toString(),
        iotConsensusV2Receiver.getConsensusGroupIdStr(),
