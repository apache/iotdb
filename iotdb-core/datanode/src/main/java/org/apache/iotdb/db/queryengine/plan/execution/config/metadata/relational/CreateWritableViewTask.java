...
public class CreateWritableViewTask extends CreateTableTask {
  private final Map<String, String> viewColumnCommentMap;

  public CreateWritableViewTask(
  ...
  public ListenableFuture<ConfigTaskResult> execute(final IConfigTaskExecutor configTaskExecutor)
    ...
    return configTaskExecutor.createWritableView(
        (WritableView) table, database, ifNotExists, viewColumnCommentMap);
  }
}
