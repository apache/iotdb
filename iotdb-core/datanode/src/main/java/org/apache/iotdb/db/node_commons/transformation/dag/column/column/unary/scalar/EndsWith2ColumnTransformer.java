...
import static org.apache.iotdb.db.node_commons.transformation.dag.column.column.unary.scalar.StartsWithColumnTransformer.equalCompare;
    ...
    for (int i = 0; i < positionCount; i++) {
      if (!leftColumn.isNull(i) && !rightColumn.isNull(i)) {
        ...
        columnBuilder.writeBoolean(
            equalCompare(leftValue, rightValue, leftValue.length - rightValue.length));
      } else {
