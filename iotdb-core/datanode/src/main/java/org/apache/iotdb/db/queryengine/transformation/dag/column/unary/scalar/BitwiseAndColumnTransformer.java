...
public class BitwiseAndColumnTransformer extends AbstractBitwiseColumnTransformer {
  ...
  protected void transform(Column column, ColumnBuilder columnBuilder, int i) {
    ...
    long currentValue = BitwiseUtils.bitwiseAndTransform(leftValue, rightValue);
