...
import org.apache.iotdb.commons.node_commons.plan.planner.plan.node.process.ProcessNode;
...
public class NodePathsConvertNode extends ProcessNode {
  ...
  public <R, C> R accept(IPlanVisitor<R, C> visitor, C context) {
    return ((PlanVisitor<R, C>) visitor).visitNodePathConvert(this, context);
  }
