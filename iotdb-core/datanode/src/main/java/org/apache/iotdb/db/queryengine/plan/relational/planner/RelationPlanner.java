        ...
        extends AstVisitor<RelationPlan, Void>
{
    ...
    protected RelationPlan visitTable(Table node, Void context) {
        ...
        if (expansion != null) {
            ...
            return new RelationPlan(expansion.getRoot(), expansion.getScope(), expansion.getFieldMappings());
        }
        ...
        if (namedQuery != null) {
            ...
            if (analysis.isExpandableQuery(namedQuery)) {
                subPlan = new QueryPlanner(analysis, symbolAllocator, idAllocator,
            ...
            plan = new RelationPlan(coerced.getNode(), scope, coerced.getFields());
        } else {
            ...
            PlanNode root = TableScanNode.newInstance(idAllocator.genPlanNodeId(), handle, outputSymbols,
                    columns.buildOrThrow(), Optional.empty());
    ...
    public RelationPlan addRowFilters(Table node, RelationPlan plan,
                                      Function<Expression, Expression> predicateTransformation,
                                      Function<Table, Scope> accessControlScope) {
