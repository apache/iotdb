...
public class PipeEventCommitManager {
  ...
  private final Map<String, Object> committableConnectors = new ConcurrentHashMap<>();
  ...
  public void register(String pipeName, int dataRegionId, String pipePluginName) {
    if (!committableConnectors.containsKey(pipePluginName) || pipeName == null) {
      return;
    }
  ...
  private PipeEventCommitManager() {
    committableConnectors.put(
        BuiltinPipePlugin.IOTDB_THRIFT_CONNECTOR.getPipePluginName(), new Object());
    committableConnectors.put(
        BuiltinPipePlugin.IOTDB_THRIFT_SYNC_CONNECTOR.getPipePluginName(), new Object());
    committableConnectors.put(
        BuiltinPipePlugin.IOTDB_THRIFT_ASYNC_CONNECTOR.getPipePluginName(), new Object());
    committableConnectors.put(
        BuiltinPipePlugin.IOTDB_LEGACY_PIPE_CONNECTOR.getPipePluginName(), new Object());
    committableConnectors.put(
        BuiltinPipePlugin.WRITE_BACK_CONNECTOR.getPipePluginName(), new Object());

    committableConnectors.put(
        BuiltinPipePlugin.IOTDB_THRIFT_SINK.getPipePluginName(), new Object());
    committableConnectors.put(
        BuiltinPipePlugin.IOTDB_THRIFT_SYNC_SINK.getPipePluginName(), new Object());
    committableConnectors.put(
        BuiltinPipePlugin.IOTDB_THRIFT_ASYNC_SINK.getPipePluginName(), new Object());
    committableConnectors.put(
        BuiltinPipePlugin.IOTDB_LEGACY_PIPE_SINK.getPipePluginName(), new Object());
    committableConnectors.put(BuiltinPipePlugin.WRITE_BACK_SINK.getPipePluginName(), new Object());
  }
