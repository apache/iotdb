...
public class DataRegionSourceWithPattern {
  ...
  public DataRegionSourceWithPattern(final PipeRealtimeDataRegionSource source) {
    ...
    this.tablePattern = source.getTablePattern();
  }

  public DataRegionSourceWithPattern(
  ...
  public PipeRealtimeDataRegionSource getSource() {
    return source;
  }
