...
public class PruneCopyToColumns implements Rule<CopyToNode> {
  private static final Pattern<CopyToNode> PATTERN = copyTo();

  @Override
  public Pattern<CopyToNode> getPattern() {
    return PATTERN;
  }

  @Override
  public Result apply(CopyToNode node, Captures captures, Context context) {
    return restrictChildOutputs(
            context.getIdAllocator(), node, ImmutableSet.copyOf(node.getChildPermittedOutputs()))
