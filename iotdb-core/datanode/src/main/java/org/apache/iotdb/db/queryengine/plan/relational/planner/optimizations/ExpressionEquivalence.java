...
// {
//    private static final Ordering<RowExpression> ROW_EXPRESSION_ORDERING = Ordering.from(new
// RowExpressionComparator());
...
//
//    public ExpressionEquivalence(Metadata metadata, FunctionManager functionManager, TypeManager
// typeManager, IrTypeAnalyzer typeAnalyzer)
//    {
...
//    }
//
//    public boolean areExpressionsEquivalent(Session session, Expression leftExpression, Expression
// rightExpression, TypeProvider types)
//    {
...
//        RowExpression canonicalizedRight = rightRowExpression.accept(canonicalizationVisitor,
// null);
//
//        return canonicalizedLeft.equals(canonicalizedRight);
//    }
//
//    private RowExpression toRowExpression(Session session, Expression expression, Map<Symbol,
// Integer> symbolInput, TypeProvider types)
//    {
//        return translate(
//                expression,
...
//
//            CatalogSchemaFunctionName callName =
// call.getResolvedFunction().getSignature().getName();
//
//            if (callName.equals(builtinFunctionName(EQUAL)) ||
// callName.equals(builtinFunctionName(IS_DISTINCT_FROM))) {
//                // sort arguments
...
//                List<RowExpression> sortedArguments =
// ROW_EXPRESSION_ORDERING.sortedCopy(distinctArguments);
//
...
//        {
//            return new LambdaDefinitionExpression(lambda.getArgumentTypes(),
// lambda.getArguments(), lambda.getBody().accept(this, context));
//        }
//
//        @Override
//        public RowExpression visitVariableReference(VariableReferenceExpression reference, Void
// context)
//        {
//            return reference;
//        }
...
//        private final ListComparator<RowExpression> argumentComparator = new
// ListComparator<>(this);
//
//        @Override
...
//                        .compare(leftCall.getResolvedFunction().toString(),
// rightCall.getResolvedFunction().toString())
//                        .compare(leftCall.getArguments(), rightCall.getArguments(),
// argumentComparator)
//                        .result();
//            }
//
...
//                        .compare(leftForm.getArguments(), rightForm.getArguments(),
// argumentComparator)
//                        .result();
//            }
//
...
//
//                result =
// leftConstant.getType().getTypeSignature().toString().compareTo(right.getType().getTypeSignature().toString());
//                if (result != 0) {
//                    return result;
//                }
//
...
// javaType == long.class) {
//                    return Long.compare(((Number) leftValue).longValue(), ((Number)
// rightValue).longValue());
//                }
//                if (javaType == float.class || javaType == double.class) {
//                    return Double.compare(((Number) leftValue).doubleValue(), ((Number)
...
//                }
//
//                // value is some random type (say regex), so we just randomly choose a greater
// value
...
//                return Integer.compare(leftInputReferenceExpression.getField(),
// ((InputReferenceExpression) right).getField());
//            }
//
...
//                VariableReferenceExpression rightVariableReference = (VariableReferenceExpression)
// right;
//
//                return ComparisonChain.start()
//                        .compare(leftVariableReference.getName(),
// rightVariableReference.getName())
//                        .compare(leftVariableReference.getType(),
// rightVariableReference.getType(), Comparator.comparing(Object::toString))
//                        .result();
//            }
//
//            throw new IllegalArgumentException("Unsupported RowExpression type " +
...
//        {
//            this.elementComparator = requireNonNull(elementComparator, "elementComparator is
// null");
//        }
//
//        @Override
