...
public class ExchangeNodeAdder extends PlanVisitor<PlanNode, NodeGroupContext> {
  ...
  @Override
  public PlanNode visitTableDeviceScan(TableDeviceScanNode node, NodeGroupContext context) {
    return processNoChildSourceNode(node, context);
  }

  @Override
  public PlanNode visitTableDeviceFetch(TableDeviceFetchNode node, NodeGroupContext context) {
    return processNoChildSourceNode(node, context);
  }
  ...
  @Override
  public PlanNode visitRegionMerge(RegionMergeNode node, NodeGroupContext context) {
