...
public class SubscriptionPipeTsFileEventBatch extends SubscriptionPipeEventBatch {
  ...
  protected List<SubscriptionEvent> generateSubscriptionEvents() throws Exception {
    ...
    final List<Pair<String, Pair<File, File>>> dbTsFilePairs = batch.sealTsFiles();
    ...
    for (final Pair<String, Pair<File, File>> pair : dbTsFilePairs) {
      final File tsFile = pair.right.left;
