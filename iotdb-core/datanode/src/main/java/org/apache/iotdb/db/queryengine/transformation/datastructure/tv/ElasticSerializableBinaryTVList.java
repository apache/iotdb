...
public class ElasticSerializableBinaryTVList {
  ...
  //    }
  //    newElasticSerializableTVList.size = internalListEvictionUpperBound *
  // newInternalTVListCapacity;
  ...
  //      newElasticSerializableTVList.putBinary(i,
  // UDFBinaryTransformer.transformToUDFBinary(empty));
  //    }
