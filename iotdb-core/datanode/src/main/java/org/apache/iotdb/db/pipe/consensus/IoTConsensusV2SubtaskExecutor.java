...
public class IoTConsensusV2SubtaskExecutor extends PipeSinkSubtaskExecutor {
  public IoTConsensusV2SubtaskExecutor() {
    super(
        ...
        ThreadName.IOT_CONSENSUS_V2_EXECUTOR_POOL.getName());
  }
}
