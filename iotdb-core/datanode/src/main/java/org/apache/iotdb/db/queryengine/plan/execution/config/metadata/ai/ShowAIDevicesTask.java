...
public class ShowAIDevicesTask implements IConfigTask {
  ...
  public ListenableFuture<ConfigTaskResult> execute(IConfigTaskExecutor configTaskExecutor)
    ...
    return configTaskExecutor.showAIDevices();
  }

  public static void buildTsBlock(
      TShowAIDevicesResp resp, SettableFuture<ConfigTaskResult> future) {
    List<TSDataType> outputDataTypes =
        ColumnHeaderConstant.showAIDevicesColumnHeaders.stream()
