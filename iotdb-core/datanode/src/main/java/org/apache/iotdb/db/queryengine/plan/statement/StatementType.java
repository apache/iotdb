...
public enum StatementType {
  ...
  ALTER_DATABASE_SECURITY_LABEL,
  
  ALTER_USER_LABEL_POLICY,

  SET_USER_LABEL_POLICY,

  ALTER_USER_LABEL_POLICY,
  ALTER_USER_LABEL_POLICY,
  SHOW_DATABASE_SECURITY_LABEL,
  SHOW_DATABASE_SECURITY_LABEL,
  SET_TABLE_USER_READ_LABEL_POLICY,
  SET_TABLE_USER_WRITE_LABEL_POLICY,
  DROP_TABLE_USER_LABEL_POLICY,
  ALTER_TABLE_USER_LABEL_POLICY,
  SHOW_TABLE_USER_LABEL_POLICY,
  SHOW_TABLE_DATABASE_SECURITY_LABEL,
  ALTER_TABLE_DATABASE_SECURITY_LABEL,
  DROP_TABLE_DATABASE_SECURITY_LABEL,
}
