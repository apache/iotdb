 ...
 * schemaengine region and persistent it into files. This class contains the interfaces to modify the
 * metadata in schemaengine region for delta system. All the operations will be inserted into the logs
