...
public class TopKSortComparator {
  ...
  public static Comparator<SortKey> getComparatorForTopK(
    ...
    for (int i = 0; i < indexList.size(); i++) {
      ...
      if (index == -1) {
        comparator = asc ? TIME_ASC_COMPARATOR : TIME_DESC_COMPARATOR;
      } else {
        comparator = new SortKeyComparator(index, nullFirst, getComparator(dataType, index, asc));
      }
