...
public class PipeHistoricalDataRegionTsFileSource implements PipeHistoricalDataRegionSource {
  ...
  private boolean shouldExtractTsFileResource(
    ...
    // If the tsFile is not already marked closing, it is not captured by the pipe realtime module.
    // Thus, we can wait for the realtime sync module to handle this, to avoid blocking the pipe
    // sync process.
