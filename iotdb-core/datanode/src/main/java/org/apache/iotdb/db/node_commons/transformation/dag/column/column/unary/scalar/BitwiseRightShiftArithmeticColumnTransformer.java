...
public class BitwiseRightShiftArithmeticColumnTransformer extends AbstractBitwiseColumnTransformer {
  ...
  protected void transform(Column column, ColumnBuilder columnBuilder, int i) {
    if (TSDataType.INT32.equals(column.getDataType())) {
      ...
      columnBuilder.writeInt(
          BitwiseUtils.bitwiseRightShiftArithmeticTransform(leftValue, rightValue));
