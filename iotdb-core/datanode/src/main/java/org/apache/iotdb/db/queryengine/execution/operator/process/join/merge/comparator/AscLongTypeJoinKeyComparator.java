...
public class AscLongTypeJoinKeyComparator implements JoinKeyComparator {
  ...
  private static final AscLongTypeJoinKeyComparator INSTANCE = new AscLongTypeJoinKeyComparator();

  private AscLongTypeJoinKeyComparator() {
    // hide constructor
  }

  public static AscLongTypeJoinKeyComparator getInstance() {
    return INSTANCE;
  }
