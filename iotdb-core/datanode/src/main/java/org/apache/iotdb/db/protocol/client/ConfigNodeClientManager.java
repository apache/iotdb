...
public class ConfigNodeClientManager {
  ...
  public static class ClientPoolFactory {
    ...
    public static class AsyncConfigNodeInternalServiceClientPoolFactory
      ...
      @Override
      public GenericKeyedObjectPool<TEndPoint, AsyncConfigNodeInternalServiceClient>
          createClientPool(ClientManager<TEndPoint, AsyncConfigNodeInternalServiceClient> manager) {
                ...
                new SyncPipeConsensusServiceClient.Factory(
                    ...
                    new ThriftClientProperty.Builder()
                        ...
                        .setConnectionTimeoutMs(
                            ThriftClientProperty.DefaultProperty.CONNECTION_NEVER_TIMEOUT_MS)
