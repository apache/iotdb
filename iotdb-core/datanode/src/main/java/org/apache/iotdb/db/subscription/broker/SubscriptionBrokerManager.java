...
public class SubscriptionBrokerManager {
  ...
  private static class SubscriptionBrokerManagerHolder {

    private static final SubscriptionBrokerManager INSTANCE = new SubscriptionBrokerManager();

    private SubscriptionBrokerManagerHolder() {
      // empty constructor
    }
  }

  public static SubscriptionBrokerManager getInstance() {
    return SubscriptionBrokerManager.SubscriptionBrokerManagerHolder.INSTANCE;
  }

  private SubscriptionBrokerManager() {
    // empty constructor
  }
}
