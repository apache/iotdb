...
public class BitwiseLeftShift2ColumnTransformer extends AbstractBitwise2ColumnTransformer {
  ...
  protected void transform(
    ...
    if (TSDataType.INT32.equals(leftColumn.getDataType())) {
      ...
      if (TSDataType.INT32.equals(rightColumn.getDataType())) {
        ...
        columnBuilder.writeInt(BitwiseUtils.bitwiseLeftShiftTransform(leftValue, rightValue));
      ...
      if (TSDataType.INT32.equals(rightColumn.getDataType())) {
        int rightValue = rightColumn.getInt(i);
        columnBuilder.writeLong(BitwiseUtils.bitwiseLeftShiftTransform(leftValue, rightValue));
      } else if (TSDataType.INT64.equals(rightColumn.getDataType())) {
        long rightValue = rightColumn.getLong(i);
        columnBuilder.writeLong(BitwiseUtils.bitwiseLeftShiftTransform(leftValue, rightValue));
      }
