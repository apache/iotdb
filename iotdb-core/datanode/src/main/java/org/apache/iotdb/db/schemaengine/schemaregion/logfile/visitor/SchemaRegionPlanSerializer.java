...
public class SchemaRegionPlanSerializer implements ISerializer<ISchemaRegionPlan> {
  ...
  private static class SchemaRegionPlanSerializeVisitor
    ...
    @Override
    public SchemaRegionPlanSerializationResult visitMarkSeriesInvalid(
        final MarkSeriesInvalidNode markSeriesInvalidNode, final DataOutputStream outputStream) {
      return visitPlanNode(markSeriesInvalidNode, outputStream);
    }
    ...
    @Override
    public SchemaRegionPlanSerializationResult visitMarkSeriesEnabled(
        final MarkSeriesEnabledNode markSeriesEnabledNode, final DataOutputStream outputStream) {
      return visitPlanNode(markSeriesEnabledNode, outputStream);
    }
