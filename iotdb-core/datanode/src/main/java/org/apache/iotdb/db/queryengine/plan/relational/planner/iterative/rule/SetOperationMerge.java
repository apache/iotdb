...
public class SetOperationMerge {
   ...
   * set operation is INTERSECT DISTINCT: 3. if the parent is DISTINCT, the result has unique
   * values, regardless of whether child branches were DISTINCT or ALL, 4. if the child is DISTINCT,
