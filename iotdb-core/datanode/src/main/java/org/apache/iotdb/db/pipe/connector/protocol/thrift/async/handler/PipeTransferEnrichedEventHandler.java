...
public class PipeTransferEnrichedEventHandler extends PipeTransferTrackableHandler {

  private static final Logger LOGGER =
      LoggerFactory.getLogger(PipeTransferEnrichedEventHandler.class);

  private final EnrichedEvent event;
  private final TPipeTransferReq req;

  public PipeTransferEnrichedEventHandler(
  ...
  protected boolean onCompleteInternal(final TPipeTransferResp response) {
    ...
    try {
      ...
      event.decreaseReferenceCount(PipeTransferEnrichedEventHandler.class.getName(), true);
  ...
  public void updateLeaderCache(final TSStatus status) {}
}
