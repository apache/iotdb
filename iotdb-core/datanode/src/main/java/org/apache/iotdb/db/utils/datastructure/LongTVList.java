...
public abstract class LongTVList extends TVList {
  ...
  public TimeValuePair getTimeValuePair(int index) {
    return new TimeValuePair(
        getTime(index), Type.fromTsDataType(TSDataType.INT64).getTsPrimitiveType(getLong(index)));
  }
  ...
  protected TimeValuePair getTimeValuePair(
    ...
    return new TimeValuePair(
        time, Type.fromTsDataType(TSDataType.INT64).getTsPrimitiveType(getLong(index)));
  }
