...
public class DeviceRegionScanNode extends RegionScanNode {
  ...
  public String toString() {
    return String.format(
        "DeviceRegionScanNode-%s:[DataRegion: %s]",
        this.getPlanNodeId(), PlanNodeUtil.printRegionReplicaSet(getRegionReplicaSet()));
  }
  ...
  @Override
  public void setPaths(Set<PartialPath> paths) {
    Map<PartialPath, Boolean> curDevicePathToStatus = new HashMap<>();
    for (PartialPath path : devicePathsToAligned.keySet()) {
