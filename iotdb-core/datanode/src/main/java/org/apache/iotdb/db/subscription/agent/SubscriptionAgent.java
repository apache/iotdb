...
public class SubscriptionAgent {
  ...
  public final TPipeSubscribeResp handle(TPipeSubscribeReq req) {
    ...
    final TSStatus status =
        RpcUtils.getStatus(
            ...
            String.format("Unknown PipeMQRequestType %s.", rawRequestType));
    LOGGER.warn("Unknown PipeMQRequestType, response status = {}.", status);
  ...
  protected PipeSubscribeHandshakeResp handlePipeSubscribeHandshake(PipeSubscribeHandshakeReq req) {
