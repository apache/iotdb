...
public class CreatePipeMQTopicStatement extends Statement implements IConfigStatement {

  private String topicName;

  private Map<String, String> topicAttributes;

  public CreatePipeMQTopicStatement(StatementType createPipeStatement) {
    super();
    statementType = createPipeStatement;
  }
