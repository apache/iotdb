...
public class IoTConsensusV2DeleteEventHandler
    implements AsyncMethodCallback<TIoTConsensusV2TransferResp> {
  private static final Logger LOGGER =
      LoggerFactory.getLogger(IoTConsensusV2DeleteEventHandler.class);

  private final PipeDeleteDataNodeEvent event;

  private final TIoTConsensusV2TransferReq req;
  ...
  public IoTConsensusV2DeleteEventHandler(
  ...
  public void onComplete(TIoTConsensusV2TransferResp response) {
    ...
    try {
      ...
      event.decreaseReferenceCount(IoTConsensusV2DeleteEventHandler.class.getName(), true);
