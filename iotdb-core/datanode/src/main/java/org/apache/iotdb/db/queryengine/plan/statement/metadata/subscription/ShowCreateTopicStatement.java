...
public class ShowCreateTopicStatement extends Statement implements IConfigStatement {

  private String topicName;
  private boolean isTableModel;

  public ShowCreateTopicStatement() {
    super();
    statementType = StatementType.SHOW_CREATE_TOPIC;
  }
  ...
  public <R, C> R accept(final StatementVisitor<R, C> visitor, final C context) {
    return visitor.visitShowCreateTopic(this, context);
  }
