...
public class OldInnerSpaceCompactionTask extends AbstractCompactionTask {
  ...
  public OldInnerSpaceCompactionTask(
  ...
  public boolean equalsOtherTask(AbstractCompactionTask otherTask) {
    if (!(otherTask instanceof OldInnerSpaceCompactionTask)) {
      return false;
    }
    OldInnerSpaceCompactionTask task = (OldInnerSpaceCompactionTask) otherTask;
