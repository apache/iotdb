...
public interface AstVisitor<R, C> extends CommonQueryAstVisitor<R, C> {
  ...
  default R visitCliActivate(CliActivate node, C context) {
    return visitStatement(node, context);
  }

  default R visitShowActivation(ShowActivation node, C context) {
    return visitStatement(node, context);
  }

  default R visitShowMigrations(ShowMigrations node, C context) {
    return visitStatement(node, context);
  }

  default R visitCancelMigrations(CancelMigrations node, C context) {
    return visitStatement(node, context);
  }

  default R visitDescribeQuery(DescribeQuery node, C context) {
    return visitStatement(node, context);
  }

  default R visitDescribeOutput(DescribeOutput node, C context) {
    return visitStatement(node, context);
  }
  ...
  default R visitLoadBalance(LoadBalance node, C context) {
    return visitStatement(node, context);
  }
