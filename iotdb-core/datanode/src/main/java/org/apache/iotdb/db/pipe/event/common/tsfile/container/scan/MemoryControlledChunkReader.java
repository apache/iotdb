...
class MemoryControlledChunkReader implements IChunkReader, EstimatedMemoryChunkReader {
  ...
  MemoryControlledChunkReader(
      final IChunkReader delegate, final List<Long> pageEstimatedMemoryUsageInBytesList) {
    this.delegate = delegate;
    this.pageEstimatedMemoryUsageInBytesList = pageEstimatedMemoryUsageInBytesList;
  }
