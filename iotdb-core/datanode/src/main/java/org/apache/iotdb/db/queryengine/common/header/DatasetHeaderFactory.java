...
public class DatasetHeaderFactory {
  ...
  public static DatasetHeader getDescribeWritableViewDetailsHeader() {
    return new DatasetHeader(ColumnHeaderConstant.describeWritableViewDetailsColumnHeaders, true);
  }
