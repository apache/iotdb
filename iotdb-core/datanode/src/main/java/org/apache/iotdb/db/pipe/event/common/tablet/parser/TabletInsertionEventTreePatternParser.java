...
public class TabletInsertionEventTreePatternParser implements TabletInsertionEventParser {

  private static final Logger LOGGER =
      LoggerFactory.getLogger(TabletInsertionEventTreePatternParser.class);
