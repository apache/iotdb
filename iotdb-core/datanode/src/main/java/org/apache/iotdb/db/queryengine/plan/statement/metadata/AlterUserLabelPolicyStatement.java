...
/**
 * AlterUserLabelPolicyStatement represents the SQL statement: ALTER USER username DROP LABEL_POLICY
 * FOR READ|WRITE|READ,WRITE
 *
 * <p>This statement is used to drop label policies for users to support Label-Based Access Control
 * (LBAC) functionality.
 */
public class AlterUserLabelPolicyStatement extends Statement implements IConfigStatement {

  /** The username to drop label policy for */
  ...
  public AlterUserLabelPolicyStatement() {
    super();
    this.statementType = StatementType.ALTER_USER_LABEL_POLICY;
  }
