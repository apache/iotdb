...
public class MeasureDefinition extends Node {
  private static final long INSTANCE_SIZE =
      RamUsageEstimator.shallowSizeOfInstance(MeasureDefinition.class);
  ...
  public <R, C> R accept(IAstVisitor<R, C> visitor, C context) {
    return ((CommonQueryAstVisitor<R, C>) visitor).visitMeasureDefinition(this, context);
  }
  ...
  public String toString() {
    return toStringHelper(this).add("expression", expression).add("name", name).toString();
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(expression, that.expression) && Objects.equals(name, that.name);
  }
