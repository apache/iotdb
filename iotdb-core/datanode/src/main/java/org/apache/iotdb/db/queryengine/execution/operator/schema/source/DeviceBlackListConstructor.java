...
public class DeviceBlackListConstructor extends DevicePredicateHandler {
  final BiFunction<Integer, String, Binary> attributeProvider;
  final List<IDeviceMNode<IMemMNode>> nodes = new ArrayList<>(DEFAULT_MAX_TS_BLOCK_LINE_NUMBER);
