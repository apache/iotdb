...
public class PruneEnforceSingleRowColumns extends ProjectOffPushDownRule<EnforceSingleRowNode> {
  ...
  protected Optional<PlanNode> pushDownProjectOff(
      Context context, EnforceSingleRowNode enforceSingleRowNode, Set<Symbol> referencedOutputs) {
