...
public class RepairDataPartitionTableTask implements IConfigTask {
  ...
  private final RepairDataPartitionTableStatement repairDataPartitionTableStatement;

  public RepairDataPartitionTableTask(RepairDataPartitionTableStatement repairDataPartitionTableStatement) {
    this.repairDataPartitionTableStatement = repairDataPartitionTableStatement;
  }
