...
public class RelationalIntoOperator extends AbstractIntoOperator {
  private static final long INSTANCE_SIZE =
      RamUsageEstimator.shallowSizeOfInstance(RelationalIntoOperator.class);

  private final IDeviceID deviceID;
  private final List<Pair<String, PartialPath>> sourceTargetPathPairList;

  public RelationalIntoOperator(
  ...
  protected static List<InsertTabletStatementGenerator> constructInsertTabletStatementGenerators(
    ...
    for (Map.Entry<PartialPath, Map<String, InputLocation>> entry :
      ...
      TableModelInsertTabletStatementGenerator generator =
          new TableModelInsertTabletStatementGenerator(
              databaseName,
              targetDevice,
              entry.getValue(),
