...
import static org.apache.iotdb.db.calc_commons.plan.relational.utils.matching.Pattern.empty;
 ...
 * aggregation over distinct operator (grouped aggregation with no aggregation assignments), in case
 * when the distinct operator cannot be de-correlated by PlanNodeDecorrelator It is similar to
 * TransformCorrelatedGlobalAggregationWithProjection rule, but does not support projection over
