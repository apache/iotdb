...
public class CreateAliasSeriesNode extends PlanNode implements ISchemaRegionPlan {
  ...
  public void addChild(PlanNode child) {
    throw new UnsupportedOperationException("CreateAliasSeriesNode does not support children");
  }

  @Override
  public PlanNode clone() {
    return new CreateAliasSeriesNode(getPlanNodeId(), oldPath, newPath, timeSeriesInfo, isRollback);
  }
  ...
  public static CreateAliasSeriesNode deserialize(ByteBuffer byteBuffer) {
    ...
    return new CreateAliasSeriesNode(planNodeId, oldPath, newPath, timeSeriesInfo, isRollback);
  }

  @Override
  public <R, C> R accept(IPlanVisitor<R, C> visitor, C context) {
    return ((PlanVisitor<R, C>) visitor).visitCreateAliasSeries(this, context);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), oldPath, newPath, timeSeriesInfo, isRollback);
  }
}
