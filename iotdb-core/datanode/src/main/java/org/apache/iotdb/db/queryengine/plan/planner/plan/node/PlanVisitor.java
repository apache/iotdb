...
public interface PlanVisitor<R, C> extends ICoreQueryPlanVisitor<R, C> {
  ...
  default R visitCreateAliasSeries(CreateAliasSeriesNode node, C context) {
    return visitPlan(node, context);
  }

  default R visitMarkSeriesInvalid(MarkSeriesInvalidNode node, C context) {
    return visitPlan(node, context);
  }

  default R visitUpdatePhysicalAliasRef(UpdatePhysicalAliasRefNode node, C context) {
    return visitPlan(node, context);
  }

  default R visitDropAliasSeries(DropAliasSeriesNode node, C context) {
    return visitPlan(node, context);
  }

  default R visitMarkSeriesEnabled(MarkSeriesEnabledNode node, C context) {
    return visitPlan(node, context);
  }

  default R visitUnlockForAlias(UnlockForAliasNode node, C context) {
    return visitPlan(node, context);
  }

  default R visitLockAlias(LockAliasNode node, C context) {
    return visitPlan(node, context);
  }
