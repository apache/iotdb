...
public class AcosColumnTransformer extends UnaryColumnTransformer {
  public AcosColumnTransformer(Type returnType, ColumnTransformer childColumnTransformer) {
