...
package org.apache.iotdb.db.pipe.constant;
...
/**
 * {@link PipeSchemaNodeConstant} is to classify the {@link PlanNode}s to help linkedList and pipe
 * to collect.
 */
public class PipeSchemaNodeConstant {

  // The "default" schema synchronization set
  public static Set<PlanNodeType> defaultNodeSet =
  ...
  public static Set<PlanNodeType> deletionNodeSet =
      Collections.unmodifiableSet(
          new HashSet<>(
              Arrays.asList(
  ...
  private PipeSchemaNodeConstant() {
    // Utility class
  }
}
