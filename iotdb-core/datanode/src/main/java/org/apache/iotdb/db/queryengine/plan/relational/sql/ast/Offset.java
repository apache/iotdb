...
public class Offset extends Node {
  ...
  private static final long INSTANCE_SIZE = RamUsageEstimator.shallowSizeOfInstance(Offset.class);
  ...
  public <R, C> R accept(IAstVisitor<R, C> visitor, C context) {
    return ((AstVisitor<R, C>) visitor).visitOffset(this, context);
  }
  ...
  public long ramBytesUsed() {
    ...
    size += AstMemoryEstimationHelper.getEstimatedSizeOfAccountableObject(rowCount);
    return size;
  }
}
