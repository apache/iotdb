...
public class TableUDFUtils {
  ...
  private static ITableFunctionAINodeService loadAINodeService() {
    ITableFunctionAINodeService aiNodeService = null;
    ServiceLoader<ITableFunctionAINodeServiceProvider> loader =
    ...
    return aiNodeService == null ? EMPTY_AI_NODE_SERVICE : aiNodeService;
  }

  public static ITableFunctionAINodeService getTableFunctionAINodeService() {
    return AI_NODE_SERVICE;
  }
