...
public class IoTConsensusV2SinkMetrics implements IMetricSet {
  private final IoTConsensusV2AsyncSink iotConsensusV2AsyncConnector;
  ...
  private static final String CONNECTOR = "iotConsensusV2AsyncConnector";

  public IoTConsensusV2SinkMetrics(IoTConsensusV2AsyncSink iotConsensusV2AsyncConnector) {
    this.iotConsensusV2AsyncConnector = iotConsensusV2AsyncConnector;
  }
  ...
  private void bindAutoGauge(AbstractMetricService metricService) {
    metricService.createAutoGauge(
        ...
        IoTConsensusV2AsyncSink::getTransferBufferSize,
        Tag.NAME.toString(),
        CONNECTOR,
        Tag.REGION.toString(),
        iotConsensusV2AsyncConnector.getConsensusGroupIdStr(),
    ...
    metricService.createAutoGauge(
        ...
        MetricLevel.IMPORTANT,
        iotConsensusV2AsyncConnector,
        IoTConsensusV2AsyncSink::getRetryBufferSize,
        Tag.NAME.toString(),
        CONNECTOR,
        Tag.REGION.toString(),
        iotConsensusV2AsyncConnector.getConsensusGroupIdStr(),
