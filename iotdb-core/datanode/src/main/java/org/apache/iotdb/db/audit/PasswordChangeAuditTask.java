...
/** Records the final result of a password-change config task without changing its execution. */
public final class PasswordChangeAuditTask implements IConfigTask {
  ...
  private PasswordChangeAuditTask(IConfigTask delegate, PasswordChangeAuditContext auditContext) {
    this.delegate = delegate;
    this.auditContext = auditContext;
  }

  public static IConfigTask wrap(IConfigTask delegate, PasswordChangeAuditContext auditContext) {
  ...
  public ListenableFuture<ConfigTaskResult> execute(IConfigTaskExecutor configTaskExecutor)
    ...
    try {
      final ListenableFuture<ConfigTaskResult> future = delegate.execute(configTaskExecutor);
      Futures.addCallback(
          future,
