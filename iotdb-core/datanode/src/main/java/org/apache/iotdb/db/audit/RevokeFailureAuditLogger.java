...
/** Records failed privilege-revocation statements independently of an RPC entry point. */
public final class RevokeFailureAuditLogger {

  private final DNAuditLogger auditLogger;

  RevokeFailureAuditLogger(DNAuditLogger auditLogger) {
    this.auditLogger = auditLogger;
  }

  public static RevokeFailureAuditLogger getInstance() {
    return RevokeFailureAuditLoggerHolder.INSTANCE;
  }

  public void log(Statement statement, IAuditEntity auditEntity, @Nullable TSStatus status) {
    log(
  ...
  public void log(
    ...
    log(getTargetName(statement), sessionInfo, sql, status);
  }
  ...
  private static class RevokeFailureAuditLoggerHolder {

    private static final RevokeFailureAuditLogger INSTANCE =
        new RevokeFailureAuditLogger(DNAuditLogger.getInstance());

    private RevokeFailureAuditLoggerHolder() {}
  }
}
