...
public class DataNodePlanNodeDeserializer extends CommonPlanNodeDeserializer {
  ...
  public PlanNode deserialize(ByteBuffer buffer, short nodeType) {
    switch (nodeType) {
      ...
      case 100:
        return LockAliasNode.deserialize(buffer);
      case 101:
        return CreateAliasSeriesNode.deserialize(buffer);
      case 102:
        return MarkSeriesInvalidNode.deserialize(buffer);
      case 103:
        return UpdatePhysicalAliasRefNode.deserialize(buffer);
      case 104:
        return DropAliasSeriesNode.deserialize(buffer);
      case 105:
        return MarkSeriesEnabledNode.deserialize(buffer);
      case 106:
        return UnlockForAliasNode.deserialize(buffer);
