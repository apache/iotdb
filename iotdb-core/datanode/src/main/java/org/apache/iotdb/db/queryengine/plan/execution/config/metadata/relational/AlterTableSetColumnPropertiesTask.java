...
public class AlterTableSetColumnPropertiesTask extends AbstractAlterOrDropTableTask {
  ...
  public ListenableFuture<ConfigTaskResult> execute(final IConfigTaskExecutor configTaskExecutor)
    ...
    return configTaskExecutor.alterTableSetColumnProperties(
        database, tableName, columnName, properties, queryId, tableIfExists, columnIfExists);
  }
}
