...
public interface IAuthorityFetcher {
  ...
  SettableFuture<ConfigTaskResult> operatePermission(AuthorRStatement authorStatement);

  SettableFuture<ConfigTaskResult> queryPermission(AuthorRStatement authorStatement);
