...
public class ModificationFileV1 implements AutoCloseable {
  ...
  public static ModificationFileV1 getCompactionMods(TsFileResource tsFileResource) {
    return new ModificationFileV1(
        tsFileResource.getTsFilePath() + ModificationFileV1.COMPACTION_FILE_SUFFIX);
  }
