...
public class StatementAnalyzer {
  ...
  private final class Visitor implements AstVisitor<Scope, Optional<Scope>> {
    ...
    @Override
    public Scope visitDescribeQuery(final DescribeQuery node, final Optional<Scope> context) {
      analysis.setFinishQueryAfterAnalyze();
      return visitQuery(node.getQuery(), context);
    }

    @Override
    public Scope visitDescribeOutput(final DescribeOutput node, final Optional<Scope> context) {
