...
public class IoTConsensusV2TsFileInsertionEventHandler
  ...
  private static final Logger LOGGER =
      LoggerFactory.getLogger(IoTConsensusV2TsFileInsertionEventHandler.class);
  ...
  public void transfer(final AsyncIoTConsensusV2ServiceClient client)
  ...
  public void onComplete(final TIoTConsensusV2TransferResp response) {
    ...
    // IoTConsensusV2TransferFilePieceResp
    try {
      ...
      if (code == TSStatusCode.IOT_CONSENSUS_V2_TRANSFER_FILE_OFFSET_RESET.getStatusCode()) {
