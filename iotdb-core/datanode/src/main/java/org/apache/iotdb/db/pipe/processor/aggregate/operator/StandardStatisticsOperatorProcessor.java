...
public class StandardStatisticsOperatorProcessor extends AbstractOperatorProcessor {
  @Override
  public Map<String, AggregatedResultOperator> getAggregatorName2StaticAttributesMap() {
    return null;
  }

  @Override
  public Map<String, IntermediateResultOperator> getIntermediateResultName2AttributesMap() {
    return null;
  }
}
