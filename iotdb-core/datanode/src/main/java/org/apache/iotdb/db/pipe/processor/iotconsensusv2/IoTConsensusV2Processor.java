...
package org.apache.iotdb.db.pipe.processor.iotconsensusv2;
...
@TreeModel
@TableModel
public class IoTConsensusV2Processor implements PipeProcessor {
  ...
  public void process(TsFileInsertionEvent tsFileInsertionEvent, EventCollector eventCollector)
    ...
    if (tsFileInsertionEvent instanceof EnrichedEvent
        && ((EnrichedEvent) tsFileInsertionEvent).getReplicateIndexForIoTV2()
