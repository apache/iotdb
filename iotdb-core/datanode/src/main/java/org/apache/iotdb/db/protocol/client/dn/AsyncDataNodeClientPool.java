...
public abstract class AsyncDataNodeClientPool<ClientType> {

  private static final Logger LOGGER = LoggerFactory.getLogger(AsyncDataNodeClientPool.class);

  IClientManager<TEndPoint, ClientType> clientManager;

  private static final int MAX_RETRY_NUM = 6;

  AsyncDataNodeClientPool() {}
  ...
  public ClientType getAsyncClient(TDataNodeLocation targetDataNode) throws ClientManagerException {
