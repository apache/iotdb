...
/**
 * DropTableDatabaseSecurityLabelTask handles the execution of dropping database security labels in
 * table model. This task specifically handles the deletion of security labels for databases to
 * support Label-Based Access Control (LBAC) functionality in the table model.
 */
public class DropTableDatabaseSecurityLabelTask implements IConfigTask {

  private final String database;

  public DropTableDatabaseSecurityLabelTask(DropDatabaseSecurityLabelStatement statement) {
