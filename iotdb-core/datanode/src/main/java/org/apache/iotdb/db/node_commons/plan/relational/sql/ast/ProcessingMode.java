...
public final class ProcessingMode extends Node {
  private static final long INSTANCE_SIZE =
      RamUsageEstimator.shallowSizeOfInstance(ProcessingMode.class);
  ...
  public <R, C> R accept(IAstVisitor<R, C> visitor, C context) {
    return ((CommonQueryAstVisitor<R, C>) visitor).visitProcessingMode(this, context);
  }
  ...
  public String toString() {
    return toStringHelper(this).add("mode", mode).toString();
  }
