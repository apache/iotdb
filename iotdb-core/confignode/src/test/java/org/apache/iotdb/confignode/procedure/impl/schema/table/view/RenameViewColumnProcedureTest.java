...
public class RenameViewColumnProcedureTest {
  ...
  public void serializeDeserializeTest() throws IllegalPathException, IOException {
    ...
    Assert.assertEquals(
        ProcedureType.RENAME_VIEW_COLUMN_PROCEDURE.getTypeCode(), byteBuffer.getShort());

    final RenameViewColumnProcedure deserializedProcedure = new RenameViewColumnProcedure(false);
