...
public class DropViewColumnProcedureTest {
  @Test
  public void serializeDeserializeTest() throws IllegalPathException, IOException {
    final DropViewColumnProcedure dropViewColumnProcedure =
        new DropViewColumnProcedure("database1", "table1", "0", "columnName", false);
    ...
    Assert.assertEquals(
        ProcedureType.DROP_VIEW_COLUMN_PROCEDURE.getTypeCode(), byteBuffer.getShort());

    final DropViewColumnProcedure deserializedProcedure = new DropViewColumnProcedure(false);
