...
public class DropViewProcedureTest {
  ...
  public void serializeDeserializeTest() throws IllegalPathException, IOException {
    ...
    Assert.assertEquals(ProcedureType.DROP_VIEW_PROCEDURE.getTypeCode(), byteBuffer.getShort());

    final DropViewProcedure deserializedProcedure = new DropViewProcedure(false);
