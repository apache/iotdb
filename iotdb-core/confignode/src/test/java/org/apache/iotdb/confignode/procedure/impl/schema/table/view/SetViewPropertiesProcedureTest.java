...
public class SetViewPropertiesProcedureTest {
  @Test
  public void serializeDeserializeTest() throws IllegalPathException, IOException {
    ...
    Assert.assertEquals(
        ProcedureType.SET_VIEW_PROPERTIES_PROCEDURE.getTypeCode(), byteBuffer.getShort());

    final SetViewPropertiesProcedure deserializedProcedure = new SetViewPropertiesProcedure(false);
