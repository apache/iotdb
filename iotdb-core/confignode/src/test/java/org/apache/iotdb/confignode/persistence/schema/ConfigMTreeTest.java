...
public class ConfigMTreeTest {
  ...
  public void testSetDatabaseExceptionMessage() {
    try {
  ...
  @Test
  public void testSetDatabase() throws IllegalPathException {
    try {
  ...
  @Test
  public void testCountDatabase() throws MetadataException {
