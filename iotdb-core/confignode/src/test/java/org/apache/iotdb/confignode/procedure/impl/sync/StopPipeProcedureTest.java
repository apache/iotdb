...
public class StopPipeProcedureTest {
  @Test
  public void serializeDeserializeTest() throws IOException {
    ...
    StopPipeProcedure proc = new StopPipeProcedure(pipeInfo);

    try {
      proc.serialize(outputStream);
      ByteBuffer buffer =
          ByteBuffer.wrap(byteArrayOutputStream.getBuf(), 0, byteArrayOutputStream.size());
      StopPipeProcedure proc2 = (StopPipeProcedure) ProcedureFactory.getInstance().create(buffer);
