...
public class StartPipeProcedureTest {
  @Test
  public void serializeDeserializeTest() throws IOException {
    ...
    StartPipeProcedure proc = new StartPipeProcedure(pipeInfo);

    try {
      proc.serialize(outputStream);
      ByteBuffer buffer =
          ByteBuffer.wrap(byteArrayOutputStream.getBuf(), 0, byteArrayOutputStream.size());
      StartPipeProcedure proc2 = (StartPipeProcedure) ProcedureFactory.getInstance().create(buffer);
