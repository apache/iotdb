...
public class RenameWritableViewProcedure extends RenameTableProcedure {
  public RenameWritableViewProcedure(final boolean isGeneratedByPipe) {
    super(isGeneratedByPipe);
  }

  public RenameWritableViewProcedure(
  ...
  protected String getActionMessage() {
    return ProcedureMessages.RENAME_WRITABLE_VIEW;
  }
  ...
  public void serialize(final DataOutputStream stream) throws IOException {
    stream.writeShort(
        isGeneratedByPipe
            ? ProcedureType.PIPE_ENRICHED_RENAME_WRITABLE_VIEW_PROCEDURE.getTypeCode()
            : ProcedureType.RENAME_WRITABLE_VIEW_PROCEDURE.getTypeCode());
