...
public class RenameWritableViewColumnProcedure extends RenameTableColumnProcedure {
  public RenameWritableViewColumnProcedure(boolean isGeneratedByPipe) {
    super(isGeneratedByPipe);
  }

  public RenameWritableViewColumnProcedure(
  ...
  protected String getActionMessage() {
    return ProcedureMessages.RENAME_WRITABLE_VIEW_COLUMN;
  }
  ...
  public void serialize(final DataOutputStream stream) throws IOException {
    stream.writeShort(
        isGeneratedByPipe
            ? ProcedureType.PIPE_ENRICHED_RENAME_WRITABLE_VIEW_COLUMN_PROCEDURE.getTypeCode()
            : ProcedureType.RENAME_WRITABLE_VIEW_COLUMN_PROCEDURE.getTypeCode());
