...
public class DropWritableViewProcedure extends DropTableProcedure {

  public DropWritableViewProcedure(final boolean isGeneratedByPipe) {
    super(isGeneratedByPipe);
  }

  public DropWritableViewProcedure(
  ...
  protected String getActionMessage() {
    return ProcedureMessages.DROP_WRITABLE_VIEW;
  }

  @Override
  protected ConfigPhysicalPlan createPreDeleteTablePlan() {
    return new PreDeleteWritableViewPlan(
        database, tableName, getOriginalDatabase(), getOriginalTableName());
  }
  ...
  public void serialize(final DataOutputStream stream) throws IOException {
    stream.writeShort(
        isGeneratedByPipe
            ? ProcedureType.PIPE_ENRICHED_DROP_WRITABLE_VIEW_PROCEDURE.getTypeCode()
            : ProcedureType.DROP_WRITABLE_VIEW_PROCEDURE.getTypeCode());
