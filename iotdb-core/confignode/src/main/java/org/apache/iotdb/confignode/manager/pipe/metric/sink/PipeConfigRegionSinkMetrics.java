...
public class PipeConfigRegionSinkMetrics implements IMetricSet {

  private static final Logger LOGGER = LoggerFactory.getLogger(PipeConfigRegionSinkMetrics.class);
  ...
  private static class PipeConfigNodeSubtaskMetricsHolder {
    ...
    private static final PipeConfigRegionSinkMetrics INSTANCE = new PipeConfigRegionSinkMetrics();
  ...
  public static PipeConfigRegionSinkMetrics getInstance() {
    return PipeConfigNodeSubtaskMetricsHolder.INSTANCE;
  }

  private PipeConfigRegionSinkMetrics() {
    // Empty constructor
  }
}
