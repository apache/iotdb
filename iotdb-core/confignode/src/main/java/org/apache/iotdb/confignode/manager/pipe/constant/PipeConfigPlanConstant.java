...
package org.apache.iotdb.confignode.manager.pipe.constant;
...
/**
 * {@link PipeConfigPlanConstant} is to classify the {@link ConfigPhysicalPlan}s to help linkedList
 ...
 */
public class PipeConfigPlanConstant {

  // The "default" schema synchronization set
  public static Set<ConfigPhysicalPlanType> schemaDefaultPlanSet =
  ...
  public static Set<ConfigPhysicalPlanType> schemaDeletionPlanSet =
      Collections.unmodifiableSet(
          new HashSet<>(
              Arrays.asList(
  ...
  public static Set<ConfigPhysicalPlanType> authorityDefaultPlanSet =
      Collections.unmodifiableSet(
          new HashSet<>(
              Arrays.asList(
  ...
  public static Set<ConfigPhysicalPlanType> authorityDeletionPlanSet =
      Collections.unmodifiableSet(
          new HashSet<>(
              Arrays.asList(
