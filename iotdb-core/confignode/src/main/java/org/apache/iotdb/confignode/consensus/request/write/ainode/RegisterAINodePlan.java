...
public class RegisterAINodePlan extends ConfigPhysicalPlan {
  ...
  protected void serializeImpl(DataOutputStream stream) throws IOException {
    ...
    ThriftCommonsSerDeUtils.serializeTAINodeInfo(aiNodeConfiguration, stream);
  }

  @Override
  protected void deserializeImpl(ByteBuffer buffer) throws IOException {
    aiNodeConfiguration = ThriftCommonsSerDeUtils.deserializeTAINodeInfo(buffer);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(aiNodeConfiguration);
  }
}
