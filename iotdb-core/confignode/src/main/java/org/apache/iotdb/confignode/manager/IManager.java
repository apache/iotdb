...
public interface IManager {
   ...
   * @param isGeneratedByPipe whether the request is generated by pipe
   * @return status
   */
  TSStatus deleteDatabases(List<String> deletedPaths, boolean isGeneratedByPipe);
  ...
  /** Create trigger. */
  TSStatus createTrigger(TCreateTriggerReq req, boolean isGeneratedByPipe);

  /** Drop trigger. */
  TSStatus dropTrigger(TDropTriggerReq req, boolean isGeneratedByPipe);
   ...
   * @return TSStatus
   */
  TSStatus setSchemaTemplate(TSetSchemaTemplateReq req, boolean isGeneratedByPipe);
  ...
  TSStatus deactivateSchemaTemplate(TDeactivateSchemaTemplateReq req, boolean isGeneratedByPipe);

  /** Unset schemaengine template. */
  TSStatus unsetSchemaTemplate(TUnsetSchemaTemplateReq req, boolean isGeneratedByPipe);
  ...
  /** Delete timeseries. */
  TSStatus deleteTimeSeries(TDeleteTimeSeriesReq req, boolean isGeneratedByPipe);

  TSStatus deleteLogicalView(TDeleteLogicalViewReq req, boolean isGeneratedByPipe);

  TSStatus alterLogicalView(TAlterLogicalViewReq req, boolean isGeneratedByPipe);
  ...
  TSStatus createCQ(TCreateCQReq req, boolean isGeneratedByPipe);
