...
public class CreateTopicPlan extends ConfigPhysicalPlan {

  private TopicMeta topicMeta;

  public CreateTopicPlan() {
    super(ConfigPhysicalPlanType.CreateTopic);
  }

  public CreateTopicPlan(TopicMeta topicMeta) {
    super(ConfigPhysicalPlanType.CreateTopic);
  ...
  public String toString() {
    return "CreateTopicPlan{" + "topicMeta='" + topicMeta + "'}";
  }
}
