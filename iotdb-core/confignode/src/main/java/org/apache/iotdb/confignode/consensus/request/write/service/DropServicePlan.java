...
public class DropServicePlan extends ConfigPhysicalPlan {

  private String serviceName;

  public DropServicePlan() {
    super(ConfigPhysicalPlanType.DropService);
  }

  public DropServicePlan(String serviceName) {
    super(ConfigPhysicalPlanType.DropService);
  ...
  public boolean equals(Object o) {
    ...
    DropServicePlan that = (DropServicePlan) o;
