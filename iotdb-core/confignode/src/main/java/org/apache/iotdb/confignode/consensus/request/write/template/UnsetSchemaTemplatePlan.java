...
public class UnsetSchemaTemplatePlan extends ConfigPhysicalPlan {

  private int templateId;
  private PartialPath path;

  public UnsetSchemaTemplatePlan() {
    super(ConfigPhysicalPlanType.UnsetTemplate);
  }

  public UnsetSchemaTemplatePlan(int templateId, PartialPath path) {
    super(ConfigPhysicalPlanType.UnsetTemplate);
