...
public enum ProcedureType {
  ...
  CREATE_TABLE_VIEW_PROCEDURE((short) 758),
  ADD_VIEW_COLUMN_PROCEDURE((short) 759),
  DROP_VIEW_COLUMN_PROCEDURE((short) 760),
  DROP_VIEW_PROCEDURE((short) 761),
  SET_VIEW_PROPERTIES_PROCEDURE((short) 762),
  RENAME_VIEW_COLUMN_PROCEDURE((short) 763),
  ...
  ALTER_DATABASE_SECURITY_LABEL_PROCEDURE((short) 1401),

  /** Pipe Enriched */
  PIPE_ENRICHED_DELETE_DATABASE_PROCEDURE((short) 1402),
  PIPE_ENRICHED_DELETE_TIMESERIES_PROCEDURE((short) 1403),
  PIPE_ENRICHED_DEACTIVATE_TEMPLATE_PROCEDURE((short) 1404),
  PIPE_ENRICHED_UNSET_TEMPLATE_PROCEDURE((short) 1405),
  PIPE_ENRICHED_SET_TEMPLATE_PROCEDURE((short) 1406),
  PIPE_ENRICHED_ALTER_LOGICAL_VIEW_PROCEDURE((short) 1407),
  PIPE_ENRICHED_DELETE_LOGICAL_VIEW_PROCEDURE((short) 1408),
  PIPE_ENRICHED_CREATE_TRIGGER_PROCEDURE((short) 1409),
  PIPE_ENRICHED_DROP_TRIGGER_PROCEDURE((short) 1410),
  PIPE_ENRICHED_AUTH_OPERATE_PROCEDURE((short) 1411),
  PIPE_ENRICHED_SET_TTL_PROCEDURE((short) 1412),
  PIPE_ENRICHED_CREATE_TABLE_PROCEDURE((short) 1413),
  PIPE_ENRICHED_DROP_TABLE_PROCEDURE((short) 1414),
  PIPE_ENRICHED_ADD_TABLE_COLUMN_PROCEDURE((short) 1415),
  PIPE_ENRICHED_SET_TABLE_PROPERTIES_PROCEDURE((short) 1416),
  PIPE_ENRICHED_RENAME_TABLE_COLUMN_PROCEDURE((short) 1417),
  PIPE_ENRICHED_DROP_TABLE_COLUMN_PROCEDURE((short) 1418),
  PIPE_ENRICHED_DELETE_DEVICES_PROCEDURE((short) 1419),
  PIPE_ENRICHED_RENAME_TABLE_PROCEDURE((short) 1420),
  PIPE_ENRICHED_CREATE_TABLE_VIEW_PROCEDURE((short) 1421),
  PIPE_ENRICHED_ADD_VIEW_COLUMN_PROCEDURE((short) 1422),
  PIPE_ENRICHED_DROP_VIEW_COLUMN_PROCEDURE((short) 1423),
  PIPE_ENRICHED_DROP_VIEW_PROCEDURE((short) 1424),
  PIPE_ENRICHED_SET_VIEW_PROPERTIES_PROCEDURE((short) 1425),
  PIPE_ENRICHED_RENAME_VIEW_COLUMN_PROCEDURE((short) 1426),
  PIPE_ENRICHED_RENAME_VIEW_PROCEDURE((short) 1427),
