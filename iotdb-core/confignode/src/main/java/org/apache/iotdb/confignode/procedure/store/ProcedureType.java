...
public enum ProcedureType {
  ...
  ALTER_TIMESERIES_DATATYPE_PROCEDURE((short) 302),
  RENAME_TIMESERIES_PROCEDURE((short) 303),
  ...
  CREATE_WRITABLE_VIEW_PROCEDURE((short) -766),
  ADD_WRITABLE_VIEW_COLUMN_PROCEDURE((short) -767),
  DROP_WRITABLE_VIEW_COLUMN_PROCEDURE((short) -768),
  DROP_WRITABLE_VIEW_PROCEDURE((short) -769),
  SET_WRITABLE_VIEW_PROPERTIES_PROCEDURE((short) -770),
  ALTER_WRITABLE_VIEW_COLUMN_DATATYPE_PROCEDURE((short) -771),
  RENAME_WRITABLE_VIEW_COLUMN_PROCEDURE((short) -772),
  RENAME_WRITABLE_VIEW_PROCEDURE((short) -773),
  ...
  PIPE_ENRICHED_RENAME_TABLE_PROCEDURE((short) 1419),
  ...
  PIPE_ENRICHED_RENAME_VIEW_COLUMN_PROCEDURE((short) 146),
  PIPE_ENRICHED_RENAME_VIEW_PROCEDURE((short) 147),
  PIPE_ENRICHED_ALTER_ENCODING_COMPRESSOR_PROCEDURE((short) 148),
  PIPE_ENRICHED_ALTER_TIMESERIES_DATATYPE_PROCEDURE((short) 149),
  PIPE_ENRICHED_RENAME_TIMESERIES_PROCEDURE((short) 150),
  PIPE_ENRICHED_CREATE_WRITABLE_VIEW_PROCEDURE((short) -151),
  PIPE_ENRICHED_ADD_WRITABLE_VIEW_COLUMN_PROCEDURE((short) -152),
  PIPE_ENRICHED_DROP_WRITABLE_VIEW_COLUMN_PROCEDURE((short) -153),
  PIPE_ENRICHED_DROP_WRITABLE_VIEW_PROCEDURE((short) -154),
  PIPE_ENRICHED_SET_WRITABLE_VIEW_PROPERTIES_PROCEDURE((short) -155),
  PIPE_ENRICHED_ALTER_WRITABLE_VIEW_COLUMN_DATATYPE_PROCEDURE((short) -156),
  PIPE_ENRICHED_RENAME_WRITABLE_VIEW_COLUMN_PROCEDURE((short) -157),
  PIPE_ENRICHED_RENAME_WRITABLE_VIEW_PROCEDURE((short) -158),
