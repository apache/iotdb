...
public class ConfigPipeListeningQueue extends PipeLinkedListQueue<ConfigPhysicalPlan> {

  private static class ConfigPipeListeningQueueHolder {
    private static final ConfigPipeListeningQueue instance = new ConfigPipeListeningQueue();
  }
