...
public final class ConfigNodeMessages {
  ...
  public static final String INITIAL_CONFIGNODE_FREE_MEMORY = "initial ConfigNode freeMemory = {}";
  ...
  public static final String EXECUTE_GET_METADATA_WITH_RESULT =
      "Execute getMetaDataCache with result {}";
  ...
  public static final String CONFIGPROCEDURESTORE_START_FAILED =
      "ConfigProcedureStore start failed ";
  ...
  public static final String FAILED_TO_SET_PIPE_STATUS_BECAUSE =
      "Failed to set pipe status, because ";
  ...
  public static final String FAILED_TO_CREATE_MULTIPLE_PIPES_BECAUSE =
      "Failed to create multiple pipes, because ";
  ...
  public static final String FAILED_TO_HANDLE_LEADER_CHANGE_BECAUSE =
      "Failed to handle leader change, because ";
  public static final String FAILED_TO_HANDLE_META_CHANGES_BECAUSE =
      "Failed to handle meta changes, because ";
  public static final String GET_PIPEPLUGIN_JAR_FAILED_BECAUSE =
      "Get PipePlugin_Jar failed, because ";
  ...
  public static final String STOP_AND_CLEAR_CONFIGNODE_SUCCESS =
      "Stop And Clear ConfigNode Success.";
  ...
  public static final String FAIL_TO_TRUNCATE_LOG_FILE_TO_SIZE =
  ...
  public static final String MESSAGE_NUMBER_TTL_RULES_HAS_REACHED_LIMIT_8575FF1E =
  ...
  public static final String LOG_EXITS_JVM_MEMORY_USAGE_ARG_0BCD1CCF =
      " exits. Jvm memory usage: {}";
  public static final String
  ...
  public static final String EXCEPTION_ADD_CONSENSUSGROUP_ARG_FAILED_D3FDDC1B =
      "Add ConsensusGroup to: %s failed.";
  public static final String EXCEPTION_ADD_PEER_ARG_FAILED_17DEB6CA = "Add peer: %s failed.";
  public static final String EXCEPTION_DATABASE_ARG_DOESN_T_EXIST_778BBF66 =
  ...
  public static final String LOG_FAILED_WRITE_AUDIT_LOG_DATANODE_ARG_RESPONSE_ARG_691ABC90 =
      "Failed to write audit log to DataNode {}, response: {}";
  ...
  public static final String EXCEPTION_LOADPIPETASKINFOEXCEPTION_2270468E =
  ...
  public static final String LOG_HANDLING_COMMIT_PROGRESS_META_CHANGES_FA21A080 =
      "Handling commit progress meta changes ...";
  public static final String
  ...
  public static final String LOG_TRYING_GET_MAX_TTL_UNDER_ONE_DATABASE_USE_LONG_MAX_9D70ACB2 =
      " when trying to get max ttl under one database, use Long.MAX_VALUE.";
  public static final String
  ...
  public static final String LOG_START_CLEANING_UP_RELATED_SERVICES_A409E261 =
