...
public final class ProcedureMessages {
  ...
  public static final String FAILED_TO_PROVE_AN_UNREACHABLE_DN_IS_FENCED =
      "Failed to prove an unreachable DataNode is fenced";
  ...
  public static final String LOG_ARG_JOIN_WAIT_GOT_INTERRUPTED_316B5E9F =
      "{} join wait got interrupted";
  public static final String LOG_NO_COMPLETED_PROCEDURES_CLEANUP_50434D91 =
      "No completed procedures to cleanup.";
  public static final String LOG_ERROR_DELETING_COMPLETED_PROCEDURES_ARG_1A3A185E =
      "Error deleting completed procedures {}.";
  ...
  public static final String
      LOG_EXECUTING_PROCEDURE_SHOULD_RUNNABLE_STATE_BUT_IT_S_NOT_PROCEDURE_7CF42CE8 =
          "The executing procedure should in RUNNABLE state, but it's not. Procedure is {}";
  public static final String LOG_FINISHED_SUBPROCEDURE_PID_ARG_RESUME_PROCESSING_PPID_ARG_93ED990B =
      "Finished subprocedure pid={}, resume processing ppid={}";
  public static final String LOG_HALT_PID_ARG_ACTIVECOUNT_ARG_411F3EBF =
  ...
  public static final String LOG_PROCEDURE_WORKERS_ARG_RUNNING_ARG_RUNNING_STUCK_1565936D =
      "Procedure workers: {} is running, {} is running and stuck";
  public static final String LOG_ADD_PROCEDURE_ARG_AS_ARG_TH_ROLLBACK_STEP_C71B2184 =
      "Add procedure {} as the {}th rollback step";
  public static final String
  ...
  public static final String
      LOG_DON_T_ADD_SUCCESSFUL_PROCEDURE_BACK_SCHEDULER_IT_WILL_IGNORED_E015472C =
          "Don't add a successful procedure back to the scheduler, it will be ignored";
  public static final String LOG_SCHEDULER_NOT_RUNNING_6969C9FF = "the scheduler is not running";
  public static final String LOG_SCHEDULER_WAITING_TIME_LEFT_ARG_NANOS_D7717019 =
      "the scheduler waiting time left {} nanos";
  public static final String LOG_SLEEP_FAILED_CONFIGNODEPROCEDUREENV_BCD470AC =
      "Sleep failed in ConfigNodeProcedureEnv: ";
  public static final String LOG_INVALIDATE_CACHE_FAILED_BECAUSE_DATANODE_ARG_UNKNOWN_4F2D374C =
  ...
  public static final String LOG_START_CREATE_TRIGGERINSTANCE_ARG_DATA_NODES_917C3313 =
      "Start to create triggerInstance [{}] on Data Nodes";
  public static final String LOG_START_ACTIVE_TRIGGER_ARG_DATA_NODES_A4AB8131 =
      "Start to active trigger [{}] on Data Nodes";
  public static final String LOG_START_ACTIVE_TRIGGER_ARG_CONFIG_NODES_153A5D40 =
      "Start to active trigger [{}] on Config Nodes";
  public static final String LOG_RETRIEVABLE_ERROR_TRYING_CREATE_TRIGGER_ARG_STATE_ARG_44976C4E =
      "Retrievable error trying to create trigger [{}], state [{}]";
  public static final String LOG_START_CONFIG_NODE_INACTIVE_ROLLBACK_TRIGGER_ARG_536929E5 =
      "Start to [CONFIG_NODE_INACTIVE] rollback of trigger [{}]";
  public static final String LOG_START_DATA_NODE_INACTIVE_ROLLBACK_TRIGGER_ARG_38C93D64 =
      "Start to [DATA_NODE_INACTIVE] rollback of trigger [{}]";
  public static final String LOG_RETRIEVABLE_ERROR_TRYING_DROP_TRIGGER_ARG_STATE_ARG_2282AC35 =
      "Retrievable error trying to drop trigger [{}], state [{}]";
  public static final String LOG_DELETEDATABASEPROCEDURE_PRE_DELETE_DATABASE_ARG_6A1FEACC =
      "[DeleteDatabaseProcedure] Pre delete database: {}";
  public static final String LOG_DELETEDATABASEPROCEDURE_INVALIDATE_CACHE_DATABASE_ARG_299FC9BC =
      "[DeleteDatabaseProcedure] Invalidate cache of database: {}";
  public static final String LOG_DELETEDATABASEPROCEDURE_DELETE_DATABASESCHEMA_ARG_A49A47AC =
  ...
  public static final String LOG_DELETEDATABASEPROCEDURE_ROLLBACK_PREDELETED_ARG_638F53DA =
      "[DeleteDatabaseProcedure] Rollback to preDeleted: {}";
  ...
  public static final String LOG_FAILED_ROLLBACK_CONFIGNODE_TTL_STATE_9666EF54 =
      "Failed to rollback ConfigNode ttl state.";
  public static final String LOG_FAILED_ROLLBACK_DATANODE_TTL_CACHE_436C008A =
      "Failed to rollback DataNode ttl cache.";
  public static final String EXCEPTION_ROLLBACK_CONFIGNODE_TTL_FAILED_6D4FB59A =
      "Rollback ConfigNode ttl failed for ";
  public static final String EXCEPTION_ROLLBACK_DATANODE_TTL_CACHE_FAILED_AF9C7102 =
      "Rollback dataNode ttl cache failed for ";
  public static final String
  ...
  public static final String LOG_PROCEDUREID_ARG_ACQUIRE_LOCK_3FBF9987 =
      "procedureId {} acquire lock.";
  public static final String
  ...
  public static final String LOG_PROCEDUREID_ARG_RELEASE_LOCK_FF860D6B =
      "procedureId {} release lock.";
  public static final String LOG_RETRIEVABLE_ERROR_TRYING_ADD_CONFIG_NODE_ARG_STATE_ARG_D7285810 =
  ...
  public static final String LOG_ARG_CAN_NOT_REMOVE_DATANODE_ARG_495F9F85 =
  ...
  public static final String LOG_ARG_DATANODE_REGIONS_REMOVED_ARG_216A7DC7 =
      "{}, DataNode regions to be removed is {}";
  public static final String LOG_RETRIEVABLE_ERROR_TRYING_REMOVE_DATA_NODE_ARG_STATE_ARG_4EFEB850 =
  ...
  public static final String LOG_ARG_CANNOT_FIND_TARGET_DATANODE_MIGRATE_REGION_ARG_81A78E06 =
  ...
  public static final String LOG_ARG_START_ROLL_BACK_DATANODES_STATUS_ARG_05C67270 =
      "{}, Start to roll back the DataNodes status: {}";
  public static final String LOG_ARG_ROLL_BACK_DATANODES_STATUS_SUCCESSFULLY_ARG_6773A2DF =
  ...
  public static final String
      LOG_DATAPARTITIONINTEGRITY_FAILED_COLLECTED_EARLIEST_TIMESLOTS_DATANODE_ID_ARG_RESPONSE_STATUS_B0A31EC4 =
          "[DataPartitionIntegrity] Failed to collected earliest timeslots from the DataNode[id={}],"
              + " response status is {}";
  public static final String LOG_COLLECTED_EARLIEST_TIMESLOTS_DATANODE_ID_ARG_ARG_5CDF2BA6 =
  ...
  public static final String LOG_REQUESTING_DATAPARTITIONTABLE_GENERATION_ARG_DATANODES_559F97E8 =
  ...
  public static final String
      LOG_DATAPARTITIONINTEGRITY_FAILED_DESERIALIZE_DATABASESCOPEDDATAPARTITIONTABLE_3B6933B5 =
          "[DataPartitionIntegrity] Failed to deserialize DatabaseScopedDataPartitionTable";
  ...
  public static final String
      LOG_SUBSCRIPTIONHANDLELEADERCHANGEPROCEDURE_EXECUTEFROMVALIDATE_97490577 =
          "SubscriptionHandleLeaderChangeProcedure: executeFromValidate";
  public static final String
      LOG_SUBSCRIPTIONHANDLELEADERCHANGEPROCEDURE_EXECUTEFROMOPERATEONCONFIGNODES_D4E8BD37 =
          "SubscriptionHandleLeaderChangeProcedure: executeFromOperateOnConfigNodes";
  public static final String
  ...
  public static final String
      LOG_SUBSCRIPTIONHANDLELEADERCHANGEPROCEDURE_EXECUTEFROMOPERATEONDATANODES_0D9F7C98 =
          "SubscriptionHandleLeaderChangeProcedure: executeFromOperateOnDataNodes";
  public static final String
  ...
  public static final String
      LOG_SUBSCRIPTIONHANDLELEADERCHANGEPROCEDURE_ROLLBACKFROMOPERATEONCONFIGNODES_D4C70763 =
          "SubscriptionHandleLeaderChangeProcedure: rollbackFromOperateOnConfigNodes";
  public static final String
      LOG_SUBSCRIPTIONHANDLELEADERCHANGEPROCEDURE_ROLLBACKFROMOPERATEONDATANODES_0250F6E9 =
          "SubscriptionHandleLeaderChangeProcedure: rollbackFromOperateOnDataNodes";
  public static final String
  ...
  public static final String
      EXCEPTION_FAILED_PUSH_SUBSCRIPTION_RUNTIME_STATE_READABLE_DATANODES_DURING_LEADER_CHANGE_F37E6F2C =
          "Failed to push subscription runtime state to readable DataNodes during leader change,"
              + " details: %s";
  public static final String EXCEPTION_FAILED_SERIALIZE_REGION_PROGRESS_1769D6F1 =
      "Failed to serialize region progress ";
  public static final String
  ...
  public static final String LOG_MODE_ARG_SKIPPING_PIPE_CREATION_5F4D1026 =
  ...
  public static final String
      LOG_CREATESUBSCRIPTIONPROCEDURE_SYNCHRONIZING_COMMIT_PROGRESS_AFTER_CONSUMER_GROUP_NEWLY_SUBSCRIBED_CONSENSUS_TOPICS_ARG_F5687D36 =
          "CreateSubscriptionProcedure: synchronizing commit progress after consumer group newly subscribed consensus topics {}";
  public static final String
  ...
  public static final String LOG_MODE_ARG_SKIPPING_PIPE_REMOVAL_133B0CD6 =
  ...
  public static final String LOG_COMMITPROGRESSSYNCPROCEDURE_EXECUTEFROMVALIDATE_CF220E1F =
      "CommitProgressSyncProcedure: executeFromValidate";
  public static final String
  ...
  public static final String
      EXCEPTION_FAILED_TO_PULL_REQUIRED_COMMIT_PROGRESS_FROM_DATANODE_ARG_STATUS_ARG_E08A2450 =
          "Failed to pull required commit progress from DataNode %s, status: %s";
  public static final String
      LOG_COMMITPROGRESSSYNCPROCEDURE_EXECUTEFROMOPERATEONDATANODES_NO_OP_34420360 =
          "CommitProgressSyncProcedure: executeFromOperateOnDataNodes (no-op)";
  public static final String LOG_COMMITPROGRESSSYNCPROCEDURE_ROLLBACKFROMVALIDATE_2309D4D2 =
  ...
  public static final String
      LOG_COMMITPROGRESSSYNCPROCEDURE_ROLLBACKFROMOPERATEONCONFIGNODES_57CB907B =
          "CommitProgressSyncProcedure: rollbackFromOperateOnConfigNodes";
  public static final String
      LOG_COMMITPROGRESSSYNCPROCEDURE_ROLLBACKFROMOPERATEONDATANODES_0D2CEB50 =
          "CommitProgressSyncProcedure: rollbackFromOperateOnDataNodes";
  public static final String
