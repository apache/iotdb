...
public final class ManagerMessages {
  ...
  public static final String DATAPARTITIONTABLEINTEGRITYCHECKPROCEDURE_IS_ALREADY_SUBMITTED =
  ...
  public static final String
      FAILED_TO_UNBIND_FROM_PIPE_TEMPORARY_META_METRICS_PIPETEMPORARYMETA_MAP =
  ...
  public static final String
      REGIONPRIORITY_THE_ROUTING_PRIORITY_OF_REGIONGROUPS_IS_NOT_DETERMINED_AFTER =
  ...
  public static final String
      UN_PARSE_ABLE_PATH_NAME_ENCOUNTERED_DURING_TEMPLATE_PRIVILEGE_TRIMMING =
          "Un-parse-able path name encountered during template privilege trimming, please check";
  public static final String
      UPGRADE_CONFIGNODE_CONSENSUS_WAL_DIR_FOR_SIMPLECONSENSUS_FROM_VERSION_1 =
  ...
  public static final String MIGRATE_THE_SERVICE_ON_THE_REMOVED_DATANODES_FAILED =
      "Migrate the service on the removed DataNodes failed";
  public static final String SERVER_ACCEPTED_THE_REQUEST = "Server accepted the request";
  public static final String SERVER_REJECTED_THE_REQUEST_MAYBE_REQUESTS_ARE_TOO_MANY =
      "Server rejected the request, maybe requests are too many";
  public static final String THERE_IS_ALREADY_ONE_AINODE_IN_THE_CLUSTER =
      "There is already one AINode in the cluster.";
  public static final String REMOVE_AINODE_FAILED_BECAUSE_THERE_IS_NO_AINODE_IN_THE =
      "Remove AINode failed because there is no AINode in the cluster.";
  public static final String REMOVE_CONFIGNODE_FAILED_DUE_TO_THREAD_INTERRUPTION =
      "Remove ConfigNode failed due to thread interruption.";
  public static final String
  ...
  public static final String REMOVE_CONFIGNODE_FAILED_BECAUSE_TRANSFER_CONFIGNODE_LEADER_FAILED =
      "Remove ConfigNode failed because transfer ConfigNode leader failed.";
  public static final String
      LOG_FAILED_TO_TRANSFER_CONFIGNODE_LEADER_FROM_ARG_TO_ARG_TRYING_ANOTHER_CANDIDATE_BA922E92 =
          "Failed to transfer ConfigNode leader from {} to {}, trying another candidate.";
  public static final String
      LOG_COULD_NOT_CONFIRM_A_CONFIGNODE_LEADER_OTHER_THAN_ARG_AFTER_ATTEMPTING_TO_TRANSFER_LEADERSHIP_TO_ARG_TRYING_ANOTHER_CANDIDATE_91EF68C1 =
          "Could not confirm a ConfigNode leader other than {} after attempting to transfer leadership to {}, trying another candidate.";
  public static final String
      LOG_STOPPED_RETRYING_CONFIGNODE_LEADER_TRANSFER_BECAUSE_THE_REMAINING_RPC_TIMEOUT_IS_INSUFFICIENT_6429A49C =
          "Stopped retrying ConfigNode leader transfer because the remaining RPC timeout is insufficient.";
  ...
  public static final String
      LOG_SUBSCRIPTIONHANDLELEADERCHANGEPROCEDURE_WAS_SUBMITTED_PROCEDUREID_ARG_6DBD6075 =
          "SubscriptionHandleLeaderChangeProcedure was submitted, procedureId: {}.";
  public static final String
      LOG_SUBSCRIPTIONHANDLELEADERCHANGEPROCEDURE_WAS_FAILED_SUBMIT_58FAB03F =
          "SubscriptionHandleLeaderChangeProcedure was failed to submit.";
  ...
  public static final String MESSAGE_CONSENSUSMANAGER_TARGET_CONFIGNODE_NOT_INITIALIZED_4D386066 =
  ...
  public static final String MESSAGE_CONFIG_NODE_CONSENSUS_PROTOCOL_CLASS_D0F437AF =
      "config_node_consensus_protocol_class";
  public static final String MESSAGE_DATA_REGION_CONSENSUS_PROTOCOL_CLASS_AB025B20 =
      "data_region_consensus_protocol_class";
  public static final String MESSAGE_SCHEMA_REGION_CONSENSUS_PROTOCOL_CLASS_480645EF =
      "schema_region_consensus_protocol_class";
  public static final String MESSAGE_SERIES_SLOT_NUM_115D9BE0 = "series_slot_num";
  public static final String MESSAGE_SERIES_PARTITION_EXECUTOR_CLASS_AD1B5C24 =
      "series_partition_executor_class";
  public static final String MESSAGE_TIME_PARTITION_INTERVAL_CE476507 = "time_partition_interval";
  public static final String MESSAGE_SCHEMA_REPLICATION_FACTOR_11DB65B5 =
      "schema_replication_factor";
  public static final String MESSAGE_DATA_REPLICATION_FACTOR_22465D3B = "data_replication_factor";
  public static final String MESSAGE_SCHEMA_REGION_PER_DATA_NODE_555F29BC =
      "schema_region_per_data_node";
  public static final String MESSAGE_DATA_REGION_PER_DATA_NODE_C183AAD5 =
      "data_region_per_data_node";
  public static final String MESSAGE_READ_CONSISTENCY_LEVEL_B12D8D95 = "read_consistency_level";
  public static final String MESSAGE_DISK_SPACE_WARNING_THRESHOLD_19635ACA =
  ...
  public static final String LOG_SCHEMA_TEMPLATE_NEED_TWO_FILES_1E57542A =
      "schema_template need two files";
  public static final String LOG_GOT_IOEXCEPTION_DESERIALIZE_USE_ROLE_FILE_TYPE_ARG_1B548759 =
      "Got IOException when deserialize use&role file, type:{}";
  public static final String LOG_GOT_IOEXCEPTION_DESERIALIZE_ROLELIST_1354F29E =
      "Got IOException when deserialize roleList";
  public static final String LOG_GOT_EXCEPTION_DESERIALIZING_TTL_FILE_F806EB40 =
      "Got exception when deserializing ttl file";
  public static final String
      LOG_UNRECOGNIZED_NODE_TYPE_CANNOT_DESERIALIZE_MTREE_GIVEN_BUFFER_5CF3121B =
          "Unrecognized node type. Cannot deserialize MTree from given buffer";
  public static final String LOG_GOT_IOEXCEPTION_CONSTRUCT_DATABASE_TREE_49436621 =
      "Got IOException when construct database Tree";
  public static final String LOG_GOT_IOEXCEPTION_DESERIALIZE_TEMPLATE_INFO_49EE617E =
      "Got IOException when deserialize template info";
  public static final String MESSAGE_MEASUREMENTS_NOT_FOUND_ARG_CANNOT_AUTO_DETECT_980D7D44 =
      "Measurements not found for %s, cannot auto detect";
  public static final String
      LOG_FAILED_TAKE_SNAPSHOT_BECAUSE_SNAPSHOT_FILE_ARG_ALREADY_EXIST_EB2A6093 =
          "Failed to take snapshot, because snapshot file [{}] is already exist.";
  public static final String LOG_FAILED_LOAD_SNAPSHOT_SNAPSHOT_FILE_ARG_NOT_EXIST_8828CFBA =
      "Failed to load snapshot,snapshot file [{}] is not exist.";
  public static final String LOG_YOU_MAYBE_NEED_RENAME_SIMPLE_DIR_0_0_MANUALLY_2A12C5C9 =
      "you maybe need to rename the simple dir to 0_0 manually.";
  public static final String LOG_CONFIGNODE_LOCAL_PEER_HAS_ALREADY_BEEN_CREATED_ARG_FA75E88F =
      "ConfigNode local peer has already been created: {}";
  public static final String LOG_CONFIGNODE_PEER_ARG_HAS_ALREADY_BEEN_ADDED_ARG_A8F958B0 =
      "ConfigNode peer {} has already been added: {}";
  public static final String LOG_CONFIGNODE_PEER_ARG_HAS_ALREADY_BEEN_REMOVED_ARG_FACD71EE =
  ...
  public static final String MESSAGE_CURRENT_CONFIGNODE_LEADER_SERVICE_NOT_READY =
  ...
  public static final String LOG_FAILED_SYNC_COMMIT_PROGRESS_RESULT_STATUS_ARG_A9E46E80 =
      "Failed to sync commit progress. Result status: {}.";
  public static final String MESSAGE_FAILED_ALTER_DATABASE_DATABASE_2734674F =
  ...
  public static final String MESSAGE_ACCEPT_NODE_REGISTRATION_4133276A =
  ...
  public static final String MESSAGE_CLUSTER_ID_HAS_NOT_GENERATED_PLEASE_TRY_AGAIN_LATER_58A1C3F2 =
      "cluster id has not generated, please try again later";
  public static final String
      MESSAGE_REJECT_ARG_RESTART_BECAUSE_CLUSTERNAME_CURRENT_ARG_TARGET_CLUSTER_INCONSISTENT_2075F29D =
          "Reject %s restart. Because the ClusterName of the current %s and the target cluster are"
              + " inconsistent. ";
  public static final String MESSAGE_REJECT_ARG_RESTART_BECAUSE_NODEID_CURRENT_ARG_ARG_AC13EDD5 =
      "Reject %s restart. Because the nodeId of the current %s is %d.";
  public static final String MESSAGE_1_DELETE_DATA_DIR_RETRY_86A23473 =
  ...
  public static final String MESSAGE_1_PLEASE_CHECK_IF_NODE_CONFIGURATION_PATH_CORRECT_7FB5D559 =
  ...
  public static final String MESSAGE_CONFIGNODE_REMOVED_LEADER_ALREADY_TRANSFER_LEADER_FA6D1603 =
  ...
  public static final String LOG_REGIONGROUP_ARG_SERIESPARTITIONSLOT_COUNT_ARG_30F57B14 =
      "to RegionGroup {}, SeriesPartitionSlot Count: {}";
  public static final String LOG_REGIONGROUPID_ARG_SERIESPARTITIONSLOT_COUNT_ARG_5DAE4B6A =
  ...
  public static final String LOG_PIPEMETAFROMAGENT_NULL_PIPEMETAFROMCOORDINATOR_ARG_36C513AE =
  ...
  public static final String LOG_DETECT_PIPERUNTIMECONNECTORCRITICALEXCEPTION_ARG_7D198DD7 =
  ...
  public static final String EXCEPTION_DATANODEID_SHOULD_NOT_BE_MINUS_1_HERE_5CB27796 =
      "dataNodeId should not be -1 here";
  public static final String MESSAGE_SUBSCRIPTIONOWNERLEASESYNCER_IS_STARTED_SUCCESSFULLY_09CA6848 =
      "SubscriptionOwnerLeaseSyncer is started successfully.";
  public static final String
      MESSAGE_FAILED_TO_PUSH_SUBSCRIPTION_TOPIC_OWNER_LEASES_TO_DATANODES_EBFBA668 =
          "Failed to push subscription topic owner leases to DataNodes.";
  public static final String MESSAGE_SUBSCRIPTIONOWNERLEASESYNCER_IS_STOPPED_SUCCESSFULLY_11442F29 =
