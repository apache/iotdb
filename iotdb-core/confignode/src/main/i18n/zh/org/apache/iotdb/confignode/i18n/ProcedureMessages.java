...
public final class ProcedureMessages {
  ...
  public static final String ALTERING_COLUMN_IN_ON_CONFIGNODE = "在 ConfigNode 上修改表 {}.{} 中的列 {}";
  ...
  public static final String ALTER_TIME_SERIES_DATA_TYPE_FAILED = "修改时间序列 {} 数据类型失败";
  ...
  public static final String CANNOT_FIND_REGION_REPLICA_NODES_REGION = "找不到 region 副本节点，region：{}";
  public static final String
  ...
  public static final String CLEARING_CACHE_AFTER_ALTER_TIME_SERIES_DATA_TYPE =
      "修改时间序列 {} 数据类型后清理缓存";
  public static final String COLUMN_CHECK_FOR_TABLE_WHEN_ADDING_COLUMN = "添加列时对表 {}.{} 进行列检查";
  public static final String COLUMN_CHECK_FOR_TABLE_WHEN_RENAMING_COLUMN = "重命名列时对表 {}.{} 进行列检查";
  public static final String COLUMN_CHECK_FOR_TABLE_WHEN_RENAMING_TABLE = "重命名表时对表 {}.{} 进行列检查";
  ...
  public static final String CONSTRUCT_SCHEMA_BLACK_LIST_WITH_TEMPLATE = "使用模板 {} 构建 schema 黑名单";
  ...
  public static final String DELETE_DATA_OF_TEMPLATE_TIMESERIES = "删除模板时间序列 {} 的数据";
  public static final String DELETE_DATA_OF_TIMESERIES = "删除时间序列 {} 的数据";
  public static final String DELETE_DEVICES_IN_IN_SCHEMAENGINE = "在 schemaEngine 中删除 {}.{} 中的设备";
  public static final String DELETE_TIMESERIES_SCHEMAENGINE_OF = "删除时间序列 {} 的 schemaEngine";
  ...
  public static final String DELETING_DEVICES_FOR_TABLE_WHEN_DROPPING_TABLE = "删除表时正在删除表 {}.{} 的设备";
  public static final String DESERIALIZE_MEETS_ERROR_IN_CREATEREGIONGROUPSPROCEDURE =
      "在 CreateRegionGroupsProcedure 中反序列化出错";
  public static final String DROPPING_COLUMN_IN_ON_CONFIGNODE = "在 ConfigNode 上删除表 {}.{} 中的列 {}";
  ...
  public static final String FAILED_TO_COMMIT_SET_TEMPLATE_ON_PATH_DUE_TO =
      "在路径 {} 上提交设置模板 {} 失败，原因：{}";
  public static final String FAILED_TO_CREATE_CONSENSUS_PIPE = "{}, 创建共识 pipe {} 失败：{}";
  public static final String
  ...
  public static final String FAILED_TO_EXECUTE_PLAN_BECAUSE = "执行 plan {} 失败，原因：{}";
  ...
  public static final String FAILED_TO_ROLLBACK_TABLE_CREATION = "回滚表 {} 的创建失败。{}";
  public static final String FAILED_TO_ROLLBACK_TEMPLATE_CACHE_OF_TEMPLATE_SET_ON =
      "回滚模板 {}（设置在 {} 上）的模板缓存失败";
  public static final String FAILED_TO_SERIALIZE_DATAPARTITIONTABLES = "序列化 dataPartitionTables 失败";
  public static final String FAILED_TO_SERIALIZE_FAILEDDATANODE = "序列化 failedDataNode 失败";
  ...
  public static final String FAILED_TO_UPDATE_TTL_CACHE_OF_DATANODE = "更新 DataNode 的 ttl 缓存失败。";
  ...
  public static final String FAIL_TO_CREATE_TRIGGER_AT_STATE = "在 STATE [%s] 处创建 trigger [%s] 失败";
  ...
  public static final String FINISH_SCHEDULING_CQ_SUCCESSFULLY = "成功完成 CQ {} 的调度";
  ...
  public static final String INVALIDATE_CACHE_OF_DEVICES_IN = "使 {}.{} 中设备的缓存失效";
  public static final String INVALIDATE_CACHE_OF_TEMPLATE_SET_ON = "使模板 {}（设置在 {} 上）的缓存失效";
  public static final String INVALIDATE_CACHE_OF_TEMPLATE_TIMESERIES = "使模板时间序列 {} 的缓存失效";
  ...
  public static final String INVALIDATE_COLUMN_CACHE_FAILED_FOR_TABLE = "使表 %s.%s 的列 %s 缓存失效失败";
  ...
  public static final String INVALIDATE_VIEW_SCHEMAENGINE_CACHE_FAILED = "使视图 schemaengine 缓存失效失败";
  ...
  public static final String PID_REMOVEREGION_STATE_SUCCESS = "[pid{}][RemoveRegion] 状态 {} 成功";
  public static final String
  ...
  public static final String PRE_RELEASE_INFO_FOR_TABLE_WHEN_SETTING_PROPERTIES =
      "设置属性时预释放表 {}.{} 的信息";
  public static final String PRE_RELEASE_INFO_OF_TABLE_WHEN_ADDING_COLUMN = "添加列时预释放表 {}.{} 的信息";
  public static final String PRE_RELEASE_INFO_OF_TABLE_WHEN_ALTERING_COLUMN = "修改列时预释放表 {}.{} 的信息";
  public static final String PRE_RELEASE_INFO_OF_TABLE_WHEN_RENAMING_COLUMN = "重命名列时预释放表 {}.{} 的信息";
  public static final String PRE_RELEASE_INFO_OF_TABLE_WHEN_RENAMING_TABLE = "重命名表时预释放表 {}.{} 的信息";
  ...
  public static final String PROCEDUREID_TRY_TO_ACQUIRE_PIPE_LOCK = "ProcedureId {} 尝试获取 pipe 锁。";
  ...
  public static final String RENAME_COLUMN_TO_TABLE_ON_CONFIG_NODE = "在 ConfigNode 上重命名表 {}.{} 的列";
  ...
  public static final String ROLLBACK_TEMPLATE_PRE_UNSET_FAILED_BECAUSE_OF = "回滚预取消设置模板失败，原因";
  public static final String
  ...
  public static final String START_ROLLBACK_PRE_CREATE_TABLE = "开始回滚预创建表 {}.{}";
  public static final String START_ROLLBACK_PRE_RELEASE_INFO_FOR_TABLE_WHEN_SETTING_PROPERTIES =
      "设置属性时开始回滚预释放表 {}.{} 的信息";
  public static final String START_ROLLBACK_PRE_RELEASE_INFO_OF_TABLE = "开始回滚预释放表 {}.{} 的信息";
  public static final String START_ROLLBACK_PRE_RELEASE_SCHEMAENGINE_TEMPLATE_ON_PATH =
      "开始回滚预释放在路径 {} 上设置的 schemaengine 模板 {}";
  public static final String START_ROLLBACK_PRE_RELEASE_TABLE = "开始回滚预释放表 {}.{}";
  ...
  public static final String START_ROLLBACK_SET_PROPERTIES_TO_TABLE = "开始回滚设置表 {}.{} 的属性";
  ...
  public static final String SUBMITTED_ASYNC_CONSENSUS_PIPE_CREATION = "{}, 已提交异步共识 pipe 创建：{}";
  ...
  public static final String UNRECOGNIZED_DROPTABLECOLUMNSTATE = "无法识别的 DropTableColumnState ";
  ...
  public static final String UNRECOGNIZED_RENAMETABLECOLUMNSTATE = "无法识别的 RenameTableColumnState ";
  ...
  public static final String VALIDATE_TABLE_FOR_TABLE_WHEN_SETTING_PROPERTIES = "设置属性时校验表 {}.{}";
  public static final String
  ...
  public static final String
      LOG_STATEMACHINEPROCEDURE_PID_ARG_SET_NEXT_STATE_ARG_BUT_RETURN_NO_0CA2D56C =
          "StateMachineProcedure pid={} 设置下一状态为 {}，但返回 NO_MORE_STATE";
  public static final String
      LOG_DON_T_ADD_SUCCESSFUL_PROCEDURE_BACK_SCHEDULER_IT_WILL_IGNORED_E015472C =
          "不要将已成功的 procedure 加回 scheduler，它将被忽略";
  ...
  public static final String
      LOG_DATAPARTITIONINTEGRITY_NO_DATABASES_HAVE_LOST_DATA_PARTITIONS_TERMINATING_PROCEDURE_3E718CC3 =
          "[DataPartitionIntegrity] 没有数据库丢失数据分区，终止 procedure";
  public static final String
  ...
  public static final String
      LOG_DATAPARTITIONINTEGRITY_FAILED_REQUEST_DATAPARTITIONTABLE_GENERATION_DATANODE_ID_ARG_ARG_818B47B8 =
          "[DataPartitionIntegrity] 从 DataNode[id={}] 请求生成 DataPartitionTable 失败：{}";
  public static final String
  ...
  public static final String
      LOG_DATAPARTITIONINTEGRITY_DATANODE_ARG_STILL_GENERATING_DATAPARTITIONTABLE_63F84C78 =
          "[DataPartitionIntegrity] DataNode {} 仍在生成 DataPartitionTable";
  public static final String
      LOG_DATAPARTITIONINTEGRITY_DATANODE_ARG_RETURNED_UNKNOWN_ERROR_CODE_ARG_2DA6A21E =
          "[DataPartitionIntegrity] DataNode {} 返回未知错误码：{}";
  public static final String
  ...
  public static final String
      LOG_DATAPARTITIONINTEGRITY_NO_DATAPARTITIONTABLES_MERGE_DATAPARTITIONTABLES_EMPTY_920E3DE6 =
          "[DataPartitionIntegrity] 没有可合并的 DataPartitionTable，dataPartitionTables 为空";
  public static final String
  ...
  public static final String
      LOG_SUBSCRIPTIONHANDLELEADERCHANGEPROCEDURE_FAILED_PULL_COMMIT_PROGRESS_DATANODE_ARG_STATUS_ARG_8C6DEC4E =
          "SubscriptionHandleLeaderChangeProcedure：拉取 DataNode {} 的提交进度失败，状态：{}";
  public static final String
      LOG_SUBSCRIPTIONHANDLELEADERCHANGEPROCEDURE_FAILED_WRITE_API_EXECUTING_CONSENSUS_LAYER_56B3832A =
          "SubscriptionHandleLeaderChangeProcedure：写入 API 执行共识层时失败，原因：";
  public static final String
  ...
  public static final String
      LOG_SUBSCRIPTIONHANDLELEADERCHANGEPROCEDURE_FAILED_DESERIALIZE_REGION_PROGRESS_KEY_ARG_SUMMARY_ARG_F6935E59 =
          "SubscriptionHandleLeaderChangeProcedure: 反序列化 Region 进度失败，key={}, summary={}";
  public static final String
      EXCEPTION_FAILED_PUSH_SUBSCRIPTION_RUNTIME_STATE_READABLE_DATANODES_DURING_LEADER_CHANGE_F37E6F2C =
          "leader 变更期间向可读 DataNode 推送订阅运行时状态失败，详情：%s";
  ...
  public static final String
      LOG_COMMITPROGRESSSYNCPROCEDURE_ACQUIRELOCK_SKIP_PROCEDURE_LAST_EXECUTION_TIME_ARG_CE3DD247 =
          "CommitProgressSyncProcedure：acquireLock，因上次执行时间 {} 跳过该 procedure";
  ...
  public static final String
      LOG_COMMITPROGRESSSYNCPROCEDURE_FAILED_DESERIALIZE_REGION_PROGRESS_KEY_ARG_SUMMARY_ARG_0202F658 =
          "CommitProgressSyncProcedure: 反序列化 Region 进度失败，key={}, summary={}";
