...
public final class ManagerMessages {
  ...
  public static final String CREATE_DATAPARTITION_FAILED_BECAUSE = "创建 DataPartition 失败，原因：";
  ...
  public static final String CREATE_SCHEMAPARTITION_FAILED_BECAUSE = "创建 SchemaPartition 失败，原因：";
  ...
  public static final String DECREASE_REFERENCE_COUNT_FOR_SNAPSHOT_ERROR = "减少快照 {} 的引用计数失败。";
  ...
  public static final String ERROR_HAPPENED_WHILE_SHUTTING_DOWN_PREVIOUS_CQ_SCHEDULE_THREAD_POOL =
      "关闭上一个 CQ 调度线程池时出错。";
  public static final String ERROR_OCCURRED_DURING_CLOSING_PIPECONNECTOR = "关闭 PipeConnector 时出错。";
  public static final String ERROR_OCCURRED_DURING_CLOSING_PIPEEXTRACTOR = "关闭 PipeExtractor 时出错。";
  public static final String ERROR_OCCURRED_DURING_CLOSING_PIPEPROCESSOR = "关闭 PipeProcessor 时出错。";
  ...
  public static final String EVENT_SERVICE_IS_STARTED_SUCCESSFULLY = "Event 服务已成功启动。";
  public static final String EVENT_SERVICE_IS_STOPPED_SUCCESSFULLY = "Event 服务已成功停止。";
  ...
  public static final String FAILED_TO_ACQUIRE_PIPE_LOCK_FOR_HANDLING_SUCCESSFUL_RESTART =
      "为处理成功重启获取 pipe 锁失败。";
  public static final String FAILED_TO_ALTER_PIPE_RESULT_STATUS = "修改 pipe {} 失败。结果状态：{}。";
  public static final String FAILED_TO_CHECK_AND_REPAIR_CONSENSUS_PIPES = "检查并修复 consensus pipe 失败";
  public static final String FAILED_TO_CHECK_PASSWORD_FOR_PIPE = "检查 pipe %s 的密码失败。";
  ...
  public static final String FAILED_TO_COLLECT_UNSETTEMPLATEPLAN = "收集 UnsetTemplatePlan 失败";
  public static final String FAILED_TO_COLLECT_USER_NAME_FOR_USER_ID = "为用户 id {} 收集用户名失败";
  ...
  public static final String FAILED_TO_CREATE_PIPE_RESULT_STATUS = "创建 pipe {} 失败。结果状态：{}。";
  ...
  public static final String FAILED_TO_DROP_PIPE_RESULT_STATUS = "删除 pipe {} 失败。结果状态：{}。";
  public static final String FAILED_TO_GET_ALL_PIPE_INFO = "获取全部 pipe 信息失败。";
  public static final String FAILED_TO_GET_ALL_SUBSCRIPTION_INFO = "获取全部订阅信息失败。";
  ...
  public static final String FAILED_TO_LOAD_SNAPSHOT_FROM_BYTEBUFFER = "从 byteBuffer {} 加载快照失败。";
  ...
  public static final String FAILED_TO_START_PIPE_RESULT_STATUS = "启动 pipe {} 失败。结果状态：{}。";
  public static final String FAILED_TO_STOP_PIPE_RESULT_STATUS = "停止 pipe {} 失败。结果状态：{}。";
  ...
  public static final String FAILED_TO_SYNC_PIPE_META_RESULT_STATUS = "同步 pipe 元数据失败。结果状态：{}。";
  public static final String FAILED_TO_SYNC_TEMPLATE_EXTENSION_INFO_TO_DATANODE =
      "将模板 {} 的扩展信息同步到 DataNode {} 失败";
  public static final String FAILED_TO_SYNC_TOPIC_META_RESULT_STATUS = "同步 topic 元数据失败。结果状态：{}。";
  ...
  public static final String FAIL_TO_TRANSFER_BECAUSE_WILL_RETRY = "传输失败，原因：{}，将重试";
  ...
  public static final String HEARTBEAT_SERVICE_IS_STARTED_SUCCESSFULLY = "心跳服务已成功启动。";
  public static final String HEARTBEAT_SERVICE_IS_STOPPED_SUCCESSFULLY = "心跳服务已成功停止。";
  ...
  public static final String INTERRUPT_WHEN_WAIT_FOR_CALCULATING_REGION_PRIORITY =
      "等待计算 Region 优先级时被中断";
  public static final String INTERRUPT_WHEN_WAIT_FOR_LEADER_ELECTION = "等待 leader 选举时被中断";
  ...
  public static final String NETWORK_ERROR_WHEN_TRANSFER_EVENT_BECAUSE = "传输事件 %s 时出现网络错误，原因：%s。";
  public static final String NODEMANAGER_START_TO_REMOVE_DATANODE = "NodeManager 开始移除 DataNode {}";
  ...
  public static final String PIPEHEARTBEAT_IS_STARTED_SUCCESSFULLY = "PipeHeartbeat 已成功启动。";
  public static final String PIPEHEARTBEAT_IS_STOPPED_SUCCESSFULLY = "PipeHeartbeat 已成功停止。";
  public static final String PIPEMETASYNCER_IS_STARTED_SUCCESSFULLY = "PipeMetaSyncer 已成功启动。";
  public static final String PIPEMETASYNCER_IS_STOPPED_SUCCESSFULLY = "PipeMetaSyncer 已成功停止。";
  public static final String PIPERUNTIMECONFIGNODEAGENT_STARTED = "PipeRuntimeConfigNodeAgent 已启动";
  public static final String PIPERUNTIMECONFIGNODEAGENT_STOPPED = "PipeRuntimeConfigNodeAgent 已停止";
  ...
  public static final String PIPE_SNAPSHOT_DIR_FOUND_DELETING_IT = "发现 pipe 快照目录，正在删除：{}，";
  ...
  public static final String REGIONCLEANER_IS_STARTED_SUCCESSFULLY = "RegionCleaner 已成功启动。";
  public static final String REGIONCLEANER_IS_STOPPED_SUCCESSFULLY = "RegionCleaner 已成功停止。";
  ...
  public static final String REGIONGROUPSTATISTICS_REGION_IN_DATANODE_NULL_2 =
      "[RegionGroupStatistics]\t DataNode {} 中的 Region：{} -> null";
  public static final String REGIONGROUPSTATUS_DOESN_T_EXIST = "RegionGroupStatus %s 不存在。";
  ...
  public static final String START_TO_CREATE_REGION_ON_DATANODE = "开始在 DataNode: {} 上创建 Region：{}";
  public static final String START_TO_CREATE_UDF_ON_DATA_NODES_NEEDTOSAVEJAR =
      "开始在 Data Nodes 上创建 UDF [{}]，needToSaveJar[{}]";
  public static final String START_TO_DELETE_REGION_ON_DATANODE = "开始在 DataNode: {} 上删除 Region：{}";
  ...
  public static final String SUBMITTED_ASYNC_CONSENSUS_PIPE_CREATION = "已异步提交 consensus pipe 创建：{}";
  public static final String SUBMITTED_ASYNC_CONSENSUS_PIPE_DROP = "已异步提交 consensus pipe 删除：{}";
  ...
  public static final String SUCCESSFULLY_TRANSFERRED_CONFIG_EVENT = "成功传输 config event {}。";
  ...
  public static final String TOPOLOGY_CLUSTER_TOPOLOGY_CHANGED_LATEST = "[Topology] 集群拓扑已变化，最新：{}";
  public static final String TOPOLOGY_PROBING_HAS_STARTED_SUCCESSFULLY = "拓扑探测已成功启动";
  public static final String TOPOLOGY_PROBING_HAS_STOPPED_SUCCESSFULLY = "拓扑探测已成功停止";
  ...
  public static final String UNEXPECTED_ERROR_HAPPENED_WHILE_DROPPING_CQ = "删除 cq {} 时发生意外错误：";
  public static final String UNEXPECTED_ERROR_HAPPENED_WHILE_DROPPING_SERVICE_ON_DATANODE =
      "在 DataNode {} 上删除 Service {} 时发生意外错误：";
  public static final String UNEXPECTED_ERROR_HAPPENED_WHILE_FETCHING_CQ_LIST = "获取 cq 列表时发生意外错误：";
  public static final String UNEXPECTED_ERROR_HAPPENED_WHILE_GETTING_USER_DEFINED_SERVICE =
      "获取用户自定义 Service 时发生意外错误：";
  public static final String UNEXPECTED_ERROR_HAPPENED_WHILE_SHOWING_CQ = "展示 cq 时发生意外错误：";
  ...
  public static final String WRITE_PARTITION_ALLOCATION_RESULT_FAILED_BECAUSE = "写入分区分配结果失败，原因：{}";
  ...
  public static final String REMOVE_CONFIGNODE_FAILED_BECAUSE_TRANSFER_CONFIGNODE_LEADER_FAILED =
      "移除 ConfigNode 失败，转移 ConfigNode leader 失败。";
  public static final String
  ...
  public static final String
      LOG_SUBSCRIPTIONHANDLELEADERCHANGEPROCEDURE_WAS_SUBMITTED_PROCEDUREID_ARG_6DBD6075 =
          "SubscriptionHandleLeaderChangeProcedure 已提交，procedureId：{}。";
  public static final String
      LOG_SUBSCRIPTIONHANDLELEADERCHANGEPROCEDURE_WAS_FAILED_SUBMIT_58FAB03F =
          "SubscriptionHandleLeaderChangeProcedure 提交失败。";
  ...
  public static final String
      MESSAGE_1_USE_SQL_SHOW_CLUSTER_DETAILS_FIND_OUT_CONFLICT_NODES_A1195AEA =
          "\t1. 使用 SQL：\"show cluster details\" 找出冲突节点。移除它们后重试启动。";
  public static final String
  ...
  public static final String
      MESSAGE_CREATE_DATAPARTITION_FAILED_BECAUSE_DATABASE_ARG_NOT_EXISTS_F223D5C2 =
          "创建 DataPartition 失败，原因：数据库 %s 不存在";
  public static final String
  ...
  public static final String
      LOG_CREATEREGIONGROUPS_REGIONGROUP_ARG_BELONGED_DATABASE_ARG_DATANODES_ARG_5270AB6B =
          "[CreateRegionGroups] RegionGroup：{}，所属数据库：{}，DataNodes：{}";
