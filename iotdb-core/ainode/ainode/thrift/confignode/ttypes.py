...
class TShowModelResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i717 in range(_size713):
                        _elem718 = iprot.readBinary()
                        self.modelInfoList.append(_elem718)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.modelInfoList is not None:
            ...
            for iter719 in self.modelInfoList:
                oprot.writeBinary(iter719)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TDataSchemaForTable(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i731 in range(_size727):
                        ...
                        self.databaseList.append(_elem732)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.LIST:
                    ...
                    for _i737 in range(_size733):
                        _elem738 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.tableList.append(_elem738)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.databaseList is not None:
            ...
            for iter739 in self.databaseList:
...
class TDataSchemaForTree(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i745 in range(_size741):
                        _elem746 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.path.append(_elem746)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.path is not None:
            ...
            for iter747 in self.path:
                oprot.writeString(iter747.encode('utf-8') if sys.version_info[0] == 2 else iter747)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TCreateTrainingReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i752 in range(_size748):
                        ...
                        _val754 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.parameters[_key753] = _val754
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i759 in range(_size755):
                        ...
                        for _i765 in range(_size761):
                            ...
                            _elem760.append(_elem766)
                        iprot.readListEnd()
                        self.timeRanges.append(_elem760)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.parameters is not None:
            ...
            for kiter767, viter768 in self.parameters.items():
        ...
        if self.timeRanges is not None:
            ...
            for iter769 in self.timeRanges:
                oprot.writeListBegin(TType.I64, len(iter769))
                for iter770 in iter769:
                    oprot.writeI64(iter770)
                oprot.writeListEnd()
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TSpaceQuotaResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i775 in range(_size771):
                        ...
                        _val777 = iotdb.thrift.common.ttypes.TSpaceQuota()
                        _val777.read(iprot)
                        self.spaceQuota[_key776] = _val777
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.MAP:
                    ...
                    for _i782 in range(_size778):
                        ...
                        _val784 = iotdb.thrift.common.ttypes.TSpaceQuota()
                        _val784.read(iprot)
                        self.spaceQuotaUsage[_key783] = _val784
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.spaceQuota is not None:
            ...
            for kiter785, viter786 in self.spaceQuota.items():
        ...
        if self.spaceQuotaUsage is not None:
            ...
            for kiter787, viter788 in self.spaceQuotaUsage.items():
...
class TThrottleQuotaResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i793 in range(_size789):
                        _key794 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val795 = iotdb.thrift.common.ttypes.TThrottleQuota()
                        _val795.read(iprot)
                        self.throttleQuota[_key794] = _val795
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.throttleQuota is not None:
            ...
            for kiter796, viter797 in self.throttleQuota.items():
                oprot.writeString(kiter796.encode('utf-8') if sys.version_info[0] == 2 else kiter796)
                viter797.write(oprot)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TAINodeConfigurationResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i802 in range(_size798):
                        ...
                        _val804 = iotdb.thrift.common.ttypes.TAINodeConfiguration()
                        _val804.read(iprot)
                        self.aiNodeConfigurationMap[_key803] = _val804
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.aiNodeConfigurationMap is not None:
            ...
            for kiter805, viter806 in self.aiNodeConfigurationMap.items():
                oprot.writeI32(kiter805)
...
class TAINodeRegisterResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i811 in range(_size807):
                        _elem812 = iotdb.thrift.common.ttypes.TConfigNodeLocation()
                        _elem812.read(iprot)
                        self.configNodeList.append(_elem812)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.configNodeList is not None:
            oprot.writeFieldBegin('configNodeList', TType.LIST, 2)
            oprot.writeListBegin(TType.STRUCT, len(self.configNodeList))
            for iter813 in self.configNodeList:
                iter813.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.aiNodeId is not None:
...
class TAINodeRestartResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i818 in range(_size814):
                        _elem819 = iotdb.thrift.common.ttypes.TConfigNodeLocation()
                        _elem819.read(iprot)
                        self.configNodeList.append(_elem819)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.configNodeList is not None:
            oprot.writeFieldBegin('configNodeList', TType.LIST, 2)
            oprot.writeListBegin(TType.STRUCT, len(self.configNodeList))
            for iter820 in self.configNodeList:
                iter820.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TShowTableResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i825 in range(_size821):
                        _elem826 = TTableInfo()
                        _elem826.read(iprot)
                        self.tableInfoList.append(_elem826)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.tableInfoList is not None:
            ...
            for iter827 in self.tableInfoList:
                iter827.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TShowTable4InformationSchemaResp(object):
                ...
                if ftype == TType.MAP:
                    ...
                    for _i832 in range(_size828):
                        ...
                        for _i839 in range(_size835):
                            _elem840 = TTableInfo()
                            _elem840.read(iprot)
                            _val834.append(_elem840)
                        iprot.readListEnd()
                        self.databaseTableInfoMap[_key833] = _val834
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.databaseTableInfoMap is not None:
            ...
            for kiter841, viter842 in self.databaseTableInfoMap.items():
                oprot.writeString(kiter841.encode('utf-8') if sys.version_info[0] == 2 else kiter841)
                oprot.writeListBegin(TType.STRUCT, len(viter842))
                for iter843 in viter842:
                    iter843.write(oprot)
                oprot.writeListEnd()
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
...
class TDescTableResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.SET:
                    ...
                    for _i848 in range(_size844):
                        ...
                        self.preDeletedColumns.add(_elem849)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.preDeletedColumns is not None:
            ...
            for iter850 in self.preDeletedColumns:
...
class TDescTable4InformationSchemaResp(object):
                ...
                if ftype == TType.MAP:
                    ...
                    for _i855 in range(_size851):
                        ...
                        for _i862 in range(_size858):
                            ...
                            _val864 = TTableColumnInfo()
                            _val864.read(iprot)
                            _val857[_key863] = _val864
                        iprot.readMapEnd()
                        self.tableColumnInfoMap[_key856] = _val857
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.tableColumnInfoMap is not None:
            ...
            for kiter865, viter866 in self.tableColumnInfoMap.items():
                oprot.writeString(kiter865.encode('utf-8') if sys.version_info[0] == 2 else kiter865)
                oprot.writeMapBegin(TType.STRING, TType.STRUCT, len(viter866))
                for kiter867, viter868 in viter866.items():
            ...
            if fid == 1:
                ...
                if ftype == TType.SET:
                    ...
                    for _i873 in range(_size869):
                        _elem874 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.preDeletedColumns.add(_elem874)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            else:
