...
class getSchemaPartitionTableWithSlots_args(object):
                ...
                if ftype == TType.MAP:
                    ...
                    for _i880 in range(_size876):
                        ...
                        for _i887 in range(_size883):
                            _elem888 = iotdb.thrift.common.ttypes.TSeriesPartitionSlot()
                            _elem888.read(iprot)
                            _val882.append(_elem888)
                        iprot.readListEnd()
                        self.dbSlotMap[_key881] = _val882
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.dbSlotMap is not None:
            ...
            for kiter889, viter890 in self.dbSlotMap.items():
                oprot.writeString(kiter889.encode('utf-8') if sys.version_info[0] == 2 else kiter889)
                oprot.writeListBegin(TType.STRUCT, len(viter890))
                for iter891 in viter890:
                    iter891.write(oprot)
                oprot.writeListEnd()
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
...
class getOrCreateSchemaPartitionTableWithSlots_args(object):
            ...
            if fid == -1:
                if ftype == TType.MAP:
                    ...
                    for _i896 in range(_size892):
                        _key897 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val898 = []
                        (_etype902, _size899) = iprot.readListBegin()
                        for _i903 in range(_size899):
                            _elem904 = iotdb.thrift.common.ttypes.TSeriesPartitionSlot()
                            _elem904.read(iprot)
                            _val898.append(_elem904)
                        iprot.readListEnd()
                        self.dbSlotMap[_key897] = _val898
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.dbSlotMap is not None:
            oprot.writeFieldBegin('dbSlotMap', TType.MAP, -1)
            oprot.writeMapBegin(TType.STRING, TType.LIST, len(self.dbSlotMap))
            for kiter905, viter906 in self.dbSlotMap.items():
                oprot.writeString(kiter905.encode('utf-8') if sys.version_info[0] == 2 else kiter905)
                oprot.writeListBegin(TType.STRUCT, len(viter906))
...
class clearCache_args(object):
            ...
            if fid == -1:
                if ftype == TType.SET:
                    ...
                    for _i912 in range(_size908):
                        _elem913 = iprot.readI32()
                        self.cacheClearOptions.add(_elem913)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.cacheClearOptions is not None:
            ...
            for iter914 in self.cacheClearOptions:
                oprot.writeI32(iter914)
            oprot.writeSetEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class showSpaceQuota_args(object):
            ...
            if fid == -1:
                if ftype == TType.LIST:
                    ...
                    for _i919 in range(_size915):
                        ...
                        self.databases.append(_elem920)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.databases is not None:
            ...
            for iter921 in self.databases:
                oprot.writeString(iter921.encode('utf-8') if sys.version_info[0] == 2 else iter921)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class fetchTables_args(object):
            ...
            if fid == -1:
                if ftype == TType.MAP:
                    ...
                    for _i926 in range(_size922):
                        _key927 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val928 = set()
                        (_etype932, _size929) = iprot.readSetBegin()
                        for _i933 in range(_size929):
                            ...
                            _val928.add(_elem934)
                        iprot.readSetEnd()
                        self.fetchTableMap[_key927] = _val928
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.fetchTableMap is not None:
            ...
            for kiter935, viter936 in self.fetchTableMap.items():
                oprot.writeString(kiter935.encode('utf-8') if sys.version_info[0] == 2 else kiter935)
                oprot.writeSetBegin(TType.STRING, len(viter936))
                for iter937 in viter936:
