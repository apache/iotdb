...
class TDataNodeHeartbeatResp(object):
    ...
    def __init__(self, heartbeatTimestamp=None, status=None, statusReason=None, judgedLeaders=None, loadSample=None, regionSeriesUsageMap=None, regionDeviceUsageMap=None, regionDisk=None, schemaLimitLevel=None, pipeMetaList=None, activateStatus=None, confirmedConfigNodeEndPoints=None, consensusLogicalTimeMap=None, pipeCompletedList=None, pipeRemainingEventCountList=None, pipeRemainingTimeList=None, dataRegionRawDataSize=None,):
        ...
        self.dataRegionRawDataSize = dataRegionRawDataSize
    ...
    def write(self, oprot):
        ...
        if self.judgedLeaders is not None:
            ...
            for kiter220, viter221 in self.judgedLeaders.items():
                kiter220.write(oprot)
                oprot.writeBool(viter221)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        ...
        if self.regionSeriesUsageMap is not None:
            ...
            for kiter222, viter223 in self.regionSeriesUsageMap.items():
        ...
        if self.regionDeviceUsageMap is not None:
            ...
            for kiter224, viter225 in self.regionDeviceUsageMap.items():
        ...
        if self.regionDisk is not None:
            ...
            for kiter226, viter227 in self.regionDisk.items():
        ...
        if self.pipeMetaList is not None:
            ...
            for iter228 in self.pipeMetaList:
                oprot.writeBinary(iter228)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        ...
        if self.confirmedConfigNodeEndPoints is not None:
            ...
            for iter229 in self.confirmedConfigNodeEndPoints:
                iter229.write(oprot)
            oprot.writeSetEnd()
            oprot.writeFieldEnd()
        if self.consensusLogicalTimeMap is not None:
            ...
            for kiter230, viter231 in self.consensusLogicalTimeMap.items():
        ...
        if self.pipeCompletedList is not None:
            ...
            for iter232 in self.pipeCompletedList:
                oprot.writeBool(iter232)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.pipeRemainingEventCountList is not None:
            ...
            for iter233 in self.pipeRemainingEventCountList:
        ...
        if self.pipeRemainingTimeList is not None:
            ...
            for iter234 in self.pipeRemainingTimeList:
                oprot.writeDouble(iter234)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.dataRegionRawDataSize is not None:
            oprot.writeFieldBegin('dataRegionRawDataSize', TType.MAP, 17)
            oprot.writeMapBegin(TType.I32, TType.I64, len(self.dataRegionRawDataSize))
            for kiter235, viter236 in self.dataRegionRawDataSize.items():
...
class TRegionRouteReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i241 in range(_size237):
                        _key242 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _key242.read(iprot)
                        _val243 = iotdb.thrift.common.ttypes.TRegionReplicaSet()
                        _val243.read(iprot)
                        self.regionRouteMap[_key242] = _val243
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.regionRouteMap is not None:
            ...
            for kiter244, viter245 in self.regionRouteMap.items():
                kiter244.write(oprot)
...
class TDeleteColumnDataReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i250 in range(_size246):
                        _elem251 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem251.read(iprot)
                        self.regionIdList.append(_elem251)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.regionIdList is not None:
            ...
            for iter252 in self.regionIdList:
                iter252.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.tableName is not None:
...
class TDeleteDataOrDevicesForDropTableReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i257 in range(_size253):
                        _elem258 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem258.read(iprot)
                        self.regionIdList.append(_elem258)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.regionIdList is not None:
            oprot.writeFieldBegin('regionIdList', TType.LIST, 1)
            oprot.writeListBegin(TType.STRUCT, len(self.regionIdList))
            for iter259 in self.regionIdList:
                iter259.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.tableName is not None:
...
class TTableDeviceDeletionWithPatternAndFilterReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i264 in range(_size260):
                        _elem265 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem265.read(iprot)
                        self.schemaRegionIdList.append(_elem265)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.schemaRegionIdList is not None:
            ...
            for iter266 in self.schemaRegionIdList:
                iter266.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.tableName is not None:
...
class TTableDeviceDeletionWithPatternOrModReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i271 in range(_size267):
                        _elem272 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem272.read(iprot)
                        self.regionIdList.append(_elem272)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.regionIdList is not None:
            oprot.writeFieldBegin('regionIdList', TType.LIST, 1)
            oprot.writeListBegin(TType.STRUCT, len(self.regionIdList))
            for iter273 in self.regionIdList:
                iter273.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.tableName is not None:
...
class TLoadCommandReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i278 in range(_size274):
                        _key279 = iotdb.thrift.common.ttypes.TTimePartitionSlot()
                        _key279.read(iprot)
                        _val280 = iprot.readBinary()
                        self.timePartition2ProgressIndex[_key279] = _val280
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.timePartition2ProgressIndex is not None:
            ...
            for kiter281, viter282 in self.timePartition2ProgressIndex.items():
                kiter281.write(oprot)
                oprot.writeBinary(viter282)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TAttributeUpdateReq(object):
            ...
            if fid == 1:
                if ftype == TType.MAP:
                    ...
                    for _i287 in range(_size283):
                        ...
                        _val289 = TSchemaRegionAttributeInfo()
                        _val289.read(iprot)
                        self.attributeUpdateMap[_key288] = _val289
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.attributeUpdateMap is not None:
            ...
            for kiter290, viter291 in self.attributeUpdateMap.items():
...
class TDeviceViewReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i296 in range(_size292):
                        _elem297 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem297.read(iprot)
                        self.regionIds.append(_elem297)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.LIST:
                    ...
                    for _i302 in range(_size298):
                        ...
                        self.prefixPattern.append(_elem303)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                ...
                if ftype == TType.SET:
                    ...
                    for _i308 in range(_size304):
                        ...
                        self.requiredMeasurements.add(_elem309)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.prefixPattern is not None:
            ...
            for iter311 in self.prefixPattern:
        ...
        if self.requiredMeasurements is not None:
            ...
            for iter312 in self.requiredMeasurements:
...
class TDeviceViewResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i317 in range(_size313):
                        ...
                        self.deviewViewFieldTypeMap[_key318] = _val319
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.deviewViewFieldTypeMap is not None:
            ...
            for kiter320, viter321 in self.deviewViewFieldTypeMap.items():
                oprot.writeString(kiter320.encode('utf-8') if sys.version_info[0] == 2 else kiter320)
                oprot.writeByte(viter321)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TConstructSchemaBlackListReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i326 in range(_size322):
                        _elem327 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem327.read(iprot)
                        self.schemaRegionIdList.append(_elem327)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.schemaRegionIdList is not None:
            oprot.writeFieldBegin('schemaRegionIdList', TType.LIST, 1)
            oprot.writeListBegin(TType.STRUCT, len(self.schemaRegionIdList))
            for iter328 in self.schemaRegionIdList:
                iter328.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
class TRollbackSchemaBlackListReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i333 in range(_size329):
                        _elem334 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem334.read(iprot)
                        self.schemaRegionIdList.append(_elem334)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.schemaRegionIdList is not None:
            oprot.writeFieldBegin('schemaRegionIdList', TType.LIST, 1)
            oprot.writeListBegin(TType.STRUCT, len(self.schemaRegionIdList))
            for iter335 in self.schemaRegionIdList:
                iter335.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.pathPatternTree is not None:
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i340 in range(_size336):
                        _elem341 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem341.read(iprot)
                        self.schemaRegionIdList.append(_elem341)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
...
class TDeleteDataForDeleteSchemaReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i347 in range(_size343):
                        _elem348 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem348.read(iprot)
                        self.dataRegionIdList.append(_elem348)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.dataRegionIdList is not None:
            ...
            for iter349 in self.dataRegionIdList:
                iter349.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.pathPatternTree is not None:
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i354 in range(_size350):
                        _elem355 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem355.read(iprot)
                        self.schemaRegionIdList.append(_elem355)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
...
class TConstructSchemaBlackListWithTemplateReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i361 in range(_size357):
                        _elem362 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem362.read(iprot)
                        self.schemaRegionIdList.append(_elem362)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.MAP:
                    ...
                    for _i367 in range(_size363):
                        ...
                        iprot.readListEnd()
                        self.templateSetInfo[_key368] = _val369
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.schemaRegionIdList is not None:
            oprot.writeFieldBegin('schemaRegionIdList', TType.LIST, 1)
            oprot.writeListBegin(TType.STRUCT, len(self.schemaRegionIdList))
            for iter376 in self.schemaRegionIdList:
                iter376.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.templateSetInfo is not None:
            ...
            for kiter377, viter378 in self.templateSetInfo.items():
                oprot.writeString(kiter377.encode('utf-8') if sys.version_info[0] == 2 else kiter377)
                oprot.writeListBegin(TType.I32, len(viter378))
...
class TRollbackSchemaBlackListWithTemplateReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i384 in range(_size380):
                        _elem385 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem385.read(iprot)
                        self.schemaRegionIdList.append(_elem385)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.MAP:
                    ...
                    for _i390 in range(_size386):
                        ...
                        iprot.readListEnd()
                        self.templateSetInfo[_key391] = _val392
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.schemaRegionIdList is not None:
            oprot.writeFieldBegin('schemaRegionIdList', TType.LIST, 1)
            oprot.writeListBegin(TType.STRUCT, len(self.schemaRegionIdList))
            for iter399 in self.schemaRegionIdList:
                iter399.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.templateSetInfo is not None:
            oprot.writeFieldBegin('templateSetInfo', TType.MAP, 2)
            oprot.writeMapBegin(TType.STRING, TType.LIST, len(self.templateSetInfo))
            for kiter400, viter401 in self.templateSetInfo.items():
                oprot.writeString(kiter400.encode('utf-8') if sys.version_info[0] == 2 else kiter400)
                oprot.writeListBegin(TType.I32, len(viter401))
...
class TDeactivateTemplateReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i407 in range(_size403):
                        _elem408 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem408.read(iprot)
                        self.schemaRegionIdList.append(_elem408)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.MAP:
                    ...
                    for _i413 in range(_size409):
                        ...
                        for _i420 in range(_size416):
                            _elem421 = iprot.readI32()
                            _val415.append(_elem421)
                        iprot.readListEnd()
                        self.templateSetInfo[_key414] = _val415
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.schemaRegionIdList is not None:
            oprot.writeFieldBegin('schemaRegionIdList', TType.LIST, 1)
            oprot.writeListBegin(TType.STRUCT, len(self.schemaRegionIdList))
            for iter422 in self.schemaRegionIdList:
                iter422.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.templateSetInfo is not None:
            oprot.writeFieldBegin('templateSetInfo', TType.MAP, 2)
            oprot.writeMapBegin(TType.STRING, TType.LIST, len(self.templateSetInfo))
            for kiter423, viter424 in self.templateSetInfo.items():
                oprot.writeString(kiter423.encode('utf-8') if sys.version_info[0] == 2 else kiter423)
                oprot.writeListBegin(TType.I32, len(viter424))
                for iter425 in viter424:
                    oprot.writeI32(iter425)
                oprot.writeListEnd()
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.isGeneratedByPipe is not None:
...
class TCountPathsUsingTemplateReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i430 in range(_size426):
                        _elem431 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem431.read(iprot)
                        self.schemaRegionIdList.append(_elem431)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.schemaRegionIdList is not None:
            ...
            oprot.writeListBegin(TType.STRUCT, len(self.schemaRegionIdList))
            for iter432 in self.schemaRegionIdList:
                iter432.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TCheckSchemaRegionUsingTemplateReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i437 in range(_size433):
                        _elem438 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem438.read(iprot)
                        self.schemaRegionIdList.append(_elem438)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.schemaRegionIdList is not None:
            oprot.writeFieldBegin('schemaRegionIdList', TType.LIST, 1)
            oprot.writeListBegin(TType.STRUCT, len(self.schemaRegionIdList))
            for iter439 in self.schemaRegionIdList:
                iter439.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TCheckTimeSeriesExistenceReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i444 in range(_size440):
                        _elem445 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem445.read(iprot)
                        self.schemaRegionIdList.append(_elem445)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.schemaRegionIdList is not None:
            ...
            oprot.writeListBegin(TType.STRUCT, len(self.schemaRegionIdList))
            for iter446 in self.schemaRegionIdList:
                iter446.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i451 in range(_size447):
                        ...
                        self.pipeMetas.append(_elem452)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class TPushPipeMetaResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i458 in range(_size454):
                        _elem459 = TPushPipeMetaRespExceptionMessage()
                        _elem459.read(iprot)
                        self.exceptionMessages.append(_elem459)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.exceptionMessages is not None:
            ...
            for iter460 in self.exceptionMessages:
                iter460.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TPushMultiPipeMetaReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i465 in range(_size461):
                        ...
                        self.pipeMetas.append(_elem466)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.LIST:
                    ...
                    for _i471 in range(_size467):
                        ...
                        self.pipeNamesToDrop.append(_elem472)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.pipeMetas is not None:
            oprot.writeFieldBegin('pipeMetas', TType.LIST, 1)
            oprot.writeListBegin(TType.STRING, len(self.pipeMetas))
            for iter473 in self.pipeMetas:
                oprot.writeBinary(iter473)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.pipeNamesToDrop is not None:
            ...
            for iter474 in self.pipeNamesToDrop:
...
class TPushTopicMetaReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i479 in range(_size475):
                        ...
                        self.topicMetas.append(_elem480)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.topicMetas is not None:
            ...
            for iter481 in self.topicMetas:
                oprot.writeBinary(iter481)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TPushMultiTopicMetaReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i486 in range(_size482):
                        ...
                        self.topicMetas.append(_elem487)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.LIST:
                    ...
                    for _i492 in range(_size488):
                        ...
                        self.topicNamesToDrop.append(_elem493)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.topicMetas is not None:
            oprot.writeFieldBegin('topicMetas', TType.LIST, 1)
            oprot.writeListBegin(TType.STRING, len(self.topicMetas))
            for iter494 in self.topicMetas:
                oprot.writeBinary(iter494)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.topicNamesToDrop is not None:
            ...
            for iter495 in self.topicNamesToDrop:
                oprot.writeString(iter495.encode('utf-8') if sys.version_info[0] == 2 else iter495)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TPushTopicMetaResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i500 in range(_size496):
                        _elem501 = TPushTopicMetaRespExceptionMessage()
                        _elem501.read(iprot)
                        self.exceptionMessages.append(_elem501)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.exceptionMessages is not None:
            oprot.writeFieldBegin('exceptionMessages', TType.LIST, 2)
            oprot.writeListBegin(TType.STRUCT, len(self.exceptionMessages))
            for iter502 in self.exceptionMessages:
                iter502.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TPushConsumerGroupMetaReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i507 in range(_size503):
                        ...
                        self.consumerGroupMetas.append(_elem508)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.consumerGroupMetas is not None:
            ...
            for iter509 in self.consumerGroupMetas:
                oprot.writeBinary(iter509)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TPushConsumerGroupMetaResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i514 in range(_size510):
                        _elem515 = TPushConsumerGroupMetaRespExceptionMessage()
                        _elem515.read(iprot)
                        self.exceptionMessages.append(_elem515)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.exceptionMessages is not None:
            oprot.writeFieldBegin('exceptionMessages', TType.LIST, 2)
            oprot.writeListBegin(TType.STRUCT, len(self.exceptionMessages))
            for iter516 in self.exceptionMessages:
                iter516.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TConstructViewSchemaBlackListReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i521 in range(_size517):
                        _elem522 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem522.read(iprot)
                        self.schemaRegionIdList.append(_elem522)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.schemaRegionIdList is not None:
            oprot.writeFieldBegin('schemaRegionIdList', TType.LIST, 1)
            oprot.writeListBegin(TType.STRUCT, len(self.schemaRegionIdList))
            for iter523 in self.schemaRegionIdList:
                iter523.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.pathPatternTree is not None:
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i528 in range(_size524):
                        _elem529 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem529.read(iprot)
                        self.schemaRegionIdList.append(_elem529)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
...
class TDeleteViewSchemaReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i535 in range(_size531):
                        _elem536 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem536.read(iprot)
                        self.schemaRegionIdList.append(_elem536)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.schemaRegionIdList is not None:
            oprot.writeFieldBegin('schemaRegionIdList', TType.LIST, 1)
            oprot.writeListBegin(TType.STRUCT, len(self.schemaRegionIdList))
            for iter537 in self.schemaRegionIdList:
                iter537.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.pathPatternTree is not None:
...
class TAlterViewReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i542 in range(_size538):
                        _elem543 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem543.read(iprot)
                        self.schemaRegionIdList.append(_elem543)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.LIST:
                    ...
                    for _i548 in range(_size544):
                        ...
                        self.viewBinaryList.append(_elem549)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.schemaRegionIdList is not None:
            oprot.writeFieldBegin('schemaRegionIdList', TType.LIST, 1)
            oprot.writeListBegin(TType.STRUCT, len(self.schemaRegionIdList))
            for iter550 in self.schemaRegionIdList:
                iter550.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.viewBinaryList is not None:
            ...
            for iter551 in self.viewBinaryList:
...
class TFetchMoreDataResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i556 in range(_size552):
                        _elem557 = iprot.readBinary()
                        self.tsDataset.append(_elem557)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.tsDataset is not None:
            ...
            for iter558 in self.tsDataset:
                oprot.writeBinary(iter558)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
class TFetchTimeseriesResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i563 in range(_size559):
                        _elem564 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.columnNameList.append(_elem564)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.LIST:
                    ...
                    for _i569 in range(_size565):
                        _elem570 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.columnTypeList.append(_elem570)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.MAP:
                    ...
                    for _i575 in range(_size571):
                        _key576 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val577 = iprot.readI32()
                        self.columnNameIndexMap[_key576] = _val577
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
                if ftype == TType.LIST:
                    ...
                    for _i582 in range(_size578):
                        ...
                        self.tsDataset.append(_elem583)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
    ...
    def write(self, oprot):
        ...
        if self.columnNameList is not None:
            ...
            for iter584 in self.columnNameList:
        ...
        if self.columnTypeList is not None:
            ...
            for iter585 in self.columnTypeList:
                oprot.writeString(iter585.encode('utf-8') if sys.version_info[0] == 2 else iter585)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.columnNameIndexMap is not None:
            ...
            for kiter586, viter587 in self.columnNameIndexMap.items():
                oprot.writeString(kiter586.encode('utf-8') if sys.version_info[0] == 2 else kiter586)
                oprot.writeI32(viter587)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.tsDataset is not None:
            oprot.writeFieldBegin('tsDataset', TType.LIST, 6)
            oprot.writeListBegin(TType.STRING, len(self.tsDataset))
            for iter588 in self.tsDataset:
                oprot.writeBinary(iter588)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.hasMoreData is not None:
...
class TOperatorStatistics(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i593 in range(_size589):
                        ...
                        _val595 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.specifiedInfo[_key594] = _val595
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
    ...
    def write(self, oprot):
        ...
        if self.specifiedInfo is not None:
            ...
            for kiter596, viter597 in self.specifiedInfo.items():
...
class TFetchFragmentInstanceStatisticsResp(object):
    ...
    def __init__(self, status=None, fragmentInstanceId=None, dataRegion=None, startTimeInMS=None, endTimeInMS=None, queryStatistics=None, operatorStatisticsMap=None, initDataQuerySourceCost=None, seqUnclosedNum=None, seqClosednNum=None, unseqClosedNum=None, unseqUnclosedNum=None, readyQueuedTime=None, blockQueuedTime=None, ip=None, state=None, initDataQuerySourceRetryCount=None,):
        ...
        self.ip = ip
        self.state = state
        self.initDataQuerySourceRetryCount = initDataQuerySourceRetryCount
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i602 in range(_size598):
                        ...
                        _val604 = TOperatorStatistics()
                        _val604.read(iprot)
                        self.operatorStatisticsMap[_key603] = _val604
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
                ...
                if ftype == TType.I32:
                    self.initDataQuerySourceRetryCount = iprot.readI32()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.operatorStatisticsMap is not None:
            ...
            for kiter605, viter606 in self.operatorStatisticsMap.items():
        ...
        if self.state is not None:
            ...
            oprot.writeString(self.state.encode('utf-8') if sys.version_info[0] == 2 else self.state)
            oprot.writeFieldEnd()
        if self.initDataQuerySourceRetryCount is not None:
            oprot.writeFieldBegin('initDataQuerySourceRetryCount', TType.I32, 17)
            oprot.writeI32(self.initDataQuerySourceRetryCount)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
TDataNodeHeartbeatResp.thrift_spec = (
    ...
    (17, TType.MAP, 'dataRegionRawDataSize', (TType.I32, None, TType.I64, None, False), None, ),  # 17
)
