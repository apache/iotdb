...
def main(argv: List[str] = None) -> int:
    ...
    model_group.add_argument("--seq-len", type=int, default=1440)
    ...
    optim_group.add_argument("--num-train-epochs", type=int, default=10)
    optim_group.add_argument("--train-batch-size", type=int, default=32)
    optim_group.add_argument("--val-batch-size", type=int, default=32)
    ...
    optim_group.add_argument("--save-steps", type=int, default=500)
    optim_group.add_argument("--logging-steps", type=int, default=100)
...
if __name__ == "__main__":
    ...
    path = "/root/gxh/other_framework/fine_tune/timechodb/iotdb-core/ainode/data/ainode/models/fine_tuned/sundial_air"
