...
def get_weaver(config: WeaverConfig) -> BaseFeatureWeaver:
    ...
    """
    from timecho.ainode.core.finetune.adapter.weaver.weaver_cnn import WeaverCNN
    from timecho.ainode.core.finetune.adapter.weaver.weaver_mlp import WeaverMLP
