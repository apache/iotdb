...
from timecho.ainode.core.data_provider.datasets.csv_dataset import (
    CSVDataset,
    ParquetDataset,
)
from timecho.ainode.core.data_provider.datasets.iotdb_dataset import (
    IoTDBTableModelDataset,
    IoTDBTreeModelDataset,
)
from timecho.ainode.core.data_provider.datasets.tsfile_dataset import TsFileDataset
from timecho.ainode.core.hparams.data_args import DataArguments
...
def create_dataset(
    ...
    common_kwargs = dict(
        ...
        output_token_len=model_args.output_token_len,
    ...
    if dataset_type == "iotdb.table":
        dataset = IoTDBTableModelDataset(
            data_schema_list=data_args.data_schema_list,
            aggregation_interval=data_args.aggregation_interval,
            multivariate=data_args.multivariate,
            train_ratio=data_args.train_ratio,
            **common_kwargs,
        )

    elif dataset_type == "iotdb.tree":
        dataset = IoTDBTreeModelDataset(
            data_schema_list=data_args.data_schema_list,
            **common_kwargs,
        )
        ...
        dataset = TsFileDataset(
            ...
            preload=data_args.tsfile_preload,
            train_ratio=data_args.train_ratio,
            **common_kwargs,
        )
