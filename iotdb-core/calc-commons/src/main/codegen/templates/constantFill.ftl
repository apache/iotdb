...
<#list allDataTypes.types as type>
  ...
  <@pp.changeOutputFile name="/org/apache/iotdb/calc_commons/execution/operator/process/fill/constant/${className}.java" />
package org.apache.iotdb.calc_commons.execution.operator.process.fill.constant;
