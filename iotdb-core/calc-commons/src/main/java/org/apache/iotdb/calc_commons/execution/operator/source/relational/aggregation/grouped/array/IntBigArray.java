...
package org.apache.iotdb.calc_commons.execution.operator.source.relational.aggregation.grouped.array;
...
import static org.apache.iotdb.calc_commons.execution.operator.source.relational.aggregation.grouped.array.BigArrays.SEGMENT_SIZE;
import static org.apache.iotdb.calc_commons.execution.operator.source.relational.aggregation.grouped.array.BigArrays.offset;
import static org.apache.iotdb.calc_commons.execution.operator.source.relational.aggregation.grouped.array.BigArrays.segment;
...
public final class IntBigArray {
  private static final long INSTANCE_SIZE = shallowSizeOfInstance(IntBigArray.class);
   ...
   */
  public void copyTo(
      long sourceIndex, IntBigArray destination, long destinationIndex, long length) {
    while (length > 0) {
