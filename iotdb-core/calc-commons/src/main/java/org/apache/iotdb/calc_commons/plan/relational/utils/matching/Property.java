 ...
 * under the License.
 */
package org.apache.iotdb.calc_commons.plan.relational.utils.matching;

import org.apache.iotdb.calc_commons.plan.relational.utils.matching.pattern.EqualsPattern;
import org.apache.iotdb.calc_commons.plan.relational.utils.matching.pattern.FilterPattern;
...
public class Property<F, C, T> {
  ...
  public static <F, C, T> Property<F, C, T> property(String name, BiFunction<F, C, T> function) {
    return optionalProperty(
        name, (source, context) -> Optional.of(function.apply(source, context)));
  }

  public static <F, C, T> Property<F, C, T> optionalProperty(
      String name, Function<F, Optional<T>> function) {
    return new Property<>(name, (source, context) -> function.apply(source));
  }

  public static <F, C, T> Property<F, C, T> optionalProperty(
      String name, BiFunction<F, C, Optional<T>> function) {
