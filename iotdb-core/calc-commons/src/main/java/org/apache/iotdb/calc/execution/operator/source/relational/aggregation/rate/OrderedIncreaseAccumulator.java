...
public final class OrderedIncreaseAccumulator extends AbstractIncreaseTableAccumulator {

  private static final long INSTANCE_SIZE =
      RamUsageEstimator.shallowSizeOfInstance(OrderedIncreaseAccumulator.class);
  ...
  public OrderedIncreaseAccumulator(TSDataType valueDataType) {
    super(valueDataType);
  }
  ...
  public TableAccumulator copy() {
    return new OrderedIncreaseAccumulator(valueDataType);
  }
  ...
  public void evaluateFinal(ColumnBuilder output) {
    ...
    output.writeDouble(
        calculateIncrease(sampleCount, firstTime, firstValue, lastTime, correctedIncrease));
  }
