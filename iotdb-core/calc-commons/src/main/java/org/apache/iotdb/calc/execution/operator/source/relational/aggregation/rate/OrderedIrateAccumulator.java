...
public final class OrderedIrateAccumulator extends AbstractIrateTableAccumulator {
  ...
  private static final long INSTANCE_SIZE =
      RamUsageEstimator.shallowSizeOfInstance(OrderedIrateAccumulator.class);
  ...
  public OrderedIrateAccumulator(TSDataType valueDataType) {
    super(valueDataType);
  }
  ...
  public TableAccumulator copy() {
    return new OrderedIrateAccumulator(valueDataType);
  }
  ...
  public void evaluateFinal(ColumnBuilder output) {
    ...
    output.writeDouble(calculateIrate(previousTime, previousValue, lastTime, lastValue));
  }
