...
public final class GroupedOrderedRateAccumulator extends AbstractGroupedRateAccumulator {

  private static final long INSTANCE_SIZE =
      RamUsageEstimator.shallowSizeOfInstance(GroupedOrderedRateAccumulator.class);
  ...
  public GroupedOrderedRateAccumulator(TSDataType valueDataType) {
    super(valueDataType);
  }
