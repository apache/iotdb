...
public class AscIntTypeJoinKeyComparator implements JoinKeyComparator {
  ...
  private static final AscIntTypeJoinKeyComparator INSTANCE = new AscIntTypeJoinKeyComparator();

  private AscIntTypeJoinKeyComparator() {
    // hide constructor
  }

  public static AscIntTypeJoinKeyComparator getInstance() {
    return INSTANCE;
  }
