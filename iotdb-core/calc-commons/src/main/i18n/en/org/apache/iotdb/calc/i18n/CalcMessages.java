...
public final class CalcMessages {
  ...
  public static final String CANT_HAPPEN_LOOP_FELL_THROUGH = "Can't happen ... loop fell through";
  ...
  public static final String UNEXPECTED_VALUE_FOR_SEQUENCES = "Unexpected value for sequences: ";
  ...
  public static final String UNSUPPORTED_ARITHMETIC_OPERATOR = "Unsupported arithmetic operator: ";
  ...
  public static final String UNSUPPORTED_COMPARISON_OPERATOR = "Unsupported comparison operator: ";
  ...
  public static final String PUSHED_ELEMENT_IS_NULL = "pushed element is null";
  ...
  public static final String EXCEPTION_READ_OBJECT_SIZE_ARG_TOO_LARGE_SIZE_2G_FILE_PATH_7D4A4D10 =
      "Read object size %s is too large (size > 2G), file path is %s";
  public static final String LOG_FAILED_CLOSE_FILE_METHOD_DEREGISTER_ARG_BECAUSE_ARG_1744AC60 =
      "Failed to close file in method deregister(%s), because %s";
  public static final String LOG_FAILED_CLEAN_DIR_METHOD_DEREGISTER_ARG_BECAUSE_ARG_F53193E5 =
      "Failed to clean dir in method deregister(%s), because %s";
  public static final String EXCEPTION_TYPE_ACCUMULATOR_DOES_NOT_SUPPORT_REMOVE_INPUT_905AFAA1 =
      "This type of accumulator does not support remove input!";
  public static final String EXCEPTION_UNSUPPORTED_DATA_TYPE_AGGREGATION_VARIANCE_ARG_17A45959 =
      "Unsupported data type in aggregation variance : %s";
  public static final String EXCEPTION_UNSUPPORTED_DATA_TYPE_CENTRALMOMENT_AGGREGATION_0A19C2A8 =
      "Unsupported data type in CentralMoment Aggregation: ";
  public static final String EXCEPTION_UNKNOWN_FUNCTION_ARG_NODE_ARG_927DA6A7 =
  ...
  public static final String
      EXCEPTION_INLIST_LITERAL_TIMESTAMP_CAN_ONLY_LONGLITERAL_DOUBLELITERAL_GENERICLITERAL_CURRENT_A3105E67 =
          "InList Literal for TIMESTAMP can only be LongLiteral, DoubleLiteral and GenericLiteral,"
              + " current is ";
  public static final String EXCEPTION_PARTITION_HANDLER_FINISHED_CANNOT_ADD_MORE_DATA_D8E31A3E =
  ...
  public static final String EXCEPTION_AGGREGATE_FUNCTION_ARG_DOES_NOT_SUPPORT_COPYING_3E03976C =
      "aggregate function %s does not support copying";
  public static final String EXCEPTION_UNSUPPORTED_BUILT_WINDOW_FUNCTION_NAME_F994ED27 =
      "Unsupported built-in window function name: ";
  public static final String EXCEPTION_UNSUPPORTED_DEFAULT_VALUE_S_DATA_TYPE_LAG_BEB00511 =
      "Unsupported default value's data type in Lag: ";
  public static final String EXCEPTION_CANNOT_COMPARE_VALUES_DIFFERENT_TYPES_A95EDA7F =
      "Cannot compare values of different types: ";
  public static final String EXCEPTION_VS_AEDAB253 = " vs. ";
  public static final String EXCEPTION_TARGET_TYPE_NOT_GENERICDATATYPE_CB87EF37 =
      "Target type is not a GenericDataType: ";
  public static final String EXCEPTION_UNSUPPORTED_EXPRESSION_TYPE_5C50C92E =
  ...
  public static final String EXCEPTION_UNSUPPORTED_DATA_TYPE_LAST_ARG_37F52124 =
      "Unsupported data type in LAST: %s";
  public static final String EXCEPTION_UNSUPPORTED_DATA_TYPE_LAST_AGGREGATION_ARG_2FCF5ADA =
      "Unsupported data type in LAST Aggregation: %s";
  public static final String EXCEPTION_UNSUPPORTED_DATA_TYPE_LAST_AGGREGATION_ARG_B3F2EE42 =
      "Unsupported data type in LAST aggregation: %s";
  public static final String EXCEPTION_SIZE_CHILDRENCOLUMNS_DATATYPES_SHOULD_SAME_6EA43EA8 =
      "The size of childrenColumns and dataTypes should be the same.";
  public static final String EXCEPTION_UNSUPPORTED_DATA_TYPE_FIRST_AGGREGATION_ARG_8D31C6CA =
  ...
  public static final String EXCEPTION_NO_EXACT_DOUBLE_REPRESENTATION_LONG_ARG_3E5B7550 =
      "no exact double representation for long: %s";
  public static final String EXCEPTION_UNSUPPORTED_DATA_TYPE_COVARIANCE_AGGREGATION_ARG_643BEDD0 =
      "Unsupported data type in Covariance Aggregation: %s";
  public static final String EXCEPTION_UNSUPPORTED_DATA_TYPE_LAST_AGGREGATION_ARG_8C41FBCC =
  ...
  public static final String EXCEPTION_UNSUPPORTED_DATA_TYPE_AGGREGATION_AVG_ARG_4E63A3C3 =
      "Unsupported data type in aggregation AVG : %s";
  public static final String EXCEPTION_UNSUPPORTED_DATA_TYPE_CORRELATION_AGGREGATION_ARG_2FF29597 =
      "Unsupported data type in Correlation Aggregation: %s";
  public static final String EXCEPTION_UNSUPPORTED_DATA_TYPE_FIRST_ARG_D5B6C6F9 =
      "Unsupported data type in FIRST: %s";
  public static final String EXCEPTION_UNSUPPORTED_DATA_TYPE_FIRST_AGGREGATION_ARG_B2D27BB9 =
      "Unsupported data type in FIRST Aggregation: %s";
  public static final String EXCEPTION_UNSUPPORTED_DATA_TYPE_FIRST_AGGREGATION_ARG_2652C363 =
      "Unsupported data type in FIRST aggregation: %s";
  public static final String EXCEPTION_UNSUPPORTED_DATA_TYPE_VARIANCE_AGGREGATION_ARG_C641D425 =
      "Unsupported data type in VARIANCE Aggregation: %s";
  public static final String EXCEPTION_UNSUPPORTED_DATA_TYPE_ARG_7D59F7B2 =
  ...
  public static final String EXCEPTION_UNSUPPORTED_DATA_TYPE_MAX_AGGREGATION_ARG_CCB09C60 =
      "Unsupported data type in MAX Aggregation: %s";
  public static final String EXCEPTION_UNSUPPORTED_DATA_TYPE_SUM_AGGREGATION_ARG_92F5A18D =
  ...
  public static final String
      EXCEPTION_APPROXMOSTFREQUENTACCUMULATOR_DOES_NOT_SUPPORT_STATISTICS_DB1E218B =
          "ApproxMostFrequentAccumulator does not support statistics";
  public static final String EXCEPTION_DISTINCT_AGGREGATION_FUNCTION_STATE_CAN_NOT_COPIED_34D0A276 =
      "Distinct aggregation function state can not be copied";
  public static final String EXCEPTION_UNSUPPORTED_DATA_TYPE_REGRESSION_AGGREGATION_ARG_7BB08DA2 =
      "Unsupported data type in Regression Aggregation: %s";
  public static final String EXCEPTION_UNSUPPORTED_DATA_TYPE_MIN_AGGREGATION_ARG_CB73B158 =
      "Unsupported data type in MIN Aggregation: %s";
  public static final String EXCEPTION_INVALID_FORMAT_SERIALIZED_HISTOGRAM_GOT_ENCODING_A8E50EA5 =
      "Invalid format for serialized histogram, got encoding: ";
  public static final String EXCEPTION_MAX_STANDARD_ERROR_MUST_ARG_ARG_ARG_EB8443D6 =
      "Max Standard Error must be in [%s, %s]: %s";
  public static final String
      EXCEPTION_CANNOT_MERGE_HYPERLOGLOG_INSTANCES_DIFFERENT_PRECISION_9DCF13BC =
  ...
  public static final String EXCEPTION_UNSUPPORTED_DATA_TYPE_MAX_MIN_AGGREGATION_ARG_982BEBD5 =
      "Unsupported data type in MAX_BY/MIN_BY Aggregation: %s";
  public static final String EXCEPTION_UNSUPPORTED_DATA_TYPE_EXTREME_AGGREGATION_ARG_AF4DA98F =
      "Unsupported data type EXTREME Aggregation: %s";
  public static final String EXCEPTION_UNSUPPORTED_DATA_TYPE_EXTREME_AGGREGATION_ARG_276BE220 =
      "Unsupported data type in EXTREME Aggregation: %s";
  public static final String EXCEPTION_UNSUPPORTED_DATA_TYPE_AVG_AGGREGATION_ARG_66BF3128 =
      "Unsupported data type in AVG Aggregation: %s";
  public static final String EXCEPTION_CAN_T_READ_NEW_TSBLOCK_FILESPILLERREADER_072AF71D =
      "Can't read a new tsBlock in FileSpillerReader: ";
  public static final String EXCEPTION_CAN_T_CLOSE_FILECHANNEL_FILESPILLERREADER_E46979F0 =
      "Can't close fileChannel in FileSpillerReader: ";
  public static final String EXCEPTION_CREATE_FILE_ERROR_B8B379CF = "Create file error: ";
  public static final String EXCEPTION_CAN_T_WRITE_INTERMEDIATE_SORTED_DATA_FILE_0027961E =
      "Can't write intermediate sorted data to file: ";
  public static final String
  ...
  public static final String EXCEPTION_LONG_VALUE_ARG_OUT_RANGE_INTEGER_VALUE_B3F9016B =
      "long value %d is out of range of integer value.";
  public static final String EXCEPTION_FLOAT_VALUE_ARG_OUT_RANGE_INTEGER_VALUE_B0E6DDED =
      "Float value %f is out of range of integer value.";
  public static final String EXCEPTION_FLOAT_VALUE_ARG_OUT_RANGE_LONG_VALUE_62F8153E =
      "Float value %f is out of range of long value.";
  public static final String EXCEPTION_DOUBLE_VALUE_ARG_OUT_RANGE_INTEGER_VALUE_BAB52E11 =
      "Double value %f is out of range of integer value.";
  public static final String EXCEPTION_DOUBLE_VALUE_ARG_OUT_RANGE_LONG_VALUE_5793A91E =
      "Double value %f is out of range of long value.";
  public static final String EXCEPTION_DOUBLE_VALUE_ARG_OUT_RANGE_FLOAT_VALUE_DB914FA0 =
      "Double value %f is out of range of float value.";
  public static final String EXCEPTION_TEXT_VALUE_ARG_OUT_RANGE_FLOAT_VALUE_D171B313 =
      "Text value %s is out of range of float value.";
  public static final String EXCEPTION_TEXT_VALUE_ARG_OUT_RANGE_DOUBLE_VALUE_C0589D83 =
      "Text value %s is out of range of double value.";
  public static final String EXCEPTION_UNSUPPORTED_SOURCE_DATATYPE_ARG_678B759C =
      "Unsupported source dataType: %s";
  public static final String EXCEPTION_CANNOT_CAST_ARG_ARG_TYPE_8266A2C6 =
      "Cannot cast %s to %s type";
  public static final String
  ...
  public static final String
      EXCEPTION_FAILED_EXECUTE_FUNCTION_HMAC_SHA512_INVALID_INPUT_FORMAT_EMPTY_KEY_3671AF09 =
          "Failed to execute function hmac_sha512 due to an invalid input format, the empty key is not"
              + " allowed in HMAC operation.";
  public static final String EXCEPTION_INVALID_FORMAT_STRING_ARG_ARG_05853138 =
      "Invalid format string: %s (%s)";
  public static final String EXCEPTION_YEAR_MUST_BETWEEN_1000_9999_8FBB94AA =
  ...
  public static final String EXCEPTION_NOT_SUPPORTED_GENERATEPROBLEMATICVALUESTRING_624BB179 =
      " is not supported in generateProblematicValueString()";
  public static final String EXCEPTION_BASE64_LENGTH_MUST_MULTIPLE_4_INCLUDING_PADDING_8717829D =
      "Base64 length must be a multiple of 4 (including padding '=')";
  public static final String EXCEPTION_LENGTH_INPUT_BLOB_FUNCTION_BIG_ENDIAN_32_MUST_4_C1214BB5 =
      "The length of the input BLOB of function from_big_endian_32 must be 4.";
  public static final String EXCEPTION_LENGTH_INPUT_BLOB_FUNCTION_BIG_ENDIAN_64_MUST_8_797F1A26 =
      "The length of the input BLOB of function from_big_endian_64 must be 8.";
  public static final String EXCEPTION_LENGTH_INPUT_BLOB_FUNCTION_LITTLE_ENDIAN_32_MUST_4_0FBBD083 =
      "The length of the input BLOB of function from_little_endian_32 must be 4.";
  public static final String EXCEPTION_LENGTH_INPUT_BLOB_FUNCTION_LITTLE_ENDIAN_64_MUST_8_771F7A96 =
  ...
  public static final String EXCEPTION_FOUND_NO_COLUMN_ARG_ARG_8CF632F7 =
      "Found no column %s in %s";
  public static final String
  ...
  public static final String EXCEPTION_JOIN_KEY_TYPE_MISMATCH_LEFT_JOIN_KEY_TYPE_072E692E =
  ...
  public static final String EXCEPTION_COLUMN_ARG_CANNOT_RESOLVED_508579EC =
  ...
  public static final String
      EXCEPTION_TARGET_NODE_INDEX_MUST_BE_GREATER_THAN_OR_EQUAL_TO_ONE_75BFB7C3 =
          "Target node index must be greater than or equal to one";
  public static final String EXCEPTION_ALREADY_AT_TARGET_32DFD57F = "Already at target";
  public static final String EXCEPTION_PARTIALRESULT_OF_COVARIANCE_SHOULD_BE_1_E6A950B1 =
      "partialResult of Covariance should be 1";
  public static final String EXCEPTION_INPUT_OF_COVARIANCE_SHOULD_BE_1_75D3F4FD =
      "Input of Covariance should be 1";
  public static final String
      EXCEPTION_COVARIANCE_STATE_COUNT_IS_SMALLER_THAN_REMOVED_STATE_COUNT_8C088DC6 =
          "Covariance state count is smaller than removed state count";
  public static final String EXCEPTION_PARTIALRESULT_OF_VARIANCE_SHOULD_BE_1_9C281868 =
      "partialResult of variance should be 1";
  public static final String EXCEPTION_INPUT_OF_VARIANCE_SHOULD_BE_1_1BC7A702 =
      "Input of variance should be 1";
  public static final String EXCEPTION_PARTIALRESULT_OF_CENTRALMOMENT_SHOULD_BE_1_B7C0B4B9 =
      "partialResult of CentralMoment should be 1";
  public static final String EXCEPTION_PARTIALRESULT_SHOULD_BE_1_399D5DC3 =
      "partialResult should be 1";
  public static final String EXCEPTION_INPUT_OF_CENTRALMOMENT_SHOULD_BE_1_FD23B170 =
      "Input of CentralMoment should be 1";
  public static final String
      EXCEPTION_CENTRALMOMENT_STATE_COUNT_IS_SMALLER_THAN_REMOVED_STATE_COUNT_B87864BA =
          "CentralMoment state count is smaller than removed state count";
  public static final String EXCEPTION_PARTIALRESULT_OF_CORRELATION_SHOULD_BE_1_D5A8CED6 =
      "partialResult of Correlation should be 1";
  public static final String EXCEPTION_INPUT_OF_CORRELATION_SHOULD_BE_1_5D666DB5 =
      "Input of Correlation should be 1";
  public static final String
      EXCEPTION_CORRELATION_STATE_COUNT_IS_SMALLER_THAN_REMOVED_STATE_COUNT_66C90757 =
          "Correlation state count is smaller than removed state count";
  public static final String EXCEPTION_PARTIALRESULT_OF_REGRESSION_SHOULD_BE_1_B7ED33FA =
      "partialResult of Regression should be 1";
  public static final String EXCEPTION_INPUT_OF_REGRESSION_SHOULD_BE_1_9AF4E8EC =
      "Input of Regression should be 1";
  public static final String
      EXCEPTION_REGRESSION_STATE_COUNT_IS_SMALLER_THAN_REMOVED_STATE_COUNT_4415A3AE =
          "Regression state count is smaller than removed state count";
  public static final String EXCEPTION_INVALID_STARTINGPOSITION_COLON_ARG_7B4D49C0 =
      "invalid startingPosition: %s";
  public static final String EXCEPTION_ROWID_DOES_NOT_MATCH_THIS_TSBLOCK_18F9EB4D =
      "rowId does not match this TsBlock";
  ...
  public static final String
      EXCEPTION_SHOULD_NOT_ATTEMPT_COMPACTION_WHEN_TSBLOCK_IS_LOCKED_DF775E6B =
          "Should not attempt compaction when TsBlock is locked";
  public static final String EXCEPTION_STRATEGY_IS_NULL_DDA2C67F = "strategy is null";
  public static final String EXCEPTION_ROWIDEVICTIONLISTENER_IS_NULL_457EFBEE =
      "rowIdEvictionListener is null";
  public static final String EXCEPTION_TOPN_MUST_BE_GREATER_THAN_ZERO_43866D3E =
      "topN must be greater than zero";
  public static final String EXCEPTION_NO_ROOT_TO_PEEK_43C3D8D5 = "No root to peek";
  public static final String EXCEPTION_GROUP_ID_HAS_AN_EMPTY_HEAP_C9EDB841 =
      "Group ID has an empty heap";
  public static final String
      EXCEPTION_POPANDINSERT_LEFT_PAREN_RIGHT_PAREN_REQUIRES_AT_LEAST_A_ROOT_NODE_0CA0DD58 =
          "popAndInsert() requires at least a root node";
  ...
  public static final String EXCEPTION_LIMIT_MUST_BE_AT_LEAST_ZERO_E960530F =
      "limit must be at least zero";
  public static final String EXCEPTION_OFFSET_MUST_BE_AT_LEAST_ZERO_21BB6BB6 =
      "offset must be at least zero";
  public static final String EXCEPTION_TSBLOCKS_IS_NULL_02287FD8 = "tsBlocks is null";
  public static final String EXCEPTION_FILLARRAY_SHOULD_NOT_BE_NULL_OR_EMPTY_118FB134 =
      "fillArray should not be null or empty";
  public static final String EXCEPTION_UNIQUE_ROW_ID_EXCEEDS_A_LIMIT_COLON_ARG_71EE4B7D =
      "Unique row id exceeds a limit: %s";
  public static final String
  ...
  public static final String EXCEPTION_LOGICALINDEXNAVIGATION_IS_NULL_3B31CD23 =
      "logicalIndexNavigation is null";
  public static final String EXCEPTION_OVERRIDING_AGGREGATIONS_FOR_CHILD_THREAD_9C84E47D =
      "overriding aggregations for child thread";
  public static final String EXCEPTION_SKIP_TO_NAVIGATION_IS_MISSING_FOR_SKIP_TO_ARG_8A303D73 =
  ...
  public static final String EXCEPTION_CURRENT_ROW_IS_OUT_OF_BOUNDS_OF_THE_MATCH_D8D8B611 =
  ...
  public static final String EXCEPTION_PATTERNAGGREGATIONTRACKER_IS_NULL_82EC5B1C =
      "patternAggregationTracker is null";
  public static final String EXCEPTION_PATTERNAGGREGATIONTRACKER_IN_INCONSISTENT_STATE_C6FF5294 =
      "PatternAggregationTracker in inconsistent state";
  public static final String EXCEPTION_SETEVALUATOR_IN_INCONSISTENT_STATE_D5FAA900 =
      "SetEvaluator in inconsistent state";
  public static final String EXCEPTION_ACCUMULATOR_IS_NULL_EF0C1DFF = "accumulator is null";
  public static final String EXCEPTION_INTERMEDIATETYPE_IS_NULL_D0D9B957 =
      "intermediateType is null";
  ...
  public static final String EXCEPTION_USED_SLOTS_COUNT_IS_NEGATIVE_49F017C5 =
      "used slots count is negative";
  public static final String EXCEPTION_USED_SLOTS_COUNT_EXCEEDS_ARRAY_SIZE_6DCD8C7E =
      "used slots count exceeds array size";
  public static final String EXCEPTION_ARRAY_INDEX_OUT_OF_BOUNDS_35C8A83F =
  ...
  public static final String EXCEPTION_INVALID_MIN_VALUE_COLON_ARG_8D899A2E =
      "invalid min value: %s";
  public static final String
      EXCEPTION_INVALID_RANGE_COLON_LEFT_PAREN_ARG_COMMA_ARG_RIGHT_PAREN_EF9544AA =
          "invalid range: (%s, %s)";
  public static final String
  ...
  public static final String EXCEPTION_MARKDISTINCTCHANNELS_IS_NULL_7130C56A =
      "markDistinctChannels is null";
  public static final String
  ...
  public static final String
      EXCEPTION_LENGTH_OF_INPUT_COLUMN_LEFT_BRACKET_RIGHT_BRACKET_FOR_FIRST_BY_SHOULD_BE_3_BE623E5E =
          "Length of input Column[] for FIRST_BY should be 3";
  public static final String
  ...
  public static final String EXCEPTION_INPUT_OF_COVARIANCE_SHOULD_BE_2_786B97E6 =
      "Input of Covariance should be 2";
  public static final String
      EXCEPTION_INTERMEDIATE_INPUT_AND_OUTPUT_SHOULD_BE_BINARYCOLUMN_3B5148FA =
  ...
  public static final String
      EXCEPTION_LENGTH_OF_INPUT_COLUMN_LEFT_BRACKET_RIGHT_BRACKET_FOR_LAST_BY_SHOULD_BE_3_D759D45F =
          "Length of input Column[] for LAST_BY should be 3";
  public static final String
  ...
  public static final String EXCEPTION_ARGUMENT_OF_AVG_SHOULD_BE_ONE_COLUMN_82162B82 =
      "argument of AVG should be one column";
  public static final String
  ...
  public static final String EXCEPTION_INPUT_OF_CORRELATION_SHOULD_BE_2_64BB37B5 =
      "Input of Correlation should be 2";
  public static final String
  ...
  public static final String EXCEPTION_SELECTEDPOSITIONS_IS_NULL_2300C002 =
      "selectedPositions is null";
  public static final String EXCEPTION_RETAINEDPOSITIONS_IS_NULL_E62F9B0D =
      "retainedPositions is null";
  public static final String EXCEPTION_POSITIONCOUNT_IS_NEGATIVE_2FACCDCA =
      "positionCount is negative";
  public static final String EXCEPTION_SELECTEDPOSITIONCOUNT_IS_NEGATIVE_A8A7FDA1 =
      "selectedPositionCount is negative";
  public static final String
  ...
  public static final String
      EXCEPTION_GETSELECTEDPOSITIONS_NOT_AVAILABLE_WHEN_IN_SELECTALL_MODE_CBE671D3 =
          "getSelectedPositions not available when in selectAll mode";
  public static final String EXCEPTION_ARGUMENT_OF_MAX_SHOULD_BE_ONE_COLUMN_FC251F55 =
      "argument of MAX should be one column";
  public static final String EXCEPTION_ARGUMENT_OF_SUM_SHOULD_BE_ONE_COLUMN_D6E636D1 =
      "argument of SUM should be one column";
  public static final String
  ...
  public static final String
      EXCEPTION_ARGUMENT_OF_COUNT_LEFT_PAREN_RIGHT_PAREN_SHOULD_BE_ONE_COLUMN_9158A9FE =
          "argument of COUNT(*) should be one column";
  public static final String EXCEPTION_WRONG_INPUTDATATYPES_SIZE_DOT_675FF289 =
      "Wrong inputDataTypes size.";
  public static final String EXCEPTION_ARGUMENT_OF_COUNT_SHOULD_BE_ONE_COLUMN_906D6B19 =
      "argument of COUNT should be one column";
  public static final String
  ...
  public static final String EXCEPTION_INPUT_OF_REGRESSION_SHOULD_BE_2_3893EEE3 =
      "Input of Regression should be 2";
  public static final String
      EXCEPTION_LENGTH_OF_INPUT_COLUMN_LEFT_BRACKET_RIGHT_BRACKET_FOR_MAX_BY_SLASH_MIN_BY_SHOULD_3767E905 =
          "Length of input Column[] for MAX_BY/MIN_BY should be 2";
  public static final String
  ...
  public static final String EXCEPTION_ARGUMENT_OF_MIN_SHOULD_BE_ONE_COLUMN_F8AA1E88 =
      "argument of MIN should be one column";
  ...
  public static final String
      EXCEPTION_NUMBEROFBUCKETS_MUST_BE_A_POWER_OF_2_COMMA_ACTUAL_COLON_ARG_476E74ED =
  ...
  public static final String
      EXCEPTION_INTERMEDIATE_INPUT_AND_OUTPUT_OF_MODE_SHOULD_BE_BINARYCOLUMN_0D03B323 =
          "intermediate input and output of MODE should be BinaryColumn";
  public static final String EXCEPTION_AGGREGATION_BUFFER_IS_FULL_233DAF3E =
  ...
  public static final String
      EXCEPTION_LENGTH_OF_INPUT_COLUMN_LEFT_BRACKET_RIGHT_BRACKET_FOR_LASTBY_SLASH_FIRSTBY_SHOUL_9E836ABA =
          "Length of input Column[] for LastBy/FirstBy should be 3";
  public static final String EXCEPTION_THE_SIZE_OF_READYQUEUE_CANNOT_BE_NEGATIVE_DOT_01D8D0CB =
      "The size of readyQueue cannot be negative.";
  public static final String
  ...
  public static final String EXCEPTION_EXCEED_MAX_CALL_TIMES_OF_GETCOLUMN_69C77C7E =
      "Exceed max call times of getColumn";
  ...
  public static final String
      EXCEPTION_SOURCE_OF_SEMIJOINNODE_DOESN_QUOTE_T_CONTAIN_SOURCEOUTPUTSYMBOL_DOT_527996EC =
          "Source of SemiJoinNode doesn't contain sourceOutputSymbol.";
  public static final String
      EXCEPTION_SOURCE_OF_SEMIJOINNODE_DOESN_QUOTE_T_CONTAIN_SOURCEJOINSYMBOL_DOT_32209273 =
          "Source of SemiJoinNode doesn't contain sourceJoinSymbol.";
  public static final String
  ...
  public static final String EXCEPTION_NEW_CHILD_SHOULDN_QUOTE_T_EXIST_YET_1EB3B129 =
      "New child shouldn't exist yet";
  public static final String EXCEPTION_ROWID_AND_UNIQUEVALUE_MASK_OVERLAPS_9A092E09 =
      "RowId and uniqueValue mask overlaps";

  // --- Execution ---

  public static final String ERROR_SETTING_FUTURE_STATE_FOR = "Error setting future state for {}";
  public static final String ERROR_NOTIFYING_STATE_CHANGE_LISTENER_FOR =
      "Error notifying state change listener for {}";
  public static final String SERVER_IS_SHUTTING_DOWN = "Server is shutting down";
  ...
  public static final String
      EXCEPTION_UNSUPPORTED_DATA_TYPE_IN_PERCENTILE_AGGREGATION_ARG_8ACED24D =
          "Unsupported data type in PERCENTILE Aggregation: %s";
  ...
  public static final String EXCEPTION_THE_WINDOW_START_MUST_BE_LESS_THAN_THE_WINDOW_END_B1A38C98 =
