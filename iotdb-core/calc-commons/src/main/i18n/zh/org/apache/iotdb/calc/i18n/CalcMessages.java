...
public final class CalcMessages {
  ...
  public static final String AND_OPERATOR_ONLY_ACCEPTS_BOOLEAN_OPERANDS = "AND 运算符只接受布尔操作数";
  ...
  public static final String ESCAPE_STRING_MUST_BE_A_SINGLE_CHARACTER = "转义字符串必须是单个字符";
  ...
  public static final String INPUT_ROW_UTILS_SHOULD_NOT_BE_INSTANTIATED = "InputRowUtils 不应被实例化。";
  public static final String INVALID_AGGREGATION_FUNCTION = "无效的聚合函数：";
  public static final String INVALID_TEXT_INPUT_FOR_BOOLEAN = "布尔类型的文本输入无效：%s";
  ...
  public static final String OR_OPERATOR_ONLY_ACCEPTS_BOOLEAN_OPERANDS = "OR 运算符只接受布尔操作数";
  ...
  public static final String SHOULD_CALL_THE_CONCRETE_VISIT_XX_METHOD = "应该调用具体的 visitXX() 方法";
  ...
  public static final String THIS_ACCUMULATOR_DOES_NOT_SUPPORT_REMOVING_INPUTS = "该累加器不支持移除输入！";
  public static final String THIS_IS_A_UTILITY_CLASS_AND_CANNOT_BE_INSTANTIATED = "这是一个工具类，不能被实例化";
  ...
  public static final String UDAF_NOT_SUPPORT_CALCULATE_FROM_STATISTICS = "UDAF 目前不支持从统计信息计算";
  ...
  public static final String UNSUPPORTED_TYPE_FOR_ARITHMETIC_OPERATION = "不支持的算术运算类型：";
  public static final String UNSUPPORTED_TYPE_IN_GENERIC_LITERAL = "GenericLiteral 中不支持的类型：";
  public static final String WEIGHT_MUST_BE_GE_1 = "权重必须 >= 1，实际为 ";
  public static final String PUSHED_ELEMENT_IS_NULL = "推入的元素为 null";
  ...
  public static final String
      EXCEPTION_AFTER_MATCH_SKIP_FAILED_PATTERN_VARIABLE_NOT_PRESENT_MATCH_2891B276 =
          "匹配后跳转失败：匹配中不存在模式变量";
  public static final String
      EXCEPTION_AFTER_MATCH_SKIP_FAILED_CANNOT_SKIP_FIRST_ROW_MATCH_71D4093B = "匹配后跳转失败：不能跳到匹配的第一行";
  ...
  public static final String
      EXCEPTION_IDENTITYLINEARFILL_S_NEEDPREPAREFORNEXT_METHOD_SHOULD_ALWAYS_RETURN_FALSE_FF7AD73B =
          "IdentityLinearFill 的 needPrepareForNext() 方法应始终返回 false。";
  ...
  public static final String EXCEPTION_SIZE_CHILDRENCOLUMNS_DATATYPES_SHOULD_SAME_6EA43EA8 =
      "childrenColumns 和 dataTypes 的大小应相同。";
  ...
  public static final String
      EXCEPTION_APPROX_PERCENTILE_REQUIRES_2_3_ARGUMENTS_BUT_GOT_ARG_D78590AA =
          "APPROX_PERCENTILE 需要 2 个或 3 个参数，但实际为 %d";
  public static final String
  ...
  public static final String
      EXCEPTION_CAN_T_GET_FILE_FILESPILLERREADER_CHECK_IF_FILE_EXISTS_DEED83D9 =
          "无法获取 FileSpillerReader 的文件，请检查文件是否存在：";
  ...
  public static final String
      EXCEPTION_ARGUMENT_EXCEPTION_SCALAR_FUNCTION_BIT_COUNT_BITS_MUST_BETWEEN_2_6A365911 =
          "参数异常，标量函数 bit_count 的位数必须在 2 到 64 之间。";
  public static final String
  ...
  public static final String
      EXCEPTION_LOGICALORMULTICOLUMNTRANSFORMER_DO_NOT_SUPPORT_DOTRANSFORM_SELECTION_E3A2B2FA =
          "LogicalOrMultiColumnTransformer 不支持带 selection 的 doTransform";
  ...
  public static final String
      EXCEPTION_ARGUMENT_EXCEPTION_SCALAR_FUNCTION_SUBSTRING_LENGTH_MUST_NOT_LESS_THAN_072B7355 =
          "参数异常，标量函数 substring 的长度参数不能小于 0";
  public static final String
  ...
  public static final String
      EXCEPTION_REQUESTED_VALUE_UNKNOWN_CAPTURE_WAS_IT_REGISTERED_PATTERN_C77DF7E9 =
          "请求了未知 Capture 的值。是否已在 Pattern 中注册？";
  public static final String
      EXCEPTION_TARGET_NODE_INDEX_MUST_BE_GREATER_THAN_OR_EQUAL_TO_ONE_75BFB7C3 = "目标节点索引必须大于或等于 1";
  ...
  public static final String EXCEPTION_PARTIALRESULT_OF_CENTRALMOMENT_SHOULD_BE_1_B7C0B4B9 =
      "CentralMoment 的 partialResult 应为 1";
  ...
  public static final String
      EXCEPTION_SHOULD_NOT_ATTEMPT_COMPACTION_WHEN_TSBLOCK_IS_LOCKED_DF775E6B = "TsBlock 锁定时不应尝试压缩";
  ...
  public static final String
      EXCEPTION_GETSELECTEDPOSITIONS_NOT_AVAILABLE_WHEN_IN_SELECTALL_MODE_CBE671D3 =
          "selectAll 模式下 getSelectedPositions 不可用";
  ...
  public static final String
      EXCEPTION_EXPECTED_1_INPUT_CHANNEL_FOR_INTERMEDIATE_AGGREGATION_3190C507 = "中间聚合期望 1 个输入通道";
  ...
  public static final String
      EXCEPTION_NUMBEROFBUCKETS_MUST_BE_A_POWER_OF_2_COMMA_ACTUAL_COLON_ARG_476E74ED =
          "numberOfBuckets 必须是 2 的幂，实际为：%s";
  public static final String
  ...
  public static final String
      EXCEPTION_LENGTH_OF_INPUT_COLUMN_LEFT_BRACKET_RIGHT_BRACKET_FOR_LASTBY_SLASH_FIRSTBY_SHOUL_9E836ABA =
          "LAST_BY/FIRST_BY 的输入 Column[] 长度应为 3";
  ...
  public static final String
      EXCEPTION_SOURCE_OF_SEMIJOINNODE_DOESN_QUOTE_T_CONTAIN_SOURCEOUTPUTSYMBOL_DOT_527996EC =
          "SemiJoinNode 的 Source 不包含 sourceOutputSymbol。";
  public static final String
      EXCEPTION_SOURCE_OF_SEMIJOINNODE_DOESN_QUOTE_T_CONTAIN_SOURCEJOINSYMBOL_DOT_32209273 =
          "SemiJoinNode 的 Source 不包含 sourceJoinSymbol。";
  public static final String
  ...
  public static final String
      EXCEPTION_EXPECTEDVALUE_CAN_QUOTE_T_BE_NULL_DOT_USE_ISNULL_LEFT_PAREN_RIGHT_PAREN_PATTERN__FC25E374 =
          "expectedValue 不能为 null，请改用 isNull() 模式。";
  ...
  public static final String EXCEPTION_ROWID_AND_UNIQUEVALUE_MASK_OVERLAPS_9A092E09 =
      "RowId 和 uniqueValue 掩码重叠";

  // --- Execution ---

  public static final String ERROR_SETTING_FUTURE_STATE_FOR = "为 {} 设置 future 状态时出错";
  public static final String ERROR_NOTIFYING_STATE_CHANGE_LISTENER_FOR = "通知 {} 的状态变更监听器时出错";
  public static final String SERVER_IS_SHUTTING_DOWN = "服务器正在关闭";
  ...
  public static final String EXCEPTION_ARG_CANNOT_TRANSITION_FROM_ARG_TO_ARG_8C680D30 =
      "%s 无法从 %s 转换到 %s";
  public static final String
      EXCEPTION_CANNOT_FIRE_STATE_CHANGE_EVENT_WHILE_HOLDING_THE_LOCK_35243BC4 = "持有锁时无法触发状态变更事件。";
  public static final String EXCEPTION_CANNOT_NOTIFY_WHILE_HOLDING_THE_LOCK_15625D48 = "持有锁时无法通知。";
  public static final String EXCEPTION_CANNOT_SET_STATE_WHILE_HOLDING_THE_LOCK_FA358188 =
      "持有锁时无法设置状态。";
  public static final String
      EXCEPTION_CANNOT_WAIT_FOR_STATE_CHANGE_WHILE_HOLDING_THE_LOCK_CBD9F784 = "持有锁时无法等待状态变更。";
