...
public class FailureLogState {
  private static final long FAILURE_LOG_INTERVAL = TimeUnit.MINUTES.toMillis(5);

  private long nextLogTime = 0L;
  private String lastFailure = "";

  public boolean shouldLog(String failureMessage) {
    return shouldLog(failureMessage, System.currentTimeMillis());
  }

  public synchronized boolean shouldLog(String failureMessage, long currentTime) {
