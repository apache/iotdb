...
public final class MetricsMessages {
  ...
  public static final String REPORTER_START_NOT_FOUND =
      "Failed to start {} reporter because not find.";
  public static final String REPORTER_STOP_FAILED = "Failed to stop {} reporter.";
  public static final String REPORTER_STOP_NOT_FOUND =
      "Failed to stop {} reporter because not find.";
  ...
  // --- PrometheusReporter ---
  public static final String PROMETHEUS_REPORTER_ALREADY_START =
      "PrometheusReporter already start!";
  ...
  public static final String CANNOT_FIND_DISK_IO_STATUS_FILE = "Cannot find disk io status file {}";
  ...
  public static final String LOG_FAILED_LOAD_ARG_REPORTER_BECAUSE_ALREADY_EXISTED_4BAF2E58 =
      "Failed to load {} reporter because already existed";
  public static final String EXCEPTION_FAILED_REMOVE_BECAUSE_MISMATCH_TYPE_044E55F6 =
      " failed to remove because the mismatch of type. ";
  ...
  public static final String LOG_FAILED_GET_MEMORY_BECAUSE_041BE661 =
      "Failed to get memory, because ";
  public static final String LOG_INTERRUPTED_WAITING_MEMORY_COMMAND_CF538E10 =
      "Interrupted while waiting for memory command";
  public static final String LOG_FAILED_REMOVE_LOGBACKMETRICS_BECAUSE_9BE74246 =
      "Failed to remove logBackMetrics, because ";
  public static final String
  ...
  public static final String
      LOG_RECOVERED_WINDOWS_DISK_METRICS_COLLECTION_THROUGH_POWERSHELL_CIM_03B9110E =
          "Recovered windows disk metrics collection through PowerShell/CIM.";
  ...
  public static final String LOG_PROMETHEUSREPORTER_STARTED_USE_PORT_ARG_A688FFC8 =
      "PrometheusReporter started, use port {}";
  public static final String
