...
expression
    ...
    | unaryBeforeRegularOrLikeExpression=expression operator_not? REGEXP STRING_LITERAL
    | unaryBeforeRegularOrLikeExpression=expression operator_not? LIKE pattern=STRING_LITERAL (ESCAPE escape=STRING_LITERAL)?
