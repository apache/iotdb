...
# if you have turned on "-XX:+SafepointTimeout" and "-XX:SafepointTimeoutDelay=1000", you can use commands below to see safepoint logs
#nohup bash "$DATANODE_START_PATH" >"$IOTDB_HOME/logs/log_datanode_safepoint.txt" 2>&1 &
