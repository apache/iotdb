...
public class NoopServerContextTest {
  ...
  public void testUnwrap() {
    Assert.assertSame(
        NoopServerContext.INSTANCE, NoopServerContext.INSTANCE.unwrap(NoopServerContext.class));
    Assert.assertSame(
        NoopServerContext.INSTANCE, NoopServerContext.INSTANCE.unwrap(ServerContext.class));
