 ...
 *
 * <p>Beware that it is the responsibility of the caller to ensure that a consumer has exclusive
 * read access to the buffer. This implementation does <em>not</em> include fail-fast behavior to
