...
import static org.apache.iotdb.google.common.collect.Maps.keyOrNull;
...
public abstract class ForwardingNavigableMap<K extends Object, V extends Object>
  ...
  protected Entry<K, V> standardFirstEntry() {
    return Iterables.<Entry<K, V>>getFirst(entrySet(), null);
  }
  ...
  protected Entry<K, V> standardLastEntry() {
    return Iterables.<Entry<K, V>>getFirst(descendingMap().entrySet(), null);
  }
