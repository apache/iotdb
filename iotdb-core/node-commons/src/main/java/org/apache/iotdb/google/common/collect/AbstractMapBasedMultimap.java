...
import org.apache.iotdb.google.common.collect.Maps.ViewCachingAbstractMap;
...
abstract class AbstractMapBasedMultimap<K extends Object, V extends Object>
  ...
  class WrappedCollection extends AbstractCollection<V> {
    ...
    WrappedCollection(
        @ParametricNullness K key, Collection<V> delegate, WrappedCollection ancestor) {
      this.key = key;
  ...
  class WrappedSortedSet extends WrappedCollection implements SortedSet<V> {
    WrappedSortedSet(@ParametricNullness K key, SortedSet<V> delegate, WrappedCollection ancestor) {
  ...
  class WrappedNavigableSet extends WrappedSortedSet implements NavigableSet<V> {
    WrappedNavigableSet(
        @ParametricNullness K key, NavigableSet<V> delegate, WrappedCollection ancestor) {
      super(key, delegate, ancestor);
    }
  ...
  class WrappedList extends WrappedCollection implements List<V> {
    WrappedList(@ParametricNullness K key, List<V> delegate, WrappedCollection ancestor) {
      super(key, delegate, ancestor);
    }
