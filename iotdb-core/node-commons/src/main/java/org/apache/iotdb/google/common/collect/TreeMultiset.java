...
public final class TreeMultiset<E extends Object> extends AbstractSortedMultiset<E>
  ...
  public static <E extends Object> TreeMultiset<E> create(Comparator<? super E> comparator) {
  ...
  private static <T extends Object> void successor(AvlNode<T> a, AvlNode<T> b, AvlNode<T> c) {
    successor(a, b);
    successor(b, c);
  }
