...
public final class Suppliers {
  ...
  public static <T extends Object> Supplier<T> ofInstance(@ParametricNullness T instance) {
   ...
   */
  public static <T extends Object> Supplier<T> synchronizedSupplier(Supplier<T> delegate) {
