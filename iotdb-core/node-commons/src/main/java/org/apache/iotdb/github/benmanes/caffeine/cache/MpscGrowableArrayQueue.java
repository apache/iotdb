...
import static org.apache.iotdb.github.benmanes.caffeine.cache.UnsafeAccess.UNSAFE;
import static org.apache.iotdb.github.benmanes.caffeine.cache.UnsafeRefArrayAccess.REF_ARRAY_BASE;
import static org.apache.iotdb.github.benmanes.caffeine.cache.UnsafeRefArrayAccess.REF_ELEMENT_SHIFT;
import static org.apache.iotdb.github.benmanes.caffeine.cache.UnsafeRefArrayAccess.lvElement;
import static org.apache.iotdb.github.benmanes.caffeine.cache.UnsafeRefArrayAccess.soElement;
 ...
 *
 * <p>This is a shaded copy of <tt>MpscGrowableArrayQueue</tt> provided by <a
 * href="https://github.com/JCTools/JCTools">JCTools</a> from version 2.0.
 *
...
final class MpscGrowableArrayQueue<E> extends MpscChunkedArrayQueue<E> {
   ...
   *     be the upper limit of number of elements in this queue. Must be 4 or more and round up to a
   *     larger power of 2 than initialCapacity.
   */
