...
import org.apache.iotdb.google.common.util.concurrent.ClosingFuture.Combiner.AsyncCombiningCallable;
import org.apache.iotdb.google.common.util.concurrent.ClosingFuture.Combiner.CombiningCallable;
import org.apache.iotdb.google.common.util.concurrent.Futures.FutureCombiner;
...
import static org.apache.iotdb.google.common.base.Functions.constant;
...
import static org.apache.iotdb.google.common.collect.Lists.asList;
import static org.apache.iotdb.google.common.util.concurrent.ClosingFuture.State.CLOSED;
import static org.apache.iotdb.google.common.util.concurrent.ClosingFuture.State.CLOSING;
import static org.apache.iotdb.google.common.util.concurrent.ClosingFuture.State.OPEN;
import static org.apache.iotdb.google.common.util.concurrent.ClosingFuture.State.SUBSUMED;
import static org.apache.iotdb.google.common.util.concurrent.ClosingFuture.State.WILL_CLOSE;
import static org.apache.iotdb.google.common.util.concurrent.ClosingFuture.State.WILL_CREATE_VALUE_AND_CLOSER;
...
public final class ClosingFuture<V extends Object> {
   ...
   */
  @Deprecated
  public static <C extends Object & AutoCloseable> ClosingFuture<C> eventuallyClosing(
   ...
   *     the arguments, or if any has already been {@linkplain #finishToFuture() finished}
   */
  public static <V1 extends Object, V2 extends Object> Combiner2<V1, V2> whenAllSucceed(
   ...
   *     the arguments, or if any has already been {@linkplain #finishToFuture() finished}
   */
  public static <V1 extends Object, V2 extends Object, V3 extends Object>
   ...
   *     the arguments, or if any has already been {@linkplain #finishToFuture() finished}
   */
  public static <V1 extends Object, V2 extends Object, V3 extends Object, V4 extends Object>
