...
/**
 * Static utility methods pertaining to {@code org.apache.iotdb.google.common.base.Function}
 * instances; see that class for information about migrating to {@code java.util.function}.
 *
...
public final class Functions {
   ...
   *
   * <p>Note: if {@code map} is a {@link org.apache.iotdb.google.common.collect.BiMap BiMap} (or can
   * be one), you can use {@link org.apache.iotdb.google.common.collect.Maps#asConverter
   * Maps.asConverter} instead to get a function that also supports reverse conversion.
   *
   ...
   */
  public static <A extends Object, B extends Object, C extends Object> Function<A, C> compose(
   ...
   */
  public static <E extends Object> Function<Object, E> constant(@ParametricNullness E value) {
