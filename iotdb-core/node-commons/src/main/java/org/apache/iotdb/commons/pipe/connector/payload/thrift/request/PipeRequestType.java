...
public enum PipeRequestType {
  ...
  // Data region
  TRANSFER_TABLET_INSERT_NODE_V2((short) 2),
  TRANSFER_TABLET_RAW_V2((short) 3),
  TRANSFER_TS_FILE_PIECE_V2((short) 4),
  TRANSFER_TS_FILE_SEAL_V2((short) 5),
  TRANSFER_TABLET_BATCH_V2((short) 6),
  TRANSFER_TABLET_BINARY_V2((short) 7),
  TRANSFER_TS_FILE_PIECE_WITH_MOD_V2((short) 8),
  TRANSFER_TS_FILE_SEAL_WITH_MOD_V2((short) 9),
