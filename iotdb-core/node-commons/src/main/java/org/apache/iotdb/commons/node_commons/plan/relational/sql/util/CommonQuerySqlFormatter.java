...
import static org.apache.iotdb.commons.node_commons.plan.relational.sql.util.ExpressionFormatter.formatOrderBy;
import static org.apache.iotdb.commons.node_commons.plan.relational.sql.util.RowPatternFormatter.formatPattern;
...
public class CommonQuerySqlFormatter implements CommonQueryAstVisitor<Void, Integer> {
            ...
            groupBy ->
                append(
                        ...
                        "GROUP BY "
                            ...
                            + org.apache.iotdb.commons.node_commons.plan.relational.sql.util
  ...
  public Void visitSelect(Select node, Integer indent) {
    ...
    if (node.getSelectItems().size() > 1) {
      boolean first = true;
      for (org.apache.iotdb.commons.node_commons.plan.relational.sql.ast.SelectItem item :
          node.getSelectItems()) {
        builder.append("\n").append(indentString(indent)).append(first ? "  " : ", ");
        process(item, indent);
        first = false;
