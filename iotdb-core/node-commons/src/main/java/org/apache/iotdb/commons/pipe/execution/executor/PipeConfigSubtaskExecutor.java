...
public class PipeConfigSubtaskExecutor {

  private static final Logger LOGGER = LoggerFactory.getLogger(PipeConfigSubtaskExecutor.class);

  private static final ExecutorService subtaskCallbackListeningExecutor =
      IoTDBThreadPoolFactory.newSingleThreadExecutor(
          ThreadName.PIPE_CONFIGNODE_SUBTASK_CALLBACK_EXECUTOR_POOL.getName());
  private final ListeningExecutorService subtaskWorkerThreadPoolExecutor;

  private final Map<String, PipeConfigSubtask> registeredIdSubtaskMapper;
  private int runningSubtaskNumber;

  private PipeConfigSubtaskExecutor() {
    subtaskWorkerThreadPoolExecutor =
        MoreExecutors.listeningDecorator(
            IoTDBThreadPoolFactory.newSingleThreadExecutor(
                ThreadName.PIPE_CONFIGNODE_EXECUTOR_POOL.getName()));
  ...
  public final synchronized void register(PipeConfigSubtask subtask) {
    ...
    subtask.bindExecutors(
        ...
        new PipeConfigSubtaskScheduler(this));
  }
  ...
  public final synchronized void start(String subTaskID) {
    ...
    final PipeConfigSubtask subtask = registeredIdSubtaskMapper.get(subTaskID);
  ...
  public final synchronized void deregister(String subTaskID) {
    ...
    final PipeConfigSubtask subtask = registeredIdSubtaskMapper.remove(subTaskID);
  ...
  public final synchronized void shutdown() {
    ...
    for (PipeConfigSubtask subtask : registeredIdSubtaskMapper.values()) {
  ...
  private static class PipeConfigSubtaskExecutorHolder {
    private static PipeConfigSubtaskExecutor instance = null;
  }

  public static synchronized PipeConfigSubtaskExecutor getInstance() {
    if (PipeConfigSubtaskExecutor.PipeConfigSubtaskExecutorHolder.instance == null) {
      PipeConfigSubtaskExecutor.PipeConfigSubtaskExecutorHolder.instance =
          new PipeConfigSubtaskExecutor();
    }
    return PipeConfigSubtaskExecutor.PipeConfigSubtaskExecutorHolder.instance;
  }
}
