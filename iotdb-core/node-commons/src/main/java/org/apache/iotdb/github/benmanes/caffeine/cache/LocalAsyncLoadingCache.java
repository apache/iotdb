...
abstract class LocalAsyncLoadingCache<K, V>
  ...
  private static boolean canBulkLoad(AsyncCacheLoader<?, ?> loader) {
    try {
      ...
      Method classAsyncLoadAll =
          loader.getClass().getMethod("asyncLoadAll", Iterable.class, Executor.class);
      Method defaultAsyncLoadAll =
          defaultLoaderClass.getMethod("asyncLoadAll", Iterable.class, Executor.class);
  ...
  static final class LoadingCacheView<K, V> extends AbstractCacheView<K, V>
