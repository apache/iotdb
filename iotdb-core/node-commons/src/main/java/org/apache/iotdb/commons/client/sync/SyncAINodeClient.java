...
public class SyncAINodeClient extends IAINodeRPCService.Client
  ...
  public static class Factory extends ThriftClientFactory<TEndPoint, SyncAINodeClient> {
    ...
    @Override
    public void destroyObject(TEndPoint endpoint, PooledObject<SyncAINodeClient> pooledObject) {
      pooledObject.getObject().invalidate();
    }

    @Override
    public PooledObject<SyncAINodeClient> makeObject(TEndPoint endpoint) throws Exception {
    ...
    @Override
    public boolean validateObject(TEndPoint endpoint, PooledObject<SyncAINodeClient> pooledObject) {
