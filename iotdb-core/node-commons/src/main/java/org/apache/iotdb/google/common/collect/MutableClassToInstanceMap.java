...
import org.apache.iotdb.google.common.primitives.Primitives;
...
public final class MutableClassToInstanceMap<B extends Object>
    extends ForwardingMap<Class<? extends B>, B> implements ClassToInstanceMap<B>, Serializable {
   ...
   */
  private static <B extends Object> Entry<Class<? extends B>, B> checkedEntry(
  ...
  private static final class SerializedForm<B extends Object> implements Serializable {
