...
public interface StatsCounter {
   ...
   * evicted due to the cache's eviction strategy, and not as a result of manual {@link
  ...
  /**
   * Returns an accumulator that suppresses and logs any exception thrown by the delegate {@code
   * statsCounter}.
   *
