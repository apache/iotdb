...
import org.apache.iotdb.google.common.collect.MapDifference.ValueDifference;
...
public final class Maps {
   ...
   */
  @SuppressWarnings("unchecked")
  static <E extends Object> Comparator<? super E> orNaturalOrder(Comparator<? super E> comparator) {
   ...
   * org.apache.iotdb.google.common.base.Functions#forMap(Map)} or {@link
   * org.apache.iotdb.google.common.base.Functions#forMap(Map, Object)}.
   *
   * @since 16.0
   */
  ...
  static <K extends Object> K keyOrNull(Entry<K, ?> entry) {
    return (entry == null) ? null : entry.getKey();
  }

  static <V extends Object> V valueOrNull(Entry<?, V> entry) {
