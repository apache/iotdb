...
import org.apache.iotdb.commons.pipe.plugin.builtin.connector.IoTDBWebSocketConnector;
...
public enum BuiltinPipePlugin {
  ...
  IOTDB_WEB_SOCKET_CONNECTOR("iotdb-web-socket-connector", IoTDBWebSocketConnector.class),
  ;
