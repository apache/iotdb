 ...
 * #get(Object, Function)} or {@link #put(Object, CompletableFuture)}, and are stored in the cache
...
public interface AsyncCache<K, V> {
  ...
  /**
   * Returns the future associated with {@code key} in this cache, obtaining that value from {@code
   * mappingFunction} if necessary. This method provides a simple substitute for the conventional
   ...
   * already present in the cache. If another call to {@link #get} tries to load the value for a key
   * in {@code keys}, that thread retrieves a future that is completed by this bulk computation. Any
