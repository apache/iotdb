...
package org.apache.iotdb.commons.pipe.agent.plugin.builtin.sink;
 ...
 * sinks that can not be implemented in the node-commons module. Each IoTDB pipe connector has
...
@TreeModel
@TableModel
public class PlaceholderSink implements PipeConnector {
