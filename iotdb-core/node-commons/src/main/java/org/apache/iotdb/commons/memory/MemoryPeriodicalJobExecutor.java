...
public class MemoryPeriodicalJobExecutor {
  private static final Logger LOGGER = LoggerFactory.getLogger(MemoryPeriodicalJobExecutor.class);
  ...
  public void register(String id, Runnable periodicalJob, long intervalInSeconds) {
    ...
    LOGGER.info(
        "Memory periodical job {} is registered successfully. Interval: {} seconds.",
        id,
