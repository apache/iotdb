...
public abstract class PipePluginAgent {
  ...
  public PipeExtractor validateSource(final Map<String, String> sourceAttributes) throws Exception {
  ...
  public PipeConnector validateSink(String pipeName, Map<String, String> sinkAttributes)
      throws Exception {
