...
public class SeriesPartitionTable {
  ...
  public List<TTimePartitionSlot> autoCleanPartitionTable(
    ...
    while (iterator.hasNext()) {
      ...
      if (isTimePartitionExpired(timePartitionSlot, TTL, currentTimeSlot)) {
  ...
  private static boolean isTimePartitionExpired(
    ...
    long partitionEndTime = saturatedAdd(timePartitionSlot.getStartTime(), TIME_PARTITION_INTERVAL);
