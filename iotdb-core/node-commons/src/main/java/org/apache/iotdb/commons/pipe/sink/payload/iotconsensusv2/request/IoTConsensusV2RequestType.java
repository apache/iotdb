...
public enum IoTConsensusV2RequestType {

  // Data region
  TRANSFER_TABLET_INSERT_NODE((short) 100),
  // IoTConsensusV2 doesn't expect to handle rawTabletEvent.
...
;
  ...
  IoTConsensusV2RequestType(short type) {
    this.type = type;
  }
  ...
  private static final Map<Short, IoTConsensusV2RequestType> TYPE_MAP =
      Arrays.stream(IoTConsensusV2RequestType.values())
          .collect(
              HashMap::new,
              (typeMap, IoTConsensusV2RequestType) ->
                  typeMap.put(IoTConsensusV2RequestType.getType(), IoTConsensusV2RequestType),
              HashMap::putAll);
  ...
  public static IoTConsensusV2RequestType valueOf(short type) {
