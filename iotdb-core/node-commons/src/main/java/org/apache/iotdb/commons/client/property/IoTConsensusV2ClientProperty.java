...
/** This class defines the configurations used by the IoTConsensusV2 Client. */
public class IoTConsensusV2ClientProperty {
  ...
  public IoTConsensusV2ClientProperty(
  ...
  public static IoTConsensusV2ClientProperty.Builder newBuilder() {
    return new IoTConsensusV2ClientProperty.Builder();
  }
  ...
  public static class Builder {
    ...
    public IoTConsensusV2ClientProperty.Builder setIsRpcThriftCompressionEnabled(
        boolean isRpcThriftCompressionEnabled) {
      this.isRpcThriftCompressionEnabled = isRpcThriftCompressionEnabled;
      return this;
    }

    public IoTConsensusV2ClientProperty.Builder setSelectorNumOfClientManager(
        int selectorNumOfClientManager) {
      this.selectorNumOfClientManager = selectorNumOfClientManager;
      return this;
    }

    public IoTConsensusV2ClientProperty.Builder setPrintLogWhenThriftClientEncounterException(
        boolean printLogWhenThriftClientEncounterException) {
      this.printLogWhenThriftClientEncounterException = printLogWhenThriftClientEncounterException;
      return this;
    }

    public IoTConsensusV2ClientProperty.Builder setMaxClientNumForEachNode(
        int maxClientNumForEachNode) {
      this.maxClientNumForEachNode = maxClientNumForEachNode;
      return this;
    }

    public IoTConsensusV2ClientProperty build() {
      return new IoTConsensusV2ClientProperty(
