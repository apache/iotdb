...
public class MemoryRuntimeController implements IService {
  ...
  private static final long MEMORY_ADAPT_INTERVAL_IN_S = CONFIG.getMemoryAdaptIntervalInS();
  ...
  public void start() throws StartupException {
    ...
    if (ENABLE_MEMORY_ADAPT) {
      LOGGER.info(
          "Enable automatic memory adapt with an interval of {} s", MEMORY_ADAPT_INTERVAL_IN_S);
