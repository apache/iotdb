...
public interface CacheLoader<K, V> extends AsyncCacheLoader<K, V> {
   ...
   *
   * <p><b>Warning:</b> loading <b>must not</b> attempt to update any mappings of this cache
   * directly.
   *
   ...
   * returned. This method is called when an existing cache entry is refreshed by {@link
