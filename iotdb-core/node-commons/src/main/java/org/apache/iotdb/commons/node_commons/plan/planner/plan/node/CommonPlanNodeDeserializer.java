...
package org.apache.iotdb.commons.node_commons.plan.planner.plan.node;
...
public class CommonPlanNodeDeserializer implements IPlanNodeDeserializer {
  ...
  public PlanNode deserialize(ByteBuffer buffer, short nodeType) {
    switch (nodeType) {
      case 1001:
        return org.apache.iotdb.commons.node_commons.plan.relational.planner.node.FilterNode
            .deserialize(buffer);
      case 1002:
        return org.apache.iotdb.commons.node_commons.plan.relational.planner.node.ProjectNode
            .deserialize(buffer);
      case 1003:
        return OutputNode.deserialize(buffer);
      case 1004:
        return org.apache.iotdb.commons.node_commons.plan.relational.planner.node.LimitNode
            .deserialize(buffer);
      case 1005:
        return org.apache.iotdb.commons.node_commons.plan.relational.planner.node.OffsetNode
            .deserialize(buffer);
      case 1006:
        return org.apache.iotdb.commons.node_commons.plan.relational.planner.node.SortNode
            .deserialize(buffer);
      case 1007:
        return MergeSortNode.deserialize(buffer);
      case 1008:
        return org.apache.iotdb.commons.node_commons.plan.relational.planner.node.TopKNode
            .deserialize(buffer);
      case 1009:
        return org.apache.iotdb.commons.node_commons.plan.relational.planner.node.CollectNode
            .deserialize(buffer);
      case 1010:
      ...
      case 1015:
        return org.apache.iotdb.commons.node_commons.plan.relational.planner.node.AggregationNode
            .deserialize(buffer);
      case 1017:
