...
import static org.apache.iotdb.google.common.util.concurrent.NullnessCasts.uncheckedNull;
 ...
 * org.apache.iotdb.google.common.base.Function, java.util.concurrent.Executor) Futures.transform}
 * and {@link Futures#catching(ListenableFuture, Class,
 * org.apache.iotdb.google.common.base.Function, java.util.concurrent.Executor) Futures.catching}.
 *
...
public abstract class AbstractFuture<V extends Object> extends InternalFutureFailureAccess
   ...
   * org.apache.iotdb.google.common.util.concurrent.SettableFuture} do not expose it to their users
   * as an instance method. In the unlikely event that you need to call this method, call {@link
  ...
  public String toString() {
    ...
    if (getClass().getName().startsWith("org.apache.iotdb.google.common.util.concurrent.")) {
