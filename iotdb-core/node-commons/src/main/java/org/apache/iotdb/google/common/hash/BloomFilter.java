...
import org.apache.iotdb.google.common.hash.BloomFilterStrategies.LockFreeBitArray;
import org.apache.iotdb.google.common.math.DoubleMath;
import org.apache.iotdb.google.common.math.LongMath;
import org.apache.iotdb.google.common.primitives.SignedBytes;
...
public final class BloomFilter<T extends Object> implements Predicate<T>, Serializable {
   ...
   */
  public static <T extends Object> BloomFilter<T> readFrom(InputStream in, Funnel<? super T> funnel)
      throws IOException {
