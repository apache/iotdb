 ...
 * @since 15.0
 * @deprecated Use {@link org.apache.iotdb.google.common.graph.Traverser} instead. All instance
 *     methods have their equivalent on the result of {@code Traverser.forTree(tree)} where {@code
 *     tree} implements {@code SuccessorsFunction}, which has a similar API as {@link #children} or
 *     can be the same lambda function as passed into {@link #using(Function)}.
...
public abstract class TreeTraverser<T> {
   ...
   *
   * @since 20.0
   * @deprecated Use {@link org.apache.iotdb.google.common.graph.Traverser#forTree} instead. If you
   *     are using a lambda, these methods have exactly the same signature.
   */
  @Deprecated
   ...
   *
   * @deprecated Use {@link org.apache.iotdb.google.common.graph.Traverser#depthFirstPreOrder}
   ...
   * is in progress or when the iterators generated by {@link #children} are advanced.
   *
   * @deprecated Use {@link org.apache.iotdb.google.common.graph.Traverser#depthFirstPostOrder}
   *     instead, which has the same behavior.
   */
  @Deprecated
   ...
   * is in progress or when the iterators generated by {@link #children} are advanced.
   *
   * @deprecated Use {@link org.apache.iotdb.google.common.graph.Traverser#breadthFirst} instead,
