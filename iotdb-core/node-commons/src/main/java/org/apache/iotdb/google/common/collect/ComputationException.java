 ...
 * @author Bob Lee
 * @since 2.0
 * @deprecated This exception is no longer thrown by {@code org.apache.iotdb.google.common}.
 *     Previously, it was thrown by {@link MapMaker} computing maps. When support for computing maps
 *     was removed from {@code MapMaker}, it was added to {@code CacheBuilder}, which throws {@code
