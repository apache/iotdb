...
public class PipeSourceConstant {
  ...
  public static final boolean SOURCE_REALTIME_ENABLE_DEFAULT_VALUE = true;
  ...
  public static final String SOURCE_REALTIME_MODE_HYBRID_VALUE = "hybrid";
  public static final String SOURCE_REALTIME_MODE_FILE_VALUE = "file";
  public static final String SOURCE_REALTIME_MODE_LOG_VALUE = "log";
  public static final String SOURCE_REALTIME_MODE_FORCED_LOG_VALUE = "forced-log";
  public static final String SOURCE_REALTIME_MODE_STREAM_MODE_VALUE = "stream";
  public static final String SOURCE_REALTIME_MODE_BATCH_MODE_VALUE = "batch";
  ...
  public static final String SOURCE_REALTIME_LOOSE_RANGE_TIME_VALUE = "time";
  public static final String SOURCE_REALTIME_LOOSE_RANGE_PATH_VALUE = "path";
  public static final String SOURCE_REALTIME_LOOSE_RANGE_ALL_VALUE = "all";
  public static final String SOURCE_REALTIME_LOOSE_RANGE_DEFAULT_VALUE = "";
  ...
  public static final boolean SOURCE_MODE_STREAMING_DEFAULT_VALUE = true;
  ...
  public static final boolean SOURCE_MODE_STRICT_DEFAULT_VALUE = true;
  ...
  public static final boolean SOURCE_MODE_SNAPSHOT_DEFAULT_VALUE = false;
  ...
  public static final boolean SOURCE_MODE_DOUBLE_LIVING_DEFAULT_VALUE = false;
