...
public class With extends Node {
  ...
  private static final long INSTANCE_SIZE = RamUsageEstimator.shallowSizeOfInstance(With.class);
  ...
  public <R, C> R accept(IAstVisitor<R, C> visitor, C context) {
    return ((CommonQueryAstVisitor<R, C>) visitor).visitWith(this, context);
  }
  ...
  public long ramBytesUsed() {
    ...
    size += AstMemoryEstimationHelper.getEstimatedSizeOfNodeList(queries);
    return size;
  }
}
