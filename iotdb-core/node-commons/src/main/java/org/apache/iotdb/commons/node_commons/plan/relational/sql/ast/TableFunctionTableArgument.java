...
import static org.apache.iotdb.commons.node_commons.plan.relational.sql.util.ExpressionFormatter.formatSortItems;
...
public class TableFunctionTableArgument extends Node {
  ...
  public <R, C> R accept(IAstVisitor<R, C> visitor, C context) {
    return ((CommonQueryAstVisitor<R, C>) visitor).visitTableArgument(this, context);
  }
