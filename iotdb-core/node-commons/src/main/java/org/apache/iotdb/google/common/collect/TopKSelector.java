...
import static org.apache.iotdb.google.common.collect.NullnessCasts.uncheckedCastNullableTToT;
...
final class TopKSelector<T extends Object> {
   ...
   * @throws IllegalArgumentException if {@code k < 0} or {@code k > Integer.MAX_VALUE / 2}
   */
  public static <T extends Object> TopKSelector<T> least(int k, Comparator<? super T> comparator) {
