...
public class SyncIoTConsensusV2ServiceClient extends IoTConsensusV2IService.Client
    implements ThriftClient, AutoCloseable {

  private final boolean printLogWhenEncounterException;
  private final TEndPoint endpoint;
  private final ClientManager<TEndPoint, SyncIoTConsensusV2ServiceClient> clientManager;
  private static final CommonConfig commonConfig = CommonDescriptor.getInstance().getConfig();

  public SyncIoTConsensusV2ServiceClient(
      ThriftClientProperty property,
      TEndPoint endpoint,
      ClientManager<TEndPoint, SyncIoTConsensusV2ServiceClient> clientManager)
  ...
  public String toString() {
    return String.format("SyncIoTConsensusV2ServiceClient{%s}", endpoint);
  }
  ...
  public static class Factory
      extends ThriftClientFactory<TEndPoint, SyncIoTConsensusV2ServiceClient> {
    ...
    public void destroyObject(
        TEndPoint endpoint, PooledObject<SyncIoTConsensusV2ServiceClient> pooledObject) {
