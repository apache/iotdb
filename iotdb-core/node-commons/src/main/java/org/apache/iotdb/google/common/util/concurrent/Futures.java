...
import org.apache.iotdb.google.common.util.concurrent.CollectionFuture.ListFuture;
import org.apache.iotdb.google.common.util.concurrent.ImmediateFuture.ImmediateCancelledFuture;
import org.apache.iotdb.google.common.util.concurrent.ImmediateFuture.ImmediateFailedFuture;
import org.apache.iotdb.google.common.util.concurrent.internal.InternalFutureFailureAccess;
import org.apache.iotdb.google.common.util.concurrent.internal.InternalFutures;
...
import static org.apache.iotdb.google.common.util.concurrent.Internal.toNanosSaturated;
import static org.apache.iotdb.google.common.util.concurrent.MoreExecutors.directExecutor;
import static org.apache.iotdb.google.common.util.concurrent.Uninterruptibles.getUninterruptibly;
...
public final class Futures extends GwtFuturesCatchingSpecialization {
   ...
   */
  public static <I extends Object, O extends Object> ListenableFuture<O> transformAsync(
   ...
   */
  public static <I extends Object, O extends Object> ListenableFuture<O> transform(
  ...
  public static <V extends Object> ListenableFuture<List<V>> allAsList(
    ...
    ListenableFuture<List<V>> nullable = new ListFuture<V>(ImmutableList.copyOf(futures), true);
  ...
  // cancelled.
  private static final class InCompletionOrderFuture<T extends Object> extends AbstractFuture<T> {
