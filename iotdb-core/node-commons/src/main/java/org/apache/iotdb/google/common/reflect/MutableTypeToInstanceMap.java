...
package org.apache.iotdb.google.common.reflect;

import org.apache.iotdb.google.common.collect.ForwardingMap;
import org.apache.iotdb.google.common.collect.ForwardingMapEntry;
import org.apache.iotdb.google.common.collect.ForwardingSet;
...
public final class MutableTypeToInstanceMap<B extends Object>
    extends ForwardingMap<TypeToken<? extends B>, B> implements TypeToInstanceMap<B> {
  ...
  private static final class UnmodifiableEntry<K, V extends Object>
      extends ForwardingMapEntry<K, V> {

    private final Entry<K, V> delegate;

    static <K, V extends Object> Set<Entry<K, V>> transformEntries(Set<Entry<K, V>> entries) {
    ...
    private static <K, V extends Object> Iterator<Entry<K, V>> transformEntries(
