...
final class Synchronized {
  ...
  @VisibleForTesting
  static <E extends Object> Set<E> set(Set<E> set, Object mutex) {
  ...
  private static <E extends Object> SortedSet<E> sortedSet(SortedSet<E> set, Object mutex) {
  ...
  private static <E extends Object> List<E> list(List<E> list, Object mutex) {
    return (list instanceof RandomAccess)
        ? new SynchronizedRandomAccessList<E>(list, mutex)
        : new SynchronizedList<E>(list, mutex);
  }

  private static class SynchronizedList<E extends Object> extends SynchronizedCollection<E>
      implements List<E> {
  ...
  static <E extends Object> Multiset<E> multiset(Multiset<E> multiset, Object mutex) {
  ...
  private static class SynchronizedListMultimap<K extends Object, V extends Object>
  ...
  private static class SynchronizedSetMultimap<K extends Object, V extends Object>
  ...
  private static <E extends Object> Set<E> typePreservingSet(Set<E> set, Object mutex) {
  ...
  @VisibleForTesting
  static <K extends Object, V extends Object> Map<K, V> map(Map<K, V> map, Object mutex) {
  ...
  static <K extends Object, V extends Object> BiMap<K, V> biMap(BiMap<K, V> bimap, Object mutex) {
  ...
  static <E extends Object> Queue<E> queue(Queue<E> queue, Object mutex) {
    return (queue instanceof SynchronizedQueue) ? queue : new SynchronizedQueue<E>(queue, mutex);
  }

  private static class SynchronizedQueue<E extends Object> extends SynchronizedCollection<E>
      implements Queue<E> {
  ...
  static <E extends Object> Deque<E> deque(Deque<E> deque, Object mutex) {
    return new SynchronizedDeque<E>(deque, mutex);
  }

  private static final class SynchronizedDeque<E extends Object> extends SynchronizedQueue<E>
      implements Deque<E> {
  ...
  static <R extends Object, C extends Object, V extends Object> Table<R, C, V> table(
      Table<R, C, V> table, Object mutex) {
      ...
      synchronized (mutex) {
        return map(
            Maps.transformValues(
                delegate().rowMap(),
                new org.apache.iotdb.google.common.base.Function<Map<C, V>, Map<C, V>>() {
                  @Override
    ...
    public Map<C, Map<R, V>> columnMap() {
      synchronized (mutex) {
        return map(
            Maps.transformValues(
                delegate().columnMap(),
                new org.apache.iotdb.google.common.base.Function<Map<R, V>, Map<R, V>>() {
                  @Override
