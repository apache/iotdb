...
final class References {
  ...
  /**
   * The value in a cache that holds values weakly. This class retains a reference to the key in the
   * advent that the value is reclaimed so that the entry can be removed from the cache in constant
   * time.
   */
  ...
  /**
   * The value in a cache that holds values softly. This class retains a reference to the key in the
   * advent that the value is reclaimed so that the entry can be removed from the cache in constant
   * time.
   */
