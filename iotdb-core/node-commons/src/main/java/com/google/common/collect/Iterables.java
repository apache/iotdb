...
public final class Iterables {
   ...
   */
  public static <T extends Object> T[] toArray(Iterable<? extends T> iterable, Class<T> type) {
   ...
   * @since 7.0
   */
  public static <T extends Object> T getFirst(Iterable<? extends T> iterable, T defaultValue) {
   ...
   * @since 3.0
   */
  public static <T extends Object> T getLast(Iterable<? extends T> iterable, T defaultValue) {
    if (iterable instanceof Collection) {
