...
class ImmutableMapEntry<K, V> extends ImmutableEntry<K, V> {
   ...
   * declare it as {@code ImmutableMapEntry[]} because our checker doesn't require newly created
   * arrays to have a {@code @Nullable} element type even when they're created directly with {@code
