...
public final class Maps {
   ...
   */
  public static <K extends Object, V extends Object> HashMap<K, V> newHashMapWithExpectedSize(
      int expectedSize) {
   ...
   */
  public static <K extends Object, V extends Object> MapDifference<K, V> difference(
   ...
   * @since 11.0
   */
  public static <K extends Object, V extends Object> SortedMapDifference<K, V> difference(
  ...
  static class ValueDifferenceImpl<V extends Object> implements MapDifference.ValueDifference<V> {
    ...
    static <V extends Object> ValueDifference<V> create(V left, V right) {
  ...
  static <K extends Object, V extends Object> Iterator<Entry<K, V>> asMapEntryIterator(
   ...
   */
  public static <K extends Object, V extends Object> Entry<K, V> immutableEntry(K key, V value) {
   ...
   */
  static <K extends Object, V extends Object> Set<Entry<K, V>> unmodifiableEntrySet(
  ...
  static class UnmodifiableEntries<K extends Object, V extends Object>
    ...
    public Object[] toArray() {
      /*
       * standardToArray returns `Object[]` rather than `Object[]` but because it can
       ...
       * overrides, so we declare `Object[]` as the return type.
       */
   ...
   */
  public static <K extends Object, V extends Object> BiMap<K, V> synchronizedBiMap(
      BiMap<K, V> bimap) {
   ...
   * @since 11.0
   */
  public static <K extends Object, V1 extends Object, V2 extends Object>
   ...
   */
  // NavigableMap
  public static <K extends Object, V extends Object> NavigableMap<K, V> filterKeys(
   ...
   * @since 11.0
   */
  public static <K extends Object, V extends Object> SortedMap<K, V> filterValues(
   ...
   */
  // NavigableMap
  public static <K extends Object, V extends Object> NavigableMap<K, V> filterValues(
   ...
   * @since 11.0
   */
  public static <K extends Object, V extends Object> SortedMap<K, V> filterEntries(
   ...
   */
  // NavigableMap
  public static <K extends Object, V extends Object> NavigableMap<K, V> filterEntries(
   ...
   * sorted map.
   */
  private static <K extends Object, V extends Object> SortedMap<K, V> filterFiltered(
   ...
   * map.
   */
  private static <K extends Object, V extends Object> BiMap<K, V> filterFiltered(
  ...
  private static final class FilteredMapValues<K extends Object, V extends Object>
  ...
  private static class FilteredEntrySortedMap<K extends Object, V extends Object>
   ...
   * entrySet views.
   */
  abstract static class ViewCachingAbstractMap<K extends Object, V extends Object>
  ...
  abstract static class IteratorBasedAbstractMap<K extends Object, V extends Object>
      extends AbstractMap<K, V> {
    @Override
  ...
  static class SortedKeySet<K extends Object, V extends Object> extends KeySet<K, V>
   ...
   */
  // NavigableMap
  public static <K extends Comparable<? super K>, V extends Object> NavigableMap<K, V> subMap(
