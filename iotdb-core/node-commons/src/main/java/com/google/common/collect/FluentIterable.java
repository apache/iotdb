...
public abstract class FluentIterable<E extends Object> implements Iterable<E> {
   ...
   * @since 20.0
   */
  public static <T extends Object> FluentIterable<T> concat(Iterable<? extends T>... inputs) {
   ...
   * @since 20.0
   */
  public static <E extends Object> FluentIterable<E> of(E element, E... elements) {
  ...
  public final Optional<E> firstMatch(Predicate<? super E> predicate) {
    return Iterables.<E>tryFind((Iterable<E>) getDelegate(), predicate);
  }
   ...
   */
  public final <T extends Object> FluentIterable<T> transform(Function<? super E, T> function) {
  ...
  public final ImmutableList<E> toList() {
    return ImmutableList.copyOf((Iterable<E>) getDelegate());
  }
  ...
  public final ImmutableList<E> toSortedList(Comparator<? super E> comparator) {
    return Ordering.from(comparator).immutableSortedCopy((Iterable<E>) getDelegate());
  }
  ...
  public final ImmutableSet<E> toSet() {
    return ImmutableSet.copyOf((Iterable<E>) getDelegate());
  }
  ...
  public final ImmutableSortedSet<E> toSortedSet(Comparator<? super E> comparator) {
    return ImmutableSortedSet.copyOf(comparator, (Iterable<E>) getDelegate());
  }
  ...
  public final ImmutableMultiset<E> toMultiset() {
    return ImmutableMultiset.copyOf((Iterable<E>) getDelegate());
  }
  ...
  public final <V> ImmutableMap<E, V> toMap(Function<? super E, V> valueFunction) {
    return Maps.toMap((Iterable<E>) getDelegate(), valueFunction);
  }
  ...
  public final <K> ImmutableListMultimap<K, E> index(Function<? super E, K> keyFunction) {
    return Multimaps.index((Iterable<E>) getDelegate(), keyFunction);
  }
  ...
  public final <K> ImmutableMap<K, E> uniqueIndex(Function<? super E, K> keyFunction) {
    return Maps.uniqueIndex((Iterable<E>) getDelegate(), keyFunction);
  }
