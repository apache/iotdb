...
public final class ObjectArrays {
   ...
   */
  public static <T extends Object> T[] concat(T[] first, T[] second, Class<T> type) {
   ...
   */
  public static <T extends Object> T[] concat(T element, T[] array) {
   ...
   */
  public static <T extends Object> T[] concat(T[] array, T element) {
   ...
   * <i>only</i> if the caller knows that the collection does not contain any null elements.
   */
  static <T extends Object> T[] toArrayImpl(Object[] src, int offset, int len, T[] dst) {
