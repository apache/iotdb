...
public final class ServiceMessages {
  ...
  public static final String INTERRUPTED_WAITING_DEVICE_VIEW_UPDATE = "等待下一次设备视图更新时被中断：{}";
  ...
  public static final String FAILED_TO_START_SERVICE_BECAUSE = "%s: 启动 %s 失败，原因：";
  public static final String SERVICE_THREAD_BEGIN_TO_RUN = "{} 服务线程开始运行...";
  public static final String SERVICE_EXIT_BECAUSE = "%s: %s 退出，原因：";
  public static final String UNEXPECTED_SERVER_TYPE = "未预期的服务器类型 {}";
  public static final String FAILED_TO_LOAD_KEYSTORE_OR_TRUSTSTORE = "加载密钥库或信任库文件失败";
  public static final String KEYSTORE_OR_TRUSTSTORE_NOT_FOUND = "未找到密钥库或信任库文件";
  ...
  // ---- RegisterManager ----
  public static final String SERVICE_ALREADY_REGISTERED = "{} 已注册，跳过";
  public static final String SERVICE_STARTED_WITH_TIME = "{} 服务已成功启动，耗时 {} 毫秒。";
  ...
  public static final String START_JMX_REMOTELY = "远程启动 JMX：JMX 已开启，监听远程连接端口 {}";
  public static final String JDK_VERSION_TOO_LOW = "要求 JDK 版本 >= %d，当前版本为 %d。";
  ...
  // ---- ThriftService ----
  public static final String START_LATCH_NULL_WHEN_GETTING_STATUS = "获取状态时启动门闩为空";
  public static final String START_STATUS_WHEN_GETTING_STATUS = "获取状态时启动状态为 {}";
  public static final String STOP_LATCH_NULL_WHEN_GETTING_STATUS = "获取状态时停止门闩为空";
  public static final String STOP_LATCH_WHEN_GETTING_STATUS = "获取状态时停止门闩为 {}";
  public static final String SERVICE_ALREADY_RUNNING = "{}: {} 已在运行中";
  public static final String START_SERVICE = "{}: 启动 {}...";
  public static final String START_SERVICE_SUCCESSFULLY = "{}: {} 启动成功，监听 IP {} 端口 {}";
  ...
  public static final String GC_ALERT_ACCUMULATED_GC_TIME = "当前观察窗口内累计 GC 时间：{} 毫秒";
  public static final String GC_ALERT_OBSERVATION_WINDOW_FROM_TO = "观察窗口从：{} 到：{}";
  public static final String GC_ALERT_OBSERVATION_WINDOW_TIME = "观察窗口时长：{} 毫秒。";

  // ---- JvmGcMonitorMetrics ----
  public static final String JVM_GC_MONITOR_STOPPED = "JVM GC 定时监控已成功停止。";

  // ---- MetricService ----
  public static final String LOAD_METRIC_REPORTERS = "加载指标上报器，类型：{}";
  public static final String FAILED_TO_LOAD_REPORTER = "加载类型为 {} 的上报器失败";
  public static final String METRIC_SERVICE_START_TO_INIT = "指标服务开始初始化。";
  public static final String METRIC_SERVICE_START_SUCCESSFULLY = "指标服务启动成功。";
  public static final String METRIC_SERVICE_FAILED_TO_START = "指标服务启动 {} 失败，原因：";
  public static final String METRIC_SERVICE_TRY_TO_RESTART = "指标服务尝试重启。";
  public static final String METRIC_SERVICE_REBIND_METRIC_SET = "指标服务重新绑定指标集：{}";
  public static final String METRIC_SERVICE_RESTART_SUCCESSFULLY = "指标服务重启成功。";
  public static final String METRIC_SERVICE_TRY_TO_STOP = "指标服务尝试停止。";
  public static final String METRIC_SERVICE_STOP_SUCCESSFULLY = "指标服务停止成功。";
  public static final String METRIC_SERVICE_RELOAD_INTERNAL_REPORTER = "指标服务重新加载内部上报器。";
  public static final String METRIC_SERVICE_RELOAD_INTERNAL_REPORTER_SUCCESSFULLY =
      "指标服务重新加载内部上报器成功。";
  public static final String METRIC_SERVICE_RESTART_REPORTERS_SUCCESSFULLY = "指标服务重启上报器成功。";
  public static final String NOTHING_CHANGED_IN_METRIC_CONFIG = "指标配置未发生变更。";
  public static final String INTERNAL_REPORTER_FAILED_TO_START = "内部上报器启动失败！";
