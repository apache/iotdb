...
public final class PathMessages {
  ...
  public static final String ONLY_MEASUREMENT_PATH_SUPPORT_ALIAS = "仅 MeasurementPath 支持别名";
  ...
  public static final String ALIGNED_PATH_NO_MEASUREMENT_NAME = "AlignedPath 没有测点名称！";
  public static final String PATH_IS_ILLEGAL = "路径非法：{}";

  // MeasurementPath deserialization
  public static final String UNKNOWN_MEASUREMENT_SCHEMA_TYPE = "measurementSchema 的类型（%s）未知。";
  ...
  public static final String
      EXCEPTION_NODES_LENGTH_MEASUREMENTPATH_SHOULD_ALWAYS_GREATER_THAN_2_CURRENT_39B913AE =
          "MeasurementPath 的 nodes.length 应始终大于 2，当前为：";
  public static final String EXCEPTION_WILDCARDS_NOT_ALLOWED_PREFIX_PATH_948C42D1 =
      "前缀路径中不允许使用通配符：";
}
