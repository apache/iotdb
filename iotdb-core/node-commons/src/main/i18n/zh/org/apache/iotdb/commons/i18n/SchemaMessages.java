...
public final class SchemaMessages {
  ...
  public static final String UNKNOWN_TABLE_UPDATE_OPERATION_TYPE = "未知的 table 更新操作类型%s";

  // Column 相关消息
  public static final String UNSUPPORTED_COLUMN_TYPE_IN_TSFILE = "TsFile 中不支持的列类型：%s";
  ...
  public static final String CANNOT_CALCULATE_VIEW_SCHEMA_SIZE = "序列化之前无法计算 view schema 的大小。";
  ...
  // Filter 相关消息
  public static final String UNSUPPORTED_SCHEMA_FILTER_TYPE = "不支持的 schema filter 类型：%s";
  ...
  public static final String TOO_MANY_DOTS_IN_TABLE_NAME = "表名中含有过多的点号：%s";

  public static final String S_IS_NULL = "%s 为 null";
  // ---------------------------------------------------------------------------
