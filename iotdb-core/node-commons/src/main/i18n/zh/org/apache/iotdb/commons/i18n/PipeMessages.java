...
public final class PipeMessages {
  ...
  public static final String FAILED_TO_CLOSE_TEMPORARY_SOURCE = "关闭临时 source 失败：{}";
  public static final String FAILED_TO_CLOSE_TEMPORARY_PROCESSOR = "关闭临时 processor 失败：{}";
  public static final String FAILED_TO_CLOSE_TEMPORARY_CONNECTOR = "关闭临时 connector 失败：{}";

  // ===================== PipePluginExecutableManager =====================

  public static final String FAILED_TO_READ_MD5_FOR_PIPE_PLUGIN = "读取 pipe 插件 {} 的 MD5 文件失败";

  // ===================== AbstractPipePeriodicalJobExecutor =====================

  public static final String PERIODICAL_JOB_FAILED = "定时任务 {} 执行失败。";
  public static final String PERIODICAL_JOB_REGISTERED = "Pipe 定时任务 {} 注册成功。间隔：{} 秒。";
  public static final String PERIODICAL_JOB_EXECUTOR_STARTED = "Pipe 定时任务执行器已成功启动。";
  public static final String PERIODICAL_JOB_EXECUTOR_STOPPED = "Pipe 定时任务执行器已成功停止。";
  public static final String PERIODICAL_JOBS_CLEARED = "所有 pipe 定时任务已成功清除。";
  ...
  public static final String NOT_ENOUGH_MEMORY_FOR_PIPE_FORMAT =
      NOT_ENOUGH_MEMORY_FOR_PIPE + "需要内存：%d 字节，空闲内存：%d 字节，保留内存：%d 字节，" + "总内存：%d 字节";
  ...
  public static final String INTERRUPTED_ACQUIRING_READ_LOCK = "获取 pipeMetaKeeper 读锁时被中断。";
  public static final String INTERRUPTED_ACQUIRING_WRITE_LOCK = "获取 pipeMetaKeeper 写锁时被中断。";
  public static final String FAILED_TO_HANDLE_SINGLE_PIPE_META_CHANGES = "处理 pipe {} 的单条元数据变更失败";
  ...
  public static final String FAILED_TO_DROP_PIPE_FORMAT = "删除 pipe %s 失败，原因：%s";
  public static final String FAILED_TO_ACQUIRE_LOCK_DROPPING_ALL = "删除所有 pipe 任务时获取锁失败，将跳过删除";
  public static final String FAILED_TO_DROP_PIPE_WITH_CREATION_TIME = "删除 pipe {}（创建时间 = {}）失败";
  public static final String STOPPED_ALL_PIPES_WITH_CRITICAL_EXCEPTION = "已停止所有存在严重异常的 pipe。";
  public static final String FAILED_TO_STOP_ALL_PIPES_RETRY = "停止所有存在严重异常的 pipe 失败，重试次数：{}。";
  public static final String INTERRUPTED_STOPPING_ALL_PIPES = "尝试停止所有存在严重异常的 pipe 时被中断，异常信息：{}";
  public static final String FAILED_TO_STOP_ALL_PIPES = "停止所有存在严重异常的 pipe 失败，异常信息：{}";
  public static final String FAILED_TO_HANDLE_PIPE_META_CHANGES_FORMAT =
      "处理 pipe %s 的元数据变更失败，原因：%s";
  public static final String FAILED_TO_HANDLE_PIPE_META_CHANGES_LOG = "处理 pipe %s 的元数据变更失败";
  public static final String CREATE_PIPE_FAILED_ENCRYPTION =
      "创建 Pipe %s 失败，因为 TsFile 配置了加密，禁止使用 Pipe";
  public static final String PIPE_ALREADY_CREATED = "Pipe {}（创建时间 = {}）已经创建。当前状态 = {}。跳过创建。";
  public static final String PIPE_ALREADY_DROPPED_RECREATING =
      "Pipe {}（创建时间 = {}）已被删除，但 pipe 任务元数据尚未清理。" + "当前状态 = {}。尝试删除并重新创建。";
  public static final String PIPE_ALREADY_DROPPED_SKIP_NO_CREATION_TIME = "Pipe {} 已被删除或尚未创建。跳过删除。";
  ...
  public static final String PIPE_STARTED_CURRENT_STATUS = "Pipe {}（创建时间 = {}）已创建。当前状态 = {}。正在启动。";
  public static final String PIPE_ALREADY_STARTED = "Pipe {}（创建时间 = {}）已经启动。当前状态 = {}。跳过启动。";
  public static final String PIPE_ALREADY_DROPPED_SKIP_STARTING_STATUS =
      "Pipe {}（创建时间 = {}）已被删除。当前状态 = {}。跳过启动。";
  public static final String PIPE_ALREADY_STOPPED = "Pipe {}（创建时间 = {}）已经停止。当前状态 = {}。跳过停止。";
  public static final String PIPE_RUNNING_STOPPING = "Pipe {}（创建时间 = {}）已启动。当前状态 = {}。正在停止。";
  public static final String PIPE_ALREADY_DROPPED_SKIP_STOPPING_STATUS =
      "Pipe {}（创建时间 = {}）已被删除。当前状态 = {}。跳过停止。";
  public static final String CREATE_ALL_PIPE_TASKS = "Pipe {} 的所有任务在 {} 毫秒内创建成功";
  public static final String DROP_ALL_PIPE_TASKS = "Pipe {} 的所有任务在 {} 毫秒内删除成功";
  public static final String START_ALL_PIPE_TASKS = "Pipe {} 的所有任务在 {} 毫秒内启动成功";
  public static final String STOP_ALL_PIPE_TASKS = "Pipe {} 的所有任务在 {} 毫秒内停止成功";
  ...
  public static final String PIPE_COMMITTER_REGISTERED = "Pipe committer 已在 region 上注册：{}";
  public static final String PIPE_COMMITTER_OVERWRITING = "同名 pipe 已在此 region 上注册，将覆盖：{}";
  public static final String PIPE_COMMITTER_DEREGISTERED = "Pipe committer 已在 region 上注销：{}";

  // ===================== BlockingPendingQueue =====================

  public static final String PENDING_QUEUE_PUT_INTERRUPTED = "待处理队列 put 操作被中断。";
  public static final String PENDING_QUEUE_POLL_INTERRUPTED = "待处理队列 poll 操作被中断。";
  ...
  public static final String INTERRUPTED_WAITING_HIGH_PRIORITY = "等待高优先级锁任务时被中断。";
  ...
  public static final String INTERRUPTED_RETRYING_SUBTASK = "重试执行子任务 {}（创建时间：{}，类名：{}）时被中断";
  public static final String SUBTASK_RETRY_EXCEEDED_FORMAT =
      "执行子任务 %s（创建时间：%s，类名：%s）失败，" + "重试次数超过最大值 %d，上次异常：%s，根因：%s";
  ...
  public static final String PATTERN_INCLUSION_CANNOT_BE_USED_WITH_PATH_EXCLUSION =
      "Pipe：%s 不能与 %s 同时使用。";
  public static final String PATH_AND_PATTERN_CANNOT_BE_USED_TOGETHER = "Pipe：%s 和 %s 不能同时使用。";
  public static final String PARAMETER_ONLY_SUPPORTS_SINGLE_PATTERN = "Pipe：参数 %s 当前只支持单个 pattern。";
  ...
  public static final String HANDSHAKE_FAILED_RETRYING = "{} 与目标系统握手失败，已重试 {} 次，最多重试 {} 次。根因：{}。";
  public static final String INTERRUPTED_WHILE_SLEEPING_RETRY_HANDSHAKE = "休眠时被中断，将重试与目标系统握手。";
  public static final String HANDSHAKE_FAILED_STOPPING =
      "{} 与目标系统握手在 {} 次尝试后失败，"
          + "正在停止当前子任务 {}（创建时间：{}，类名：{}）。"
          + "查询 pipe 时显示的状态将为 'STOPPED'。"
          + "如需要，请手动执行 'START PIPE' 重新启动任务。";
  public static final String TEMPORARILY_OUT_OF_MEMORY = "pipe 事件传输时暂时内存不足，将等待内存释放。";
  public static final String EXCEPTION_IN_PIPE_TRANSFER_FORMAT = "pipe 传输异常，子任务：%s，最后事件：%s，根因：%s";
  public static final String EXCEPTION_IN_PIPE_TRANSFER_IGNORED = "pipe 传输异常，因 sink 子任务已删除而忽略。{}";
  public static final String PIPE_EXCEPTION_IGNORED = "{} pipe 传输异常，因 connector 子任务已删除而忽略。{}";

  // ===================== PipeCompressorFactory =====================

  public static final String COMPRESSOR_CONFIG_NULL = "PipeCompressorConfig 为空";
  public static final String COMPRESSOR_CONFIG_NAME_NULL = "PipeCompressorConfig.getName() 为空";
  public static final String CREATE_ZSTD_COMPRESSOR = "创建新的 PipeZSTDCompressor，压缩级别：{}";
  public static final String COMPRESSOR_NOT_FOUND_BY_NAME = "未找到名称为 %s 的 PipeCompressor";
  public static final String COMPRESSOR_NOT_FOUND_BY_INDEX = "未找到索引为 %s 的 PipeCompressor";
  ...
  public static final String ORDER_ID_MISMATCH = "Order ID 不匹配：期望 {}，实际 {}";
  public static final String SLICE_COUNT_MISMATCH = "分片数量不匹配：期望 {}，实际 {}";

  // ===================== IoTDBSink =====================

  public static final String IOTDB_SINK_NODE_URLS = "IoTDBSink nodeUrls：{}";
  public static final String IOTDB_SINK_TABLET_BATCH_MODE = "IoTDBSink isTabletBatchModeEnabled：{}";
  ...
  public static final String SYNC_CLIENT_MANAGER_CLOSED = "IoTDB sync 客户端管理器已关闭";
  ...
  public static final String CONNECTED_TO_TARGET_SERVER = "成功连接到目标服务器 ip：{}，端口：{}。";
  public static final String FAILED_TO_CLOSE_SOCKET = "关闭与目标服务器的 socket 失败（ip：{}，端口：{}），原因：{}。已忽略。";
  public static final String FAILED_TO_CONNECT_TO_TARGET = "连接目标服务器失败（ip：{}，端口：{}），原因：{}。已忽略。";
  public static final String HANDSHAKE_ERROR_RECEIVING_END = "握手错误，可能由接收端错误引起。已忽略。根因：{}。";
  public static final String HANDSHAKE_ERROR_WITH_TARGET = "与目标服务器握手失败，endpoint：%s";
  ...
  public static final String UNKNOWN_LOAD_BALANCE_STRATEGY = "未知的负载均衡策略：{}，将使用轮询策略替代。";

  // ===================== IoTDBSyncClientManager =====================

  public static final String CLIENT_CLOSED = "客户端 {}:{} 已关闭。";
  public static final String FAILED_TO_CLOSE_CLIENT_ENDPOINT = "关闭客户端 {}:{} 失败，原因：{}。";
  public static final String FAILED_TO_INIT_CLIENT = "初始化客户端失败，目标服务器 ip：%s，端口：%s，原因：%s";

  // ===================== IoTDBNonDataRegionSource =====================

  public static final String CANNOT_GET_NEWEST_SNAPSHOT = "触发快照后无法获取最新快照。";

  // ===================== PipeInclusionOptions =====================

  public static final String ILLEGAL_PATH_INITIALIZING_OPTIONS = "初始化 LEGAL_OPTIONS 时遇到非法路径。";

  // ===================== IoTDBTreePattern / TablePattern =====================

  public static final String ILLEGAL_IOTDB_PIPE_PATTERN = "非法的 IoTDBPipePattern：%s";
  // ===================== ConcurrentIterableLinkedQueue =====================

  public static final String NULL_ELEMENT_NOT_ALLOWED = "不允许空元素。";
  public static final String CALLING_NEXT_ON_CLOSED_ITERATOR = "在已关闭的迭代器上调用 next()，将返回 null。";
  public static final String INTERRUPTED_WAITING_FOR_NEXT = "等待下一个元素时被中断。";
  ...
  public static final String UNKNOWN_SERIALIZER_TYPE = "未知的序列化器类型：%s";

  // ===================== EnrichedEvent =====================

  // ===================== PipeEventCommitMetrics =====================

  public static final String FAILED_TO_UNBIND_COMMIT_METRICS = "从 pipe 事件提交指标解绑失败，事件提交器映射不为空";

  // ===================== PipePhantomReferenceManager =====================

  public static final String CLEAN_PHANTOM_REFERENCES = "在 {} 毫秒内成功清理 {} 个 pipe 虚引用，剩余引用数：{}";
  public static final String REMAINING_PHANTOM_REFERENCE_COUNT = "剩余 pipe 虚引用数量：{}";
  public static final String PIPE_EVENT_RESOURCE_LEAK = "检测到 PIPE 事件资源泄漏（{}）：{}";

  // ===================== PipeSnapshotResourceManager =====================

  public static final String CANNOT_FIND_SNAPSHOT_PATH = "无法在 pipe 目录中找到 {} 的正确目标快照路径";
  public static final String CANNOT_FIND_SNAPSHOT_PATH_EXCEPTION = "无法在 pipe 目录中找到 %s 的正确目标快照路径";

  // ===================== IoTDBReceiverAgent =====================

  public static final String CLEAN_RECEIVER_DIR_SUCCESS = "清理 pipe 接收目录 {} 成功。";
  public static final String CLEAN_RECEIVER_DIR_FAILED = "清理 pipe 接收目录 {} 失败。";
  public static final String CREATE_RECEIVER_DIR_SUCCESS = "创建 pipe 接收目录 {} 成功。";
  public static final String CREATE_RECEIVER_DIR_FAILED = "创建 pipe 接收目录 {} 失败。";

  // ===================== PipeReceiverFilePathUtils =====================

  public static final String ILLEGAL_FILENAME_PATH_TRAVERSAL = "非法文件名：%s（检测到路径遍历）";

  // ===================== IoTDBFileReceiver =====================

  public static final String RECEIVER_HANDSHAKE_FAILED = "握手失败，响应状态 = %s。";
  public static final String RECEIVER_HANDSHAKE_FAILED_WITH_ID = "接收器 id = %s：握手失败，响应状态 = %s。";
  public static final String RECEIVER_HANDSHAKE_FAILED_LOGIN = "接收器 id = %s：因登录失败导致握手失败，响应状态 = %s。";
  public static final String RECEIVER_TEMPORARILY_OUT_OF_MEMORY_FORMAT =
      "执行 %s 时暂时内存不足。请求内存：%d bytes。根因：%s";
  public static final String RECEIVER_USER_LOGIN_SUCCESS = "接收器 id = {}：用户 {} 登录成功。";
  public static final String RECEIVER_EXITED = "接收器 id = {}：处理退出：接收器已退出。";
  public static final String RECEIVER_ORIGINAL_DIR_DELETED = "接收器 id = {}：原始接收文件目录 {} 已删除。";
  public static final String RECEIVER_FAILED_DELETE_ORIGINAL_DIR =
      "接收器 id = %s：删除原始接收文件目录 %s 失败，原因：%s。";
  public static final String RECEIVER_ORIGINAL_DIR_NOT_EXIST = "接收器 id = {}：原始接收文件目录 {} 不存在。无需删除。";
  public static final String RECEIVER_DIR_NULL_NO_DELETE = "接收器 id = {}：当前接收文件目录为空。无需删除。";
  ...
  public static final String RECEIVER_FAILED_CREATE_DIR = "接收器 id = %s：创建接收文件目录 %s 失败。";
  public static final String RECEIVER_FAILED_CREATE_DIR_STATUS = "创建接收文件目录 %s 失败。";
  public static final String RECEIVER_CANNOT_GET_CLUSTER_ID = "接收器无法从配置节点获取 clusterId。";
  public static final String RECEIVER_NO_CLUSTER_ID_IN_REQUEST = "握手请求中不包含 clusterId。";
  public static final String RECEIVER_SAME_CLUSTER = "接收器和发送器来自同一集群 %s。";
  public static final String RECEIVER_NO_TIMESTAMP_PRECISION = "握手请求中不包含 timestampPrecision。";
  public static final String RECEIVER_TIMESTAMP_PRECISION_MISMATCH =
      "IoTDB 接收器的时间精度为 %s，connector 的时间精度为 %s。校验失败。";
  public static final String RECEIVER_FAILED_LOGIN = "接收器 id = %s：登录失败，用户名 = %s，响应 = %s。";
  public static final String RECEIVER_FILE_OFFSET_RESET = "接收器 id = %s：接收器请求文件偏移量重置，响应状态 = %s。";
  public static final String RECEIVER_FAILED_WRITE_FILE_PIECE = "接收器 id = %s：写入文件片段失败，请求 %s。";
  public static final String FAILED_TO_WRITE_FILE_PIECE = "写入文件片段失败，原因：%s";
  public static final String RECEIVER_WRITING_FILE_NOT_EXIST =
      "接收器 id = {}：写入文件 {} 不存在或名称不正确，尝试创建。当前写入文件为 {}。";
  public static final String RECEIVER_FILE_DIR_CREATED = "接收器 id = {}：接收文件目录 {} 已创建。";
  public static final String RECEIVER_FAILED_CREATE_FILE_DIR = "接收器 id = {}：创建接收文件目录 {} 失败。";
  public static final String RECEIVER_WRITING_FILE_CREATED = "接收器 id = {}：写入文件 {} 已创建。准备写入文件片段。";
  public static final String RECEIVER_ILLEGAL_FILENAME = "接收器 id = %s：检查写入文件时遇到非法文件名 %s。";
  public static final String RECEIVER_PATH_TRAVERSAL = "接收器 id = {}：检测到路径遍历攻击！文件名：{}";
  public static final String RECEIVER_WRITER_CLOSED = "接收器 id = {}：当前写入文件 writer {} 已关闭，长度 {}。";
  public static final String RECEIVER_FAILED_CLOSE_WRITER =
      "接收器 id = %s：关闭当前写入文件 writer %s 失败，原因：%s。";
  public static final String RECEIVER_WRITER_NULL = "接收器 id = {}：当前写入文件 writer 为空。无需关闭。";
  public static final String RECEIVER_FILE_NULL = "接收器 id = {}：当前写入文件为空。无需删除。";
  public static final String RECEIVER_ORIGINAL_FILE_DELETED = "接收器 id = {}：原始写入文件 {} 已删除。";
  public static final String RECEIVER_FAILED_DELETE_FILE = "接收器 id = %s：删除原始写入文件 %s 失败，原因：%s。";
  public static final String RECEIVER_ORIGINAL_FILE_NOT_EXIST = "接收器 id = {}：原始文件 {} 不存在。无需删除。";
  ...
  public static final String RECEIVER_FILE_NOT_AVAILABLE =
      "接收器 id = {}：写入文件 {} 不可用。" + "写入文件为空：{}，写入文件存在：{}，写入文件 writer 为空：{}。";
  public static final String FAILED_TO_SEAL_FILE_NOT_AVAILABLE = "封存文件失败，因为写入文件 %s 不可用。";
  public static final String FAILED_TO_SEAL_FILE_WRITING_FILE_MISMATCH = "封存文件 %s 失败，因为写入文件为 %s。";
  public static final String RECEIVER_FAILED_SEAL_FILE_WRITING =
      "接收器 id = %s：封存文件 %s 失败，因为写入文件为 %s。";
  public static final String FAILED_TO_SEAL_FILE_NOT_EXIST = "封存文件 %s 失败，文件不存在。";
  ...
  public static final String FAILED_TO_SEAL_FILE_LENGTH_INCORRECT =
      "封存文件 %s 失败，文件长度不正确。" + "原始文件长度为 %s，但接收文件长度为 %s。";
  public static final String RECEIVER_FAILED_SEAL_FILE_LENGTH_INCORRECT =
      "接收器 id = %s：封存文件 %s 失败，文件长度不正确。" + "原始文件长度为 %s，但接收文件长度为 %s。";
  public static final String RECEIVER_SEAL_FILE_SUCCESS = "接收器 id = {}：封存文件 {} 成功。";
  public static final String RECEIVER_FAILED_SEAL_FILE = "接收器 id = %s：封存文件 %s 失败，原因：%s。";
  public static final String RECEIVER_FAILED_SEAL_FILE_STATUS = "接收器 id = %s：封存文件 %s 失败，状态为 %s。";
  public static final String RECEIVER_FAILED_SEAL_FILE_FROM_REQ = "接收器 id = %s：从请求 %s 封存文件 %s 失败。";
  public static final String FAILED_TO_SEAL_FILE = "封存文件 %s 失败，原因：%s";
  public static final String FAILED_TO_SEAL_FILE_MULTI = "封存文件 %s 失败，因为写入文件 %s 不可用。";
  public static final String REQUEST_SENDER_RESET_OFFSET = "请求发送方将文件读取器偏移量从 %s 重置为 %s。";
  public static final String RECEIVER_EXIT_WRITER_CLOSED = "接收器 id = {}：处理退出：写入文件 writer 已关闭。";
  public static final String RECEIVER_EXIT_CLOSE_WRITER_ERROR =
      "接收器 id = {}：处理退出：关闭写入文件 writer 出错。";
  public static final String RECEIVER_EXIT_WRITER_NULL = "接收器 id = {}：处理退出：写入文件 writer 为空。无需关闭。";
  public static final String RECEIVER_EXIT_FILE_DELETED = "接收器 id = {}：处理退出：写入文件 {} 已删除。";
  public static final String RECEIVER_EXIT_DELETE_FILE_ERROR = "接收器 id = {}：处理退出：删除写入文件 {} 出错。";
  public static final String RECEIVER_EXIT_FILE_NULL = "接收器 id = {}：处理退出：写入文件为空。无需删除。";
  public static final String RECEIVER_EXIT_DIR_DELETED = "接收器 id = {}：处理退出：原始接收文件目录 {} 已删除。";
  public static final String RECEIVER_EXIT_DELETE_DIR_ERROR = "接收器 id = {}：处理退出：删除原始接收文件目录 {} 出错。";
  public static final String RECEIVER_EXIT_DIR_NOT_EXIST = "接收器 id = {}：处理退出：原始接收文件目录 {} 不存在。无需删除。";
  public static final String RECEIVER_EXIT_DIR_NULL = "接收器 id = {}：处理退出：原始接收文件目录为空。无需删除。";

  // ===================== PipeReceiverStatusHandler =====================

  public static final String IOT_CONSENSUS_RETRY_WITH_INTERVAL = "IoTConsensusV2：将以递增间隔重试。状态：{}";
  public static final String IOT_CONSENSUS_WILL_NOT_RETRY = "IoTConsensusV2：将不再重试。状态：{}";
  public static final String IDEMPOTENT_CONFLICT_IGNORED = "幂等冲突异常：将被忽略。状态：{}";
  public static final String TEMPORARY_UNAVAILABLE_RETRY = "临时不可用异常：将无限重试。状态：%s，消息：%s";
  public static final String USER_CONFLICT_IGNORED = "{}：无权限时跳过。将被忽略。事件：{}。状态：{}";
  public static final String USER_CONFLICT_RETRY_TIMEOUT = "用户冲突异常：重试超时。将被忽略。事件：{}。状态：{}";
  public static final String USER_CONFLICT_WILL_RETRY = "用户冲突异常：将重试 {}。状态：{}";
  public static final String MESSAGE_FOR_AT_LEAST_ADE37405 = "至少 ";
  public static final String USER_CONFLICT_NOT_ALLOWED = "用户冲突异常：因不允许重试而被忽略。事件：{}。状态：{}";
  public static final String OTHER_EXCEPTION_RETRY_TIMEOUT = "{}：重试超时。将被忽略。事件：{}。状态：{}";
  public static final String OTHER_EXCEPTION_RETRY_FOREVER = "%s：将无限重试。状态：%s，消息：%s";
  public static final String OTHER_EXCEPTION_RETRY_SECONDS = "{}：将至少重试 {} 秒。状态：{}";
  ...
  public static final String THROWING_EXCEPTION_IN_PROCESS_TABLET =
      "在 process(TabletInsertionEvent, EventCollector) 中抛出异常";
  public static final String THROWING_EXCEPTION_IN_PROCESS_TSFILE =
      "在 process(TsFileInsertionEvent, EventCollector) 中抛出异常";
  public static final String THROWING_EXCEPTION_IN_PROCESS_EVENT =
      "在 process(Event, EventCollector) 中抛出异常";
  ...
  public static final String FAILED_TO_COMPUTE_MD5 = "注册函数 %s 失败，因为计算函数 %s 的 jar 文件 MD5 时发生错误 ";
  ...
  public static final String ILLEGAL_OPTIONS_CHECKING_LEGAL = "检查所有选项是否合法时解析到非法选项 {}：{}";
  ...
  public static final String HANDSHAKE_ERROR_WITH_TARGET_RETRY =
      "与目标服务器握手出错（ip：{}，端口：{}），原因：{}。" + "将使用 PipeTransferHandshakeV1Req 重试握手。";
  public static final String HANDSHAKE_ERROR_WITH_TARGET_SERVER = "与目标服务器握手出错（ip：{}，端口：{}），原因：{}。";
  public static final String HANDSHAKE_SUCCESS_TARGET = "握手成功。目标服务器 ip：{}，端口：{}";
  public static final String ALL_CLIENTS_DEAD = "所有客户端均不可用，请检查与接收器的连接。";
  public static final String ALL_SOCKETS_DEAD = "所有 socket 均不可用，请检查与接收器的连接。";
  public static final String ALL_TARGET_SERVERS_NOT_AVAILABLE = "所有目标服务器 %s 均不可用。";
  ...
  public static final String FAILED_TO_RECONNECT = "重新连接目标服务器失败，原因：{}。稍后将重试连接。";

  // ===================== IoTDBReceiverAgent (additional) =====================

  public static final String RECEIVER_VERSION_MISMATCH = "接收器版本 {} 与发送器版本 {} 不同，接收器将被重置为发送器版本。";
  public static final String UNSUPPORTED_PIPE_VERSION = "不支持的 pipe 版本 %d";

  // ===================== PipeEventCommitManager (additional) =====================

  public static final String FAILED_TO_MARK_COMMIT_RATE = "标记 pipe 任务提交速率失败：{}，堆栈跟踪：{}";
  ...
  public static final String PARSE_URL_ERROR = "解析目标服务器节点 URL 时发生异常：{}";
  ...
  public static final String EXCEPTION_UNSUPPORTED_PIPERUNTIMEEXCEPTION_TYPE_ARG_C5D5D84C =
      "不支持的 PipeRuntimeException 类型 %s.";
