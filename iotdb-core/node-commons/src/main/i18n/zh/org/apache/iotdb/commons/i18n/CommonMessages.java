...
public final class CommonMessages {
  ...
  // --- consensus ---
  public static final String UNRECOGNIZED_CONSENSUS_GROUP_ID = "无法识别的 ConsensusGroupId：%s";
  public static final String IOTV2_BG_NOT_TERMINATED = "IoTV2 后台服务在 {}s 内未终止";
  public static final String IOTV2_BG_STILL_RUNNING = "IoTV2 后台线程在 30s 后仍未退出";
  ...
  // --- memory ---
  public static final String MEMORY_ALLOC_INTERRUPTED = "exactAllocate：等待可用内存时被中断";
  public static final String MEMORY_RELEASE_FAILED = "releaseWithOutNotify：关闭内存块 {} 失败";
  public static final String MEMORY_RELEASE_FAILED_NO_DETAIL = "releaseWithOutNotify：关闭内存块失败";
  ...
  public static final String BASE_VALUE_SHOULD_NOT_BE_NULL = "比较时基准值不应为 null";
  public static final String SIZE_MUST_BE_POSITIVE = "Size 必须大于 0";

  // --- sync ---
  public static final String UNEXPECTED_SERIALIZATION_ERROR = "序列化 PipeInfo 时发生意外错误。";
  ...
  // --- binaryallocator ---
  public static final String BINARY_ALLOCATOR_RUNNING_GC_EVICTION = "二进制分配器正在执行 GC 驱逐";
  public static final String BINARY_ALLOCATOR_SHUTTING_DOWN_HIGH_GC =
      "由于 GC 时间百分比过高 ({}%)，二进制分配器正在关闭。";
  public static final String AUTO_RELEASER_EXIT_INTERRUPTED = "{} 因 InterruptedException 退出。";
  public static final String STOPPING_COMPONENT = "正在停止 {}";
  public static final String UNABLE_TO_STOP_AUTO_RELEASER = "在 {} 毫秒后仍无法停止自动释放器";
  ...
  public static final String ITERATOR_REMOVE_ONLY_AFTER_NEXT =
      "Iterator remove() 只能在 next() 之后调用一次";
  public static final String FAIL_TO_GET_DATA_TYPE_IN_ROW = "获取行中数据类型失败，行时间：";
  // ---------------------------------------------------------------------------
  // Additional auto-collected messages
  // ---------------------------------------------------------------------------
  public static final String LOG_STEP_METRICS_ARG_ARG_TOTAL_ARG_SUM_2FMS_AVG_ARG_87491AB0 =
      "步骤指标 [%d]-[%s] - 总数: %d, 总和: %.2fms, 平均: %fms, 最近%d次平均: %fms";
  public static final String
      LOG_ERROR_OCCURRED_DURING_TRANSFERRING_FILE_ARG_BYTEBUFFER_CAUSE_ARG_FEDC38A3 =
          "传输文件{}到 ByteBuffer 时发生错误，原因：{}";
  public static final String LOG_ERROR_OCCURRED_DURING_WRITING_BYTEBUFFER_ARG_CAUSE_ARG_F3AD2DA0 =
      "向 {} 写入 bytebuffer 时发生错误，原因：{}";
  public static final String EXCEPTION_SIZE_FILE_EXCEED_ARG_BYTES_C60F1149 = "文件大小超过 %d 字节";
  public static final String EXCEPTION_UNRECOGNIZED_TCONSENSUSGROUPTYPE_9204FF8E =
      "无法识别的 TConsensusGroupType: ";
  ...
  public static final String
      LOG_MEMORY_COST_RELEASED_LARGER_THAN_MEMORY_COST_MEMORY_BLOCK_ARG_00DD9DA9 =
          "待释放的内存开销大于内存块 {} 的内存开销";
  public static final String LOG_EXACTALLOCATEIFSUFFICIENT_FAILED_ALLOCATE_MEMORY_A47897D9 =
      "exactAllocateIfSufficient: 无法分配内存, ";
  public static final String LOG_TOTAL_MEMORY_SIZE_ARG_BYTES_USED_MEMORY_SIZE_ARG_BYTES_5FB5059F =
      "总内存大小 {} 字节，已用内存大小 {} 字节，";
  public static final String LOG_REQUESTED_MEMORY_SIZE_ARG_BYTES_USED_THRESHOLD_ARG_D7061DEB =
      "请求内存大小 {} 字节，已用阈值 {}";
  public static final String LOG_TRYALLOCATE_ALLOCATED_MEMORY_B3D564D9 = "tryAllocate: 已分配内存, ";
  public static final String LOG_ORIGINAL_REQUESTED_MEMORY_SIZE_ARG_BYTES_03D28A6B =
      "原始请求内存大小 {} 字节，";
  ...
  public static final String
      LOG_GETORREGISTERMEMORYBLOCK_FAILED_MEMORY_BLOCK_ARG_ALREADY_EXISTS_42CA8914 =
          "getOrRegisterMemoryBlock 失败：内存块 {} 已存在，";
  ...
  public static final String
      LOG_GETMEMORYMANAGER_MEMORY_MANAGER_ARG_ALREADY_EXISTS_IT_S_SIZE_ARG_0102560A =
          "getMemoryManager：内存管理器 {} 已存在，其大小为 {}，enabled 为 {}";
  public static final String
  ...
  public static final String
      EXCEPTION_TMP_SYSTEM_PROPERTIES_FILE_MUST_EXIST_CALL_REPLACEFORMALFILE_FA63B976 =
          "调用 replaceFormalFile 时，临时 system properties 文件必须存在";
  public static final String
  ...
  public static final String
      LOG_UNRECOVERABLE_ERROR_OCCURS_SHUTDOWN_SYSTEM_DIRECTLY_BECAUSE_HANDLE_SYSTEM_ERROR_14FC06C9 =
          "发生不可恢复错误！由于 handle_system_error 为 SHUTDOWN，直接关闭系统。";
  public static final String EXCEPTION_TYPE_ARG_NOT_SUPPORTED_PIPE_RATE_AVERAGE_F74694AD =
      "pipe rate average 不支持类型 %s。";
  ...
  public static final String EXCEPTION_CAN_NOT_RECOGNIZE_PIPETYPE_ARG_8850A249 =
      "无法识别 PipeType %s。";
  public static final String EXCEPTION_TARGETREGIONLIST_EMPTY_DEVICE_ARG_TIMESLOT_ARG_E7E5818C =
      "targetRegionList 为空。device：%s，timeSlot：%s";
  ...
  public static final String
      EXCEPTION_NOT_EXISTS_FAILED_CREATE_AUTOMATICALLY_BECAUSE_ENABLE_AUTO_CREATE_SCHEMA_80DE1A4B =
          " 不存在，且无法自动创建，原因：enable_auto_create_schema 为 FALSE。";
  public static final String EXCEPTION_PATH_DOES_NOT_EXIST_737CB95D = "路径不存在。";
  public static final String EXCEPTION_CAN_T_GET_NEXT_FOLDER_ARG_BECAUSE_THEY_ALL_FULL_A105BB2D =
      "无法从 [%s] 获取下一个文件夹，原因：全部文件夹都已满。";
  public static final String
      EXCEPTION_PARAMETER_ARG_CAN_NOT_ARG_PLEASE_SET_ARG_BECAUSE_ARG_749738D1 =
          "参数 %s 不能为 %s，请设置为：%s。原因：%s";
  ...
  public static final String EXCEPTION_UNEXPECTED_ERROR_OCCURS_SERIALIZATION_A6B2E222 =
      "序列化时发生意外错误";
  public static final String EXCEPTION_COLUMN_ARG_TABLE_ARG_ARG_DOES_NOT_EXIST_D8145581 =
      "列 %s 在表 '%s.%s' 中不存在。";
  ...
  public static final String
      EXCEPTION_COULDN_T_CONSTRUCTOR_SERIESPARTITIONEXECUTOR_CLASS_ARG_34FB9F45 =
          "无法构造 SeriesPartitionExecutor 类：%s";
  public static final String EXCEPTION_CANNOT_USE_SETVALUE_OBJECT_BEING_SET_ALREADY_MAP_676ED3BF =
      "对象已在 map 中时，不能使用 setValue()";
  public static final String
      EXCEPTION_ITERATOR_GETKEY_CAN_ONLY_CALLED_AFTER_NEXT_BEFORE_REMOVE_009C456B =
          "Iterator getKey() 只能在 next() 之后、remove() 之前调用";
  public static final String
      EXCEPTION_ITERATOR_GETVALUE_CAN_ONLY_CALLED_AFTER_NEXT_BEFORE_REMOVE_927A88A2 =
          "Iterator getValue() 只能在 next() 之后、remove() 之前调用";
  public static final String
      EXCEPTION_ITERATOR_SETVALUE_CAN_ONLY_CALLED_AFTER_NEXT_BEFORE_REMOVE_51505AD1 =
          "Iterator setValue() 只能在 next() 之后、remove() 之前调用";
  public static final String LOG_FAILED_CLOSE_UDFCLASSLOADER_QUERYID_ARG_BECAUSE_ARG_8B1C3739 =
      "无法关闭 UDFClassLoader (queryId: {})，原因：{}";
  public static final String EXCEPTION_ATTRIBUTE_ARG_ARG_REQUIRED_BUT_WAS_NOT_PROVIDED_CD090883 =
      "attribute \"%s\"/\"%s\" 为必填项，但未提供。";
  public static final String EXCEPTION_USE_ATTRIBUTE_ARG_ARG_ONLY_ONE_AT_TIME_B431468C =
      "只能同时使用 attribute \"%s\" 或 \"%s\" 中的一个。";
  public static final String
      EXCEPTION_ILLEGAL_OUTLIER_METHOD_OUTLIER_TYPE_SHOULD_AVG_STENDIS_COS_PRENEXTDIS_91D1C70A =
          "非法 outlier 方法。outlier 类型应为 avg、stendis、cos 或 prenextdis。";
  public static final String
  ...
  public static final String
      EXCEPTION_CUMULATIVE_TABLE_FUNCTION_REQUIRES_SIZE_MUST_INTEGRAL_MULTIPLE_STEP_D8A9DA94 =
          "累积表函数要求 size 必须是 step 的整数倍。";
  public static final String EXCEPTION_COLUMN_TYPE_MUST_NUMERIC_IF_DELTA_NOT_0_F7864D4E =
      "DELTA 不为 0 时，列类型必须为数值类型。";
  public static final String EXCEPTION_TYPE_COLUMN_ARG_NOT_AS_EXPECTED_7A81636E =
      "列 [%s] 的类型不符合预期。";
  public static final String
      EXCEPTION_REQUIRED_COLUMN_ARG_NOT_FOUND_SOURCE_TABLE_ARGUMENT_993E1C08 = "未在源表参数中找到必需列 [%s]。";
  public static final String EXCEPTION_UNSUPPORTED_PROGRESS_INDEX_TYPE_ARG_A84CDFF9 =
      "不支持的进度索引类型 %s。";
  public static final String
      EXCEPTION_TIMEWINDOWSTATEPROGRESSINDEX_DOES_NOT_SUPPORT_TOPOLOGICAL_SORTING_897C8976 =
          "TimeWindowStateProgressIndex 不支持拓扑排序";
  public static final String
  ...
  public static final String
      EXCEPTION_TABLE_ARGUMENT_WITH_SET_SEMANTICS_REQUIRES_AN_ORDER_BY_CLAUSE_10C986D9 =
          "具有 set 语义的 table 参数需要 ORDER BY 子句。";
  public static final String EXCEPTION_THE_TYPE_OF_THE_COLUMN_ARG_IS_NOT_COMPARABLE_E3098096 =
      "列 [%s] 的类型不可比较。";
  public static final String EXCEPTION_NO_COMPARABLE_COLUMNS_FOUND_FOR_M4_CALCULATION_4E5A3092 =
      "未找到可用于 M4 计算的可比较列。";
  public static final String
