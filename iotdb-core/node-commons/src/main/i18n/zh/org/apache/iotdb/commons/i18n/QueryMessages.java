...
public final class QueryMessages {
  ...
  // ---------------------------------------------------------------------------
  public static final String EXCEPTION_UNKNOWN_TYPE_BC7EAB78 = "未知的type: ";
  public static final String EXCEPTION_UNEXPECTED_ROWSPERMATCH_F9B931C9 = "unexpected rowsPerMatch: ";
  public static final String EXCEPTION_UNSUPPORTED_FILL_METHOD_0809912A = "不支持的fill method: ";
  public static final String EXCEPTION_EXCEPTNODE_SHOULD_NEVER_SERIALIZED_CURRENT_VERSION_6F5B4EE0 = "Except节点 应never be 序列化d in 当前version";
  public static final String EXCEPTION_EXCEPTNODE_SHOULD_NEVER_DESERIALIZED_CURRENT_VERSION_690C18F0 = "Except节点 应never be de序列化d in 当前version";
  public static final String EXCEPTION_INTERSECTNODE_SHOULD_NEVER_SERIALIZED_CURRENT_VERSION_68D2C0D3 = "Intersect节点 应never be 序列化d in 当前version";
  public static final String EXCEPTION_INTERSECTNODE_SHOULD_NEVER_DESERIALIZED_CURRENT_VERSION_A3614371 = "Intersect节点 应never be de序列化d in 当前version";
  ...
  public static final String EXCEPTION_EXPECTED_ARG_FIELDS_COMMA_GOT_ARG_498063F2 = "期望 %s fields, got %s";
  public static final String EXCEPTION_MISSING_TABLE_ARGUMENT_COLON_ARG_4F1E9F4E = "Missing table argument: %s";
  public static final String EXCEPTION_TABLE_ARGUMENT_SPECIFICATION_CANNOT_HAVE_A_DEFAULT_VALUE_DOT_009A02CA = "Table argument specification 无法 have a default value.";
  ...
  public static final String EXCEPTION_UNEXPECTED_OFFSET_ROWCOUNT_COLON_977E305C = "un期望 OFFSET rowCount: ";
  public static final String EXCEPTION_INVALID_LIMIT_NODE_TYPE_DOT_EXPECTED_COLON_LIMIT_DOT_ACTUAL_COLON_ARG_5BCD1C76 = "无效的 limit node type. 期望: Limit. Actual: %s";
  public static final String EXCEPTION_UNEXPECTED_LIMIT_ROWCOUNT_COLON_CFF154F0 = "un期望 LIMIT rowCount: ";
  ...
  public static final String EXCEPTION_OUTPUT_FIELDS_IS_NULL_FOR_SELECT_ITEM_ARG_56AFEC51 = "output fields 不能为空 for select item %s";
  ...
  public static final String EXCEPTION_MINIMUMREQUIREDCAPACITY_MUST_BE_POSITIVE_81638118 = "minimumRequiredCapacity 必须为 positive";
  public static final String EXCEPTION_EXPECTEDSIZE_MUST_BE_GREATER_THAN_ZERO_DA2E0345 = "期望Size 必须为 greater than zero";
  ...
  public static final String EXCEPTION_ORDERBY_KEYS_AND_ORDERINGS_DON_QUOTE_T_MATCH_E0334493 = "orderBy keys 和 orderings don't match";
  ...
  public static final String EXCEPTION_UNEXPECTED_EXPRESSION_COLON_ARG_8E4AC833 = "Un期望 expression: %s";
  ...
  public static final String EXCEPTION_BASE_TYPE_NAME_CANNOT_BE_A_TYPE_VARIABLE_71E810A9 = "Base type name 无法 be a type variable";
  ...
  public static final String EXCEPTION_PARAMETERS_FOR_ROW_TYPE_MUST_BE_NAMED_TYPE_PARAMETERS_6AADD078 = "Parameters for ROW type 必须为 NAMED_TYPE parameters";
  ...
  public static final String EXCEPTION_INVALID_NAME_ARG_AD3FA0BF = "无效的 name %s";
  public static final String EXCEPTION_INVALID_NAME_COLON_LEFT_BRACKET_ARG_RIGHT_BRACKET_C46F15A4 = "无效的 name: [%s]";
  ...
  public static final String EXCEPTION_ARG_JOIN_CANNOT_HAVE_JOIN_CRITERIA_3B23E0D1 = "%s join 无法 have join criteria";
  ...
  public static final String EXCEPTION_GROUPING_SETS_CANNOT_BE_EMPTY_8E0BE7DB = "grouping sets 无法 be empty";
  ...
  public static final String EXCEPTION_UNEXPECTED_ROWCOUNT_CLASS_COLON_ARG_170FC7CD = "un期望 rowCount class: %s";
  ...
  public static final String EXCEPTION_LINE_MUST_BE_AT_LEAST_ONE_COMMA_GOT_COLON_ARG_6BA7A99C = "line 必须为 at least one, got: %s";
  public static final String EXCEPTION_COLUMN_MUST_BE_AT_LEAST_ONE_COMMA_GOT_COLON_ARG_4A529240 = "column 必须为 at least one, got: %s";
  ...
  public static final String EXCEPTION_EXPECTED_AT_LEAST_2_TERMS_87CD9010 = "期望 at least 2 terms";
  ...
  public static final String EXCEPTION_UNEXPECTED_IDENTIFIER_IN_SKIP_TO_ARG_58438AFC = "un期望 identifier in SKIP TO %s";
  ...
  public static final String EXCEPTION_LIMIT_MUST_BE_OPTIONAL_OF_EITHER_FETCHFIRST_OR_LIMIT_TYPE_0636CAA9 = "limit 必须为 optional of either FetchFirst 或 Limit type";
  ...
  public static final String EXCEPTION_VALUES_CANNOT_BE_EMPTY_F18F863D = "values 无法 be empty";
  public static final String EXCEPTION_SELECT_IS_NULL_B45C440F = "select 不能为空";
  public static final String EXCEPTION_FROM_IS_NULL_2651BF57 = "来自 不能为空";
  ...
  public static final String EXCEPTION_RUN_IRROWPATTERNFLATTENER_FIRST_TO_REMOVE_REDUNDANT_EMPTY_PATTERN_D2FB553C = "run IrRowPatternFlattener first 到 remove redundant empty pattern";
  ...
  public static final String EXCEPTION_DECLARED_AND_ACTUAL_ROW_COUNTS_DON_QUOTE_T_MATCH_COLON_ARG_VS_ARG_EC8361A5 = "declared 和 actual row counts don't match: %s vs %s";
  ...
  public static final String EXCEPTION_MISMATCHED_ROWS_DOT_ALL_ROWS_MUST_BE_THE_SAME_SIZE_E98CF3BE = "mismatched rows. All rows 必须为 the same size";
  ...
  public static final String EXCEPTION_PREPARTITIONEDINPUTS_MUST_BE_CONTAINED_IN_PARTITIONBY_CE9DCE6F = "prePartitionedInputs 必须为 contained in partitionBy";
  public static final String EXCEPTION_CANNOT_HAVE_SORTED_MORE_SYMBOLS_THAN_THOSE_REQUESTED_52EEB7C9 = "无法 have sorted more symbols than those requested";
  ...
  public static final String EXCEPTION_ORIGINALSTARTVALUE_MUST_BE_PRESENT_IF_STARTVALUE_IS_PRESENT_30B6FDFF = "originalStartValue 必须为 present if startValue is present";
  public static final String EXCEPTION_FOR_FRAME_OF_TYPE_RANGE_COMMA_SORTKEYCOERCEDFORFRAMESTARTCOMPARISON_MUST_BE_PRES_7533A433 = "for frame of type RANGE, sortKeyCoercedForFrameStartComparison 必须为 present if startValue is present";
  public static final String EXCEPTION_ORIGINALENDVALUE_MUST_BE_PRESENT_IF_ENDVALUE_IS_PRESENT_E79EF3D2 = "originalEndValue 必须为 present if endValue is present";
  public static final String EXCEPTION_FOR_FRAME_OF_TYPE_RANGE_COMMA_SORTKEYCOERCEDFORFRAMEENDCOMPARISON_MUST_BE_PRESEN_36A665AC = "for frame of type RANGE, sortKeyCoercedForFrameEndComparison 必须为 present if endValue is present";
  ...
  public static final String EXCEPTION_INPUT_DOES_NOT_CONTAIN_SYMBOLS_FROM_CORRELATION_1B3DB7BF = "Input does not contain symbols 来自 correlation";
  public static final String EXCEPTION_EXPECTED_NEWCHILDREN_TO_CONTAIN_2_NODES_25FE7927 = "期望 newChildren 到 contain 2 nodes";
  ...
  public static final String EXCEPTION_EVERY_CHILD_NEEDS_TO_MAP_ITS_SYMBOLS_TO_AN_OUTPUT_ARG_OPERATION_SYMBOL_7FA107A2 = "Every child needs 到 map its symbols 到 an output %s operation symbol";
  ...
  public static final String EXCEPTION_FILTER_MUST_BE_AN_EXPRESSION_OF_BOOLEAN_TYPE_COLON_ARG_F358F1A8 = "Filter 必须为 an expression of boolean type: %s";
  ...
  public static final String EXCEPTION_EQUALITY_JOIN_CRITERIA_SHOULD_BE_NORMALIZED_ACCORDING_TO_JOIN_SIDES_COLON_ARG_76EB7C14 = "Equality join criteria should be normalized according 到 join sides: %s";
  public static final String EXCEPTION_EXPECTED_NEWCHILDREN_TO_CONTAIN_2_NODES_FOR_JOINNODE_BEEC3D82 = "期望 newChildren 到 contain 2 nodes for JoinNode";
  ...
  public static final String EXCEPTION_DISTINCTSYMBOLS_CANNOT_BE_EMPTY_A44A693E = "distinctSymbols 无法 be empty";
  ...
  public static final String EXCEPTION_COLUMNNAMES_AND_OUTPUTSYMBOLS_SIZES_DON_QUOTE_T_MATCH_1BDF6B28 = "columnNames 和 outputSymbols sizes don't match";
  ...
  public static final String EXCEPTION_GROUPING_SET_COUNT_MUST_BE_LARGER_THAN_0_06FE609E = "grouping set count 必须为 larger than 0";
  public static final String EXCEPTION_LIST_OF_EMPTY_GLOBAL_GROUPING_SETS_MUST_BE_NO_LARGER_THAN_GROUPING_SET_COUNT_12DAD147 = "list of empty global grouping sets 必须为 no larger than grouping set count";
  ...
  public static final String EXCEPTION_ARG_AGGREGATION_FUNCTION_ARG_HAS_ARG_ARGUMENTS_COMMA_BUT_ARG_ARGUMENTS_WERE_PROV_53CC06CF = "%s aggregation function %s has %s arguments, but %s arguments were provided 到 function call";
  public static final String EXCEPTION_IDCOLUMN_IS_NULL_FA206D71 = "idColumn 不能为空";
  public static final String EXCEPTION_EXPECTED_NEWCHILDREN_TO_CONTAIN_1_NODE_7A97D180 = "期望 newChildren 到 contain 1 node";
