...
public final class QueryMessages {
  ...
  public static final String PLAN_NODE_NOT_SUPPORT_GET_TYPE = "该 PlanNode 不支持 getType() 操作。";
  public static final String PLAN_NODE_CANNOT_CREATE_SUB_NODE = "无法为 %s 创建子节点";
  public static final String PLAN_NODE_CHILD_COUNT_INCORRECT = "PlanNode 的子节点数量不正确。期望：%d，实际：%d";
  public static final String PLAN_NODE_SERIALIZE_ERROR = "序列化 writePlanNode 时发生意外错误。";
  public static final String PLAN_NODE_NOT_SUPPORT_GET_OUTPUT_SYMBOLS =
      "该 PlanNode 不支持 getOutputSymbols() 操作。";
  public static final String TWO_CHILD_NODE_EXCEEDS_LIMIT = "该节点不支持两个以上的子节点";
  ...
  public static final String UNSUPPORTED_IR_NODE_TYPE = "不支持的节点类型：%s";

  // ======================== SQL AST ========================

  public static final String NOT_YET_IMPLEMENTED = "尚未实现：%s";
  public static final String NOT_YET_IMPLEMENTED_VISIT = "尚未实现：%s.visit%s";
  public static final String GET_EXPRESSION_TYPE_NOT_IMPLEMENTED = "getExpressionType 尚未实现：%s";
  public static final String INVALID_EXPRESSION_TYPE = "无效的表达式类型：%s";
  public static final String ONLY_TABLE_SUBQUERY_SUPPORTED = "目前仅支持 TableSubquery";
  public static final String FLOAT_LITERAL_CANNOT_CREATE_FROM_LOCATION =
      "当前不支持通过 NodeLocation 创建 FloatLiteral";
  public static final String COLUMNS_SHOULD_BE_EXPANDED = "Columns 应在 Analyze 阶段展开";

  // ======================== Parsing ========================

  public static final String BINARY_LITERAL_HEX_ONLY = "二进制字面量只能包含十六进制数字";
  public static final String BINARY_LITERAL_EVEN_DIGITS = "二进制字面量必须包含偶数个数字";
  public static final String GENERIC_LITERAL_NO_SPACE = "'X' 与二进制字面量的起始引号之间不允许有空格";
  ...
  public static final String UNSUPPORTED_LOGICAL_EXPRESSION_TYPE = "不支持的逻辑表达式类型：%s";
  ...
  public static final String UNEXPECTED_ROWS_PER_MATCH = "意外的 rowsPerMatch：%s";
  ...
  public static final String UNSUPPORTED_TYPE_PARAMETER_KIND = "不支持的类型参数种类：%s";
  public static final String EXPECTED_ALL_TYPE_SIGNATURES = "期望所有参数均为 TypeSignature，但发现了 [%s]";
  public static final String PARAMETER_KIND_MISMATCH = "ParameterKind 为 [%s]，但期望为 [%s]";
  ...
  public static final String VARIADIC_BOUND_MUST_BE_ROW = "variadicBound 必须为 row，但实际为 %s";
  public static final String BUILTIN_SCALAR_FUNCTION_CANNOT_BE_INVOKED = "内置标量函数 %s 不可调用。";
  public static final String OPERATOR_TYPE_CANNOT_BE_INVOKED = "OperatorType %s 不可调用。";
  public static final String INVALID_AGGREGATION_FUNCTION = "无效的聚合函数：%s";
  ...
  public static final String PARAM_SHOULD_NOT_BE_NULL_OR_EMPTY = "%s 不能为 null 或空";
  public static final String PARAM_SHOULD_NOT_BE_NULL_OR_EMPTY_DOT = "%s 不能为 null 或空。";
  public static final String PARAM_SHOULD_BE_GREATER_THAN_ZERO = "%s 应大于 0";
  public static final String TARGETS_TOO_MANY_COLUMNS = "%s 不应包含多于一个目标列，发现了 [%s] 个目标列。";
  ...
  public static final String TIME_COLUMN_SHOULD_NOT_BE_NULL = "时间列不应为 null";
  public static final String NON_PARTITIONING_PASS_THROUGH =
      "非 pass-through 来源的表函数不允许使用非分区 pass-through 列";

  // ======================== Pattern Match TVF ========================

  public static final String SMOOTH_MUST_BE_NON_NEGATIVE = "smooth 必须为非负数，但传入了：%s";
  public static final String THRESHOLD_MUST_BE_NON_NEGATIVE = "threshold 必须为非负数，但传入了：%s";
  public static final String WIDTH_MUST_BE_NON_NEGATIVE = "width 必须为非负数，但传入了：%s";
  public static final String HEIGHT_MUST_BE_NON_NEGATIVE = "height 必须为非负数，但传入了：%s";
  public static final String INVALID_PATTERN_MISSING_REPEAT_SIGN = "无效的模式：%s，'}' 后缺少重复符号";
  ...
  public static final String FORECAST_EXECUTION_ERROR = "执行 forecast 时发生错误：[%s]";
  public static final String CLASSIFY_EXECUTION_ERROR = "执行 classify 时发生错误：[%s]";
  public static final String MODEL_OUTPUT_COLUMN_MISMATCH = "模型 %s 输出了 %s 列，与指定的 %s 列不一致";
  public static final String MODEL_OUTPUT_LENGTH_MISMATCH = "模型 %s 输出长度为 %s，与指定的 %s 不一致";

  // ======================== UDF Management ========================

  public static final String UDF_INFORMATION_NOT_AVAILABLE = "UDFInformation 不可用";
  public static final String UDF_REGISTER_CONFLICT_BUILTIN = "注册 UDF %s(%s) 失败，因为函数名与内置函数名冲突";
  public static final String UDF_REGISTER_JAR_MD5_CONFLICT =
      "注册函数 %s(%s) 失败，因为函数 %s 已有的 jar 文件 md5 与新 jar 文件不同。";
  public static final String UDF_REGISTER_INSTANCE_FAILED = "注册 UDF %s(%s) 失败，因为无法成功构造其实例。异常：%s";
  public static final String UDF_CLASS_TYPE_UNSUPPORTED = "不支持的 UDF 类类型。仅支持 UDF 和 SQLFunction。";
  public static final String UDF_REFLECT_NOT_REGISTERED = "反射 UDF 实例失败，因为 UDF %s 尚未注册。";
  public static final String UDF_REFLECT_INSTANCE_FAILED = "反射 UDF %s(%s) 实例失败，原因：%s";
  public static final String AI_NODE_SERVICE_NOT_AVAILABLE = "当前节点不支持表函数 AINode 服务";
  // ======================== UDTF Forecast ========================

  public static final String INPUT_DATA_TYPE_NOT_SUPPORTED = "输入数据类型 %s 不被支持，仅允许 %s。";
  public static final String MODEL_ID_MUST_BE_PROVIDED = "MODEL_ID 参数必须提供且不能为空。";
  public static final String UNSUPPORTED_DATA_TYPE_FOR_UDF = "不支持的数据类型 %s";
  public static final String FORECAST_FAILED = "预测失败，错误码 %d，原因：%s";
  public static final String FORECAST_RESULT_LENGTH_MISMATCH = "预测结果长度 %d 与期望的输出长度 %d 不一致";
  public static final String FORECAST_RESULT_SINGLE_COLUMN = "预测结果应仅包含一个值列，但实际有 %d 个";

  // ======================== TableSchema ========================

  public static final String TABLE_COLUMN_NAME_DUPLICATED = "表中的列不应同名：%s。";
  public static final String TSFILE_TABLE_SCHEMA_CONVERT_FAILED =
      "无法将 TsFile 表结构转换为 IoTDB 表结构，表名：{}，TsFile 表结构：{}";

  // ======================== DateTime ========================

  public static final String TIMESTAMP_OVERFLOW = "时间戳溢出，毫秒值：%s，时间戳精度：%s";
  public static final String EXTRACT_TIMESTAMP_MS_PART_NULL = "ExtractTimestampMsPart 为 null";
  public static final String EXTRACT_TIMESTAMP_US_PART_NULL = "ExtractTimestampUsPart 为 null";
  public static final String EXTRACT_TIMESTAMP_NS_PART_NULL = "ExtractTimestampNsPart 为 null";
  ...
  public static final String UNSUPPORTED_TIME_PRECISION = "不支持的 time_precision：%s";
  ...
  public static final String MEMORY_FOR_FLAT_HASH_NOT_ENOUGH = "flatHash 的内存不足";
  public static final String LONG_OVERFLOW = "long 溢出";
  public static final String INTEGER_OVERFLOW = "integer 溢出";
  public static final String INVALID_INPUT_DESC_LENGTH_LT_8 = "无效输入：desc.length - offset < 8";
  ...
  public static final String NO_CHANNEL_GROUP_BY_HASH_NOT_SUPPORT_APPEND =
      "NoChannelGroupByHash 不支持 appendValuesTo";
  public static final String NO_CHANNEL_GROUP_BY_HASH_NOT_SUPPORT_RAW_HASH =
      "NoChannelGroupByHash 不支持 getRawHash";
  public static final String MULTIPLE_TABLE_FUNCTION_AI_NODE_PROVIDER =
      "找到多个 ITableFunctionAINodeServiceProvider";
  // ---------------------------------------------------------------------------
  ...
  public static final String EXCEPTION_EXCEPTNODE_SHOULD_NEVER_SERIALIZED_CURRENT_VERSION_6F5B4EE0 =
      "ExceptNode 在当前版本中绝不应被序列化";
  public static final String
      EXCEPTION_EXCEPTNODE_SHOULD_NEVER_DESERIALIZED_CURRENT_VERSION_690C18F0 =
          "ExceptNode 在当前版本中绝不应被反序列化";
  public static final String
      EXCEPTION_INTERSECTNODE_SHOULD_NEVER_SERIALIZED_CURRENT_VERSION_68D2C0D3 =
          "IntersectNode 在当前版本中绝不应被序列化";
  public static final String
      EXCEPTION_INTERSECTNODE_SHOULD_NEVER_DESERIALIZED_CURRENT_VERSION_A3614371 =
          "IntersectNode 在当前版本中绝不应被反序列化";
  ...
  public static final String EXCEPTION_EXPECTED_ARG_FIELDS_COMMA_GOT_ARG_498063F2 =
      "期望 %s 个字段，实际为 %s";
  ...
  public static final String EXCEPTION_UNEXPECTED_OFFSET_ROWCOUNT_COLON_977E305C =
      "意外的 OFFSET rowCount: ";
  public static final String
      EXCEPTION_INVALID_LIMIT_NODE_TYPE_DOT_EXPECTED_COLON_LIMIT_DOT_ACTUAL_COLON_ARG_5BCD1C76 =
          "无效的 limit node type。期望: Limit。实际: %s";
  public static final String EXCEPTION_UNEXPECTED_LIMIT_ROWCOUNT_COLON_CFF154F0 =
      "意外的 LIMIT rowCount: ";
  public static final String
      EXCEPTION_NON_MINUS_EMPTY_ORDERBYEXPRESSIONS_LIST_WITHOUT_ORDERBYSCOPE_PROVIDED_240DDD64 =
          "非空 orderByExpressions 列表未提供 orderByScope";
  public static final String EXCEPTION_OUTPUT_FIELDS_IS_NULL_FOR_SELECT_ITEM_ARG_56AFEC51 =
      "select item %s 的输出字段不能为空";
  public static final String EXCEPTION_NODE_IS_NULL_C1479F4A = "node 不能为空";
  public static final String EXCEPTION_COLUMNS_SHOULDN_QUOTE_T_BE_EMPTY_HERE_34E44AAA =
      "columns 此处不应为空";
  ...
  public static final String EXCEPTION_MINIMUMREQUIREDCAPACITY_MUST_BE_POSITIVE_81638118 =
      "minimumRequiredCapacity 必须为正数";
  public static final String EXCEPTION_EXPECTEDSIZE_MUST_BE_GREATER_THAN_ZERO_DA2E0345 =
      "expectedSize 必须大于 0";
  ...
  public static final String EXCEPTION_ORDERBY_KEYS_AND_ORDERINGS_DON_QUOTE_T_MATCH_E0334493 =
      "orderBy keys 和 orderings 不匹配";
  public static final String EXCEPTION_NO_ORDERING_FOR_SYMBOL_COLON_ARG_F54E70FC =
      "symbol 缺少 ordering: %s";
  public static final String EXCEPTION_NAME_IS_NULL_C8B35959 = "name 不能为空";
  public static final String EXCEPTION_UNEXPECTED_EXPRESSION_COLON_ARG_8E4AC833 =
      "意外的 expression: %s";
  ...
  public static final String
      EXCEPTION_SYMBOL_ARG_ALREADY_HAS_ASSIGNMENT_ARG_COMMA_WHILE_ADDING_ARG_EE8CADA3 =
          "Symbol %s 已有 assignment %s，无法再添加 %s";
  public static final String EXCEPTION_TYPEVARIABLECONSTRAINTS_IS_NULL_0A86DA34 =
      "typeVariableConstraints 不能为空";
  public static final String EXCEPTION_LONGVARIABLECONSTRAINTS_IS_NULL_51F80E3C =
      "longVariableConstraints 不能为空";
  ...
  public static final String EXCEPTION_TYPEVARIABLECONSTRAINT_IS_NULL_18B97042 =
      "typeVariableConstraint 不能为空";
  ...
  public static final String EXCEPTION_BASE_TYPE_NAME_CANNOT_BE_A_TYPE_VARIABLE_71E810A9 =
      "base type name 不能是 type variable";
  ...
  public static final String EXCEPTION_BAD_CHARACTERS_IN_BASE_TYPE_COLON_ARG_FA811786 =
      "base type 中存在非法字符: %s";
  ...
  public static final String EXCEPTION_FUNCTIONNULLABILITY_IS_NULL_6EF52FB4 =
      "functionNullability 不能为空";
  public static final String EXCEPTION_INVALID_NAME_ARG_AD3FA0BF = "无效名称 %s";
  public static final String EXCEPTION_INVALID_NAME_COLON_LEFT_BRACKET_ARG_RIGHT_BRACKET_C46F15A4 =
      "无效名称: [%s]";
  ...
  public static final String EXCEPTION_SYMBOLREFERENCEFORMATTER_IS_NULL_B9B540EC =
      "symbolReferenceFormatter 不能为空";
  public static final String EXCEPTION_BUILDER_IS_NULL_ADE64E9B = "builder 不能为空";
  public static final String EXCEPTION_VISITEXPRESSION_SHOULD_ONLY_BE_CALLED_AT_ROOT_93E4AAD4 =
      "visitExpression 只能在 root 调用";
  public static final String EXCEPTION_VISITROWPATTERN_SHOULD_ONLY_BE_CALLED_AT_ROOT_9DE9F574 =
      "visitRowPattern 只能在 root 调用";
  public static final String EXCEPTION_MISSING_IDENTIFIER_IN_AFTER_MATCH_SKIP_TO_LAST_82A12A21 =
      "AFTER MATCH SKIP TO LAST 中缺少标识符";
  public static final String EXCEPTION_MISSING_IDENTIFIER_IN_AFTER_MATCH_SKIP_TO_FIRST_F988B839 =
      "AFTER MATCH SKIP TO FIRST 中缺少标识符";
  ...
  public static final String EXCEPTION_ARG_JOIN_CANNOT_HAVE_JOIN_CRITERIA_3B23E0D1 =
      "%s join 不能包含 join criteria";
  ...
  public static final String
      EXCEPTION_THE_LENGTH_OF_SIMPLECASEEXPRESSION_QUOTE_S_WHENCLAUSES_MUST_GREATER_THAN_0_5D2963B9 =
          "SimpleCaseExpression 的 whenClauses 长度必须大于 0";
  public static final String EXCEPTION_SETS_IS_NULL_C9A2FA67 = "sets 不能为空";
  public static final String EXCEPTION_GROUPING_SETS_CANNOT_BE_EMPTY_8E0BE7DB =
      "grouping sets 不能为空";
  ...
  public static final String EXCEPTION_VALUE_CONTAINS_ILLEGAL_CHARACTERS_COLON_ARG_C6DBFEBA =
      "value 包含非法字符: %s";
  ...
  public static final String EXCEPTION_EXISTINGWINDOWNAME_IS_NULL_5D67FD72 =
      "existingWindowName 不能为空";
  ...
  public static final String EXCEPTION_VARIABLEDEFINITIONS_IS_NULL_5F7B8ED4 =
      "variableDefinitions 不能为空";
  public static final String EXCEPTION_VARIABLEDEFINITIONS_IS_EMPTY_9E324869 =
      "variableDefinitions 为空";
  public static final String EXCEPTION_UNEXPECTED_ROWCOUNT_CLASS_COLON_ARG_170FC7CD =
      "意外的 rowCount class: %s";
  ...
  public static final String EXCEPTION_MUST_HAVE_AT_LEAST_TWO_OPERANDS_CE7B0DCB =
      "必须至少有两个 operands";
  public static final String EXCEPTION_LINE_MUST_BE_AT_LEAST_ONE_COMMA_GOT_COLON_ARG_6BA7A99C =
      "line 必须至少为 1，实际为: %s";
  public static final String EXCEPTION_COLUMN_MUST_BE_AT_LEAST_ONE_COMMA_GOT_COLON_ARG_4A529240 =
      "column 必须至少为 1，实际为: %s";
  ...
  public static final String EXCEPTION_MISSING_IDENTIFIER_IN_SKIP_TO_ARG_33E1A7C3 =
      "SKIP TO %s 中缺少标识符";
  public static final String EXCEPTION_UNEXPECTED_IDENTIFIER_IN_SKIP_TO_ARG_58438AFC =
      "SKIP TO %s 中出现意外的标识符";
  ...
  public static final String
      EXCEPTION_LIMIT_MUST_BE_OPTIONAL_OF_EITHER_FETCHFIRST_OR_LIMIT_TYPE_0636CAA9 =
          "limit 必须是 FetchFirst 或 Limit 类型之一的可选项";
  ...
  public static final String EXCEPTION_FIELDINDEX_MUST_BE_GREATER_THAN_EQUALS_0_4138C39B =
      "fieldIndex 必须为 >= 0";
  ...
  public static final String EXCEPTION_SIMPLEGROUPBYEXPRESSIONS_IS_NULL_3F6A1ECC =
      "simpleGroupByExpressions 不能为空";
  public static final String
      EXCEPTION_THE_LENGTH_OF_SEARCHEDCASEEXPRESSION_QUOTE_S_WHENCLAUSES_MUST_GREATER_THAN_0_D710DBF6 =
          "SearchedCaseExpression 的 whenClauses 长度必须大于 0";
  ...
  public static final String EXCEPTION_PATTERNQUANTIFIER_IS_NULL_0AC88BAB =
      "patternQuantifier 不能为空";
  ...
  public static final String EXCEPTION_MATCHNUMBERSYMBOL_IS_NULL_D88DC4EE =
      "matchNumberSymbol 不能为空";
  public static final String EXCEPTION_LOGICALINDEXPOINTER_IS_NULL_BF8B516B =
      "logicalIndexPointer 不能为空";
  ...
  public static final String
      EXCEPTION_PATTERN_CONCATENATION_MUST_HAVE_AT_LEAST_2_ELEMENTS_LEFT_PAREN_ACTUAL_COLON_ARG__8B283563 =
          "pattern concatenation 必须至少有 2 个元素（实际: %s）";
  ...
  public static final String
      EXCEPTION_LOGICAL_OFFSET_MUST_BE_GREATER_THAN_EQUALS_0_COMMA_ACTUAL_COLON_ARG_539807BF =
          "logical offset 必须 >= 0，实际: %s";
  public static final String
      EXCEPTION_PATTERN_ALTERNATION_MUST_HAVE_AT_LEAST_2_ELEMENTS_LEFT_PAREN_ACTUAL_COLON_ARG_RI_A03B40AC =
          "pattern alternation 必须至少有 2 个元素（实际: %s）";
  public static final String
      EXCEPTION_RUN_IRROWPATTERNFLATTENER_FIRST_TO_REMOVE_REDUNDANT_EMPTY_PATTERN_D2FB553C =
          "请先运行 IrRowPatternFlattener，以移除多余的空 pattern";
  ...
  public static final String
      EXCEPTION_DECLARED_AND_ACTUAL_ROW_COUNTS_DON_QUOTE_T_MATCH_COLON_ARG_VS_ARG_EC8361A5 =
          "声明的 row count 与实际 row count 不匹配: %s vs %s";
  public static final String
      EXCEPTION_MISSING_ROWS_SPECIFICATION_FOR_VALUES_WITH_NON_MINUS_EMPTY_OUTPUT_SYMBOLS_9BA9C169 =
          "具有非空 output symbols 的 Values 缺少 rows specification";
  public static final String EXCEPTION_MISMATCHED_ROWS_DOT_ALL_ROWS_MUST_BE_THE_SAME_SIZE_E98CF3BE =
      "rows 不匹配。所有 rows 大小必须一致";
  public static final String
      EXCEPTION_ROW_SIZE_DOESN_QUOTE_T_MATCH_THE_NUMBER_OF_OUTPUT_SYMBOLS_COLON_ARG_VS_ARG_5FBDF729 =
          "row size 与 output symbols 数量不匹配: %s vs %s";
  public static final String EXCEPTION_ARGUMENTNAME_IS_NULL_7F8F665F = "argumentName 不能为空";
  public static final String EXCEPTION_PASSTHROUGHSPECIFICATION_IS_NULL_2B48FE41 =
      "passThroughSpecification 不能为空";
  ...
  public static final String EXCEPTION_SORTKEYCOERCEDFORFRAMESTARTCOMPARISON_IS_NULL_4E922E4D =
      "sortKeyCoercedForFrameStartComparison 不能为空";
  ...
  public static final String EXCEPTION_SORTKEYCOERCEDFORFRAMEENDCOMPARISON_IS_NULL_CB0BAC41 =
      "sortKeyCoercedForFrameEndComparison 不能为空";
  public static final String EXCEPTION_ORIGINALSTARTVALUE_IS_NULL_6BCE78A9 =
      "originalStartValue 不能为空";
  ...
  public static final String
      EXCEPTION_PREPARTITIONEDINPUTS_MUST_BE_CONTAINED_IN_PARTITIONBY_CE9DCE6F =
          "prePartitionedInputs 必须包含在 partitionBy 中";
  public static final String
      EXCEPTION_CANNOT_HAVE_SORTED_MORE_SYMBOLS_THAN_THOSE_REQUESTED_52EEB7C9 =
          "不能包含多于请求数量的 sorted symbols";
  public static final String
      EXCEPTION_PRESORTEDORDERPREFIX_CAN_ONLY_BE_GREATER_THAN_ZERO_IF_ALL_PARTITION_SYMBOLS_ARE__76BBC8DD =
          "只有在所有 partition symbols 均已 pre-partitioned 时，preSortedOrderPrefix 才能大于 0";
  public static final String
      EXCEPTION_ORIGINALSTARTVALUE_MUST_BE_PRESENT_IF_STARTVALUE_IS_PRESENT_30B6FDFF =
          "startValue 存在时 originalStartValue 必须存在";
  public static final String
      EXCEPTION_FOR_FRAME_OF_TYPE_RANGE_COMMA_SORTKEYCOERCEDFORFRAMESTARTCOMPARISON_MUST_BE_PRES_7533A433 =
          "RANGE 类型 frame 中，startValue 存在时 sortKeyCoercedForFrameStartComparison 必须存在";
  public static final String
      EXCEPTION_ORIGINALENDVALUE_MUST_BE_PRESENT_IF_ENDVALUE_IS_PRESENT_E79EF3D2 =
          "endValue 存在时 originalEndValue 必须存在";
  public static final String
      EXCEPTION_FOR_FRAME_OF_TYPE_RANGE_COMMA_SORTKEYCOERCEDFORFRAMEENDCOMPARISON_MUST_BE_PRESEN_36A665AC =
          "RANGE 类型 frame 中，endValue 存在时 sortKeyCoercedForFrameEndComparison 必须存在";
  public static final String EXCEPTION_SUBQUERYASSIGNMENTS_IS_NULL_946CDC43 =
      "subqueryAssignments 不能为空";
  ...
  public static final String EXCEPTION_INPUT_DOES_NOT_CONTAIN_SYMBOLS_FROM_CORRELATION_1B3DB7BF =
      "Input 不包含来自 correlation 的 symbols";
  public static final String EXCEPTION_EXPECTED_NEWCHILDREN_TO_CONTAIN_2_NODES_25FE7927 =
      "期望 newChildren 包含 2 个 nodes";
  ...
  public static final String
      EXCEPTION_EVERY_CHILD_NEEDS_TO_MAP_ITS_SYMBOLS_TO_AN_OUTPUT_ARG_OPERATION_SYMBOL_7FA107A2 =
          "每个 child 都需要将其 symbols 映射到输出 %s operation symbol";
  public static final String EXCEPTION_CHILD_DOES_NOT_PROVIDE_REQUIRED_SYMBOLS_B7CE956E =
      "Child 未提供必需 symbols";
  public static final String EXCEPTION_LEFTOUTPUTSYMBOLS_IS_NULL_083AE900 =
      "leftOutputSymbols 不能为空";
  public static final String EXCEPTION_RIGHTOUTPUTSYMBOLS_IS_NULL_F44B848F =
      "rightOutputSymbols 不能为空";
  ...
  public static final String EXCEPTION_DISTINCTSYMBOLS_CANNOT_BE_EMPTY_A44A693E =
      "distinctSymbols 不能为空";
  public static final String EXCEPTION_EXPRESSIONANDVALUEPOINTERS_IS_NULL_8A02F345 =
      "expressionAndValuePointers 不能为空";
  ...
  public static final String
      EXCEPTION_COLUMNNAMES_AND_OUTPUTSYMBOLS_SIZES_DON_QUOTE_T_MATCH_1BDF6B28 =
          "columnNames 和 outputSymbols 的大小不匹配";
  ...
  public static final String EXCEPTION_PREGROUPEDSYMBOLS_IS_NULL_DC24FF7B =
      "preGroupedSymbols 不能为空";
  public static final String EXCEPTION_GLOBALGROUPINGSETS_IS_NULL_5B175B47 =
      "globalGroupingSets 不能为空";
  ...
  public static final String EXCEPTION_GROUPING_COLUMNS_DOES_NOT_CONTAIN_GROUPID_COLUMN_83976C83 =
      "Grouping columns 不包含 groupId column";
  public static final String EXCEPTION_ORDER_BY_DOES_NOT_SUPPORT_DISTRIBUTED_AGGREGATION_05109B26 =
      "ORDER BY 不支持分布式聚合";
  public static final String
      EXCEPTION_PRE_MINUS_GROUPED_SYMBOLS_MUST_BE_A_SUBSET_OF_THE_GROUPING_KEYS_AFC6C33D =
          "pre-grouped symbols 必须是 grouping keys 的子集";
  public static final String EXCEPTION_GROUPING_SET_COUNT_MUST_BE_LARGER_THAN_0_06FE609E =
      "grouping set 数量必须大于 0";
  public static final String
      EXCEPTION_LIST_OF_EMPTY_GLOBAL_GROUPING_SETS_MUST_BE_NO_LARGER_THAN_GROUPING_SET_COUNT_12DAD147 =
          "空 global grouping sets 列表大小不能大于 grouping set 数量";
  public static final String
      EXCEPTION_NO_GROUPING_KEYS_IMPLIES_AT_LEAST_ONE_GLOBAL_GROUPING_SET_COMMA_BUT_NONE_PROVIDE_F099B6D2 =
          "没有 grouping keys 意味着至少需要一个 global grouping set，但未提供";
  public static final String EXCEPTION_ARGUMENT_MUST_BE_SYMBOL_COLON_ARG_9C176D4D =
      "argument 必须为 symbol: %s";
  public static final String
      EXCEPTION_ARG_AGGREGATION_FUNCTION_ARG_HAS_ARG_ARGUMENTS_COMMA_BUT_ARG_ARGUMENTS_WERE_PROV_53CC06CF =
          "%s aggregation function %s 有 %s 个参数，但函数调用提供了 %s 个参数";
  public static final String EXCEPTION_IDCOLUMN_IS_NULL_FA206D71 = "idColumn 不能为空";
  public static final String EXCEPTION_EXPECTED_NEWCHILDREN_TO_CONTAIN_1_NODE_7A97D180 =
      "期望 newChildren 包含 1 个 node";
  public static final String EXCEPTION_SOURCEJOINSYMBOL_IS_NULL_A88AEC85 = "sourceJoinSymbol 不能为空";
  public static final String EXCEPTION_FILTERINGSOURCEJOINSYMBOL_IS_NULL_502C5BD5 =
      "filteringSourceJoinSymbol 不能为空";
  public static final String EXCEPTION_SEMIJOINOUTPUT_IS_NULL_D961A39B = "semiJoinOutput 不能为空";
  public static final String EXCEPTION_SOURCE_DOES_NOT_CONTAIN_JOIN_SYMBOL_FA572FD2 =
      "Source 不包含 join symbol";
  public static final String
      EXCEPTION_FILTERING_SOURCE_DOES_NOT_CONTAIN_FILTERING_JOIN_SYMBOL_0C7B1BE3 =
          "Filtering source 不包含 filtering join symbol";
  public static final String EXCEPTION_REHASHMEMORYRESERVATION_IS_NEGATIVE_7EFEFCC2 =
      "rehashMemoryReservation 不能为负数";
  public static final String EXCEPTION_IDENTIFIER_CANNOT_BE_EMPTY_OR_NULL_9C70B87D =
      "Identifier 不能为空或 null";
  public static final String EXCEPTION_COLUMN_ALIAS_ARG_IS_AMBIGUOUS_AT_POSITIONS_ARG_F6FF2E93 =
      "列别名 '%s' 在位置 %s 处存在歧义";
  public static final String EXCEPTION_INVALID_ARGUMENT_ARG_EXPECTED_SCALAR_ARGUMENT_4AD4E32F =
      "无效的参数 %s。期望标量参数";
  public static final String
      EXCEPTION_THE_SLIDE_ARGUMENT_MUST_HAVE_THE_SAME_WINDOW_MODE_AS_THE_SIZE_ARGUMENT_419C9844 =
          "SLIDE 参数必须与 SIZE 参数具有相同的窗口模式。";
  public static final String
      EXCEPTION_THE_ORIGIN_ARGUMENT_IS_ONLY_SUPPORTED_IN_TIME_WINDOW_MODE_B3F358B9 =
          "ORIGIN 参数仅在时间窗口模式下受支持。";
  public static final String
  ...
  public static final String
      EXCEPTION_ARGUMENTS_SHOULD_NEVER_BE_EMPTY_WHEN_RESOLVING_M4_MODE_F982EA1C = "解析 M4 模式时参数不应为空";
