...
public final class SchemaMessages {
  ...
  // Filter messages
  public static final String UNSUPPORTED_SCHEMA_FILTER_TYPE = "Unsupported schema filter type: %s";
  ...
  public static final String TOO_MANY_DOTS_IN_TABLE_NAME = "Too many dots in table name: %s";

  public static final String S_IS_NULL = "%s is null";
  // ---------------------------------------------------------------------------
  // Additional auto-collected messages
  // ---------------------------------------------------------------------------
  public static final String EXCEPTION_DATABASE_MUST_SPECIFIED_SESSION_DATABASE_NOT_SET_CBF6F21F =
  ...
  public static final String
      EXCEPTION_FAILED_PARSE_TREE_VIEW_STRING_ARG_CONVERT_IDEVICEID_6E735586 =
          "Failed to parse the tree view string %s when convert to IDeviceID";
  ...
  public static final String EXCEPTION_ARG_IS_NOT_LOWERCASE_COLON_ARG_D78298F6 =
