...
public final class QueryMessages {
  ...
  public static final String PLAN_NODE_CANNOT_CREATE_SUB_NODE = "Can't create subNode for %s";
  ...
  public static final String UNSUPPORTED_IR_NODE_TYPE = "unsupported node type: %s";

  // ======================== SQL AST ========================

  public static final String NOT_YET_IMPLEMENTED = "not yet implemented: %s";
  public static final String NOT_YET_IMPLEMENTED_VISIT = "not yet implemented: %s.visit%s";
  ...
  public static final String ONLY_TABLE_SUBQUERY_SUPPORTED = "Only TableSubquery is supported now";
  ...
  public static final String UNEXPECTED_ROWS_PER_MATCH = "unexpected rowsPerMatch: %s";
  ...
  public static final String PARAMETER_KIND_MISMATCH = "ParameterKind is [%s] but expected [%s]";
  ...
  public static final String VARIADIC_BOUND_MUST_BE_ROW = "variadicBound must be row but is %s";
  public static final String BUILTIN_SCALAR_FUNCTION_CANNOT_BE_INVOKED =
      "BuiltinScalarFunctio %s cannot be invoked.";
  public static final String OPERATOR_TYPE_CANNOT_BE_INVOKED = "OperatorType %s cannot be invoked.";
  public static final String INVALID_AGGREGATION_FUNCTION = "Invalid Aggregation function: %s";
  ...
  public static final String PARAM_SHOULD_NOT_BE_NULL_OR_EMPTY = "%s should never be null or empty";
  public static final String PARAM_SHOULD_NOT_BE_NULL_OR_EMPTY_DOT =
      "%s should never be null or empty.";
  public static final String PARAM_SHOULD_BE_GREATER_THAN_ZERO = "%s should be greater than 0";
  ...
  public static final String TIME_COLUMN_SHOULD_NOT_BE_NULL = "Time column should never be null";
  ...
  public static final String FORECAST_FAILED = "Forecast failed due to %d %s";
  ...
  public static final String EXTRACT_TIMESTAMP_MS_PART_NULL = "ExtractTimestampMsPart is null";
  public static final String EXTRACT_TIMESTAMP_US_PART_NULL = "ExtractTimestampUsPart is null";
  public static final String EXTRACT_TIMESTAMP_NS_PART_NULL = "ExtractTimestampNsPart is null";
  ...
  public static final String UNSUPPORTED_TIME_PRECISION = "not supported time_precision: %s";
  ...
  public static final String MEMORY_FOR_FLAT_HASH_NOT_ENOUGH = "Memory for flatHash is not enough";
  ...
  public static final String TIME_PRECISION_MUST_BE_ONE_OF =
      "time precision must be one of: h,m,s,ms,u,n";
  public static final String INVALID_INPUT_BYTES_OFFSET_LT_4 =
      "Invalid input: bytes.length - offset < 4";
  public static final String INVALID_INPUT_BYTES_OFFSET_LT_8 =
      "Invalid input: bytes.length - offset < 8";
  public static final String INVALID_INPUT_DESC_OFFSET_LT_4 =
      "Invalid input: desc.length - offset < 4";
  public static final String SIZE_OF_HASH_TABLE_CANNOT_EXCEED =
  ...
  public static final String EXCEPTION_UNEXPECTED_ROWSPERMATCH_F9B931C9 =
      "unexpected rowsPerMatch: ";
  public static final String EXCEPTION_UNSUPPORTED_FILL_METHOD_0809912A =
      "Unsupported fill method: ";
  ...
  public static final String EXCEPTION_WARNINGCOLLECTOR_IS_NULL_7A524A68 =
  ...
  public static final String EXCEPTION_MISSING_TABLE_ARGUMENT_COLON_ARG_4F1E9F4E =
      "Missing table argument: %s";
  public static final String
  ...
  public static final String
      EXCEPTION_MISSING_DEFAULT_VALUE_FOR_SCALAR_ARGUMENT_COLON_ARG_8AF70F38 =
          "Missing default value for scalar argument: %s";
  public static final String
  ...
  public static final String EXCEPTION_OUTPUT_FIELDS_IS_NULL_FOR_SELECT_ITEM_ARG_56AFEC51 =
      "output fields is null for select item %s";
  ...
  public static final String EXCEPTION_COLUMNS_SHOULDN_QUOTE_T_BE_EMPTY_HERE_34E44AAA =
      "columns shouldn't be empty here";
  ...
  public static final String EXCEPTION_MINIMUMREQUIREDCAPACITY_MUST_BE_POSITIVE_81638118 =
      "minimumRequiredCapacity must be positive";
  public static final String EXCEPTION_EXPECTEDSIZE_MUST_BE_GREATER_THAN_ZERO_DA2E0345 =
      "expectedSize must be greater than zero";
  public static final String EXCEPTION_POSITION_COUNT_OUT_OF_BOUND_5513847E =
      "position count out of bound";
  public static final String EXCEPTION_ID_IS_NULL_9D5D27B1 = "id is null";
  public static final String EXCEPTION_NEWCHILDREN_IS_NOT_EMPTY_170FCE18 =
      "newChildren is not empty";
  ...
  public static final String EXCEPTION_TYPEVARIABLECONSTRAINT_IS_NULL_18B97042 =
      "typeVariableConstraint is null";
  ...
  public static final String EXCEPTION_RESOLVEDFUNCTION_IS_NULL_81B5B93A =
      "resolvedFunction is null";
  ...
  public static final String EXCEPTION_INVALID_NAME_COLON_LEFT_BRACKET_ARG_RIGHT_BRACKET_C46F15A4 =
      "Invalid name: [%s]";
  public static final String EXCEPTION_ARGUMENTNULLABLE_IS_NULL_0CC221D3 =
      "argumentNullable is null";
  public static final String EXCEPTION_LITERALFORMATTER_IS_NULL_3F4F4A2B =
  ...
  public static final String EXCEPTION_VISITROWPATTERN_SHOULD_ONLY_BE_CALLED_AT_ROOT_9DE9F574 =
      "visitRowPattern should only be called at root";
  ...
  public static final String EXCEPTION_COLUMN_MUST_BE_GREATER_THAN_0_2481C561 =
      "column must be > 0";
  ...
  public static final String EXCEPTION_NO_JOIN_CRITERIA_SPECIFIED_44DED0B9 =
      "No join criteria specified";
  ...
  public static final String
      EXCEPTION_THE_LENGTH_OF_SIMPLECASEEXPRESSION_QUOTE_S_WHENCLAUSES_MUST_GREATER_THAN_0_5D2963B9 =
          "the length of SimpleCaseExpression's whenClauses must greater than 0";
  ...
  public static final String EXCEPTION_VALUE_CONTAINS_ILLEGAL_CHARACTERS_COLON_ARG_C6DBFEBA =
      "value contains illegal characters: %s";
  ...
  public static final String EXCEPTION_SORTITEMS_SHOULD_NOT_BE_EMPTY_78C26791 =
  ...
  public static final String EXCEPTION_AFTERMATCHSKIPTO_IS_NULL_7623C3C0 =
      "afterMatchSkipTo is null";
  ...
  public static final String EXCEPTION_EXPECTED_AT_LEAST_2_TERMS_87CD9010 =
      "Expected at least 2 terms";
  ...
  public static final String
      EXCEPTION_THE_LENGTH_OF_SEARCHEDCASEEXPRESSION_QUOTE_S_WHENCLAUSES_MUST_GREATER_THAN_0_D710DBF6 =
          "the length of SearchedCaseExpression's whenClauses must greater than 0";
  ...
  public static final String EXCEPTION_CLASSIFIERSYMBOL_IS_NULL_B92EE093 =
      "classifierSymbol is null";
  ...
  public static final String
      EXCEPTION_LOGICAL_OFFSET_MUST_BE_GREATER_THAN_EQUALS_0_COMMA_ACTUAL_COLON_ARG_539807BF =
          "logical offset must be >= 0, actual: %s";
  public static final String
  ...
  public static final String EXCEPTION_MISMATCHED_ROWS_DOT_ALL_ROWS_MUST_BE_THE_SAME_SIZE_E98CF3BE =
      "mismatched rows. All rows must be the same size";
  public static final String
  ...
  public static final String EXCEPTION_PASSTHROUGHSPECIFICATION_IS_NULL_2B48FE41 =
      "passThroughSpecification is null";
  public static final String EXCEPTION_SYMBOL_IS_NULL_AE539B31 = "symbol is null";
  public static final String EXCEPTION_WRONG_NUMBER_OF_NEW_CHILDREN_817AF800 =
      "wrong number of new children";
  ...
  public static final String EXCEPTION_SORTKEYCOERCEDFORFRAMEENDCOMPARISON_IS_NULL_CB0BAC41 =
      "sortKeyCoercedForFrameEndComparison is null";
  public static final String EXCEPTION_ORIGINALSTARTVALUE_IS_NULL_6BCE78A9 =
      "originalStartValue is null";
  public static final String EXCEPTION_ORIGINALENDVALUE_IS_NULL_EBA46FFA =
      "originalEndValue is null";
  public static final String
  ...
  public static final String EXCEPTION_MUST_HAVE_AT_LEAST_ONE_SOURCE_4114F454 =
  ...
  public static final String
      EXCEPTION_EXPECTED_NEWCHILDREN_TO_CONTAIN_2_NODES_FOR_JOINNODE_BEEC3D82 =
          "expected newChildren to contain 2 nodes for JoinNode";
  ...
  public static final String EXCEPTION_GROUPING_SET_COUNT_MUST_BE_LARGER_THAN_0_06FE609E =
      "grouping set count must be larger than 0";
  public static final String
  ...
  public static final String EXCEPTION_EXPECTED_NEWCHILDREN_TO_CONTAIN_1_NODE_7A97D180 =
      "expected newChildren to contain 1 node";
  public static final String EXCEPTION_SOURCEJOINSYMBOL_IS_NULL_A88AEC85 =
      "sourceJoinSymbol is null";
  public static final String EXCEPTION_FILTERINGSOURCEJOINSYMBOL_IS_NULL_502C5BD5 =
      "filteringSourceJoinSymbol is null";
  ...
  public static final String
      EXCEPTION_ARGUMENTS_SHOULD_NEVER_BE_EMPTY_WHEN_RESOLVING_M4_MODE_F982EA1C =
          "Arguments should never be empty when resolving M4 mode";
