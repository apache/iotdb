...
public final class UtilMessages {
  ...
  public static final String FAILED_TO_READ_FILE_STORE_PATH = "Failed to read file store path '{}'";
  ...
  public static final String WRITE_T_DATA_NODE_LOCATION_FAILED = "Write TDataNodeLocation failed: ";
  public static final String READ_T_DATA_NODE_LOCATION_FAILED = "Read TDataNodeLocation failed: ";
  ...
  public static final String READ_T_TIME_PARTITION_SLOT_FAILED = "Read TTimePartitionSlot failed: ";
  public static final String WRITE_T_CONSENSUS_GROUP_ID_FAILED = "Write TConsensusGroupId failed: ";
  public static final String READ_T_CONSENSUS_GROUP_ID_FAILED = "Read TConsensusGroupId failed: ";
  public static final String WRITE_T_REGION_REPLICA_SET_FAILED = "Write TRegionReplicaSet failed: ";
  public static final String READ_T_REGION_REPLICA_SET_FAILED = "Read TRegionReplicaSet failed: ";
  ...
  public static final String EXCEPTION_LENGTH_NAME_MUST_GREATER_THAN_EQUAL_0387C3A5 =
      "The length of name must be greater than or equal to ";
  public static final String EXCEPTION_LENGTH_NAME_MUST_LESS_THAN_EQUAL_B7B31C94 =
      "The length of name must be less than or equal to ";
  ...
  public static final String EXCEPTION_LENGTH_PASSWORD_MUST_GREATER_THAN_EQUAL_F95F3E8F =
      "The length of password must be greater than or equal to ";
  public static final String EXCEPTION_LENGTH_PASSWORD_MUST_LESS_THAN_EQUAL_C822ECBE =
      "The length of password must be less than or equal to ";
  ...
  public static final String
      EXCEPTION_ILLEGAL_PATTERN_PATH_ARG_ONLY_PATTERN_PATH_END_SUPPORTED_16CBB77D =
          "Illegal pattern path: %s, only pattern path that end with ** are supported.";
  public static final String
  ...
  public static final String MESSAGE_FAILED_REMOVING_DATANODE_B4B7F050 =
      "Failed while removing DataNode.";
  ...
  public static final String MESSAGE_MEET_ERROR_DEALING_METADATA_1C4A38B9 =
      "Meet error when dealing with metadata.";
  public static final String MESSAGE_INSERTION_TIME_LESS_THAN_TTL_TIME_BOUND_0F1BB861 =
      "Insertion time is less than TTL time bound.";
  public static final String MESSAGE_MEET_ERROR_MERGING_28424A77 = "Meet error while merging.";
  public static final String MESSAGE_MEET_ERROR_DISPATCHING_73E4FD5E =
      "Meet error while dispatching.";
  public static final String MESSAGE_DATABASE_PROCESSOR_RELATED_ERROR_C58690B1 =
      "Database processor related error.";
  public static final String MESSAGE_STORAGE_ENGINE_RELATED_ERROR_94DEBBCF =
      "Storage engine related error.";
  public static final String MESSAGE_TSFILE_PROCESSOR_RELATED_ERROR_B6C57C3E =
      "TsFile processor related error.";
  public static final String MESSAGE_ILLEGAL_PATH_020B26BC = "Illegal path.";
  public static final String MESSAGE_MEET_ERROR_LOADING_FILE_A90EBC21 =
      "Meet error while loading file.";
  public static final String MESSAGE_EXECUTE_STATEMENT_ERROR_54E4A395 = "Execute statement error.";
  public static final String MESSAGE_MEET_ERROR_PARSING_SQL_3C5A3B80 =
      "Meet error while parsing SQL.";
  public static final String MESSAGE_MEET_ERROR_GENERATING_TIME_ZONE_94E03CA3 =
      "Meet error while generating time zone.";
  public static final String MESSAGE_MEET_ERROR_SETTING_TIME_ZONE_CBE88DCF =
      "Meet error while setting time zone.";
  public static final String MESSAGE_QUERY_STATEMENTS_NOT_ALLOWED_ERROR_58D30C99 =
      "Query statements are not allowed error.";
  public static final String MESSAGE_LOGICAL_OPERATOR_RELATED_ERROR_D94D5972 =
      "Logical operator related error.";
  public static final String MESSAGE_LOGICAL_OPTIMIZE_RELATED_ERROR_36D63CB3 =
      "Logical optimize related error.";
  public static final String MESSAGE_UNSUPPORTED_FILL_TYPE_RELATED_ERROR_67BE2CF2 =
      "Unsupported fill type related error.";
  public static final String MESSAGE_QUERY_PROCESS_RELATED_ERROR_93FA1016 =
      "Query process related error.";
  public static final String MESSAGE_WRITING_DATA_RELATED_ERROR_0CA06C4D =
      "Writing data related error.";
