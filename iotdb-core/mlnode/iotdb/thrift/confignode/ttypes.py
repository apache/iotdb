...
class TShowClusterResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i342 in range(_size338):
                        ...
                        _val344 = TNodeVersionInfo()
                        _val344.read(iprot)
                        self.nodeVersionInfo[_key343] = _val344
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.configNodeList is not None:
            oprot.writeFieldBegin('configNodeList', TType.LIST, 2)
            oprot.writeListBegin(TType.STRUCT, len(self.configNodeList))
            for iter345 in self.configNodeList:
                iter345.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.dataNodeList is not None:
            ...
            for iter346 in self.dataNodeList:
                iter346.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.nodeStatus is not None:
            ...
            for kiter347, viter348 in self.nodeStatus.items():
                oprot.writeI32(kiter347)
                oprot.writeString(viter348.encode('utf-8') if sys.version_info[0] == 2 else viter348)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.nodeVersionInfo is not None:
            ...
            for kiter349, viter350 in self.nodeVersionInfo.items():
                oprot.writeI32(kiter349)
...
class TShowDataNodesResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i355 in range(_size351):
                        _elem356 = TDataNodeInfo()
                        _elem356.read(iprot)
                        self.dataNodesInfoList.append(_elem356)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.dataNodesInfoList is not None:
            ...
            for iter357 in self.dataNodesInfoList:
                iter357.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TShowConfigNodesResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i362 in range(_size358):
                        _elem363 = TConfigNodeInfo()
                        _elem363.read(iprot)
                        self.configNodesInfoList.append(_elem363)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.configNodesInfoList is not None:
            ...
            for iter364 in self.configNodesInfoList:
                iter364.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TShowDatabaseResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i369 in range(_size365):
                        _key370 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val371 = TDatabaseInfo()
                        _val371.read(iprot)
                        self.databaseInfoMap[_key370] = _val371
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.databaseInfoMap is not None:
            ...
            for kiter372, viter373 in self.databaseInfoMap.items():
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i378 in range(_size374):
                        ...
                        self.databases.append(_elem379)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class TShowRegionResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i385 in range(_size381):
                        _elem386 = TRegionInfo()
                        _elem386.read(iprot)
                        self.regionInfoList.append(_elem386)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.regionInfoList is not None:
            ...
            for iter387 in self.regionInfoList:
                iter387.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TRegionRouteMapResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i392 in range(_size388):
                        _key393 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _key393.read(iprot)
                        _val394 = iotdb.thrift.common.ttypes.TRegionReplicaSet()
                        _val394.read(iprot)
                        self.regionRouteMap[_key393] = _val394
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.regionRouteMap is not None:
            ...
            for kiter395, viter396 in self.regionRouteMap.items():
...
class TGetAllTemplatesResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i401 in range(_size397):
                        _elem402 = iprot.readBinary()
                        self.templateList.append(_elem402)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.templateList is not None:
            ...
            for iter403 in self.templateList:
                oprot.writeBinary(iter403)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TGetAllPipeInfoResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i415 in range(_size411):
                        ...
                        self.allPipeInfo.append(_elem416)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.allPipeInfo is not None:
            ...
            for iter417 in self.allPipeInfo:
                oprot.writeBinary(iter417)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TCreatePipeReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i422 in range(_size418):
                        ...
                        self.extractorAttributes[_key423] = _val424
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.MAP:
                    ...
                    for _i429 in range(_size425):
                        ...
                        self.processorAttributes[_key430] = _val431
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.MAP:
                    ...
                    for _i436 in range(_size432):
                        ...
                        self.connectorAttributes[_key437] = _val438
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.extractorAttributes is not None:
            ...
            for kiter439, viter440 in self.extractorAttributes.items():
                oprot.writeString(kiter439.encode('utf-8') if sys.version_info[0] == 2 else kiter439)
                oprot.writeString(viter440.encode('utf-8') if sys.version_info[0] == 2 else viter440)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.processorAttributes is not None:
            ...
            for kiter441, viter442 in self.processorAttributes.items():
        ...
        if self.connectorAttributes is not None:
            ...
            for kiter443, viter444 in self.connectorAttributes.items():
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i449 in range(_size445):
                        _key450 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val451 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.attributes[_key450] = _val451
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class TGetPipeSinkResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i458 in range(_size454):
                        _elem459 = TPipeSinkInfo()
                        _elem459.read(iprot)
                        self.pipeSinkInfoList.append(_elem459)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.pipeSinkInfoList is not None:
            ...
            for iter460 in self.pipeSinkInfoList:
                iter460.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TShowPipeResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i465 in range(_size461):
                        _elem466 = TShowPipeInfo()
                        _elem466.read(iprot)
                        self.pipeInfoList.append(_elem466)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.pipeInfoList is not None:
            ...
            for iter467 in self.pipeInfoList:
                iter467.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TCreateModelReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i479 in range(_size475):
                        _elem480 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.queryExpressions.append(_elem480)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i485 in range(_size481):
                        ...
                        _val487 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.modelConfigs[_key486] = _val487
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.queryExpressions is not None:
            ...
            for iter488 in self.queryExpressions:
        ...
        if self.modelConfigs is not None:
            ...
            for kiter489, viter490 in self.modelConfigs.items():
...
class TShowModelResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i495 in range(_size491):
                        ...
                        self.modelInfoList.append(_elem496)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.modelInfoList is not None:
            ...
            for iter497 in self.modelInfoList:
                oprot.writeBinary(iter497)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TShowTrailResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i502 in range(_size498):
                        ...
                        self.trailInfoList.append(_elem503)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.trailInfoList is not None:
            ...
            for iter504 in self.trailInfoList:
                oprot.writeBinary(iter504)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TUpdateModelInfoReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i509 in range(_size505):
                        ...
                        _val511 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.modelInfo[_key510] = _val511
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.modelInfo is not None:
            ...
            for kiter512, viter513 in self.modelInfo.items():
...
class TSpaceQuotaResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i518 in range(_size514):
                        ...
                        _val520 = iotdb.thrift.common.ttypes.TSpaceQuota()
                        _val520.read(iprot)
                        self.spaceQuota[_key519] = _val520
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.MAP:
                    ...
                    for _i525 in range(_size521):
                        _key526 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val527 = iotdb.thrift.common.ttypes.TSpaceQuota()
                        _val527.read(iprot)
                        self.spaceQuotaUsage[_key526] = _val527
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.spaceQuota is not None:
            ...
            for kiter528, viter529 in self.spaceQuota.items():
        ...
        if self.spaceQuotaUsage is not None:
            ...
            for kiter530, viter531 in self.spaceQuotaUsage.items():
...
class TThrottleQuotaResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i536 in range(_size532):
                        _key537 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val538 = iotdb.thrift.common.ttypes.TThrottleQuota()
                        _val538.read(iprot)
                        self.throttleQuota[_key537] = _val538
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.throttleQuota is not None:
            ...
            for kiter539, viter540 in self.throttleQuota.items():
                oprot.writeString(kiter539.encode('utf-8') if sys.version_info[0] == 2 else kiter539)
