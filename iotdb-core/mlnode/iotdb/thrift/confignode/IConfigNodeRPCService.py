...
class countMatchedDatabases_args(object):
            ...
            if fid == -1:
                if ftype == TType.LIST:
                    ...
                    for _i536 in range(_size532):
                        ...
                        self.DatabasePathPattern.append(_elem537)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.DatabasePathPattern is not None:
            ...
            for iter538 in self.DatabasePathPattern:
...
class getMatchedDatabaseSchemas_args(object):
            ...
            if fid == -1:
                if ftype == TType.LIST:
                    ...
                    for _i543 in range(_size539):
                        ...
                        self.DatabasePathPattern.append(_elem544)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.DatabasePathPattern is not None:
            oprot.writeFieldBegin('DatabasePathPattern', TType.LIST, -1)
            oprot.writeListBegin(TType.STRING, len(self.DatabasePathPattern))
            for iter545 in self.DatabasePathPattern:
...
class showDatabase_args(object):
            ...
            if fid == -1:
                if ftype == TType.LIST:
                    ...
                    for _i550 in range(_size546):
                        ...
                        self.databasePathPattern.append(_elem551)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.databasePathPattern is not None:
            oprot.writeFieldBegin('databasePathPattern', TType.LIST, -1)
            oprot.writeListBegin(TType.STRING, len(self.databasePathPattern))
            for iter552 in self.databasePathPattern:
            ...
            if fid == -1:
                if ftype == TType.LIST:
                    ...
                    for _i557 in range(_size553):
                        ...
                        self.databases.append(_elem558)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
