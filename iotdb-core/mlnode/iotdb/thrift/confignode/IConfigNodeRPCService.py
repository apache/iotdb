...
class countMatchedDatabases_args(object):
            ...
            if fid == -1:
                if ftype == TType.LIST:
                    ...
                    for _i545 in range(_size541):
                        _elem546 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.DatabasePathPattern.append(_elem546)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.DatabasePathPattern is not None:
            ...
            for iter547 in self.DatabasePathPattern:
...
class getMatchedDatabaseSchemas_args(object):
            ...
            if fid == -1:
                if ftype == TType.LIST:
                    ...
                    for _i552 in range(_size548):
                        ...
                        self.DatabasePathPattern.append(_elem553)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.DatabasePathPattern is not None:
            oprot.writeFieldBegin('DatabasePathPattern', TType.LIST, -1)
            oprot.writeListBegin(TType.STRING, len(self.DatabasePathPattern))
            for iter554 in self.DatabasePathPattern:
...
class showDatabase_args(object):
            ...
            if fid == -1:
                if ftype == TType.LIST:
                    ...
                    for _i559 in range(_size555):
                        ...
                        self.databasePathPattern.append(_elem560)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.databasePathPattern is not None:
            oprot.writeFieldBegin('databasePathPattern', TType.LIST, -1)
            oprot.writeListBegin(TType.STRING, len(self.databasePathPattern))
            for iter561 in self.databasePathPattern:
            ...
            if fid == -1:
                if ftype == TType.LIST:
                    ...
                    for _i566 in range(_size562):
                        ...
                        self.databases.append(_elem567)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
