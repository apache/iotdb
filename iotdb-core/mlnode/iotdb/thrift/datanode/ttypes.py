...
class THeartbeatReq(object):
    ...
    def __init__(self, heartbeatTimestamp=None, needJudgeLeader=None, needSamplingLoad=None, timeSeriesQuotaRemain=None, schemaRegionIds=None, dataRegionIds=None, spaceQuotaUsage=None, needPipeMetaList=None, deviceQuotaRemain=None,):
...
class THeartbeatResp(object):
    ...
    def __init__(self, heartbeatTimestamp=None, status=None, statusReason=None, judgedLeaders=None, loadSample=None, regionSeriesUsageMap=None, regionDeviceUsageMap=None, regionDisk=None, schemaLimitLevel=None, pipeMetaList=None,):
        self.heartbeatTimestamp = heartbeatTimestamp
        self.status = status
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i90 in range(_size86):
                        ...
                        self.regionSeriesUsageMap[_key91] = _val92
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
                if ftype == TType.MAP:
                    ...
                    for _i97 in range(_size93):
                        ...
                        self.regionDeviceUsageMap[_key98] = _val99
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
    ...
    def write(self, oprot):
        ...
        if self.regionSeriesUsageMap is not None:
            ...
            for kiter115, viter116 in self.regionSeriesUsageMap.items():
        ...
        if self.regionDeviceUsageMap is not None:
            ...
            for kiter117, viter118 in self.regionDeviceUsageMap.items():
...
class TLoadCommandReq(object):
    ...
    def __init__(self, commandType=None, uuid=None, isGeneratedByPipe=None,):
