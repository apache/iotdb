...
//            System.out.println("bit_width_value[1]="+bit_width_value[1]);
    ...
    private static int numberOfEncodeSegment2Bytes(int[][] delta_segments, int[][] bit_width_segments, int segment_size) {
...
//        System.out.println("value pos_encode:"+pos_encode);
    ...
    private static int REGERBlockEncoder(int[][] data, int i, int block_size, int supply_length, int segment_size, int encode_pos, byte[] cur_byte) {
...
//                data[j + i * block_size][0] -= min_time;
        ...
        time_length[0] = numberOfEncodeSegment2Bytes(ts_block_delta_time, bit_width_segments_time, segment_size);


        encode_pos = encodeSegment2Bytes(ts_block_delta_time, bit_width_segments_time, time_length, segment_size, theta_time, encode_pos, cur_byte);
...
//            System.out.println(encode_pos);
        ...
        if (remaining_length != 0 && remaining_length != 1) {
            ...
            encode_pos = REGERBlockEncoder(data, block_num, block_size, supple_length+remaining_length, segment_size, encode_pos, encoded_result);
...
//        String parent_dir = "C:/Users/xiaoj/Desktop/test";
        ...
        String output_parent_dir = "/Users/xiaojinzhao/Documents/GitHub/encoding-reorder/compression_ratio/reger_only_segment";
...
//        for (int file_i = 9; file_i < 10; file_i++) {
            ...
            for (File f : tempList) {
                ...
                for (int repeat = 0; repeat < repeatTime2; repeat++)
                    length = ReorderingRegressionEncoder(data2_arr, dataset_block_size.get(file_i), 8, encoded_result);
...
//        String parent_dir = "C:/Users/xiaoj/Desktop/test";
        String parent_dir = "/Users/xiaojinzhao/Documents/GitHub/iotdb/iotdb-core/tsfile/src/test/resources/";
        String output_parent_dir = "/Users/xiaojinzhao/Documents/GitHub/encoding-reorder/compression_ratio/block_size_only_segment";
...
//        String parent_dir = "C:/Users/xiaoj/Desktop/test";
        String parent_dir = "/Users/xiaojinzhao/Documents/GitHub/iotdb/iotdb-core/tsfile/src/test/resources/";
        String output_parent_dir = "/Users/xiaojinzhao/Documents/GitHub/encoding-reorder/compression_ratio/pack_size_only_segment";
...
//        for (int file_i = 6; file_i < input_path_list.size(); file_i++) {
            ...
            for (File f : tempList) {
                ...
                for(int segment_size_exp = 6;segment_size_exp>2;segment_size_exp--){
                    ...
                    int length = 0;
                    for (int repeat = 0; repeat < repeatTime2; repeat++)
                        length = ReorderingRegressionEncoder(data2_arr, dataset_block_size.get(file_i), segment_size, encoded_result);
                    long e = System.nanoTime();
                    encodeTime += ((e - s) / repeatTime2);
                    compressed_size += length;
                    double ratioTmp = compressed_size / (double) (data.size() * Integer.BYTES * 2);
