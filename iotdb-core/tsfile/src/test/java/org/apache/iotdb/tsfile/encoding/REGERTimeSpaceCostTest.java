...
public class REGERTimeSpaceCostTest {
    ...
    for (int segment_i = 0; segment_i < segment_n; segment_i++) {
      ...
      pos_encode =
          bitPacking(
              ...
              pos_encode,
              encoded_result);
      //            pos_encode = bitPacking(delta_segments, 1, segment_i * segment_size + 1,
      // segment_size, bit_width_value, pos_encode, encoded_result);
    }
  ...
  public void REGER() throws IOException {
    ...
    String output_parent_dir =
        "/Users/xiaojinzhao/Documents/GitHub/encoding-reorder/compression_ratio/reger_time_space_cost";
    int pack_size = 16;
    int block_size = 512;
