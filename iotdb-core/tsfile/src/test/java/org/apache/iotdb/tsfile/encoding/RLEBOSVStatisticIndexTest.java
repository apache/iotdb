...
public class RLEBOSVStatisticIndexTest {
    ...
    private static int BOSBlockEncoder(int[] ts_block, int block_i, int block_size,int remaining, int encode_pos , byte[] cur_byte, int[] index_bitmap) {
        ...
        encode_pos = BOSEncodeBits(ts_block_delta,init_block_size,  final_k_start_value, final_k_end_value, max_delta_value,
                min_delta,repeat_count, encode_pos , cur_byte, index_bitmap);
    ...
    public static int BOSEncoder(
        ...
        int[] index_bitmap = new int[2];
        index_bitmap[0] = 0;
        index_bitmap[1] = 0;
        for (int i = 0; i < block_num; i++) {
            encode_pos =  BOSBlockEncoder(data, i, block_size, block_size,encode_pos,encoded_result,index_bitmap);
//            System.out.println(encode_pos);
        ...
        if (remaining_length <= 3) {
            ...
            encode_pos = BOSBlockEncoder(data, block_num, block_size,remaining, encode_pos,encoded_result,index_bitmap);
...
//            encode_pos = BOSBlockEncoder(ts_block, encode_pos,encoded_result);
        ...
        System.out.println("bitmap: "+index_bitmap[0]);
        System.out.println("direct index:"+index_bitmap[1]);
        return encode_pos;
    }
...
//        String parent_dir = "/Users/zihanguo/Downloads/R/outlier/outliier_code/encoding-outlier/";
        String output_parent_dir = parent_dir + "vldb/compression_ratio/aaa0000test";
