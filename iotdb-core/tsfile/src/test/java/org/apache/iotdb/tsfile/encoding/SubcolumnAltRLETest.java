...
public class SubcolumnAltRLETest {
    /**
     * 位宽
     * 
     * @param value
    ...
    public static int BOSBlockEncoder(int[] data, int block_index, int block_size, int remainder,
        ...
        writeBits(encoded_result, startBitPosition, 32, data_delta.length);
        startBitPosition += 32;
        ...
        writeBits(encoded_result, startBitPosition, 8, repeat_count_arr.length);
        startBitPosition += 8;
        ...
        startBitPosition = SubcolumnAltEncoder(repeat_count_arr, startBitPosition, encoded_result);
    ...
    public static int BOSBlockDecoder(byte[] encoded_result, int block_index, int block_size, int remainder,
        ...
        int data_delta_length = readBits(encoded_result, startBitPosition, 32, 0);
        startBitPosition += 32;

        int repeat_count_length = readBits(encoded_result, startBitPosition, 8, 0);
        startBitPosition += 8;
        ...
        startBitPosition = SubcolumnAltDecoder(encoded_result, startBitPosition, repeat_count);
    ...
    public void testBOS() throws IOException {
        ...
        output_path_list.add(output_parent_dir + "subcolumn_alt_rle.csv");
