...
public class REGERRandomSortTest {
...
//            System.out.println(i);
    ...
    public void REGERTimeSortTest() throws IOException {
        ...
        String output_parent_dir = "/Users/xiaojinzhao/Documents/GitHub/encoding-reorder/compression_ratio/reger_sort_random";
        int pack_size = 16;
        int block_size = 512;
        ...
        for (int file_i = 0; file_i < input_path_list.size(); file_i++) {
            ...
            for (File f : tempList) {
                ...
                shuffleArray(data2_arr);
//                System.out.println(Arrays.toString(data2_arr));
