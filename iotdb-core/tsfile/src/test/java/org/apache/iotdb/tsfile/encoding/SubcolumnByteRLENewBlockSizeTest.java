...
public class SubcolumnByteRLENewBlockSizeTest {
    // SubcolumnByteRLENewTest 测试不同 block size
    ...
    public void testSubcolumn() throws IOException {
        ...
        for (int block_size : block_size_list) {
            ...
            for (File file : csvFiles) {
                ...
                for (int repeat = 0; repeat < repeatTime; repeat++) {
                    int[] data2_arr_decoded = SubcolumnByteRLENewTest.Decoder(encoded_result);
