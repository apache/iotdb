...
//                final_k2 = cur_k2;
        ...
        if(min_bits_center >= center_bits_3_part){
            encode_pos += 23;
            ...
            int final_center_bits =(final_k3 *getBitWith(final_x_2_minus-final_x_l_plus)
                    +(n_center_values-final_k3)*getBitWith(final_x_u_minus-(final_x_2_plus)));
            encode_pos += (final_center_bits)/8;
            encode_pos += ((block_size *2)/8);
        }
