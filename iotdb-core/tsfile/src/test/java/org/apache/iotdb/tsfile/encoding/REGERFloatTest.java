...
public class REGERFloatTest {
  ...
  public static void pack8Values(
      long[] values, int index, int offset, int width, int encode_pos, byte[] encoded_result) {
    int bufIdx = 0;
    int valueIdx = offset;
  ...
  public static void splitTimeStamp3(ArrayList<Long> ts_block, ArrayList<Integer> result) {
    int td_common = 0;
  ...
  private static void adjust1TimeCost(
      long[] ts_block, int i, int[] raw_length, ArrayList<Integer> min_index, float[] theta) {
    ...
    while (j < block_size) {
      tmp_j = ts_block[j];
      int epsilon_r_j = getTime(tmp_j) - (int) (theta0_t + theta1_t * (float) getTime(tmp_j_1));
  ...
  private static void adjust1ValueCost(
    ...
    int min_delta_value =
        getValue(ts_block[i]) - (int) (theta0_v + theta1_v * (float) getValue(ts_block[i - 1]));
    ...
    while (j < block_size) {
      tmp_j = ts_block[j];
      int epsilon_r_j = getValue(tmp_j) - (int) (theta0_v + theta1_v * (float) getValue(tmp_j_1));
  ...
  private static int[] adjust0MinChange(long[] ts_block, int j, float[] theta) {
    int block_size = ts_block.length;
    assert j != block_size;
    ...
    for (int i = 2; i < block_size; i++) {
      ...
      if (i != j) {
        ...
        timestamp_delta_i = getTime(tmp_j) - (int) (theta0_t + theta1_t * (float) getTime(tmp_0));
        value_delta_i = getValue(tmp_j) - (int) (theta0_v + theta1_v * (float) getValue(tmp_0));
  ...
  private static int[] adjust0MinChangeNo(long[] ts_block, int[] raw_length, int j, float[] theta) {
    int block_size = ts_block.length;
    assert j != block_size;
    ...
    timestamp_delta_i =
        getTime(tmp_j_plus_1) - (int) (theta0_t + theta1_t * (float) getTime(tmp_j_minus_1));
    value_delta_i =
        getValue(tmp_j_plus_1) - (int) (theta0_v + theta1_v * (float) getValue(tmp_j_minus_1));
    ...
    timestamp_delta_i =
        getTime(tmp_0) - (int) (theta0_t + theta1_t * (float) getTime(tmp_j_minus_1));
    ...
    timestamp_delta_i =
        getTime(tmp_j_plus_1) - (int) (theta0_t + theta1_t * (float) getTime(tmp_0));
  ...
  // adjust 0 to n
  private static int[] adjust0n1MinChange(long[] ts_block, float[] theta) {
    int block_size = ts_block.length;
    int[] b = new int[3];
    int timestamp_delta_min = Integer.MAX_VALUE;
    int value_delta_min = Integer.MAX_VALUE;
    ...
    timestamp_delta_i =
        getTime(tmp_0) - (int) (theta0_t + theta1_t * (float) getTime(tmp_block_size_1));
    value_delta_i =
        getValue(tmp_0) - (int) (theta0_v + theta1_v * (float) getValue(tmp_block_size_1));
    ts_block_delta[pos_ts_block_delta] = combine2Int(timestamp_delta_i, value_delta_i);
    pos_ts_block_delta++;
  ...
  private static int[] adjust0n1MinChangeNo(long[] ts_block, int[] raw_length, float[] theta) {
    int block_size = ts_block.length;
    int[] b = new int[3];
    int timestamp_delta_min = raw_length[3];
    int value_delta_min = raw_length[4];
  ...
  // adjust n to no 0
  private static int[] adjustnMinChange(long[] ts_block, int j, float[] theta) {
    int block_size = ts_block.length;
    assert j != 0;
    int[] b = new int[3];
    int timestamp_delta_min = Integer.MAX_VALUE;
    ...
    for (int i = 1; i < block_size - 1; i++) {
      ...
      if (i != j) {
        ...
        timestamp_delta_i =
            getTime(tmp_j) - (int) (theta0_t + theta1_t * (float) getTime(tmp_block_size_1));
        value_delta_i =
            getValue(tmp_j) - (int) (theta0_v + theta1_v * (float) getValue(tmp_block_size_1));
        ts_block_delta[pos_ts_block_delta] = combine2Int(timestamp_delta_i, value_delta_i);
        pos_ts_block_delta++;
        if (timestamp_delta_i < timestamp_delta_min) {
          timestamp_delta_min = timestamp_delta_i;
        ...
        timestamp_delta_i =
            getTime(tmp_block_size_1) - (int) (theta0_t + theta1_t * (float) getTime(tmp_j_1));
        value_delta_i =
            getValue(tmp_block_size_1) - (int) (theta0_v + theta1_v * (float) getValue(tmp_j_1));
      }
      ts_block_delta[pos_ts_block_delta] = combine2Int(timestamp_delta_i, value_delta_i);
      pos_ts_block_delta++;
  ...
  private static int[] adjustnMinChangeNo(long[] ts_block, int[] raw_length, int j, float[] theta) {
    int block_size = ts_block.length;
    assert j != 0;
    int[] b = new int[3];
    int timestamp_delta_min = raw_length[3];
    ...
    timestamp_delta_i =
        getTime(tmp_block_size_1) - (int) (theta0_t + theta1_t * (float) getTime(tmp_block_size_2));
    value_delta_i =
        getValue(tmp_block_size_1)
            - (int) (theta0_v + theta1_v * (float) getValue(tmp_block_size_2));
  ...
  private static int[] adjustn0MinChangeNo(long[] ts_block, int[] raw_length, float[] theta) {
    int block_size = ts_block.length;
    int[] b = new int[3];
    int timestamp_delta_min = raw_length[3];
    int value_delta_min = raw_length[4];
  ...
  private static int[] adjustAlphaToJMinChange(
      ...
      float[] theta,
      long tmp_alpha,
      long tmp_alpha_plus_1,
      long tmp_alpha_minus_1) {
    ...
    for (int i = 1; i < block_size; i++) {
      ...
      if (i == j) {
        timestamp_delta_i =
            getTime(tmp_j) - (int) (theta0_t + theta1_t * (float) getTime(tmp_alpha));
        value_delta_i = getValue(tmp_j) - (int) (theta0_v + theta1_v * (float) getValue(tmp_alpha));
      } else if (i == alpha) {
        timestamp_delta_i =
            getTime(tmp_alpha) - (int) (theta0_t + theta1_t * (float) getTime(tmp_j_minus_1));
        value_delta_i =
            getValue(tmp_alpha) - (int) (theta0_v + theta1_v * (float) getValue(tmp_j_minus_1));
      } else if (i == alpha + 1) {
        timestamp_delta_i =
            getTime(tmp_alpha_plus_1)
                - (int) (theta0_t + theta1_t * (float) getTime(tmp_alpha_minus_1));
        value_delta_i =
            getValue(tmp_alpha_plus_1)
                - (int) (theta0_v + theta1_v * (float) getValue(tmp_alpha_minus_1));
      } else {
        long tmp_i = ts_block[i];
        long tmp_i_1 = ts_block[i - 1];
        timestamp_delta_i = getTime(tmp_i) - (int) (theta0_t + theta1_t * (float) getTime(tmp_i_1));
  ...
  private static int[] adjustAlphaToJMinChangeNo(
    ...
    timestamp_delta_i =
        getTime(tmp_alpha_plus_1) - (int) (theta0_t + theta1_t * (float) getTime(tmp_alpha));
    value_delta_i =
        getValue(tmp_alpha_plus_1) - (int) (theta0_v + theta1_v * (float) getValue(tmp_alpha));
    length -= getBitWith(timestamp_delta_i - timestamp_delta_min);
    length -= getBitWith(value_delta_i - value_delta_min);

    timestamp_delta_i =
        getTime(tmp_alpha) - (int) (theta0_t + theta1_t * (float) getTime(tmp_alpha_minus_1));
    value_delta_i =
        getValue(tmp_alpha) - (int) (theta0_v + theta1_v * (float) getValue(tmp_alpha_minus_1));
    length -= getBitWith(timestamp_delta_i - timestamp_delta_min);
    length -= getBitWith(value_delta_i - value_delta_min);

    timestamp_delta_i =
        getTime(tmp_j) - (int) (theta0_t + theta1_t * (float) getTime(tmp_j_minus_1));
  ...
  // move alpha to 0
  private static int[] adjustTo0MinChange(
      long[] ts_block,
      int alpha,
      float[] theta,
      long tmp_alpha,
    ...
    for (int i = 1; i < block_size; i++) {
      ...
      if (i == (alpha + 1)) {
        ...
        long tmp_0 = ts_block[0];
        timestamp_delta_i =
            getTime(tmp_0) - (int) (theta0_t + theta1_t * (float) getTime(tmp_alpha));
  ...
  private static int[] adjustTonMinChange(
    ...
    for (int i = 1; i < block_size; i++) {
      ...
      if (i == (alpha + 1)) {
        ...
        long tmp_block_size_1 = ts_block[block_size - 1];
        timestamp_delta_i =
            getTime(tmp_alpha) - (int) (theta0_t + theta1_t * (float) getTime(tmp_block_size_1));
        value_delta_i =
            getValue(tmp_alpha) - (int) (theta0_v + theta1_v * (float) getValue(tmp_block_size_1));
      } else {
        long tmp_i = ts_block[i];
        long tmp_i_1 = ts_block[i - 1];
        timestamp_delta_i = getTime(tmp_i) - (int) (theta0_t + theta1_t * (float) getTime(tmp_i_1));
  ...
  public static long[] getEncodeBitsRegressionNoTrain(
      long[] ts_block, int block_size, int[] raw_length, float[] theta, int segment_size) {
    ...
    while (j < block_size) {
      ...
      int epsilon_r_j = getTime(tmp_j) - (int) (theta0_r + theta1_r * (float) getTime(tmp_j_1));
      int epsilon_v_j = getValue(tmp_j) - (int) (theta0_v + theta1_v * (float) getValue(tmp_j_1));
  ...
  public static int getBeta(
    ...
    if (alpha == 0) {
      ...
      for (int j = start_j; j < end_j; j++) {
        ...
        if (alpha != j && (alpha + 1) != j) {
          if (min_index.contains(
            ...
            b =
                adjustAlphaToJMinChange(
                    ts_block, alpha, j, theta, tmp_alpha, tmp_alpha_plus_1, tmp_alpha_minus_1);
          } else {
            b =
                adjustAlphaToJMinChangeNo(
                    ts_block,
                    raw_length,
                    alpha,
                    j,
      ...
      if (min_index.contains(0)) { // || min_index.contains(alpha) || min_index.contains(alpha + 1)
        b =
            adjustTo0MinChange(
                ts_block, alpha, theta, tmp_alpha, tmp_alpha_plus_1, tmp_alpha_minus_1);
      } else {
        b =
            adjustTo0MinChangeNo(
                ts_block, raw_length, alpha, theta, tmp_alpha, tmp_alpha_plus_1, tmp_alpha_minus_1);
      }
      if (b[0] < raw_abs_sum) {
        raw_abs_sum = b[0];
        j_star_list = new ArrayList<>();
  ...
  public static int[] getIStar(
      long[] ts_block, ArrayList<Integer> min_index, int block_size, float[] theta) {
    int timestamp_delta_max = Integer.MIN_VALUE;
    int value_delta_max = Integer.MIN_VALUE;
    int timestamp_delta_min = Integer.MAX_VALUE;
    int value_delta_min = Integer.MAX_VALUE;
  ...
  public static int encodeRLEBitWidth2Bytes(long[] bit_width_segments) {
  ...
  private static long[] ReorderingTimeSeries(
      long[] ts_block, int[] raw_length, float[] theta, int segment_size) {
    ...
    while (pos_new_length_list != 0) {
      ...
      if (min_length <= raw_length[0]) {
        ...
        moveAlphaToBeta(
            new_ts_block, new_alpha_list[min_length_index], beta_list[min_length_index]);
        int[] new_length = raw_length.clone();
  ...
  private static int REGERBlockEncoder(
    ...
    long[] ts_block_delta_time =
        getEncodeBitsRegressionNoTrain(ts_block, block_size, time_length, theta_time, segment_size);
    ...
    long[] ts_block_delta_partition =
        getEncodeBitsRegressionNoTrain(
            ts_block_partition, block_size, partition_length, theta_partition, segment_size);

    Arrays.sort(ts_block_value);
    trainParameter(ts_block_value, block_size, theta_reorder);
    long[] ts_block_delta_reorder =
        getEncodeBitsRegressionNoTrain(
            ts_block_value, block_size, reorder_length, theta_reorder, segment_size);
    ...
    if (choose == 0) {
      ...
      ts_block_delta_partition =
          ReorderingTimeSeries(ts_block_partition, partition_length, theta_partition, segment_size);
  ...
  public static int ReorderingRegressionEncoder(
      long[] data, int block_size, int[] third_value, int segment_size, byte[] encoded_result) {
    block_size++;
  ...
  private static void encodeSort(
      int[] block_sort, int encode_pos_block_sort, byte[] encoded_result) {
  ...
  public static int REGERBlockDecoder(
    ...
    for (int segment_i = 0; segment_i < segment_n; segment_i++) {
      ...
      for (; pos_decode_time_result < length_decode_time_result; pos_decode_time_result++) {
        pre_time =
            (int) (theta_time0 + theta_time1 * (float) pre_time)
                + decode_time_result[pos_decode_time_result]
                + min_time;
        pre_value =
            (int) (theta_value0 + theta_value1 * (float) pre_value)
                + decode_value_result[pos_decode_time_result]
                + min_value;
  ...
  public static int REGERBlockDecoderValue(
      byte[] encoded,
      int decode_pos,
      int[][] value_list,
      int block_size,
  ...
  public void REGER() throws IOException {
    ...
    String output_parent_dir =
        "/Users/xiaojinzhao/Documents/GitHub/encoding-reorder/compression_ratio/reger_float";
    int pack_size = 16;
    int block_size = 512;
  ...
  @Test
  public void REGERTest() throws IOException {
    ...
    for (int file_i = 0; file_i < 1; file_i++) {
      ...
      for (File f : tempList) {
        ...
        System.out.println("Memory used: " + (memoryAfter - memoryBefore) / (1024 * 1024));
        long e = System.nanoTime();
        encodeTime += ((e - s) / repeatTime2);
        compressed_size += length;
        double ratioTmp = compressed_size / (double) (data.size() * Integer.BYTES * 2);
      ...
      for (File f : tempList) {
        ...
        for (int block_size_exp = 13; block_size_exp >= 4; block_size_exp--) {
          ...
          for (int repeat = 0; repeat < repeatTime2; repeat++)
            length =
                ReorderingRegressionEncoder(
                    data2_arr, block_size, dataset_third.get(file_i), pack_size, encoded_result);
          long e = System.nanoTime();
          encodeTime += ((e - s) / repeatTime2);
          compressed_size += length;
          double ratioTmp = compressed_size / (double) (data.size() * Integer.BYTES * 2);
  ...
  @Test
  public void REGERVaryBlockSizeMemoryTest() throws IOException {
    //        String parent_dir = "C:/Users/xiaoj/Desktop/test";
    String parent_dir =
        "/Users/xiaojinzhao/Documents/GitHub/iotdb/iotdb-core/tsfile/src/test/resources/";
    String output_parent_dir =
        "/Users/xiaojinzhao/Documents/GitHub/encoding-reorder/compression_ratio/block_size_memory";
    int pack_size = 16;
      ...
      for (File f : tempList) {
        ...
        for (int block_size_exp = 13; block_size_exp >= 4; block_size_exp--) {
          ...
          for (int repeat = 0; repeat < repeatTime2; repeat++) {
            ...
            encodeTime += (e - s);
            long memoryAfter = runtime.totalMemory() - runtime.freeMemory();
            memory_cost += (memoryAfter - memoryBefore) / (data.size());
          }
          encodeTime /= repeatTime2;
          memory_cost /= repeatTime2;
          System.out.println("Memory used: " + (memory_cost));
          compressed_size += length;
