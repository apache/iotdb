...
public class Subcolumn5BetaQueryEqualTest {
    // Subcolumn5Test Query Equal
    ...
    public void testQuery() throws IOException {
        ...
        for (int beta : beta_list) {
            String outputPath = output_parent_dir + "subcolumn5_query_equal_beta_" + beta + ".csv";
            ...
            for (File file : csvFiles) {
                ...
                for (int repeat = 0; repeat < repeatTime; repeat++) {
                    Subcolumn5QueryEqualTest.Query(encoded_result, queryRange.get(datasetName));
                }
