...
public class Subcolumn5BetaQueryLessTest {
    ...
    public void testQuery() throws IOException {
        ...
        for (int beta : beta_list) {
            String outputPath = output_parent_dir + "subcolumn5_query_less_beta_" + beta + ".csv";
            ...
            for (File file : csvFiles) {
                ...
                for (int repeat = 0; repeat < repeatTime; repeat++) {
                    Subcolumn5QueryLessTest.Query(encoded_result, queryRange.get(datasetName));
                }
