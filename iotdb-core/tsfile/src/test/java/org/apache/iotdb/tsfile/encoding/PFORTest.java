...
public class PFORTest {
  ...
  public static int[] getAbsDeltaTsBlock(int[] ts_block, ArrayList<Integer> min_delta) {
  ...
  public static int[] getAbsDeltaTsBlockSPRINTZ(int[] ts_block, ArrayList<Integer> min_delta) {
    int[] ts_block_delta = new int[ts_block.length - 1];
  ...
  public static ArrayList<Integer> getAbsDeltaTsBlockRLE(
      int[] ts_block, ArrayList<Integer> min_delta, ArrayList<Integer> repeat_count) {
    ...
    for (int i = 1; i < block_size; i++) {
      ...
      if (delta == pre_delta) {
        ...
        if (pre_count > 7) {
          ...
          for (int j = 0; j < pre_count; j++) ts_block_delta.add(pre_delta);
        }
        pre_count = 1;
        repeat_i = i;
      }
                    ...
                    case "TS_2DIFF":
                      {
                        ...
                        int[] min_sliceBlock =
                            Arrays.copyOfRange(outBlock2, offset + 2, first_endindex);
                        ...
                        while (offset != outBlock.size()) {
                          ...
                          for (i = 0; i < origin_size; i++) {
                            uncompressed[j] =
                                sliceUncompressed[i] + new_min[k] + uncompressed[j - 1];
                            j++;
                          }
                          k++;
                          offset = endindex;
                    ...
                    case "RLE":
                      {
                        ...
                        while (offset < data.size()) {
                          ...
                          ArrayList<Integer> new_slice_list =
                              getAbsDeltaTsBlockRLE(slice, min, repeat_list);
                        ...
                        while (offset != outBlock.size()) {
                          ...
                          for (index1 = 0; index1 < origin_size; index1++) {
                            if (index2 < sliceUncompressed2.length
                                && fake_index == sliceUncompressed2[index2]) {
                              // repeat
              ...
              case "TS_2DIFF":
                {
                  ...
                  while (fileRepeat < 1) {
                    ...
                    for (int index : columnIndexes) {
                      ...
                      outputoffset = new IntWrapper(0);
                      codec.compress(
                          minList, inputoffset, minList.length, compressed, outputoffset);
                      compressed = Arrays.copyOf(compressed, outputoffset.intValue());
                      ...
                      while (offset != outBlock.size()) {
                        ...
                        codec.uncompress(
                            sliceBlock, new IntWrapper(0), sliceBlock.length, recovered, recoffset);
                        uncompressed[j] = new_min[k];
                        j++;
                        k++;
                        for (i = 0; i < origin_size; i++) {
                  ...
                  while (fileRepeat < 1) {
                    ...
                    for (int index : columnIndexes) {
                      ...
                      while (offset < data.size()) {
                        ...
                        outputoffset = new IntWrapper(0);
                        codec.compress(
                            repeat, inputoffset, repeat.length, compressed, outputoffset);
                        compressed = Arrays.copyOf(compressed, outputoffset.intValue());
                        outBlock.add(compressed.length);
                        outBlock.add(repeat.length);
                        for (i = 0; i < compressed.length; i++) {
