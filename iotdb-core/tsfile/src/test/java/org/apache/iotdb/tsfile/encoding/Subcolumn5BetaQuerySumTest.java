...
public class Subcolumn5BetaQuerySumTest {
    ...
    public void testQuery() throws IOException {
        ...
        for (int beta : beta_list) {
            String outputPath = output_parent_dir + "subcolumn5_query_sum_beta_" + beta + ".csv";
            ...
            for (File file : csvFiles) {
                ...
                for (int repeat = 0; repeat < repeatTime; repeat++) {
                    Subcolumn5QuerySumTest.Query(encoded_result);
                }
