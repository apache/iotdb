...
//        int final_k_start_value = ts_block_order_value[0];
        ...
        int start_value_size =  unique_value_count - 1;

//        for(int k_spread_value_i = 1;k_spread_value_i < max_delta_value_bit_width;k_spread_value_i++){
//            int k_spread_value = spread_value[k_spread_value_i];
//            for (int start_value_i = 1; start_value_i < start_value_size; start_value_i++) {
...
//        }
        ...
        for (int start_value_i = 1; start_value_i < start_value_size; start_value_i++) {
            ...
            int cur_k1 = getCount(sorted_value_list[start_value_i-1],mask);
            int end_value_i = start_value_i;
            for(int k_spread_value_i = 1;k_spread_value_i < max_delta_value_bit_width;k_spread_value_i++){
                int k_spread_value = spread_value[k_spread_value_i];
                if(k_start_value < k_spread_value ){
                    int k_start_value_next = getUniqueValue(sorted_value_list[start_value_i+1], left_shift);
                    if(getBitWith(k_start_value) == getBitWith(k_start_value_next))
                        continue;
                }
