...
public class SubcolumnAltTest {
    ...
    public static int BOSBlockDecoder(byte[] encoded_result, int block_index, int block_size, int remainder,
        ...
        startBitPosition = SubcolumnAltDecoder(encoded_result, startBitPosition, block_data);
    ...
    public void testBOS() throws IOException {
        ...
        output_path_list.add(output_parent_dir + "/subcolumn_alt.csv");
