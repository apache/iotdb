...
public class TSDIFFBOSSplitTest {
...
//        if(k1+k2!=block_size)
    ...
    public static void writeListToCSV(ArrayList<Integer> list, String filePath) throws IOException {
    ...
    private static int BOSBlockEncoder(int[] ts_block, int block_i, int block_size, int remaining ,int encode_pos ,
                                       byte[] cur_byte, String output_path) throws IOException {
        ...
        String final_left_outlier_path = output_path+"left_"+block_i+".csv";
        String final_right_outlier_path = output_path+"right_"+block_i+".csv";
        String final_center_path = output_path+"center_"+block_i+".csv";
        writeListToCSV(final_left_outlier, final_left_outlier_path);
        writeListToCSV(final_right_outlier, final_right_outlier_path);
        writeListToCSV(final_normal, final_center_path);
...
//        System.out.println(encode_pos);
    ...
    public static int BOSEncoder(
            int[] data, int block_size, byte[] encoded_result, String output_path) throws IOException {
        block_size++;
        ...
        for (int i = 0; i < block_num; i++) {
            ...
            encode_pos =  BOSBlockEncoder(data, i, block_size, block_size,encode_pos,encoded_result,output_path);
        ...
        if (remaining_length <= 3) {
            ...
            encode_pos = BOSBlockEncoder(data, block_num, block_size,remaining, encode_pos,encoded_result,output_path);
...
//        String parent_dir = "/Users/zihanguo/Downloads/R/outlier/outliier_code/encoding-outlier/";
        ...
        String output_data = "/Users/xiaojinzhao/Documents/GitHub/encoding-outlier/icde0802/supply_experiment/R3O2_compare_compression/data/";
        ArrayList<String> input_path_list = new ArrayList<>();
        ArrayList<String> output_path_list = new ArrayList<>();
        ArrayList<String> dataset_name = new ArrayList<>();
        ArrayList<Integer> dataset_block_size = new ArrayList<>();
        ArrayList<String> output_data_path_list = new ArrayList<>();
        ...
        for (String value : dataset_name) {
            ...
            output_data_path_list.add(output_data+value+"/");
...
//                        data.add(Integer.valueOf(value));
                ...
                for (int repeat = 0; repeat < repeatTime2; repeat++) {
                    length =  BOSEncoder(data2_arr, dataset_block_size.get(file_i), encoded_result,output_data_path_list.get(file_i));
                }
