...
import static org.apache.iotdb.tsfile.encoding.BOSAmortization.BOSDecoder;
import static org.apache.iotdb.tsfile.encoding.BOSAmortization.BOSEncoder;

public class BOSAmortizationVaryQ {
...
//                            buffer1 = ReorderingRegressionEncoder(data1, dataset_block_size.get(file_i), dataset_name.get(file_i));
                            buffer2 = BOSEncoder(data2, dataset_block_size.get(file_i), dataset_name.get(file_i), q, 1);
                        }
