...
public class REGERValueSortTest {
  ...
  private static int REGERBlockEncoder(
    ...
    //        long[] ts_block_delta_time = getEncodeBitsRegressionNoTrain(ts_block, block_size,
    ...
    //                for (int j = block_size - 1; j >= 0; j--) {
    //                    long datum = ts_block[j];
    //                    if (getValue(datum) <= third_value[third_i] && getValue(datum) >
    ...
    //        long[] ts_block_delta_partition = getEncodeBitsRegressionNoTrain(ts_block_partition,
    // block_size, partition_length, theta_partition, segment_size);
    ...
    //            block_sort[i] = 0;
    //            ts_block_delta_time = ReorderingTimeSeries(ts_block, time_length, theta_time,
    // segment_size);
    ...
    // partition_length, segment_size, theta_partition, encode_pos, cur_byte);
    //        } else if (choose == 2) {
    //
    block_sort[i] = 1;
  ...
  @Test
  public void REGERValueSortTest() throws IOException {

    String parent_dir =
        "/Users/xiaojinzhao/Documents/GitHub/iotdb/iotdb-core/tsfile/src/test/resources/";
    String output_parent_dir =
        "/Users/xiaojinzhao/Documents/GitHub/encoding-reorder/compression_ratio/reger_sort_value";
    int pack_size = 16;
    int block_size = 512;
