...
public class SubcolumnNewQuerySumTest {
        ...
        for (int i = l - 1; i >= 0; i--) {
            ...
            if (!type) {
                ...
                for (int j = 0; j < remainder; j++) {
                    int value = SubcolumnByteRLETest.bytesToInt(encoded_result, startBitPosition + j * bitWidthList[i], bitWidthList[i]);
                ...
                int[] rle_values = SubcolumnByteRLETest.bitUnpacking(encoded_result, startBitPosition, bitWidthList[i], index);
    ...
    public void testQuery() throws IOException {
        ...
        String outputPath = output_parent_dir + "test_byte_query_sum_new.csv";
