...
showDiskUsageStatement
    : SHOW DISK_USAGE FROM (tableName=qualifiedName)
    ;
...
nonReserved
    ...
    | DATA | DATABASE | DATABASES | DATANODE | DATANODES | DATASET | DATE | DAY | DECLARE | DEFAULT | DEFINE | DEFINER | DENY | DESC | DESCRIPTOR | DETAILS| DETERMINISTIC | DEVICES | DISK_USAGE | DISTRIBUTED | DO | DOUBLE
