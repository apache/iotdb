...
import org.apache.iotdb.consensus.iotconsensusv2.thrift.TNotifyPeerToCreateConsensusPipeResp;
import org.apache.iotdb.consensus.iotconsensusv2.thrift.TNotifyPeerToDropConsensusPipeReq;
import org.apache.iotdb.consensus.iotconsensusv2.thrift.TNotifyPeerToDropConsensusPipeResp;
import org.apache.iotdb.consensus.iotconsensusv2.thrift.TSetActiveReq;
import org.apache.iotdb.consensus.iotconsensusv2.thrift.TSetActiveResp;
import org.apache.iotdb.consensus.iotconsensusv2.thrift.TWaitReleaseAllRegionRelatedResourceReq;
import org.apache.iotdb.consensus.iotconsensusv2.thrift.TWaitReleaseAllRegionRelatedResourceResp;
...
/** IoTConsensusV2ServerImpl is a consensus server implementation for pipe consensus. */
public class IoTConsensusV2ServerImpl {
  private static final Logger LOGGER = LoggerFactory.getLogger(IoTConsensusV2ServerImpl.class);
  ...
  private final IoTConsensusV2PeerManager peerManager;
  ...
  private final IoTConsensusV2ServerMetrics iotConsensusV2ServerMetrics;
  private final ReplicateMode replicateMode;

  private ProgressIndex cachedProgressIndex = MinimumProgressIndex.INSTANCE;

  public IoTConsensusV2ServerImpl(
      Peer thisNode,
      IStateMachine stateMachine,
      List<Peer> peers,
      IoTConsensusV2Config config,
      IClientManager<TEndPoint, SyncIoTConsensusV2ServiceClient> syncClientManager)
      throws IOException {
    this.thisNode = thisNode;
    this.stateMachine = stateMachine;
    this.peerManager = new IoTConsensusV2PeerManager(peers);
    ...
    this.iotConsensusV2ServerMetrics = new IoTConsensusV2ServerMetrics(this);
  ...
  public synchronized void start() throws IOException {
    stateMachine.start();
    MetricService.getInstance().addMetricSet(this.iotConsensusV2ServerMetrics);
    isStarted.set(true);
  }
  ...
  public void setRemotePeerActive(Peer peer, boolean isActive, boolean isForDeletionPurpose)
    ...
    try (SyncIoTConsensusV2ServiceClient client =
