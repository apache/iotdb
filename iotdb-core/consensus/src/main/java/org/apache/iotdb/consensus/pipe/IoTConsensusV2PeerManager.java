...
public class IoTConsensusV2PeerManager {

  private static final Logger LOGGER = LoggerFactory.getLogger(IoTConsensusV2PeerManager.class);

  private final Set<Peer> peers;

  public IoTConsensusV2PeerManager(List<Peer> peers) {
