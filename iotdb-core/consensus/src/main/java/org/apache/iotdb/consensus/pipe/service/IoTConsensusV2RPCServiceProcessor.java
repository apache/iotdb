...
public class IoTConsensusV2RPCServiceProcessor implements IoTConsensusV2IService.Iface {
  private static final Logger LOGGER =
      LoggerFactory.getLogger(IoTConsensusV2RPCServiceProcessor.class);
  private final IoTConsensusV2 iotConsensusV2;

  private final IoTConsensusV2Config.Pipe config;

  public IoTConsensusV2RPCServiceProcessor(
      IoTConsensusV2 iotConsensusV2, IoTConsensusV2Config.Pipe config) {
    this.iotConsensusV2 = iotConsensusV2;
    this.config = config;
  }

  @Override
  public TIoTConsensusV2TransferResp iotConsensusV2Transfer(TIoTConsensusV2TransferReq req) {
    return config.getConsensusPipeReceiver().receive(req);
  }

  // TODO: consider batch transfer
  @Override
  public TIoTConsensusV2BatchTransferResp iotConsensusV2BatchTransfer(
      TIoTConsensusV2BatchTransferReq req) throws TException {
    return new TIoTConsensusV2BatchTransferResp();
  }
