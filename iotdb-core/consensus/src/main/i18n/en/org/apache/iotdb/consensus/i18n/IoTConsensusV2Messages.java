...
public final class IoTConsensusV2Messages {
  ...
  public static final String RECOVER_TASK_CANCELLED = "IoTV2 Recover Task is cancelled";
  public static final String RECOVER_FUTURE_EXCEPTION =
      "Exception while waiting for recover future completion";
  public static final String RECOVER_TASK_INTERRUPTED = "IoTV2 Recover Task is interrupted";
  ...
  public static final String INACTIVATE_NEW_PEER = "[{}] inactivate new peer: {}";
  ...
  public static final String ACTIVATE_NEW_PEER = "[{}] activate new peer...";
  ...
  public static final String INACTIVATE_PEER = "[{}] inactivate peer {}";
  public static final String WAIT_TARGET_PEER_COMPLETE_TRANSFER =
      "[{}] wait target peer{} complete transfer...";
  public static final String WAIT_PEER_RELEASE_RESOURCE = "[{}] wait {} to release all resource...";
  public static final String NOT_SUPPORT_LEADER_TRANSFER = "%s does not support leader transfer";
  ...
  public static final String ERROR_SET_PEER_ACTIVE_SHORT = "error when set peer %s to active %s";
