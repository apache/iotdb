...
public final class IoTConsensusMessages {
  ...
  public static final String INACTIVATE_NEW_PEER = "[IoTConsensus] inactivate new peer: {}";
  public static final String NOTIFY_PEERS_BUILD_SYNC_LOG =
      "[IoTConsensus] notify current peers to build sync log...";
  public static final String START_TAKE_SNAPSHOT = "[IoTConsensus] start to take snapshot...";
  ...
  public static final String ACTIVATE_NEW_PEER = "[IoTConsensus] activate new peer...";
  public static final String CLEANUP_REMOTE_SNAPSHOT = "[IoTConsensus] clean up remote snapshot...";
  ...
  public static final String CLEANUP_LOCAL_SNAPSHOT = "[IoTConsensus] clean up local snapshot...";
  ...
  public static final String CANNOT_MKDIR_FOR_SNAPSHOT = "%s: cannot mkdir for snapshot";
  public static final String UNKNOWN_ERROR_TAKING_SNAPSHOT = "unknown error when taking snapshot";
  public static final String ERROR_TAKING_SNAPSHOT = "error when taking snapshot";
  public static final String CANNOT_FIND_SNAPSHOT_DIR =
      "Can not find any snapshot dir after build a new snapshot for group {}";
  public static final String DELETE_OLD_SNAPSHOT_FAILED = "Delete old snapshot dir {} failed";
  ...
  public static final String ERROR_RECEIVING_SNAPSHOT = "error when receiving snapshot %s";
  public static final String INVALID_SNAPSHOT_RELATIVE_PATH = "Invalid snapshotRelativePath: ";
  ...
  public static final String ERROR_INACTIVATING_PEER = "error when inactivating %s. %s";
  public static final String ERROR_INACTIVATING_PEER_SHORT = "error when inactivating %s";
  public static final String ERROR_TRIGGERING_SNAPSHOT_LOAD =
      "error when triggering snapshot load %s. %s";
  public static final String ERROR_ACTIVATING_PEER = "error when activating %s. %s";
  public static final String ERROR_ACTIVATING_PEER_SHORT = "error when activating %s";
  ...
  public static final String SYNC_LOG_CHANNEL_STARTED = "Sync log channel has started.";
  public static final String SYNC_LOG_CHANNEL_START_LATER = "Sync log channel maybe start later.";
  ...
  public static final String ERROR_CREATING_NEW_FILE = "Error occurred when creating new file {}";
  ...
  public static final String DISPATCHER_STARTS = "{}: Dispatcher for {} starts";
  public static final String DISPATCHER_EXITS = "{}: Dispatcher for {} exits";
  ...
  public static final String ACCUMULATED_FROM_WAL = "{} : accumulated a {} from wal";
  public static final String ACCUMULATED_FROM_QUEUE = "{} : accumulated a {} from queue";
  ...
  public static final String CANNOT_SYNC_LOGS_TO_PEER = "Can not sync logs to peer {} because";
  public static final String CONSTRUCT_FROM_WAL = "construct from WAL for one Entry, index : {}";
  public static final String WAIT_NEXT_WAL_INTERRUPTED = "wait for next WAL entry is interrupted";
  ...
  public static final String FREE_MEMORY = "{} free {} bytes, total memory size: {} bytes.";
  ...
  public static final String LOG_PLEASE_CHECK_STATUS_NODE_MANUALLY_40FBC9B3 =
  ...
  public static final String
      LOG_ARG_WRITE_OPERATION_FAILED_SEARCHINDEX_ARG_CODE_ARG_SUBSCRIPTIONQUEUES_ARG_THIS_ARG_F4B17576 =
          "{}: write operation failed. searchIndex: {}. Code: {}, subscriptionQueues: {}, this: {}";
}
