...
public class IoTDBDatabaseMetadata implements DatabaseMetaData {
        ...
        try {
            ...
            if (flag) {
                try {
                    ...
                    throw new SQLException(String.format("Fail to get colums catalog=%s, schemaPattern=%s,"
    ...
    private ResultSet getColumnsFunc(String catalog, String schemaPattern, String columnPattern, String devicePattern)
        ...
        try {
            ...
            if (flag) {
                try {
                    ...
                    System.out.println(
                            "Fail to get all timeseries " + "info after reconnecting. please check server status");
