...
public class MManagerDiskBasedTest {
    ...
    public void advancedTest_testCache() throws MetadataException {
        ...
        Assert.assertEquals(
                TSDataType.INT32, ((MeasurementMNode) manager.getNodeByPath(new PartialPath("root.vehicle.d0.s0"))).getSchema().getType());
    ...
    private void doCacheTest(String deviceId, List<String> measurementList) throws MetadataException {
        ...
        for (String s : measurementList) {
            ...
            MeasurementMNode measurementNode = (MeasurementMNode) manager.getNodeByPath(new PartialPath(deviceId+"."+s));
