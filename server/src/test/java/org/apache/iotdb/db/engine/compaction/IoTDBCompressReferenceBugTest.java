 ...
 * @time 22/12/20 上午11:05
 **/
public class IoTDBCompressReferenceBugTest {
  @Before
  ...
  public void testGZIPCompression() throws Exception {
    ...
    try (Connection connection = DriverManager
      ...
      statement.execute("CREATE TIMESERIES root.ln.wf01.wt01.age WITH DATATYPE=INT32, ENCODING=RLE, COMPRESSOR = SNAPPY");
