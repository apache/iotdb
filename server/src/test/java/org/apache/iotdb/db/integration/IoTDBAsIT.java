...
public class IoTDBAsIT {
  ...
  public void lastWithAsTest() throws ClassNotFoundException {
    String[] retArray = new String[] {"400,speed,FLOAT,50.4,", "400,root.sg.d1.s2,FLOAT,28.3,"};
    ...
    try (Connection connection =
      ...
      try (ResultSet resultSet = statement.getResultSet()) {
        ...
        assertEquals("Time,timeseries,dataType,value,", header.toString());
  ...
  public void lastWithAsDuplicatedTest() throws ClassNotFoundException {
    String[] retArray =
        new String[] {
          "400,speed,FLOAT,50.4,", "400,root.sg.d1.s1,FLOAT,50.4,", "400,temperature,FLOAT,28.3,"
        };
