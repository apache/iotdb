...
public class IoTDBAggregationWithoutValueFilterIT {
    ...
    public void countAlignedWithoutValueFilterTest() throws ClassNotFoundException {
        ...
        try (Connection connection =
            ...
            boolean hasResultSet = statement.execute("select count(s2) from root.sg1.d1 where time>=16 and time<=34");
    ...
    public void sumAlignedWithoutValueFilterTest() throws ClassNotFoundException {
        ...
        try (Connection connection =
            ...
            boolean hasResultSet = statement.execute("select count(s3) from root.sg1.d1 where time>=16 and time<=34");
            Assert.assertTrue(hasResultSet);
            try (ResultSet resultSet = statement.getResultSet()) {
                ResultSetMetaData resultSetMetaData = resultSet.getMetaData();
                Map<String, Integer> map = new HashMap<>();
    ...
    public void avgAlignedWithoutValueFilterTest() throws ClassNotFoundException {
        ...
        try (Connection connection =
            ...
            boolean hasResultSet = statement.execute("select avg(s2) from root.sg1.d1 where time>=16 and time<=34");
            Assert.assertTrue(hasResultSet);
            try (ResultSet resultSet = statement.getResultSet()) {
                ResultSetMetaData resultSetMetaData = resultSet.getMetaData();
                Map<String, Integer> map = new HashMap<>();
