...
public class OldLRUCacheTest {
  ...
  @Before
  public void setUp() {
    cache = new OldLRUCache(CACHE_SIZE);
    performance_cache = new OldLRUCache(PERFORMANCE_CACHE_SIZE);
  }
  ...
  public void testRandomPerformance() {
    ...
    for(int i=0;i<rate.length;i++) {
      ...
      System.out.println("Random OldLRUCache " + rate[i] + " " + (sum / LOOP_COUNT));
    }
  }
  ...
  public void testScanPerformance() {
    ...
    for(int i=0;i<rate.length;i++) {
      ...
      System.out.println("Scan OldLRUCache " + rate[i] + " " + (sum / LOOP_COUNT));
    }
  }
}
