...
package org.apache.iotdb.db.engine.merge.testMerge.level;
...
public class MergeTaskTest extends MergeTest {
  ...
  public void testMerge() throws Exception {
    ...
    LevelMergeTask mergeTask =
        new LevelMergeTask(new MergeResource(seqResources, unseqResources),
            tempSGDir.getPath(),
  ...
  public void mergeWithDeletionTest() throws Exception {
    ...
    TsFileResource[] newResource = new TsFileResource[1];
    LevelMergeTask mergeTask =
        new LevelMergeTask(new MergeResource(seqResources, unseqResources.subList(0, 1)),
            tempSGDir.getPath(),
            (k, v, l, n) -> {
              try {
