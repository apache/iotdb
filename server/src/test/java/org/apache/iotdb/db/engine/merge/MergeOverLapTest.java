...
//    NewSeriesReaderWithoutValueFilter tsFilesReader = new NewSeriesReaderWithoutValueFilter(path,
//        measurementSchemas[0].getType(), Collections.singletonList(seqResources.get(0)),
//        null, context);
//    int cnt = 0;
//    try {
