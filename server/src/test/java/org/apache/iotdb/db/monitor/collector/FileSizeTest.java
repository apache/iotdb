...
public class FileSizeTest {
  ...
  private static final String TEST_FILE_PATH =
      FileSizeMetrics.DATA.getPath() + File.separatorChar + "schemaFile";
  ...
  public void testGetFileSizesInByte() {
    ...
    dataSizeBefore = FileSize.getInstance().getFileSizesInByte().get(FileSizeMetrics.DATA);
    ...
    dataSizeAfter = FileSize.getInstance().getFileSizesInByte().get(FileSizeMetrics.DATA);
