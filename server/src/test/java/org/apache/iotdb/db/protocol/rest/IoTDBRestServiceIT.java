  ...
  public void expression(CloseableHttpClient httpClient) {
    ...
    try {
      ...
      Assert.assertArrayEquals(
          expressionsResult, ((List) map.get("expressions")).toArray(new String[] {}));
      Assert.assertArrayEquals(timestamps, ((List) map.get("timestamps")).toArray(new Long[] {}));
      Assert.assertArrayEquals(
          values1, ((List) ((List) map.get("values")).get(0)).toArray(new Object[] {}));
      Assert.assertArrayEquals(
          values2, ((List) ((List) map.get("values")).get(1)).toArray(new Object[] {}));
    } catch (IOException e) {
      e.printStackTrace();
      fail(e.getMessage());
    } finally {
