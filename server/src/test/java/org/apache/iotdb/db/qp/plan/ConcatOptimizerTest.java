...
public class ConcatOptimizerTest {
  ...
  public void before() throws MetadataException {
    ...
    IoTDB.metaManager.setStorageGroup(Arrays.asList("root", "laptop"));
  ...
  public void testConcat3() throws QueryProcessException, RecognitionException {
    ...
    SingleSeriesExpression seriesExpression = new SingleSeriesExpression(
        new Path(Arrays.asList("root", "laptop", "d1", "s1")),
        ValueFilter.lt(10));
    ...
    IExpression expression = BinaryExpression.and(
        BinaryExpression.and(
            new SingleSeriesExpression(
                ...
                ValueFilter.lt(10)),
            new SingleSeriesExpression(
                new Path(Arrays.asList("root", "laptop", "d2", "s1")),
                ValueFilter.lt(10))
        ),
        new SingleSeriesExpression(
            new Path(Arrays.asList("root", "laptop", "d3", "s1")),
            ValueFilter.lt(10))
    );
