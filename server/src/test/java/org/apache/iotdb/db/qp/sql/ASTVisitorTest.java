...
public class ASTVisitorTest {
  ...
  public void testParseTimeFormatNowPrecision() {
    ...
    CommonDescriptor.getInstance().getConf().setTimestampPrecision("ms");
    long now_ms = visitor.parseDateFormat(SqlConstant.NOW_FUNC);
    String ms_str = String.valueOf(now_ms);

    CommonDescriptor.getInstance().getConf().setTimestampPrecision("us");
    long now_us = visitor.parseDateFormat(SqlConstant.NOW_FUNC);
    String us_str = String.valueOf(now_us);

    CommonDescriptor.getInstance().getConf().setTimestampPrecision("ns");
    ...
    CommonDescriptor.getInstance().getConf().setTimestampPrecision(timePrecision);
  }
