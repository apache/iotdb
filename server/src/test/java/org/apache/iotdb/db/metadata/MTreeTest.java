...
public class MTreeTest {
  ...
  public void testAddAndQueryPathWithAlias() {
    ...
    try {
      ...
      List<PartialPath> result2 = root
          .getAllTimeseriesPathWithAlias(new PartialPath("root.a.*.s0"), 0, 0);
      ...
      result2 = root.getAllTimeseriesPathWithAlias(new PartialPath("root.a.*.temperature"), 0, 0);
      assertEquals(2, result2.size());
  ...
  public void testAddSubDevice() throws MetadataException {
    ...
    assertEquals(2, root.getAllTimeseriesPathWithAlias(new PartialPath("root"), 0, 0).size());
  }
