...
public class MTreeTest {
  ...
  public void testAddAndQueryPath() {
    ...
    try {
      List<PartialPath> result = root.getAllTimeseriesName(new PartialPath("root.a.*.s0"));
      assertEquals(2, result.size());
      assertEquals("root.a.d0.s0", result.get(0).toString());
      assertEquals("root.a.d1.s0", result.get(1).toString());

      result = root.getAllTimeseriesName(new PartialPath("root.a.*.*.s0"));
      assertEquals("root.a.b.d0.s0", result.get(0).toString());
    } catch (MetadataException e) {
      e.printStackTrace();
      fail(e.getMessage());
    }
  ...
  public void testAddAndQueryPathWithAlias() {
    ...
    try {
      ...
      result = root.getAllTimeseriesName(new PartialPath("root.a.*.temperature"));
      assertEquals(2, result.size());
      assertEquals("root.a.d0.s0", result.get(0).toString());
      assertEquals("root.a.d1.s0", result.get(1).toString());

      List<PartialPath> result2 = root.getAllTimeseriesPath(new PartialPath("root.a.*.s0"));
      assertEquals(2, result2.size());
      assertEquals("root.a.d0.s0", result2.get(0).toString());
      assertNull(result2.get(0).getAlias());
      assertEquals("root.a.d1.s0", result2.get(1).toString());
      assertNull(result2.get(1).getAlias());

      result2 = root.getAllTimeseriesPath(new PartialPath("root.a.*.temperature"));
      assertEquals(2, result2.size());
      assertEquals("root.a.d0.temperature", result2.get(0).getPathWithoutLastNodeWithAlias());
      assertEquals("root.a.d1.temperature", result2.get(1).getPathWithoutLastNodeWithAlias());
    } catch (MetadataException e) {
      e.printStackTrace();
      fail(e.getMessage());
    }
  ...
  public void testSetStorageGroup() throws IllegalPathException {
    ...
    try {
      ...
      assertEquals("root.laptop.d1", root.getStorageGroupName(new PartialPath("root.laptop.d1")).toString());
      ...
      assertEquals("root.laptop.d1", root.getStorageGroupName(new PartialPath("root.laptop.d1.s1")).toString());
    } catch (MetadataException e) {
      e.printStackTrace();
      fail(e.getMessage());
    }
    ...
    try {
      assertEquals("root.laptop.d1", root.getStorageGroupName(new PartialPath("root.laptop.d1.s0")).toString());
      root.createTimeseries(new PartialPath("root.laptop.d1.s0"), TSDataType.INT32, TSEncoding.RLE,
          TSFileDescriptor.getInstance().getConfig().getCompressor(), Collections.emptyMap(), null);
      assertEquals("root.laptop.d1", root.getStorageGroupName(new PartialPath("root.laptop.d1.s1")).toString());
      root.createTimeseries(new PartialPath("root.laptop.d1.s1"), TSDataType.INT32, TSEncoding.RLE,
          TSFileDescriptor.getInstance().getConfig().getCompressor(), Collections.emptyMap(), null);
      assertEquals("root.laptop.d2", root.getStorageGroupName(new PartialPath("root.laptop.d2.s0")).toString());
      root.createTimeseries(new PartialPath("root.laptop.d2.s0"), TSDataType.INT32, TSEncoding.RLE,
          TSFileDescriptor.getInstance().getConfig().getCompressor(), Collections.emptyMap(), null);
      assertEquals("root.laptop.d2", root.getStorageGroupName(new PartialPath("root.laptop.d2.s1")).toString());
  ...
  public void testGetAllFileNamesByPath() {
    ...
    try {
      root.setStorageGroup(new PartialPath("root.laptop.d1"));
      root.setStorageGroup(new PartialPath("root.laptop.d2"));
      root.createTimeseries(new PartialPath("root.laptop.d1.s1"), TSDataType.INT32, TSEncoding.PLAIN,
          CompressionType.GZIP, null, null);
      root.createTimeseries(new PartialPath("root.laptop.d1.s2"), TSDataType.INT32, TSEncoding.PLAIN,
          CompressionType.GZIP, null, null);
  ...
  public void testGetAllTimeseriesCount() {
    ...
    try {
      ...
      root.createTimeseries(new PartialPath("root.laptop.d1.s2"), TSDataType.INT32, TSEncoding.PLAIN,
          CompressionType.GZIP, null, null);
      root.createTimeseries(new PartialPath("root.laptop.d2.s1"), TSDataType.INT32, TSEncoding.PLAIN,
          CompressionType.GZIP, null, null);
      root.createTimeseries(new PartialPath("root.laptop.d2.s2"), TSDataType.INT32, TSEncoding.PLAIN,
          CompressionType.GZIP, null, null);
  ...
  public void testAddSubDevice() throws MetadataException {
    ...
    assertEquals(2, root.getAllTimeseriesName(new PartialPath("root")).size());
