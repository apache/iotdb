...
public class MTreeTest {
  ...
  //    } catch (MetadataException e) {
  //      Assert.assertEquals(
  //          "some children of root.laptop have already been set to storage group",
  // e.getMessage());
  //    }
  //    // check timeseries
  ...
  //      assertTrue(
  //          root.getBelongedStorageGroups(new
  // PartialPath("root.vehicle.device.sensor")).isEmpty());
  //
  ...
  //      assertFalse(root.getBelongedStorageGroups(new
  // PartialPath("root.vehicle.device")).isEmpty());
  //      assertFalse(
  //          root.getBelongedStorageGroups(new
  // PartialPath("root.vehicle.device.sensor")).isEmpty());
  ...
  //      assertTrue(root.getBelongedStorageGroups(new
  // PartialPath("root.vehicle1.device")).isEmpty());
  //
  //      root.setStorageGroup(new PartialPath("root.vehicle1.device"));
  //      assertTrue(root.getBelongedStorageGroups(new
  // PartialPath("root.vehicle1.device1")).isEmpty());
  //      assertTrue(root.getBelongedStorageGroups(new
  ...
  // root.\"sg.ln\" is not a legal path",
  //          e.getMessage());
  //    }
  //  }
  //
  ...
  //
  //    try {
  //      // mtree doesn't support nested timeseries which means MeasurementMNode is leaf of the
  // tree.
  //      root.createTimeseries(
