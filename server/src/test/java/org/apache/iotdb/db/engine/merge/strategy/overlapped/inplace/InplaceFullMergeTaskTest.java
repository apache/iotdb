...
package org.apache.iotdb.db.engine.merge.strategy.overlapped.inplace;
...
public class InplaceFullMergeTaskTest extends MergeTest {
  ...
  public void testMerge() throws Exception {
    InplaceFullMergeTask mergeTask =
        new InplaceFullMergeTask(new MergeResource(seqResources, unseqResources), tempSGDir.getPath(),
            (k, v, l, n) -> {
  ...
  public void testPartialMerge1() throws Exception {
    InplaceFullMergeTask mergeTask =
        new InplaceFullMergeTask(new MergeResource(seqResources, unseqResources.subList(0, 1)),
            tempSGDir.getPath(),
            (k, v, l, n) -> {
            }, "test", false, MERGE_TEST_SG);
    mergeTask.call();
  ...
  public void testPartialMerge2() throws Exception {
    InplaceFullMergeTask mergeTask =
        new InplaceFullMergeTask(new MergeResource(seqResources, unseqResources.subList(5, 6)),
            tempSGDir.getPath(),
            (k, v, l, n) -> {
            }, "test", false, MERGE_TEST_SG);
    mergeTask.call();
  ...
  public void testPartialMerge3() throws Exception {
    InplaceFullMergeTask mergeTask =
        new InplaceFullMergeTask(new MergeResource(seqResources, unseqResources.subList(0, 5)),
            tempSGDir.getPath(),
            (k, v, l, n) -> {
            }, "test", false, MERGE_TEST_SG);
    mergeTask.call();
