...
//        }
    ...
    public void averagePerformanceComparison() throws Exception {
        ...
        System.out.println("MTreeMem RW performance: " + createCostTime / times + "ms, " + readCostTime / times + "ms");
        ...
        System.out.println("MTreeDisk RW performance: " + createCostTime / times + "ms, " + readCostTime / times + "ms");
    }
