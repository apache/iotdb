...
public abstract class ReaderTestHelper {
  ...
  abstract protected void insertData() throws IOException, StorageEngineException;

  protected void insertOneRecord(long time, int num) throws StorageEngineException {
