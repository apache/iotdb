...
public class TsFileRewriteExcutorTest {
    ...
    public void tsFileRewriteExcutorTest() {
        ...
        try {
            ...
            TsFileRewriteExcutor excutor = new TsFileRewriteExcutor(tsFileResource, targetTsFileResource, fullPath, curEncoding, curCompressionType, 0, true);
            excutor.execute();
        ...
        try(TsFileSequenceReader reader = new TsFileSequenceReader(targetTsFile.getAbsolutePath(), true)) {
    ...
    public void tsFileRewriteExcutorAlignedTest() {
        ...
        try {
            ...
            excutor = new TsFileRewriteExcutor(tsFileResource, targetTsFileResource, fullPath, curEncoding, curCompressionType, 0, true);
            excutor.execute();
            targetTsFile = targetTsFileResource.getTsFile();
        } catch (Exception e) {
            Assert.fail(e.getMessage());
