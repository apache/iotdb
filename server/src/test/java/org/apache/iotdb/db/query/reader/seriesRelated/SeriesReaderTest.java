...
//
//  static final String SERIES_READER_TEST_SG = "root.mergeTest";
...
//    seriesReader = new SeriesReader(new Path(SERIES_READER_TEST_SG + PATH_SEPARATOR + "device0", "sensor0"),
//            TSDataType.DOUBLE, new QueryContext(), seqResources, unseqResources, null, null);
//  }
//
//  @After
...
//    try {
//      assertTrue(seriesReader.hasNextChunk());
//      assertTrue(seriesReader.hasNextPage());
//      assertTrue(seriesReader.isPageOverlapped());
//      assertTrue(seriesReader.hasNextOverlappedPage());
//      BatchData data = seriesReader.nextOverlappedPage();
