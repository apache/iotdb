...
public class SqueezeFullMergeTaskTest extends MergeTest {

  private File tempSGDir;
  private SizeBasedFileSelectorStrategy preMergeSizeSelectorStrategy;
  ...
  public void testMerge() throws Exception {
    ...
    SqueezeFullMergeTask mergeTask =
        new SqueezeFullMergeTask(new MergeResource(seqResources, unseqResources), tempSGDir.getPath(),
            (k, v
  ...
  public void testPartialMerge1() throws Exception {
    TsFileResource[] newResource = new TsFileResource[1];
    SqueezeFullMergeTask mergeTask =
        new SqueezeFullMergeTask(new MergeResource(seqResources, unseqResources.subList(0, 1)),
            tempSGDir.getPath(),
            (k, v, l, n) -> newResource[0] = n.get(0), "test", MERGE_TEST_SG);
    mergeTask.call();
    newResource[0].close();
  ...
  public void testPartialMerge2() throws Exception {
    TsFileResource[] newResource = new TsFileResource[1];
    SqueezeFullMergeTask mergeTask =
        new SqueezeFullMergeTask(new MergeResource(seqResources, unseqResources.subList(5, 6)),
            tempSGDir.getPath(),
            (k, v, l, n) -> newResource[0] = n.get(0), "test", MERGE_TEST_SG);
    mergeTask.call();
    newResource[0].close();
  ...
  public void testPartialMerge3() throws Exception {
    TsFileResource[] newResource = new TsFileResource[1];
    SqueezeFullMergeTask mergeTask =
        new SqueezeFullMergeTask(new MergeResource(seqResources, unseqResources.subList(0, 5)),
            tempSGDir.getPath(),
            (k, v, l, n) -> newResource[0] = n.get(0), "test", MERGE_TEST_SG);
    mergeTask.call();
    newResource[0].close();
