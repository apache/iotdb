...
public class OpenApiServiceTest{
  ...
  public void postV1RestDataRead() throws NotFoundException {
    ...
    Gson json = new Gson();
    assertEquals("write data success",json.fromJson(response.getEntity().toString(), Map.class).get("message"));
  }
  @Test
  public void postV1NonQuery() throws NotFoundException {
    ...
    Gson json = new Gson();
    assertEquals("execute sucessfully",json.fromJson(result.getEntity().toString(), Map.class).get("message"));
  }
  @Test
  public void postV1RestDataWrite() throws NotFoundException {
    ...
    Gson json = new Gson();
    assertEquals("write data success",json.fromJson(result.getEntity().toString(), Map.class).get("message"));
  }
@Test
  ...
  public void postV1GrafanaDataSimplejson() throws NotFoundException {
    Response response= v1ApiService.postV1GrafanaDataSimplejson(groupByFillPlan,basicSecurityContext);
    assertNotNull(response.getEntity());
  }
