...
import static org.apache.iotdb.db.conf.IoTDBConstant.CPU_LOAD;
import static org.apache.iotdb.db.conf.IoTDBConstant.FREE_MEMORYSIZE;
import static org.apache.iotdb.db.conf.IoTDBConstant.IP_ADDRESS;
import static org.apache.iotdb.db.conf.IoTDBConstant.SYSTEM_TIME;
import static org.apache.iotdb.db.conf.IoTDBConstant.TOTAL_MEMORYSIZE;
...
public class ShowNowDataSet extends ShowDataSet {
  ...
  public List<RowRecord> getQueryDataSet() throws MetadataException {
    ...
    for (ShowNowResult result : showNowResults) {
      ...
      updateRecord(record, result.getTotalMemoerySize());
