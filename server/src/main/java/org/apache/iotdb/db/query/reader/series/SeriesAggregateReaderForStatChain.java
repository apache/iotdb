...
public class SeriesAggregateReaderForStatChain implements IAggregateReader {

  public final SeriesReaderForStatChain seriesReader;

  public SeriesAggregateReaderForStatChain(
  ...
  public BatchData nextPage() throws IOException {
    BatchData tmp = seriesReader.nextPage();
    return tmp == null ? null : tmp.flip();
  }
  //  @Override
