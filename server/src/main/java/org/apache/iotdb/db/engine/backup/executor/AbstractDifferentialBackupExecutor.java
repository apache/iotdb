...
public abstract class AbstractDifferentialBackupExecutor extends AbstractBackupExecutor {

  protected AbstractDifferentialBackupExecutor(
  ...
  public boolean checkBackupPathValid(String outputPath) {
    ...
    // Output path for differential backup should be a non-empty folder.
