...
import static org.apache.iotdb.db.engine.merge.sizeMerge.independence.recover.IndependenceMergeLogger.MERGE_LOG_NAME;
...
import org.apache.iotdb.db.engine.merge.sizeMerge.independence.recover.LogAnalyzer;
import org.apache.iotdb.db.engine.merge.sizeMerge.independence.recover.LogAnalyzer.Status;
 ...
 */
public class RecoverIndependenceMergeTask extends IndependenceMergeTask implements
    IRecoverMergeTask {

  private static final Logger logger = LoggerFactory.getLogger(
      RecoverIndependenceMergeTask.class);

  public RecoverIndependenceMergeTask(List<TsFileResource> seqFiles,
  ...
  public void recoverMerge(boolean continueMerge) throws IOException {
    File logFile = SystemFileFactory.INSTANCE
        .getFile(storageGroupSysDir, MERGE_LOG_NAME);
    if (!logFile.exists()) {
