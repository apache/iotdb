...
import static org.apache.iotdb.db.engine.merge.strategy.small.regularization.recover.RegularizationMergeLogger.MERGE_LOG_NAME;
...
import org.apache.iotdb.db.engine.merge.strategy.small.regularization.recover.LogAnalyzer.Status;
...
public class RecoverRegularizationMergeTask extends RegularizationMergeTask implements
  ...
  public RecoverRegularizationMergeTask(Collection<TsFileResource> seqFiles,
