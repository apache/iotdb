...
public class AscTimeOrderUtils implements TimeOrderUtils {
  ...
  public long getOrderTime(TsFileResource fileResource, PartialPath partialPath) {
    return fileResource.getStartTime(partialPath.getDevice());
  }
  ...
  public boolean isOverlapped(long time, TsFileResource right, PartialPath partialPath) {
    return time >= right.getStartTime(partialPath.getDevice());
  }
