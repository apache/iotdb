...
public class RollbackPreDeleteTimeSeriesPlan extends PhysicalPlan {
  ...
  public RollbackPreDeleteTimeSeriesPlan() {
    super(Operator.OperatorType.ROLLBACK_PRE_DELETE_TIMESERIES);
  }

  public RollbackPreDeleteTimeSeriesPlan(PathPatternTree patternTree) {
    super(Operator.OperatorType.ROLLBACK_PRE_DELETE_TIMESERIES);
  ...
  public void serialize(DataOutputStream stream) throws IOException {
    stream.write((byte) PhysicalPlanType.ROLLBACK_PRE_DELETE_TIMESERIES.ordinal());
  ...
  protected void serializeImpl(ByteBuffer buffer) {
    buffer.put((byte) PhysicalPlanType.ROLLBACK_PRE_DELETE_TIMESERIES.ordinal());
