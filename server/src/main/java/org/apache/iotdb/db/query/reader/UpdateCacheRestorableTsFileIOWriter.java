...
public class UpdateCacheRestorableTsFileIOWriter extends RestorableTsFileIOWriter {
  ...
  public UpdateCacheRestorableTsFileIOWriter(File file, long maxMetadataSize) throws IOException {
    super(file, maxMetadataSize);
  }

  public UpdateCacheRestorableTsFileIOWriter(File file, boolean truncate) throws IOException {
    super(file, truncate);
  }
