 ...
 * to access an element by index. Most codes are copied directly because the fields are
 * package-private and cannot be accessed by a simple extension.
 *
 * @param <E>
 */
...
public class RandomAccessArrayDeque<E> extends AbstractCollection<E>
   ...
   *
   * <p>This method differs from {@link #poll poll} only in that it throws an exception if this
   * deque is empty.
   *
