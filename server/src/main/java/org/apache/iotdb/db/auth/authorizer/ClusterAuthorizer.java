...
public class ClusterAuthorizer {
  ...
  public SettableFuture<Void> operatePermission(AuthorStatement authorStatement) {
    ...
    try {
      ...
      TAuthorizerReq req = getTAuthorizerReq(authorStatement);
  ...
  public void queryPermission(AuthorStatement authorStatement) {
    ...
    try {
      configNodeClient = new ConfigNodeClient();
      TAuthorizerReq req = getTAuthorizerReq(authorStatement);
      configNodeClient.queryPermission(req);
   ...
   * Construct request using statement
   *
   * @param authorStatement AuthorStatement
   * @return TAuthorizerReq
   * @throws AuthException
   */
  public TAuthorizerReq getTAuthorizerReq(AuthorStatement authorStatement) throws AuthException {
