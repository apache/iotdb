...
import org.apache.iotdb.tsfile.utils.DDSketchPositiveForDupli;
...
public class DupliQuantileDDAggrResult extends AggregateResult {
  String returnType = "value";
  private TSDataType seriesDataType;
  private int iteration;
  private long n;
  private DDSketchPositiveForDupli sketch;
  private boolean hasFinalResult;
  double DD_ALPHA, MIN_V = 0;
  long DEBUG = 0;
  ...
  public DupliQuantileDDAggrResult(TSDataType seriesDataType) throws UnSupportedDataTypeException {
    super(DOUBLE, AggregationType.DUPLI_QUANTILE_DD);
  ...
  private void updateStatusFromData(Object data) {
    ...
    n++;
    sketch.update(dataD - MIN_V + 1);
  }

  @Override
  public void startIteration() {
    sketch =
        new DDSketchPositiveForDupli(
            DD_ALPHA, DDSketchPositiveForDupli.getBucketNumLimit(maxMemoryByte));
    n = 0;
  }
  ...
  public void finishIteration() {
    ...
    iteration++;
    if (n == 0) {
      setDoubleValue(0 + MIN_V - 1);
      hasFinalResult = true;
      return;
    }

    setDoubleValue(sketch.getQuantile(QUANTILE) + MIN_V - 1);
    hasFinalResult = true;
  }
  ...
  public void setAttributes(Map<String, String> attrs) {
    ...
    if (attrs.containsKey("dd_alpha")) this.DD_ALPHA = Double.parseDouble(attrs.get("dd_alpha"));
    if (attrs.containsKey("min_v")) this.MIN_V = Double.parseDouble(attrs.get("min_v"));
