...
/** This node is responsible for contacting horizontally two or more TsBlocks have same columns. */
public class HorizontallyConcatNode extends MultiChildProcessNode {
  ...
  protected void serializeAttributes(ByteBuffer byteBuffer) {
    PlanNodeType.HORIZONTALLY_CONCAT.serialize(byteBuffer);
  }

  @Override
  protected void serializeAttributes(DataOutputStream stream) throws IOException {
    PlanNodeType.HORIZONTALLY_CONCAT.serialize(stream);
  }
