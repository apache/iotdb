...
public class UDTFSum implements UDTF {
  ...
  public void beforeStart(UDFParameters parameters, UDTFConfigurations configurations)
    ...
    System.out.println("paths:"+parameters.getPaths());
      ...
      case FLOAT:
        {
          ...
          collector.putFloat(time, result);
        }
        break;
      case DOUBLE:
        {
          ...
          collector.putDouble(time, result);
        }
        break;
      default:
  ...
  protected void setTransformer() {
    throw new UnsupportedOperationException("UDTFSum#setTransformer()");
  }
}
