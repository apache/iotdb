...
%               different fileNames and chunkIds are ploteed in the same
%               line.
...
%              to sort seqKeys&unseqKeys by tsName priority.
    ...
    for k = keys(timeMap)
        ...
        if contains(key,'unseq') % unsequence tsfile
            ...
            % the relative order of chunkId can be used by to differentiate
            % the insert order of chunks of a single time series in an unsequence tsfile
