...
import org.apache.iotdb.tsfile.utils.KLLDupliPairFTgamma;
...
public class DupliQuantileKLLPairGammaAggrResult extends AggregateResult {
  String returnType = "value";
  private TSDataType seriesDataType;
  private int iteration;
  private long n;
  private KLLDupliPairFTgamma sketch;
  ...
  public DupliQuantileKLLPairGammaAggrResult(TSDataType seriesDataType)
      throws UnSupportedDataTypeException {
    super(DOUBLE, AggregationType.DUPLI_QUANTILE_KLL_PAIR_GAMMA);
  ...
  public void startIteration() {
    sketch = new KLLDupliPairFTgamma(maxMemoryByte, this.GAMMA);
    n = 0;
  }
