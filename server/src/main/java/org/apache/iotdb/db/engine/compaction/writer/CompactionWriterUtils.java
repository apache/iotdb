...
//  }
//
//  public static void flushChunkToFileWriter(TsFileIOWriter targetWriter, IChunkWriter
// iChunkWriter)
//      throws IOException {
...
//            isCrossSpace ? CompactionType.CROSS_COMPACTION :
...
//      return ((AlignedChunkWriterImpl)
// iChunkWriter).checkIsChunkSizeOverThreshold(targetChunkSize);
//    } else {
