...
import org.apache.iotdb.db.engine.merge.strategy.overlapped.squeeze.recover.LogAnalyzer.Status;
 ...
 */
public class RecoverSqueezeFullMergeTask extends SqueezeFullMergeTask implements IRecoverMergeTask {

  private static final Logger logger = LoggerFactory.getLogger(RecoverSqueezeFullMergeTask.class);

  public RecoverSqueezeFullMergeTask(Collection<TsFileResource> seqFiles,
