...
public class ExternalPipeSink implements PipeSink {
  ...
  private final PipeSink.Type type = Type.ExternalPipe;

  private final String name;
  private final String pipeSinkTypeName;

  Map<String, String> sinkParams;

  public ExternalPipeSink(String name, String pipeSinkTypeName) {
    this.name = name;
    this.pipeSinkTypeName = pipeSinkTypeName;
  }
  ...
  public void setAttribute(List<Pair<String, String>> params) throws PipeSinkException {
    ...
    try {
      ExternalPipePluginManager.getInstance()
          .getWriteFactory(pipeSinkTypeName)
  ...
  public String getPipeSinkTypeName() {
    return pipeSinkTypeName;
  }
}
