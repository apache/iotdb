...
public class CreateAutoAlignedTimeSeriesPlan extends PhysicalPlan {
  ...
  public List<PartialPath> getPaths() {
    ...
    for (String measurement : measurements) {
      try {
        ...
        logger.error("Failed to get paths of CreateAutoAlignedTimeSeriesPlan. ", e);
      }
    }
    return paths;
  }
  ...
  public void serialize(DataOutputStream stream) throws IOException {
    stream.writeByte((byte) PhysicalPlanType.CREATE_AUTOALIGNED_TIMESERIES.ordinal());
  ...
  public void serializeImpl(ByteBuffer buffer) {
    buffer.put((byte) PhysicalPlanType.CREATE_AUTOALIGNED_TIMESERIES.ordinal());
    byte[] bytes = prefixPath.getFullPath().getBytes();
