...
public class OldFileTimeIndex implements ITimeIndex {
  ...
  public OldFileTimeIndex() {
    this.devices = new ConcurrentSet<>();
    this.startTime = Long.MAX_VALUE;
    this.endTime = Long.MIN_VALUE;
  }

  public OldFileTimeIndex(Set<String> devices, long startTime, long endTime) {
  ...
  @Override
  public OldFileTimeIndex deserialize(InputStream inputStream) throws IOException {
  ...
  public OldFileTimeIndex deserialize(ByteBuffer buffer) {
    ...
    return new OldFileTimeIndex(deviceSet, buffer.getLong(), buffer.getLong());
  }
