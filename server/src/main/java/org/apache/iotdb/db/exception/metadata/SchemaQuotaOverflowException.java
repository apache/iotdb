...
public class SchemaQuotaOverflowException extends MetadataException {
  public SchemaQuotaOverflowException(ClusterSchemaQuotaLevel level, long limit) {
    super(
        String.format(
        ...
        TSStatusCode.SCHEMA_QUOTA_OVERFLOW.getStatusCode());
  }
}
