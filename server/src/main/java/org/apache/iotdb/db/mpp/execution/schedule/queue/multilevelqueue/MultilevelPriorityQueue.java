...
public class MultilevelPriorityQueue {
    ...
    /**
     * Expected scheduled time of level0-level4 is:
     * levelTimeMultiplier^4 : levelTimeMultiplier^3 : levelTimeMultiplier^2 : levelTimeMultiplier : 1
     */
     ...
     * we pick the DriverTask with the lowest priority.
     */
    @GuardedBy("lock")
