 ...
 */
public class UnSealedTsFileIterateChunkReader extends IterateChunkReader {
   ...
   */
  private IAggregateChunkReader initUnSealedTsFileDiskReader(TsFileResource unSealedTsFile,
      Filter filter)
      throws IOException {
