...
public class ExternalPipeConfiguration {
  private static final Logger logger = LoggerFactory.getLogger(ExternalPipeConfiguration.class);
  ...
  private ExternalPipeConfiguration(String pipeName) {
  ...
  public static class Builder {
    ...
    public Builder(String pipeName) {
      configuration = new ExternalPipeConfiguration(pipeName);
    }
    ...
    public ExternalPipeConfiguration build() {
