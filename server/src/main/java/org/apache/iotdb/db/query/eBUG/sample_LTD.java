...
public class sample_LTD {
  public static void main(String[] args) throws IOException {
    if (args.length < 7) {
      System.out.println(
          "Usage: Please provide arguments: inputFilePath,hasHeader,timeIdx,valueIdx,N,m,maxIter,(outDir)");
    }
    String input = args[0];
    ...
    String outputFile =
        generateOutputFileName(input, outDir, "-LTD-" + maxIter + "-n" + points.size() + "-m" + m);
