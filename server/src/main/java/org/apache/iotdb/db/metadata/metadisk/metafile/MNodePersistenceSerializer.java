...
public class MNodePersistenceSerializer implements MNodeSerializer{
    ...
    private void serializeLastCache(TimeValuePair cachedLastValuePair, TSDataType dataType, ByteBuffer dataBuffer){
    ...
    private int evaluateMeasurementDataLength(MeasurementMNode measurementMNode) {
        ...
        length+=evaluateLastCacheLength(measurementMNode.getCachedLast(),measurementMNode.getSchema().getType());// lastCache
