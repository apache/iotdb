...
public class FullReadOnceAggrResult extends AggregateResult {

  public FullReadOnceAggrResult() {
  ...
  public void merge(AggregateResult another) {
    FullReadOnceAggrResult anotherCount = (FullReadOnceAggrResult) another;
