...
import org.apache.iotdb.tsfile.utils.TDigestForDupli;
...
public class DupliQuantileTDAggrResult extends AggregateResult {
  String returnType = "value";
  private TSDataType seriesDataType;
  private int iteration;
  private long n;
  private TDigestForDupli sketch;
  ...
  public DupliQuantileTDAggrResult(TSDataType seriesDataType) throws UnSupportedDataTypeException {
    super(DOUBLE, AggregationType.DUPLI_QUANTILE_TD);
  ...
  public void startIteration() {
    sketch = new TDigestForDupli(maxMemoryByte);
    n = 0;
  }
