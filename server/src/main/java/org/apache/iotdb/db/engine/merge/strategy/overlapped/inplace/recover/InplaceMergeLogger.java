...
public class InplaceMergeLogger implements MergeLogger {
  ...
  private void logSeqFiles(Collection<TsFileResource> seqFiles) throws IOException {
  ...
  private void logUnseqFiles(Collection<TsFileResource> unseqFiles) throws IOException {
