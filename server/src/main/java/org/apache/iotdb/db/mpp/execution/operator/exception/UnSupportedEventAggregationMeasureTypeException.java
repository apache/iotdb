...
public class UnSupportedEventAggregationMeasureTypeException extends RuntimeException {
  ...
  public UnSupportedEventAggregationMeasureTypeException(CompareType compareType) {
    super(String.format("Unsupported measure type in event aggregation: %s", compareType));
  }
}
