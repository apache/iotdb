 ...
 */
public class InplaceAppendMergeTask extends InplaceBaseMergeTask {

  public InplaceAppendMergeTask(MergeResource mergeResource, String storageGroupSysDir,
      MergeCallback callback, String taskName, String storageGroupName) {
    super(mergeResource, storageGroupSysDir, callback, false, taskName, storageGroupName);
  }
