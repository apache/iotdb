...
public class PriorityMergeReaderForStat implements IPointReader {
  ...
  public PriorityMergeReaderForStat() {
    heap =
        new PriorityQueue<>(
            (o1, o2) -> {
              int timeCompare =
  ...
  public PriorityMergeReaderForStat(List<IPointReader> prioritySeriesReaders, int startPriority)
      throws IOException {
    heap =
        new PriorityQueue<>(
            (o1, o2) -> {
