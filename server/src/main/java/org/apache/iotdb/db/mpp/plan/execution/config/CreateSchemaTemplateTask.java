...
public class CreateSchemaTemplateTask  implements IConfigTask {
    ...
    public ListenableFuture<ConfigTaskResult> execute(IConfigTaskExecutor configTaskExecutor)
        ...
        configTaskExecutor.createSchemaTemplate(this.createSchemaTemplateStatement);
        return null;
    }

    public static TCreateSchemaTemplateReq constructTCreateSchemaTemplateReq(CreateSchemaTemplateStatement createSchemaTemplateStatement) {
