...
public class LogReplayer {
  ...
  private void replayBatchInsert(BatchInsertPlan batchInsertPlan) throws PlannerException {
  ...
  private void replayInsert(InsertPlan insertPlan) throws PlannerException {
    if (currentTsFileResource != null) {
      // the last chunk group may contain the same data with the logs, ignore such logs in seq file
