...
class SqueezeMergeSchedulerTask extends BaseMergeSchedulerTask {

  SqueezeMergeSchedulerTask(MergeContext context, String taskName, MergeLogger mergeLogger,
  ...
  public List<TsFileResource> mergeSeries() throws IOException {
    SmallFileMergeStage mergeSmallFileStrategyFactory = IoTDBDescriptor.getInstance()
        .getConfig().getMergeSmallFileStrategyFactory();
    BaseMergeSchedulerTask mergeSchedulerTask = mergeSmallFileStrategyFactory.getMergeSchedulerTask(mergeContext, taskName, mergeLogger, resource, unmergedSeries, storageGroupName);
    return mergeSchedulerTask.mergeSeries();
  }
}
