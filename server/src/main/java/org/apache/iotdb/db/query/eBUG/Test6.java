...
public class Test6 {
  ...
  public static void main(String[] args) {
    ...
    List<Point> sampled =
        seg_bottomUp_maxerror_withTimestamps(polyline.getVertices(), maxError, null, false);
    ...
    startTime = System.currentTimeMillis();
    sampled =
        seg_bottomUp_maxerror_withTimestamps(polyline.getVertices(), maxError, prefixSum, false);
    endTime = System.currentTimeMillis();
    System.out.println(
        "Time taken to bottomUp-L2 with prefix sum acceleration:" + (endTime - startTime) + "ms");
    System.out.println(sampled.size());
