...
public enum FragmentState {
    ...
    /**
     * Fragment is planned but has not been scheduled yet.  A Fragment will
     * be in the planned state until, the dependencies of the Fragment
    ...
    FINISHED(true, false),
    /**
     * Fragment was aborted due to a failure in the query.  The failure
     * was not in this Fragment.
     */
    ABORTED(true, true),
    /**
    ...
    public static final Set<FragmentState> TERMINAL_FRAGMENT_STATES = Stream.of(FragmentState.values()).filter(FragmentState::isDone).collect(toImmutableSet());
