...
public class WindowSplitNode extends SingleChildProcessNode {
  ...
  public WindowSplitNode(PlanNodeId id, PlanNode child, long interval, long step) {
    super(id, child);
    this.interval = interval;
    this.step = step;
  }

  public WindowSplitNode(PlanNodeId id, long interval, long step) {
    super(id);
    this.interval = interval;
    this.step = step;
  }
  ...
  public PlanNode clone() {
    return new WindowSplitNode(getPlanNodeId(), interval, step);
  }
  ...
  public static WindowSplitNode deserialize(ByteBuffer byteBuffer) {
    ...
    return new WindowSplitNode(planNodeId, interval, step);
  }
  ...
  public boolean equals(Object o) {
    ...
    return interval == that.getInterval() && step == that.getStep();
  }
