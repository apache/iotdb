...
public class DupliQuantileKLLVanillaAggrResult extends AggregateResult {
  String returnType = "value";
  private TSDataType seriesDataType;
  private int iteration;
  private long n;
  private KLLSketchLazyExactPriori sketch;
  ...
  public DupliQuantileKLLVanillaAggrResult(TSDataType seriesDataType)
      throws UnSupportedDataTypeException {
    super(DOUBLE, AggregationType.DUPLI_QUANTILE_KLL_VANILLA);
  ...
  public void startIteration() {
    sketch = new KLLSketchLazyExactPriori(maxMemoryByte);
    n = 0;
  }
