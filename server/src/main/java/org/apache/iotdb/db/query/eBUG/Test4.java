...
//        }
        ...
        System.out.println("Time taken to compute L2 error with prefix sum: " + (endTime - startTime) + "ms");
        ...
        endTime = System.currentTimeMillis();
        System.out.println("Time taken to compute L2 error without prefix sum: " + (endTime - startTime) + "ms");
