...
public class BTreePageManager extends PageManager {
   ...
   */
  @Override
  protected void buildSubIndex(ICacheMNode parNode) throws MetadataException, IOException {
    ...
    Queue<ICacheMNode> children = cursorPage.getAsSegmentedPage().getChildren((short) 0);
    ICacheMNode child;
  ...
  private ICacheMNode getChildWithAlias(ICacheMNode par, String alias)
      throws IOException, MetadataException {
  ...
  public Iterator<ICacheMNode> getChildren(ICacheMNode parent)
    ...
    Queue<ICacheMNode> initChildren = page.getAsSegmentedPage().getChildren(segId);
    return new Iterator<ICacheMNode>() {
      long nextSeg = actualSegAddr;
      Queue<ICacheMNode> children = initChildren;
