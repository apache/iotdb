...
import static org.apache.iotdb.db.engine.merge.strategy.small.regularization.task.RegularizationMergeTask.MERGE_SUFFIX;
...
public class RegularizationMergeSchedulerTask extends BaseMergeSchedulerTask {

  private static final Logger logger = LoggerFactory.getLogger(
      RegularizationMergeSchedulerTask.class);
  ...
  public RegularizationMergeSchedulerTask(MergeContext context, String taskName,
  ...
  public List<TsFileResource> mergeSeries() throws IOException {
    if (logger.isDebugEnabled()) {
      ...
      logger.debug("merge before seqFile chunk large = {}", totalChunkPoint * 1.0 / chunkNum);
    }
