...
public class ExpressionAnalyzer {
  ...
  public static List<PartialPath> concatExpressionWithSuffixPaths(
    ...
    //            expression, new ConcatExpressionWithSuffixPathsVisitor.Context(prefixPaths,
    // null));
  ...
  public static List<Expression> removeWildcardInExpression(
    ...
    //    } else if (expression instanceof UnaryExpression) {
    //      List<Expression> childExpressions =
    //          removeWildcardInExpression(((UnaryExpression) expression).getExpression(),
    // schemaTree);
    //      return reconstructUnaryExpressions((UnaryExpression) expression, childExpressions);
    //    } else if (expression instanceof FunctionExpression) {
    //      // One by one, remove the wildcards from the input expressions. In most cases, an
    // expression
    ...
    //          // Let's ignore the eval of the function which has at least one non-existence series
    // as
    ...
    //              ((FunctionExpression) expression).getFunctionName(), children,
    // extendedExpressions);
    //          break;
    //        }
    //      }
    //
    //      // Calculate the Cartesian product of extendedExpressions to get the actual expressions
    // after
  ...
  public static List<Expression> removeWildcardInFilter(
    ...
    //              ((TernaryExpression) predicate).getFirstExpression(), prefixPaths, schemaTree,
    // false);
    //      List<Expression> secondExpressions =
    //          removeWildcardInFilter(
    ...
    //      List<Expression> thirdExpressions =
    //          removeWildcardInFilter(
    //              ((TernaryExpression) predicate).getThirdExpression(), prefixPaths, schemaTree,
    // false);
    //      return reconstructTernaryExpressions(
    ...
    //      List<Expression> leftExpressions =
    //          removeWildcardInFilter(
    //              ((BinaryExpression) predicate).getLeftExpression(), prefixPaths, schemaTree,
    // false);
    //      List<Expression> rightExpressions =
    //          removeWildcardInFilter(
    //              ((BinaryExpression) predicate).getRightExpression(), prefixPaths, schemaTree,
    // false);
    ...
    //          bindTypeForAggregationNonSeriesInputExpressions(
    //              ((FunctionExpression) predicate).getFunctionName(), children,
    // extendedExpressions);
    //          break;
    //        }
    //      }
    //      List<List<Expression>> childExpressionsList = new ArrayList<>();
    //      cartesianProduct(extendedExpressions, childExpressionsList, 0, new ArrayList<>());
    //      return reconstructFunctionExpressions((FunctionExpression) predicate,
    // childExpressionsList);
    //    } else if (predicate instanceof TimeSeriesOperand) {
  ...
  public static Expression replaceRawPathWithGroupedPath(
    ...
    //        }
    //      }
    //      return reconstructFunctionExpression((FunctionExpression) expression,
    // childrenExpressions);
    //    } else if (expression instanceof TimeSeriesOperand) {
    //      PartialPath rawPath = ((TimeSeriesOperand) expression).getPath();
    //      PartialPath groupedPath = rawPathToGroupedPathMap.get(rawPath);
    //      return reconstructTimeSeriesOperand(groupedPath);
    //    } else if (expression instanceof TimestampOperand || expression instanceof
    // ConstantOperand) {
    //      return expression;
    //    } else {
    //      throw new IllegalArgumentException(
  ...
  public static List<Expression> removeWildcardInFilterByDevice(
    ...
    //      List<Expression> leftExpressions =
    //          removeWildcardInFilterByDevice(
    //              ((BinaryExpression) predicate).getLeftExpression(), devicePath, schemaTree,
    // isWhere);
    //      List<Expression> rightExpressions =
    //          removeWildcardInFilterByDevice(
    //              ((BinaryExpression) predicate).getRightExpression(), devicePath, schemaTree,
    // isWhere);
    ...
    //      for (Expression suffixExpression : predicate.getExpressions()) {
    //        extendedExpressions.add(
    //            removeWildcardInFilterByDevice(suffixExpression, devicePath, schemaTree,
    // isWhere));
    //      }
    //      List<List<Expression>> childExpressionsList = new ArrayList<>();
    //      cartesianProduct(extendedExpressions, childExpressionsList, 0, new ArrayList<>());
  ...
  public static Expression removeAliasFromExpression(Expression expression) {
    ...
    //      }
    //      // Reconstruct the function name to lower case to finish the calculation afterwards
    // while the
  ...
  public static Expression bindTypeForTimeSeriesOperand(
    ...
    //      }
    //      return reconstructFunctionExpression((FunctionExpression) predicate,
    // childrenExpressions);
    //    } else if (predicate instanceof TimeSeriesOperand) {
