...
/**
 * RecoverInplaceFullMergeTask is an extension of MergeTask, which resumes the last merge progress
 * by scanning merge.log using LogAnalyzer and continue the unfinished merge.
 */
public class RecoverInplaceFullMergeTask extends RecoverInplaceBaseMergeTask {

  public RecoverInplaceFullMergeTask(Collection<TsFileResource> seqFiles,
