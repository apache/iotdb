...
public enum ServiceType {
  ...
  UDF_REGISTRATION_SERVICE("UDF Registration Service", "UdfRegistration"),
  TEMPORARY_QUERY_DATA_FILE_SERVICE("Temporary Query Data File Service", "TempQueryDataFile"),
  TRIGGER_REGISTRATION_SERVICE("Trigger Registration Service", "TriggerRegistration"),
