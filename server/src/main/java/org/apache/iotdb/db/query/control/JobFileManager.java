...
public class JobFileManager {
   ...
   */
  public void addUsedFilesForGivenJob(long queryId, QueryDataSource dataSource) {

    //sequence data
    addUsedFilesForGivenJob(queryId, dataSource.getSeqResources());

    //unsequence data
    addUsedFilesForGivenJob(queryId, dataSource.getUnseqResources());
  }

  private void addUsedFilesForGivenJob(long queryId, List<TsFileResource> resources) {
   ...
   */
  void removeUsedFilesForGivenJob(long queryId) {
