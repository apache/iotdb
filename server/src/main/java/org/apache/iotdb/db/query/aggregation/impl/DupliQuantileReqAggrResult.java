...
public class DupliQuantileReqAggrResult extends AggregateResult {
  String returnType = "value";
  private TSDataType seriesDataType;
  private int iteration;
  private long n;
  private ReqSketch sketch;
  ...
  public DupliQuantileReqAggrResult(TSDataType seriesDataType) throws UnSupportedDataTypeException {
    super(DOUBLE, AggregationType.DUPLI_QUANTILE_REQ);
  ...
  private void updateStatusFromData(Object data) {
    ...
    n++;
    sketch.update((float) dataD);
  }

  @Override
  public void startIteration() {
    if (maxMemoryByte / 1024 == 128) sketch = new ReqSketchBuilder().setK(86).build();
    else if (maxMemoryByte / 1024 == 512) sketch = new ReqSketchBuilder().setK(366).build();
    n = 0;
  }
