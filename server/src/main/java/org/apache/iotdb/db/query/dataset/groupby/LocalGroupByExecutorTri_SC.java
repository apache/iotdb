...
import org.apache.iotdb.db.query.simpiece.ShrinkingCone;
...
public class LocalGroupByExecutorTri_SC implements GroupByExecutor {
  ...
  public LocalGroupByExecutorTri_SC(
      PartialPath path,
  ...
  public List<AggregateResult> calcResult(
    ...
    // Shrinking cone
    List<Point> reducedPoints = ShrinkingCone.reducePoints(timeSeries.data, epsilon);
