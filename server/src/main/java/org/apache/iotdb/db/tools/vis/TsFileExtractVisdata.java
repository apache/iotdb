 ...
 * <p>
 * Example: G:\\debug\\data\\sequence true G:\\debug\\data\\unsequence false visdata.csv 2N+1 args
 * in total.
 * <p>
 * `seqIndicator` should be 'true' or 'false' (not case sensitive). 'true' means is the file is
          ...
          try (TsFileSequenceReader reader = new TsFileSequenceReader(f)) {
            ...
            for (ChunkGroupMetadata chunkGroupMetadata : allChunkGroupMetadata) {
              ...
              for (ChunkMetadata chunkMetadata : chunkMetadataList) {
                ...
                // the relative order of chunkId can be used by vis.m to differentiate the insert
                // order of chunks of a single time series in an unsequence tsfile
                chunkId++;
