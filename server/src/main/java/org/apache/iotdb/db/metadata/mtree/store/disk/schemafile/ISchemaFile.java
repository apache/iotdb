...
public interface ISchemaFile {
  ...
  /**
   * Modify header of pb-tree file corresponding to the database node synchronously
   *
  ...
  /**
   * Only database node along with its descendents could be flushed into pb-tree file.
   *
   * @param node
   */
