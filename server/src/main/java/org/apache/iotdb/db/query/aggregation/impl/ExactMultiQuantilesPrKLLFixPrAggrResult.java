...
public class ExactMultiQuantilesPrKLLFixPrAggrResult extends AggregateResult {
  double fixPr = 0.99;
  ...
  public ExactMultiQuantilesPrKLLFixPrAggrResult(TSDataType seriesDataType)
      throws UnSupportedDataTypeException {
    super(DOUBLE, AggregationType.EXACT_MULTI_QUANTILES_PR_KLL_FIX_PR);
