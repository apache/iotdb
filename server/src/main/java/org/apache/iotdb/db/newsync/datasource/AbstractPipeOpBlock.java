...
public abstract class AbstractPipeOpBlock implements Comparable<AbstractPipeOpBlock> {
  private static final Logger logger = LoggerFactory.getLogger(AbstractPipeOpBlock.class);
  ...
  public AbstractPipeOpBlock(String storageGroupName) {
    this(storageGroupName, 0);
  }

  public AbstractPipeOpBlock(String storageGroupName, long beginIndex) {
  ...
  @Override
  public int compareTo(AbstractPipeOpBlock o) {
