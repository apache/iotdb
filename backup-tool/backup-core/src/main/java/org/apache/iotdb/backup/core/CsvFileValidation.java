...
import org.apache.iotdb.backup.core.service.CsvFileValidationForPipelineService;
...
public class CsvFileValidation {
  ...
  public static void dataValidation(
    ...
    CsvFileValidationForPipelineService forPipelineService =
        new CsvFileValidationForPipelineService();
    forPipelineService.dataValidateWithServer(path, session, charset, type);
  }
}
