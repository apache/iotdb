// Generated from /Users/lly/Documents/SE/Projects/github-community/iotdb/iotdb/antlr/src/main/antlr4/org/apache/iotdb/db/qp/sql/SqlLexer.g4 by ANTLR 4.10.1
...
public class SqlLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"WS", "ADD", "AFTER", "ALIAS", "ALIGN", "ALIGNED", "ALL", "ALTER", "AND", 
			"ANY", "APPEND", "AS", "ASC", "ATTRIBUTES", "BEFORE", "BEGIN", "BETWEEN", 
			"BLOCKED", "BOUNDARY", "BY", "CACHE", "CHILD", "CLEAR", "CLUSTER", "VARIABLES", 
			"CONCAT", "CONDITION", "CONFIGNODES", "CONFIGURATION", "CONTAINS", "CONTINUOUS", 
			...
			"ELAPSEDTIME", "END", "ENDTIME", "EVERY", "EXPLAIN", "FALSE", "FILL", 
			"FILE", "FLUSH", "FOR", "FROM", "FULL", "FUNCTION", "FUNCTIONS", "GLOBAL", 
			"GRANT", "GROUP", "HAVING", "IN", "INDEX", "INFO", "INSERT", "INTO", 
			"IS", "KILL", "LABEL", "LAST", "LATEST", "LEVEL", "LIKE", "LIMIT", "LINEAR", 
			"LINK", "LIST", "LOAD", "LOCAL", "LOCK", "MERGE", "METADATA", "MIGRATE", 
			"NAN", "NODEID", "NODES", "NONE", "NOT", "NOW", "NULL", "OF", "OFF", 
			"OFFSET", "ON", "OR", "ORDER", "ONSUCCESS", "PARTITION", "PASSWORD", 
			"PATHS", "PIPE", "PIPES", "PIPESINK", "PIPESINKS", "PIPESINKTYPE", "POLICY", 
			"PREVIOUS", "PREVIOUSUNTILLAST", "PRIVILEGES", "PROCESSLIST", "PROPERTY", 
			"PRUNE", "QUERIES", "QUERY", "QUERYID", "RANGE", "READONLY", "REGEXP", 
			"REGION", "REGIONID", "REGIONS", "REMOVE", "RENAME", "RESAMPLE", "RESOURCE", 
			"REVOKE", "ROLE", "ROOT", "RUNNING", "SCHEMA", "SELECT", "SERIESSLOTID", 
			"SESSION", "SET", "SETTLE", "SGLEVEL", "SHOW", "SLIMIT", "SOFFSET", "STORAGE", 
			"START", "STARTTIME", "STATEFUL", "STATELESS", "STATEMENT", "STOP", "SYSTEM", 
			"TAGS", "TASK", "TEMPLATE", "TEMPLATES", "TIME", "TIMEOUT", "TIMESERIES", 
			"TIMESLOTID", "TIMESTAMP", "TO", "TOLERANCE", "TOP", "TRACING", "TRIGGER", 
			"TRIGGERS", "TRUE", "TTL", "UNLINK", "UNLOAD", "UNSET", "UPDATE", "UPSERT", 
			"URI", "USER", "USING", "VALUES", "VARIATION", "VERIFY", "VERSION", "WATERMARK_EMBEDDING", 
			"WHERE", "WITH", "WITHOUT", "WRITABLE", "PRIVILEGE_VALUE", "SET_STORAGE_GROUP", 
			...
			"DURATION_LITERAL", "DATETIME_LITERAL", "DATE_LITERAL", "TIME_LITERAL", 
			"INTEGER_LITERAL", "EXPONENT_NUM_PART", "DEC_DIGIT", "BOOLEAN_LITERAL", 
			"NAN_LITERAL", "ID", "QUOTED_ID", "NAME_CHAR", "CN_CHAR", "DQUOTA_STRING", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"BOOLEAN_LITERAL", "NAN_LITERAL", "ID", "QUOTED_ID"
		};
	}
