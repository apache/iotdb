...
groupByAttributeClause
    ...
    | VARIATION LR_BRACKET expression (COMMA delta=INTEGER_LITERAL|realLiteral)? (COMMA keyValuePair)* RR_BRACKET
    ;

keyValuePair
    : key=STRING_LITERAL operator_eq value=BOOLEAN_LITERAL
    ;
