...
public class EncodeTest {
  ...
  public void test() throws IOException {
    String inputPath = "/home/ubuntu/datasets/DOUBLE"; // the direction of input compressed data
    String Output =
    ...
    // props.put(Encoder.MAX_POINT_NUMBER,"2");
                ...
                for (CompressionType comp : compressList) {
                  ...
                  for (int i = 0; i < repeatTime; i++) {
                    ...
                    Encoder encoderIndex =
                        TSEncodingBuilder.getEncodingBuilder(encoding).getEncoder(TSDataType.INT64);
                    Decoder decoderIndex = Decoder.getDecoderByType(encoding, TSDataType.INT64);
                    Encoder encoder =
                    ...
                    double ratioTmp =
                        (double) (compressedIndex.length + compressed.length)
                            / (double) (tmpIndex.size() * Long.BYTES + tmp.size() * Integer.BYTES);
                    ratio += ratioTmp;
              ...
              for (TSEncoding encoding : encodingList) {
                ...
                for (CompressionType comp : compressList) {
                  ...
                  for (int i = 0; i < repeatTime; i++) {
                    ...
                    double ratioTmp =
                        (double) (compressedIndex.length + compressed.length)
                            / (double) (tmpIndex.size() * Long.BYTES + tmp.size() * Long.BYTES);
                    ratio += ratioTmp;
              ...
              for (TSEncoding encoding : encodingList) {
                ...
                for (CompressionType comp : compressList) {
                  ...
                  for (int i = 0; i < repeatTime; i++) {
                    ...
                    double ratioTmp =
                        (double) (compressedIndex.length + compressed.length)
                            / (double) (tmpIndex.size() * Long.BYTES + tmp.size() * Double.BYTES);
                    ratio += ratioTmp;
              ...
              for (TSEncoding encoding : encodingList) {
                ...
                for (CompressionType comp : compressList) {
                  ...
                  for (int i = 0; i < repeatTime; i++) {
                    ...
                    double ratioTmp =
                        (double) (compressedIndex.length + compressed.length)
                            / (double) (tmpIndex.size() * Long.BYTES + tmp.size() * Float.BYTES);
                    ratio += ratioTmp;
