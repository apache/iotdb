...
public class ContestEncodeTest {
  ...
  public static void main(@org.jetbrains.annotations.NotNull String[] args) throws IOException {
    ...
    String[] head = {"Encoding", "Compress", "Compression Ratio"};
    ...
    String[] record = {"TS_2DIFF", "GZIP", String.valueOf(ratio / 71)};
...
//                        //                        compressTime = compressTime / ((long)
// repeatTime);
//                        //                        uncompressTime = uncompressTime / ((long)
// repeatTime);
