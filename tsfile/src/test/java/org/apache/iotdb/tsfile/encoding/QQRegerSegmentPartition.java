...
public class QQRegerSegmentPartition {
...
//                min_index.add(alpha_list.get(k+1));
        ...
        while (isMoveable.size() != 0) {
          if (adjust_count < block_size / 2 && adjust_count <= -1) {
            adjust_count++;
          } else {
            break;
          }
...
//            raw_length.set(0,all_length.get(0).get(0)) ;
//            raw_length.set(3,all_length.get(0).get(1)) ;
//            raw_length.set(4,all_length.get(0).get(2)) ;
...
//        String parent_dir = "C:\\Users\\xiaoj\\Desktop\\test";
    ...
    String output_parent_dir = parent_dir + "vldb\\compression_ratio\\segment_test_time";
