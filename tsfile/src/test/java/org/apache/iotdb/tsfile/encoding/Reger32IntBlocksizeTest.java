...
public class Reger32IntBlocksizeTest {
  ...
  public static ArrayList<ArrayList<Integer>> getEncodeBitsRegression(
    ...
    if (m_reg * sum_squ_X_r != sum_X_r * sum_X_r) {
      theta0_r =
          (int) (sum_squ_X_r * sum_Y_r - sum_X_r * sum_squ_XY_r)
              / (int) (m_reg * sum_squ_X_r - sum_X_r * sum_X_r);
      theta1_r =
          (int) (m_reg * sum_squ_XY_r - sum_X_r * sum_Y_r)
              / (int) (m_reg * sum_squ_X_r - sum_X_r * sum_X_r);
    }
    ...
    if (m_reg * sum_squ_X_v != sum_X_v * sum_X_v) {
      theta0_v =
          (int) (sum_squ_X_v * sum_Y_v - sum_X_v * sum_squ_XY_v)
              / (int) (m_reg * sum_squ_X_v - sum_X_v * sum_X_v);
      theta1_v =
          (int) (m_reg * sum_squ_XY_v - sum_X_v * sum_Y_v)
              / (int) (m_reg * sum_squ_X_v - sum_X_v * sum_X_v);
    }
  ...
  public static int getJStar(
    ...
    for (int i = 1; i < block_size; i++) {
      int delta_t_i =
          ts_block.get(i).get(0) - (int) (theta0_t + theta1_t * (int) ts_block.get(i - 1).get(0));
      int delta_v_i =
          ts_block.get(i).get(1) - (int) (theta0_v + theta1_v * (int) ts_block.get(i - 1).get(1));
  ...
  private static ArrayList<Integer> adjustTo0(
      ArrayList<ArrayList<Integer>> ts_block, int alpha, ArrayList<Integer> theta) {
      ...
      if (i == (alpha + 1)) {
        timestamp_delta_i =
            ts_block.get(alpha + 1).get(0)
                - (int) (theta0_t + theta1_t * (int) ts_block.get(alpha - 1).get(0));
        value_delta_i =
            ts_block.get(alpha + 1).get(1)
                - (int) (theta0_v - theta1_v * (int) ts_block.get(alpha - 1).get(1));
      } else if (i == alpha) {
        timestamp_delta_i =
            ts_block.get(0).get(0) - (int) (theta0_t + theta1_t * (int) ts_block.get(alpha).get(0));
        value_delta_i =
            ts_block.get(0).get(1) - (int) (theta0_v + theta1_v * (int) ts_block.get(alpha).get(1));
      } else {
        timestamp_delta_i =
            ts_block.get(i).get(0) - (int) (theta0_t + theta1_t * (int) ts_block.get(i - 1).get(0));
        value_delta_i =
      ...
      if (i == (alpha + 1)) {
        ...
        timestamp_delta_i =
            ts_block.get(alpha).get(0)
                - (int) (theta0_t + theta1_t * (int) ts_block.get(block_size - 1).get(0));
        value_delta_i =
            ts_block.get(alpha).get(1)
                - (int) (theta0_v + theta1_v * (int) ts_block.get(block_size - 1).get(1));
      } else {
        timestamp_delta_i =
            ts_block.get(i).get(0) - (int) (theta0_t + theta1_t * (int) ts_block.get(i - 1).get(0));
        value_delta_i =
  ...
  private static ArrayList<Integer> adjustAlphaToJ(
      ArrayList<ArrayList<Integer>> ts_block, int alpha, int j, ArrayList<Integer> theta) {
    ...
    for (int i = 1; i < block_size; i++) {
      ...
      if (i == j) {
        timestamp_delta_i =
            ts_block.get(j).get(0) - (int) (theta0_t + theta1_t * (int) ts_block.get(alpha).get(0));
        value_delta_i =
            ts_block.get(j).get(1) - (int) (theta0_v + theta1_v * (int) ts_block.get(alpha).get(1));
      } else if (i == alpha) {
        timestamp_delta_i =
            ts_block.get(alpha).get(0)
                - (int) (theta0_t + theta1_t * (int) ts_block.get(j - 1).get(0));
        value_delta_i =
            ts_block.get(alpha).get(1)
                - (int) (theta0_v + theta1_v * (int) ts_block.get(j - 1).get(1));
      } else if (i == alpha + 1) {
        timestamp_delta_i =
            ts_block.get(alpha + 1).get(0)
                - (int) (theta0_t + theta1_t * (int) ts_block.get(alpha - 1).get(0));
  ...
  private static ArrayList<Integer> adjustn0(
      ArrayList<ArrayList<Integer>> ts_block, ArrayList<Integer> theta) {
    int block_size = ts_block.size();
    ArrayList<Integer> b = new ArrayList<>();
    int timestamp_delta_max = Integer.MIN_VALUE;
    int value_delta_max = Integer.MIN_VALUE;
  ...
  public static int getIStar(
      ArrayList<ArrayList<Integer>> ts_block, int block_size, int index, ArrayList<Integer> theta) {
    int timestamp_delta_max = Integer.MIN_VALUE;
    int value_delta_max = Integer.MIN_VALUE;
    ...
    if (index == 0) {
      for (int j = 1; j < block_size; j++) {
        int epsilon_v_j =
            ts_block.get(j).get(1) - (int) (theta0_v + theta1_v * (int) ts_block.get(j - 1).get(1));
      ...
      for (int j = 1; j < block_size; j++) {
        int epsilon_r_j =
            ts_block.get(j).get(0) - (int) (theta0_t + theta1_t * (int) ts_block.get(j - 1).get(0));
