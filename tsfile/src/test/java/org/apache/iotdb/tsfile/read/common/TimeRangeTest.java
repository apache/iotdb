...
//        TimeRange range = new TimeRange(1,3);
//        ArrayList<TimeRange> prevRanges = new ArrayList<>();
//        prevRanges.add(new TimeRange(1,2));
//        prevRanges.add(new TimeRange(5,5));
//
//        ArrayList<TimeRange> remainRanges = range.getRemains(prevRanges);
//        assertEquals(remainRanges.size(), 1);
