...
public class ChunkBuffer {
     ...
     * @param valueCount
     *            - the amount of values in that page
     * @param statistics
     *            - the statistics for that page
     * @param maxTimestamp
     *            - timestamp maximum in given data
     * @param minTimestamp
     *            - timestamp minimum in given data
    ...
    public int writePageHeaderAndDataIntoBuff(ByteBuffer data, int valueCount, Statistics<?> statistics,
        ...
        try {
            PageHeader header = new PageHeader(uncompressedSize, compressedSize, valueCount, statistics, maxTimestamp,
                    minTimestamp);
     ...
     *
     * @param writer
     *            the specified IOWriter
     * @param statistics
     *            the statistic information provided by series writer
