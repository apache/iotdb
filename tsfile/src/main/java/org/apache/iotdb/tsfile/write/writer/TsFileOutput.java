...
public interface TsFileOutput {
    ...
    /**
     * Writes <code>b.length</code> bytes from the specified byte array to this output at the current position.
     *
     * @param b
     *            the data.
    ...
    /**
     * Writes <code>b.remaining()</code> bytes from the specified byte array to this output at the current position.
     *
     * @param b
     *            the data.
     * @exception IOException
