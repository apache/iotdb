...
/**
 * Series reader is used to query one series of one tsfile, this reader has no
 * filter.
 */
public class FileSeriesReaderWithoutFilter extends FileSeriesReader {

  public FileSeriesReaderWithoutFilter(IChunkLoader chunkLoader, List<ChunkMetaData> chunkMetaDataList) {
