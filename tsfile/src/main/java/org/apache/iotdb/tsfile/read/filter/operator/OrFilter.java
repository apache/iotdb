...
/**
 * Either of the left and right operators of AndExpression must satisfy the
 * condition.
 */
public class OrFilter extends BinaryFilter implements Serializable {
  ...
  public boolean containStartEndTime(long startTime, long endTime) {
    return left.containStartEndTime(startTime, endTime) || right.containStartEndTime(startTime, endTime);
  }
