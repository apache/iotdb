...
/**
 * Each subclass of TSEncodingBuilder responds a enumerate value in {@linkplain TSEncoding TSEncoding}, which stores
...
public abstract class TSEncodingBuilder {
    ...
    /**
     * for TSEncoding, JSON is a kind of type for initialization. {@code InitFromJsonObject} gets values from JSON
     * object which will be used latter.<br>
    ...
    public static class RLE extends TSEncodingBuilder {
        ...
        /**
         * RLE could specify <b>max_point_number</b> in given JSON Object, which means the maximum decimal digits for
    ...
    public static class TS_2DIFF extends TSEncodingBuilder {
        ...
        @Override
        /**
         * TS_2DIFF could specify <b>max_point_number</b> in given JSON Object, which means the maximum decimal digits
         * for float or double data.
         */
        public void initFromProps(Map<String, String> props) {
            // set max error from initialized map or default value if not set
