...
public class PipeInputSeriesNumberNotValidException extends PipeParameterNotValidException {

  public PipeInputSeriesNumberNotValidException(int actual, int expected) {
    super(
        String.format(
  ...
  public PipeInputSeriesNumberNotValidException(
