...
public class SeriesRename {
  ...
  private static Optional<Pair<String, MeasurementSchema>> rename(
    ...
    //          return Optional.empty();
    //        }
    //        if (dataType != TSDataType.FLOAT || "value".equalsIgnoreCase(measurement)) {
    //          return Optional.empty();
    //        }
    ...
    //        measurementSchema = new MeasurementSchema(measurement, dataType, encoding,
    // compressionType);
    //
    //        return Optional.of(new Pair<>(newDevice, measurementSchema));
    //      case 'F':
    ...
    //          return Optional.empty();
    //        }
    //        if (dataType != TSDataType.DOUBLE || "value".equalsIgnoreCase(measurement)) {
    //          return Optional.empty();
    //        }
    ...
    //        builder = new StringBuilder();
    //        builder.append(device);
    //        newDevice = processDeviceWithF(measurement, nodes[4].length(), builder);
    //        measurementSchema =
    //            new MeasurementSchema("value", TSDataType.FLOAT, encoding, compressionType);
    //        return Optional.of(new Pair<>(newDevice, measurementSchema));
    //
  ...
  //  }
  //
  //  private static String processDevice(String measurement, StringBuilder builder) {
  //    return builder.append('.').append(measurement).toString();
  //  }
  //
  //  private static String processDeviceWithS(String measurement, StringBuilder builder) {
  //    return builder.delete(16, 18).append('.').append(measurement).append(".S").toString();
  //  }
  //
