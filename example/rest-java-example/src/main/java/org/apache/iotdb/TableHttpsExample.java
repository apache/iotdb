...
public class TableHttpsExample {
  ...
  public void insertTablet() {
    ...
    try {
      ...
      String json =
          "{\"database\":\"test\",\"column_categories\":[\"TAG\",\"ATTRIBUTE\",\"FIELD\"],\"timestamps\":[1635232143960,1635232153960,1635232163960,1635232173960,1635232183960],\"column_names\":[\"id1\",\"t1\",\"s1\"],\"data_types\":[\"STRING\",\"STRING\",\"FLOAT\"],\"values\":[[\"a11\",\"true\",11333],[\"a11\",\"false\",22333],[\"a13\",\"false1\",23333],[\"a14\",\"false2\",24],[\"a15\",\"false3\",25]],\"table\":\"db211\"}";
  ...
  public void nonQuery() {
    ...
    try {
      ...
      String sql =
          "{\"database\":\"test\",\"sql\":\"INSERT INTO db211(time, id1, s1) values(100, 'd1', 0)\"}";
  ...
  public void createTable() {
    ...
    try {
      HttpPost httpPost = getHttpPost("https://127.0.0.1:18080/rest/table/v1/nonQuery");
      String sql =
          "{\"database\":\"test\",\"sql\":\"create table db211 (id1 string TAG,t1 STRING ATTRIBUTE, s1 FLOAT FIELD)\"}";
      httpPost.setEntity(new StringEntity(sql, Charset.defaultCharset()));
      response = httpClient.execute(httpPost);
      HttpEntity responseEntity = response.getEntity();
      String message = EntityUtils.toString(responseEntity, UTF8);
  ...
  public void query() {
    ...
    try {
      ...
      String sql = "{\"database\":\"test\",\"sql\":\"select * from db211\"}";
      httpPost.setEntity(new StringEntity(sql, Charset.defaultCharset()));
      response = httpClient.execute(httpPost);
      HttpEntity responseEntity = response.getEntity();
      String message = EntityUtils.toString(responseEntity, UTF8);
