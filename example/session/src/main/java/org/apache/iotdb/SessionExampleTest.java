  ...
  public static void main(String[] args)
    ...
    session =
        new Session.Builder()
            ...
            .build();
    session.open(false);
    String sql = "select sum(s1) from (select * from table1)";
    ...
    System.out.println("Avg execution time is : " + (end - start) / loop + "ms");
    ...
    //                    Tablet.ColumnType.MEASUREMENT,
    //                    Tablet.ColumnType.MEASUREMENT);
    //    Tablet tablet = new Tablet("table1", schemaList, columnTypes, 100000);
    //    long timestamp = 0;
