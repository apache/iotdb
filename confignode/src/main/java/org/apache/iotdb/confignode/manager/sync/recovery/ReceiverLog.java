...
public class ReceiverLog {
  ...
  public void init() throws IOException {
    File logFile = new File(SyncReceiverPathUtil.getSysDir(), SyncConstant.RECEIVER_LOG_NAME);
    File msgFile = new File(SyncReceiverPathUtil.getSysDir(), SyncConstant.RECEIVER_MSG_LOG_NAME);
