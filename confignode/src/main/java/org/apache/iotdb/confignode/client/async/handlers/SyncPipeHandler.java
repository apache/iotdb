...
public class SyncPipeHandler extends AbstractRetryHandler implements AsyncMethodCallback<TSStatus> {

  private static final Logger LOGGER = LoggerFactory.getLogger(SyncPipeHandler.class);

  private final List<TSStatus> dataNodeResponseStatus;

  public SyncPipeHandler(
