...
public class GetDataNodesInfoListPlan extends ConfigPhysicalPlan {

  private TConsensusGroupType regionType;

  public GetDataNodesInfoListPlan() {
    super(ConfigPhysicalPlanType.GetDataNodesInfoList);
  }

  public GetDataNodesInfoListPlan(TConsensusGroupType regionType) {
    super(ConfigPhysicalPlanType.GetDataNodesInfoList);
