...
public final class MqttMessages {
  ...
  // --- MPPPublishHandler ---
  public static final String ON_PUBLISH_EXCEPTION = "onPublish 执行异常，消息为 [{}]，错误：";
  ...
  public static final String FIND_MQTT_PLUGIN = "PayloadFormatManager()，找到 MQTT Payload 插件 {}。";
  ...
  public static final String
      LOG_LINE_PATTERN_PARSING_FAILS_FAILED_LINE_MESSAGE_ARG_EXCEPTION_6EFB0EE2 =
          "行模式解析失败，失败的行消息为 {}，异常为";
  public static final String
      LOG_CONNECTION_REFUSED_CLIENT_ID_MISSING_EMPTY_VALID_CLIENT_ID_REQUIRED_A566DC15 =
          "连接被拒绝：client_id 缺失或为空。建立连接需要有效的 client_id。";
  public static final String
      LOG_RECEIVE_PUBLISH_MESSAGE_CLIENTID_ARG_USERNAME_ARG_QOS_ARG_TOPIC_7E60C3A6 =
          "收到 publish 消息。clientId: {}, 用户名: {}, qos: {}, 主题: {}, payload: {}";
  public static final String LOG_MQTT_JSON_INSERT_ERROR_CODE_ARG_MESSAGE_ARG_B1A78FBD =
      "MQTT JSON 插入错误，code={}，消息={}";
  public static final String
      LOG_MEET_ERROR_INSERTING_DATABASE_ARG_TABLE_ARG_TAGS_ARG_ATTRIBUTES_173457D5 =
          "插入数据库 {}、表 {}、标签 {}、属性 {}、字段 {}、时间 {} 时遇到错误，原因：";
  public static final String
