...
public final class RestMessages {
  ...
  public static final String COLUMN_CATEGORIES_NOT_NULL = "column_categories should not be null";
  ...
  public static final String ILLEGAL_TABLE_DATA_TYPE = "The %s data type of %s is illegal";
