...
public class InfluxDBSqlVisitor extends InfluxDBBaseVisitor<Operator> {
    ...
    private FilterOperator parseBasicFunctionOperator(InfluxDBParser.PredicateContext ctx, String keyName) {
    ...
    private ResultColumn parseResultColumn(InfluxDBParser.ResultColumnContext resultColumnContext) {
        return new ResultColumn(parseExpression(resultColumnContext.expression()),
    ...
    private Expression parseFunctionExpression(InfluxDBParser.ExpressionContext functionClause) {
        ...
        // attributes
        for (InfluxDBParser.FunctionAttributeContext functionAttribute : functionClause.functionAttribute()) {
