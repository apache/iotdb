...
service IDataNodeRPCService {
  ...
  /**
  * dispatch FragmentInstance to remote node for read request
  */
  ...
  */
  ...
  /**
   * Config node will create a schemaengine region on a list of data nodes.
   *
   * @param data nodes of the schemaengine region, and schemaengine region id generated by config node
   */
  ...
  /**
     * Config node will delete a data/schemaengine region of a certain storageGroup.
     *
     * @param data nodes of the data region, and data region id generated by config node
     */
  ...
  **/
  ...
  /**
   * Construct schemaengine black list in target schemaRegion to block R/W on matched timeseries
   */
  common.TSStatus constructSchemaBlackList(TConstructSchemaBlackListReq req)

  /**
   * Remove the schemaengine black list to recover R/W on matched timeseries
   */
  ...
  /**
   * Config node will fetch the schemaengine info in black list.
   *
   * @param binary: pathPatternTree
   */
  ...
  /**
   * Delete matched timeseries and remove according schemaengine black list in target schemRegion
   */
  common.TSStatus deleteTimeSeries(TDeleteTimeSeriesReq req)

  /**
   * Construct schemaengine black list in target schemaRegion to block R/W on matched timeseries represent by template
   */
  common.TSStatus constructSchemaBlackListWithTemplate(TConstructSchemaBlackListWithTemplateReq req)

  /**
   * Remove the schemaengine black list to recover R/W on matched timeseries represent by template
   */
   ...
   * and remove according template schemaengine black list in target schemRegion
   */
