...
| Latest Changes                                               | Related Committers                 |
| ------------------------------------------------------------ | ---------------------------------- |
| Add parameter sessionId in getTimeZone, getProperties, setDatabase, createTimeseries... | Tian Jiang|
...
| Latest Changes                     | Related Committers |
| ---------------------------------- | ------------------ |
| Delete struct TSSetDatabaseReq | Jialin Qiao        |
...
| Remove optional set\<string> childPaths, nodesList, databases, devices in TSFetchMetadataResp | Genius_pig |
...
| Add method TSStatus setDatabase(1:string database)   | Zesong Sun, Jialin Qiao            |
...
| Add method TSStatus deleteDatabases(1:list\<string> database) | Yi Tao                             |
...
| Rename some fields in TSFetchMetadataResp: ~~ColumnsList~~ to columnsList, ~~showTimeseriesList~~ to timeseriesList, ~~showDatabases~~ to databases | Zesong Sun             |
