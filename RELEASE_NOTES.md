...
* [IOTDB-3214] Refactor predefined metric part
* [IOTDB-3246] Validation tool

## Improvements

* [IOTDB-2503] Import a Status for TsFileResource
* [IOTDB-2561] Compaction code refactoring for restart recovery and exception handling
* [IOTDB-2610] Add metrics for compation module
...
* [IOTDB-2839] Add Python client CI
* [IOTDB-2873] provide json template for grafana
* [IOTDB-2963] Add some new metrics of process and hardware
* [IOTDB-3515] Load empty TsFile error message
...
* [IOTDB-2777] Modify the name of dropwizard, update the implementation of IoTDBReporter and fix NPE error
* [IOTDB-2787] Fix aligned mem chunk concurrent problem
* [IOTDB-2818] Fix exception occurs when submitting compaction task to global queue
* [IOTDB-2824] fix stop-server.sh that wrongly kill process
...
* [IOTDB-2855] Fix DeletionFileNodeTest error
* [IOTDB-2859] Fix python tablet with None value is incorrect
* [IOTDB-2852] The import-csv tool can not import the data to non aligned device
* [IOTDB-2861] Fix Cross compaction selector bug
...
* [IOTDB-3113] Add speed log for compaction
* [IOTDB-3120] Print the tsfile name when meet IOException
* [IOTDB-3158] Fix NPE exception
...
* [IOTDB-3392] File doesn't exist when move tsfile when virtual\_storage\_group\_num > 1
