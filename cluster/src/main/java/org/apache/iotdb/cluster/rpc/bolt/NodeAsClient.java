...
import org.apache.iotdb.cluster.closure.TaskClosure;
import org.apache.iotdb.cluster.exception.RaftConnectionException;
import org.apache.iotdb.cluster.rpc.bolt.request.BasicRequest;

public class NodeAsClient {

  public void asyncHandleRequest(BasicRequest request, PeerId leader, TaskClosure closure) {
  }

  public void syncHandleRequest(BasicRequest request, PeerId leader,
      TaskClosure taskClosure) throws RaftConnectionException {
  }
}
