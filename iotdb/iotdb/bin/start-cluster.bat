...
if NOT DEFINED MAIN_CLASS set MAIN_CLASS=org.apache.iotdb.cluster.entity.Server
...
set CLASSPATH="%IOTDB_HOME%\lib_cluster"

REM For each jar in the IOTDB_HOME lib directory call append to build the CLASSPATH variable.
for %%i in ("%IOTDB_HOME%\lib_cluster\*.jar") do call :append "%%i"
set CLASSPATH=%CLASSPATH%;iotdb.Cluster
goto okClasspath
