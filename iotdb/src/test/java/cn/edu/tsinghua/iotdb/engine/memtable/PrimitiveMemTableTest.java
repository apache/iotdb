...
public class PrimitiveMemTableTest {
    ...
    public void simpleTest() {
        ...
        for (int i = 0; i < dataSize; i++) {
            memTable.write(deviceId, measurementId[0], TSDataType.INT32, dataSize - i - 1, String.valueOf(i + 10));
        }
        for (int i = 0; i < dataSize; i++) {
    ...
    private void write(IMemTable memTable, String deviceId, String sensorId, TSDataType dataType, int size) {
        int dataSize = 100;
