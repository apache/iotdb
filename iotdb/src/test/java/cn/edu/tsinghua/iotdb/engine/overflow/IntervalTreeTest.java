    ...
    public void intDataMixTest() {
        ...
        for (int i = 0; i < crudResult.valueLength; i++) {
            if (i == 0) {
                ...
                Assert.assertEquals(crudResult.getTime(i * 2), 500);
                Assert.assertEquals(crudResult.getTime(i * 2 + 1), -500);
                Assert.assertEquals(crudResult.getInt(i), 2);
            }
        }
    ...
    public void floatDataMixTest() {
        ...
        for (int i = 0; i < crudResult.valueLength; i++) {
            if (i == 0) {
                ...
                Assert.assertEquals(crudResult.getTime(i * 2), 500);
                Assert.assertEquals(crudResult.getTime(i * 2 + 1), -500);
                Assert.assertEquals(crudResult.getFloat(i), 2.7, delta);
            }
        }
    }
    ...
    public void longDataMixTest() {
        ...
        for (int i = 0; i < crudResult.valueLength; i++) {
            if (i == 0) {
                ...
                Assert.assertEquals(crudResult.getTime(i * 2), 500);
                Assert.assertEquals(crudResult.getTime(i * 2 + 1), -500);
                Assert.assertEquals(crudResult.getLong(i), 2L);
            }
        }
    }
    ...
    public void doubleDataMixTest() {
        ...
        for (int i = 0; i < crudResult.valueLength; i++) {
            if (i == 0) {
                ...
                Assert.assertEquals(crudResult.getTime(i * 2), 500);
                Assert.assertEquals(crudResult.getTime(i * 2 + 1), -500);
                Assert.assertEquals(crudResult.getDouble(i), 2.6, delta);
            }
        }
    }
    ...
    public void stringDataMixTest() {
        ...
        for (int i = 0; i < crudResult.valueLength; i++) {
            if (i == 0) {
                ...
                Assert.assertEquals(crudResult.getTime(i * 2), 500);
                Assert.assertEquals(crudResult.getTime(i * 2 + 1), -500);
                Assert.assertEquals(crudResult.getBinary(i).getStringValue(), "tsfile2");
            }
        }
    }
