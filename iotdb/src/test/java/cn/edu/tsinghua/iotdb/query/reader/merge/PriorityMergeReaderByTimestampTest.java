...
public class PriorityMergeReaderByTimestampTest {
  ...
  public void test() throws IOException {
    FakedPrioritySeriesReaderByTimestamp reader1 = new FakedPrioritySeriesReaderByTimestamp(100, 200, 5, 11);
    FakedPrioritySeriesReaderByTimestamp reader2 = new FakedPrioritySeriesReaderByTimestamp(850, 200, 7, 19);
    FakedPrioritySeriesReaderByTimestamp reader3 = new FakedPrioritySeriesReaderByTimestamp(1080, 200, 13, 31);
  ...
  public static class FakedPrioritySeriesReaderByTimestamp implements EngineReaderByTimeStamp {
    ...
    public FakedPrioritySeriesReaderByTimestamp(long startTime, int size, int interval, int modValue) {
      long time = startTime;
