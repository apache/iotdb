...
public class IoTDBAggregationLargeDataTestIT {
  ...
  private void lastAggreWithMultiFilterTest() throws ClassNotFoundException, SQLException {
    ...
    try {
      ...
      while (resultSet.next()) {
        String ans = resultSet.getString(TIMESTAMP_STR) + "," + resultSet.getString(Constant.last(d0s0)) + ","
            + resultSet.getString(Constant.last(d0s1)) + "," + resultSet.getString(Constant.last(d0s2))
            + "," + resultSet.getString(Constant.last(d0s3)) + "," + resultSet.getString(Constant.last(d0s4));
  ...
  private void firstAggreWithSingleFilterTest() throws ClassNotFoundException, SQLException {
    ...
    try {
      ...
      int cnt = 0;
      while (resultSet.next()) {
        String ans = resultSet.getString(TIMESTAMP_STR) + "," + resultSet.getString(Constant.first(d0s0)) + ","
            + resultSet.getString(Constant.first(d0s1)) + "," + resultSet.getString(Constant.first(d0s2))
            + "," + resultSet.getString(Constant.first(d0s3)) + "," + resultSet.getString(Constant.first(d0s4));
        Assert.assertEquals(ans, retArray[cnt]);
        cnt++;
      }
      Assert.assertEquals(1, cnt);
  ...
  private void minMaxTimeAggreWithSingleFilterTest() throws ClassNotFoundException, SQLException {
    ...
    try {
      ...
      int cnt = 0;
      while (resultSet.next()) {
        String ans = resultSet.getString(TIMESTAMP_STR) + "," + resultSet.getString(Constant.min_time(d0s0)) + ","
            + resultSet.getString(Constant.min_time(d0s1)) + "," + resultSet.getString(Constant.min_time(d0s2))
            + "," + resultSet.getString(Constant.min_time(d0s3)) + "," + resultSet.getString(Constant.min_time(d0s4));
        Assert.assertEquals(ans, retArray[cnt]);
        cnt++;
      }
      Assert.assertEquals(1, cnt);
  ...
  public static void insertSQL() throws ClassNotFoundException, SQLException {
    ...
    try {
      ...
      System.out.println("d0s0sum = "+d0s0sum+"; d0s1sum = "+d0s1sum+"; d0s2sum = "+d0s2sum);
