...
public class SQLParserTest {
    ...
    public void createTimeseries() throws ParseException {
        ...
        ArrayList<String> ans = new ArrayList<>(Arrays.asList("TOK_CREATE", "TOK_TIMESERIES", "TOK_PATH", "TOK_ROOT",
                "laptop", "d0", "s2", "TOK_WITH", "TOK_DATATYPE", "FLOAT", "TOK_ENCODING", "RLE", "TOK_CLAUSE",
                "freq_encoding", "DFT", "TOK_CLAUSE", "write_main_freq", "true", "TOK_CLAUSE", "dft_pack_length", "300",
    ...
    public void multiInsert() throws ParseException {
        // template for test case
        ArrayList<String> ans = new ArrayList<>(
                Arrays.asList("TOK_INSERT", "TOK_PATH", "TOK_ROOT", "vehicle", "d0", "TOK_MULT_IDENTIFIER", "TOK_TIME",
                        "s0", "s1", "s2", "TOK_MULT_VALUE", "12345678", "-1011.666", "'da#$%fa'", "FALSE", "True"));
        ArrayList<String> rec = new ArrayList<>();
    ...
    public void multiInsert2() throws ParseException {
        ...
        ArrayList<String> rec = new ArrayList<>();
        ASTNode astTree = ParseGenerator
                .generateAST("insert into root.vehicle.d0 (timestamp, s0, s1)  values(now() , -1011.666, 1231);");
        astTree = ParseUtils.findRootNonNullToken(astTree);
        recursivePrintSon(astTree, rec);
    ...
    public void multiInsert3() throws ParseException {
        ...
        ArrayList<String> ans = new ArrayList<>(
                Arrays.asList("TOK_INSERT", "TOK_PATH", "TOK_ROOT", "vehicle", "d0", "TOK_MULT_IDENTIFIER", "TOK_TIME",
                        "s0", "s1", "TOK_MULT_VALUE", "TOK_DATETIME", "2016-02-01 11:12:35", "-1011.666", "1231"));
        ArrayList<String> rec = new ArrayList<>();
        ASTNode astTree = ParseGenerator.generateAST(
    ...
    public void multiInsert4() throws ParseException {
        ...
        ArrayList<String> ans = new ArrayList<>(Arrays.asList("TOK_INSERT", "TOK_PATH", "TOK_ROOT", "vehicle", "d0",
                "TOK_MULT_IDENTIFIER", "TOK_TIME", "s0", "s1", "TOK_MULT_VALUE", "TOK_DATETIME", "2016-02-01 11:12:35",
                "\'12\"3a\\'bc\'", "\"12\\\"3abc\""));
        ArrayList<String> rec = new ArrayList<>();
    ...
    public void updateValueWithTimeFilter1() throws ParseException {
        // template for test case
        ArrayList<String> ans = new ArrayList<>(Arrays.asList("TOK_UPDATE", "TOK_PATH", "TOK_ROOT", "laptop",
                "TOK_VALUE", "TOK_PATH", "d1", "s1", "-33000", "TOK_VALUE", "TOK_PATH", "mac", "d1", "s2", "'string'",
    ...
    public void updateValueWithTimeFilter2() throws ParseException {
        ...
        ArrayList<String> rec = new ArrayList<>();
        ASTNode astTree = ParseGenerator
                .generateAST("UPDATE root.laptop.* SET d1.s1 = -33000, mac.d1.s2 = 'string' WHERE time < 100;");
        astTree = ParseUtils.findRootNonNullToken(astTree);
        recursivePrintSon(astTree, rec);
    ...
    public void updateValueWithTimeFilter3() throws ParseException {
        // template for test case
        ArrayList<String> ans = new ArrayList<>(Arrays.asList("TOK_UPDATE", "TOK_PATH", "TOK_ROOT", "laptop",
                "TOK_VALUE", "TOK_PATH", "d1", "s1", "-33.54", "TOK_VALUE", "TOK_PATH", "mac", "d1", "s2", "FALSE",
                "TOK_WHERE", "not", "=", "TOK_PATH", "d1", "s2", "TRUE"));
        ArrayList<String> rec = new ArrayList<>();
        ASTNode astTree = ParseGenerator
                .generateAST("UPDATE root.laptop SET d1.s1 = -33.54, mac.d1.s2 = FALSE WHERE not(d1.s2 = TRUE)");
        astTree = ParseUtils.findRootNonNullToken(astTree);
        recursivePrintSon(astTree, rec);
    ...
    public void delete() throws ParseException {
        // template for test case
        ArrayList<String> ans = new ArrayList<>(Arrays.asList("TOK_DELETE", "TOK_PATH", "TOK_ROOT", "d1", "s1",
    ...
    public void delete4() throws ParseException {
        // template for test case
        ArrayList<String> ans = new ArrayList<>(Arrays.asList("TOK_DELETE", "TOK_PATH", "TOK_ROOT", "d1", "s1",
                "TOK_PATH", "TOK_ROOT", "d2", "s3", "TOK_WHERE", "<", "TOK_PATH", "time", "TOK_DATETIME", "now"));
        ArrayList<String> rec = new ArrayList<>();
    ...
    public void delete5() throws ParseException {
        // template for test case
        ArrayList<String> ans = new ArrayList<>(Arrays.asList("TOK_DELETE", "TOK_PATH", "TOK_ROOT", "d1", "*",
                "TOK_PATH", "TOK_ROOT", "*", "s2", "TOK_WHERE", "!", "<", "TOK_PATH", "time", "123456"));
        ArrayList<String> rec = new ArrayList<>();
    ...
    public void deleteTimeseires1() throws ParseException, RecognitionException {
        // template for test case
        ArrayList<String> ans = new ArrayList<>(
                Arrays.asList("TOK_DELETE", "TOK_TIMESERIES", "TOK_PATH", "TOK_ROOT", "dt", "a", "b", "d1", "s1"));
        ArrayList<String> rec = new ArrayList<>();
    ...
    public void deleteTimeseires3() throws ParseException, RecognitionException {
        // template for test case
        ArrayList<String> ans = new ArrayList<>(Arrays.asList("TOK_DELETE", "TOK_TIMESERIES", "TOK_PATH", "TOK_ROOT",
    ...
    public void query1() throws ParseException, RecognitionException {
        // template for test case
        ArrayList<String> ans = new ArrayList<>(Arrays.asList("TOK_QUERY", "TOK_SELECT", "TOK_PATH", "device_1",
                "sensor_1", "TOK_PATH", "device_2", "sensor_2", "TOK_FROM", "TOK_PATH", "TOK_ROOT", "vehicle",
                "TOK_WHERE", "and", "not", "<", "TOK_PATH", "TOK_ROOT", "laptop", "device_1", "sensor_1", "2000", ">",
    ...
    public void query2() throws ParseException, RecognitionException {
        ...
        ArrayList<String> ans = new ArrayList<>(Arrays.asList("TOK_QUERY", "TOK_SELECT", "TOK_PATH", "device_1",
                "sensor_1", "TOK_PATH", "device_2", "sensor_2", "TOK_FROM", "TOK_PATH", "TOK_ROOT", "vehicle",
                "TOK_WHERE", "&&", "<", "TOK_PATH", "TOK_ROOT", "laptop", "device_1", "sensor_1", "-2.2E10", ">",
    ...
    public void query3() throws ParseException, RecognitionException {
        // template for test case
        ArrayList<String> ans = new ArrayList<>(
                Arrays.asList("TOK_QUERY", "TOK_SELECT", "TOK_PATH", "device_1", "sensor_1", "TOK_PATH", "device_2",
                        "sensor_2", "TOK_FROM", "TOK_PATH", "TOK_ROOT", "vehicle", "TOK_WHERE", "&", "<", "TOK_PATH",
    ...
    public void query4() throws ParseException {
        // template for test case
        ArrayList<String> ans = new ArrayList<>(Arrays.asList("TOK_QUERY", "TOK_SELECT", "TOK_PATH", "*", "TOK_FROM",
                "TOK_PATH", "TOK_ROOT", "vehicle", "TOK_WHERE", "||", "<", "TOK_PATH", "time", "1234567", ">",
                "TOK_PATH", "time", "TOK_DATETIME", "2017-6-2T12:00:12+07:00"));
        ArrayList<String> rec = new ArrayList<>();
        ASTNode astTree = ParseGenerator
                .generateAST("SELECT * FROM root.vehicle WHERE time < 1234567 || time > 2017-6-2T12:00:12+07:00;");
        astTree = ParseUtils.findRootNonNullToken(astTree);
        recursivePrintSon(astTree, rec);
    ...
    public void aggregation1() throws ParseException, RecognitionException {
        // template for test case
        ArrayList<String> ans = new ArrayList<>(Arrays.asList("TOK_QUERY", "TOK_SELECT", "TOK_PATH", "TOK_CLUSTER",
                "TOK_PATH", "s1", "count", "TOK_PATH", "TOK_CLUSTER", "TOK_PATH", "s2", "max_time", "TOK_FROM",
                "TOK_PATH", "TOK_ROOT", "vehicle", "d1", "TOK_WHERE", "and", "<", "TOK_PATH", "TOK_ROOT", "vehicle",
    ...
    public void aggregation2() throws ParseException, RecognitionException {
        // template for test case
        ArrayList<String> ans = new ArrayList<>(Arrays.asList("TOK_QUERY", "TOK_SELECT", "TOK_PATH", "TOK_CLUSTER",
                "TOK_PATH", "s2", "sum", "TOK_FROM", "TOK_PATH", "TOK_ROOT", "vehicle", "d1", "TOK_WHERE", "or", "<",
    ...
    public void aggregation3() throws ParseException, RecognitionException {
        // template for test case
        ArrayList<String> ans = new ArrayList<>(
                Arrays.asList("TOK_QUERY", "TOK_SELECT", "TOK_PATH", "s1", "TOK_PATH", "TOK_CLUSTER", "TOK_PATH", "s2",
                        "sum", "TOK_FROM", "TOK_PATH", "TOK_ROOT", "vehicle", "d1", "TOK_WHERE", "|", "<", "TOK_PATH",
    ...
    public void groupby1() throws ParseException, RecognitionException {
        ...
        ArrayList<String> ans = new ArrayList<>(Arrays.asList("TOK_QUERY", "TOK_SELECT", "TOK_PATH", "TOK_CLUSTER",
                "TOK_PATH", "s1", "count", "TOK_PATH", "TOK_CLUSTER", "TOK_PATH", "s2", "max_time", "TOK_FROM",
                "TOK_PATH", "TOK_ROOT", "vehicle", "d1", "TOK_WHERE", "and", "<", "TOK_PATH", "TOK_ROOT", "vehicle",
                "d1", "s1", "0.32e6", "<=", "TOK_PATH", "time", "TOK_DATETIME", "now", "TOK_GROUPBY", "TOK_TIMEUNIT",
                "10", "w", "TOK_TIMEORIGIN", "44", "TOK_TIMEINTERVAL", "TOK_TIMEINTERVALPAIR", "1", "3",
                "TOK_TIMEINTERVALPAIR", "4", "5"));
        ArrayList<String> rec = new ArrayList<>();
        ASTNode astTree = ParseGenerator.generateAST("select count(s1),max_time(s2) " + "from root.vehicle.d1 "
                + "where root.vehicle.d1.s1 < 0.32e6 and time <= now() " + "group by(10w, 44, [1,3], [4,5])");
        astTree = ParseUtils.findRootNonNullToken(astTree);
        recursivePrintSon(astTree, rec);
    ...
    public void groupby2() throws ParseException, RecognitionException {
        ...
        ArrayList<String> ans = new ArrayList<>(Arrays.asList("TOK_QUERY", "TOK_SELECT", "TOK_PATH", "TOK_CLUSTER",
                "TOK_PATH", "s2", "sum", "TOK_FROM", "TOK_PATH", "TOK_ROOT", "vehicle", "d1", "TOK_WHERE", "or", "<",
                "TOK_PATH", "s1", "2000", ">=", "TOK_PATH", "time", "1234567", "TOK_GROUPBY", "TOK_TIMEUNIT", "111",
                "ms", "TOK_TIMEINTERVAL", "TOK_TIMEINTERVALPAIR", "123", "TOK_DATETIME", "2017-6-2T12:00:12+07:00",
    ...
    public void groupby3() throws ParseException, RecognitionException {
        // template for test case
        ArrayList<String> ans = new ArrayList<>(Arrays.asList("TOK_QUERY", "TOK_SELECT", "TOK_PATH", "s1", "TOK_PATH",
                "TOK_CLUSTER", "TOK_PATH", "s2", "sum", "TOK_FROM", "TOK_PATH", "TOK_ROOT", "vehicle", "d1",
                "TOK_WHERE", "|", "<", "TOK_PATH", "TOK_ROOT", "vehicle", "d1", "s1", "2000", ">=", "TOK_PATH", "time",
    ...
    public void fill1() throws ParseException {
        // template for test case
        ArrayList<String> ans = new ArrayList<>(Arrays.asList("TOK_QUERY", "TOK_SELECT", "TOK_PATH", "s1", "TOK_FROM",
                "TOK_PATH", "TOK_ROOT", "vehicle", "d1", "TOK_WHERE", "=", "TOK_PATH", "time", "1234567", "TOK_FILL",
    ...
    public void fill5() throws ParseException {
        // template for test case
        ArrayList<String> ans = new ArrayList<>(Arrays.asList("TOK_QUERY", "TOK_SELECT", "TOK_PATH", "s1", "TOK_PATH",
                "s2", "TOK_FROM", "TOK_PATH", "TOK_ROOT", "vehicle", "d1", "TOK_WHERE", "=", "TOK_PATH", "time",
                "1234567", "TOK_FILL", "TOK_TYPE", "int", "TOK_LINEAR", "TOK_TIMEUNIT", "5", "ms", "TOK_TIMEUNIT", "7",
                "d", "TOK_TYPE", "float", "TOK_PREVIOUS", "TOK_TYPE", "boolean", "TOK_LINEAR", "TOK_TYPE", "text",
                "TOK_PREVIOUS", "TOK_TIMEUNIT", "66", "w"));
        ArrayList<String> rec = new ArrayList<>();
        ASTNode astTree = ParseGenerator.generateAST("select s1,s2 " + "FROM root.vehicle.d1 " + "WHERE time = 1234567 "
    ...
    public void limit3() throws ParseException {
        // template for test case
        ArrayList<String> ans = new ArrayList<>(Arrays.asList("TOK_QUERY", "TOK_SELECT", "TOK_PATH", "device_1",
                "sensor_1", "TOK_PATH", "device_2", "*", "TOK_FROM", "TOK_PATH", "TOK_ROOT", "vehicle", "TOK_WHERE",
                "&&", "<", "TOK_PATH", "TOK_ROOT", "laptop", "device_1", "sensor_1", "-2.2E10", ">", "TOK_PATH", "time",
    ...
    public void limit4() throws ParseException {
        // template for test case
        ArrayList<String> ans = new ArrayList<>(Arrays.asList("TOK_QUERY", "TOK_SELECT", "TOK_PATH", "device_1",
                "sensor_1", "TOK_PATH", "device_2", "sensor_2", "TOK_FROM", "TOK_PATH", "TOK_ROOT", "*", "TOK_WHERE",
                "&&", "<", "TOK_PATH", "TOK_ROOT", "laptop", "device_1", "sensor_1", "-2.2E10", ">", "TOK_PATH", "time",
    ...
    public void limit6() throws ParseException, RecognitionException {
        ...
        ArrayList<String> ans = new ArrayList<>(Arrays.asList("TOK_QUERY", "TOK_SELECT", "TOK_PATH", "TOK_CLUSTER",
                "TOK_PATH", "s1", "count", "TOK_PATH", "TOK_CLUSTER", "TOK_PATH", "s2", "max_time", "TOK_FROM",
                "TOK_PATH", "TOK_ROOT", "vehicle", "*", "TOK_WHERE", "and", "<", "TOK_PATH", "TOK_ROOT", "vehicle",
                "d1", "s1", "0.32e6", "<=", "TOK_PATH", "time", "TOK_DATETIME", "now", "TOK_GROUPBY", "TOK_TIMEUNIT",
                "10", "w", "TOK_TIMEORIGIN", "44", "TOK_TIMEINTERVAL", "TOK_TIMEINTERVALPAIR", "1", "3",
                "TOK_TIMEINTERVALPAIR", "4", "5", "TOK_SLIMIT", "1", "TOK_SOFFSET", "1", "TOK_LIMIT", "11"));
        ArrayList<String> rec = new ArrayList<>();
        ASTNode astTree = ParseGenerator.generateAST("select count(s1),max_time(s2) " + "from root.vehicle.* "
                + "where root.vehicle.d1.s1 < 0.32e6 and time <= now() " + "group by(10w, 44, [1,3], [4,5])"
    ...
    public void limit7() throws ParseException {
        // template for test case
        ArrayList<String> ans = new ArrayList<>(
                Arrays.asList("TOK_QUERY", "TOK_SELECT", "TOK_PATH", "*", "TOK_FROM", "TOK_PATH", "TOK_ROOT", "vehicle",
                        "d1", "TOK_WHERE", "=", "TOK_PATH", "time", "1234567", "TOK_FILL", "TOK_TYPE", "float",
                        "TOK_PREVIOUS", "TOK_TIMEUNIT", "11", "h", "TOK_SLIMIT", "15", "TOK_SOFFSET", "50"));
        ArrayList<String> rec = new ArrayList<>();
        ASTNode astTree = ParseGenerator.generateAST("select * " + "FROM root.vehicle.d1 " + "WHERE time = 1234567 "
    ...
    public void grantUser() throws ParseException {
        // template for test case
        ArrayList<String> ans = new ArrayList<>(Arrays.asList("TOK_GRANT", "TOK_USER", "myusername", "TOK_PRIVILEGES",
    ...
    public void grantRole() throws ParseException {
        // template for test case
        ArrayList<String> ans = new ArrayList<>(Arrays.asList("TOK_GRANT", "TOK_ROLE", "admin", "TOK_PRIVILEGES",
                "'create'", "'delete'", "TOK_PATH", "TOK_ROOT", "laptop", "d1", "s1"));
        ArrayList<String> rec = new ArrayList<>();
        ASTNode astTree = ParseGenerator
    ...
    public void revokeUser() throws ParseException {
        // template for test case
        ArrayList<String> ans = new ArrayList<>(Arrays.asList("TOK_REVOKE", "TOK_USER", "myusername", "TOK_PRIVILEGES",
                "'create'", "'delete'", "TOK_PATH", "TOK_ROOT", "laptop", "d1", "s1"));
        ArrayList<String> rec = new ArrayList<>();
        ASTNode astTree = ParseGenerator
    ...
    public void revokeRole() throws ParseException {
        // template for test case
        ArrayList<String> ans = new ArrayList<>(Arrays.asList("TOK_REVOKE", "TOK_ROLE", "admin", "TOK_PRIVILEGES",
                "'create'", "'delete'", "TOK_PATH", "TOK_ROOT", "laptop", "d1", "s1"));
        ArrayList<String> rec = new ArrayList<>();
        ASTNode astTree = ParseGenerator
    ...
    public void linkLabel() throws ParseException {
        // template for test case
        ArrayList<String> ans = new ArrayList<>(Arrays.asList("TOK_LINK", "TOK_PATH", "TOK_ROOT", "a", "b", "c",
    ...
    public void unlinkLabel() throws ParseException {
        // template for test case
        ArrayList<String> ans = new ArrayList<>(Arrays.asList("TOK_UNLINK", "TOK_PATH", "TOK_ROOT", "m1", "m2",
                "TOK_LABEL", "myLabel", "TOK_PROPERTY", "myProp"));
        ArrayList<String> rec = new ArrayList<>();
    ...
    public void createIndex1() throws ParseException, RecognitionException {
        ArrayList<String> ans = new ArrayList<>(Arrays.asList("TOK_CREATE", "TOK_INDEX", "TOK_PATH", "TOK_ROOT", "a",
                "b", "c", "TOK_FUNC", "kvindex", "TOK_WITH", "TOK_INDEX_KV", "window_length", "50", "TOK_WHERE", ">",
                "TOK_PATH", "time", "123"));
        ArrayList<String> rec = new ArrayList<>();
        ASTNode astTree = ParseGenerator
                .generateAST("create index on root.a.b.c using kvindex with window_length=50 where time > 123");
        astTree = ParseUtils.findRootNonNullToken(astTree);
        recursivePrintSon(astTree, rec);
    ...
    public void createIndex2() throws ParseException, RecognitionException {
        ArrayList<String> ans = new ArrayList<>(Arrays.asList("TOK_CREATE", "TOK_INDEX", "TOK_PATH", "TOK_ROOT", "a",
                "b", "c", "TOK_FUNC", "kv-match2", "TOK_WITH", "TOK_INDEX_KV", "xxx", "50", "TOK_INDEX_KV", "xxx",
                "123", "TOK_WHERE", ">", "TOK_PATH", "time", "TOK_DATETIME", "now"));
        ArrayList<String> rec = new ArrayList<>();
        ASTNode astTree = ParseGenerator
                .generateAST("create index on root.a.b.c using kv-match2 with xxx=50,xxx=123 where time > now();");
        astTree = ParseUtils.findRootNonNullToken(astTree);
        recursivePrintSon(astTree, rec);
    ...
    public void selectIndex1() throws ParseException, RecognitionException {
        ArrayList<String> ans = new ArrayList<>(Arrays.asList("TOK_QUERY", "TOK_SELECT_INDEX", "subsequence_matching",
                "TOK_PATH", "TOK_ROOT", "a", "b", "c", "TOK_PATH", "TOK_ROOT", "a", "b", "c", "123", "132", "123.1",
    ...
    public void selectIndex3() throws ParseException, RecognitionException {
        ArrayList<String> ans = new ArrayList<>(Arrays.asList("TOK_QUERY", "TOK_SELECT_INDEX", "kvindex", "TOK_PATH",
    ...
    public void dropIndex() throws ParseException, RecognitionException {
        ArrayList<String> ans = new ArrayList<>(
                Arrays.asList("TOK_DROP", "TOK_INDEX", "TOK_PATH", "TOK_ROOT", "a", "b", "c", "TOK_FUNC", "kvindex"));
        ArrayList<String> rec = new ArrayList<>();
