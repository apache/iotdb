        ...
        Thread writeThread = new Thread(() -> {
            ...
            try {
                ...
                while(true) {
                    ...
                    WriteLogNode logNode = MultiFileLogNodeManager.getInstance().getNode("root.logFileTest.bufferwrite" + IoTDBConstant.BUFFERWRITE_LOG_NODE_SUFFIX, null, null);
        ...
        Thread writeThread = new Thread(() -> {
            ...
            try {
                ...
                while(true) {
                    ...
                    statement.execute(sql);
                    WriteLogNode logNode = MultiFileLogNodeManager.getInstance().getNode("root.logFileTest.overflow" + IoTDBConstant.OVERFLOW_LOG_NODE_SUFFIX, null, null);
