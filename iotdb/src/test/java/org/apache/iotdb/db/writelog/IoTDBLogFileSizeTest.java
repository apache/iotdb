...
public class IoTDBLogFileSizeTest {
    ...
    public void testBufferwrite() throws InterruptedException {
            ...
            try {
                ...
                while (true) {
                    ...
                    String sql = String.format(
                            "INSERT INTO root.logFileTest.bufferwrite(timestamp,val) VALUES (%d, %d)", ++cnt, cnt);
                    statement.execute(sql);
                    WriteLogNode logNode = MultiFileLogNodeManager.getInstance().getNode(
                            "root.logFileTest.bufferwrite" + IoTDBConstant.BUFFERWRITE_LOG_NODE_SUFFIX, null, null);
        ...
        System.out.println("Max size of bufferwrite wal is " + MemUtils.bytesCntToStr(maxLength[0]) + " after "
    ...
    public void testOverflow() throws InterruptedException {
        ...
        Thread writeThread = new Thread(() -> {
            ...
            try {
                ...
                while (true) {
                    ...
                    String sql = String.format("INSERT INTO root.logFileTest.overflow(timestamp,val) VALUES (%d, %d)",
                            ++cnt, cnt);
                    statement.execute(sql);
                    WriteLogNode logNode = MultiFileLogNodeManager.getInstance()
                            .getNode("root.logFileTest.overflow" + IoTDBConstant.OVERFLOW_LOG_NODE_SUFFIX, null, null);
        ...
        System.out.println("Max size of overflow wal is " + MemUtils.bytesCntToStr(maxLength[0]) + " after " + runtime
