...
public class IOTDBGroupByTestIT {
  ...
  public void countSumMeanTest() throws SQLException {
    ...
    try {
      ...
      boolean hasResultSet = statement.execute("select count(temperature), sum(temperature), mean(temperature) from root.ln.wf01.wt01 where time > 3 "
      ...
      while (resultSet.next()) {
        String ans = resultSet.getString(TIMESTAMP_STR) + "," + resultSet.getString(count("root.ln.wf01.wt01.temperature"))
            + "," + resultSet.getString(sum("root.ln.wf01.wt01.temperature"))+ "," + resultSet.getString(mean("root.ln.wf01.wt01.temperature"));
      ...
      hasResultSet = statement.execute("select count(temperature), sum(temperature), mean(temperature) from root.ln.wf01.wt01 where temperature > 3 "
          + "GROUP BY (20ms, 5,[2,30], [35,37], [50, 160], [310, 314])");
  ...
  public void maxMinValeTimeTest() throws SQLException {
    ...
    try {
      connection = DriverManager.getConnection("jdbc:iotdb://127.0.0.1:6667/", "root", "root");
      Statement statement = connection.createStatement();
      boolean hasResultSet = statement.execute("select max_value(temperature), min_value(temperature), max_time(temperature), min_time(temperature) from root.ln.wf01.wt01 where time > 3 "
          + "GROUP BY (20ms, 5,[2,30], [35,37], [50, 160], [310, 314])");
      ...
      int cnt = 0;
      while (resultSet.next()) {
        String ans = resultSet.getString(TIMESTAMP_STR) + "," + resultSet.getString(max_value("root.ln.wf01.wt01.temperature"))
            + "," + resultSet.getString(min_value("root.ln.wf01.wt01.temperature"))+ "," + resultSet.getString(max_time("root.ln.wf01.wt01.temperature"))
      ...
      statement = connection.createStatement();
      hasResultSet = statement.execute("select max_value(temperature), min_value(temperature), max_time(temperature), min_time(temperature) from root.ln.wf01.wt01 where temperature > 3 "
          + "GROUP BY (20ms, 5,[2,30], [35,37], [50, 160], [310, 314])");
  ...
  public void firstLastTest() throws SQLException {
    ...
    try {
      connection = DriverManager.getConnection("jdbc:iotdb://127.0.0.1:6667/", "root", "root");
      Statement statement = connection.createStatement();
      boolean hasResultSet = statement.execute("select last(temperature), first(temperature) from root.ln.wf01.wt01 where time > 3 "
          + "GROUP BY (20ms, 5,[2,30], [35,37], [50, 160], [310, 314])");
      ...
      statement = connection.createStatement();
      hasResultSet = statement.execute("select first(temperature), last(temperature) from root.ln.wf01.wt01 where temperature > 3 "
          + "GROUP BY (20ms, 5,[2,30], [35,37], [50, 160], [310, 314])");
