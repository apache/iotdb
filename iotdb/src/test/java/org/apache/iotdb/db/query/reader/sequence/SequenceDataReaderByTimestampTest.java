...
public class SequenceDataReaderByTimestampTest {
  ...
  /**
   * Test hasNext() and getValueInTimestamp(long timestamp) method in SequenceDataReaderByTimestamp.
   */
  @Test
  public void text() throws IOException {
    ...
    FakedSeriesReaderByTimestamp unsealedTsFile = new FakedSeriesReaderByTimestamp(100 + 1005 *7,100, 17, 3);
    FakedSeriesReaderByTimestamp dataInMemory = new FakedSeriesReaderByTimestamp(100 + 1005 *7 + 100 * 17,60, 19, 23);
