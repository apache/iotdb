...
public class IoTDBTimeZoneTest {
    ...
    String[] retArray = new String[] { "1514775603000,4", "1514779200000,1", "1514779201000,2", "1514779202000,3",
            "1514779203000,8", "1514782804000,5", "1514782805000,7", "1514782806000,9", "1514782807000,10",
    ...
    public void timezoneTest() throws ClassNotFoundException, SQLException, TException {
        ...
        try {
            connection = (IoTDBConnection) DriverManager.getConnection(Config.IOTDB_URL_PREFIX + "127.0.0.1:6667/",
                    "root", "root");
