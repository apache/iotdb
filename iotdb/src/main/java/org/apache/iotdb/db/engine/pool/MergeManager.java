...
public class MergeManager {
     ...
     * 
     * @param block
     *            if set block to true, this method will wait for timeOut milliseconds to close the merge pool. false,
     *            return directly.
     * @param timeOut
     *            block time out in milliseconds.
     * @throws ProcessorException
     *             if timeOut reach or interrupted while waiting to exit.
     */
     ...
     * 
     * @param block
     *            if set to true, this method will wait for timeOut milliseconds. false, return directly. False, return
     *            directly.
     * @param timeOut
     *            block time out in milliseconds.
     * @throws ProcessorException
