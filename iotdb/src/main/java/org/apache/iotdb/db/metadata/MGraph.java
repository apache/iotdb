...
public class MGraph implements Serializable {
     ...
     * 
     * @param path
     *            a seriesPath belongs to MTree or PTree
     * @throws PathErrorException
     */
    ...
    /**
     * Get all paths for given seriesPath regular expression if given seriesPath belongs to MTree, or get all linked
     * seriesPath for given seriesPath if given seriesPath belongs to PTree Notice: Regular expression in this method is
