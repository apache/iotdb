...
public class RemoveNotOptimizer implements IFilterOptimizer {
     ...
     *             exception in RemoveNot optimizing
     */
    @Override
    ...
    private FilterOperator reverseFilter(FilterOperator filter) throws LogicalOperatorException {
        ...
        if (filter.isLeaf()) {
            try {
                ...
                throw new LogicalOperatorException("convert BasicFuntion to reserved meet failed: previous token:"
        ...
        default:
            throw new LogicalOptimizeException(
                    "Unknown token in reverseFilter: " + tokenInt + "," + SQLConstant.tokenNames.get(tokenInt));
        }
    }
