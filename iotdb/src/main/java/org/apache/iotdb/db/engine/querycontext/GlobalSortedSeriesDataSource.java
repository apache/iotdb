...
public class GlobalSortedSeriesDataSource {
  ...
  public GlobalSortedSeriesDataSource(Path seriesPath, List<TsFileInstance> sealedTsFiles,
  ...
  public List<TsFileInstance> getSealedTsFiles() {
    return sealedTsFiles;
  }

  public void setSealedTsFiles(List<TsFileInstance> sealedTsFiles) {
    this.sealedTsFiles = sealedTsFiles;
  }
