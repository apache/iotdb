...
public class SessionDatasetTest {
    ...
    private static final int ROW_NUMBER = 8000000;
...
//    @Test
//    public void testV1V2() throws IoTDBConnectionException, StatementExecutionException {
//        session.open();
//
//        SessionDataSet sd1 = session.executeQueryStatement("select * from "+DEVICE_ID,1000);
//        SessionDataSet sd2 = session.executeQueryStatementV2("select * from "+DEVICE_ID,1000);
//        Assert.assertEquals(sd1.getFetchSize(),sd2.getFetchSize());
//
//        while(sd1.hasNext()&&sd2.hasNext()){
//            RowRecord r1 = sd1.next();
//            RowRecord r2 = sd2.next();
