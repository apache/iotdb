...
public class UDTFViolation implements UDTF {
    ...
    public UDTFViolation() throws Exception {
    }
    ...
    public void terminate(PointCollector collector) throws Exception {
        tsq.computeViolation(usePreSpeed, sMin, sMax);
        collector.putDouble(0, tsq.getViolation());
    }
