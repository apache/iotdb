...
public class ConsecutiveUtil {
  ...
  /**
   * 检查给定的行中是否存在空值 check Null values
   *
  ...
  /** 根据窗口内的数据计算标准间隔 calculate standard timestamp gap in given window. */
  ...
  /** 清空窗口内的数据，并处理其中的行 clear data points in the window */
