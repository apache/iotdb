...
/** This function calculates RMSE between two input series. */
public class UDAFRmse implements UDTF {
  ...
  public void terminate(PointCollector collector) throws Exception {
    if (count > 0) { // calculate RMSE only when there is more than 1 point
      double rmse = Math.sqrt(sum / count);
      collector.putDouble(0, rmse);
    } else {
