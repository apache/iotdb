...
/**
 * calculate the approximate percentile the function has two parameters: $rank$ and $error$
 * (optional) $rank$ is the rank ratio of the percentile, e.g. a percentile with $rank$=0.5 is the
