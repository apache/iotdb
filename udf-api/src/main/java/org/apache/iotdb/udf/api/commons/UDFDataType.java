...
public enum UDFDataType {
   ...
   * @return -enum type
   */
  public static UDFDataType deserialize(byte type) {
    return getUDFDataType(type);
  }
  ...
  public static UDFDataType getUDFDataType(byte type) {
    switch (type) {
      case 0:
        return UDFDataType.BOOLEAN;
      case 1:
        return UDFDataType.INT32;
      case 2:
        return UDFDataType.INT64;
      case 3:
        return UDFDataType.FLOAT;
      case 4:
        return UDFDataType.DOUBLE;
      case 5:
        return UDFDataType.TEXT;
      case 6:
        return UDFDataType.VECTOR;
      default:
        throw new IllegalArgumentException("Invalid input: " + type);
    }
  }

  public static UDFDataType deserializeFrom(ByteBuffer buffer) {
