...
```
./<spark-shell-path>  --jars  tsfile-spark-connector.jar,tsfile-0.11.1-jar-with-dependencies.jar
```
...
```
. /<spark-shell-path>   --jars  tsfile-spark-connector.jar,tsfile-0.11.1-jar-with-dependencies.jar  --master spark://ip:7077
```
