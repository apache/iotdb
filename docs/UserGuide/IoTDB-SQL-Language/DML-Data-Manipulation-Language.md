...
All supported aggregation functions are: count, sum, avg, last_value, first_value, min_time, max_time, min_value, max_value, ext.
When using four aggregations: sum, avg, min_value, max_value and ext please make sure all the aggregated series have exactly the same data type.
