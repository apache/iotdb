...
This chapter provides examples of how to establish a database connection, execute SQL and display the query results.

It requires including the packages containing the JDBC classes needed for database programming.

**NOTE: For faster inserts, executeBatch() is recommended..**
