...
|  MODE         | Find the mode. Note: </br>1.Having too many different values in the input series risks a memory exception; </br>2. If all the elements have the same number of occurrences, that is no Mode, return the value with earliest time; </br>If there are many Modes, return the Mode with earliest time; | All data Types                     | No                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | INT64                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
## COUNT
