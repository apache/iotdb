...
| quantity | name="{{storageGroup}}", type="memtable-flush"                      | core      | The current point number of memtable already flushed in IoTDB | quantity{name="memtable",type="flush"} 1.0    |
