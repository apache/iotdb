...
| region | name="total" | core | The total number of region | region{name="total",} 34.0 |
| region | name="schemaRegion/dataRegion" | important | The number of schemaRegion/dataRegion | region{name="schemaRegion",} 6.0 |
| region | name="{{storageGroupName}}" | normal | The number of region | region{name="root.schema.sg1",} 17.0 |
