...
|READ_STORAGE_GROUP|show storage groups; path dependent|Eg: `show storage group;`|
...
|READ\_TIMESERIES|query data; path dependent| Eg1: `show child paths root.ln, show child nodes root.ln;`<br />Eg2: `show devices;`<br />Eg3: `show timeseries root.**;`<br />Eg4: `show schema templates;`<br />Eg5: `show all ttl`<br />Eg6: [Query-Data](../Query-Data/Overview.md)（The query statements under this section all use this permission）<br />Eg7: CVS format data export<br />`./export-csv.bat -h 127.0.0.1 -p 6667 -u tempuser -pw root -td ./`<br />Eg8: Performance Tracing Tool<br />`tracing select * from root`<br />Eg9: UDF-Query<br />`select example(*) from root.sg.d1`<br />Eg10: Triggers-Query<br />`show triggers` |
