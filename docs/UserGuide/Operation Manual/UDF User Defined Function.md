...
3. Place the JAR package in the directory `iotdb-server-0.12.0-SNAPSHOT/lib` or in a subdirectory of `iotdb-server-0.12.0-SNAPSHOT/lib`.
...
2. Delete `example.jar` under `iotdb-server-0.12.0-SNAPSHOT/lib`.
...
4. Upload the new JAR package to `iotdb-server-0.12.0-SNAPSHOT/lib`.
