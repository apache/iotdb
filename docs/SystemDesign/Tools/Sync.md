...
* Because the receiver needs to receive files from multiple sender at the same time, it is necessary to distinguish files from different sender and manage these files in a unified manner.
