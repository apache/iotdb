...
| Metric                | Tags                        | Type  | Description            |
| --------------------- | --------------------------- | ----- | ---------------------- |
| ratis_consensus_write | stage="checkWriteCondition" | Timer | 检查写入条件阶段的时间 |
| ratis_consensus_write | stage="totalConsensusWrite" | Timer | 总写入时间             |
...
| ratis_consensus_read  | stage="checkReadCondition"  | Timer | 检查读取条件阶段的时间 |
| ratis_consensus_read  | stage="submitReadRequest"   | Timer | 提交读取请求阶段的时间 |
| ratis_consensus_read  | stage="totalConsensusRead"  | Timer | 总读取时间             |
