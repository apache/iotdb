...
```   sql
select top_k(s1, "k"="2"), bottom_k(s1, "k"="2") from root.sg1.d2;
```

结果：

``` 
IoTDB> select top_k(s1, "k"="2"), bottom_k(s1, "k"="2") from root.sg1.d2;
select top_k(s1, "k"="2"), bottom_k(s1, "k"="2") from root.sg1.d2;
+-----------------------------+------------------------------+---------------------------------+
|                         Time|top_k(root.sg1.d2.s1, "k"="2")|bottom_k(root.sg1.d2.s1, "k"="2")|
+-----------------------------+------------------------------+---------------------------------+
|2020-12-10T17:13:11.077+08:00|           9201214097692006503|                             null|
|2020-12-10T17:13:29.090+08:00|                          null|             -9196654591176698800|
|2020-12-10T17:13:29.146+08:00|           9166094207389021695|                             null|
|2020-12-10T20:35:08.345+08:00|                          null|             -9201554342060357274|
+-----------------------------+------------------------------+---------------------------------+
Total line number = 4
It costs 0.008s
```
