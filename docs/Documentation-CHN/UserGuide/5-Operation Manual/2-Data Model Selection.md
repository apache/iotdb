...
在向IoTDB导入数据之前，首先要根据样例数据选择合适的数据存储模型，然后使用[SET STORAGE GROUP](/#/Documents/progress/chap5/sec4)语句和[CREATE TIMESERIES](/#/Documents/progress/chap5/sec4)语句设置存储组，并创建时间序列。
