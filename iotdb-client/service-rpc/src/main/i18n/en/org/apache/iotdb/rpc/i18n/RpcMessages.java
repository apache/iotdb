...
public final class RpcMessages {
  ...
  public static final String FRAME_ERROR_NEGATIVE_FRAME_SIZE = "Read a negative frame size (%d)%s!";
  ...
  public static final String COULD_NOT_LOAD_KEYSTORE = "Could not load keystore or truststore file";
  ...
  public static final String COLUMN_INDEX_SHOULD_START_FROM_1 = "column index should start from 1";
  public static final String COLUMN_INDEX_OUT_OF_RANGE = "column index %d out of range %d";
  ...
  public static final String FAILED_TO_SERIALIZE_PARAMETERS = "Failed to serialize parameters";
  ...
  public static final String EXCEPTION_LATER_REQUEST_SAME_GROUP_WILL_REDIRECTED_0A61CB0B =
      "later request in same group will be redirected to ";
  public static final String
