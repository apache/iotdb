...
public enum TSStatusCode {
  ...
  SHOW_TOPIC_ERROR(2002),
  ALTER_TOPIC_ERROR(2003),
  CREATE_TOPIC_ON_DATANODE_ERROR(2004),
  DROP_TOPIC_ON_DATANODE_ERROR(2005),
  SHOW_TOPIC_ON_DATANODE_ERROR(2006),
  ALTER_TOPIC_ON_DATANODE_ERROR(2007),
  TOPIC_PUSH_META_ERROR(2008),

  // Consumer
  CREATE_CONSUMER_ERROR(2100),
  CREATE_CONSUMER_ON_DATANODE_ERROR(2101),
  DROP_CONSUMER_ERROR(2102),
  DROP_CONSUMER_ON_DATANODE_ERROR(2103),
  CONSUMER_PUSH_META_ERROR(2104),
  ;
