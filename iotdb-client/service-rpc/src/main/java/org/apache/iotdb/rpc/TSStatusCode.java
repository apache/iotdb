...
public enum TSStatusCode {
  ...
  // Topic
  CREATE_TOPIC_ERROR(1900),
  DROP_TOPIC_ERROR(1901),
  SHOW_TOPIC_ERROR(1902),
  ALTER_TOPIC_ERROR(1903),
  CREATE_TOPIC_ON_DATANODE_ERROR(1904),
  DROP_TOPIC_ON_DATANODE_ERROR(1905),
  SHOW_TOPIC_ON_DATANODE_ERROR(1906),
  ALTER_TOPIC_ON_DATANODE_ERROR(1907),
  ;
