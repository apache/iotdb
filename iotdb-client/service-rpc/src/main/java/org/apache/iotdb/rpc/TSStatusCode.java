...
public enum TSStatusCode {
  ...
  // Service
  SERVICE_CREATE_SERVICE_ERROR(2300),
  SERVICE_DROP_SERVICE_ERROR(2301),
  SERVICE_CREATE_SERVICE_ON_DATANODE_ERROR(2302),
  SERVICE_DROP_SERVICE_ON_DATANODE_ERROR(2303),
  SERVICE_NOT_EXIST_ERROR(2304),
  SERVICE_STOP_SERVICE_ERROR_ON_DATANODE_ERROR(2305),
  SERVICE_START_SERVICE_ERROR_ON_DATANODE_ERROR(2306),
  SERVICE_DOWNLOAD_ERROR(2307),
  SERVICE_LOAD_CLASS_ERROR(2308),
  ;
