...
public enum TSStatusCode {
  ...
  PIPE_CONSENSUS_UNSUPPORTED_EVENT(2203),
  PIPE_CONSENSUS_TRANSFER_FILE_OFFSET_RESET(2204),
  PIPE_CONSENSUS_TRANSFER_FILE_ERROR(2205),
  PIPE_CONSENSUS_TYPE_ERROR(2206),
  ;
