...
public enum TSStatusCode {
  ...
  DATABASE_MODEL(530),
  TEMPLATE_TIMESERIES_CANNOT_CREATE_ALIAS(531),
  VIEW_TIMESERIES_CANNOT_CREATE_ALIAS(532),
  INVALID_TIMESERIES_CANNOT_CREATE_ALIAS(533),
  TIMESERIES_ALREADY_RENAMING(534),
  ...
  SESSION_NUMS_EXCEEDED(821),
  USER_LOGIN_LOCKED(822),
  ...
  // Consensus Exception
  IOT_CONSENSUS_V2_CONNECTOR_RESTART_ERROR(2200),
  IOT_CONSENSUS_V2_VERSION_ERROR(2201),
  IOT_CONSENSUS_V2_DEPRECATED_REQUEST(2202),
  IOT_CONSENSUS_V2_TRANSFER_FILE_OFFSET_RESET(2203),
  IOT_CONSENSUS_V2_TRANSFER_FILE_ERROR(2204),
  IOT_CONSENSUS_V2_TYPE_ERROR(2205),
  CONSENSUS_GROUP_NOT_EXIST(2206),
  RATIS_READ_UNAVAILABLE(2207),
  IOT_CONSENSUS_V2_CLOSE_ERROR(2208),
  IOT_CONSENSUS_V2_WAIT_ORDER_TIMEOUT(2209),
