...
public class IoTDBWebSocketClient extends WebSocketClient {
  ...
  private final IoTDBPollConsumer consumer;
  private transient Status status = Status.WAITING;

  public IoTDBWebSocketClient(URI uri, IoTDBPollConsumer consumer) {
    super(uri);
  ...
  public void onMessage(ByteBuffer bytes) {
    ...
    consumer.addTablet(new TabletWrapper(commitId, this, tablet));
  }
