...
public class RleColumnEncoder implements ColumnEncoder {
  ...
  public void encode(Binary[] values, ByteArrayOutputStream out) {
    throw new UnSupportedDataTypeException("RLE doesn't support data type: " + dataType);
  }

  private void setColumnEntry(Integer compressedSize, Integer unCompressedSize) {
    columnEntry = new ColumnEntry(compressedSize, unCompressedSize, dataType, TSEncoding.RLE);
  }
