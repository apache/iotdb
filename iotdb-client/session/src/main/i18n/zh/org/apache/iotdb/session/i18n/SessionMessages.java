...
public final class SessionMessages {
  ...
  public static final String ALL_VALUES_NULL = "{} 的所有值均为 null，null 值为 {}";
  public static final String SOME_VALUES_NULL = "{} 的部分值为 null，null 值为 {}";
  ...
  public static final String SESSION_NOT_OPEN = "Session 尚未打开，请先调用 Session.open()";
  public static final String ALL_INSERT_DATA_IS_NULL = "所有写入数据均为 null。";

  // SessionConnection
  public static final String CLUSTER_NO_NODES = "集群中没有可连接的节点";
  public static final String CLOSE_SESSION_ERROR = "关闭服务端 Session 时发生错误，服务器可能已宕机。";
  public static final String REDIRECT_QUERY_ERROR = "需要重定向查询，不应看到此错误。";
  public static final String RETRY_RECONNECTING = "第 {} 次重试，正在重连其他 DataNode";
  public static final String NODE_DOWN_TRY_NEXT = "当前节点 {} 可能已宕机，尝试下一个节点";
  ...
  // ThriftConnection
  public static final String CLOSING_SESSION_FAILED = "关闭 Session-{} 与 {} 的连接失败。";

  // NodesSupplier
  public static final String FAILED_TO_CREATE_CONNECTION = "创建与 {} 的连接失败。";
  public static final String FAILED_TO_FETCH_DATA_NODE_LIST = "从 {} 获取 DataNode 列表失败。";

  // SessionUtils
  public static final String NODE_URLS_IS_NULL = "nodeUrls 为 null";
  public static final String EXCEPTION_NODEURL_INCORRECT_FORMAT_C1463B2C = "NodeUrl 格式不正确";
  ...
  public static final String TIMEOUT_TO_GET_CONNECTION = "从 %s 获取连接超时";
  ...
  public static final String INSERT_RECORDS_OF_ONE_DEVICE_FAILED = "insertRecordsOfOneDevice 失败";
  ...
  public static final String EXECUTE_NON_QUERY_STATEMENT_FAILED = "executeNonQueryStatement 失败";
  ...
  public static final String IS_MEASUREMENT_IN_TEMPLATE_FAILED = "isMeasurementInTemplate 失败";
  public static final String IS_PATH_EXIST_IN_TEMPLATE_FAILED = "isPathExistInTemplata 失败";
  public static final String SHOW_MEASUREMENTS_IN_TEMPLATE_FAILED = "showMeasurementsInTemplate 失败";
  public static final String SHOW_ALL_TEMPLATES_FAILED = "showAllTemplates 失败";
  public static final String SHOW_PATHS_TEMPLATE_SET_ON_FAILED = "showPathsTemplateSetOn 失败";
  public static final String SHOW_PATHS_TEMPLATE_USING_ON_FAILED = "showPathsTemplateUsingOn 失败";
  public static final String SET_SCHEMA_TEMPLATE_ON_FAILED = "setSchemaTemplate [{}] 在 [{}] 上失败";
  public static final String UNSET_SCHEMA_TEMPLATE_ON_FAILED =
      "unsetSchemaTemplate [{}] 在 [{}] 上失败";
  public static final String DROP_SCHEMA_TEMPLATE_FAILED = "dropSchemaTemplate [{}] 失败";
  ...
  public static final String UNEXPECTED_ERROR_IN_INSERT_TABLET = "insertTablet 发生意外错误";
  public static final String UNEXPECTED_ERROR_IN_INSERT_ALIGNED_TABLET =
      "insertAlignedTablet 发生意外错误";
  public static final String UNEXPECTED_ERROR_IN_INSERT_TABLETS = "insertTablets 发生意外错误";
  public static final String UNEXPECTED_ERROR_IN_INSERT_ALIGNED_TABLETS =
      "insertAlignedTablets 发生意外错误";
  public static final String UNEXPECTED_ERROR_IN_INSERT_RECORDS = "insertRecords 发生意外错误";
  public static final String UNEXPECTED_ERROR_IN_INSERT_ALIGNED_RECORDS =
      "insertAlignedRecords 发生意外错误";
  public static final String UNEXPECTED_ERROR_IN_INSERT_RECORD = "insertRecord 发生意外错误";
  ...
  public static final String UNEXPECTED_ERROR_IN_DELETE_DATA = "deleteData 发生意外错误";
  public static final String UNEXPECTED_ERROR_IN_DELETE_TIMESERIES = "deleteTimeseries 发生意外错误";
  public static final String UNEXPECTED_ERROR_IN_SET_STORAGE_GROUP = "setStorageGroup 发生意外错误";
  public static final String UNEXPECTED_ERROR_IN_DELETE_STORAGE_GROUP = "deleteStorageGroup 发生意外错误";
  public static final String UNEXPECTED_ERROR_IN_DELETE_STORAGE_GROUPS =
      "deleteStorageGroups 发生意外错误";
  public static final String UNEXPECTED_ERROR_IN_CREATE_DATABASE = "createDatabase 发生意外错误";
  public static final String UNEXPECTED_ERROR_IN_DELETE_DATABASE = "deleteDatabase 发生意外错误";
  public static final String UNEXPECTED_ERROR_IN_DELETE_DATABASES = "deleteDatabases 发生意外错误";
  public static final String UNEXPECTED_ERROR_IN_CREATE_TIMESERIES = "createTimeseries 发生意外错误";
  ...
  public static final String UNEXPECTED_ERROR_IN_TEST_INSERT_TABLET = "testInsertTablet 发生意外错误";
  public static final String UNEXPECTED_ERROR_IN_TEST_INSERT_TABLETS = "testInsertTablets 发生意外错误";
  public static final String UNEXPECTED_ERROR_IN_TEST_INSERT_RECORD = "testInsertRecord 发生意外错误";
  public static final String UNEXPECTED_ERROR_IN_TEST_INSERT_RECORDS = "testInsertRecords 发生意外错误";
  ...
  public static final String UNEXPECTED_ERROR_IN_SHOW_ALL_TEMPLATES = "showAllTemplates 发生意外错误";
  ...
  public static final String UNEXPECTED_ERROR_IN_SET_SCHEMA_TEMPLATE = "setSchemaTemplate 发生意外错误";
  public static final String UNEXPECTED_ERROR_IN_UNSET_SCHEMA_TEMPLATE =
      "unsetSchemaTemplate 发生意外错误";
  public static final String UNEXPECTED_ERROR_IN_DROP_SCHEMA_TEMPLATE = "dropSchemaTemplate 发生意外错误";
  ...
  public static final String
      LOG_FAILED_CHANGE_BACK_SQL_DIALECT_EXECUTING_SET_SQL_DIALECT_ARG_947F35E7 =
          "执行 set sql_dialect={} 时无法切回 sql_dialect";
