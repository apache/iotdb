...
def test_insert_relational_tablet():
        ...
        column_types = [
                ColumnType.ID, ColumnType.ID, ColumnType.ID,
                ColumnType.ATTRIBUTE, ColumnType.ATTRIBUTE, ColumnType.ATTRIBUTE,
                ColumnType.MEASUREMENT, ColumnType.MEASUREMENT, ColumnType.MEASUREMENT, ColumnType.MEASUREMENT, ColumnType.MEASUREMENT, ColumnType.MEASUREMENT, ColumnType.MEASUREMENT, ColumnType.MEASUREMENT, ColumnType.MEASUREMENT, ColumnType.MEASUREMENT
        ]
        timestamps = []
        values = []
...
def test_insert_relational_numpy_tablet():
        ...
        np_values = [
                np.array(["id1:{}".format(i) for i in range(0, 10)]),np.array(["id2:{}".format(i) for i in range(0, 10)]),np.array(["id3:{}".format(i) for i in range(0, 10)]),
                np.array(["attr1:{}".format(i) for i in range(0, 10)]),np.array(["attr2:{}".format(i) for i in range(0, 10)]),np.array(["attr3:{}".format(i) for i in range(0, 10)]),
