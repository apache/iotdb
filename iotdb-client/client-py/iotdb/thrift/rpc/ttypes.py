...
class ServerProperties(object):
    ...
    def __init__(self, version=None, supportedTimeAggregationOperations=None, timestampPrecision=None, maxConcurrentClientNum=None, watermarkSecretKey=None, watermarkBitString=None, watermarkParamMarkRate=None, watermarkParamMaxRightBit=None, thriftMaxFrameSize=None, isReadOnly=None, buildInfo=None, logo=None,):
    ...
    def write(self, oprot):
        ...
        if self.logo is not None:
            oprot.writeFieldBegin('logo', TType.STRING, 12)
...
ServerProperties.thrift_spec = (
    ...
    (12, TType.STRING, 'logo', 'UTF8', None, ),  # 12
)
