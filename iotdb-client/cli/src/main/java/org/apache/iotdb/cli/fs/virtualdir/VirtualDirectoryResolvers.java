...
public final class VirtualDirectoryResolvers {
  ...
  public static List<VirtualDirectoryResolver> forTree(
    ...
    resolvers.add(new ByDatabaseVirtualDirectoryResolver(executor, delegate, true));
    resolvers.add(new TreeByMeasurementVirtualDirectoryResolver(executor, delegate));
    resolvers.add(new TreeByTagVirtualDirectoryResolver(executor, delegate));
    resolvers.add(new TreeByAttributeVirtualDirectoryResolver(executor, delegate));
    return resolvers;
  }
  ...
  public static List<VirtualDirectoryResolver> forTable(
      SqlExecutor executor, FilesystemSchemaProvider delegate) {
    List<VirtualDirectoryResolver> resolvers = new ArrayList<>();
    resolvers.add(new ByDatabaseVirtualDirectoryResolver(executor, delegate, false));
    resolvers.add(new TableByTableVirtualDirectoryResolver(executor, delegate));
    return resolvers;
  }
}
