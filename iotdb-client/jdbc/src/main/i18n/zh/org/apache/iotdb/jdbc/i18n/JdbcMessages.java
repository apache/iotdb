...
public final class JdbcMessages {
  ...
  // IoTDBDriver
  public static final String REGISTER_DRIVER_ERROR = "注册 TsFile 驱动时发生错误";
  ...
  public static final String MIN_BIT_BIGGER_THAN_MAX = "错误：minBitPosition 大于 maxBitPosition";
  ...
  public static final String QUERY_RESULT_SHOULD_NOT_BE_NULL = "execResp.queryResult 不应为 null。";
  ...
  public static final String NOT_SUPPORT_GET_RESULT_SET_CONCURRENCY = "不支持 getResultSetConcurrency";
  public static final String NOT_SUPPORT_GET_RESULT_SET_HOLDABILITY = "不支持 getResultSetHoldability";
  public static final String NOT_SUPPORT_IS_CLOSE_ON_COMPLETION = "不支持 isCloseOnCompletion";
  ...
  public static final String NOT_SUPPORT_SET_ESCAPE_PROCESSING = "不支持 setEscapeProcessing";
  public static final String CANNOT_AFTER_CONNECTION_CLOSED = "连接已关闭后无法执行 %s！";
  ...
  public static final String FAILED_TO_EXECUTE_PREPARED_STATEMENT = "执行预编译语句失败：";
  public static final String FAILED_TO_DEALLOCATE_PREPARED_STATEMENT = "释放预编译语句失败：{}";
  public static final String ERROR_DEALLOCATING_PREPARED_STATEMENT = "释放预编译语句时出错";
  ...
  public static final String GET_MAX_CONCURRENT_CLIENT_ERROR = "获取最大并发客户端数错误：{}";
  public static final String GET_MAX_STATEMENT_LENGTH_ERROR = "获取最大语句长度错误：{}";
  public static final String GET_PROCEDURES_ERROR = "获取存储过程错误：{}";
  public static final String GET_PROCEDURE_COLUMNS_ERROR = "获取存储过程列错误：{}";
  public static final String GET_BEST_ROW_IDENTIFIER_ERROR = "获取最佳行标识符错误：{}";
  ...
  public static final String GET_DB_MAJOR_VERSION_ERROR = "获取数据库主版本号错误：{}";
  public static final String GET_DB_MINOR_VERSION_ERROR = "获取数据库次版本号错误：{}";

  // IoTDBDatabaseMetadata
  public static final String INIT_SQL_KEYWORDS_ERROR = "初始化 SQL 关键字时出错：";
  public static final String GET_TABLES_SQL = "获取表：SQL：{}";
  public static final String GET_PRIMARY_KEYS_ERROR = "获取主键错误：{}";
  public static final String FAILED_TO_FETCH_METADATA_JSON = "获取 JSON 格式的元数据失败：";

  // IoTDBRelationalDatabaseMetadata
  public static final String RELATIONAL_INIT_SQL_KEYWORDS_ERROR = "初始化 SQL 关键字时出错：";
  public static final String RELATIONAL_GET_PRIMARY_KEYS_ERROR = "获取主键错误：{}";
  ...
  // IoTDBJDBCResultSet
  public static final String CLOSE_SERVER_SIDE_ERROR = "服务端关闭操作时发生错误 ";
  public static final String CLOSE_CONNECTING_ERROR = "连接服务器进行关闭操作时发生错误 ";
  ...
  public static final String CANNOT_CREATE_STATEMENT_CLOSED = "连接已关闭，无法创建语句";
  ...
  public static final String NOT_SUPPORT_SET_TRANSACTION_ISOLATION = "不支持 setTransactionIsolation";
  ...
  public static final String NOT_SUPPORT_RELEASE_SAVEPOINT = "不支持 releaseSavepoint";
  public static final String SET_TIMEZONE_ERROR = "设置时区错误：";
  public static final String NOT_SUPPORT_CLIENT_INFO_TYPE = "不支持此类型的客户端信息：";
  public static final String NOT_SUPPORT_SET_NETWORK_TIMEOUT = "不支持 setNetworkTimeout";
  public static final String QUERY_TIMEOUT_MUST_BE_NON_NEGATIVE = "queryTimeout %d 必须 >= 0！";
  ...
  public static final String LOG_SET_TIME_ERROR_IOTDB_PREPARED_STATEMENT_ARG_AAAACB25 =
      "IoTDB prepared statement 设置时间出错：%s ";
  public static final String
      EXCEPTION_CAN_T_INFER_SQL_TYPE_USE_INSTANCE_ARG_USE_SETOBJECT_A5B1C1BD =
          "无法推断 %s 实例要使用的 SQL 类型。请使用 setObject() 并";
  public static final String EXCEPTION_EXPLICIT_TYPES_VALUE_SPECIFY_TYPE_USE_CD046EDA =
      "显式指定 Types 值来确定要使用的类型。";
  ...
  public static final String LOG_GETTING_ALL_TIMESERIES_INFO_PLEASE_CHECK_SERVER_STATUS_009B5EFE =
      "获取所有时间序列信息时。请检查服务器状态";
  public static final String EXCEPTION_FAILED_FETCH_ALL_METADATA_JSON_5FB95E70 =
      "无法获取 JSON 格式的所有元数据 ";
  public static final String EXCEPTION_AFTER_RECONNECTING_PLEASE_CHECK_SERVER_STATUS_DE1D65AC =
      "重新连接后。请检查服务器状态。";
  public static final String EXCEPTION_FAILED_RECONNECT_SERVER_632A4B76 = "无法重新连接到服务器 ";
  public static final String
      EXCEPTION_FETCHING_ALL_METADATA_JSON_PLEASE_CHECK_SERVER_STATUS_1A0813B2 =
          "获取 JSON 格式的所有元数据时。请检查服务器状态。";
  public static final String
      LOG_PROTOCOL_DIFFER_CLIENT_VERSION_ARG_BUT_SERVER_VERSION_ARG_F0AA3D03 =
          "协议不同，客户端版本为 {}，服务器版本为 {}";
  public static final String LOG_ARG_ARG_PLEASE_CHANGE_IT_TIME_VIA_ALTER_USER_STATEMENT_6B67087C =
      "{}{}，请及时通过 'ALTER USER' 语句修改";
  public static final String
      EXCEPTION_ERROR_OCCURS_CLOSING_SESSION_AT_SERVER_MAYBE_SERVER_DOWN_2BCE63C0 =
          "在服务器端关闭会话时发生错误。服务器可能已宕机。";
  public static final String
      EXCEPTION_STATEMENTS_RESULT_SET_CONCURRENCY_ARG_NOT_SUPPORTED_C6043E9A =
          "不支持结果集并发级别为 %d 的 Statement";
  public static final String EXCEPTION_STATEMENTS_RESULTSET_TYPE_ARG_NOT_SUPPORTED_8BE22644 =
  ...
  public static final String
      EXCEPTION_CAN_NOT_ESTABLISH_CONNECTION_ARG_YOU_MAY_TRY_CONNECT_OLD_8FC3703E =
          "无法与 %s 建立连接：可能正在使用新版本客户端连接旧版本 IoTDB 实例：" + "%s。";
  public static final String EXCEPTION_CAN_NOT_ESTABLISH_CONNECTION_ARG_ARG_D7246055 =
      "无法与 %s 建立连接：%s。";
}
