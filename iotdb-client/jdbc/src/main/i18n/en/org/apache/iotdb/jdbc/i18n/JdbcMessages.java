...
public final class JdbcMessages {
  ...
  // IoTDBDriver
  public static final String REGISTER_DRIVER_ERROR = "Error occurs when registering TsFile driver";
  ...
  public static final String NOT_SUPPORT_IS_CLOSE_ON_COMPLETION = "Not support isCloseOnCompletion";
  ...
  public static final String NOT_SUPPORT_SET_ESCAPE_PROCESSING = "Not support setEscapeProcessing";
  ...
  public static final String GET_MAX_STATEMENT_LENGTH_ERROR = "Get max statement length error: {}";
  ...
  public static final String GET_BEST_ROW_IDENTIFIER_ERROR = "Get best row identifier error: {}";
  ...
  public static final String GET_DB_MAJOR_VERSION_ERROR = "Get database major version error: {}";
  public static final String GET_DB_MINOR_VERSION_ERROR = "Get database minor version error: {}";

  // IoTDBDatabaseMetadata
  public static final String INIT_SQL_KEYWORDS_ERROR = "Error when initializing SQL keywords: ";
  ...
  public static final String RELATIONAL_GET_PRIMARY_KEYS_ERROR = "Get primary keys error: {}";
  ...
  public static final String NOT_SUPPORT_RELEASE_SAVEPOINT = "Does not support releaseSavepoint";
  ...
  public static final String NOT_SUPPORT_SET_NETWORK_TIMEOUT = "Does not support setNetworkTimeout";
  public static final String QUERY_TIMEOUT_MUST_BE_NON_NEGATIVE = "queryTimeout %d must be >= 0!";
  ...
  public static final String EXCEPTION_PLEASE_CHECK_SERVER_STATUS_DA9E1E33 =
  ...
  public static final String EXCEPTION_PARAMETER_INDEX_OUT_RANGE_3DD066E0 =
  ...
  public static final String LOG_SET_TIME_ERROR_IOTDB_PREPARED_STATEMENT_ARG_AAAACB25 =
      "set time error when iotdb prepared statement :%s ";
  public static final String
  ...
  public static final String EXCEPTION_TYPES_BOOLEAN_POSSIBLE_54D316E6 =
  ...
  public static final String LOG_PLEASE_CHECK_SERVER_STATUS_2049BB22 =
      " please check server status";
  ...
  public static final String EXCEPTION_FAILED_RECONNECT_SERVER_632A4B76 =
  ...
  public static final String EXCEPTION_STATEMENTS_RESULTSET_TYPE_ARG_NOT_SUPPORTED_8BE22644 =
      "Statements with ResultSet type %d are not supported";
  public static final String
