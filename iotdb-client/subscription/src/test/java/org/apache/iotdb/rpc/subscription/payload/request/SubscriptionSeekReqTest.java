...
public class SubscriptionSeekReqTest {
  ...
  public void testTopicProgressSeekRoundTrip() throws IOException {
    ...
    final SubscriptionSeekReq req =
        SubscriptionSeekReq.toSeekAfterTopicProgressReq("topicA", original);
    final SubscriptionSeekReq parsed = SubscriptionSeekReq.fromThriftReq(req);

    assertEquals(SubscriptionSeekReq.SEEK_AFTER_TOPIC_PROGRESS, parsed.getSeekType());
