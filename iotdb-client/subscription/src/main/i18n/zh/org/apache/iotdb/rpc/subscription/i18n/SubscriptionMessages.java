...
public final class SubscriptionMessages {
  ...
  public static final String UNEXPECTED_REQUEST_TYPE = "意外的请求类型：{}，payload 将为 null";

  // --- SubscriptionPollResponse ---
  public static final String UNEXPECTED_RESPONSE_TYPE = "意外的响应类型：{}，payload 将为 null";
  ...
  public static final String CONSUMER_LISTENER_FAILURE = "消费消息时消费者监听器结果失败：{}";
  ...
  public static final String EXECUTOR_NOT_LAUNCHED_SUBMIT = "{} 尚未启动，忽略提交任务";
  public static final String EXECUTOR_NOT_LAUNCHED_INVOKE = "{} 尚未启动，忽略批量调用任务";
  public static final String EXECUTOR_NOT_LAUNCHED_ZERO = "{} 尚未启动，返回零";
  public static final String EXECUTOR_NOT_LAUNCHED_SCHEDULE =
      "{} 尚未启动，忽略 scheduleWithFixedDelay 任务";

  // --- AbstractSubscriptionProviders ---
  public static final String PROVIDER_CLOSE_FAILED = "关闭订阅提供者 {} 失败，原因：{}";
  public static final String ADD_NEW_PROVIDER = "添加新的订阅提供者 {}";
  public static final String CLOSE_STALE_PROVIDER = "关闭并移除过期的订阅提供者 {}";
  public static final String OPEN_PROVIDERS_FAILED = "为消费者 {} 打开提供者失败，原因：{}";
  public static final String FETCH_ENDPOINTS_FAILED = "为消费者 {} 获取所有端点失败，原因：{}";
  ...
  public static final String AUTO_COMMIT_UNEXPECTED = "自动提交消息时发生意外情况...";
  public static final String COMMIT_DURING_CLOSE_UNEXPECTED = "关闭期间提交消息时发生意外情况";

  // --- AbstractSubscriptionConsumer ---
  public static final String UNEXPECTED_RESPONSE_TYPE_WARN = "意外的响应类型：{}";
  public static final String CONSUMER_CANCEL_HEARTBEAT_WORKER = "SubscriptionConsumer {} 取消心跳工作线程";
  public static final String CONSUMER_SUBMIT_HEARTBEAT_WORKER = "SubscriptionConsumer {} 提交心跳工作线程";
  public static final String CONSUMER_CANCEL_ENDPOINTS_SYNCER = "SubscriptionConsumer {} 取消端点同步器";
  public static final String CONSUMER_SUBMIT_ENDPOINTS_SYNCER = "SubscriptionConsumer {} 提交端点同步器";
  ...
  public static final String
      EXCEPTION_UNEXPECTED_FIELDS_ARG_WAS_OBTAINED_DURING_SHOW_TOPIC_30B5D702 =
          "执行 SHOW TOPIC 时获取到意外字段 %s...";
  public static final String
      EXCEPTION_UNEXPECTED_FIELDS_ARG_WAS_OBTAINED_DURING_SHOW_SUBSCRIPTION_71F9C549 =
          "执行 SHOW SUBSCRIPTION 时获取到意外字段 %s...";
  public static final String EXCEPTION_SUBSCRIPTION_SESSION_MUST_CONFIGURED_ENDPOINT_2CAD53A9 =
      "订阅会话必须配置 endpoint。";
  public static final String
  ...
  public static final String
      EXCEPTION_WATERMARK_TIMESTAMP_ONLY_AVAILABLE_WATERMARK_MESSAGES_ACTUAL_MESSAGE_TYPE_F8E32C57 =
          "Watermark 时间戳仅适用于 watermark 消息，实际消息类型：";
  public static final String EXCEPTION_ARG_DO_NOT_SUPPORT_GETRESULTSETS_7789852D =
      "%s 不支持 getResultSets().";
  public static final String EXCEPTION_ARG_DO_NOT_SUPPORT_GETRECORDTABLETITERATOR_46B4A489 =
      "%s 不支持 getRecordTabletIterator().";
  public static final String EXCEPTION_ARG_DO_NOT_SUPPORT_GETTSFILE_40D23462 =
      "%s 不支持 getTsFile().";
  ...
  public static final String
      EXCEPTION_ARG_DOES_NOT_SUPPORT_OPENTREEREADER_TABLE_MODEL_TSFILE_68621ECF =
          "%s 不支持对表模型 TsFile 调用 openTreeReader()。";
  public static final String
  ...
  public static final String
      LOG_SUBSCRIPTIONPUSHCONSUMER_ARG_POLL_EMPTY_MESSAGE_TOPICS_ARG_AFTER_ARG_MILLISECOND_741801C2 =
          "SubscriptionPushConsumer {} 从主题 {} poll 到空消息，耗时 {} 毫秒";
  public static final String LOG_CONSUMER_LISTENER_RAISED_EXCEPTION_CONSUMING_MESSAGE_ARG_867EE46D =
      "消费者 listener 消费消息时抛出异常：{}";
  public static final String LOG_ARG_FAILED_CREATE_CONNECTION_ARG_BECAUSE_ARG_E536E22A =
      "{} 无法与 {} 创建连接，原因：{}";
  public static final String LOG_ARG_FAILED_FETCH_ALL_ENDPOINTS_ARG_BECAUSE_ARG_2C9E11D4 =
      "{} 无法从 {} 获取所有 endpoint，原因：{}";
  public static final String
      LOG_TERMINATION_OCCURRED_SUBSCRIPTIONCONSUMER_ARG_POLLING_TOPICS_UNSUBSCRIBE_TOPIC_ARG_AUTOMATICALLY_E9B695FA =
          "订阅消费者 {} poll 主题时发生终止，自动取消订阅主题 {}";
  public static final String
  ...
  public static final String LOG_ARG_HAS_BEEN_LAUNCHED_SET_CORE_POOL_SIZE_ARG_WILL_0FDECBE3 =
      "{} 已启动，将 core pool size 设置为 {} 的操作会被忽略";
  public static final String
  ...
  public static final String
      LOG_SUBSCRIPTIONRUNTIMENONCRITICALEXCEPTION_OCCURRED_SUBSCRIPTIONCONSUMER_ARG_POLLING_TOPICS_ARG_61838153 =
          "SubscriptionConsumer {} poll 主题 {} 时发生 SubscriptionRuntimeNonCriticalException";
  public static final String LOG_ARG_START_POLL_FILE_ARG_COMMIT_CONTEXT_ARG_AT_OFFSET_0F677E12 =
      "{} 开始 poll 文件 {}，commit context {}，offset {}";
  public static final String
      LOG_SUBSCRIPTIONCONSUMER_ARG_SUCCESSFULLY_POLL_FILE_ARG_COMMIT_CONTEXT_ARG_A23E0FDB =
          "订阅消费者 {} 成功 poll 文件 {}，commit context {}";
  public static final String
      LOG_ERROR_OCCURRED_SUBSCRIPTIONCONSUMER_ARG_POLLING_FILE_ARG_COMMIT_CONTEXT_ARG_03619D67 =
          "订阅消费者 {} poll 文件 {} 时发生错误，commit context {}：{}，critical：{}";
  public static final String
      LOG_ERROR_OCCURRED_SUBSCRIPTIONCONSUMER_ARG_POLLING_TABLETS_COMMIT_CONTEXT_ARG_ARG_FF40B4E1 =
          "订阅消费者 {} poll tablets 时发生错误，commit context {}：{}，critical：{}";
  public static final String LOG_ARG_FAILED_COMMIT_CONTEXTS_ARG_CF224D1E =
      "{} commit contexts 失败：{}";
  public static final String
      LOG_ARG_STAGED_ARG_CONSENSUS_ACK_S_REDIRECT_AFTER_PROVIDER_ARG_0F0C0623 =
          "{} 已暂存 {} 个 consensus ack，用于 provider {} 不可用后的重定向";
  public static final String LOG_ARG_KEEP_ARG_NON_CONSENSUS_ACK_S_PENDING_AFTER_PROVIDER_32F56904 =
      "{} 保留 {} 个 non-consensus ack 待处理，因为 provider {} commit 失败";
  public static final String
      LOG_ARG_FAILED_SUBSCRIBE_TOPICS_ARG_SUBSCRIPTION_PROVIDER_ARG_TRY_NEXT_4DF9FC46 =
          "{} 无法订阅主题 {}，SubscriptionProvider {} 失败，尝试下一个 SubscriptionProvider...";
  public static final String
      LOG_ARG_FAILED_UNSUBSCRIBE_TOPICS_ARG_SUBSCRIPTION_PROVIDER_ARG_TRY_NEXT_2205E8A8 =
          "{} 无法取消订阅主题 {}，SubscriptionProvider {} 失败，尝试下一个 SubscriptionProvider...";
  public static final String
  ...
  public static final String LOG_ARG_FAILED_REDIRECT_ARG_PENDING_CONSENSUS_ACK_S_ARG_VIA_E6A10AC5 =
      "{} 无法重定向 {} 个待处理 consensus ack，目标 {}，provider {}";
  public static final String
      LOG_ARG_FAILED_FETCH_ALL_ENDPOINTS_SUBSCRIPTION_PROVIDER_ARG_TRY_NEXT_25651CAD =
          "{} 无法从 SubscriptionProvider {} 获取所有 endpoint，尝试下一个 SubscriptionProvider...";
  public static final String
      EXCEPTION_FAILED_HANDSHAKE_SUBSCRIPTION_PROVIDER_ARG_BECAUSE_ARG_251C2E2A =
          "与 SubscriptionProvider %s 握手失败，原因：%s";
  public static final String
      EXCEPTION_CLUSTER_HAS_NO_AVAILABLE_SUBSCRIPTION_PROVIDERS_ARG_POLL_TOPIC_ARG_FABF7A4E =
          "%s poll 主题 %s 时，集群没有可用的 SubscriptionProvider";
  public static final String
  ...
  public static final String EXCEPTION_UNSUPPORTED_SUBSCRIPTIONCOMMITCONTEXT_VERSION_8021B27B =
      "不支持的 SubscriptionCommitContext 版本：";
