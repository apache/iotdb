...
public final class SubscriptionMessages {
  ...
  public static final String AUTO_POLL_UNEXPECTED =
      "something unexpected happened when auto poll messages...";
  ...
  public static final String EXECUTOR_NOT_LAUNCHED_ZERO = "{} has not been launched, return zero";
  ...
  public static final String CLOSE_STALE_PROVIDER =
      "close and remove stale subscription provider {}";
  ...
  public static final String EXCEPTION_ARG_DO_NOT_SUPPORT_GETRESULTSETS_7789852D =
      "%s do not support getResultSets().";
  ...
  public static final String EXCEPTION_ARG_DO_NOT_SUPPORT_GETTSFILE_40D23462 =
      "%s do not support getTsFile().";
  public static final String EXCEPTION_USER_DATA_HAS_BEEN_REMOVED_ARG_7093644B =
      "User data has been removed from %s.";
  public static final String
  ...
  public static final String EXCEPTION_UNKNOWN_COLUMN_CATEGORY_4F49F64B =
  ...
  public static final String LOG_CONSUMER_LISTENER_RAISED_EXCEPTION_CONSUMING_MESSAGE_ARG_867EE46D =
      "Consumer listener raised an exception while consuming message: {}";
  ...
  public static final String LOG_FAILED_COMMIT_DRAINED_PROCESSOR_MESSAGES_CLOSE_4264DB35 =
      "Failed to commit drained processor messages on close";
  public static final String LOG_FAILED_COMMIT_PENDING_DRAINED_PROCESSOR_MESSAGES_CLOSE_644B5DDD =
      "Failed to commit pending drained processor messages on close";
  public static final String
  ...
  public static final String
      EXCEPTION_FAILED_HANDSHAKE_SUBSCRIPTION_PROVIDER_ARG_BECAUSE_ARG_251C2E2A =
          "Failed to handshake with subscription provider %s because of %s";
  public static final String
  ...
  public static final String EXCEPTION_UNSUPPORTED_SUBSCRIPTIONCOMMITCONTEXT_VERSION_8021B27B =
      "Unsupported SubscriptionCommitContext version: ";
