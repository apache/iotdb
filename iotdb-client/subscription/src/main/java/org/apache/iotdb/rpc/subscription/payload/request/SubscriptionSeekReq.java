...
public class SubscriptionSeekReq extends TPipeSubscribeReq {
   ...
   * client.
   */
  public static SubscriptionSeekReq toThriftReq(
      final String topicName, final short seekType, final long timestamp) throws IOException {
    return toThriftReq(topicName, seekType, timestamp, null);
  }

  public static SubscriptionSeekReq toTopicProgressReq(
      final String topicName, final TopicProgress topicProgress) throws IOException {
    return toThriftReq(topicName, SEEK_TO_TOPIC_PROGRESS, 0, topicProgress);
  }

  public static SubscriptionSeekReq toSeekAfterTopicProgressReq(
      final String topicName, final TopicProgress topicProgress) throws IOException {
    return toThriftReq(topicName, SEEK_AFTER_TOPIC_PROGRESS, 0, topicProgress);
  }
  ...
  public static SubscriptionSeekReq toThriftReq(
      ...
      throws IOException {
    final SubscriptionSeekReq req = new SubscriptionSeekReq();
   ...
   */
  public static SubscriptionSeekReq fromThriftReq(final TPipeSubscribeReq seekReq) {
    final SubscriptionSeekReq req = new SubscriptionSeekReq();
  ...
  public boolean equals(final Object obj) {
    ...
    final SubscriptionSeekReq that = (SubscriptionSeekReq) obj;
