...
public class TSExecuteBatchStatementReq implements org.apache.thrift.TBase<TSExecuteBatchStatementReq, TSExecuteBatchStatementReq._Fields>, java.io.Serializable, Cloneable, Comparable<TSExecuteBatchStatementReq> {
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TSExecuteBatchStatementReqStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TSExecuteBatchStatementReqTupleSchemeFactory();

  public long sessionId; // required
  public @org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> statements; // required
  ...
  public TSExecuteBatchStatementReq(TSExecuteBatchStatementReq other) {
    ...
    if (other.isSetStatements()) {
      java.util.List<java.lang.String> __this__statements = new java.util.ArrayList<java.lang.String>(other.statements);
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<java.lang.String> getStatementsIterator() {
    return (this.statements == null) ? null : this.statements.iterator();
  }

  public void addToStatements(java.lang.String elem) {
    if (this.statements == null) {
      this.statements = new java.util.ArrayList<java.lang.String>();
    }
  ...
  public TSExecuteBatchStatementReq setStatements(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> statements) {
    this.statements = statements;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case STATEMENTS:
      if (value == null) {
        ...
        setStatements((java.util.List<java.lang.String>)value);
      }
      break;
  ...
  public int compareTo(TSExecuteBatchStatementReq other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetStatements(), other.isSetStatements());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetStatements()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TSExecuteBatchStatementReq(");
    boolean first = true;
  ...
  private static class TSExecuteBatchStatementReqStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
  ...
  private static class TSExecuteBatchStatementReqStandardScheme extends org.apache.thrift.scheme.StandardScheme<TSExecuteBatchStatementReq> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TSExecuteBatchStatementReq struct) throws org.apache.thrift.TException {
      ...
      if (struct.statements != null) {
        oprot.writeFieldBegin(STATEMENTS_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter129 : struct.statements)
          {
  ...
  private static class TSExecuteBatchStatementReqTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
  ...
  private static class TSExecuteBatchStatementReqTupleScheme extends org.apache.thrift.scheme.TupleScheme<TSExecuteBatchStatementReq> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TSExecuteBatchStatementReq struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI64(struct.sessionId);
      {
        ...
        for (java.lang.String _iter130 : struct.statements)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TSExecuteBatchStatementReq struct) throws org.apache.thrift.TException {
      ...
      struct.setSessionIdIsSet(true);
      {
        ...
        struct.statements = new java.util.ArrayList<java.lang.String>(_list131.size);
        @org.apache.thrift.annotation.Nullable java.lang.String _elem132;
        for (int _i133 = 0; _i133 < _list131.size; ++_i133)
        {
          _elem132 = iprot.readString();
          struct.statements.add(_elem132);
        }
      }
      struct.setStatementsIsSet(true);
    }
