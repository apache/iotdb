...
public class IoTDBContinuousQueryIT {
  ...
  //      statement.execute(
  //          String.format(
  //              "create timeseries %s with datatype=FLOAT,encoding=RLE",
  ...
  //    statement.execute(
  //        String.format(
  //            "select avg(temperature) from root.ln.wf01.*.* GROUP BY ([%d, %d), %dms), level=1,2
  // without null all",
  ...
  //  }
  //
  //  private void checkShowContinuousQueriesResult(String[] continuousQueryArray) throws
  // SQLException {
