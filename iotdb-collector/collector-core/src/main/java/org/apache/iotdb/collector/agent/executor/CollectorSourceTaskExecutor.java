...
public class CollectorSourceTaskExecutor extends CollectorTaskExecutor {
  ...
  private static final Map<String, ExecutorService> SOURCE_EXECUTOR = new ConcurrentHashMap<>();
  private static final Map<String, CollectorTask> SOURCE_TASK_MAP = new ConcurrentHashMap<>();
