...
public class TsFilesReaderTest {
    ...
    private void TsFilesReaderWithFilterTest() throws IOException, FileNodeManagerException {
    ...
    private void TsFilesReaderWithTimeFilterTest() throws IOException, FileNodeManagerException {
        ...
        Path p = new Path("root.vehicle.d0.s0");
        SeriesFilter seriesFilter = new SeriesFilter(p, TimeFilter.gtEq((long) 800));
        queryExpression.setQueryFilter(seriesFilter);
        QueryDataSet queryDataSet = ioTDBQueryEngine.query(queryExpression);
