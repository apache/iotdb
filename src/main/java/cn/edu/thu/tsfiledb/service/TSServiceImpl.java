...
public class TSServiceImpl implements TSIService.Iface, ServerContext {
	...
	try {
	    ...
	    // MManager.getInstance().getMetadataInString();
	    // Map<String, List<ColumnSchema>> seriesMap =
	    // metadata.getSeriesMap();
	    // Map<String, List<TSColumnSchema>> tsSeriesMap =
	    // Utils.convertAllSchema(seriesMap);
