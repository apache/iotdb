 ...
 */
public class JDBCServer2 implements JDBCServerMBean {
    private static final Logger LOGGER = LoggerFactory.getLogger(JDBCServer2.class);
    private DBDao dBdao;
    ...
    public JDBCServer2() throws TTransportException {
        isStart = false;
    }
    ...
    public static void main(String[] args) throws TTransportException, InterruptedException {
        JDBCServer2 server = new JDBCServer2();
        server.startServer();
    }
