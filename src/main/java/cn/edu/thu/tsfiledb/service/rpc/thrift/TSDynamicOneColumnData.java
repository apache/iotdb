...
public class TSDynamicOneColumnData implements org.apache.thrift.TBase<TSDynamicOneColumnData, TSDynamicOneColumnData._Fields>, java.io.Serializable, Cloneable, Comparable<TSDynamicOneColumnData> {
  ...
  public List<Byte> binaryList; // optional
  ...
  public TSDynamicOneColumnData(TSDynamicOneColumnData other) {
    ...
    if (other.isSetBinaryList()) {
      List<Byte> __this__binaryList = new ArrayList<Byte>(other.binaryList);
  ...
  public java.util.Iterator<Byte> getBinaryListIterator() {
    return (this.binaryList == null) ? null : this.binaryList.iterator();
  }

  public void addToBinaryList(byte elem) {
    if (this.binaryList == null) {
      this.binaryList = new ArrayList<Byte>();
    }
  ...
  public TSDynamicOneColumnData setBinaryList(List<Byte> binaryList) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.binaryList = new ArrayList<Byte>(_list86.size);
                byte _elem87;
                for (int _i88 = 0; _i88 < _list86.size; ++_i88)
                {
                  _elem87 = iprot.readByte();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TSDynamicOneColumnData struct) throws org.apache.thrift.TException {
      ...
      if (struct.binaryList != null) {
        if (struct.isSetBinaryList()) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.BYTE, struct.binaryList.size()));
            for (byte _iter95 : struct.binaryList)
            {
              oprot.writeByte(_iter95);
            }
            oprot.writeListEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.isSetBinaryList()) {
        {
          ...
          for (byte _iter102 : struct.binaryList)
          {
            oprot.writeByte(_iter102);
          }
        }
      }
    }
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.binaryList = new ArrayList<Byte>(_list121.size);
          byte _elem122;
          for (int _i123 = 0; _i123 < _list121.size; ++_i123)
          {
            _elem122 = iprot.readByte();
