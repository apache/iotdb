...
public class PartialPathTest {
  ...
  @Test
  public void testGetOverlapPathWith() throws Exception {
    PartialPath[][] pathPairs =
        new PartialPath[][] {
          new PartialPath[] {new PartialPath("root.**"), new PartialPath("root.sg.**")},
          new PartialPath[] {new PartialPath("root.**.*"), new PartialPath("root.**")},
    ...
    PartialPath[] results =
        new PartialPath[] {
          ...
          new PartialPath("root.sg.**.*"),
          new PartialPath("root.sg.**.s"),
          new PartialPath("root.sg.**"),
          new PartialPath("root.sg1.d.s"),
          new PartialPath("root.*.d.s"),
          new PartialPath("root.*.d.s"),
          new PartialPath("root.sg.d.s"),
          null,
          null,
          null,
          new PartialPath("root.**.d2.s"),
          null,
          new PartialPath("root.d2.d1.s"),
          new PartialPath("root.d2.**.d1.**"),
          new PartialPath("root.d2.*.s1.**.**"),
          new PartialPath("root.s1.d1.**.s1.d1"),
          new PartialPath("root.**.s2.s1"),
          new PartialPath("root.d1.s1.s2.*"),
          null,
          new PartialPath("root.*.*.**.*"),
          new PartialPath("root.*.**.**.**.*"),
        };
    Assert.assertEquals(pathPairs.length, results.length);
    for (int i = 0; i < pathPairs.length; i++) {
      Assert.assertEquals(results[i], pathPairs[i][0].getOverlapPathWith(pathPairs[i][1]));
    }
  }
}
