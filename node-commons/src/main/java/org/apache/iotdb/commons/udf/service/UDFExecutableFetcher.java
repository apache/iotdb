...
public class UDFExecutableFetcher {

  private final String temporaryLibRoot;
  private final String extLibRoot;

  private UDFExecutableFetcher(String temporaryLibRoot, String extLibRoot) {
    this.temporaryLibRoot = temporaryLibRoot;
    this.extLibRoot = extLibRoot;
  }

  private static UDFExecutableFetcher INSTANCE = null;

  public static synchronized UDFExecutableFetcher setupAndGetInstance(
    ...
    if (INSTANCE == null) {
      ...
      INSTANCE = new UDFExecutableFetcher(temporaryLibRoot, extLibRoot);
    }
    return INSTANCE;
  }
  ...
  public static UDFExecutableFetcher getInstance() {
    return INSTANCE;
  }
}
