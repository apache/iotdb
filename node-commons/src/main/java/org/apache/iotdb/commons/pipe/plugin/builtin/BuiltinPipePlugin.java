...
import org.apache.iotdb.commons.pipe.plugin.builtin.connector.IoTDBOldSyncConnector;
...
public enum BuiltinPipePlugin {
  ...
  IOTDB_OLD_SYNC_CONNECTOR("iotdb_old_sync_connector", IoTDBOldSyncConnector.class);
