...
public class Accumulator1 implements UDTF {

  private static final Logger logger = LoggerFactory.getLogger(Accumulator1.class);
  ...
  private class ExampleUDFConstant {
