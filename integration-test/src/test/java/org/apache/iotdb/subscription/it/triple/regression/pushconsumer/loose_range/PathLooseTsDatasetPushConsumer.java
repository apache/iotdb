 ...
 * result: pass
 */
public class PathLooseTsDatasetPushConsumer extends AbstractSubscriptionRegressionIT {
  ...
  public void do_test()
    ...
    AWAIT.untilAsserted(
        () -> {
          check_count(9, "select count(s_0) from " + device, "Out-of-range data: s_0" + device);
