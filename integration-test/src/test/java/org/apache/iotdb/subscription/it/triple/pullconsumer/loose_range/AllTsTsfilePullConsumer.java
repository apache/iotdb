...
public class AllTsTsfilePullConsumer extends AbstractSubscriptionRegressionIT {
  ...
  public void do_test()
    ...
    consumer =
        new SubscriptionPullConsumer.Builder()
            .host(SRC_HOST)
            .port(SRC_PORT)
            .consumerId("ts_pattern_history_tsfile_pull")
    ...
    // Exact value 6
    assertEquals(rowCountList.get(0), 10);
