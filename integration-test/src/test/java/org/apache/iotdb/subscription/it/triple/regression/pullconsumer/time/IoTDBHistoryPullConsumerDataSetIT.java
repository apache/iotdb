...
public class IoTDBHistoryPullConsumerDataSetIT extends AbstractSubscriptionRegressionIT {
  ...
  public void do_test()
    ...
    consumer.subscribe(topicName);
    //        System.out.println("After resubscribing:");
    //        subs.getSubscriptions().forEach((System.out::println));
    ...
    check_count2(8, "select count(s_0) from " + device, "consume data again:" + pattern);
    check_count2(0, "select count(s_1) from " + device, "Consumption Data: s_1");
  }
}
