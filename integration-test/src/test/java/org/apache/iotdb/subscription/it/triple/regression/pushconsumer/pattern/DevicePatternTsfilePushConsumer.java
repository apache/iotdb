...
public class DevicePatternTsfilePushConsumer extends AbstractSubscriptionRegressionIT {
  ...
  public void do_test()
    ...
    consumer =
        new SubscriptionPushConsumer.Builder()
            .host(SRC_HOST)
            .port(SRC_PORT)
            .consumerId("device_TsFile_consumer")
    ...
    AWAIT.untilAsserted(
        () -> {
          ...
          assertEquals(rowCounts.get(1).get(), 10, device + ".s_1");
    ...
    AWAIT.untilAsserted(
        () -> {
          ...
          assertEquals(rowCounts.get(1).get(), 25, device + ".s_1");
          assertEquals(rowCounts.get(2).get(), 0, database + ".d_1.s_0");
        });
  }
}
