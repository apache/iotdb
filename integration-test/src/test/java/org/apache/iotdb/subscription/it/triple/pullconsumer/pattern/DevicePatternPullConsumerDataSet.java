...
public class DevicePatternPullConsumerDataSet extends AbstractSubscriptionRegressionIT {
  ...
  private static final String device2 = database2 + ".d_2";
  private static final String topicName = "topicDevicePatternPullConsumerDataSet";
  ...
  public void setUp() throws Exception {
    ...
    session_dest.executeNonQueryStatement(
        "create aligned timeseries " + database + ".d_1(s_0 int64,s_1 double);");
    session_src.executeNonQueryStatement("create timeseries " + device2 + ".s_0 int32;");
    session_dest.executeNonQueryStatement("create timeseries " + device2 + ".s_0 int32;");
    session_src.executeNonQueryStatement("create timeseries " + device2 + ".s_1 float;");
    session_dest.executeNonQueryStatement("create timeseries " + device2 + ".s_1 float;");
    session_src.executeNonQueryStatement(
        "insert into " + device2 + "(time,s_0,s_1)values(1000,132,4567.89);");
    session_src.executeNonQueryStatement(
  ...
  public void do_test()
    ...
    consumer = create_pull_consumer("pull_pattern", "device_dataset", false, null);
