 ...
 * pattern: device
 */
public class DevicePatternDatasetPushConsumer extends AbstractSubscriptionRegressionIT {
  ...
  private static final String topicName = "topic_DevicePatternDatasetPushConsumer";
  private static List<MeasurementSchema> schemaList = new ArrayList<>();

  private static String pattern = database + ".d_0.**";
  ...
  public void do_test()
    ...
    consumer =
        new SubscriptionPushConsumer.Builder()
            .host(SRC_HOST)
            .port(SRC_PORT)
            .consumerId("device_dataset_consumer")
