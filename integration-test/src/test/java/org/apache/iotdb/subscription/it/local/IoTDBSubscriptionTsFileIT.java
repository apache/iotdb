...
public class IoTDBSubscriptionTsFileIT extends AbstractSubscriptionLocalIT {

  private static final Logger LOGGER = LoggerFactory.getLogger(IoTDBSubscriptionTsFileIT.class);
