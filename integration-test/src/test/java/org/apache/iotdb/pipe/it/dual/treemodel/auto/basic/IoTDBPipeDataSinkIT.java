...
public class IoTDBPipeDataSinkIT extends AbstractPipeDualTreeModelAutoIT {
  ...
  @Test
  public void testThriftConnectorWithRealtimeFirstDisabled2() throws Exception {
    final DataNodeWrapper receiverDataNode = receiverEnv.getDataNodeWrapper(0);
    final DataNodeWrapper receiverDataNode2 = receiverEnv.getDataNodeWrapper(1);
    final String receiverIp1 = receiverDataNode.getIp();
    final int receiverPort1 = receiverDataNode.getPort();
    final String receiverIp2 = receiverDataNode2.getIp();
    final int receiverPort2 = receiverDataNode2.getPort();
    ...
    try (final SyncConfigNodeIServiceClient client =
      ...
      connectorAttributes.put(
          "connector.node-urls",
          receiverIp1 + ":" + receiverPort1 + "," + receiverIp2 + ":" + receiverPort2);
      connectorAttributes.put("connector.realtime-first", "false");
