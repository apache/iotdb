...
public class IoTDBSinFunctionTableIT {
    ...
    public void testNormalTransformer() {
        ...
        tableResultSetEqualTest(
                "select time,s2,sin(s2),s3,sin(s3),s4,sin(s4),s5,sin(s5),s8,sin(s8) from table1",
                expectedHeader,
                expectedAns,
                DATABASE_NAME);
    }
    ...
    public void testFailTransformer() {
        ...
        tableAssertTestFail(
                "select s2,sin(s2,1) from table1",
        ...
        tableAssertTestFail(
                "select s10,sin(s10) from table1",
                TSStatusCode.SEMANTIC_ERROR.getStatusCode()
                        + ": Scalar function sin only accepts one argument and it must be TimeStamp, Double, Float, Int32 or Int64 data type.",
                DATABASE_NAME);
    }
