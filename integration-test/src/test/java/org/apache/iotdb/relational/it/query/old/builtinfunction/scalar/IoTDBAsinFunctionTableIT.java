...
public class IoTDBAsinFunctionTableIT {
    ...
    public void testNormalTransformer() {
        ...
        tableResultSetEqualTest(
                "select time,s2,asin(s2),s3,asin(s3),s4,asin(s4),s5,asin(s5),s8,asin(s8) from table1",
                expectedHeader,
                expectedAns,
                DATABASE_NAME);
    }
    ...
    public void testFailTransformer() {
        ...
        tableAssertTestFail(
                "select s2,asin(s2,1) from table1",
        ...
        tableAssertTestFail(
                "select s10,asin(s10) from table1",
                TSStatusCode.SEMANTIC_ERROR.getStatusCode()
                        + ": Scalar function asin only accepts one argument and it must be TimeStamp, Double, Float, Int32 or Int64 data type.",
                DATABASE_NAME);
    }
