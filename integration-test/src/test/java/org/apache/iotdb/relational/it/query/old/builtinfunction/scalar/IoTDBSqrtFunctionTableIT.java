...
public class IoTDBSqrtFunctionTableIT {
    ...
    private static final String[] SQLs =
            new String[] {
                    ...
                    "INSERT INTO table1(Time,device_id,s2) values(2, 'd1',  0)",
                    "INSERT INTO table1(Time,device_id,s2) values(3, 'd1',  -1)",
                    "INSERT INTO table1(Time,device_id,s3) values(2, 'd1',  0)",
                    "INSERT INTO table1(Time,device_id,s3) values(3, 'd1',  -1)",
                    "INSERT INTO table1(Time,device_id,s4) values(2, 'd1',  0.0)",
                    "INSERT INTO table1(Time,device_id,s4) values(3, 'd1',  -1.5)",
                    "INSERT INTO table1(Time,device_id,s5) values(2, 'd1',  0.0)",
                    "INSERT INTO table1(Time,device_id,s5) values(3, 'd1',  -1.5)",
                    "INSERT INTO table1(Time,device_id,s8) values(2, 'd1',  0)",
    ...
    public void testNormalTransformer() {
        ...
        String[] expectedHeader = new String[] {"time","s2","_col2","s3","_col4","s4","_col6","s5","_col8","s8","_col10"};
        ...
        tableResultSetEqualTest(
                "select time,s2,sqrt(s2),s3,sqrt(s3),s4,sqrt(s4),s5,sqrt(s5),s8,sqrt(s8) from table1",
                expectedHeader,
                expectedAns,
                DATABASE_NAME);
    }
    ...
    public void testFailTransformer() {
        ...
        tableAssertTestFail(
                "select s2,sqrt(s2,1) from table1",
        ...
        tableAssertTestFail(
                "select s10,sqrt(s10) from table1",
                TSStatusCode.SEMANTIC_ERROR.getStatusCode()
                        + ": Scalar function sqrt only accepts one argument and it must be TimeStamp, Double, Float, Int32 or Int64 data type.",
                DATABASE_NAME);
    }
