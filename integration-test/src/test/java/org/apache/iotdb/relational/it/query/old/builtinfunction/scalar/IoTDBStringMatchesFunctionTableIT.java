...
public class IoTDBStringMatchesFunctionTableIT {
    ...
    public void testNormalTransformer() {
        ...
        tableResultSetEqualTest(
                "select time,s1,string_matches(s1,'^abcd$'),s9,string_matches(s9,'[a-h]+') from table1",
                expectedHeader,
                retArray,
                DATABASE_NAME);
        ...
        tableResultSetEqualTest(
                "select time,s1,s9,string_matches(s1,s9) from table1",
                expectedHeader,
                retArray,
                DATABASE_NAME);
    }
    ...
    public void testFailTransformer() {
        ...
        tableAssertTestFail(
                "select s1,string_matches(s1, 'es', 'ab') from table1",
                TSStatusCode.SEMANTIC_ERROR.getStatusCode()
                        + ": Scalar function string_matches only accepts two arguments and they must be text or string data type.",
                DATABASE_NAME);

        // case 2: less than two argument
        tableAssertTestFail(
                "select s1,string_matches(s1) from table1",
                TSStatusCode.SEMANTIC_ERROR.getStatusCode()
                        + ": Scalar function string_matches only accepts two arguments and they must be text or string data type.",
                DATABASE_NAME);
        ...
        tableAssertTestFail(
                "select s2,string_matches(s2, 'es') from table1",
                TSStatusCode.SEMANTIC_ERROR.getStatusCode()
                        + ": Scalar function string_matches only accepts two arguments and they must be text or string data type.",
                DATABASE_NAME);
        ...
        tableAssertTestFail(
                "select s3,string_matches(s3, 'es') from table1",
                TSStatusCode.SEMANTIC_ERROR.getStatusCode()
                        + ": Scalar function string_matches only accepts two arguments and they must be text or string data type.",
                DATABASE_NAME);
        ...
        tableAssertTestFail(
                "select s4,string_matches(s4, 'es') from table1",
                TSStatusCode.SEMANTIC_ERROR.getStatusCode()
                        + ": Scalar function string_matches only accepts two arguments and they must be text or string data type.",
                DATABASE_NAME);
        ...
        tableAssertTestFail(
                "select s5,string_matches(s5, 'es') from table1",
                TSStatusCode.SEMANTIC_ERROR.getStatusCode()
                        + ": Scalar function string_matches only accepts two arguments and they must be text or string data type.",
                DATABASE_NAME);
        ...
        tableAssertTestFail(
                "select s6,string_matches(s6, 'es') from table1",
                TSStatusCode.SEMANTIC_ERROR.getStatusCode()
                        + ": Scalar function string_matches only accepts two arguments and they must be text or string data type.",
                DATABASE_NAME);
        ...
        tableAssertTestFail(
                "select s7,string_matches(s7, 'es') from table1",
                TSStatusCode.SEMANTIC_ERROR.getStatusCode()
                        + ": Scalar function string_matches only accepts two arguments and they must be text or string data type.",
                DATABASE_NAME);
        ...
        tableAssertTestFail(
                "select s8,string_matches(s8, 'es') from table1",
                TSStatusCode.SEMANTIC_ERROR.getStatusCode()
                        + ": Scalar function string_matches only accepts two arguments and they must be text or string data type.",
                DATABASE_NAME);
        ...
        tableAssertTestFail(
                "select s10,string_matches(s10, 'es') from table1",
                TSStatusCode.SEMANTIC_ERROR.getStatusCode()
                        + ": Scalar function string_matches only accepts two arguments and they must be text or string data type.",
                DATABASE_NAME);
    }
