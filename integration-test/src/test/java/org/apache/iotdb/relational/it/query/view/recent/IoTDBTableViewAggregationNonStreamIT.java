...
public class IoTDBTableViewAggregationNonStreamIT {
  ...
  protected static final String[] createTableViewSqls =
      new String[] {
        ...
        "USE " + DATABASE_NAME,
        "CREATE TABLE VIEW table1(province STRING FIELD, city STRING FIELD, region STRING FIELD FROM region1, device_id STRING TAG, s1 INT32 FIELD, s2 INT64 FIELD, s3 FLOAT FIELD, s4 DOUBLE FIELD, s5 BOOLEAN FIELD, s6 TEXT FIELD, s7 STRING FIELD, s8 BLOB FIELD, s9 TIMESTAMP FIELD, s10 DATE FIELD) as root.test.table1.**",
      };
