...
public class IoTDBAbsFunctionTableIT {
  ...
  private static final String[] SQLs =
      new String[] {
        ...
        "INSERT INTO table1(Time,device_id,s2) values(2, 'd1',  -1)",
        "INSERT INTO table1(Time,device_id,s2) values(3, 'd1',  -2)",
        "INSERT INTO table1(Time,device_id,s3) values(2, 'd1',  -1)",
        "INSERT INTO table1(Time,device_id,s3) values(3, 'd1',  -2)",
        "INSERT INTO table1(Time,device_id,s4) values(2, 'd1',  -1.5)",
        "INSERT INTO table1(Time,device_id,s4) values(3, 'd1',  -2.5)",
        "INSERT INTO table1(Time,device_id,s5) values(2, 'd1',  -1.5)",
        "INSERT INTO table1(Time,device_id,s5) values(3, 'd1',  -2.5)",
        "INSERT INTO table1(Time,device_id,s8) values(2, 'd1',  1)",
        "INSERT INTO table1(Time,device_id,s8) values(3, 'd1',  2)",
        "flush"
      }; // 给数字类型写入两个负数
  ...
  public void testNormalTransformer() {
    ...
    tableResultSetEqualTest(
        "select time,s2,abs(s2),s3,abs(s3),s4,abs(s4),s5,abs(s5),s8,abs(s8) from table1",
        expectedHeader,
        expectedAns,
        DATABASE_NAME);
  }
  ...
  public void testFailTransformer() {
    ...
    tableAssertTestFail(
        "select s2,abs(s2,1) from table1",
    ...
    tableAssertTestFail(
        "select s10,abs(s10) from table1",
        TSStatusCode.SEMANTIC_ERROR.getStatusCode()
            + ": Scalar function abs only accepts one argument and it must be TimeStamp, Double, Float, Int32 or Int64 data type.",
        DATABASE_NAME);
  }
