...
public class IoTDBLengthFunctionTableIT {
  ...
  public void testNormalTransformer() {
    ...
    tableResultSetEqualTest(
        "select time,s1,Length(s1) from table1", expectedHeader, expectedAns, DATABASE_NAME);
    ...
    tableResultSetEqualTest(
        "select time,s9,Length(s9) from table1", expectedHeader, expectedAns, DATABASE_NAME);
  }
