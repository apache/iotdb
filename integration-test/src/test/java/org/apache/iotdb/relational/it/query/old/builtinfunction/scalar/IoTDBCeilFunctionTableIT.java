...
public class IoTDBCeilFunctionTableIT {
    ...
    public void testNormalTransformer() {
        ...
        tableResultSetEqualTest(
                "select time,s2,ceil(s2),s3,ceil(s3),s4,ceil(s4),s5,ceil(s5),s8,ceil(s8) from table1",
                expectedHeader,
                expectedAns,
                DATABASE_NAME);
    }
    ...
    public void testFailTransformer() {
        ...
        tableAssertTestFail(
                "select s2,ceil(s2,1) from table1",
        ...
        tableAssertTestFail(
                "select s10,ceil(s10) from table1",
                TSStatusCode.SEMANTIC_ERROR.getStatusCode()
                        + ": Scalar function ceil only accepts one argument and it must be TimeStamp, Double, Float, Int32 or Int64 data type.",
                DATABASE_NAME);
    }
