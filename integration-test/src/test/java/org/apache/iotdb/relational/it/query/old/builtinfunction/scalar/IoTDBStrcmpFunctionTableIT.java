...
public class IoTDBStrcmpFunctionTableIT {
    ...
    public void testNormalTransformer() {
        ...
        tableResultSetEqualTest(
                "select time,s1,s9,strcmp(s1,s9) from table1",
                expectedHeader,
                retArray,
                DATABASE_NAME);
    }
    ...
    public void testFailTransformer() {
        ...
        tableAssertTestFail(
                "select s1,strcmp(s1, 'es', 'ab') from table1",
        ...
        tableAssertTestFail(
                "select s1,strcmp(s1) from table1",
                TSStatusCode.SEMANTIC_ERROR.getStatusCode()
                        + ": Scalar function strcmp only accepts two arguments and they must be text or string data type.",
                DATABASE_NAME);
        ...
        tableAssertTestFail(
                "select s2,strcmp(s2, 'es') from table1",
                TSStatusCode.SEMANTIC_ERROR.getStatusCode()
                        + ": Scalar function strcmp only accepts two arguments and they must be text or string data type.",
                DATABASE_NAME);
        ...
        tableAssertTestFail(
                "select s3,strcmp(s3, 'es') from table1",
                TSStatusCode.SEMANTIC_ERROR.getStatusCode()
                        + ": Scalar function strcmp only accepts two arguments and they must be text or string data type.",
                DATABASE_NAME);
        ...
        tableAssertTestFail(
                "select s4,strcmp(s4, 'es') from table1",
                TSStatusCode.SEMANTIC_ERROR.getStatusCode()
                        + ": Scalar function strcmp only accepts two arguments and they must be text or string data type.",
                DATABASE_NAME);
        ...
        tableAssertTestFail(
                "select s5,strcmp(s5, 'es') from table1",
                TSStatusCode.SEMANTIC_ERROR.getStatusCode()
                        + ": Scalar function strcmp only accepts two arguments and they must be text or string data type.",
                DATABASE_NAME);
        ...
        tableAssertTestFail(
                "select s6,strcmp(s6, 'es') from table1",
                TSStatusCode.SEMANTIC_ERROR.getStatusCode()
                        + ": Scalar function strcmp only accepts two arguments and they must be text or string data type.",
                DATABASE_NAME);
        ...
        tableAssertTestFail(
                "select s7,strcmp(s7, 'es') from table1",
                TSStatusCode.SEMANTIC_ERROR.getStatusCode()
                        + ": Scalar function strcmp only accepts two arguments and they must be text or string data type.",
                DATABASE_NAME);
        ...
        tableAssertTestFail(
                "select s8,strcmp(s8, 'es') from table1",
                TSStatusCode.SEMANTIC_ERROR.getStatusCode()
                        + ": Scalar function strcmp only accepts two arguments and they must be text or string data type.",
                DATABASE_NAME);
        ...
        tableAssertTestFail(
                "select s10,strcmp(s10, 'es') from table1",
                TSStatusCode.SEMANTIC_ERROR.getStatusCode()
                        + ": Scalar function strcmp only accepts two arguments and they must be text or string data type.",
                DATABASE_NAME);
    }
