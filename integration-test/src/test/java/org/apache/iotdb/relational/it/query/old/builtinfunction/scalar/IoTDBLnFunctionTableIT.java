...
public class IoTDBLnFunctionTableIT {
    ...
    public void testNormalTransformer() {
        ...
        tableResultSetEqualTest(
                "select time,s2,ln(s2),s3,ln(s3),s4,ln(s4),s5,ln(s5),s8,ln(s8) from table1",
                expectedHeader,
                expectedAns,
                DATABASE_NAME);
    }
