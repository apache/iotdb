...
public class IoTDBPredicatePushDownIT {
  ...
  public void testAlignedRawDataAlignByTime1() {
    ...
    resultSetEqualTest(
        "select s2, s3 from table0 where device='d1' and s2 - 1 >= 9 and s2 < 30",
        expectedHeader1,
        retArray1);
    ...
    resultSetEqualTest(
        "select s3 from table0 where device='d1' and s2 - 1 >= 9 and s2 < 30",
        expectedHeader2,
        retArray2);
    ...
    resultSetEqualTest(
        "select s2 from table0 where device='d1' and s2 - 1 >= 9 and s2 < 30",
        expectedHeader3,
        retArray3);
    ...
    resultSetEqualTest(
        "select s2 from table0 where device='d1' and s2 - 1 >= 9 and s2 < 30 offset 3 limit 2",
        expectedHeader4,
        retArray4);
  }
  ...
  public void testAlignedRawDataAlignByTime2() {
    ...
    resultSetEqualTest(
        "select s2, s3 + 1 from table0 where device='d1' and s3 + 1 > 16",
        expectedHeader1,
        retArray1);
    ...
    resultSetEqualTest(
        "select s2 from table0 where device='d1' and s3 + 1 > 16", expectedHeader2, retArray2);
    ...
    resultSetEqualTest(
        "select s3 from table0 where device='d1' and s3 + 1 > 16", expectedHeader3, retArray3);

    String expectedHeader4 = "Time,root.sg1.d1.s3,";
    String[] retArray4 = new String[] {"3,30000,", "13,130000,", "16,16,"};
    resultSetEqualTest(
        "select s3 from table0 where device='d1' and s3 + 1 > 16 limit 3",
        expectedHeader4,
        retArray4);
  }
