...
public class IoTDBUpperFunctionTableIT {
    ...
    public void testNormalTransformer() {
        ...
        tableResultSetEqualTest(
                "select time,s1,upper(s1),s9,upper(s9) from table1",
                expectedHeader,
                retArray,
                DATABASE_NAME);
    }
    ...
    public void testFailTransformer() {
        ...
        tableAssertTestFail(
                "select s1,upper(s1, 1) from table1",
        ...
        tableAssertTestFail(
                "select s2,upper(s2) from table1",
                TSStatusCode.SEMANTIC_ERROR.getStatusCode()
                        + ": Scalar function upper only accepts one argument and it must be text or string data type.",
                DATABASE_NAME);
        ...
        tableAssertTestFail(
                "select s3,upper(s3) from table1",
                TSStatusCode.SEMANTIC_ERROR.getStatusCode()
                        + ": Scalar function upper only accepts one argument and it must be text or string data type.",
                DATABASE_NAME);
        ...
        tableAssertTestFail(
                "select s4,upper(s4) from table1",
                TSStatusCode.SEMANTIC_ERROR.getStatusCode()
                        + ": Scalar function upper only accepts one argument and it must be text or string data type.",
                DATABASE_NAME);
        ...
        tableAssertTestFail(
                "select s5,upper(s5) from table1",
                TSStatusCode.SEMANTIC_ERROR.getStatusCode()
                        + ": Scalar function upper only accepts one argument and it must be text or string data type.",
                DATABASE_NAME);
        ...
        tableAssertTestFail(
                "select s6,upper(s6) from table1",
                TSStatusCode.SEMANTIC_ERROR.getStatusCode()
                        + ": Scalar function upper only accepts one argument and it must be text or string data type.",
                DATABASE_NAME);
        ...
        tableAssertTestFail(
                "select s7,upper(s7) from table1",
                TSStatusCode.SEMANTIC_ERROR.getStatusCode()
                        + ": Scalar function upper only accepts one argument and it must be text or string data type.",
                DATABASE_NAME);
        ...
        tableAssertTestFail(
                "select s8,upper(s8) from table1",
                TSStatusCode.SEMANTIC_ERROR.getStatusCode()
                        + ": Scalar function upper only accepts one argument and it must be text or string data type.",
                DATABASE_NAME);
        ...
        tableAssertTestFail(
                "select s10,upper(s10) from table1",
                TSStatusCode.SEMANTIC_ERROR.getStatusCode()
                        + ": Scalar function upper only accepts one argument and it must be text or string data type.",
                DATABASE_NAME);
    }
