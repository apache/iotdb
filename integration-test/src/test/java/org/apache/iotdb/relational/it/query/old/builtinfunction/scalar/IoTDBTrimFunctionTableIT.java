...
public class IoTDBTrimFunctionTableIT {
  ...
  public void testNormalTransformer() {
    ...
    tableResultSetEqualTest(
        "select time,s1,trim(s1,'es'),s9,trim(s9,'es') from table1",
        expectedHeader,
        retArray,
        DATABASE_NAME);
    ...
    tableResultSetEqualTest(
        "select time,s1,trim('es',s1),s9,trim('es',s9) from table1",
        expectedHeader,
        retArray,
        DATABASE_NAME);
    ...
    tableResultSetEqualTest(
        "select time,s1,s9,trim(s1,s9) from table1", expectedHeader, retArray, DATABASE_NAME);
    ...
    tableResultSetEqualTest(
        "select time,s1,s9,trim('header',s1,'body',s9,'tail') from table1",
        expectedHeader,
        retArray,
        DATABASE_NAME);
  }
  ...
  public void testFailTransformer() {
    ...
    tableAssertTestFail(
        ...
        TSStatusCode.SEMANTIC_ERROR.getStatusCode()
            + ": Scalar function trim only accepts two or more arguments and they must be text or string data type.",
        DATABASE_NAME);
