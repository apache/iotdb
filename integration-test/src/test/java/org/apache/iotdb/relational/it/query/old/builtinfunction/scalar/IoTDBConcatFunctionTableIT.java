...
public class IoTDBConcatFunctionTableIT {
    ...
    public void testNormalTransformer() {
        ...
        tableResultSetEqualTest(
                "select time,s1,s9,concat(s1,s9) from table1",
                expectedHeader,
                retArray,
                DATABASE_NAME);
    }
    ...
    public void testFailTransformer() {
        ...
        tableAssertTestFail(
                "select s1,concat(s1, 'es', 'ab') from table1",
                TSStatusCode.SEMANTIC_ERROR.getStatusCode()
                        + ": Scalar function concat only accepts two arguments and they must be text or string data type.",
                DATABASE_NAME);
