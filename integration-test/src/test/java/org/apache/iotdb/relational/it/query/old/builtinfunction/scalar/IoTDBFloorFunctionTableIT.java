...
public class IoTDBFloorFunctionTableIT {
    ...
    private static final String[] SQLs =
            new String[] {
                    ...
                    "INSERT INTO table1(Time,device_id,s2) values(3, 'd1',  -2)",
                    "INSERT INTO table1(Time,device_id,s3) values(2, 'd1',  2)",
                    "INSERT INTO table1(Time,device_id,s3) values(3, 'd1',  -2)",
                    "INSERT INTO table1(Time,device_id,s4) values(2, 'd1',  2.5)",
                    "INSERT INTO table1(Time,device_id,s4) values(3, 'd1',  -2.5)",
                    "INSERT INTO table1(Time,device_id,s5) values(2, 'd1',  2.5)",
                    "INSERT INTO table1(Time,device_id,s5) values(3, 'd1',  -2.5)",
    ...
    public void testNormalTransformer() {
        ...
        tableResultSetEqualTest(
                "select time,s2,floor(s2),s3,floor(s3),s4,floor(s4),s5,floor(s5),s8,floor(s8) from table1",
                expectedHeader,
                expectedAns,
                DATABASE_NAME);
    }
    ...
    public void testFailTransformer() {
        ...
        tableAssertTestFail(
                "select s2,floor(s2,1) from table1",
        ...
        tableAssertTestFail(
                "select s1,floor(s1) from table1",
                TSStatusCode.SEMANTIC_ERROR.getStatusCode()
                        + ": Scalar function floor only accepts one argument and it must be TimeStamp, Double, Float, Int32 or Int64 data type.",
                DATABASE_NAME);
        ...
        tableAssertTestFail(
                "select s6,floor(s6) from table1",
                TSStatusCode.SEMANTIC_ERROR.getStatusCode()
                        + ": Scalar function floor only accepts one argument and it must be TimeStamp, Double, Float, Int32 or Int64 data type.",
                DATABASE_NAME);
        ...
        tableAssertTestFail(
                "select s7,floor(s7) from table1",
                TSStatusCode.SEMANTIC_ERROR.getStatusCode()
                        + ": Scalar function floor only accepts one argument and it must be TimeStamp, Double, Float, Int32 or Int64 data type.",
                DATABASE_NAME);
        ...
        tableAssertTestFail(
                "select s9,floor(s9) from table1",
                TSStatusCode.SEMANTIC_ERROR.getStatusCode()
                        + ": Scalar function floor only accepts one argument and it must be TimeStamp, Double, Float, Int32 or Int64 data type.",
                DATABASE_NAME);
        ...
        tableAssertTestFail(
                "select s10,floor(s10) from table1",
                TSStatusCode.SEMANTIC_ERROR.getStatusCode()
                        + ": Scalar function floor only accepts one argument and it must be TimeStamp, Double, Float, Int32 or Int64 data type.",
                DATABASE_NAME);
    }
