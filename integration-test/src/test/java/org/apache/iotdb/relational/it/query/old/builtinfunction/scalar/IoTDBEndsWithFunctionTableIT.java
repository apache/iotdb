...
public class IoTDBEndsWithFunctionTableIT {
  ...
  public void testNormalTransformer() {
    ...
    tableResultSetEqualTest(
        "select time,s1,endswith(s1,'gh'),s9,endswith(s9,'gh') from table1",
        expectedHeader,
        retArray,
        DATABASE_NAME);
    ...
    tableResultSetEqualTest(
        "select time,s1,s9,endswith(s1,s9) from table1", expectedHeader, retArray, DATABASE_NAME);
  }
  ...
  public void testFailTransformer() {
    ...
    tableAssertTestFail(
        "select s1,endswith(s1, 'es', 'ab') from table1",
        TSStatusCode.SEMANTIC_ERROR.getStatusCode()
            + ": Scalar function endswith only accepts two arguments and they must be text or string data type.",
        DATABASE_NAME);

    // case 2: less than two argument
    tableAssertTestFail(
        "select s1,endswith(s1) from table1",
        TSStatusCode.SEMANTIC_ERROR.getStatusCode()
            + ": Scalar function endswith only accepts two arguments and they must be text or string data type.",
        DATABASE_NAME);
    ...
    tableAssertTestFail(
        "select s2,endswith(s2, 'es') from table1",
        TSStatusCode.SEMANTIC_ERROR.getStatusCode()
            + ": Scalar function endswith only accepts two arguments and they must be text or string data type.",
        DATABASE_NAME);
    ...
    tableAssertTestFail(
        "select s3,endswith(s3, 'es') from table1",
        TSStatusCode.SEMANTIC_ERROR.getStatusCode()
            + ": Scalar function endswith only accepts two arguments and they must be text or string data type.",
        DATABASE_NAME);
    ...
    tableAssertTestFail(
        "select s4,endswith(s4, 'es') from table1",
        TSStatusCode.SEMANTIC_ERROR.getStatusCode()
            + ": Scalar function endswith only accepts two arguments and they must be text or string data type.",
        DATABASE_NAME);
    ...
    tableAssertTestFail(
        "select s5,endswith(s5, 'es') from table1",
        TSStatusCode.SEMANTIC_ERROR.getStatusCode()
            + ": Scalar function endswith only accepts two arguments and they must be text or string data type.",
        DATABASE_NAME);
    ...
    tableAssertTestFail(
        "select s6,endswith(s6, 'es') from table1",
        TSStatusCode.SEMANTIC_ERROR.getStatusCode()
            + ": Scalar function endswith only accepts two arguments and they must be text or string data type.",
        DATABASE_NAME);
    ...
    tableAssertTestFail(
        "select s7,endswith(s7, 'es') from table1",
        TSStatusCode.SEMANTIC_ERROR.getStatusCode()
            + ": Scalar function endswith only accepts two arguments and they must be text or string data type.",
        DATABASE_NAME);
    ...
    tableAssertTestFail(
        "select s8,endswith(s8, 'es') from table1",
        TSStatusCode.SEMANTIC_ERROR.getStatusCode()
            + ": Scalar function endswith only accepts two arguments and they must be text or string data type.",
        DATABASE_NAME);
    ...
    tableAssertTestFail(
        "select s10,endswith(s10, 'es') from table1",
        TSStatusCode.SEMANTIC_ERROR.getStatusCode()
            + ": Scalar function endswith only accepts two arguments and they must be text or string data type.",
        DATABASE_NAME);
  }
