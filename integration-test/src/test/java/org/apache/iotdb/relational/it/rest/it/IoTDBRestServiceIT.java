...
public class IoTDBRestServiceIT {
  ...
  public void testQuery() {
    String sql = "insert into db11(tag1,s1,s2,s3,time) values('aa',11,1.1,1,1),('aa2',21,2.1,2,2)";
    ...
    JsonObject queryResult =
        RestUtils.query(
            httpClient,
            port,
            sqlHandler("test", "select tag1,s1,s2,s3,time from db11 order by time"));
  ...
  public void testQuery1() {
    JsonObject result =
        RestUtils.query(
            httpClient,
            port,
            sqlHandler(null, "select tag1,s1,s2,s3,time from db11 order by time"));
  ...
  public void rightNonQuery2() {
    String sql = "insert into db10(tag1,s1,time,s2) values('aa',1,1,1.1)";
    JsonObject result = RestUtils.nonQuery(httpClient, port, sqlHandler("test", sql));
    assertEquals(200, result.get("code").getAsInt());
  }

  public void rightNonQuery4() {
    String sql = "insert into db10(tag1,s1,time,s2) values('aa',1,1,1.1),('bb',2,2,2.1)";
    JsonObject result = RestUtils.nonQuery(httpClient, port, sqlHandler("test", sql));
    assertEquals(200, result.get("code").getAsInt());
  }
  ...
  public void testInsertMultiPartition() {
    List<String> sqls =
        Arrays.asList(
            "create table db1 (tag1 string tag, s1 int32 field)",
            "insert into db1(tag1,time,s1) values('d1',1,2)",
            "flush",
            "insert into db1(tag1,time,s1) values('d1',2,2)",
            "insert into db1(tag1,time,s1) values('d1',604800001,2)",
            "flush");
    for (String sql : sqls) {
  ...
  public void testInsertTablet() {
    List<String> sqls =
        Collections.singletonList(
            "create table db211 (tag1 string tag,t1 STRING ATTRIBUTE, s1 FLOAT field)");
    for (String sql : sqls) {
      RestUtils.nonQuery(httpClient, port, sqlHandler("test", sql));
    }
    String json =
        "{\"database\":\"test\",\"column_categories\":[\"TAG\",\"ATTRIBUTE\",\"FIELD\"],\"timestamps\":[1635232143960,1635232153960,1635232163960,1635232173960,1635232183960],\"column_names\":[\"tag1\",\"t1\",\"s1\"],\"data_types\":[\"STRING\",\"STRING\",\"FLOAT\"],\"values\":[[\"a11\",\"true\",11],[\"a11\",\"false\",22],[\"a13\",\"false1\",23],[\"a14\",\"false2\",24],[\"a15\",\"false3\",25]],\"table\":\"db211\"}";
  ...
  public void testInsertTabletNoDatabase() {
    ...
    String json =
        "{\"database\":\"\",\"column_categories\":[\"TAG\",\"ATTRIBUTE\",\"FIELD\"],\"timestamps\":[1635232143960,1635232153960,1635232163960,1635232173960,1635232183960],\"column_names\":[\"tag1\",\"t1\",\"s1\"],\"data_types\":[\"STRING\",\"STRING\",\"FLOAT\"],\"values\":[[\"a11\",\"true\",11],[\"a11\",\"false\",22],[\"a13\",\"false1\",23],[\"a14\",\"false2\",24],[\"a15\",\"false3\",25]],\"table\":\"db211\"}";
  ...
  public void testInsertTablet1() {
    ...
    String json =
        "{\"database\":\"test\",\"column_categories\":[\"ATTRIBUTE\",\"FIELD\"],\"timestamps\":[1635232143960,1635232153960,1635232163960,1635232173960,1635232183960],\"column_names\":[\"id1\",\"t1\",\"s1\"],\"data_types\":[\"STRING\",\"STRING\",\"FLOAT\"],\"values\":[[\"a11\",\"true\",11],[\"a11\",\"false\",22],[\"a13\",\"false1\",23],[\"a14\",\"false2\",24],[\"a15\",\"false3\",25]],\"table\":\"db211\"}";
    JsonObject result = RestUtils.insertTablet(httpClient, port, json);
    assertEquals(305, Integer.parseInt(result.get("code").toString()));
    assertEquals(
  ...
  public void testInsertTablet2() {
    ...
    String json =
        "{\"database\":\"test\",\"column_categories\":[\"TAG\",\"ATTRIBUTE\",\"FIELD\"],\"timestamps\":[1635232143960,1635232153960,1635232163960,1635232183960],\"column_names\":[\"tag1\",\"t1\",\"s1\"],\"data_types\":[\"STRING\",\"STRING\",\"FLOAT\"],\"values\":[[\"a11\",\"true\",11],[\"a11\",\"false\",22],[\"a13\",\"false1\",23],[\"a14\",\"false2\",24],[\"a15\",\"false3\",25]],\"table\":\"db211\"}";
    JsonObject result = RestUtils.insertTablet(httpClient, port, json);
    assertEquals(305, Integer.parseInt(result.get("code").toString()));
    assertEquals(
  ...
  public void rightInsertTablet(String json) {
    ...
    JsonObject queryResult =
        RestUtils.query(
            httpClient, port, sqlHandler("test", "select tag1,t1,s1 from db211 order by time"));
    JsonArray jsonArray = queryResult.get("values").getAsJsonArray();
