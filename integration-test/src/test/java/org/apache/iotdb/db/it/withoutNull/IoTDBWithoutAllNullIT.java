...
public class IoTDBWithoutAllNullIT {
  ...
  public void withoutAllNullTest2() {
    ...
    try (Connection connection = EnvFactory.getEnv().getConnection();
      ...
      boolean hasResultSet =
          statement.execute(
              "select last_value(*) from root.testWithoutAllNull.d1 GROUP BY([1, 21), 5ms) limit 1 offset 1"
                  + "where s1 != null || s2 != null || s3 != null");
  ...
  public void withoutAllNullTest4() {
    ...
    try (Connection connection = EnvFactory.getEnv().getConnection();
      ...
      boolean hasResultSet =
          statement.execute(
              "select last_value(*) from root.testWithoutAllNull.d1 GROUP BY([1, 21), 5ms) LIMIT 1 OFFSET 1 ALIGN BY DEVICE"
                  + "where s1 != null || s2 != null || s3 != null");
