...
public class IoTDBDeleteTimeseriesIT extends AbstractSchemaIT {
  ...
  //
  //    String insertSql = "insert into root.sg.d1(time, s1, s2, s3, s4) values(%d, %d, %d, %d,
  // %d)";
  //    for (int i = 1; i <= 4; i++) {
  ...
  //                      + ": Timeseries [root.**] does not exist or is represented by schema
  // template"));
  //    }
  //
  //    String[] retArray1 = new String[] {"0,4,4,4,4"};
  ...
  //              .contains(
  //                  TSStatusCode.PATH_NOT_EXIST.getStatusCode()
  //                      + ": Timeseries [root.*.d1.s3] does not exist or is represented by schema
  // template"));
  //    }
  //  }
  //
