...
@Ignore
public class IoTDBGroupByWithFillIT {
  ...
  private static final String[] SQLs =
      new String[] {
        ...
        "INSERT INTO root.ln.wf01.wt01(timestamp, temperature, status, hardware) values(10, 21, false, 11.1)",
        "INSERT INTO root.ln.wf01.wt01(timestamp, temperature, status, hardware) values(12, 23, true, 22.3)",
        "INSERT INTO root.ln.wf01.wt01(timestamp, temperature, status, hardware) values(14, 25, false, 33.5)",
        "INSERT INTO root.ln.wf01.wt01(timestamp, temperature, status, hardware) values(23, 28, true, 34.9)",
        "INSERT INTO root.ln.wf01.wt01(timestamp, temperature, status, hardware) values(25, 23, false, 31.7)",
        "INSERT INTO root.ln.wf01.wt01(timestamp, temperature, status, hardware) values(33, 29, false, 44.6)",
        "INSERT INTO root.ln.wf01.wt01(timestamp, temperature, status, hardware) values(36, 24, true, 44.8)",
        "INSERT INTO root.ln.wf01.wt01(timestamp, temperature, status, hardware) values(48, 28, false, 54.6)",
        "INSERT INTO root.ln.wf01.wt01(timestamp, temperature, status, hardware) values(50, 30, true, 55.8)",
        "INSERT INTO root.ln.wf01.wt01(timestamp, temperature, status, hardware) values(66, 40, false, 33.0)",
        "flush"
      };
  ...
  public static void setUp() throws Exception {
    PartitionInterval = ConfigFactory.getConfig().getPartitionInterval();
  ...
  //    resultSetEqualTest("select last_value(temperature) from "
  //            + "root.ln.wf01.wt01 "
  //            + "GROUP BY ([17, 55), 5ms) FILL(int32[previous])",expectedHeader,retArray);
  //  }
  //
  //  @Test
  ...
  //    String[] retArray =
  //        new String[] {
  //          "17,null", "22,66.6", "27,66.6", "32,89.4", "37,89.4", "42,89.4", "47,110.4",
  // "52,110.4"
  //        };
  //
  //    try (Connection conn = EnvFactory.getEnv().getConnection();
  ...
  //    String[] retArray =
  //        new String[] {
  //          "17,null", "22,false", "27,false", "32,true", "37,true", "42,true", "47,true",
  // "52,null"
  //        };
  //
  //    try (Connection conn = EnvFactory.getEnv().getConnection();
  ...
  //              "select last_value(status) from "
  //                  + "root.ln.wf01.wt01 "
  //                  + "GROUP BY ([17, 55), 5ms) FILL(boolean[previousUntilLast]) order by time
  // desc");
  //      assertTrue(hasResultSet);
  //      try (ResultSet resultSet = statement.getResultSet()) {
  //        cnt = 0;
  ...
  //              "select first_value(hardware) from "
  //                  + "root.ln.wf01.wt01 "
  //                  + "GROUP BY ([17, 55), 5ms) FILL(double[previousUntilLast]) order by time
  // desc");
  //      assertTrue(hasResultSet);
  //      try (ResultSet resultSet = statement.getResultSet()) {
  //        cnt = 0;
  ...
  //              "select count(hardware) from "
  //                  + "root.ln.wf01.wt01 "
  //                  + "GROUP BY ([17, 55), 5ms) FILL(int64[previousUntilLast]) order by time
  // desc");
  //      assertTrue(hasResultSet);
  //      try (ResultSet resultSet = statement.getResultSet()) {
  //        cnt = 0;
  ...
  //    String[] retArray =
  //        new String[] {"17,null", "22,25", "27,25", "32,36", "37,36", "42,36", "47,50",
  // "52,null"};
  //
  //    try (Connection conn = EnvFactory.getEnv().getConnection();
  //        Statement statement = conn.createStatement()) {
  ...
  //    String[] retArray =
  //        new String[] {"17,null", "22,28", "27,28", "32,29", "37,29", "42,29", "47,30",
  // "52,null"};
  //
  //    try (Connection conn = EnvFactory.getEnv().getConnection();
  //        Statement statement = conn.createStatement()) {
  ...
  //              "select max_value(temperature) from "
  //                  + "root.ln.wf01.wt01 "
  //                  + "GROUP BY ([17, 55), 5ms) FILL(int32[previousUntilLast]) order by time
  // desc");
  //      assertTrue(hasResultSet);
  //      try (ResultSet resultSet = statement.getResultSet()) {
  //        cnt = 0;
  ...
  //    String[] retArray =
  //        new String[] {"17,null", "22,23", "27,23", "32,33", "37,33", "42,33", "47,48",
  // "52,null"};
  //
  //    try (Connection conn = EnvFactory.getEnv().getConnection();
  //        Statement statement = conn.createStatement()) {
  ...
  //    String[] retArray =
  //        new String[] {"17,null", "22,23", "27,23", "32,24", "37,24", "42,24", "47,28",
  // "52,null"};
  //
  //    try (Connection conn = EnvFactory.getEnv().getConnection();
  //        Statement statement = conn.createStatement()) {
  ...
  //    String[] retArray =
  //        new String[] {"17,100", "22,23", "27,100", "32,24", "37,100", "42,100", "47,30",
  // "52,100"};
  //
  //    try (Connection conn = EnvFactory.getEnv().getConnection();
  //        Statement statement = conn.createStatement()) {
  ...
  //    String[] retArray =
  //        new String[] {"17,888", "22,25", "27,888", "32,36", "37,888", "42,888", "47,50",
  // "52,888"};
  //
  //    try (Connection conn = EnvFactory.getEnv().getConnection();
  //        Statement statement = conn.createStatement()) {
  ...
  //    String[] retArray =
  //        new String[] {"17,100", "22,28", "27,100", "32,29", "37,100", "42,100", "47,30",
  // "52,100"};
  //
  //    try (Connection conn = EnvFactory.getEnv().getConnection();
  //        Statement statement = conn.createStatement()) {
  ...
  //    String[] retArray =
  //        new String[] {"17,null", "22,23", "27,23", "32,24", "37,26", "42,28", "47,30",
  // "52,null"};
  //
  //    try (Connection conn = EnvFactory.getEnv().getConnection();
  //        Statement statement = conn.createStatement()) {
  ...
  //    String[] retArray =
  //        new String[] {"17,null", "22,25", "27,30", "32,36", "37,40", "42,45", "47,50",
  // "52,null"};
  //
  //    try (Connection conn = EnvFactory.getEnv().getConnection();
  //        Statement statement = conn.createStatement()) {
  ...
  //    String[] retArray =
  //        new String[] {"17,null", "22,23", "27,28", "32,33", "37,38", "42,43", "47,48",
  // "52,null"};
  //
  //    try (Connection conn = EnvFactory.getEnv().getConnection();
  //        Statement statement = conn.createStatement()) {
  ...
  //    String[] retArray =
  //        new String[] {"17,null", "22,23", "27,23", "32,24", "37,25", "42,26", "47,28",
  // "52,null"};
  //
  //    try (Connection conn = EnvFactory.getEnv().getConnection();
  //        Statement statement = conn.createStatement()) {
  ...
  //    String[] retArray =
  //        new String[] {"17,null", "22,28", "27,28", "32,29", "37,29", "42,29", "47,28",
  // "52,null"};
  //
  //    try (Connection conn = EnvFactory.getEnv().getConnection();
  //        Statement statement = conn.createStatement()) {
  ...
  //    String[] retArray =
  //        new String[] {
  //          "17,null", "22,66.6", "27,78.0", "32,89.4", "37,96.4", "42,103.4", "47,110.4",
  // "52,null"
  //        };
  //
  //    try (Connection conn = EnvFactory.getEnv().getConnection();
  ...
  //
  //  /**
  //   * Test group by fill without aggregation function used in select clause. The expected
  // situation
