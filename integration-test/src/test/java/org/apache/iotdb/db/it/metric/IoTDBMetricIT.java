...
public class IoTDBMetricIT {
  ...
  private static final String METRIC_LINE_REGEX =
      METRIC_NAME_REGEX + "(\\{" + LABEL_NAME_REGEX + "=\"" + LABEL_VALUE_REGEX + "\",("
          + LABEL_NAME_REGEX + "=\"" + LABEL_VALUE_REGEX
          + "\",)*})? [+-]?[0-9]*\\.?[0-9]+([eE][+-]?[0-9]+)?";
  ...
  private static final String VALID_LOG_STRING = "This line {} is invalid in prometheus line protocol";
