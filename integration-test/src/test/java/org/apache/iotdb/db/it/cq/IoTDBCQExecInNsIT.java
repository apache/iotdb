...
public class IoTDBCQExecInNsIT {
    ...
    try (Connection connection = EnvFactory.getEnv().getConnection();
      ...
      statement.execute(
          String.format(
              ...
              startTime,
              1,
              startTime + 500_000_000L,
              2,
              startTime + 1_000_000_000L,
              3,
              startTime + 1_500_000_000L,
              4,
              startTime + 2_000_000_000L,
              5,
              startTime + 2_500_000_000L,
              6,
              startTime + 3_000_000_000L,
              7,
              startTime + 3_500_000_000L,
              8,
      ...
      if (System.currentTimeMillis() > firstExecutionTime / 1_000_000L) {
        statement.execute("DROP CQ cq1");
        return;
      }

      long targetTime = firstExecutionTime / 1_000_000L + 10_000;
