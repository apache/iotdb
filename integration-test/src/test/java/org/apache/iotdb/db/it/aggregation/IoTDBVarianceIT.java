...
public class IoTDBVarianceIT {
  ...
  public void testStddevAlignByDevice() {
    ...
    String[] retArray = new String[] {"root.db.d1,1.5811388300841898,0.5477225575051661,1.5811388300841898,0.5477225575051661,"};
    resultSetEqualTest(
  ...
  public void testStddevPopAlignByDevice() {
    ...
    String[] retArray = new String[] {"root.db.d1,1.4142135623730951,0.4898979485566356,1.4142135623730951,0.4898979485566356,"};
    resultSetEqualTest(
            "select stddev_pop(s1),stddev_pop(s2),stddev_pop(s4),stddev_pop(s5) from root.db.d1 align by device",
            expectedHeader,
            retArray);

    retArray = new String[] {"root.db.d1,0.816496580927726,0.4714045207910317,0.816496580927726,0.4714045207910317,"};
    resultSetEqualTest(
  ...
  public void testVarPopAlignByDevice() {
    ...
    retArray = new String[] {"root.db.d1,0.6666666666666666,0.2222222222222222,0.6666666666666666,0.2222222222222222,"};
    resultSetEqualTest(
  ...
  public void testStddevSampInHaving() {
    ...
    String[] retArray = new String[] {"1.5811388300841898,"};
    resultSetEqualTest(
            "select stddev_samp(s1) from root.db.d1 having stddev_samp(s2)>0", expectedHeader, retArray);
  }
  ...
  public void testStddevWithGroupByLevel() {
    ...
    String[] retArray = new String[] {"1.4907119849998598,0.48304589153964794,1.0540925533894598,1.4181364924121764,"};
    resultSetEqualTest(
  ...
  public void testStddevPopWithGroupByLevel() {
    ...
    String[] retArray = new String[] {"1.4142135623730951,0.45825756949558405,1.0,1.3453624047073711,"};
    resultSetEqualTest(
  ...
  public void testVarianceWithGroupByLevel() {
    ...
    String[] retArray = new String[] {"2.2222222222222223,0.23333333333333334,1.1111111111111112,2.011111111111111,"};
    resultSetEqualTest(
  ...
  public void testStddevPopWithSlidingWindow() {
    ...
    resultSetEqualTest(
            "select stddev_pop(s1) from root.db.d1 group by time([1,4),3ms,2ms)", expectedHeader, retArray);
  }
  ...
  public void testStddevSampWithSlidingWindow() {
    ...
    String[] retArray = new String[] {"1,1.0,", "3,null,"};
    resultSetEqualTest(
            "select stddev_samp(s1) from root.db.d1 group by time([1,4),3ms,2ms)", expectedHeader, retArray);
  }
  ...
  public void testVarianceWithSlidingWindow() {
    ...
    String[] retArray = new String[] {"1,1.0,", "3,null,"};
    resultSetEqualTest(
            "select variance(s1) from root.db.d1 group by time([1,4),3ms,2ms)", expectedHeader, retArray);
  }
  ...
  public void testVarPopWithSlidingWindow() {
    ...
    resultSetEqualTest(
            "select var_pop(s1) from root.db.d1 group by time([1,4),3ms,2ms)", expectedHeader, retArray);
  }
  ...
  public void testVarSampWithSlidingWindow() {
    ...
    String[] retArray = new String[] {"1,1.0,", "3,null,"};
    resultSetEqualTest(
            "select var_samp(s1) from root.db.d1 group by time([1,4),3ms,2ms)", expectedHeader, retArray);
  }
}
