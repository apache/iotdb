...
public class IoTDBAlignedSeriesQueryIT {
  ...
  public void countAllAlignedAndNonAlignedWithoutTimeFilterTest() {
    String[] retArray =
        new String[] {"20", "29", "28", "19", "20", "19", "29", "28", "18", "19", "1"};
    String[] columnNames = {
      "count(root.sg1.d1.s1)",
      "count(root.sg1.d1.s2)",
      "count(root.sg1.d1.s3)",
  ...
  public void countAllAlignedAndNonAlignedWithoutTimeFilterAlignByDeviceTest() {
    String[] retArray =
        new String[] {"root.sg1.d1,20,29,28,19,20,null,", "root.sg1.d2,19,29,28,18,19,1,"};
    String[] columnNames = {
      "Device", "count(s1)", "count(s2)", "count(s3)", "count(s4)", "count(s5)", "count(s6)"
    };
