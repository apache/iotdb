...
public class IoTDBTriggerExecutionIT {
  ...
  private void createTimeseries() {
    try (Connection connection = EnvFactory.getEnv().getConnection();
        Statement statement = connection.createStatement()) {
      statement.execute(
          "CREATE TIMESERIES root.vehicle.a.b.c.d1.s1 WITH DATATYPE=INT32, ENCODING=PLAIN, COMPRESSION=UNCOMPRESSED");
      statement.execute(
          "CREATE TIMESERIES root.vehicle.a.b.c.d1.s2 WITH DATATYPE=INT64, ENCODING=PLAIN, COMPRESSION=UNCOMPRESSED");
      statement.execute(
          "CREATE TIMESERIES root.vehicle.a.b.c.d1.s3 WITH DATATYPE=FLOAT, ENCODING=PLAIN, COMPRESSION=UNCOMPRESSED");
      statement.execute(
          "CREATE TIMESERIES root.vehicle.a.b.c.d1.s4 WITH DATATYPE=DOUBLE, ENCODING=PLAIN, COMPRESSION=UNCOMPRESSED");
      statement.execute(
          "CREATE TIMESERIES root.vehicle.a.b.c.d1.s5 WITH DATATYPE=BOOLEAN, ENCODING=PLAIN, COMPRESSION=UNCOMPRESSED");
      statement.execute(
          "CREATE TIMESERIES root.vehicle.a.b.c.d1.s6 WITH DATATYPE=TEXT, ENCODING=PLAIN, COMPRESSION=UNCOMPRESSED");
