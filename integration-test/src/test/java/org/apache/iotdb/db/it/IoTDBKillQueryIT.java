...
public class IoTDBKillQueryIT {
  ...
  private static final String DATABASE = "root.kill_query";
  private static final String DEVICE = DATABASE + ".d1";
  private static final String TIMESERIES = DEVICE + ".s1";
  private static final String QUERY_USER = "kill_query_query_user";
  private static final String KILL_USER = "kill_query_kill_user";
