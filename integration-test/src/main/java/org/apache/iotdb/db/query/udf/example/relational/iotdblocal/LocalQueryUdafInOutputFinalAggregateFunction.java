...
/** UDAF that calls {@link IoTDBLocal#query(String)} only in {@link #outputFinal} with local. */
public class LocalQueryUdafInOutputFinalAggregateFunction implements AggregateFunction {
  ...
  public void outputFinal(State state, ResultValue resultValue, IoTDBLocal local) {
    ...
    resultValue.setLong(countState.count + extraCount);
  }
}
