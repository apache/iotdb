...
/** Base scalar UDF that probes a mutating SQL statement via {@link IoTDBLocal#query(String)}. */
abstract class MutatingQueryProbeFunction implements ScalarFunction {

  protected abstract String mutatingSql();
  ...
  public void beforeStart(FunctionArguments arguments, IoTDBLocal local) throws UDFException {
    local.query(mutatingSql());
  }

  @Override
  public Object evaluate(Record input) {
    return new Binary("unexpected", TSFileConfig.STRING_CHARSET);
  }
}
