...
public abstract class TableFunction {
  ...
  public abstract List<ParameterSpecification> getArgumentsSpecification();

  public abstract ReturnTypeSpecification getReturnTypeSpecification();

  /**
   * @return must be {@linkplain Descriptor#isTyped()} if present
   */
