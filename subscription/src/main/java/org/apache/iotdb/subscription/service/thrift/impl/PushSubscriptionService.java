...
package org.apache.iotdb.subscription.service.thrift.impl;
...
public class PushSubscriptionService extends SubscriptionService {
  public PushConsumer consumer;

  public PushSubscriptionService(String localHost, Integer localPort) {
    super(localHost, localPort);
  }

  @Override
  public void registerConsumer(Consumer consumer) {
    this.consumer = (PushConsumer) consumer;
  }
